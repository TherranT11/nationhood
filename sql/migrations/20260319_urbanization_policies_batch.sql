...
INSERT INTO policies (
    ...
    NULL, NULL,
    'urbanization', 'UP', 0.8, 20, 0, 100, 15, true
...
INSERT INTO policies (
    ...
    NULL, NULL,
    'urbanization', 'UP', 0.2, 48, 0, 100, 2, true
) RETURNING id INTO v_policy_id;
RAISE NOTICE 'Created: Urban Enterprise Zone Act (%)', v_policy_id;
INSERT INTO nation_policies (nation_id, policy_id, major_sector, law_category, fiscal_category, status, activated_at_tick, effects_started, effects_completed, ticks_elapsed)
SELECT nid, v_policy_id, 'ECONOMICS', 'regulatory', 'Finance', 'active', 0, true, true, 53
...
INSERT INTO policies (
    ...
    NULL, NULL,
    'urbanization', 'UP', 0.3, 20, 0, 100, 6, true
) RETURNING id INTO v_policy_id;
...
INSERT INTO policies (
    ...
    NULL, NULL,
    'urbanization', 'UP', 0.2, 48, 0, 100, 3, true
) RETURNING id INTO v_policy_id;
RAISE NOTICE 'Created: Urban Housing Subsidy Program (%)', v_policy_id;
INSERT INTO nation_policies (nation_id, policy_id, major_sector, law_category, fiscal_category, status, activated_at_tick, effects_started, effects_completed, ticks_elapsed)
SELECT nid, v_policy_id, 'SOCIAL', 'welfare', 'Interior', 'active', 0, true, true, 52
...
INSERT INTO policies (
    ...
    NULL, NULL,
    'urbanization', 'UP', 0.3, 20, 0, 100, 10, true
) RETURNING id INTO v_policy_id;
...
INSERT INTO policies (
    ...
    NULL, NULL,
    'urbanization', 'UP', 0.15, 48, 0, 100, 2, true
) RETURNING id INTO v_policy_id;
RAISE NOTICE 'Created: Urban Migrant Employment Program (%)', v_policy_id;
INSERT INTO nation_policies (nation_id, policy_id, major_sector, law_category, fiscal_category, status, activated_at_tick, effects_started, effects_completed, ticks_elapsed)
SELECT nid, v_policy_id, 'LABOR', 'workers', 'Labor', 'active', 0, true, true, 52
...
INSERT INTO policies (
    ...
    'SOCIAL', 'Civil Rights', 'civil_rights', 'Interior',
    'Equality', '["Equality","Progress"]'::jsonb,
    40, 'population',
    8, 'population',
    '[
    ...
    NULL, NULL,
    'urbanization', 'UP', 0.2, 16, 0, 100, 8, true
) RETURNING id INTO v_policy_id;
RAISE NOTICE 'Created: Informal Settlement Regularization Program (%)', v_policy_id;
INSERT INTO nation_policies (nation_id, policy_id, major_sector, law_category, fiscal_category, status, activated_at_tick, effects_started, effects_completed, ticks_elapsed)
SELECT nid, v_policy_id, 'SOCIAL', 'civil_rights', 'Interior', 'active', 0, true, true, 21
...
INSERT INTO policies (
    ...
    NULL, NULL,
    'urbanization', 'DOWN', 0.2, 48, 0, 100, 3, true
) RETURNING id INTO v_policy_id;
...
INSERT INTO policies (
    ...
    NULL, NULL,
    'urbanization', 'DOWN', 0.1, 48, 0, 100, 1, true
) RETURNING id INTO v_policy_id;
...
INSERT INTO policies (
    ...
    NULL, NULL,
    'urbanization', 'DOWN', 0.15, 48, 0, 100, 1, true
) RETURNING id INTO v_policy_id;
...
INSERT INTO policies (
    ...
    NULL, NULL,
    'urbanization', 'DOWN', 0.1, 48, 0, 100, 2, true
) RETURNING id INTO v_policy_id;
...
INSERT INTO policies (
    ...
    NULL, NULL,
    'urbanization', 'DOWN', 0.2, 20, 0, 100, 10, true
) RETURNING id INTO v_policy_id;
...
INSERT INTO policies (
    ...
    NULL, NULL,
    'urbanization', 'DOWN', 0.15, 48, 0, 100, 3, true
) RETURNING id INTO v_policy_id;
...
INSERT INTO policies (
    ...
    'ECONOMICS', 'Fiscal Policy', 'fiscal_policy', 'Finance',
    'Equality', '["Equality","Collectivism"]'::jsonb,
    3, NULL,
    1, NULL,
    '[
...
INSERT INTO nation_policies (nation_id, policy_id, major_sector, law_category, fiscal_category, status, activated_at_tick, effects_started, effects_completed, ticks_elapsed)
SELECT nid, v_policy_id, 'ECONOMICS', 'fiscal_policy', 'Finance', 'active', 0, true, true, 53
FROM unnest(ARRAY[v_av, v_se, v_pa]) AS nid WHERE nid IS NOT NULL;
...
INSERT INTO policies (
    ...
    'ECONOMICS', 'Structural Reform', 'structural_reform', 'Interior',
    'Nationalism', '["Nationalism","Collectivism"]'::jsonb,
    10, NULL,
    2, 'population',
    '[
...
INSERT INTO nation_policies (nation_id, policy_id, major_sector, law_category, fiscal_category, status, activated_at_tick, effects_started, effects_completed, ticks_elapsed)
SELECT nid, v_policy_id, 'ECONOMICS', 'structural_reform', 'Interior', 'active', 0, true, true, 53
