-- ════════════════════════════════════════════════════════════════
-- Interior Infrastructure upkeep
--
-- Adds upkeep_per_year to the existing interior_infrastructure_tiers()
-- SoT JSONB. Once a build completes (processInteriorInfrastructureCompletions
-- in political-actions.js), every active project of that tier costs
-- the listed annual upkeep, charged via computePanelAnnualExpenditures
-- → processNationDebtTick (same path as Vola Stadium upkeep).
--
-- Tier upkeep:
--   small        $1 / yr
--   modest       $2 / yr
