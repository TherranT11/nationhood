import{_supabase as gt}from"./supabase-client-qEAQbBjE.js";/* empty css                  */import{r as ea}from"./role-actions-fros7AI4.js";import{l as aa,d as Ae,i as ia}from"./common-hUGd1WrW.js";import{g as Bt,U as oa,a8 as na,W as sa}from"./political-actions-DKWURJip.js";import{q as K,f as pe,h as rt,n as Et,c as me,r as ra,M as la}from"./government-structure-DUNrPmll.js";import{GAME_CONFIG as lt,FORMATION_DEADLINE_TICKS as te}from"./config-CKNXR-qR.js";import{f as da}from"./no-confidence-C3okxeC-.js";import{i as ca,g as pa,j as Te}from"./elections-CFT9Pv9X.js";import{d as ma,c as fa,s as va,a as Tt}from"./stats-tIiBSaQA.js";import{tickToDate as ua}from"./utils-A98FEun4.js";import"./preload-helper-BXl3LOEh.js";import"./corp-topbar-CPI0igZM.js";import"./bills-B5lzMfi_.js";import"./corp-valuation-C0hsb2EQ.js";import"./budget-Dk7fC1DR.js";import"./presidential-CfLHmXot.js";const xt=[{id:"economic_reform",name:"Economic Reform",icon:"📈",tagline:"Growth-first neoliberal agenda",desc:"Prioritize GDP, attract foreign capital, lower corporate taxes. The rising tide theory — grow the pie and worry about slicing it later.",improve:["gdp_growth","foreign_investment","currency_strength","credit","service_output","manufacturing_output"],worsen:["income_inequality","poverty_rate","union_strength","income_tax"],tradeoff:"Income inequality tends to rise. Working class sees GDP numbers go up while their wages don't."},{id:"social_justice",name:"Social Justice",icon:"⚖️",tagline:"Redistribution and equity",desc:"Raise minimum wage, expand welfare, progressive taxation. Close the gap between rich and poor through direct intervention.",improve:["minimum_wage","poverty_rate","income_inequality","social_mobility","healthcare_accessibility","education_accessibility"],worsen:["foreign_investment","gdp_growth","corporate_tax"],tradeoff:"Capital flight risk. Foreign investors avoid high-tax environments. Growth may slow."},{id:"national_security",name:"National Security",icon:"🛡️",tagline:"Borders, military, order",desc:"Strengthen defense, tighten borders, expand police powers. Safety through strength.",improve:["stability","crime_rate","terrorism","political_violence","illegal_immigration"],worsen:["freedom_index","press_freedom","civil_unrest","polarization"],tradeoff:"Freedom index drops. Minority communities disproportionately affected. International criticism."},{id:"anti_corruption",name:"Anti-Corruption",icon:"🔍",tagline:"Clean government, institutional reform",desc:"Independent judiciary, transparent budgets, prosecute the connected. Popular with voters but powerful people fight back hard.",improve:["corruption","judicial_independence","press_freedom","legitimacy","efficiency"],worsen:["stability"],tradeoff:"Short-term chaos as exposing corruption shakes institutions. Your own party's skeletons may surface."},{id:"green_transition",name:"Green Transition",icon:"🌱",tagline:"Climate and environment",desc:"Renewable energy investment, carbon taxes, emissions targets. Save the planet — but the bill comes due now, not later.",improve:["renewable_energy_pct","pollution","carbon_emissions","energy_generation"],worsen:["fuel_prices","manufacturing_output","gdp_growth","cost_of_living"],tradeoff:"Energy costs spike during transition. Rural and industrial voters feel abandoned."},{id:"industrialization",name:"Industrialization",icon:"🏭",tagline:"Factories, exports, production",desc:"Build manufacturing capacity, create blue-collar jobs, develop physical infrastructure. The backbone of a real economy.",improve:["manufacturing_output","labor_force_participation","unemployment","physical_infrastructure","gdp_growth"],worsen:["pollution","carbon_emissions","arable_land","healthcare_quality"],tradeoff:"Environment gets destroyed. Long-term health costs from industrial pollution."},{id:"digital_modernization",name:"Digital Modernization",icon:"💻",tagline:"Tech economy, connectivity",desc:"Fiber everywhere, tech sector incentives, digital government services. Leap into the future — but not everyone makes the jump.",improve:["digital_infrastructure","service_output","higher_education","academic_immigration","efficiency"],worsen:["manufacturing_output","labor_force_participation","income_inequality","urbanization"],tradeoff:"Automation displaces workers. Rural communities left behind. Tech wealth concentrates in cities."},{id:"welfare_state",name:"Welfare State",icon:"🏥",tagline:"Universal services, safety net",desc:"Free healthcare, free education, generous pensions, unemployment insurance. Cradle to grave — funded by steep taxes on everyone.",improve:["healthcare_quality","healthcare_accessibility","education_accessibility","poverty_rate","standard_of_living","happiness"],worsen:["income_tax","corporate_tax","gdp_growth","foreign_investment"],tradeoff:"Massive fiscal cost. Tax burden on middle class, not just the rich. Sustainability questioned."},{id:"populist_nationalism",name:"Populist Nationalism",icon:"🇲",tagline:"The people vs. elites and outsiders",desc:"Restrict immigration, protect domestic industry, reject globalism. Our people first. Our jobs first. Our culture first.",improve:["immigration","illegal_immigration","manufacturing_output","minimum_wage","union_strength"],worsen:["foreign_investment","academic_immigration","freedom_index","press_freedom","polarization","ethnic_diversity"],tradeoff:"International isolation. Brain drain as educated professionals emigrate. Deep social polarization."},{id:"free_market",name:"Free Market Liberalism",icon:"🏛️",tagline:"Deregulate everything",desc:"Cut taxes, cut red tape, let the market decide winners and losers. Government is the problem, not the solution.",improve:["gdp_growth","foreign_investment","credit","service_output","currency_strength"],worsen:["union_strength","minimum_wage","healthcare_accessibility","income_inequality","poverty_rate"],tradeoff:"Growth at the cost of the working class. Social safety net erodes. Boom-bust volatility."},{id:"law_and_order",name:"Law & Order",icon:"⚔️",tagline:"Tough on crime, strong institutions",desc:"More police, harsher sentences, zero tolerance. Restore order to the streets. Criminals fear the state.",improve:["crime_rate","stability","political_violence","terrorism","drug_use"],worsen:["incarceration_rate","freedom_index","civil_unrest"],tradeoff:"Prison population explodes. Minority communities targeted. Policing costs balloon."},{id:"education_first",name:"Education First",icon:"🎓",tagline:"Human capital as the long game",desc:"Fund schools, universities, research institutions, teacher salaries. The 20-year bet that the next generation will be smarter and richer.",improve:["literacy","higher_education","education_accessibility","academic_immigration","social_mobility","labor_force_participation"],worsen:["income_tax","gdp_growth"],tradeoff:"Voters don't see results before next election. Brain drain if jobs don't exist for graduates."},{id:"healthcare_reform",name:"Healthcare Reform",icon:"💊",tagline:"Fix the hospitals",desc:"More beds, more doctors, better drugs, universal coverage. Nobody dies because they can't afford treatment.",improve:["healthcare_quality","healthcare_accessibility","beds_per_100k","lifespan","drug_use"],worsen:["income_tax","gdp_growth","cost_of_living"],tradeoff:"Pharmaceutical lobby fights back. Extremely expensive. Takes multiple cycles to show results."},{id:"housing_cost",name:"Housing & Cost of Living",icon:"🏠",tagline:"The kitchen-table platform",desc:"Rent controls, public housing, affordable food, price caps on essentials. People can't eat GDP growth.",improve:["housing_affordability","cost_of_living","standard_of_living","physical_infrastructure","urbanization"],worsen:["foreign_investment","gdp_growth"],tradeoff:"Property owners and developers become your enemies. Market distortions create shortages."},{id:"energy_independence",name:"Energy Independence",icon:"⛽",tagline:"Control your own power supply",desc:"Exploit domestic oil, gas, and minerals. No more dependency on foreign energy. Cheap fuel, strong economy, sovereign power.",improve:["energy_generation","oil_and_gas","rare_minerals","fuel_prices","manufacturing_output","gdp_growth"],worsen:["pollution","carbon_emissions","renewable_energy_pct","arable_land"],tradeoff:"Climate commitments broken. Green voters abandon you. Environmental debt for future generations."},{id:"open_society",name:"Open Society",icon:"🕊️",tagline:"Liberal democracy, civil liberties",desc:"Free press, open borders, multicultural embrace, strong civil rights. A beacon of freedom — and a target for those who fear it.",improve:["freedom_index","press_freedom","immigration","academic_immigration","ethnic_diversity","happiness","judicial_independence"],worsen:["stability","illegal_immigration","polarization","terrorism"],tradeoff:"Nationalist backlash. Rural-urban divide deepens. Security vulnerabilities from openness."}],ye={gdp_growth:"GDP Growth",inflation:"Inflation",interest_rates:"Interest Rates",currency_strength:"Currency Strength",foreign_investment:"Foreign Investment",credit:"Credit",income_tax:"Income Tax",corporate_tax:"Corporate Tax",sales_tax:"Sales Tax",unemployment:"Unemployment",labor_force_participation:"Labor Force Participation",minimum_wage:"Minimum Wage",union_strength:"Union Strength",poverty_rate:"Poverty Rate",income_inequality:"Income Inequality",healthcare_quality:"Healthcare Quality",healthcare_accessibility:"Healthcare Accessibility",beds_per_100k:"Beds per 100k",lifespan:"Lifespan",drug_use:"Drug Use",literacy:"Literacy",higher_education:"Higher Education",education_accessibility:"Education Accessibility",academic_immigration:"Academic Immigration",physical_infrastructure:"Physical Infrastructure",digital_infrastructure:"Digital Infrastructure",urbanization:"Urbanization",energy_generation:"Energy Generation",renewable_energy_pct:"Renewable Energy %",arable_land:"Arable Land",rare_minerals:"Rare Minerals",oil_and_gas:"Oil & Gas",fuel_prices:"Fuel Prices",pollution:"Pollution",carbon_emissions:"Carbon Emissions",standard_of_living:"Standard of Living",happiness:"Happiness",social_mobility:"Social Mobility",crime_rate:"Crime Rate",incarceration_rate:"Incarceration Rate",religiosity:"Religiosity",stability:"Stability",legitimacy:"Legitimacy",efficiency:"Efficiency",corruption:"Corruption",press_freedom:"Press Freedom",judicial_independence:"Judicial Independence",freedom_index:"Freedom Index",polarization:"Polarization",civil_unrest:"Civil Unrest",terrorism:"Terrorism",political_violence:"Political Violence",immigration:"Immigration",illegal_immigration:"Illegal Immigration",emigration:"Emigration",ethnic_diversity:"Ethnic Diversity",cost_of_living:"Cost of Living",housing_affordability:"Housing Affordability",manufacturing_output:"Manufacturing Output",service_output:"Service Output"},fe=new Set(["inflation","unemployment","poverty_rate","income_inequality","drug_use","pollution","carbon_emissions","crime_rate","incarceration_rate","corruption","polarization","civil_unrest","terrorism","political_violence","illegal_immigration","emigration","cost_of_living","fuel_prices"]),ga=new Set(["income_tax","corporate_tax","sales_tax"]);function be(e,t){const a=fe.has(e),i=ga.has(e);return t==="improve"?a?{arrow:"↓",color:"#5cc55c"}:i?{arrow:"↑",color:"#c84"}:{arrow:"↑",color:"#5cc55c"}:a?{arrow:"↑",color:"#c55"}:i?{arrow:"↓",color:"#5cc55c"}:{arrow:"↓",color:"#c55"}}function xe(e){switch(e){case 0:return{momentum:12,penalty:0,label:"+12",color:"#5cc55c",note:"Unclaimed — full momentum"};case 1:return{momentum:6,penalty:6,label:"+6",color:"#ca5",note:"Contested by 1 rival — reduced momentum"};case 2:return{momentum:4,penalty:4,label:"+4",color:"#c84",note:"Crowded (2 rivals) — minimal momentum"};default:return{momentum:2,penalty:2,label:"+2",color:"#c84",note:`Crowded (${e} rivals) — minimal momentum`}}}function ya(e,t){return e.map(a=>{const i=xt.find(o=>o.id===a.platform_key);if(!i)return{...a,stats:[]};const n=i.improve.map(o=>{const r=a.baseline_stats?.[o],c=a.target_stats?.[o],d=Number(t?.[o]??50),l=fe.has(o);if(r==null||c==null)return{stat:o,baseline:d,target:d,current:d,progress:0,met:!1};const m=Math.abs(c-r),s=l?Math.max(0,r-d):Math.max(0,d-r),p=m>0?Math.min(1,s/m):1,f=l?d<=c:d>=c;return{stat:o,baseline:r,target:c,current:d,progress:p,met:f}});return{...a,stats:n,platformDef:i}})}const ba=["Former union organizer. Knows how to mobilize a crowd.","Disbarred attorney. Understands the legal system from the inside.","Investigative journalist. Uncovered three government scandals before going private.","Ex-military intelligence. Trained in information warfare.","Community activist. Built grassroots networks across two provinces.","Former government auditor. Knows where the money hides.","Political science professor. Publishes on institutional corruption.","NGO director. Ran anti-corruption campaigns across the continent.","Former prosecutor. Left the justice ministry over political interference.","Labor rights campaigner. Organized the dockworkers' strike of 2014.","Freelance political consultant. Has worked for opposition parties in three nations.","Student movement leader. Led the university protests. Young and fearless.","Retired diplomat. Leverages international connections for domestic pressure.","Whistleblower advocate. Runs a secure tip line used by civil servants.","Former police detective. Turned against the system after a cover-up."];function vt(e){return e>=75?{label:"Exceptional",color:"#5cc55c",desc:"Elite operative. Lawsuits are devastating, intelligence is razor-sharp."}:e>=60?{label:"Strong",color:"#a3b07e",desc:"Experienced and reliable. Can handle most opposition tasks effectively."}:e>=45?{label:"Competent",color:"#ca5",desc:"Gets the job done. Occasional missteps under pressure."}:e>=30?{label:"Developing",color:"#c84",desc:"Green but eager. Results are inconsistent. Cheap to hire."}:{label:"Weak",color:"#c55",desc:"Liability risk. May botch sensitive operations. Rock-bottom price for a reason."}}function xa(e){var t=Math.max(0,e-20)/65,a=12e4+t*28e4;return Math.round(a/25e3)*25e3}function jt(e,t){return e+Math.floor(Math.random()*(t-e+1))}function he(e){return e[Math.floor(Math.random()*e.length)]}function ha(e,t){var a=[],i=new Set,n=jt(5,7),o=Bt(t),r=o.firstNames||[],c=o.lastNames||[];if(r.length===0||c.length===0)return[];for(var d=ba.slice().sort(function(){return Math.random()-.5}),l=0;l<n;l++){var m,s,p,f=0;do m=he(r),s=he(c),p=m+" "+s,f++;while(i.has(p)&&f<20);i.add(p);var v=jt(20,85),u=jt(25,60),h=d[l%d.length],b=xa(v);a.push({nation_id:e,first_name:m,last_name:s,age:u,skill:v,background:h,hire_cost:b,status:"available"})}return a.sort(function(x,g){return g.skill-x.skill}),a}async function Ne(e,t,a){var{data:i}=await e.from("nations").select("government_type").eq("id",t).maybeSingle();if(K(i)){var{data:n}=await e.from("factions").select("seats").eq("id",a).maybeSingle();return ee({partyId:a,partySeats:n?.seats,admin:null,ministryHolder:!1,nation:i})}var[o,r]=await Promise.all([pe(e,t).catch(function(u){return console.warn("[Agitator] fetchActiveCoalition failed:",u?.message||u),null}),e.from("administrations").select("id, coalition_parties, stats_at_start, started_at_tick, pm_party_id, pm_party_name, president_party_id").eq("nation_id",t).is("ended_at_tick",null).order("started_at_tick",{ascending:!1}).limit(1).maybeSingle()]);if(r.error)return console.error("[Agitator] Failed to check governing status:",r.error.message),{isGoverning:!1,isOpposition:!0,label:"OPPOSITION",administration:null};var c=r.data,d=o,l=rt(i),m=l?"president_party_id":"pm_party_id",s=Array.isArray(d?.party_ids)?d.party_ids.map(function(u){return{party_id:u}}):[];if(c&&d){!c[m]&&d.lead_party_id&&(c[m]=d.lead_party_id);var p=Array.isArray(c.coalition_parties)?c.coalition_parties:[];p.length===0&&s.length>0&&(c.coalition_parties=s)}else!c&&d&&(c={pm_party_id:null,president_party_id:null,coalition_parties:s},c[m]=d.lead_party_id||null);var f=!1;if(l){var{count:v}=await e.from("ministries").select("*",{count:"exact",head:!0}).eq("nation_id",t).eq("party_id",a).eq("is_active",!0);f=(v||0)>0}return ee({partyId:a,partySeats:null,admin:c,ministryHolder:f,nation:i})}function _a(e,t,a,i){return ee({partyId:e?.id,partySeats:e?.seats,admin:t,ministryHolder:a?a.has(e?.id):!1,nation:i})}function ee({partyId:e,partySeats:t,admin:a,ministryHolder:i,nation:n}){if(K(n)){var o=Number(t||0)>=1;return{isGoverning:o,isOpposition:!o,label:o?"LOYAL":"DISSIDENT",administration:null}}if(!a)return{isGoverning:!1,isOpposition:!0,label:"OPPOSITION",administration:null};var r=Array.isArray(a.coalition_parties)?a.coalition_parties:[],c=r.some(function(s){return s?typeof s=="string"?s===e:typeof s=="object"?(s.party_id||s.id)===e:!1:!1}),d=a.pm_party_id===e,l=a.president_party_id===e,m=d||c||l||rt(n)&&!!i;return{isGoverning:m,isOpposition:!m,label:m?"GOVERNING":"OPPOSITION",administration:a}}async function ze(e,t){var{data:a,error:i}=await e.from("faction_agitators").select("*").eq("faction_id",t).eq("status","active").maybeSingle();return i?(console.error("[Agitator] Failed to fetch agitator:",i.message),null):a}async function $a(e,t,a){var{data:i,error:n}=await e.from("agitator_pool").select("*").eq("nation_id",t).eq("status","available").order("skill",{ascending:!1});if(n)return console.error("[Agitator] Failed to fetch pool:",n.message),[];if(i&&i.length>0)return i;var o=ha(t,a),{data:r,error:c}=await e.from("agitator_pool").insert(o).select("*");return c?(console.error("[Agitator] Failed to insert pool:",c.message),[]):(r||[]).sort(function(d,l){return l.skill-d.skill})}async function wa(e,t,a,i){var n=await ze(e,t);if(n)return{success:!1,agitator:null,error:"You already have an active agitator."};var{data:o,error:r}=await e.from("faction_agitators").insert({faction_id:t,first_name:a.first_name,last_name:a.last_name,age:a.age,skill:a.skill,background:a.background,status:"active",hired_at_tick:i}).select("*").single();if(r)return console.error("[Agitator] Failed to hire:",r.message),{success:!1,agitator:null,error:r.message};var{error:c}=await e.from("agitator_pool").update({status:"hired",hired_by_faction_id:t}).eq("id",a.id);return c&&console.error("[Agitator] Failed to mark pool candidate as hired:",c.message),{success:!0,agitator:o,error:null}}const Nt=[{key:"finance",label:"Finance",icon:"💰"},{key:"defense",label:"Defense",icon:"🛡️"},{key:"education",label:"Education",icon:"🎓"},{key:"healthcare",label:"Health",icon:"🏥"},{key:"interior",label:"Interior",icon:"🏛️"},{key:"foreign",label:"Foreign",icon:"🌐"},{key:"justice",label:"Justice",icon:"⚖️"},{key:"labor",label:"Labor",icon:"🔨"},{key:"trade",label:"Trade",icon:"📦"},{key:"energy",label:"Energy",icon:"⚡"},{key:"transportation",label:"Transport",icon:"🚂"},{key:"agriculture",label:"Agriculture",icon:"🌾"}],Re=[{key:"misuse_of_funds",label:"Misuse of Public Funds",desc:"Alleging budget went somewhere it shouldn't."},{key:"civil_rights",label:"Violation of Civil Rights",desc:"Alleging government overreach or suppression."},{key:"negligence",label:"Breach of Duty / Negligence",desc:"Alleging a ministry failed its mandate."},{key:"corruption",label:"Corruption / Self-Dealing",desc:"Alleging officials enriched themselves."}];function ve(e){return e<=5?{tier:1,label:"Clean Government",color:"#c55"}:e<=10?{tier:2,label:"Minor Corruption",color:"#ca5"}:e<=20?{tier:3,label:"Significant Corruption",color:"#c84"}:{tier:4,label:"Systemic Corruption",color:"#5cc55c"}}const nt={1:{resolution:"FRIVOLOUS SUIT",filer:{momentum:-5,governance:-2},gov:{momentum:3,governance:1}},2:{resolution:"PARTIAL WIN",filer:{momentum:3,governance:0},gov:{momentum:-2,governance:-2}},3:{resolution:"MAJOR WIN",filer:{momentum:7,governance:2},gov:{momentum:-5,governance:-5}},4:{resolution:"DEVASTATING WIN",filer:{momentum:12,governance:5},gov:{momentum:-10,governance:-8}}},_e={1:{filing:"{party} files lawsuit against {ministry} alleging {basis}.",discovery:"Lawsuit discovery phase produces routine documents. No irregularities found in {ministry}.",evidence:"Legal team reviews {ministry} records. Auditors confirm standard procedures.",pre_trial:"Judge signals skepticism toward {party}'s claims. Case appears thin.",resolution:"{ministry} lawsuit dismissed. Courts find no evidence of wrongdoing. {party} criticized for wasting court resources."},2:{filing:"{party} files lawsuit against {ministry} alleging {basis}.",discovery:"{party}'s lawsuit uncovers irregular procurement contracts in {ministry}.",evidence:"Documents reveal {ministry} awarded no-bid contracts to connected firms.",pre_trial:"Judge allows case to proceed. {ministry} officials ordered to testify.",resolution:"{ministry} lawsuit concludes with partial ruling. Irregular contracts confirmed but no criminal charges filed."},3:{filing:"{party} files lawsuit against {ministry} alleging {basis}.",discovery:"{party}'s lawsuit exposes hidden accounts linked to {ministry} officials.",evidence:"Leaked documents show systematic overbilling in {ministry}. Millions unaccounted for.",pre_trial:"Multiple {ministry} officials refuse to testify. Judge threatens contempt.",resolution:"{ministry} scandal confirmed. Court finds evidence of systematic corruption. {party} vindicated."},4:{filing:"{party} files lawsuit against {ministry} alleging {basis}.",discovery:"{party}'s lawsuit reveals {ministry} ran parallel budget invisible to parliament.",evidence:"Court-ordered audit exposes network of shell companies receiving {ministry} funds.",pre_trial:"Prosecutors request criminal referral. Multiple {ministry} officials implicated.",resolution:"Devastating verdict: {ministry} operated criminal enterprise. Officials face prosecution. Government in crisis."}};function $t(e,t){var a=e;for(var i in t)a=a.split("{"+i+"}").join(t[i]);return a}async function ka(e,t){var{factionId:a,nationId:i,agitatorId:n,targetMinistry:o,basis:r,currentTick:c,partyName:d,administration:l}=t,m,s,p;if(r==="civil_rights"){var f=Number(l?.stats_at_start?.freedom_index??50),{data:v,error:u}=await e.from("nations").select("freedom_index").eq("id",i).single();if(u)return{success:!1,lawsuit:null,tier:0,error:"Failed to fetch freedom index data."};s=Number(v?.freedom_index??50),m=f,p=Math.max(0,m-s)}else{var h=Number(l?.stats_at_start?.corruption??50),{data:v,error:u}=await e.from("nations").select("corruption").eq("id",i).single();if(u)return{success:!1,lawsuit:null,tier:0,error:"Failed to fetch corruption data."};s=Number(v?.corruption??50),m=h,p=Math.max(0,s-m)}var h=m,b=s,x=ve(p),g=nt[x.tier],w=c+8,L=Nt.find(function(R){return R.key===o}),S=L?"Ministry of "+L.label:o,C=Re.find(function(R){return R.key===r}),k=C?C.label:r,{data:I,error:z}=await e.from("lawsuits").insert({faction_id:a,nation_id:i,agitator_id:n,target_ministry:o,basis:r,filed_at_tick:c,resolves_at_tick:w,corruption_at_start:h,corruption_at_filing:b,corruption_growth:p,tier:x.tier,status:"active",resolution:null,momentum_effect:g.filer.momentum,governance_effect:g.filer.governance,gov_momentum_effect:g.gov.momentum,gov_governance_effect:g.gov.governance}).select("*").single();if(z)return{success:!1,lawsuit:null,tier:0,error:z.message};var E=_e[x.tier]||_e[1],P={party:d||"Opposition",ministry:S,basis:k},M=[{event_tick:c,event_type:"filing",headline:$t(E.filing,P)},{event_tick:c+2,event_type:"discovery",headline:$t(E.discovery,P)},{event_tick:c+5,event_type:"evidence",headline:$t(E.evidence,P)},{event_tick:c+7,event_type:"pre_trial",headline:$t(E.pre_trial,P)},{event_tick:w,event_type:"resolution",headline:$t(E.resolution,P)}],A=M.map(function(R){return{lawsuit_id:I.id,nation_id:i,event_tick:R.event_tick,event_type:R.event_type,headline:R.headline,is_fired:R.event_tick===c}}),{error:N}=await e.from("lawsuit_events").insert(A);N&&console.error("[Lawsuits] Failed to insert milestone events:",N.message);var{error:T}=await e.from("event_log").insert({nation_id:i,event_name:"LAWSUIT FILED",event_type:"lawsuit",category:"political",description_chosen:M[0].headline,fired_at_tick:c,faction_id:a||null,effects_applied:{lawsuit_id:I.id,tier:x.tier,target_ministry:S,basis:k,milestone:"filing"}});return T&&console.warn("[Lawsuits] event_log insert (filing) failed:",T.message),{success:!0,lawsuit:I,tier:x.tier,error:null}}async function Ea(e,t){var{data:a,error:i}=await e.from("lawsuits").select("*").eq("faction_id",t).order("filed_at_tick",{ascending:!1}).limit(10);return i?(console.error("[Lawsuits] Failed to fetch lawsuits:",i.message),[]):a||[]}let $=null,y=null,X="leader",et=[],zt=[],j=null,D=null,pt=!1,F=null,ae=[],bt=!1,G=null,at=!1,kt=[],Mt=!1,qt=!1,Pt=new Set;function _(e){if(!e)return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML}function Q(e,t){return((e||"?")[0]+(t||"?")[0]).toUpperCase()}const Fe=[{id:"leader",title:"LEADER",fullTitle:"Party Leader",color:"#c8a832"},{id:"deputy",title:"DEPUTY",fullTitle:"Deputy Party Leader",color:"#8b9a6b"},{id:"chief",title:"CHIEF OF STAFF",fullTitle:"Chief of Staff",color:"#5cc55c"},{id:"campaign",title:"CAMPAIGN MGR",fullTitle:"Campaign Manager",color:"#c84"},{id:"comms",title:"COMMS DIR",fullTitle:"Communications Director",color:"#5a8aaa"},{id:"agitator",title:"AGITATOR",fullTitle:"Opposition Coordinator",color:"#d44a4a",oppositionOnly:!0}],Ht=[{perSeat:5e3,momDivisor:10},{perSeat:4e3,momDivisor:8},{perSeat:3e3,momDivisor:6},{perSeat:2e3,momDivisor:5},{perSeat:1e3,momDivisor:5}];let mt=0,Rt=0,ie=!1;async function Ca(){if(!$||!y?.faction?.id||!y?.shard?.current_tick)return;const{count:e,error:t}=await $.from("campaign_actions").select("id",{count:"exact",head:!0}).eq("party_id",y.faction.id).eq("action_type","fundraise").eq("tick_performed",y.shard.current_tick);mt=!t&&e!=null?e:0}async function Ia(){if(Rt=0,ie=!1,!$||!y?.nation?.id||!y?.shard?.current_tick)return;const e=y.shard.current_tick,t=F?.pm_party_id;try{const{data:a}=await $.from("bills").select("id").eq("nation_id",y.nation.id).eq("bill_type","no_confidence").in("status",["committee","floor"]).limit(1);if(ie=!!(a&&a.length),t){const{data:i}=await $.from("campaign_actions").select("tick_performed").eq("nation_id",y.nation.id).eq("action_type","no_confidence_filed").eq("target_id",t).order("tick_performed",{ascending:!1}).limit(1).maybeSingle();if(i){const n=e-Number(i.tick_performed||0),o=typeof lt<"u"&&lt.NO_CONFIDENCE_COOLDOWN_TICKS||12;Rt=Math.max(0,o-n)}}}catch(a){console.warn("[PartyActions] loadNoConfidenceState failed:",a?.message||a)}}function Oe(e,t){const a=Ht[Math.min(t,Ht.length-1)],i=e*a.perSeat,n=Math.max(1,Math.floor(e/a.momDivisor));return{raised:i,momCost:n,perSeat:a.perSeat,tierIdx:Math.min(t,Ht.length-1)}}const Be=[{id:"fundraise",name:"Fundraise",desc:"Raise party funds proportional to your seat count. Each use yields less money and costs more momentum. Momentum cannot drop below 1.",cost:"MOMENTUM",costColor:"#c84",moneyCost:0,tags:["FINANCIAL","CAMPAIGN"],locked:!1},{id:"statement",name:"Issue Statement",desc:"Public declaration on an issue. Shifts party positioning and voter bloc reactions. Media covers it. Other parties may respond.",cost:"$20k",costColor:"#c8a832",moneyCost:2e4,tags:["PUBLIC","NARRATIVE"],locked:!1},{id:"platform",name:"Set Party Platform",desc:"Choose a political focus. Defines which stats you promise to change. Awards momentum based on how many rivals share the same platform.",cost:"$120k",costColor:"#c8a832",moneyCost:12e4,tags:["STRATEGIC"],locked:!1},{id:"call_early_elections",name:"Call Early Elections",desc:"Dissolve the legislature and call snap elections. PM-only. Government enters caretaker status; election fires after a short formation window. Momentum impact is tiered by Gov. Approval: >50 boosts PM party (+3), <35 boosts opposition (+5 each) and +3 stability, 35–50 is neutral.",cost:"$0",costColor:"var(--text-dim)",moneyCost:0,tags:["LEGISLATIVE","PM ONLY"],locked:!1},{id:"resign_as_pm",name:"Resign as Prime Minister",desc:"Step down from the Prime Minister seat. PM-only. Coalition enters caretaker status and has a 3-tick window to nominate a successor via the cabinet panel. If a new PM is installed the administration continues under new leadership; otherwise a snap election fires. Cost: −3 Momentum, −0.05 Credibility, −3 Stability, 12-tick bar from PM on your party.",cost:"$0",costColor:"var(--text-dim)",moneyCost:0,tags:["GOVERNMENT","PM ONLY"],locked:!1},{id:"no_confidence",name:"Vote of No Confidence",desc:"File a motion of no confidence against the Prime Minister. If a simple majority votes YES, the government falls and snap elections are triggered. PASS: +15 Momentum to you, -10 Momentum + -10 Governance to the PM’s party. FAIL: -10 Momentum to you. 12-tick cooldown on the targeted PM party.",cost:"$0",costColor:"var(--text-dim)",moneyCost:0,tags:["LEGISLATIVE","OPPOSITION"],locked:!1},{id:"leave_coalition",name:"Leave Coalition",desc:"Walk out of the current governing coalition. Any ministries your party holds are vacated. You drop from governing to opposition. Coalition flips to minority if your exit drops it below the majority threshold. Cost: −3 Momentum to you, −5 Momentum to the PM’s party. 12-tick cooldown. PM’s party cannot use this — resign first.",cost:"−3 MOM",costColor:"#c84",moneyCost:0,tags:["GOVERNMENT","RISKY"],locked:!1},{id:"disband_party",name:"Disband Party",desc:"Voluntarily dissolve your party. Your seats are vacated and sit empty until the next election (no backfill or redistribution). All party funds and momentum are lost. You are removed from every nation chat. Cannot be undone. 24-tick cooldown per user. Cannot be used while Prime Minister, sitting President, or reigning Monarch — step down first.",cost:"IRREVERSIBLE",costColor:"#c55",moneyCost:0,tags:["IRREVERSIBLE"],locked:!1}],Ma=[{id:"fundraise",name:"Fundraise",desc:"Raise royal treasury funds proportional to your seat count. Each use yields less money and costs more momentum.",cost:"MOMENTUM",costColor:"#c84",moneyCost:0,tags:["FINANCIAL","CAMPAIGN"],locked:!1},{id:"grant_seats",name:"Grant Seats",desc:"Grant parliamentary seats to a noble house. Sharing power increases legitimacy (+0.5 per seat). Hoarding >70% of seats causes tyranny decay.",cost:"FREE",costColor:"#5cc55c",moneyCost:0,tags:["ROYAL","STRUCTURAL"],locked:!1},{id:"revoke_seats",name:"Revoke Seats",desc:"Revoke seats from a noble house. Costs $100k and -1 Legitimacy per seat revoked. Use sparingly — the people do not forget.",cost:"$100k/seat",costColor:"#d44a4a",moneyCost:1e5,tags:["ROYAL","OFFENSIVE"],locked:!1},{id:"statement",name:"Royal Decree",desc:"Issue a public declaration on an issue. Shifts positioning and voter bloc reactions. Media covers it.",cost:"$20k",costColor:"#c8a832",moneyCost:2e4,tags:["PUBLIC","NARRATIVE"],locked:!1},{id:"appoint_pm",name:"Appoint Prime Minister",desc:"Choose a party to lead the government as Prime Minister. The PM can then assign cabinet ministries. You may appoint your own party.",cost:"FREE",costColor:"#5cc55c",moneyCost:0,tags:["ROYAL","STRUCTURAL"],locked:!1}],Dt={PUBLIC:"#8b9a6b",NARRATIVE:"#5a8aaa",STRATEGIC:"#c8a832",INTERNAL:"#c84",COALITION:"#5aaa8a",RISKY:"#c55",PARLIAMENTARY:"#8b9a6b",FINANCIAL:"#5a8aaa",INTELLIGENCE:"#5a8aaa",DEFENSIVE:"#5cc55c",CAMPAIGN:"#c84",VOTER:"#c8a832",OFFENSIVE:"#c84",REACTIVE:"#ca5",STRUCTURAL:"#9e9a92",ROYAL:"#c8a832",LEGAL:"#5a8aaa"},$e=[{id:"economy",label:"Economy & Jobs",icon:"💰"},{id:"healthcare",label:"Healthcare",icon:"🏥"},{id:"education",label:"Education",icon:"🎓"},{id:"security",label:"National Security",icon:"🛡️"},{id:"environment",label:"Environment",icon:"🌱"},{id:"corruption",label:"Anti-Corruption",icon:"🔍"},{id:"infrastructure",label:"Infrastructure",icon:"🏗️"},{id:"immigration",label:"Immigration",icon:"🌐"},{id:"housing",label:"Housing & Cost of Living",icon:"🏠"},{id:"crime",label:"Crime & Justice",icon:"⚖️"},{id:"labor",label:"Labor & Workers",icon:"🔨"},{id:"foreign_policy",label:"Foreign Policy",icon:"🕊️"}],we=["{party_name} Calls for Action on {topic}","{leader_name}: '{topic}' Must Be National Priority","{leader_name} Pledges Bold Agenda on {topic}","{party_name} Leader Addresses Nation on {topic}"];async function De(e,t){$=e,y=t;const a=document.getElementById("pa-actions-root");if(!a)return;const i=t.faction;if(!i){a.innerHTML='<div style="display:flex;align-items:center;justify-content:center;min-height:300px;color:var(--text-dim);">No faction data.</div>';return}try{const{data:s}=await $.from("factions").select("momentum, party_funds, seats, action_points, bloc_id").eq("id",i.id).single();s&&(i.momentum=s.momentum??i.momentum,i.party_funds=s.party_funds??i.party_funds,i.seats=s.seats??i.seats,i.action_points=s.action_points??i.action_points,i.bloc_id=s.bloc_id??null)}catch(s){console.warn("[PartyActions] faction refresh failed, using cached state:",s)}const[n,o,r,c,d,l]=await Promise.all([$.from("faction_platforms").select("*").eq("faction_id",i.id).order("slot"),$.from("faction_platforms").select("*").eq("nation_id",t.nation?.id),ze($,i.id),Ne($,t.nation?.id,i.id),$.from("faction_electoral_standing").select("visibility, raw_appeal").eq("faction_id",i.id).eq("nation_id",t.nation?.id).maybeSingle(),pe($,t.nation?.id)]);t.nation&&(t.nation.__coalition_status=l?.status||null),n.error&&console.error("[PartyActions] Failed to load faction platforms:",n.error.message),o.error&&console.error("[PartyActions] Failed to load nation platforms:",o.error.message),et=n.data||[],zt=o.data||[],j=r,pt=c.isOpposition,F=c.administration,d.data,await Ca(),await Ia();const{data:m}=await $.from("faction_deputies").select("*").eq("faction_id",i.id).eq("status","active").maybeSingle();D=m||null,j&&(ae=await Ea($,i.id)),await Ct(i.id,t.nation?.id),H(a)}function Ge(e){return e?{isPM:!!F&&F.pm_party_id===e.id,isPresident:y?.nation?.hos_election_method==="elected"&&F?.president_party_id===e.id,isMonarchActing:K(y?.nation)&&y?.nation?.monarch_faction_id===e.id}:{isPM:!1,isPresident:!1,isMonarchActing:!1}}async function Ct(e,t){if(!e||!t){G=null,at=!1,kt=[];return}try{const{data:a,error:i}=await $.from("bloc_invitations").select("id, bloc_id, invited_by_faction_id, created_at_tick, status, bloc:bloc_id(id,name,leader_faction_id), inviter:invited_by_faction_id(id,faction_name,party_color)").eq("invited_faction_id",e).eq("status","pending").order("created_at_tick",{ascending:!1});if(i)throw i;kt=a||[];const n=y?.faction?.bloc_id||null;if(n){const{data:o,error:r}=await $.from("blocs").select("*").eq("id",n).is("dissolved_at_tick",null).maybeSingle();if(r)throw r;if(o){const{data:c}=await $.from("factions").select("id, faction_name, seats, party_color, leader_first_name, leader_last_name").eq("bloc_id",o.id).order("seats",{ascending:!1});G={...o,members:c||[]},at=o.leader_faction_id===e}else G=null,at=!1}else G=null,at=!1}catch(a){console.warn("[PartyActions] loadBlocState failed:",a?.message||a)}}function je(e){if(!G)return"";const t=at?`<span style="margin-left:6px;font-family:var(--font-mono);font-size:7px;color:${e};letter-spacing:0.08em;">LEADER</span>`:"";return`<span class="pa-bloc-tag" style="display:inline-flex;align-items:center;padding:2px 8px;background:${e}18;border:1px solid ${e}55;color:${e};font-family:var(--font-mono);font-size:9px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;">
        ...
        </div>`}).join("")}</div>`}async function ue(e){const{data:t}=await $.from("factions").select("bloc_id, momentum").eq("id",e).single();t&&(y.faction.bloc_id=t.bloc_id||null,t.momentum!=null&&(y.faction.momentum=t.momentum))}async function Sa(e,t,a){try{const i=y?.faction?.id;if(!i)throw new Error("No active faction");const n=t==="accept"?"accept_bloc_invite":"decline_bloc_invite",o=t==="accept"?"p_accepting_faction_id":"p_declining_faction_id",{data:r,error:c}=await $.rpc(n,{p_invitation_id:e,[o]:i});if(c)throw c;if(r&&r.success===!1)throw new Error(r.error||"Unknown error");await ue(i),await Ct(i,y.nation?.id),H(a)}catch(i){console.error("[PartyActions] respondToBlocInvite failed:",i),alert(t==="accept"?`Could not accept invitation: ${i.message||i}`:`Could not decline invitation: ${i.message||i}`)}}async function La(e){if(!G||qt)return;const t=G,a=at?`Leaving ${t.name} will DISSOLVE the entire bloc. All ${t.members?.length||0} members will be removed and pending invitations rescinded.

Proceed?`:`Leave the ${t.name} bloc?`;if(confirm(a)){qt=!0;try{const{data:i,error:n}=await $.rpc("leave_bloc",{p_faction_id:y.faction.id});if(n)throw n;if(i&&i.success===!1)throw new Error(i.error||"Unknown error");await ue(y.faction.id),await Ct(y.faction.id,y.nation?.id),H(e)}catch(i){console.error("[PartyActions] leave_bloc failed:",i),alert(`Could not leave bloc: ${i.message||i}`)}finally{qt=!1}}}async function Pa(e){const t=document.getElementById("pa-bloc-modal");if(!t||G)return;const a=y.faction,i=a?.color||"#c8a832";t.innerHTML=`
    ...
    `,t.classList.add("active");const n=new Set;let o=[];const r=()=>t.classList.remove("active");document.getElementById("pa-bloc-close")?.addEventListener("click",r),document.getElementById("pa-bloc-cancel")?.addEventListener("click",r),t.addEventListener("click",s=>{s.target===t&&r()});try{const s=y.nation?.id,{data:p}=await $.from("factions").select("id, faction_name, seats, party_color, leader_first_name, leader_last_name, leader_age, bloc_id").eq("nation_id",s).eq("faction_type","party").is("abandoned_at",null),f=(p||[]).filter(u=>u.id!==a.id);o=f;const v=document.getElementById("pa-bloc-party-list");if(!v)return;if(f.length===0){v.innerHTML='<div style="padding:10px;font-family:var(--font-mono);font-size:9px;color:var(--text-dim);">No other parties in this nation.</div>';return}v.innerHTML=f.map(u=>{const h=u.party_color||"#7a7a7a",b=u.leader_first_name&&u.leader_last_name?`${u.leader_first_name} ${u.leader_last_name}`:"Party Leader",x=u.bloc_id?"Already in a bloc":null;return`<label class="pa-bloc-party-row" data-party-id="${_(u.id)}" data-ineligible="${x?"1":"0"}"
            ...
            </label>`}).join(""),v.addEventListener("change",u=>{const h=u.target.closest(".pa-bloc-party-row");if(!h)return;if(h.dataset.ineligible==="1"){u.target.checked=!1;return}const b=h.dataset.partyId;u.target.checked?n.add(b):n.delete(b),m()})}catch(s){console.error("[PartyActions] Create Bloc modal fetch failed:",s);const p=document.getElementById("pa-bloc-party-list");p&&(p.innerHTML=`<div style="padding:10px;font-family:var(--font-mono);font-size:9px;color:var(--red);">Failed to load parties: ${_(s.message||String(s))}</div>`)}const c=document.getElementById("pa-bloc-name"),d=document.getElementById("pa-bloc-submit"),l=document.getElementById("pa-bloc-name-count"),m=()=>{const s=(c?.value||"").trim();l&&(l.textContent=`${s.length} / 40`),d&&(d.disabled=!(s.length>0&&n.size>0)||Mt)};c?.addEventListener("input",m),d?.addEventListener("click",async()=>{if(Mt)return;const s=(c?.value||"").trim();if(!(s.length===0||n.size===0)){Mt=!0,d.disabled=!0,d.textContent="Creating...";try{const{data:p,error:f}=await $.rpc("create_bloc",{p_leader_faction_id:a.id,p_name:s,p_invitee_faction_ids:Array.from(n)});if(f)throw f;if(p&&p.success===!1)throw new Error(p.error||"Unknown error");y.faction.party_funds=Math.max(0,(y.faction.party_funds||0)-1e5),await ue(a.id),r(),await Ct(a.id,y.nation?.id),H(e)}catch(p){console.error("[PartyActions] create_bloc failed:",p),alert(`Could not create bloc: ${p.message||p}`),d.disabled=!1,d.textContent="Create Bloc & Send Invites"}finally{Mt=!1}}})}async function Aa(e){if(!G||!at)return;const t=document.getElementById("pa-bloc-modal");if(!t)return;const a=y.faction?.color||"#c8a832";t.innerHTML=`
        ...
        </div>`,t.classList.add("active");const i=()=>t.classList.remove("active");document.getElementById("pa-blinv-close")?.addEventListener("click",i),document.getElementById("pa-blinv-cancel")?.addEventListener("click",i),t.addEventListener("click",r=>{r.target===t&&i()});const n=y.nation?.id,o=document.getElementById("pa-blinv-list");if(!(!o||!n))try{const{data:r,error:c}=await $.from("factions").select("id, faction_name, seats, party_color, bloc_id").eq("nation_id",n).eq("faction_type","party").is("abandoned_at",null).is("bloc_id",null);if(c){o.innerHTML=`<div style="padding:10px;font-family:var(--font-mono);font-size:9px;color:var(--red);">Failed to load parties: ${_(c.message)}</div>`;return}const d=(r||[]).filter(l=>l.id!==y.faction.id);if(d.length===0){o.innerHTML='<div style="padding:10px;font-family:var(--font-mono);font-size:9px;color:var(--text-dim);">No eligible parties to invite.</div>';return}o.innerHTML=d.map(l=>{const m=l.party_color||"#888";return`<div class="pa-blinv-row" data-faction-id="${_(l.id)}" style="padding:8px 10px;border:1px solid ${m}33;border-left:3px solid ${m};display:flex;justify-content:space-between;align-items:center;cursor:pointer;background:var(--bg-card);">
                <div>
        ...
        `}),document.getElementById("pa-leaders").innerHTML=Ta(r,o,t),document.getElementById("pa-actions-panel").innerHTML=Na(r,o,t),document.getElementById("pa-leaders")?.addEventListener("click",b=>{const x=b.target.closest(".pa-leader-card");if(!x||x.classList.contains("vacant"))return;const g=x.dataset.role;g&&g!==X&&(X=g,H(e))}),document.getElementById("pa-actions-panel")?.addEventListener("click",b=>{const x=b.target.closest(".pa-action-item");if(!x||x.classList.contains("locked"))return;const g=x.dataset.actionId;g==="fundraise"?ai(e):g==="grant_seats"?Wa(e):g==="revoke_seats"?Ja(e):g==="rally"?Ba(e):g==="statement"?ii(e):g==="platform"?oi(e):g==="file_lawsuit"?Va(e):g==="appoint_pm"?Ka(e):g==="modernize"?Ga(e):g==="rebrand"?ja(e):g==="no_confidence"?ei():g==="call_early_elections"?Xa():g==="resign_as_pm"?Za():g==="leave_coalition"?Qa():g==="disband_party"?ti():g==="create_bloc"?Pa(e):g==="leave_bloc"?La(e):g==="invite_to_bloc"&&Aa(e)}),document.getElementById("pa-actions-panel")?.addEventListener("click",async b=>{const x=b.target.closest(".pa-bloc-invite-btn");if(!x)return;const g=x.dataset.inviteId,w=x.dataset.decision;if(!(!g||!w)&&!Pt.has(g)){Pt.add(g);try{await Sa(g,w,e)}finally{Pt.delete(g)}}}),document.getElementById("pa-hire-agitator-btn")?.addEventListener("click",()=>Ie(e)),document.getElementById("pa-hire-agitator-panel")?.addEventListener("click",b=>{b.target.closest("#pa-hire-agitator-btn")||Ie(e)}),document.getElementById("pa-hire-deputy-btn")?.addEventListener("click",()=>Ee(e)),document.getElementById("pa-hire-deputy-panel")?.addEventListener("click",b=>{b.target.closest("#pa-hire-deputy-btn")||Ee(e)})}function Ta(e,t,a){const i=K(y.nation)&&y.nation?.monarch_faction_id===a?.id;return Fe.map(n=>{const o=n.id==="leader",r=n.id==="agitator",c=X===n.id;let d,l,m,s,p;if(o){d=!1,l=e,m=Q(a.leader_first_name,a.leader_last_name),s=Be.length;const u=K(y.nation);if(u&&y.nation?.monarch_faction_id===a.id)p={text:(y.nation?.monarch_title||"KING").toUpperCase(),color:"#c8a832"};else if(u)p={text:"NOBLE HOUSE",color:"#8b9a6b"};else{const b=F?.pm_party_id===a.id,x=y.nation?.hos_election_method==="elected"&&F?.president_party_id===a.id;b?p={text:"PRIME MINISTER",color:"#5cc55c"}:x?p={text:"PRESIDENT",color:"#5cc55c"}:pt?p={text:"OPPOSITION",color:"#c84"}:p={text:"GOVERNING",color:"#8b9a6b"}}}else r&&j?(d=!1,l=`${j.first_name} ${j.last_name}`,m=Q(j.first_name,j.last_name),s=1):r&&!j?(d=!1,l="Not Hired",m="+",s=0):n.id==="deputy"&&D?(d=!1,l=`${D.first_name} ${D.last_name}`,m=Q(D.first_name,D.last_name),s=1):n.id==="deputy"&&!D?(d=!1,l="Not Hired",m="+",s=0):n.id==="campaign"?(d=!1,l="Campaign Mgr",m="CM",s=Ue.length):(d=!0,l="Vacant",m="—",s=0);const f=n.oppositionOnly&&!pt;return`
    ...
    `}function Na(e,t,a){const i=K(y.nation),n=i&&y.nation?.monarch_faction_id===a?.id,o=Fe.find(g=>g.id===X);if(!o)return"";const r=X==="leader",c=X==="agitator",d=X==="campaign",l=X==="deputy";if(!r&&!c&&!d&&!l)return`
        ...
        `;if(c&&j)return Ua(o);if(l&&!D)return`
    ...
    `}function Oa(e){const t=Bt(e),a=t.firstNames||[],i=t.lastNames||[];if(a.length===0||i.length===0)return[];const n=5+Math.floor(Math.random()*3),o=new Set,r=[];for(let c=0;c<n;c++){let d,l,m,s=0;do d=a[Math.floor(Math.random()*a.length)],l=i[Math.floor(Math.random()*i.length)],m=d+" "+l,s++;while(o.has(m)&&s<20);o.add(m);const p=20+Math.floor(Math.random()*66),f=28+Math.floor(Math.random()*30),v=Math.max(0,p-20)/65,u=Math.round((125e3+v*525e3)/25e3)*25e3;r.push({first_name:d,last_name:l,age:f,skill:p,hire_cost:u})}return r.sort((c,d)=>d.skill-c.skill)}async function Ee(e){const t=document.getElementById("pa-deputy-modal");if(!t)return;const a=y.nation?.name,i=Oa(a);let n=null;function o(){const r=n!=null?i[n]:null,c=r?vt(r.skill):null,d=i.map((s,p)=>{const f=n===p,v=vt(s.skill);return`<div class="pa-hire-row ${f?"selected":""}" data-idx="${p}">
    ...
    `}function Ga(e){const t=document.getElementById("pa-modernize-modal");if(!t)return;const a=y.faction;let i=null,n=a.custom_logo_url||null,o=!1;function r(){const c=!!n,l=Number(a.party_funds??0)>=5e4,m=!!i&&l&&!o;t.innerHTML=`
                ...
                <div style="display:flex;">
                    ...
                    <div style="flex:1;padding:14px 20px;border-right:1px solid var(--border-main);">
                        ...
                        <div style="margin-bottom:14px;">
                            ...
                            <input class="pa-modal-input" id="rb-abbr" value="${_(x)}" maxlength="4" style="width:100px;font-size:15px;font-weight:700;letter-spacing:2px;text-transform:uppercase;text-align:center;color:${p};">
                    ...
                    <div style="width:240px;padding:14px 16px;display:flex;flex-direction:column;gap:10px;flex-shrink:0;">
                        ...
                        <div style="background:var(--bg-card);border:1px solid var(--border-main);border-left:3px solid ${p};padding:10px;">
                            <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px;">
                                ...
                                <div>
                                    ...
                                    <div style="font-family:var(--font-mono);font-size:11px;font-weight:700;color:${p};letter-spacing:1px;">${_(x||"???")}</div>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div style="display:flex;gap:3px;flex-wrap:wrap;">
                                <span style="font-family:var(--font-mono);font-size:8px;font-weight:700;padding:2px 6px;color:${p};background:${p}0a;border:1px solid ${p}25;">${_(x)}</span>
        ...
        `}t._rbCustomLogoFile=null,t._rbCustomLogoUrl=r.current,t._rbUseCustomLogo=d.current,s(),t.classList.add("active"),t.addEventListener("change",function(f){if(f.target.id==="rb-logo-file"){const v=f.target.files?.[0];if(!v)return;if(v.size>2*1024*1024){alert("Logo must be under 2MB. Selected file: "+(v.size/(1024*1024)).toFixed(1)+"MB"),f.target.value="";return}if(!["image/png","image/jpeg","image/svg+xml","image/webp"].includes(v.type)){alert("Unsupported file type. Use PNG, JPG, SVG, or WebP."),f.target.value="";return}c.current=v,r.current=null,d.current=!0,t._rbCustomLogoFile=v,t._rbCustomLogoUrl=null,t._rbUseCustomLogo=!0,s()}}),t.addEventListener("click",function p(f){if(f.target===t||f.target.closest("#rb-close")||f.target.closest("#rb-cancel")){t.classList.remove("active"),t.removeEventListener("click",p);return}const v=f.target.closest(".rb-color-swatch");if(v){n.current=v.dataset.hex,s();return}const u=f.target.closest(".rb-logo-item");if(u){o.current=parseInt(u.dataset.idx)||0,d.current=!1,t._rbUseCustomLogo=!1,s();return}if(f.target.closest("#rb-remove-logo")){r.current=null,c.current=null,d.current=!1,t._rbCustomLogoFile=null,t._rbCustomLogoUrl=null,t._rbUseCustomLogo=!1,s();return}if(f.target.closest("#rb-submit")){const h=document.getElementById("rb-name")?.value?.trim()||"",b=document.getElementById("rb-abbr")?.value?.trim()||"";if(h.length<3||b.length<2){alert("Name must be 3+ chars, abbreviation 2-4 chars.");return}l.current=!0,s();return}if(f.target.closest("#rb-back")){l.current=!1,s();return}if(f.target.closest("#rb-confirm")){qa(t,e,p);return}})}async function qa(e,t,a){const i=y.faction,n=document.getElementById("rb-name")?.value?.trim()||"",o=document.getElementById("rb-abbr")?.value?.trim()||"";document.getElementById("rb-desc")?.value?.trim();const r=document.querySelector(".rb-color-swatch.selected")?.dataset?.hex||i.party_color,c=document.querySelector(".rb-logo-item.selected")?.dataset?.idx,d=c!=null?oe[parseInt(c)]?.emoji:null,l=e._rbCustomLogoFile,m=e._rbUseCustomLogo,s=e._rbCustomLogoUrl,p=document.getElementById("rb-confirm");p&&(p.disabled=!0,p.textContent="Rebranding...");try{const f=y.shard?.current_tick||0;let v=s;if(m&&l){const g=l.name.split(".").pop()?.toLowerCase()||"png",w=`${i.id}/logo_${Date.now()}.${g}`,{data:L,error:S}=await $.storage.from("party-logos").upload(w,l,{cacheControl:"3600",upsert:!0,contentType:l.type});if(S){console.error("[Rebrand] Logo upload failed:",S.message),alert("Logo upload failed: "+S.message);return}const{data:C}=$.storage.from("party-logos").getPublicUrl(w);v=C?.publicUrl||null}else m||(v=null);const u=15e4,h=i.party_funds||0;if(h<u){alert(`Not enough funds. You have $${Math.round(h/1e3)}k, need $150k.`);return}const b=h-u,x=Math.max(1,(i.momentum||0)-10);await $.from("factions").update({party_funds:b,momentum:x,faction_name:n,abbreviation:o.toUpperCase(),party_color:r,party_logo:m?null:d,custom_logo_url:v,rebrand_cooldown_until_tick:f+120}).eq("id",i.id),await $.from("campaign_actions").insert({party_id:i.id,nation_id:y.nation?.id,action_type:"rebrand",ap_cost:3,money_cost:0,tick_performed:f,result:{oldName:i.faction_name,newName:n,oldAbbr:i.abbreviation,newAbbr:o,oldColor:i.party_color,newColor:r}}),i.party_funds=b,i.momentum=x,i.faction_name=n,i.abbreviation=o.toUpperCase(),i.party_color=r,i.party_logo=m?null:d,i.custom_logo_url=v,e.classList.remove("active"),e.removeEventListener("click",a),H(t)}catch(f){console.error("[PartyActions] Rebrand error:",f),alert("Failed to rebrand: "+(f.message||f))}finally{p&&(p.disabled=!1,p.textContent="⚠ Confirm Rebrand")}}const Ha=[{id:"file_lawsuit",name:"File Lawsuit",desc:"Sue a government ministry alleging corruption or negligence. 8-tick timeline with milestone events. Outcome depends on actual corruption growth since government took office.",cost:"$250k",costColor:"#c8a832",moneyCost:25e4,tags:["LEGAL","OFFENSIVE"],locked:!1}];function Ua(e){const t=j,a=Q(t.first_name,t.last_name),i=vt(t.skill),n=pt?'<span style="color:#5cc55c;margin-left:6px;">✓ IN OPPOSITION</span>':'<span style="color:#c84;margin-left:6px;">⚠ IN GOVERNMENT (actions limited)</span>',o=Ha.map(r=>{const c=r.tags.map(d=>`<span class="pa-action-tag" style="color:${Dt[d]||"var(--text-dim)"};">${d}</span>`).join("");return`
    ...
    `}function Ya(){if(ae.length===0)return"";const e=y.shard?.current_tick||0;return`
        <div class="pa-ls-section">
            ...
            ${ae.map(a=>{const i=Nt.find(b=>b.key===a.target_ministry),n=i?i.label:a.target_ministry,o=i?i.icon:"⚖️",r=ve(a.corruption_growth||0),c=nt[a.tier]||nt[1],d=a.status==="active",l=Math.max(0,e-a.filed_at_tick),m=8,s=Math.min(1,l/m),p=Math.max(0,a.resolves_at_tick-e),f=[{tick:0,label:"Filed",type:"filing"},{tick:2,label:"Discovery",type:"discovery"},{tick:5,label:"Evidence",type:"evidence"},{tick:7,label:"Pre-trial",type:"pre_trial"},{tick:8,label:"Verdict",type:"resolution"}],v=f.map(b=>{const x=a.filed_at_tick+b.tick,g=e>=x,w=e>=x&&(b.tick===8||e<a.filed_at_tick+f[f.indexOf(b)+1]?.tick),L=b.tick/m*100;return`<div class="pa-ls-milestone ${g?"passed":""} ${w?"current":""}" style="left:${L}%;" title="${b.label} (Tick ${x})">
                <div class="pa-ls-milestone-dot"></div>
                <div class="pa-ls-milestone-label">${b.label}</div>
            </div>`}).join("");let u="";if(!d){const b=c===nt[1]?"FRIVOLOUS":c===nt[2]?"PARTIAL WIN":c===nt[3]?"MAJOR WIN":"DEVASTATING",x=a.tier===1?"var(--red)":a.tier===2?"#ca5":a.tier===3?"#c84":"var(--green)";u=`<span class="pa-ls-tier-badge" style="color:${x};border-color:${x}44;background:${x}0a;">${b}</span>`}const h=d?"":`
    ...
    `}let Ut=!1;async function Ie(e){const t=document.getElementById("pa-hire-modal");if(!t)return;const a=y.nation?.id,i=y.nation?.name;if(!a||!i)return;t.innerHTML='<div class="pa-modal"><div style="padding:40px;text-align:center;color:var(--text-dim);font-family:var(--font-mono);font-size:10px;">Searching for candidates...</div></div>',t.classList.add("active");const n=await $a($,a,i);let o=null;function r(){const c=o!=null?n[o]:null,d=c?vt(c.skill):null,l=n.map((p,f)=>{const v=o===f,u=vt(p.skill);return`<div class="pa-hire-row ${v?"selected":""}" data-idx="${f}">
        ...
        `;const s=()=>t.classList.remove("active");document.getElementById("pa-hire-close")?.addEventListener("click",s),t.onclick=p=>{p.target===t&&s()},document.getElementById("pa-hire-list")?.addEventListener("click",p=>{const f=p.target.closest(".pa-hire-row");f&&(o=parseInt(f.dataset.idx,10),r())}),document.getElementById("pa-hire-confirm")?.addEventListener("click",async()=>{if(Ut||o==null)return;Ut=!0;const p=document.getElementById("pa-hire-confirm");p&&(p.disabled=!0,p.textContent="Hiring...");try{const f=y.shard?.current_tick||0,v=n[o],u=v.hire_cost||0,h=y.faction?.party_funds||0;if(u>0&&h<u){alert(`Not enough funds. You have $${Math.round(h/1e3)}k, need $${Math.round(u/1e3)}k.`);return}if(u>0){const x=h-u,{error:g}=await $.from("factions").update({party_funds:x}).eq("id",y.faction.id);if(g){alert("Failed to deduct funds.");return}y.faction.party_funds=x}const b=await wa($,y.faction?.id,v,f);if(!b.success){alert(b.error||"Failed to hire agitator.");return}j=b.agitator,X="agitator",s(),H(e)}catch(f){console.error("[PartyActions] Hire agitator error:",f)}finally{Ut=!1,p&&(p.disabled=!1)}})}r()}let St=!1;function Va(e){const t=document.getElementById("pa-lawsuit-modal");if(!t)return;if(!F){alert("No active government to file against.");return}const a=y.faction,i=j;let n=null,o=null;function r(){const c=n&&o,d=Nt.map(s=>{const p=n===s.key;return`<div class="pa-lawsuit-target ${p?"selected":""}" data-target="${s.key}">
        ...
        `;const m=()=>t.classList.remove("active");document.getElementById("pa-lawsuit-close")?.addEventListener("click",m),document.getElementById("pa-lawsuit-cancel")?.addEventListener("click",m),t.onclick=s=>{s.target===t&&m()},document.getElementById("pa-lawsuit-targets")?.addEventListener("click",s=>{const p=s.target.closest(".pa-lawsuit-target");p&&(n=p.dataset.target,r())}),document.getElementById("pa-lawsuit-bases")?.addEventListener("click",s=>{const p=s.target.closest(".pa-lawsuit-basis");p&&(o=p.dataset.basis,r())}),document.getElementById("pa-lawsuit-submit")?.addEventListener("click",async()=>{if(St||!n||!o)return;St=!0;const s=document.getElementById("pa-lawsuit-submit");s&&(s.disabled=!0,s.textContent="Filing...");try{const{data:f}=await $.from("factions").select("party_funds").eq("id",a.id).single(),v=f?.party_funds||0;if(v<25e4){alert(`Not enough funds. You have $${Math.round(v/1e3)}k, need $250k.`),St=!1,s&&(s.disabled=!1,s.textContent="File Lawsuit");return}const u=v-25e4;await $.from("factions").update({party_funds:u}).eq("id",a.id),a.party_funds=u,sessionStorage.removeItem("nationhood_state");const h=y.shard?.current_tick||0,b=await ka($,{factionId:a?.id,nationId:y.nation?.id,agitatorId:i?.id,targetMinistry:n,basis:o,currentTick:h,partyName:a?.faction_name||"Opposition",administration:F});if(!b.success){alert(b.error||"Failed to file lawsuit.");return}const x=ve(b.lawsuit?.corruption_growth||0),g=nt[b.tier]||nt[1];m(),alert(`Lawsuit filed against ${Nt.find(w=>w.key===n)?.label||n}.
The case is now under investigation. Results will be determined when it resolves in 8 ticks.`),H(e)}catch(p){console.error("[PartyActions] File lawsuit error:",p),alert("An error occurred. Please try again.")}finally{St=!1,s&&(s.disabled=!1,s.textContent="File Lawsuit")}})}t.classList.add("active"),r()}async function Ka(e){const t=document.getElementById("pa-appoint-pm-modal");if(!t)return;const a=y.nation;y.faction;const{data:i}=await $.from("factions").select("id, faction_name, abbreviation, party_color, seats, leader_first_name, leader_last_name, leader_age").eq("nation_id",a.id).eq("faction_type","party").is("abandoned_at",null).order("seats",{ascending:!1}),n=i||[];let o=null,r=!1;const{data:c}=await $.from("head_of_government").select("faction_id, first_name, last_name, factions(faction_name)").eq("nation_id",a.id).eq("active",!0).maybeSingle();function d(){const l=n.find(v=>v.id===o),m=c?`${c.first_name} ${c.last_name}`:null,s=c?.factions?.faction_name||null,p=c&&o===c.faction_id;t.innerHTML=`
            <div class="pa-modal" style="width:500px;">
                ...
                <div class="pa-modal-body" style="max-height:300px;overflow-y:auto;">
                    ...
                    <div style="display:flex;flex-direction:column;gap:4px;">
                        ${n.map(v=>{const u=v.id===o,h=c&&v.id===c.faction_id,b=v.leader_first_name&&v.leader_last_name?`${v.leader_first_name} ${v.leader_last_name}`:"?";return`<div class="pa-action-item ${u?"selected":""}" data-party-id="${v.id}" style="cursor:pointer;${u?`border-color:${v.party_color||"#888"};background:${v.party_color||"#888"}08;`:""}">
        ...
        `;const f=()=>t.classList.remove("active");document.getElementById("apm-close")?.addEventListener("click",f),document.getElementById("apm-cancel")?.addEventListener("click",f),t.onclick=v=>{v.target===t&&f()},t.querySelector(".pa-modal-body")?.addEventListener("click",v=>{const u=v.target.closest("[data-party-id]");u&&(o=u.dataset.partyId,d())}),document.getElementById("apm-confirm")?.addEventListener("click",async()=>{if(!o||r)return;const v=n.find(h=>h.id===o);if(!v||!confirm(`Appoint ${v.leader_first_name} ${v.leader_last_name} of ${v.faction_name} as Prime Minister?`))return;r=!0;const u=document.getElementById("apm-confirm");u&&(u.disabled=!0,u.textContent="Appointing...");try{const h=y.shard?.current_tick||0;await na($,{nationId:a.id,factionId:o,firstName:v.leader_first_name||"Unknown",lastName:v.leader_last_name||"Unknown",age:v.leader_age||50,currentTick:h});let b=0;const x=a.monarch_faction_id,g=c?.faction_id||null,w=g&&g!==x&&g!==o,L=o!==x&&o!==g;if(w&&(b-=4),L&&(b+=3),b!==0){const C=Number(a.legitimacy??50),k=Math.max(0,Math.min(100,C+b));try{await $.from("nations").update({legitimacy:k}).eq("id",a.id),a.legitimacy=k}catch{}}try{await $.from("event_log").insert({nation_id:a.id,event_name:`${a.monarch_title||"King"} appoints Prime Minister`,category:"government",description_chosen:`${a.monarch_title||"The King"} has appointed ${v.leader_first_name} ${v.leader_last_name} of ${v.faction_name} as Prime Minister.`,fired_at_tick:h})}catch{}f();const S=b>0?`

Legitimacy +${b}.`:b<0?`

Legitimacy ${b}.`:"";alert(`${v.leader_first_name} ${v.leader_last_name} of ${v.faction_name} has been appointed Prime Minister.${S}`),H(e)}catch(h){alert("Failed to appoint PM: "+(h.message||"Error")),r=!1,u&&(u.disabled=!1,u.textContent=`Appoint ${_(v.faction_name)}`)}})}t.classList.add("active"),d()}async function Wa(e){const t=document.getElementById("pa-royal-modal");if(!t)return;const a=y.nation,i=y.faction,n=i.seats||0,o=a?.total_seats||100,{data:r}=await $.from("factions").select("id, faction_name, abbreviation, party_color, seats").eq("nation_id",a.id).eq("faction_type","party").is("abandoned_at",null).order("faction_name"),c=(r||[]).filter(p=>p.id!==i.id);let d=null;const l=Math.max(0,n-1);let m=Math.min(5,l||1);function s(){const p=c.find(v=>v.id===d);t.innerHTML=`
            <div class="pa-modal" style="width:560px;">
                ...
                <div class="pa-modal-body">
                    ...
                    <div style="display:flex;flex-direction:column;gap:4px;">
                        ${c.length>0?c.map(v=>{const u=v.id===d;return`<div class="pa-action-item ${u?"selected":""}" data-faction-id="${v.id}" style="cursor:pointer;${u?`border-color:${v.party_color||"#888"};background:${v.party_color||"#888"}08;`:""}">
                                <div style="display:flex;justify-content:space-between;align-items:center;">
                                    <div style="display:flex;align-items:center;gap:8px;">
                                        <div style="width:8px;height:8px;background:${v.party_color||"#888"};"></div>
...
Proceed?`)){Jt=!0;try{const f=await da($,{faction:e,nation:t,pmFactionId:n,pmLastName:o,isSemiPres:a,tick:d,mySeats:r});if(!f.ok){alert("Failed to file motion: "+f.error);return}alert(`⚡ "${f.motionName}" has been filed!

Voting is now open for ${lt.NO_CONFIDENCE_VOTING_TICKS} ticks.`),window.location.href=`bill.html?id=${f.billId}`}catch(f){console.error("[PartyActions] No confidence file failed:",f),alert("Failed to file motion: "+(f?.message||"unknown error"))}finally{Jt=!1}}}let Xt=!1;async function ai(e){if(Xt)return;const t=y.faction,a=t.seats||0,i=Math.max(1,t.momentum??0);if(a<=0){alert("Your party has no seats — nothing to fundraise from.");return}const n=Oe(a,mt);if(i-n.momCost<1){alert(`Not enough momentum. You need ${n.momCost} momentum (current: ${Math.round(i)}, floor: 1). Try again next tick when momentum recovers.`);return}Xt=!0;try{const{data:o}=await $.from("factions").select("party_funds, momentum").eq("id",t.id).single();o&&(t.party_funds=o.party_funds??0,t.momentum=o.momentum??0);const r=Math.max(1,t.momentum??0),c=y.shard?.current_tick||0,d=Math.max(1,r-n.momCost),l=(t.party_funds||0)+n.raised,{error:m}=await $.from("factions").update({momentum:d,party_funds:l}).eq("id",t.id);if(m){alert("Fundraise failed: "+m.message);return}await $.from("campaign_actions").insert({party_id:t.id,nation_id:y.nation?.id,action_type:"fundraise",ap_cost:0,money_cost:0,tick_performed:c,result:{momentumDelta:-n.momCost,raised:n.raised,perSeat:n.perSeat,momCost:n.momCost,useNumber:mt+1,seats:a}}),t.momentum=d,t.party_funds=l,sessionStorage.removeItem("nationhood_state"),mt++,H(e)}catch(o){console.error("[PartyActions] Fundraise error:",o),alert("Fundraise failed.")}finally{Xt=!1}}function ii(e){const t=document.getElementById("pa-statement-modal");if(!t)return;const a=y.faction,i=a?.color||"#c8a832",n=a?.leader_first_name&&a?.leader_last_name?`${a.leader_first_name} ${a.leader_last_name}`:"Party Leader",o=$e.map(m=>`<div class="pa-topic-card" data-topic="${m.id}" style="padding:8px 10px;cursor:pointer;border:1px solid var(--border-mid);display:flex;align-items:center;gap:8px;transition:all 0.12s;">
    ...
    `,t.classList.add("active");let r=null,c=!1;const d=()=>t.classList.remove("active");document.getElementById("pa-stmt-close")?.addEventListener("click",d),document.getElementById("pa-stmt-cancel")?.addEventListener("click",d),t.addEventListener("click",m=>{m.target===t&&d()}),document.getElementById("pa-stmt-topics")?.addEventListener("click",m=>{const s=m.target.closest(".pa-topic-card");s&&(r=s.dataset.topic,document.querySelectorAll(".pa-topic-card").forEach(p=>{const f=p.dataset.topic===r;p.style.borderColor=f?i:"var(--border-mid)",p.style.background=f?i+"0a":"";const v=p.querySelector("span:last-child");v&&(v.style.color=f?"var(--text-bright)":"var(--text-secondary)")}),l())});const l=()=>{const m=document.getElementById("pa-stmt-body")?.value?.trim()||"",s=document.getElementById("pa-stmt-submit"),p=document.getElementById("pa-stmt-charcount");p&&(p.textContent=`${m.length} characters`),s&&(s.disabled=!(r&&m.length>=10))};document.getElementById("pa-stmt-body")?.addEventListener("input",l),document.getElementById("pa-stmt-submit")?.addEventListener("click",async()=>{if(c)return;const m=document.getElementById("pa-stmt-body")?.value?.trim();if(!r||!m||m.length<10)return;c=!0;const s=document.getElementById("pa-stmt-submit");s&&(s.disabled=!0,s.textContent="Issuing...");try{const p=y.shard?.current_tick||0,v=$e.find(z=>z.id===r)?.label||r,u=2e4,{data:h}=await $.from("factions").select("party_funds").eq("id",a.id).single(),b=h?.party_funds||0;if(b<u){alert(`Not enough funds. You have $${Math.round(b/1e3)}k, need $20k.`);return}const x=b-u,{error:g}=await $.from("factions").update({party_funds:x}).eq("id",a.id);if(g){alert("Failed to deduct funds: "+g.message);return}a.party_funds=x;const L=we[Math.floor(Math.random()*we.length)].replace("{party_name}",a.faction_name||"Unknown Party").replace("{leader_name}",n).replace("{topic}",v),{error:S}=await $.from("campaign_actions").insert({party_id:a.id,nation_id:y.nation?.id,action_type:"issue_statement",ap_cost:1,money_cost:0,tick_performed:p,result:{topic:r,topicLabel:v,headline:L,body:m,leaderName:n}});S&&console.error("[PartyActions] Statement log failed:",S.message);const{error:C}=await $.from("valdorian_articles").insert({nation_id:y.nation?.id,event_type:"issue_statement",tier:3,section:"politics",headline:L,subheadline:v,lede:m.substring(0,200)+(m.length>200?"...":""),body_paragraphs:JSON.stringify(m.split(/\n\n+/).filter(z=>z.trim())),quotes:JSON.stringify([{posture:"assertive",text:m.substring(0,150)}]),byline_reporter:"Political Desk",topic_tags:JSON.stringify([r]),source_event_id:"statement_"+Date.now(),tick:p});C&&console.error("[PartyActions] Article creation failed:",C.message);const{error:k}=await $.from("event_log").insert({nation_id:y.nation?.id,event_name:L,category:"political",description_chosen:`${a.faction_name} issues the following statement regarding ${v}: "${m}"`,fired_at_tick:p});k&&console.warn("[Statement] event_log insert failed:",k.message);const{error:I}=await $.from("admin_timeline_events").insert({nation_id:y.nation?.id,tick:p,type:"communications",title:"Statement Issued",description:`${n} issued a public statement on ${v}: "${m.substring(0,120)}${m.length>120?"...":""}"`});I&&console.warn("[Statement] timeline insert failed:",I.message),d(),H(e)}catch(p){console.error("[PartyActions] Statement error:",p),alert("Failed to issue statement. Please try again.")}finally{c=!1,s&&(s.disabled=!1,s.textContent="Issue Statement")}})}const Ft=20;function oi(e){const t=document.getElementById("pa-platform-modal");if(!t)return;const a=y.faction;y.nation;const i=a?.color||"#c8a832";let n=null,o=!1;const r={};for(const l of zt)l.faction_id!==a?.id&&(r[l.platform_key]=(r[l.platform_key]||0)+1);const c=new Set(et.map(l=>l.platform_key));function d(){const l=xt.find(f=>f.id===n),m=l?xe(r[l.id]||0):null;l&&zt.filter(f=>f.platform_key===l.id&&f.faction_id!==a?.id);const s=xt.map(f=>{const v=n===f.id,u=c.has(f.id),h=xe(r[f.id]||0),b=r[f.id]||0;return`<div class="pa-plat-card ${v?"selected":""} ${u?"adopted":""}" data-plat="${f.id}">
            ...
            </div>`;else{const f=l.improve.map(x=>{const g=be(x,"improve");return`<span style="display:inline-flex;align-items:center;gap:3px;font-family:var(--font-mono);font-size:8px;padding:2px 6px;background:rgba(92,204,92,0.05);border:1px solid rgba(92,204,92,0.15);color:${g.color};white-space:nowrap;">${g.arrow} ${ye[x]||x}</span>`}).join(""),v=l.worsen.map(x=>{const g=be(x,"worsen");return`<span style="display:inline-flex;align-items:center;gap:3px;font-family:var(--font-mono);font-size:8px;padding:2px 6px;background:rgba(204,85,85,0.05);border:1px solid rgba(204,85,85,0.15);color:${g.color};white-space:nowrap;">${g.arrow} ${ye[x]||x}</span>`}).join(""),u=c.has(l.id),h=et.length;let b;u?b=`<div style="font-family:var(--font-mono);font-size:10px;font-weight:700;color:${i};display:flex;align-items:center;gap:6px;">✓ CURRENT PLATFORM</div>`:h>=3?b='<div style="font-family:var(--font-mono);font-size:9px;color:var(--red);">All 3 platform slots are full.</div>':o?b=`<div style="display:flex;align-items:center;gap:8px;">
        ...
        `,document.getElementById("pa-plat-close")?.addEventListener("click",()=>t.classList.remove("active")),t.onclick=f=>{f.target===t&&t.classList.remove("active")},document.getElementById("pa-plat-grid")?.addEventListener("click",f=>{const v=f.target.closest(".pa-plat-card");v&&(n=v.dataset.plat,o=!1,d())}),document.getElementById("pa-plat-adopt")?.addEventListener("click",()=>{o=!0,d()}),document.getElementById("pa-plat-conf-cancel")?.addEventListener("click",()=>{o=!1,d()}),document.getElementById("pa-plat-conf-yes")?.addEventListener("click",()=>ni(e,n))}t.classList.add("active"),d()}let Lt=!1;async function ni(e,t){if(Lt)return;Lt=!0;const a=document.getElementById("pa-platform-modal"),i=y.faction,n=y.nation;if(!i||!n||!t){Lt=!1;return}const o=xt.find(l=>l.id===t);if(!o)return;const r={},c={},d=l=>fe.has(l);for(const l of o.improve){const m=Number(n[l]??50);r[l]=m,d(l)?c[l]=Math.max(0,m-Ft):c[l]=Math.min(100,m+Ft)}try{const l=y.shard?.current_tick||0,{data:m,error:s}=await $.rpc("adopt_platform",{p_faction_id:i.id,p_nation_id:n.id,p_platform_key:t,p_tick:l,p_baseline_stats:r,p_target_stats:c});if(s){console.error("[PartyActions] Platform adoption failed:",s.message),alert("Failed to adopt platform: "+s.message);return}if(m&&!m.success){alert(m.error||"Failed to adopt platform.");return}const p=m?.slot||et.length+1;et.push({faction_id:i.id,nation_id:n.id,platform_key:t,slot:p,adopted_at_tick:l,baseline_stats:r,target_stats:c,status:"active"}),zt.push(et[et.length-1]),i&&m?.momentum_gained&&(i.momentum=(i.momentum||0)+m.momentum_gained),i&&(i.action_points=Math.max(0,(i.action_points||0)-2)),a?.classList.remove("active"),H(e)}catch(l){console.error("[PartyActions] Platform adoption error:",l),alert("An error occurred. Please try again.")}finally{Lt=!1}}let ht=null,Ye={isGoverning:!1,statusLabel:"OPPOSITION",administration:null,governanceScore:0,governanceDeltas:[],governanceMultiplier:1,governanceDecayCycles:0,ticksInPower:0,myFaction:null,allParties:[],rivalParties:[],strongholdsByParty:{},recentActivity:[],caucuses:[],nextElection:null,nextElectionTicks:null};function V(e){if(!e)return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML}const si=[...ma,...fa];function ri(e,t,a,i){const n=i-(a||i);if(!t)return{score:0,deltas:[],decayCycles:0,multiplier:1,ticksInPower:n};let o=0,r=0;const c=[];for(const s of si){const p=va(s);if(p===0)continue;const f=Number(t[s]??0),v=Number(e[s]??0),u=v-f;if(u===0)continue;const h=u*p,b=h>0;c.push({key:s,start:f,now:v,delta:u,signed:h,dir:p,isGood:b}),o+=h,r++}let d=r>0?o/r:0;const l=Math.floor(n/24),m=d>0?Math.pow(.97,l):1;return d*=m,{score:Math.round(d*10)/10,deltas:c,decayCycles:l,multiplier:m,ticksInPower:n}}function li(e,t,a){const i={};for(const n of e)i[n.id]=pa(n.id,t,a,3);return i}async function di(e,t,a){ht=t;const i=document.getElementById(a);if(!i)return;const n=t.faction,o=t.nation,r=o?.id,c=n?.id;if(!n||!r){i.innerHTML='<div style="padding:40px;text-align:center;color:var(--text-dim);font-family:var(--font-mono);font-size:10px;">No faction data.</div>';return}i.innerHTML='<div style="padding:40px;text-align:center;color:var(--text-dim);font-family:var(--font-mono);font-size:10px;">Loading party overview...</div>';try{const d=t.shard?.current_tick||0,[l,m,s,p,f,v,u,h]=await Promise.all([Ne(e,r,c),e.from("factions").select("*").eq("nation_id",r).eq("faction_type","party"),e.from("sectors").select("id, sector_key, name, weight, base_turnout, is_active").eq("nation_id",r).eq("is_active",!0).order("display_order"),e.from("campaign_actions").select("*").eq("party_id",c).order("tick_performed",{ascending:!1}).limit(20),Promise.resolve({data:[],error:null}),e.from("elections").select("*").eq("nation_id",r).eq("status","scheduled").order("election_tick",{ascending:!0}).limit(5),e.from("ministries").select("party_id").eq("nation_id",r).eq("is_active",!0),aa(r)]);m.error&&console.error("[PartyOverview] Parties fetch error:",m.error.message),s.error&&console.error("[PartyOverview] Sectors fetch error:",s.error.message),p.error&&console.error("[PartyOverview] Activity fetch error:",p.error.message),f.error&&console.error("[PartyOverview] Caucus fetch error:",f.error.message),v.error&&console.error("[PartyOverview] Election fetch error:",v.error.message);const b=m.data||[],x=s.data||[],g=l.administration,w=new Set((u.data||[]).map(P=>P.party_id).filter(Boolean));let L=[];if(b.length>0&&x.length>0){const P=b.map(N=>N.id),{data:M,error:A}=await e.from("faction_sector_popularity").select("faction_id, sector_id, popularity").in("faction_id",P);A&&console.error("[PartyOverview] Popularity fetch error:",A.message),L=M||[]}const S=li(b,x,L);let C={score:0,deltas:[],decayCycles:0,multiplier:1,ticksInPower:0};g&&g.stats_at_start&&(C=ri(o,g.stats_at_start,g.started_at_tick,d));const k=v.data||[],I=k[0]||null,z=I?Math.max(0,I.election_tick-d):null;let E=null;I&&o&&rt(o)&&(E=k.some(M=>M.election_type==="presidential"&&M.election_tick===I.election_tick)?"General":"Midterm"),Ye={isGoverning:l.isGoverning,statusLabel:l.label,administration:g,ministryPartyIds:w,governanceScore:C.score,governanceDeltas:C.deltas.sort((P,M)=>Math.abs(M.signed)-Math.abs(P.signed)),governanceMultiplier:C.multiplier,governanceDecayCycles:C.decayCycles,ticksInPower:C.ticksInPower,myFaction:n,allParties:b,rivalParties:b.filter(P=>P.id!==c),blocMap:h,strongholdsByParty:S,recentActivity:p.data||[],caucuses:f.data||[],nextElection:I,nextElectionTicks:z,nextElectionLabel:E},Ve(i)}catch(d){console.error("[PartyOverview] Init error:",d),i.innerHTML='<div style="padding:40px;text-align:center;color:var(--red);font-family:var(--font-mono);font-size:10px;">Failed to load party overview.</div>'}}let ot=[];function Ve(e){const t=Ye,a=t.myFaction,i=ht.nation,n=a?.party_color||a?.color||"#c8a832";ht.shard?.current_tick,ot.length===0&&(ot=[a?.id,...t.rivalParties.map(m=>m.id)]),t.administration?.admin_name||t.isGoverning;const o=t.statusLabel,r=t.isGoverning?"var(--green)":"var(--orange)",c=a?.seats||0,d=i?.total_seats||100,l=a?.momentum??50;e.innerHTML=`<div class="po-page">
        ${ci(t,n,c,d,l)}
    ...
    </div>`}function pi(e,t,a,i,n){const o=t?.leader_first_name&&t?.leader_last_name?`${t.leader_first_name} ${t.leader_last_name}`:"Unknown",r=((t?.leader_first_name||"?")[0]+(t?.leader_last_name||"?")[0]).toUpperCase();t?.leader_age&&`${t.leader_age}`;const c=t?.approval_rating??0;return`<div class="po-card po-identity" style="border-left-color:${a};">
    ...
    </div>`}function mi(e){const t=e.governanceDeltas,a=e.governanceScore,i=a>=0?"var(--green)":"var(--red)",o=(e.governanceDecayCycles>0&&a>0?`Decay: ${((1-e.governanceMultiplier)*100).toFixed(1)}% (${e.governanceDecayCycles} cycles)`:"")||(t.length>0?`${t.length} modifier${t.length===1?"":"s"}`:""),r=t.map((c,d)=>{const l=c.isGood?"var(--green)":"var(--red)",m=c.delta>0?"+":"",s=c.key.replace(/_/g," ").replace(/\b\w/g,p=>p.toUpperCase());return`<div class="po-gov-row" style="${d<t.length-1?"border-bottom:1px solid rgba(200,196,184,0.03);":""}">
    ...
    </div>`}function vi(e){const t=(e.caucuses||[]).filter(n=>n.name&&n.name!=="Unnamed");if(t.length===0)return`<div class="po-card">
            <div class="po-card-header">
        ...
        ${i}
    </div>`}function ui(e,t){const i=Math.round(t*8/100*10)/10,n=Math.min(100,Math.max(0,t)),o=t>=60?"var(--green)":t>=30?"var(--orange)":"var(--red)";return`<div class="po-card">
        <div class="po-card-header">
    ...
    </div>`}function yi(e,t){const a=e.rivalParties,i=e.administration,n=ht.nation,o=i?.pm_party_id,r=n?.total_seats||100,c=a.map(d=>{const l=d.party_color||"#666",m=d.abbreviation||d.faction_name?.slice(0,3)?.toUpperCase()||"?",s=d.leader_first_name&&d.leader_last_name?`${d.leader_first_name} ${d.leader_last_name}`:"Unknown",p=d.seats||0,f=_a(d,i,e.ministryPartyIds,n);let v=f.label;const u=f.isGoverning?"var(--green)":"var(--orange)";f.isGoverning&&f.label==="GOVERNING"&&(d.id===o?v="GOVERNING — LEAD":v="GOVERNING — JUNIOR");const h=p-(t?.seats||0),b=h>0?"var(--green)":h<0?"var(--red)":"var(--text-dim)",x=e.strongholdsByParty?.[d.id]||[],g=x.length>0?`<div style="display:flex;flex-wrap:wrap;gap:4px;">${x.map(w=>`<span style="font-family:var(--font-mono);font-size:9px;padding:2px 6px;border:1px solid ${l}44;background:${l}10;color:var(--text-bright);white-space:nowrap;">${V(w.name)}</span>`).join("")}</div>`:'<div style="font-family:var(--font-mono);font-size:9px;color:var(--text-dim);">Unaligned</div>';return`<div style="padding:12px 16px;border-bottom:1px solid var(--border-main);">
        ...
        </div>`;return}await Ii();const n=O.faction,o=Ot!==null?Math.max(0,st-Ot):0,r=Math.max(0,te-o),c=Math.min(100,o/te*100),d=o*2;let l="safe";r<=1?l="critical":r<=2&&(l="warning");const m=l==="critical"?"⚠️":l==="warning"?"⏳":"🤝",s=l==="critical"?"No Government — Snap Election Imminent":l==="warning"?"Coalition Formation — Time Running Out":"Coalition Formation In Progress",p=l==="critical"?"Form a government immediately or face snap elections":l==="warning"?"Parties are negotiating — the deadline is approaching":"Parties are negotiating a coalition — propose or join one below",f=q.find(x=>x.id===n.id)?.seats||0,v=f>0,u=ft.some(x=>x.proposed_by===n.id);let h="";if(!v)h='<div class="cf-note">Your party has <strong>0 seats</strong>. You cannot propose a coalition, but you may be invited to one.</div>';else if(u)h='<div class="cf-note">You have already submitted a proposal for this election.</div>';else{const x=w=>(w||[]).map(L=>L.replace(/_/g," ")).join(", "),g=q.map(w=>{const L=w.id===n.id,S=w.seats||0,C=w.party_color||"#888",I=(ne[w.id]||[]).map(E=>xt.find(P=>P.id===E)).filter(Boolean).map(E=>`<div class="cf-platform">
    ...
    <div class="cf-page">
        ...
        ${h}
        ${b}
    </div>`,ct=[n.id],Mi(e)}const $i={prime_minister:"Prime Minister",interior:"Interior",foreign:"Foreign Affairs",defense:"Defense",finance:"Finance",education:"Education",healthcare:"Healthcare",labor:"Labor",justice:"Justice",trade:"Trade",energy:"Energy",transportation:"Transportation",security:"Security"};function wi(e){const t=["prime_minister","interior","foreign","defense","finance","education","healthcare","labor","justice","trade","energy","transportation"],a=["interior","foreign","defense","finance","education","healthcare","labor","justice","trade","energy","transportation"];return me(e)?t:rt(e)?a:t}function ki(e){const t=(e.party_ids||[]).map(l=>q.find(m=>m.id===l)).filter(Boolean),a=(e.party_ids||[]).includes(O.faction?.id);Y={...e.ministry_assignments||{}};const n=O.faction?.id,o=Y.prime_minister,r=o===n;let c=`<div style="padding:12px 16px;border-top:1px solid var(--border-main);background:var(--bg-card);">
        ...
        <div style="font-size:11px;color:var(--text-dim);margin-bottom:12px;">All coalition members can assign ministries. The party selected as Prime Minister clicks Form Government.</div>`;for(const l of ra){const m=$i[l]||l,s=l==="prime_minister",p=Y[l];a&&(c+=`<div style="display:flex;align-items:center;gap:8px;padding:6px 0;border-bottom:1px solid rgba(42,42,36,0.2);">
        ...
        </div>`;return}const a=At.faction?.id,i=At.nation?.total_seats||100,n=Math.ceil(i/2)+1,o=dt.map((r,c)=>{const d=re===r.id,l=(r.results?.votes||[]).sort((k,I)=>(I.seats||0)-(k.seats||0)),m=l.slice(0,3),s=r.results?.turnout_pct??0,p=r.results?.total_votes_cast??0,f=Ai(r.election_tick),v=se.find(k=>k.started_at_tick>=r.election_tick&&k.started_at_tick<=r.election_tick+5),u=se.find(k=>k.ended_at_tick!=null&&k.ended_at_tick>=r.election_tick-2&&k.ended_at_tick<=r.election_tick+2),h=Ti(r,u),b=rt(At.nation),x=b?"President":"PM",g=v?.prime_minister||"Unknown",w=v?.pm_party_id&&l.find(k=>k.party_id===v.pm_party_id)?.color||"#888",S=(c<dt.length-1?dt[c+1]:null)?.results?.votes||[];let C=`<div data-election-id="${r.id}" style="
                ...
                <div class="pe-row-head-right" style="display:flex;align-items:center;gap:10px;flex-shrink:0;">
        ...
        </div>`;if(d){const k=l.map(E=>`<div style="width:${E.seats/i*100}%;background:${E.color};height:100%;display:flex;align-items:center;justify-content:center;font-family:var(--font-mono);font-size:${E.seats>=8?9:6}px;font-weight:700;color:#000;">${E.seats>=5?E.seats:""}</div>`).join(""),I=l.map(E=>{const P=E.party_id===a,M=S.find(R=>R.party_id===E.party_id),A=M?E.seats-(M.seats||0):null,T=E.seats/i*100-(E.vote_percentage||0);return`<div class="pe-tbl-row" style="display:flex;align-items:center;padding:8px 0;border-bottom:1px solid rgba(200,196,184,0.03);${P?`background:${E.color}08;`:""}">
                    ...
                    <div style="padding:12px 16px;">
                        ...
                        <div style="display:flex;gap:10px;align-items:center;">
                            ...
                            <span style="font-family:var(--font-mono);font-size:10px;font-weight:700;color:${M?"#5c5":"#c84"};">${P} seats ${M?"(majority +"+(P-n)+")":"(minority, "+(n-P)+" short)"}</span>
                        </div>
                    </div>
