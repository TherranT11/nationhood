import{_ as w}from"./supabase-client-BXEzLDpS.js";import{e as u}from"./utils-C2W-HleY.js";import{i as zt}from"./messaging-5qyQ6ziq.js";import{c as Ot,a as Re,E as ye,b as $e,d as dt,e as Dt,f as Rt,h as nt}from"./equipment-DsuDdEne.js";const ct={LOW:"#c84",STD:"#ca5",HIGH:"#5c5"},X=[{key:"concrete",name:"Concrete",category:"RAW",tiers:{LOW:{requirements:[]},STD:{requirements:[{stat:"manufacturing_output",min:20}]},HIGH:{requirements:[{stat:"manufacturing_output",min:50},{stat:"higher_education",min:40}]}},priceDrivers:["manufacturing_output","inflation","fuel_prices","urbanization"]},{key:"steel",name:"Steel",category:"RAW",tiers:{LOW:{requirements:[{stat:"manufacturing_output",min:10}]},STD:{requirements:[{stat:"manufacturing_output",min:35},{stat:"rare_minerals",min:20}]},HIGH:{requirements:[{stat:"manufacturing_output",min:60},{stat:"rare_minerals",min:40},{stat:"higher_education",min:45}]}},priceDrivers:["manufacturing_output","rare_minerals","inflation","fuel_prices"]},{key:"lumber",name:"Lumber",category:"RAW",tiers:{LOW:{requirements:[{stat:"arable_land",min:10}]},STD:{requirements:[{stat:"arable_land",min:30},{stat:"physical_infrastructure",min:20}]},HIGH:{requirements:[{stat:"arable_land",min:50},{stat:"manufacturing_output",min:30}]}},priceDrivers:["arable_land","physical_infrastructure","inflation"]},{key:"aggregate",name:"Aggregate",category:"RAW",tiers:{LOW:{requirements:[]},STD:{requirements:[{stat:"rare_minerals",min:15},{stat:"physical_infrastructure",min:20}]},HIGH:{requirements:[{stat:"rare_minerals",min:35},{stat:"manufacturing_output",min:25}]}},priceDrivers:["rare_minerals","physical_infrastructure","inflation"]},{key:"em",name:"E&M Systems",category:"MANUFACTURED",tiers:{LOW:{requirements:[{stat:"manufacturing_output",min:15}]},STD:{requirements:[{stat:"manufacturing_output",min:40},{stat:"digital_infrastructure",min:25}]},HIGH:{requirements:[{stat:"manufacturing_output",min:55},{stat:"digital_infrastructure",min:50},{stat:"energy_generation",min:40}]}},priceDrivers:["manufacturing_output","digital_infrastructure","inflation","energy_generation"]},{key:"glass",name:"Glass & Facades",category:"MANUFACTURED",tiers:{LOW:{requirements:[{stat:"manufacturing_output",min:20}]},STD:{requirements:[{stat:"manufacturing_output",min:40},{stat:"standard_of_living",min:35}]},HIGH:{requirements:[{stat:"manufacturing_output",min:60},{stat:"digital_infrastructure",min:40},{stat:"higher_education",min:50}]}},priceDrivers:["manufacturing_output","standard_of_living","inflation"]},{key:"asphalt",name:"Asphalt",category:"RAW",tiers:{LOW:{requirements:[{stat:"oil_and_gas",min:10}]},STD:{requirements:[{stat:"oil_and_gas",min:30},{stat:"manufacturing_output",min:25}]},HIGH:{requirements:[{stat:"oil_and_gas",min:45},{stat:"manufacturing_output",min:40},{stat:"physical_infrastructure",min:40}]}},priceDrivers:["oil_and_gas","manufacturing_output","inflation","fuel_prices"]},{key:"heavy",name:"Heavy Machinery Parts",category:"MANUFACTURED",tiers:{LOW:{requirements:[{stat:"manufacturing_output",min:40},{stat:"rare_minerals",min:30}]},STD:{requirements:[{stat:"manufacturing_output",min:60},{stat:"rare_minerals",min:45},{stat:"higher_education",min:40}]},HIGH:{requirements:[{stat:"manufacturing_output",min:75},{stat:"rare_minerals",min:60},{stat:"higher_education",min:55},{stat:"digital_infrastructure",min:45}]}},priceDrivers:["manufacturing_output","rare_minerals","higher_education","digital_infrastructure"]}];function ne(e,t,i){const n=X.find(r=>r.key===e);if(!n)return{available:!1,failedStat:"unknown_material"};const a=n.tiers[t];if(!a)return{available:!1,failedStat:"unknown_tier"};for(const r of a.requirements){const l=Number(i?.[r.stat]??0);if(l<r.min)return{available:!1,failedStat:r.stat,failedMin:r.min,nationValue:l}}return{available:!0}}function Ye(e,t,i){const a={concrete:{LOW:200,STD:300,HIGH:500},steel:{LOW:400,STD:700,HIGH:1200},lumber:{LOW:80,STD:130,HIGH:200},aggregate:{LOW:40,STD:60,HIGH:100},em:{LOW:400,STD:700,HIGH:1200},glass:{LOW:300,STD:500,HIGH:900},asphalt:{LOW:120,STD:200,HIGH:350},heavy:{LOW:800,STD:1400,HIGH:2400}}[e]?.[t];if(!a)return 0;const r=X.find(o=>o.key===e);if(!r)return a;let l=1;for(const o of r.priceDrivers){const d=Number(i?.[o]??50);o==="inflation"||o==="fuel_prices"?l*=1+(d-50)/200:l*=1-(d-50)/250}return l=Math.max(.4,Math.min(2.5,l)),Math.round(a*l)}function pt(e,t,i){const a={concrete:{LOW:5e3,STD:3e3,HIGH:1e3},steel:{LOW:2e3,STD:1500,HIGH:500},lumber:{LOW:8e3,STD:4e3,HIGH:1500},aggregate:{LOW:15e3,STD:6e3,HIGH:2e3},em:{LOW:1e3,STD:700,HIGH:300},glass:{LOW:1500,STD:800,HIGH:300},asphalt:{LOW:4e3,STD:2e3,HIGH:800},heavy:{LOW:400,STD:200,HIGH:80}}[e]?.[t]||0,l=X.find(s=>s.key===e)?.priceDrivers?.[0],d=.3+(l?Number(i?.[l]??50):50)/50*.7;return Math.round(a*d)}const Qe=["LOW","STD","HIGH"],He={LOW:"Low",STD:"Standard",HIGH:"High"};let fe=[],m=null,b=null,B=null,de=[],ve={},W=[],O={},je=-1,P="concrete",z="STD",se=500,V=[],Ge=0,G="trucks",Q=0,K=1,ee=[],oe=null,be=[],Ue=null,_e=null,Fe="ALL",We="TIMELINE";function L(e){return Math.abs(e)>=1e6?"$"+(e/1e6).toFixed(1)+"M":Math.abs(e)>=1e3?"$"+(e/1e3).toFixed(0)+"k":"$"+e}function Ht(e){if(e>=12){const t=Math.floor(e/12),i=e%12;return i>0?t+"y "+i+"mo":t+"y"}return e+" ticks"}function U(e){return Math.abs(e)>=1e9?"$"+(e/1e9).toFixed(1)+"B":Math.abs(e)>=1e6?"$"+(e/1e6).toFixed(0)+"M":Math.abs(e)>=1e3?"$"+(e/1e3).toFixed(0)+"k":"$"+e}function he(e){return e==="civil_engineering"?"CIVIL":e==="industrial"?"INDUSTRIAL":e==="mega_project"?"MEGA":e?.toUpperCase()||"—"}function mt(e){return e==="civil_engineering"?"light":e==="industrial"?"heavy":e==="mega_project"?"mega":"light"}function jt(){_e&&clearInterval(_e),_e=setInterval(()=>{if(!Ue)return;const e=Ue-Date.now();if(e<=0){document.getElementById("tick-countdown").textContent="Tick due...",clearInterval(_e);return}const t=Math.floor(e/36e5),i=Math.floor(e%36e5/6e4),n=Math.floor(e%6e4/1e3);document.getElementById("tick-countdown").textContent=t+"h "+i+"m "+n+"s"},1e3)}function Gt(){document.body.classList.toggle("light-mode");const e=document.getElementById("theme-toggle");e.textContent=document.body.classList.contains("light-mode")?"Dark":"Light"}function Ut(e,t){e==="type"&&(Fe=t),e==="sort"&&(We=t),document.querySelectorAll(`.filter-pill[data-filter="${e}"]`).forEach(i=>{i.classList.toggle("active",i.dataset.value===t)}),ut()}function ft(e){return!(!m||e.sector==="mega_project"&&m.corp_subsector!=="Megaprojects"||e.sector==="industrial"&&!["Heavy Infrastructure","Megaprojects"].includes(m.corp_subsector))}function ut(){const e=document.getElementById("oc-list");let t=[...de];if(Fe==="GOVERNMENT"?t=t.filter(a=>a.issuer_type==="GOVERNMENT"):Fe==="PRIVATE"&&(t=t.filter(a=>a.issuer_type==="PRIVATE")),We==="TIMELINE"&&t.sort((a,r)=>(a.timeline_ticks||0)-(r.timeline_ticks||0)),We==="BUDGET"&&t.sort((a,r)=>(r.budget_ceiling||0)-(a.budget_ceiling||0)),document.getElementById("oc-count").textContent=t.length+" AVAILABLE",t.length===0){e.innerHTML=`
            ...
            </div>`;return}const i=B?.current_tick||0;let n="";for(const a of t){const r=a.issuer_type==="GOVERNMENT",l=r?"gov":"private",o=ft(a),d=o?"":" locked",s=mt(a.sector),c=he(a.sector),p=(a.timeline_ticks||0)>18?" warn":"",f=a.bidding_ends_tick?Math.max(0,a.bidding_ends_tick-i):"?";n+=`
            <div class="oc-item${d}" data-contract-id="${a.id}">
                <div class="oc-item__row1">
                    <span class="oc-item__name">${u(a.name)}</span>
                    <span class="oc-item__type-badge ${l}">${r?"GOV":"PRIVATE"}</span>
                </div>
                <div class="oc-item__row2">
                    <span class="oc-item__issuer ${l}">${u(a.issuer_name||"—")}</span>
            ...
            </div>`}e.innerHTML=n,e.querySelectorAll(".oc-item:not(.locked)").forEach(a=>{a.addEventListener("click",()=>{const r=a.dataset.contractId,l=de.find(o=>o.id===r);l&&vt(l)})})}let xe=null;function vt(e){xe=e;const t=document.getElementById("cd-overlay"),i=e.issuer_type==="GOVERNMENT",n=i?"gov":"private",a=(b?.name||m.nation||"—").toUpperCase(),r=ft(e);document.getElementById("cd-header-left").innerHTML=`
    ...
    `;const l=document.getElementById("cd-blueprint");e.blueprint_svg?(l.innerHTML=e.blueprint_svg,l.style.display=""):(l.innerHTML=li(e),l.style.display="");const o=e.permits_required||[],d=e.required_equipment||e.equipment_required||[],s=e.required_materials||e.materials_estimated||{},p={civil_engineering:"Civil Engineering",industrial:"Industrial Construction",mega_project:"Megaprojects"}[e.sector]||e.spec_category||e.sector||"—";let f="var(--teal)";e.sector==="industrial"&&(f="var(--orange)"),e.sector==="mega_project"&&(f="var(--red)");let _=L(e.budget_ceiling||e.budget||0),g=(e.timeline_ticks||e.timeline_months||0)+" Months",v="";v+=`
        <div class="cd-issue">
            ...
            </div>`),v+='<div class="cd-details">',e.project_type&&(v+=Z("Type",e.project_type)),e.project_subtype&&(v+=Z("Sub-Type",e.project_subtype)),v+=Z("Specialization",p,f),v+=Z("Total Budget",_,"var(--green)"),v+=Z("Timeline",g),v+=Z("Nation",b?.name||m.nation||"—"),e.region&&(v+=Z("Region",e.region)),v+="</div>",o.length>0&&(v+=`
            <div class="cd-items">
            ...
            </div>`),document.getElementById("cd-content").innerHTML=v;const h=o.filter(E=>E.status==="approved").length,x=o.length-h,$=d.filter(E=>E.owned).length,A=d.length-$;let y="";d.length>0&&(A===0?y+='<span class="cd-footer__badge ok">ALL EQUIPMENT MET</span>':y+=`<span class="cd-footer__badge bad">${A} EQUIPMENT MISSING</span>`),o.length>0&&(x===0?y+='<span class="cd-footer__badge ok">ALL PERMITS APPROVED</span>':y+=`<span class="cd-footer__badge warn">${x} PERMITS PENDING</span>`);const S=r,C=(m.action_points??0)>=2;document.getElementById("cd-footer").innerHTML=`
    ...
    `,t.classList.add("open"),document.body.style.overflow="hidden"}function yt(e){e&&e.target&&e.target!==document.getElementById("cd-overlay")||(document.getElementById("cd-overlay").classList.remove("open"),document.body.style.overflow="",xe=null)}const Ft=[{key:"concrete",name:"Concrete",unit:"units"},{key:"steel",name:"Steel",unit:"units"},{key:"lumber",name:"Lumber",unit:"units"},{key:"aggregate",name:"Aggregate",unit:"units"},{key:"em_systems",name:"E&M Systems",unit:"units"},{key:"glass_facades",name:"Glass & Facades",unit:"units"},{key:"asphalt",name:"Asphalt",unit:"units"},{key:"heavy_parts",name:"Heavy Machinery Parts",unit:"units"}],Wt=[{key:"work_trucks",name:"Work Trucks",tier:1},{key:"excavators",name:"Excavators",tier:1},{key:"bulldozers",name:"Bulldozers",tier:1},{key:"concrete_mixers",name:"Concrete Mixers",tier:1},{key:"tower_cranes",name:"Tower Cranes",tier:2},{key:"heavy_haulers",name:"Heavy Haulers",tier:2},{key:"pile_drivers",name:"Pile Drivers",tier:2},{key:"asphalt_plants",name:"Asphalt Plants",tier:2}],gt={LOW:.7,STANDARD:1,HIGH:1.4},_t={LOW:35,STANDARD:65,HIGH:90},Me=15;let D=null;function Vt(e){if(!e)return;const t=e.required_materials||{},i=e.required_equipment||[],n=e.required_workforce||{},a={concrete:18e4,steel:25e4,lumber:12e4,aggregate:8e4,em_systems:32e4,glass_facades:28e4,asphalt:14e4,heavy_parts:4e5},r=Ft.filter(c=>t[c.key]>0).map(c=>({...c,qty:t[c.key],basePrice:a[c.key]||2e5,grade:c.key==="aggregate"?"LOW":"STANDARD",highDisabled:!1})),l=Wt.filter(c=>i.includes(c.key)).map(c=>({...c,owned:(V||[]).some(p=>p.equipment_key===c.key&&p.quantity>0)})),o=(n.general||100)+(n.skilled||20),d=e.budget_ceiling||1e8,s=Math.round(d*.03);D={contract:e,budgetCeiling:d,materials:r,laborCount:o,laborRate:15200,estimatedTicks:e.timeline_ticks||8,equipment:l,permits:[],overhead:s,markupPct:15,competitors:[],playerRep:m?.standing||50,requiredWorkforce:n},document.getElementById("bid-title").textContent="BID ASSEMBLY",document.getElementById("bid-subtitle").textContent=(e.name||"Contract")+" — "+he(e.sector)+" — "+(e.issuer_name||"Government"),document.getElementById("bid-overlay").classList.add("open"),document.body.style.overflow="hidden",we()}function bt(e){e&&e.target!==document.getElementById("bid-overlay")||(document.getElementById("bid-overlay").classList.remove("open"),document.body.style.overflow="",D=null)}function N(e){return Math.abs(e)>=1e9?"$"+(e/1e9).toFixed(2)+"B":Math.abs(e)>=1e6?"$"+(e/1e6).toFixed(2)+"M":Math.abs(e)>=1e3?"$"+(e/1e3).toFixed(0)+"k":"$"+e.toLocaleString()}function Yt(e,t){if(!D)return;const i=D.materials[e];t==="HIGH"&&i.highDisabled||(i.grade=t,we())}function Qt(e){D&&(D.laborCount=e,we())}function Kt(e){D&&(D.markupPct=Number(e),we())}function we(){if(!D)return;const e=D;let t=0;for(const T of e.materials)T.lineCost=Math.round(T.qty*T.basePrice*gt[T.grade]),t+=T.lineCost;const i=Math.round(e.laborCount*e.laborRate*e.estimatedTicks),n=Math.round(e.equipment.filter(T=>T.owned).length*12e3*e.estimatedTicks);let a=0;const r=e.overhead,l=t+i+n+a+r,o=Math.round(l*e.markupPct/100),d=l+o,s=d>e.budgetCeiling,c=o,p=Math.round(e.materials.reduce((T,R)=>T+_t[R.grade],0)/e.materials.length),f=p>=80?"STRONG":p>=60?"PROMISING":p>=40?"UNCERTAIN":"POOR",_=p>=80?"var(--green)":p>=60?"var(--teal)":p>=40?"var(--orange)":"var(--red)",g=e.budgetCeiling>0?d/e.budgetCeiling:1,v=Math.max(0,Math.min(100,Math.round((1-g)*150))),h=v>=70?"STRONG":v>=40?"COMPETITIVE":v>=15?"WEAK":"UNLIKELY",x=v>=70?"var(--green)":v>=40?"var(--teal)":v>=15?"var(--orange)":"var(--red)",$=Math.round(l*(1-Me/100)),A=Math.round(l*(1+Me/100));let y="";y+='<div class="bid-section"><div class="bid-section__title">Materials</div>',e.materials.forEach((T,R)=>{const F=le=>{const Bt=T.grade===le,Pt=le==="HIGH"&&T.highDisabled;return`<button class="bid-grade-btn ${Bt?le==="LOW"?"active-low":le==="HIGH"?"active-high":"active":""} ${Pt?"disabled":""}" onclick="setBidGrade(${R},'${le}')">${le[0]}</button>`};y+=`<div class="bid-mat-row">
        ...
        <div class="bid-compete__bar-wrap"><div class="bid-compete__bar" style="width:${v}%;background:${x}"></div></div>
    ...
    `;let f='<div class="pm-phase__bar">';for(let h=0;h<te.length;h++){const x=h<e.phaseIdx,$=h===e.phaseIdx;f+=`<div class="pm-phase__seg">
        ...
        </button>`).join("");let g="";e.tab==="overview"?g=ai(e,t,s,d,c,l,o):e.tab==="events"?g=ni(e):e.tab==="materials"?g=si(e):e.tab==="equipment"&&(g=oi(e)),document.getElementById("pm-content").innerHTML=`<div style="padding:0">${g}</div>`;let v="";p>0&&(v+=`<span class="pm-ftr__badge" style="color:var(--red);background:var(--red-faint);border:1px solid var(--red-border)">${p} EVENT${p>1?"S":""} REQUIRES RESPONSE</span>`),v+=`<span class="pm-ftr__badge" style="color:${e.quality>=70?"var(--green)":e.quality>=50?"var(--amber)":"var(--orange)"};background:var(--bg-0);border:1px solid var(--border-0)">QUALITY: ${e.quality}/100 — ${e.qualityLabel}</span>`,document.getElementById("pm-footer").innerHTML=`
        <div class="pm-ftr__left">${v}</div>
        <button class="pm-ftr__close" onclick="closeProjectModal()">CLOSE</button>
    `}function ai(e,t,i,n,a,r,l){const o=Ae(e.awardedTick+e.totalTicks);Ae(e.awardedTick+e.totalTicks);const d=Ae(e.awardedTick),s=[{label:"Budget",value:U(e.budget),sub:`${n}% spent`,color:i},{label:"Spent",value:U(e.spent),color:"var(--red)"},{label:"Remaining",value:U(a),color:"var(--green)"},{label:"Quality",value:`${e.quality}/100`,sub:e.qualityLabel,color:e.quality>=70?"var(--green)":e.quality>=50?"var(--amber)":"var(--red)"},{label:"Workforce",value:`${e.laborCount}/${e.wfNeeded}`,sub:`Bid: ${e.laborCount}`,color:e.laborCount<e.wfNeeded?"var(--orange)":"var(--text-bright)"},{label:"Remaining",value:`${r} ticks`,sub:l?"OVERDUE":`Deadline: ${o}`,color:l?"var(--red)":"var(--text-bright)"}];let c="";c+=`<div style="padding:0 16px"><div class="pm-section">
        ...
        <div class="pm-manager">
            ...
            <span style="font-family:var(--font-mono);font-size:10px;color:var(--text-secondary)">Deadline: <span style="color:${l?"var(--red)":"var(--text-bright)"};font-weight:700">${o}</span></span>
        </div>
            ...
            </div>`;c+="</div></div>"}return c}function ni(e){if(e.events.length===0)return'<div class="pm-evt-empty">No events have occurred on this project yet.<br>Events will appear here as construction progresses.</div>';let t="";for(let i=0;i<e.events.length;i++){const n=e.events[i],a=e.expandedEvent===i,r=n.status==="ACTIVE",l=st[n.type]||st.WEATHER,o=ot[n.severity]||ot.LOW;if(t+=`<div class="pm-evt ${r?"pm-evt--active":"pm-evt--resolved"}" style="${r?`border-left-color:${l.color}`:""}">`,t+=`<div class="pm-evt__header" onclick="pmToggleEvent(${i})" style="${a?`background:${l.bg}`:""}">`,t+=`<div class="pm-evt__row1">
            <span class="pm-evt__type-badge" style="color:${l.color};background:${l.bg};border:1px solid ${l.border}">${n.type}</span>
            ...
            <div class="pm-mat__row1">
                <div class="pm-mat__left">
                    ...
                    <span class="pm-mat__grade" style="color:${r}">${i.grade}</span>
                </div>
    ...
    </div>`}function li(e){const t={bg:"#1a2a3a",line:"#3a6a8a",dim:"#2a4a5a",accent:"#5a9aba",text:"#4a8aaa"},i=e.drawing_number||e.contract_number+"-A1",n=B?.current_date||"",a=n?n.replace(/,\s*/," "):"",r=e.spec_category==="Heavy Infrastructure",l=e.spec_category==="Megaproject";let o=u(e.project_subtype||e.project_type||"STRUCTURE"),d=r?"80.0m":l?"200.0m":"60.0m",s=r?"40.0m":l?"100.0m":"20.0m";return`<svg viewBox="0 0 680 200" style="width:100%;display:block;background:${t.bg}">
        <!-- Grid -->
        ...
        <g transform="translate(470,172)">
        ...
        </div>`,t.style.display="none";return}const i=B?.current_tick||0;let n=0,a=0,r="";for(const l of W){const o=l.issuer_type==="GOVERNMENT",d=o?"gov":"private",s=Array.isArray(l.contract_bids)?l.contract_bids[0]:l.contract_bids,c=s?.bid_price||0,p=s?.estimated_cost||0,f=s?.estimated_quality||0,_=l.budget_ceiling||0,g=l.awarded_at_tick||i,v=g+(l.timeline_ticks||8),h=Math.max(0,v-i),x=Math.max(0,i-g),$=l.timeline_ticks||8,A=Math.min(100,Math.round(x/$*100)),y=i>v;mt(l.sector);const S=he(l.sector);n+=_,a+=c,r+=`<div class="ap-item" onclick="openProjectModal('${l.id}')">
            <div class="ap-item__row1">
                <div class="ap-item__info">
                    <div class="ap-item__name">${u(l.name)}</div>
                    <div style="font-family:var(--font-mono);font-size:8px;color:var(--text-dim);">${u(l.issuer_name||"—")} · ${S}</div>
                </div>
            ...
            <div class="ap-budget">
                <div class="ap-budget__header">
                    ...
                    <span class="ap-budget__values" style="color:${y?"var(--red)":"var(--teal)"}">
                        ${x}/${$} ticks ${y?'<span style="color:var(--red);font-weight:700;"> OVERDUE</span>':""}
                    </span>
                </div>
        ...
        </div>`}e.innerHTML=r,t.style.display=W.length>0?"":"none",W.length>0&&(document.getElementById("ap-total-crew").textContent=W.length,document.getElementById("ap-total-budget").textContent=U(n),document.getElementById("ap-total-spent").textContent=U(a))}async function ht(){if(!m)return;const{data:e,error:t}=await w.from("construction_contracts").select("*, contract_bids!inner(bid_price, material_grades, labor_count, estimated_cost, estimated_quality)").eq("awarded_to_faction",m.id).in("status",["awarded","in_progress"]).eq("contract_bids.faction_id",m.id).order("awarded_at_tick",{ascending:!0});t?(console.warn("Failed to load active projects:",t.message),W=[]):W=e||[],ci()}const wt=3e4;function kt(){let e=0,t=0;for(const i of X)for(const n of Qe){const a=O[i.key]?.[n];a&&(e+=a.qty,t+=a.value)}return{totalUnits:e,totalValue:t}}function Ke(){const e=document.getElementById("wh-list"),{totalUnits:t,totalValue:i}=kt();document.getElementById("wh-count").textContent=t.toLocaleString()+" UNITS",document.getElementById("wh-total-value").textContent=L(i);const n=Math.round(t/wt*100),a=document.getElementById("wh-capacity");a.textContent=n+"%",a.style.color=n>80?"var(--red)":n>50?"var(--orange)":"var(--green)";let r="";for(let l=0;l<X.length;l++){const o=X[l],d=je===l,s=O[o.key]?.LOW||{qty:0,value:0},c=O[o.key]?.STD||{qty:0,value:0},p=O[o.key]?.HIGH||{qty:0,value:0},f=s.qty+c.qty+p.qty,_=s.value+c.value+p.value,g=f===0,v=ne(o.key,"LOW",b),h=ne(o.key,"STD",b),x=ne(o.key,"HIGH",b),$=s.qty>0?"wh-dot wh-dot--low":"wh-dot wh-dot--empty",A=c.qty>0?"wh-dot wh-dot--std":"wh-dot wh-dot--empty",y=x.available?p.qty>0?"wh-dot wh-dot--high":"wh-dot wh-dot--empty":"wh-dot wh-dot--locked";if(r+='<div class="wh-row">',r+=`<div class="wh-row__collapsed${d?" expanded":""}" onclick="toggleWhRow(${l})">
            <span class="wh-row__arrow">${d?"▾":"▸"}</span>
            <span class="wh-row__name${g?" empty":""}">${u(o.name)}</span>
        ...
        </div>`,d){r+='<div class="wh-expand">',r+=`<div class="wh-expand__hdr">
            ...
            </div>`;const S=[{key:"LOW",label:"Low",data:s,avail:v,color:"var(--orange)",dotClass:"wh-dot--low"},{key:"STD",label:"Standard",data:c,avail:h,color:"var(--amber)",dotClass:"wh-dot--std"},{key:"HIGH",label:"High",data:p,avail:x,color:"var(--green)",dotClass:"wh-dot--high"}];for(const C of S){const E=!C.avail.available,I=C.data.qty>0,T=I?"$"+Math.round(C.data.value/C.data.qty):"—";r+=`<div class="wh-grade${E?" unavailable":""}">
        ...
        <div class="pr-market-grid">
            ...
            <div class="pr-market-cell">
                ...
                <div class="pr-market-cell__value" style="font-size:12px;color:${o};margin-top:2px;">${l}</div>
            </div>
        </div>
    </div>`,f+=`<div class="pr-drivers">
        <div class="pr-drivers__title">Price Drivers (${u(b?.name||"—")})</div>`;for(const x of i.priceDrivers){const $=Number(b?.[x]??50),A=$>=50?"var(--green)":$>=30?"var(--amber)":$>=15?"var(--orange)":"var(--red)",y=fi[x]||x;f+=`<div class="pr-driver-row">
        ...
        </div>`}f+="</div>";const g=(Number(m?.corp_cash_reserves)||0)>=r,v=se>a,h=ct[z];f+=`<div class="pr-order">
        ...
        <div class="pr-order__box">
            ...
            <div class="pr-order__total">
                <div>
                    ...
                    <div class="pr-order__total-value">${L(r)}</div>
                </div>
    ...
    </div>`,e.innerHTML=f}function ui(e){P=e,z="STD";for(const t of["STD","HIGH","LOW"])if(ne(e,t,b).available){z=t;break}It(),Je(),ke()}function vi(e){z=e,Je(),ke()}function yi(e){se=e,ke()}let Ne=!1;async function gi(){if(Ne||!m||!b)return;const e=Ye(P,z,b),t=pt(P,z,b),i=e*se,n=Number(m.corp_cash_reserves)||0;if(i>n){alert("Insufficient cash reserves.");return}if(se>t){alert("Exceeds available supply this tick.");return}Ne=!0;const a=document.querySelector(".pr-purchase-btn");a&&(a.disabled=!0,a.textContent="...");try{const r=n-i,{error:l}=await w.from("factions").update({corp_cash_reserves:r}).eq("id",m.id);if(l)throw l;const o=O[P]?.[z],d=(o?.qty||0)+se,s=(o?.value||0)+i,{error:c}=await w.from("corp_warehouse").upsert({faction_id:m.id,nation_id:m.nation_id,material_key:P,quality_tier:z,quantity:d,total_value:s,last_purchased_tick:B?.current_tick||null,updated_at:new Date().toISOString()},{onConflict:"faction_id,material_key,quality_tier"});if(c){const{error:p}=await w.from("factions").update({corp_cash_reserves:n}).eq("id",m.id);throw p&&console.error("Cash refund failed after warehouse error:",p.message),c}m.corp_cash_reserves=r,O[P]||(O[P]={}),O[P][z]={qty:d,value:s},Ke(),Et(),a&&(a.textContent="PURCHASED",setTimeout(()=>{a.isConnected&&(a.disabled=!1,a.textContent="PURCHASE")},1500))}catch(r){a&&(a.disabled=!1,a.textContent="PURCHASE"),alert("Purchase failed: "+(r.message||"Unknown error"))}finally{Ne=!1}}function Tt(e){const t=oe||b;if(!t)return[];const i=$e(e);if(!i)return[];const n=Dt(e,t),a=[],r=Number(t?.inflation??50),l=Number(t?.fuel_prices??50);Number(t?.manufacturing_output??50);const o=oe&&b&&oe.id!==b.id;let d=null;if(o&&(d=Rt(t,b)),n.newAvailable>0){const s=nt(e,t),c=i.basePrice,p=Math.round(c*((r-50)/200)),f=Math.round(c*((l-50)/300));let _=s;const g=[{label:"Base price",value:L(c)},p!==0?{label:`Inflation (${r})`,mod:(p>=0?"+":"")+L(Math.abs(p))}:null,f!==0?{label:`Fuel transport (${l})`,mod:(f>=0?"+":"")+L(Math.abs(f))}:null].filter(Boolean),v=s-c-p-f;if(v!==0&&!o&&g.push({label:"Demand/scarcity",mod:(v>=0?"+":"")+L(Math.abs(v))}),o&&d){const h=Math.round(s*d.tariff),x=Math.round(s*d.transport);_=s+h+x,g.push({label:`Import tariff (${Math.round(d.tariff*100)}%)`,mod:"+"+L(h)}),g.push({label:`Transport (${d.deliveryTicks} tick${d.deliveryTicks>1?"s":""})`,mod:"+"+L(x)})}a.push({seller:o?`${t.name} Buyers`:"Local Buyers",sellerType:"LOCAL",nation:t.name||"—",distance:o?d?.deliveryTicks||1:0,condition:100,price:Math.round(_),available:n.newAvailable,delivery:o?d.deliveryTicks+" tick"+(d.deliveryTicks>1?"s":""):"Immediate",deliveryTicks:o?d.deliveryTicks:0,used:!1,priceFactors:g,sourceNationId:t.id})}if(n.usedAvailable>0){const s=n.usedCondition,c=nt(e,t,{used:!0,condition:s});let p=c;const f=[{label:"Base price",value:L(i.basePrice)},{label:`Condition (${s}%)`,mod:"-"+L(Math.max(0,i.basePrice-c))}];if(o&&d){const _=Math.round(c*d.tariff),g=Math.round(c*d.transport);p=c+_+g,f.push({label:`Import tariff (${Math.round(d.tariff*100)}%)`,mod:"+"+L(_)}),f.push({label:`Transport (${d.deliveryTicks} tick${d.deliveryTicks>1?"s":""})`,mod:"+"+L(g)})}a.push({seller:o?`${t.name} Buyers`:"Local Buyers",sellerType:"LOCAL",nation:t.name||"—",distance:o?d?.deliveryTicks||1:0,condition:s,price:Math.round(p),available:n.usedAvailable,delivery:o?d.deliveryTicks+" tick"+(d.deliveryTicks>1?"s":""):"Immediate",deliveryTicks:o?d.deliveryTicks:0,used:!0,priceFactors:f,sourceNationId:t.id})}return a}function Ee(){const e=Number(m?.corp_cash_reserves)||0;document.getElementById("em-cash").textContent=L(e);const t=$e(G),i=ye[t?.tier||1],n=document.getElementById("em-tier-badge");n&&(n.textContent=i.tag,n.style.color=i.color),n.style.background=i.color+"0a",n.style.border="1px solid "+i.color+"33";const a=document.getElementById("em-nation-select");if(a&&a.options.length===0){const o=b?.name||m?.nation||"—";let d=`<option value="">${u(o)} (HQ)</option>`;for(const s of be)s.id!==b?.id&&(d+=`<option value="${s.id}">${u(s.name)}</option>`);a.innerHTML=d}const r=document.getElementById("em-import-tag"),l=oe&&b&&oe.id!==b.id;r&&(r.style.display=l?"":"none"),_i(),Xe()}function _i(){let e="";for(let t=1;t<=3;t++){const i=ye[t],n=Re(t),a=t===3?"em-selector__grid em-selector__grid--t3":"em-selector__grid em-selector__grid--t12";e+=`<div class="em-selector__row">
            <div class="em-selector__tier-label" style="color:${i.color}">${i.tag}</div>
            <div class="${a}">`;for(const r of n){const l=G===r.key,o=Tt(r.key).length>0;e+=`<span class="em-selector__btn${l?" active":""}${o?"":" no-listings"}"
                style="${l?"background:"+i.color+";border-color:"+i.color:""}"
                onclick="setEmType('${r.key}')">${u(r.name)}</span>`}e+="</div></div>"}document.getElementById("em-selector").innerHTML=`<div class="em-selector">${e}</div>`}function Xe(){const e=document.getElementById("em-content");if(ee=Tt(G),ee.length===0){e.innerHTML=`<div class="em-no-listings"><div class="em-no-listings__box">
        ...
        </div></div>`;return}Q>=ee.length&&(Q=0);let t="";for(let n=0;n<ee.length;n++){const a=ee[n],r=Q===n,l=a.sellerType==="LOCAL"?"var(--teal)":"#5a8aaa",o=dt(a.condition);t+=`<div class="em-listing${r?" selected":""}" style="${r?"border-left-color:"+l:""}" onclick="setEmListing(${n})">`,t+=`<div class="em-listing__row1">
            <div style="display:flex;align-items:center;gap:6px">
        ...
        </div>`,r&&a.priceFactors&&(t+=`<div class="em-breakdown">
            ...
            </div>`),t+="</div>"}const i=ee[Q];if(i){const n=$e(G),a=ye[n?.tier||1],r=Math.min(i.available,4),l=i.price*K,o=(Number(m?.corp_cash_reserves)||0)>=l;t+=`<div class="em-purchase"><div class="em-purchase__box">
            ...
            <div class="em-purchase__qty">
                ...
                <div class="em-purchase__qty-btns">
                    ${Array.from({length:r},(d,s)=>s+1).map(d=>`<span class="em-qty-btn${K===d?" active":""}" style="${K===d?"background:"+a.color+";border-color:"+a.color:""}" onclick="setEmQty(${d})">${d}</span>`).join("")}
                </div>
            ...
            <div class="em-purchase__total">
                <div>
                    ...
                    <div class="em-purchase__total-value">${L(l)}</div>
        ...
        </div>`;return}let l="";ie.forEach((o,d)=>{const s=Ci===d,c=o.financials||{},p=(c.payment||0)+(c.bonus||0)-(c.penalty||0)-(c.total_cost||0),f=p>=0,_=Mi(o.result),v={DISTINCTION:"var(--gold)",PASS:"var(--green)",CONDITIONAL:"var(--orange)",FAIL:"var(--red)"}[o.result]||"var(--text-dim)",h=o.type==="GOVERNMENT";if(l+=`<div class="dl-item ${s?"expanded":""}" onclick="toggleDlExpand(${d})">
            <div class="dl-item__inner" style="border-left:2px solid ${v}">
                ...
                </div>`,s){const x=o.inspection||{};l+='<div style="margin-top:8px;">',l+='<div class="dl-section-label">Inspection Report</div>',["materials","structural","systems"].forEach(S=>{const C=x[S]||{score:0,issues:[]},E=rt(C.score),I=Math.min(C.score/100*100,100);l+=`<div class="dl-inspect-row">
                ...
                </div>`}),l+="</div>",l+='<div class="dl-section-label">Financial Summary</div>',l+='<div class="dl-fin-panel">',l+=`<div class="dl-fin-row"><span class="dl-fin-key">CONTRACT VALUE</span><span class="dl-fin-val">${Y(c.contract_value||0)}</span></div>`,(c.bonus||0)>0&&(l+=`<div class="dl-fin-row"><span class="dl-fin-key">QUALITY BONUS</span><span class="dl-fin-val" style="color:var(--green)">+${Y(c.bonus)}</span></div>`),(c.penalty||0)>0&&(l+=`<div class="dl-fin-row"><span class="dl-fin-key">PENALTIES</span><span class="dl-fin-val" style="color:var(--red)">-${Y(c.penalty)}</span></div>`);const A=(c.payment||0)+(c.bonus||0)-(c.penalty||0);l+=`<div class="dl-fin-row"><span class="dl-fin-key">PAYMENT RECEIVED</span><span class="dl-fin-val" style="color:var(--green)">${Y(A)}</span></div>`,l+=`<div class="dl-fin-row"><span class="dl-fin-key">TOTAL COST</span><span class="dl-fin-val" style="color:var(--red)">-${Y(c.total_cost||0)}</span></div>`,l+=`<div class="dl-fin-total">
        ...
        </div>`;const a={};for(const o of V)a[o.equipment_key]=o;let r="";for(let o=1;o<=3;o++){const d=ye[o],s=Re(o),c=Ge===o,p=s.reduce((_,g)=>_+(a[g.key]?.owned||0),0),f=s.reduce((_,g)=>_+(a[g.key]?.deployed||0),0);if(r+=`<div class="eq-tier-hdr" onclick="toggleEqTier(${o})">
        ...
        </div>`,c)for(const _ of s){const g=a[_.key],v=g?.owned||0,h=g?.deployed||0,x=g?.condition||0,$=_.maintenancePerUnit*v,A=v-h,y=v>0&&A===0,S=v>0&&x<65,C=dt(x),E=g?.assigned_projects||[],I=E.length>0?E.map(T=>T.contract_name||"Project").join(", ").slice(0,30):v>0&&h>0?h+" project"+(h>1?"s":""):"—";r+=`<div class="eq-row${v===0?" unowned":""}">`,r+=`<div class="eq-row__top">
                        ...
                        <div class="eq-detail__cell" style="flex:1.2">
                            ...
                            <div class="eq-detail__bar">
                                <div class="eq-detail__bar-track">
                                    <div class="eq-detail__bar-fill" style="width:${x}%;background:${C}"></div>
                                </div>
                                <span class="eq-detail__bar-pct" style="color:${C}">${x}%</span>
                            </div>
                        </div>
    ...
    <div style="width:380px;height:450px;background:${i.surface};border:1px solid ${i.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
            ...
            <div style="padding:6px 14px;border-bottom:1px solid ${i.border};background:${i.card};">
                ...
                <div style="display:flex;gap:0;">
                    <div style="flex:1;padding:2px 6px;border-right:1px solid ${i.border}">
                        ...
                        <div style="font-family:${t};font-size:7px;color:${i.dim}">${M(l)}/yr</div>
                    </div>
                    <div style="flex:1;padding:2px 6px;border-right:1px solid ${i.border}">
                    ...
                    <div style="flex:1;padding:2px 6px;">
                        ...
                        <div style="font-family:${t};font-size:10px;font-weight:700;color:${i.text}">${r}/100</div>
        ...
        <div style="padding:8px 14px;border-top:1px solid ${i.border};background:${i.card};flex-shrink:0;">
            <div style="display:flex;justify-content:space-between;align-items:center;${c?"margin-bottom:6px;":""}">
                ...
                <div style="text-align:right;">
                    ...
                    <div style="display:flex;align-items:baseline;gap:4px;justify-content:flex-end;">
                        ...
                        <span style="font-family:${t};font-size:11px;font-weight:700;color:${x>0?i.red:i.greenBright}">${M(v)}</span>`:""}
                    </div>
                </div>
            </div>
            ${c?`<div style="display:flex;justify-content:space-between;align-items:center;padding-top:6px;border-top:1px solid ${i.border};">
                <div style="display:flex;align-items:center;gap:6px;">
                    ...
                    <span style="font-family:${t};font-size:11px;font-weight:700;color:${x>0?i.red:i.greenBright}">${x>0?"+":""}${M(x)}/yr</span>
                    <span style="font-family:${t};font-size:8px;color:${i.dim}">(${x>0?"+":""}${M(Math.round(x/12))}/tick)</span>
                </div>
        ...
        <div style="padding:8px 12px;border-bottom:1px solid ${i.border};">
            ...
            <div style="display:flex;justify-content:space-between;margin-top:2px;">
                <span style="font-family:${t};font-size:8px;color:${i.dim}">WAGE (MIN × ${g.mult}.0 × ${d.toFixed(2)} × ${s.toFixed(2)})</span>
            ...
            <div style="display:flex;justify-content:space-between;margin-top:1px;">
                ...
                <span style="font-family:${t};font-size:10px;font-weight:700;color:${i.text}">${M(x)}</span>
            </div>
        </div>`}e.innerHTML=`
    <div style="width:380px;height:450px;background:${i.surface};border:1px solid ${i.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        <div style="padding:8px 14px;border-bottom:1px solid ${i.border};display:flex;justify-content:space-between;align-items:center;flex-shrink:0;">
        ...
        <div style="flex:1;overflow:auto;">
            ...
            <div style="padding:8px 12px;background:${i.card};border-bottom:1px solid ${i.border};">
                ...
                <div style="display:flex;justify-content:space-between;">
                    ...
                    <span style="font-family:${t};font-size:9px;color:${i.text}">${a}/100 → ${M(o)}/yr</span>
                </div>
                <div style="display:flex;justify-content:space-between;margin-top:2px;">
    ...
    <div style="padding:8px 12px;border-bottom:1px solid ${i.border};">
        ...
        <div style="display:flex;gap:0;background:${i.card};border:1px solid ${i.border}">
            ...
            <div style="flex:1;padding:3px 6px;border-right:1px solid ${i.border}">
                ...
                <div style="font-family:${t};font-size:10px;font-weight:700;color:${i.gold}">Included</div>
            </div>
            <div style="flex:1;padding:3px 6px">
                <div style="font-family:${t};font-size:7px;color:${i.dim}">MAINT/MO</div>
                <div style="font-family:${t};font-size:10px;font-weight:700;color:${i.dim}">$0</div>
            </div>
        </div>
    </div>`;for(const s of J){const c=me[s.style]||me.Basic;l+=Number(s.purchase_price||0),o+=Number(s.monthly_maintenance||0),r+=`
        <div style="padding:8px 12px;border-bottom:1px solid ${i.border};">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:3px;">
    ...
    <div style="width:380px;height:450px;background:${i.surface};border:1px solid ${i.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        ...
        <div style="padding:8px 14px;border-top:1px solid ${i.border};background:${i.card};flex-shrink:0;">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:2px;">
                ...
                <span style="font-family:${t};font-size:13px;font-weight:700;color:${i.green}">${M(l)}</span>
            </div>
            <div style="display:flex;justify-content:space-between;align-items:center;">
                <span style="font-family:${t};font-size:8px;color:${i.dim};letter-spacing:0.8px">TOTAL MAINTENANCE</span>
                <span style="font-family:${t};font-size:13px;font-weight:700;color:${i.red}">${M(o)}/mo</span>
            </div>
        </div>
    </div>`}let ce=[],H=null;const me={Basic:{color:"#6a6660",label:"BASIC"},Modern:{color:"#8b9a6b",label:"MODERN"},Sustainable:{color:"#5c5",label:"SUSTAINABLE"},Innovative:{color:"#c8a832",label:"INNOVATIVE"},Heritage:{color:"#c84",label:"HERITAGE"},Premium:{color:"#ca5",label:"PREMIUM"}};async function tt(){if(!m?.nation_id)return;const{data:e,error:t}=await w.from("available_properties").select("*").eq("nation_id",m.nation_id).eq("status","available").order("price",{ascending:!0});if(t){console.warn("[Property] Failed to load marketplace:",t.message);return}ce=(e||[]).map(i=>({...i,adjusted_cost:i.price,adjusted_maintenance:i.monthly_maintenance}))}function Ce(){const e=document.getElementById("new-property-container");if(!e)return;const t="'JetBrains Mono', monospace",i={surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",redDim:"#a44",yellow:"#ca5",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"};(b?.name||m?.nation||"Nation").toUpperCase();const n=Number(b?.standard_of_living??50),a=Number(b?.gdp_growth??50),r=Number(b?.inflation??50),l=b?.capital||"Capital",o={capital:l,port:l+" Port",industrial:l+" Industrial Zone",suburban:l+" Suburbs",coastal:l+" Coast"};let d="";if(ce.length===0)d=`<div style="padding:20px;text-align:center;font-family:${t};font-size:10px;color:${i.dim}">No properties available in this market.<br>Improve GDP Growth and Standard of Living to unlock more.</div>`;else for(let s=0;s<ce.length;s++){const c=ce[s],p=H===s,f=me[c.style]||me.Basic,_=o[c.city_template]||l;d+=`
    ...
    <div style="width:380px;height:450px;background:${i.surface};border:1px solid ${i.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        ...
        <div style="padding:4px 14px;border-bottom:1px solid ${i.border};display:flex;gap:12px;flex-shrink:0;">
            ...
            <div style="display:flex;align-items:center;gap:4px;">
                ...
                <span style="font-family:${t};font-size:9px;font-weight:700;color:${r<=50?i.greenBright:i.red}">${Math.round(r)}</span>
            </div>
        </div>
        <div style="flex:1;overflow:auto;">
            ${d}
    ...
    <div style="width:440px;background:${t.surface};border:1px solid ${t.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;max-height:90vh;">
        ...
        <div style="padding:12px 16px;overflow:auto;flex:1;">
            ...
            <div style="margin-bottom:12px;">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:3px;">${l}</div>
            ...
            <div style="padding:6px 8px;background:rgba(139,154,107,0.04);border:1px solid rgba(139,154,107,0.12);">
                <div style="display:flex;justify-content:space-between;align-items:center;">
                    ...
                    <span style="font-family:${e};font-size:16px;font-weight:700;color:${r}">+${a}</span>
                </div>
...
This cannot be undone.`)){pe=!0;try{await w.from("corp_properties").update({is_active:!1}).eq("id",e);const l=Number(m?.corp_cash_reserves??0)+a;await w.from("factions").update({corp_cash_reserves:l}).eq("id",m.id),m.corp_cash_reserves=l;const d=(await w.from("shard").select("current_tick").eq("name","Alpha Shard").single()).data?.current_tick||0;await w.from("available_properties").insert({nation_id:m.nation_id,catalog_id:t.catalog_id||null,name:t.name,type:t.type,style:t.style,capacity:t.capacity,price:Math.round(a*1.1),monthly_maintenance:t.monthly_maintenance,condition:t.condition,city:t.city,generated_at_tick:d,expires_at_tick:d+6,status:"available"});const s=document.getElementById("topbar-cash");s&&(s.textContent="CASH: "+(l>=1e6?"$"+(l/1e6).toFixed(1)+"M":"$"+Math.round(l/1e3)+"k")),await et(),Te(),await tt(),Ce(),alert('Sold "'+t.name+'" for '+M(a))}catch(r){alert("Sale failed: "+r.message)}finally{pe=!1}}}window.propRefurbish=Vi;window.propSell=Yi;function Qi(){const e=document.getElementById("subsidiaries-container");if(!e)return;const t="'JetBrains Mono', monospace",i={surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",blue:"#5a9abf",gold:"#c8a832",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},n=J.filter(r=>r.type==="regional_hq");let a="";if(n.length===0)a=`<div style="padding:40px 20px;text-align:center;">
        ...
        </div>`;else for(const r of n){const l=me[r.style]||me.Basic,o=r.condition>=75?"#5c5":r.condition>=50?"#ca5":"#c84";a+=`
            <div style="padding:8px 12px;border-bottom:1px solid ${i.border};">
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:3px;">
                    <div>
                        <span style="font-size:12px;font-weight:700;color:${i.text}">${r.name}</span>
                ...
                <div style="font-family:${t};font-size:8px;color:${i.dim};margin-bottom:4px;">${r.city||"—"} · <span style="color:${l.color}">${(r.style||"Basic").toUpperCase()}</span></div>
                <div style="display:flex;gap:0;background:${i.card};border:1px solid ${i.border}">
                    <div style="flex:1;padding:3px 6px;border-right:1px solid ${i.border}">
                        <div style="font-family:${t};font-size:7px;color:${i.dim}">CAPACITY</div>
                        <div style="font-family:${t};font-size:10px;font-weight:700;color:${i.text}">${(r.capacity||0).toLocaleString()}</div>
                    </div>
                    <div style="flex:1;padding:3px 6px;border-right:1px solid ${i.border}">
                        <div style="font-family:${t};font-size:7px;color:${i.dim}">PAID</div>
                        <div style="font-family:${t};font-size:10px;font-weight:700;color:${i.gold}">${M(r.purchase_price||0)}</div>
                    </div>
                    <div style="flex:1;padding:3px 6px;border-right:1px solid ${i.border}">
                        <div style="font-family:${t};font-size:7px;color:${i.dim}">MAINT/MO</div>
                        <div style="font-family:${t};font-size:10px;font-weight:700;color:#c55">${M(r.monthly_maintenance||0)}</div>
                    </div>
                    <div style="flex:1;padding:3px 6px">
                        <div style="font-family:${t};font-size:7px;color:${i.dim}">CONDITION</div>
                        <div style="font-family:${t};font-size:10px;font-weight:700;color:${o}">${r.condition}%</div>
                    </div>
                </div>
            </div>`}e.innerHTML=`
