...
import{_supabase as g}from"./supabase-client-qEAQbBjE.js";/* empty css                    *//* empty css                         */import{c as Ce,i as ho,M as Je,Q as ti,a as ii,b as Ft,d as Li,e as zi}from"./corp-auto-services-PD5Wk5mY.js";import{_ as $o}from"./preload-helper-BXl3LOEh.js";import{escapeHtml as y,hfFmtBig as E}from"./utils-A98FEun4.js";import{initMessaging as wo}from"./messaging-Btjj7Mcp.js";import{c as ko,a as Ut,E as Xe,b as yt,d as Ri,e as Eo,f as To,h as Ii}from"./equipment-DsuDdEne.js";import{l as Co,a as Io}from"./corp-shipping-data-DA_tOdLs.js";import{V as rt}from"./vessels-CjafVZ4G.js";import{SECTOR_OPS_PAGE as Oi}from"./corp-topbar-CYaKZ_BF.js";import{r as Ht,c as Pi,M as Di,a as So}from"./shipping-CQiz46tZ.js";import"./loan-math-9I6GImoB.js";import"./government-structure-C17uG6rl.js";let $e=[],f=null,R=null,N=null,De=[],He={},Q=[],J={},Vt=-1;const qo={em:"em_systems",glass:"glass_facades",heavy:"heavy_parts"},lt=t=>qo[t]||t;let ne="concrete",K="STD",me=500,ie=[],Bi={},Gt=0,ji=[];async function Ao(){if(!f?.id)return;const{data:t}=await g.from("corp_properties").select("*").eq("faction_id",f.id).eq("is_active",!0);ji=t||[]}let oe=[],Fi=[],Ze=null,Ge={},dt={},oi=[],ct=null,se="trucks",ue=0,ye=1,we=[],Ie=null,Ui=[],Wt=null,nt=null,Yt="ALL",Qt="TIMELINE";function q(t){return Math.abs(t)>=1e6?"$"+(t/1e6).toFixed(1)+"M":Math.abs(t)>=1e3?"$"+(t/1e3).toFixed(0)+"k":"$"+t}function Mo(t){if(t>=12){const e=Math.floor(t/12),i=t%12;return i>0?e+"y "+i+"mo":e+"y"}return t+" ticks"}function Hi(t){return!t||t.length===0?"":t.map(e=>{const i=Bi[e];if(!i)return"";const o=i.reputation_bonus>0?"var(--green)":i.reputation_bonus<0?"var(--red)":"var(--text-dim)",a=i.reputation_bonus>0?"+"+i.reputation_bonus:i.reputation_bonus<0?String(i.reputation_bonus):"";return`<span style="display:inline-flex;align-items:center;gap:3px;padding:2px 6px;background: var(--border-hair);border:1px solid var(--border-0);border-radius:3px;font-family:var(--font-mono);font-size:7px;color:var(--text-secondary);">${i.icon||"📍"} ${y(i.name)}${a?` <span style="color:${o};font-weight:700;">${a} REP</span>`:""}</span>`}).filter(Boolean).join(" ")}function re(t){return Math.abs(t)>=1e9?"$"+(t/1e9).toFixed(1)+"B":Math.abs(t)>=1e6?"$"+(t/1e6).toFixed(0)+"M":Math.abs(t)>=1e3?"$"+(t/1e3).toFixed(0)+"k":"$"+t}function ai(t){return t==="civil_engineering"?"CIVIL":t==="industrial"?"INDUSTRIAL":t==="mega_project"?"MEGA":t?.toUpperCase()||"—"}function Vi(t){return t==="civil_engineering"?"light":t==="industrial"?"heavy":t==="mega_project"?"mega":"light"}function No(){nt&&clearInterval(nt),nt=setInterval(()=>{if(!Wt)return;const t=Wt-Date.now();if(t<=0){document.getElementById("tick-countdown").textContent="Tick due...",clearInterval(nt);return}const e=Math.floor(t/36e5),i=Math.floor(t%36e5/6e4),o=Math.floor(t%6e4/1e3);document.getElementById("tick-countdown").textContent=e+"h "+i+"m "+o+"s"},1e3)}function Lo(t,e){t==="type"&&(Yt=e),t==="sort"&&(Qt=e),document.querySelectorAll(`.filter-pill[data-filter="${t}"]`).forEach(i=>{i.classList.toggle("active",i.dataset.value===e)}),Wi()}const Si={"Civil Engineering":"civil_engineering","Industrial Construction":"industrial",Megaprojects:"mega_project"};function Gi(t){if(!f)return!1;if(Si[f.corp_subsector]===t.sector)return!0;const i=(ji||[]).filter(o=>o.type==="regional_hq"&&o.is_active&&o.nation_id===t.nation_id);for(const o of i)if(Si[o.subsector]===t.sector)return!0;return!1}function Wi(){const t=document.getElementById("oc-list");let e=[...De];if(Yt==="GOVERNMENT"?e=e.filter(a=>a.issuer_type==="GOVERNMENT"):Yt==="PRIVATE"&&(e=e.filter(a=>a.issuer_type==="PRIVATE")),Qt==="TIMELINE"&&e.sort((a,s)=>(a.timeline_ticks||0)-(s.timeline_ticks||0)),Qt==="BUDGET"&&e.sort((a,s)=>(s.budget_ceiling||0)-(a.budget_ceiling||0)),document.getElementById("oc-count").textContent=e.length+" AVAILABLE",e.length===0){t.innerHTML=`
            ...
            </div>`;return}const i=N?.current_tick||0;let o="";for(const a of e){const s=a.issuer_type==="GOVERNMENT",r=s?"gov":"private",n=Gi(a),l=n?"":" locked",c=Vi(a.sector),v=ai(a.sector),d=(a.timeline_ticks||0)>18?" warn":"",m=a.bidding_ends_tick?Math.max(0,a.bidding_ends_tick-i):"?";o+=`
    ...
    `;const r=document.getElementById("cd-blueprint");t.blueprint_svg?(r.innerHTML=t.blueprint_svg,r.style.display=""):(r.innerHTML=Jo(t),r.style.display="");const n=t.permits_required||[],l=t.required_equipment||t.equipment_required||{},c=Array.isArray(l)?l.map(w=>({key:w,qty:1})):Object.entries(l).map(([w,M])=>({key:w,qty:M})),v=t.required_materials||t.materials_estimated||{},m={civil_engineering:"Civil Engineering",industrial:"Industrial Construction",mega_project:"Megaprojects"}[t.sector]||t.spec_category||t.sector||"—";let u="var(--teal)";t.sector==="industrial"&&(u="var(--orange)"),t.sector==="mega_project"&&(u="var(--red)");let _=q(t.budget_ceiling||t.budget||0),b=(t.timeline_ticks||t.timeline_months||0)+" Months",p="";p+=`
        <div class="cd-issue">
            ...
            <div style="display:flex;flex-direction:column;gap:6px;">`;for(const w of h){const M=Bi[w];if(!M)continue;const B=M.reputation_bonus>0?"var(--green)":M.reputation_bonus<0?"var(--red)":"var(--text-dim)",H=M.cost_multiplier>1?"+"+Math.round((M.cost_multiplier-1)*100)+"% cost":M.cost_multiplier<1?Math.round((1-M.cost_multiplier)*100)+"% cheaper":"",X=M.reputation_bonus!==0?(M.reputation_bonus>0?"+":"")+M.reputation_bonus+" rep":"",pe=M.required_permits||[];p+=`<div style="padding:6px 10px;background: var(--border-hair);border:1px solid var(--border-hair);border-radius:4px;">
                <div style="display:flex;align-items:center;justify-content:space-between;">
                    <span style="font-weight:600;font-size:0.78rem;color:var(--text-primary);">${M.icon||"📍"} ${y(M.name)}</span>
                ...
                <div style="font-size:0.65rem;color:var(--text-dim);margin-top:2px;">${y(M.description||"")}</div>
                ${pe.length>0?`<div style="font-size:0.6rem;color:var(--amber);margin-top:3px;font-family:var(--font-mono);">Requires permits: ${pe.map(V=>y(V.replace(/_/g," "))).join(", ")}</div>`:""}
            </div>`}p+="</div></div>"}p+='<div class="cd-details">',t.project_type&&(p+=he("Type",t.project_type)),t.project_subtype&&(p+=he("Sub-Type",t.project_subtype)),p+=he("Specialization",m,u),p+=he("Total Budget",_,"var(--green)"),p+=he("Timeline",b),p+=he("Nation",R?.name||f.nation||"—"),t.region&&(p+=he("Region",t.region)),p+="</div>",n.length>0&&(p+=`
            <div class="cd-items">
                <div class="cd-section-label">Permits Required</div>
                <div class="cd-items__list">
                    ${n.map(w=>{const M=w.status==="approved"?"approved":"required",B=w.status==="approved"?"&#10003;":"&#9675;";return`<div class="cd-chip ${M}">
            ...
            </div>`),document.getElementById("cd-content").innerHTML=p;const x=n.filter(w=>w.status==="approved").length,k=n.length-x,I=c.length,T=[];for(const w of c){const M=ie.find(B=>B.equipment_key===w.key);M&&M.owned>=w.qty||T.push(w)}const $=T.length,C=t.required_materials||{},L=typeof C=="object"&&!Array.isArray(C)?Object.entries(C):[],A=[];for(const[w,M]of L){const B=J[w]||{},H=(B.LOW?.qty||0)+(B.STD?.qty||0)+(B.HIGH?.qty||0);H<M&&A.push({key:w,need:M,have:H})}const j=w=>w.replace(/_/g," ").replace(/\b\w/g,M=>M.toUpperCase());let P="";if(I>0)if($===0)P+='<span class="cd-footer__badge ok">ALL EQUIPMENT MET</span>';else{const w=T.map(M=>j(M.key)).join(", ");P+=`<span class="cd-footer__badge bad" title="${y(w)}">${$} SHORT: ${y(w)}</span>`}if(L.length>0)if(A.length===0)P+='<span class="cd-footer__badge ok">ALL MATERIALS MET</span>';else{const w=A.map(M=>j(M.key)+" ("+M.have+"/"+M.need+")").join(", ");P+=`<span class="cd-footer__badge bad" title="${y(w)}">${A.length} MAT SHORT: ${y(w)}</span>`}n.length>0&&(k===0?P+='<span class="cd-footer__badge ok">ALL PERMITS APPROVED</span>':P+=`<span class="cd-footer__badge warn">${k} PERMITS PENDING</span>`);const S=s,z=t.issuer_faction_id===f?.id,F=t.status==="bidding",U=He[t.id];document.getElementById("cd-footer").innerHTML=`
...
Insurance corps will see this in their Deal Flow.`);if(i===null)return;const o=i.trim()||"Construction Insurance",a=N.current_tick||0,{error:s}=await g.from("finance_loan_requests").insert({requesting_faction_id:f.id,nation_id:f.nation_id,request_type:"insurance",insured_contract_id:t,amount:e,term_months:0,purpose:o,status:"open",created_tick:a,expires_tick:a+12});if(s){s.message.includes("duplicate")||s.message.includes("unique")?alert("Insurance already requested for this project."):alert("Failed to request insurance: "+s.message);return}alert("Insurance request posted to Deal Flow. Insurance corporations can now offer coverage."),await Ki()}window.requestInsurance=Qo;window.openProjectModal=Re;window.closeProjectModal=jo;window.pmSetTab=Fo;window.pmToggleEvent=Uo;window.pmSelectResponse=Ho;window.pmAllocateMaterial=zo;window.pmDeallocateMaterial=Ro;window.pmDeployEquipment=Do;window.pmUndeployEquipment=Bo;window.pmAssignWorkers=Oo;window.pmUnassignWorkers=Po;async function Qi(t){if(!O)return;const{data:e,error:i}=await g.from("construction_events").select("*").eq("contract_id",t).order("fired_at_tick",{ascending:!1});i?(console.warn("Failed to load project events:",i.message),O.events=[]):O.events=(e||[]).map(o=>({id:o.id,type:o.type,severity:o.severity,tick:o.fired_at_tick,title:o.title,desc:o.description,impact:o.impact,status:o.status==="ACTIVE"?"ACTIVE":"RESOLVED",resolution:o.resolution,responses:o.responses||[]})),Ne()}let It=!1;async function Ko(t,e){if(!(It||!O)){It=!0;try{const{data:i,error:o}=await g.rpc("resolve_construction_event",{p_event_id:t,p_response_key:e});if(o){console.error("Failed to resolve event:",o.message),alert("Failed to submit response: "+o.message);return}const a=typeof i=="string"?JSON.parse(i):i;if(a?.error){alert("Error: "+a.error);return}await Qi(O.project.id),await Ki(),a?.quality_applied&&a.quality_applied!==0&&(O.quality=Math.max(0,Math.min(100,O.quality+a.quality_applied)),O.qualityLabel=O.quality>=75?"EXCELLENT":O.quality>=50?"FAIR":O.quality>=25?"POOR":"BAD"),Ne()}finally{It=!1}}}window.confirmEventResponse=Ko;function he(t,e,i){const o=i?` style="color:${i}"`:"";return`<div class="cd-detail-row">
        ...
        <g transform="translate(470,172)">
        ...
        </div>`,e.style.display="none";return}const i=N?.current_tick||0;let o=0,a=0,s="";for(const r of Q){const n=r.issuer_type==="GOVERNMENT",l=n?"gov":"private",c=Array.isArray(r.contract_bids)?r.contract_bids[0]:r.contract_bids,v=c?.bid_price||0,d=c?.estimated_cost||0,m=c?.estimated_quality||0,u=r.budget_ceiling||0,_=r.awarded_at_tick||i,b=r.stalled_ticks||0,p=Math.max(0,i-_),h=Math.max(0,p-b),x=r.timeline_ticks||8,k=Math.max(0,x-h),I=Math.min(100,Math.round(h/x*100)),T=h>x,$=b>0;let C="";if($){const A=r.required_workforce||{},j=r.workers_assigned||{},P=[];if((Number(j.general)||0)<(Number(A.general)||0)&&P.push("General: "+(Number(j.general)||0)+"/"+(Number(A.general)||0)),(Number(j.skilled)||0)<(Number(A.skilled)||0)&&P.push("Skilled: "+(Number(j.skilled)||0)+"/"+(Number(A.skilled)||0)),(Number(j.innovative)||0)<(Number(A.innovative)||0)&&P.push("Innovative: "+(Number(j.innovative)||0)+"/"+(Number(A.innovative)||0)),P.length>0)C="Workers needed — "+P.join(", ");else{const S=r.current_phase||le[Math.min(le.length-1,Math.floor(h/Math.max(1,x)*le.length))];S==="Permits"?C="Awaiting permit approval":S==="Planning"?C="Planning phase — no materials yet":C="Materials needed — allocate from warehouse"}}Vi(r.sector);const L=ai(r.sector);o+=u,a+=v,s+=`<div class="ap-item" onclick="openProjectModal('${r.id}')">
            ...
            <div class="ap-budget">
                <div class="ap-budget__header">
                    <span class="ap-budget__label">PROGRESS${$?' <span style="color:var(--orange);font-weight:700;font-size:7px;">⚠ STALLED ('+b+" ticks) — "+y(C)+"</span>":""}</span>
                ...
                <div class="ap-budget__bar">
                    <div class="ap-budget__fill" style="width:${I}%;background:${T?"var(--red)":$?"var(--orange)":"var(--teal)"}"></div>
                </div>
            </div>
            ...
            <span class="wh-row__val${_?" empty":""}">${u>0?q(u):"—"}</span>
                ...
                <span class="wh-expand__hdr-label" style="width:55px;text-align:right">$/UNIT</span>
            </div>`;const T=[{key:"LOW",label:"Low",data:c,avail:b,color:"var(--orange)",dotClass:"wh-dot--low"},{key:"STD",label:"Standard",data:v,avail:p,color:"var(--amber)",dotClass:"wh-dot--std"},{key:"HIGH",label:"High",data:d,avail:h,color:"var(--green)",dotClass:"wh-dot--high"}];for(const $ of T){const C=!$.avail.available,L=$.data.qty>0,A=L?"$"+Math.round($.data.value/$.data.qty):"—";s+=`<div class="wh-grade${C?" unavailable":""}">
                    ...
                    <span class="wh-grade__qty" style="color:${L?"var(--text-bright)":"var(--text-dim)"}">${L?$.data.qty.toLocaleString():"—"}</span>
                    <span class="wh-grade__val" style="color:${$.data.value>0?"var(--text-muted)":"var(--text-dim)"}">${$.data.value>0?q($.data.value):"—"}</span>
        ...
        <div class="pr-drivers__title">Price Drivers (${y(R?.name||"—")})</div>`;for(const T of i.priceDrivers){const $=Number(R?.[T]??50),C=$>=50?"var(--green)":$>=30?"var(--amber)":$>=15?"var(--orange)":"var(--red)",L=ea[T]||T;m+=`<div class="pr-driver-row">
            <span class="pr-driver-row__stat">${y(T)}</span>
            <div class="pr-driver-row__bar">
                <div class="pr-driver-row__fill" style="width:${$}%;background:${C}"></div>
            </div>
            <span class="pr-driver-row__val">${$}</span>
            <span class="pr-driver-row__effect">${y(L)}</span>
        </div>`}m+="</div>";const _=(Number(f?.corp_cash_reserves)||0)>=s,b=me>a,{totalUnits:p}=_t(),h=gt-p,x=me>h,k=h<=0,I=zi[K];m+=`<div class="pr-order">
        ...
        <div class="pr-order__box">
            <div class="pr-order__header">
                <div style="display:flex;align-items:center;gap:6px;">
                    ...
                    <span style="font-family:var(--font-mono);font-size:9px;color:${I}">${Ft[K]}</span>
                </div>
            ...
            <div class="pr-qty-row">
                ...
                <div class="pr-qty-btns">
                    ${[100,250,500,1e3].map(T=>`<span class="pr-qty-btn${me===T?" active":""}" onclick="setPrQty(${T})">${T>=1e3?T/1e3+"k":T}</span>`).join("")}
                </div>
            </div>
    ...
    </div>`,t.innerHTML=m}function ia(t){ne=t,K="STD";for(const e of["STD","HIGH","LOW"])if(Ce(t,e,R).available){K=e;break}Xi(),si(),xt()}function oa(t){K=t,si(),xt()}function aa(t){me=t,xt()}let St=!1;async function na(){if(St||!f||!R)return;const t=ii(ne,K,R),e=Li(ne,K,R),i=t*me,o=Number(f.corp_cash_reserves)||0;if(i>o){alert("Insufficient cash reserves.");return}if(me>e){alert("Exceeds available supply this tick.");return}const{totalUnits:a}=_t(),s=gt-a;if(s<=0){alert("Warehouse is full. Cannot purchase more materials.");return}if(me>s){alert(`Warehouse can only hold ${s.toLocaleString()} more units. Reduce quantity.`);return}St=!0;const r=document.querySelector(".pr-purchase-btn");r&&(r.disabled=!0,r.textContent="...");try{const n=o-i,{error:l}=await g.from("factions").update({corp_cash_reserves:n}).eq("id",f.id);if(l)throw l;const c=lt(ne),v=J[c]?.[K],d=(v?.qty||0)+me,m=(v?.value||0)+i,{error:u}=await g.from("corp_warehouse").upsert({faction_id:f.id,nation_id:f.nation_id,material_key:c,quality_tier:K,quantity:d,total_value:m,last_purchased_tick:N?.current_tick||null,updated_at:new Date().toISOString()},{onConflict:"faction_id,material_key,quality_tier"});if(u){const{error:_}=await g.from("factions").update({corp_cash_reserves:o}).eq("id",f.id);throw _&&console.error("Cash refund failed after warehouse error:",_.message),u}f.corp_cash_reserves=n,J[c]||(J[c]={}),J[c][K]={qty:d,value:m},ni(),ta(),r&&(r.textContent="PURCHASED",setTimeout(()=>{r.isConnected&&(r.disabled=!1,r.textContent="PURCHASE")},1500))}catch(n){r&&(r.disabled=!1,r.textContent="PURCHASE"),alert("Purchase failed: "+(n.message||"Unknown error"))}finally{St=!1}}function Zi(t){const e=Ie||R;if(!e)return[];const i=yt(t);if(!i)return[];const o=Eo(t,e),a=[],s=Number(e?.inflation??50),r=Number(e?.fuel_prices??50);Number(e?.manufacturing_output??50);const n=Ie&&R&&Ie.id!==R.id;let l=null;if(n&&(l=To(e,R)),o.newAvailable>0){const c=Ii(t,e),v=i.basePrice,d=Math.round(v*((s-50)/200)),m=Math.round(v*((r-50)/300));let u=c;const _=[{label:"Base price",value:q(v)},d!==0?{label:`Inflation (${s})`,mod:(d>=0?"+":"")+q(Math.abs(d))}:null,m!==0?{label:`Fuel transport (${r})`,mod:(m>=0?"+":"")+q(Math.abs(m))}:null].filter(Boolean),b=c-v-d-m;if(b!==0&&!n&&_.push({label:"Demand/scarcity",mod:(b>=0?"+":"")+q(Math.abs(b))}),n&&l){const p=Math.round(c*l.tariff),h=Math.round(c*l.transport);u=c+p+h,_.push({label:`Import tariff (${Math.round(l.tariff*100)}%)`,mod:"+"+q(p)}),_.push({label:`Transport (${l.deliveryTicks} tick${l.deliveryTicks>1?"s":""})`,mod:"+"+q(h)})}a.push({seller:n?`${e.name} Buyers`:"Local Buyers",sellerType:"LOCAL",nation:e.name||"—",distance:n?l?.deliveryTicks||1:0,condition:100,price:Math.round(u),available:o.newAvailable,delivery:n?l.deliveryTicks+" tick"+(l.deliveryTicks>1?"s":""):"Immediate",deliveryTicks:n?l.deliveryTicks:0,used:!1,priceFactors:_,sourceNationId:e.id})}if(o.usedAvailable>0){const c=o.usedCondition,v=Ii(t,e,{used:!0,condition:c});let d=v;const m=[{label:"Base price",value:q(i.basePrice)},{label:`Condition (${c}%)`,mod:"-"+q(Math.max(0,i.basePrice-v))}];if(n&&l){const u=Math.round(v*l.tariff),_=Math.round(v*l.transport);d=v+u+_,m.push({label:`Import tariff (${Math.round(l.tariff*100)}%)`,mod:"+"+q(u)}),m.push({label:`Transport (${l.deliveryTicks} tick${l.deliveryTicks>1?"s":""})`,mod:"+"+q(_)})}a.push({seller:n?`${e.name} Buyers`:"Local Buyers",sellerType:"LOCAL",nation:e.name||"—",distance:n?l?.deliveryTicks||1:0,condition:c,price:Math.round(d),available:o.usedAvailable,delivery:n?l.deliveryTicks+" tick"+(l.deliveryTicks>1?"s":""):"Immediate",deliveryTicks:n?l.deliveryTicks:0,used:!0,priceFactors:m,sourceNationId:e.id})}return a}function ri(){const t=Number(f?.corp_cash_reserves)||0;document.getElementById("em-cash").textContent=q(t);const e=yt(se),i=Xe[e?.tier||1],o=document.getElementById("em-tier-badge");o&&(o.textContent=i.tag,o.style.color=i.color),o.style.background=i.color+"0a",o.style.border="1px solid "+i.color+"33";const a=document.getElementById("em-nation-select");if(a&&a.options.length===0){const n=R?.name||f?.nation||"—";let l=`<option value="">${y(n)} (HQ)</option>`;for(const c of Ui)c.id!==R?.id&&(l+=`<option value="${c.id}">${y(c.name)}</option>`);a.innerHTML=l}const s=document.getElementById("em-import-tag"),r=Ie&&R&&Ie.id!==R.id;s&&(s.style.display=r?"":"none"),sa(),li()}function sa(){let t="";for(let e=1;e<=3;e++){const i=Xe[e],o=Ut(e),a=e===3?"em-selector__grid em-selector__grid--t3":"em-selector__grid em-selector__grid--t12";t+=`<div class="em-selector__row">
            ...
            <div class="${a}">`;for(const s of o){const r=se===s.key,n=Zi(s.key).length>0;t+=`<span class="em-selector__btn${r?" active":""}${n?"":" no-listings"}"
                ...
                onclick="setEmType('${s.key}')">${y(s.name)}</span>`}t+="</div></div>"}document.getElementById("em-selector").innerHTML=`<div class="em-selector">${t}</div>`}function li(){const t=document.getElementById("em-content");if(we=Zi(se),we.length===0){t.innerHTML=`<div class="em-no-listings"><div class="em-no-listings__box">
        ...
        </div></div>`;return}ue>=we.length&&(ue=0);let e="";for(let o=0;o<we.length;o++){const a=we[o],s=ue===o,r=a.sellerType==="LOCAL"?"var(--teal)":"#5a8aaa",n=Ri(a.condition);e+=`<div class="em-listing${s?" selected":""}" style="${s?"border-left-color:"+r:""}" onclick="setEmListing(${o})">`,e+=`<div class="em-listing__row1">
            <div style="display:flex;align-items:center;gap:6px">
            ...
            <div class="em-stat-cell" style="flex:1.2">
                ...
                <div class="em-stat-cell__value" style="font-size:11px;color:var(--text-bright);margin-top:2px">${q(a.price)}</div>
            </div>
            ...
            </div>`),e+="</div>"}const i=we[ue];if(i){const o=yt(se),a=Xe[o?.tier||1],s=Math.min(i.available,4),r=i.price*ye,n=(Number(f?.corp_cash_reserves)||0)>=r;e+=`<div class="em-purchase"><div class="em-purchase__box">
            <div class="em-purchase__header">
                ...
                <span class="em-purchase__price">${q(i.price)}/unit</span>
            </div>
            <div class="em-purchase__qty">
                <span class="em-purchase__qty-label">QTY</span>
                <div class="em-purchase__qty-btns">
                    ${Array.from({length:s},(l,c)=>c+1).map(l=>`<span class="em-qty-btn${ye===l?" active":""}" style="${ye===l?"background:"+a.color+";border-color:"+a.color:""}" onclick="setEmQty(${l})">${l}</span>`).join("")}
                </div>
        ...
        <div style="padding:14px 20px;overflow:auto;flex:1;">
            ...
            <div style="display:flex;gap:0;background:${e.card};border:1px solid ${e.border};margin-bottom:14px;">
                ...
                <div style="flex:1;padding:4px 8px;border-right:1px solid ${e.border};">
                    ...
                    <div style="font-family:${t};font-size:9px;font-weight:700;color:${e.text};margin-top:1px;">${q(Number(i.trade_volume||0))}</div>
                </div>
            ...
            ${(()=>{const z=i.destDepot;if(!z)return"";const F=i.destination_port||"this port",U=mi(i,i.vessel_class,z.tier),w="$"+Math.round(U).toLocaleString()+" / refuel";let M,B;return z.tier==="own"?(M=`${F} has your Fuel Depot (${y(z.ownerName||f.faction_name||"your corp")}) — ${w}.`,B=e.green):z.tier==="other"?(M=`${F} has a Fuel Depot (${y(z.ownerName||"another corp")}) — ${w}.`,B=e.gold):(M=`${F} has no fuel depot — paying ${w} to the government-owned depot.`,B=e.orange),`<div style="padding:7px 10px;margin-bottom:14px;background:${e.card};border:1px solid ${e.border};border-left:2px solid ${B};font-family:${t};font-size:9px;color:${e.text};line-height:1.5;">
                    <span style="color:${e.dim};font-size:7px;font-weight:700;letter-spacing:0.5px;">FUEL AT DESTINATION</span><br>
                    ${M}
                </div>`})()}

            ${(()=>{const z=!!i.trade_agreement_id,F=Ht(i),U=z?e.green:e.dim,w=z?`ACTIVE TRADE AGREEMENT${i.trade_agreement_name?" · "+y(i.trade_agreement_name):""}`:"OPEN-MARKET ROUTE",M=z?`Revenue = your bid × ${F.toFixed(2)} (agreement bonus).`:`Revenue = your bid × ${F.toFixed(2)} (organic route penalty). Agreement-backed lanes pay more.`;return`<div style="padding:7px 10px;margin-bottom:14px;background:${e.card};border:1px solid ${e.border};border-left:2px solid ${U};font-family:${t};font-size:9px;color:${e.text};line-height:1.5;">
            ...
            <div style="margin-bottom:14px;">
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:5px;">
                    ...
                    <span style="font-family:${t};font-size:16px;font-weight:700;color:${e.gold};">${q(ee)}/trip</span>
                </div>
                ...
                <div style="display:flex;justify-content:space-between;font-family:${t};font-size:8px;color:${e.dim};margin-top:3px;">
                    <span>Floor (${q(p)})</span>
                    <span style="color:${e.muted};">Mid (${q(x)})</span>
                    <span>Ceiling (${q(h)})</span>
                </div>
            </div>`;const k=i.destDepot?.tier==="own"?"own depot":i.destDepot?.tier==="other"?"other corp's depot +15%":"state depot (+65%)",I=Math.max(1,12/(Math.max(1,m)*2)),T=Math.round(c.revenue*I),$=Math.round(c.fuelPerTrip*I),C=n?n.status==="in_transit"?1.25:n.status==="in_port"?.55:.85:.85,L=Math.round(d*C),A=Math.round(T*Xt),j=T-$-L-A,P=j>0?e.green:j<0?e.red:e.dim;b+=`
            <div style="margin-bottom:14px;">
                ...
                <div style="background:${e.card};border:1px solid ${e.border};padding:8px 10px;">
                    <div style="display:flex;justify-content:space-between;padding:3px 0;border-bottom:1px solid ${e.border};">
                        ...
                        <span style="font-family:${t};font-size:10px;color:${e.text};">${q(c.bid)}</span>
                    </div>
                    <div style="display:flex;justify-content:space-between;padding:3px 0;border-bottom:1px solid ${e.border};">
                        <span style="font-family:${t};font-size:9px;color:${e.dim};">Revenue ×${a} (${i.trade_agreement_id?"agreement":"organic"})</span>
                        <span style="font-family:${t};font-size:10px;font-weight:700;color:${e.green};">${q(c.revenue)}</span>
                    </div>
                    <div style="display:flex;justify-content:space-between;padding:3px 0;border-bottom:1px solid ${e.border};">
                        <span style="font-family:${t};font-size:9px;color:${e.dim};">Fuel at destination (${k})</span>
                        <span style="font-family:${t};font-size:10px;color:${e.red};">-${q(c.fuelPerTrip)}</span>
                    </div>
                    <div style="display:flex;justify-content:space-between;padding:5px 0;">
                        <span style="font-family:${t};font-size:10px;font-weight:700;color:${e.text};">NET PER TRIP</span>
                        <span style="font-family:${t};font-size:14px;font-weight:700;color:${v};">${c.netPerTrip>=0?"+":""}${q(c.netPerTrip)}</span>
                    </div>
                </div>
            </div>
            ...
            <div style="margin-bottom:14px;">
                ...
                <div style="background:${e.card};border:1px solid ${e.border};padding:8px 10px;">
                    ${n?`<div style="display:flex;justify-content:space-between;padding:3px 0;border-bottom:1px solid ${e.border};">
                              ...
                              <span style="font-family:${t};font-size:10px;color:${e.text};">${q(d)} / tick</span>
                           </div>
                           <div style="display:flex;justify-content:space-between;padding:3px 0;border-bottom:1px solid ${e.border};">
                              <span style="font-family:${t};font-size:9px;color:${e.dim};">Accrues during ${m}-tick transit</span>
                              <span style="font-family:${t};font-size:10px;color:${e.text};">${q(u)}</span>
                           </div>
                           <div style="display:flex;justify-content:space-between;padding:5px 0;">
                              <span style="font-family:${t};font-size:9px;color:${e.dim};">Net per trip vs. maint accrued</span>
                              <span style="font-family:${t};font-size:10px;font-weight:700;color:${_?e.green:e.red};">${_?"covers":"short by "+q(Math.max(0,u-c.netPerTrip))}</span>
            ...
            <div style="margin-bottom:14px;">
                ...
                <div style="background:${e.card};border:1px solid ${e.border};padding:8px 10px;">
                    <div style="display:flex;justify-content:space-between;padding:3px 0;border-bottom:1px solid ${e.border};">
                        ...
                        <span style="font-family:${t};font-size:10px;font-weight:700;color:${e.green};">${q(T)}</span>
                    </div>
                    <div style="display:flex;justify-content:space-between;padding:3px 0;border-bottom:1px solid ${e.border};">
                        <span style="font-family:${t};font-size:9px;color:${e.dim};">Expected monthly fuel</span>
                        <span style="font-family:${t};font-size:10px;color:${e.red};">-${q($)}</span>
                    </div>
                    <div style="display:flex;justify-content:space-between;padding:3px 0;border-bottom:1px solid ${e.border};">
                        <span style="font-family:${t};font-size:9px;color:${e.dim};">Maintenance allocation (${Math.round(C*100)}% state factor)</span>
                        <span style="font-family:${t};font-size:10px;color:${e.red};">-${q(L)}</span>
                    </div>
                    <div style="display:flex;justify-content:space-between;padding:3px 0;border-bottom:1px solid ${e.border};">
                        <span style="font-family:${t};font-size:9px;color:${e.dim};">Incident reserve (${Math.round(Xt*100)}%)</span>
                        <span style="font-family:${t};font-size:10px;color:${e.red};">-${q(A)}</span>
                    </div>
                    <div style="display:flex;justify-content:space-between;padding:5px 0;">
                        <span style="font-family:${t};font-size:10px;font-weight:700;color:${e.text};">EST. MONTHLY NET</span>
                        <span style="font-family:${t};font-size:13px;font-weight:700;color:${P};">${j>=0?"+":""}${q(j)}</span>
                    </div>
                </div>
            </div>
    ...
    </div>`;const S=document.createElement("div");S.id="ra-modal-overlay",S.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.7);display:flex;align-items:center;justify-content:center;z-index:9999;",S.innerHTML=b,S.addEventListener("click",z=>{z.target===S&&vi()}),document.body.appendChild(S)}async function qa(){if(st||!ze||!qe||!f||!N)return;st=!0;const t=ze,e=5e4,{data:i}=await g.from("factions").select("corp_cash_reserves").eq("id",f.id).single(),o=Number(i?.corp_cash_reserves??0);if(o<e){alert("Not enough funds. Application fee: $50k. You have $"+Math.round(o/1e3)+"k."),st=!1;return}try{const a=o-e,{error:s}=await g.from("factions").update({corp_cash_reserves:a}).eq("id",f.id);if(s){alert("Failed to deduct fee.");return}const r={route_id:t.id,faction_id:f.id,vessel_id:qe,proposed_rate:ee,application_fee:e,status:"pending",applied_at_tick:N.current_tick};let{error:n}=await g.from("shipping_applications").insert(r);if(n&&/vessel_id/i.test(n.message||"")){const{vessel_id:l,...c}=r;n=(await g.from("shipping_applications").insert(c)).error}if(n){await g.from("factions").update({corp_cash_reserves:o}).eq("id",f.id);const l=n.code==="23505"||/duplicate key|idx_shipping_applications_unique/i.test(n.message||"");alert(l?"You already have a pending or approved application on this route. Withdraw it from Route Applications before applying again.":"Application failed: "+n.message);return}try{await g.from("event_log").insert({nation_id:t.origin_nation_id,event_name:f.faction_name+" applied to service "+(t.origin_port||"?")+" → "+(t.destination_port||"?"),category:"corporate",description_chosen:f.faction_name+" submitted a shipping application for the "+(t.goods_name||"trade")+" route at a proposed rate of "+q(ee)+"/trip. Vessel: "+(oe.find(l=>l.id===qe)?.vessel_name||"Unknown"),fired_at_tick:N.current_tick})}catch(l){console.warn("[Shipping] Event log failed:",l?.message||l)}vi(),await di(),Z=-1,await bt(),alert("Application submitted! The government will review your application.")}catch(a){alert("Application failed: "+(a.message||"Network error"))}finally{st=!1}}async function Aa(){if(!(Nt||Z<0||!f||!N)){var t=pi(),e=t[Z];if(e){var i=Number(f.shipping_fleet_capacity??0),o=Number(f.shipping_fleet_deployed??0);if(o>=i){alert("No available vessels. Fleet capacity: "+i+", deployed: "+o+".");return}Nt=!0;var a=document.getElementById("ar-claim-btn");a.textContent="CLAIMING...",a.className="ar-claim-btn";try{var{data:s,error:r}=await g.rpc("claim_shipping_route",{p_faction_id:f.id,p_route_id:e.id,p_current_tick:N.current_tick});if(r){alert("Claim failed: "+r.message);return}if(s&&!s.success){alert(s.error||"Claim failed.");return}if(s?.claim_id){var n=(oe||[]).find(function(m){return m.status==="in_port"&&!m.active_claim_id&&m.fuel>=10});if(n){var{error:l}=await g.from("corp_vessels").update({status:"in_transit",active_claim_id:s.claim_id,current_port_nation_id:null}).eq("id",n.id);l&&console.warn("Failed to assign vessel to route:",l.message)}else console.warn("Route claimed but no available vessel with fuel >= 10% to assign.")}try{var c=e.origin_nation?.name||e.origin_nation_id||"Unknown",v=e.destination_nation?.name||e.destination_nation_id||"Unknown",d=e.goods_type||e.cargo_type||"goods";await g.from("event_log").insert({nation_id:f.nation_id,event_name:"Shipping Route Signed",category:"corporate",description_chosen:f.faction_name+" has just signed an agreement to ship "+d+" between "+c+" and "+v+".",fired_at_tick:N.current_tick||0})}catch{}await di(),Z=-1,await Promise.all([bt(),ht(),ce()])}catch(m){alert("Claim failed: "+(m.message||"Network error"))}finally{Nt=!1,a.textContent="CLAIM ROUTE",a.className="ar-claim-btn"+(Z>=0?" active":"")}}}}let ke=[],oo="ready",Ye=null,vt=-1;async function ht(){if(!f)return;const t=await Co(g,f.id);ke=t.claims,oo=t.state,Ye=t.error,Ye&&console.warn("Failed to load active voyages:",Ye.message),ao()}function Ma(t){vt=vt===t?-1:t,ao()}async function Na(t){if(!(Lt||!f||!N)){Lt=!0;try{var{data:e,error:i}=await g.rpc("release_shipping_route",{p_faction_id:f.id,p_claim_id:t,p_current_tick:N.current_tick});if(i){alert("Release failed: "+i.message);return}if(e&&!e.success){alert(e.error||"Release failed.");return}var{error:o}=await g.from("corp_vessels").update({status:"in_port",active_claim_id:null}).eq("active_claim_id",t).eq("faction_id",f.id);o&&console.warn("Failed to free vessel on release:",o.message),vt=-1,await di(),await Promise.all([bt(),ht(),ce()])}catch(a){alert("Release failed: "+(a.message||"Network error"))}finally{Lt=!1}}}function ao(){const t=N?.current_tick||0,e=Number(f?.shipping_fleet_capacity??0),i=Number(f?.shipping_fleet_deployed??0),o=f?.corp_subsector||"--";document.getElementById("av-count").textContent=ke.length+" ACTIVE";const a=ke.reduce((v,d)=>v+Number(d.total_revenue||0),0),s=ke.reduce((v,d)=>v+(d.transits_completed||0),0),r=s>0?Math.round(a/s):0;document.getElementById("av-summary").innerHTML=`
...
Deductible:  ${a.deductible_pct||10}%`;if(!confirm(c))return;const v=i?"auto":"deal",d=N?.current_tick||0,{data:m,error:u}=await g.from("insurance_claims").insert({policy_id:a.id,policy_source:v,claimant_faction_id:f.id,insurer_faction_id:a.lender_faction_id,insured_vessel_id:e.vessel_id,claim_amount:l,claim_reason:e.description||`${s} — incident ${e.incident_type}`,policy_terms:a.policy_terms||null,deductible_pct:Number(a.deductible_pct)||10,status:"filed",filed_at_tick:d}).select("id").single();if(u){alert("Failed to file claim: "+u.message);return}const{error:_}=await g.from("vessel_incidents").update({status:"filed",filed_at_tick:d,filed_claim_id:m?.id||null}).eq("id",e.id);_&&console.warn("[VesselIncidents] incident update after file failed:",_.message);try{await g.from("event_log").insert({nation_id:e.nation_id||f.nation_id,faction_id:f.id,event_name:`${f.faction_name||"A corporation"} filed an insurance claim`,category:"corporate",description_chosen:`${f.faction_name||"Corporation"} filed a claim on ${s} for $${Math.round(l).toLocaleString()}.`,fired_at_tick:d})}catch{}await yi()}catch(i){console.error("[VesselIncidents] fileClaim error:",i),alert("File claim failed: "+(i?.message||"unknown error"))}finally{Ue=!1}}}window.viFileClaim=za;async function Ra(t){if(!Ue&&confirm("Dismiss this incident without filing a claim? The vessel remains in whatever state the tick processor left it.")){Ue=!0;try{const{error:e}=await g.from("vessel_incidents").update({status:"dismissed",filed_at_tick:N?.current_tick||0}).eq("id",t);if(e){alert("Dismiss failed: "+e.message);return}await yi()}finally{Ue=!1}}}window.viDismissIncident=Ra;function Oa(t,e){const i=(oe||[]).filter(function(s){return s.status==="in_port"&&!s.active_claim_id&&s.fuel>=15&&s.condition>=20});let o;i.length===0?o='<div style="padding:20px;text-align:center;font-family:var(--font-mono);font-size:11px;color:var(--text-dim);">No available vessels.<br>Ships must be in port with 15%+ fuel and 20%+ condition.</div>':o=i.map(function(s,r){var n=s.fuel>50?"#5c5":s.fuel>20?"#ca5":"#c55",l=s.condition>50?"#5c5":s.condition>30?"#ca5":"#c55";return`<div style="padding:10px 14px;border-bottom:1px solid var(--border-0);cursor:pointer;display:flex;justify-content:space-between;align-items:center;" onclick="assignVesselToRoute('`+t+"','"+s.id+`')"><div><div style="font-size:14px;font-weight:700;color:var(--text-bright);">`+y(s.vessel_name||"Unnamed")+'</div><div style="font-family:var(--font-mono);font-size:10px;color:var(--text-dim);">'+y(s.vessel_class||"?")+" · "+(s.capacity_dwt||0).toLocaleString()+' DWT</div></div><div style="display:flex;gap:14px;align-items:center;"><div style="text-align:center"><div style="font-family:var(--font-mono);font-size:7px;color:var(--text-dim);">FUEL</div><div style="font-family:var(--font-mono);font-size:13px;font-weight:700;color:'+n+'">'+s.fuel+'%</div></div><div style="text-align:center"><div style="font-family:var(--font-mono);font-size:7px;color:var(--text-dim);">COND</div><div style="font-family:var(--font-mono);font-size:13px;font-weight:700;color:'+l+'">'+s.condition+'%</div></div><div style="font-family:var(--font-mono);font-size:11px;font-weight:700;color:var(--teal);padding:4px 12px;border:1px solid var(--teal);cursor:pointer;">ASSIGN</div></div></div>'}).join("");var a=document.createElement("div");a.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9999;display:flex;align-items:center;justify-content:center;",a.onclick=function(s){s.target===a&&a.remove()},a.innerHTML='<div style="width:560px;max-width:95vw;max-height:80vh;background:var(--bg-panel);border:1px solid var(--border-main);display:flex;flex-direction:column;"><div style="padding:12px 16px;border-bottom:1px solid var(--border-main);background:var(--bg-card);display:flex;justify-content:space-between;align-items:center;"><span style="font-family:var(--font-mono);font-size:13px;font-weight:700;letter-spacing:1px;color:var(--teal);">ASSIGN VESSEL</span><span style="font-family:var(--font-mono);font-size:10px;color:var(--text-dim);">'+i.length+' available</span></div><div style="flex:1;overflow-y:auto;">'+o+`</div><div style="padding:10px 16px;border-top:1px solid var(--border-main);background:var(--bg-card);text-align:right;"><button onclick="this.closest('div[style*=fixed]').remove()" style="padding:6px 16px;font-family:var(--font-mono);font-size:10px;font-weight:700;color:var(--text-dim);background:transparent;border:1px solid var(--border-main);cursor:pointer;">CANCEL</button></div></div>`,document.body.appendChild(a)}async function Pa(t,e){try{var{error:i}=await g.from("corp_vessels").update({status:"in_port",active_claim_id:t}).eq("id",e).eq("faction_id",f.id);if(i){alert("Assignment failed: "+i.message);return}var o=document.querySelector('div[style*="position:fixed"][style*="z-index:9999"]');o&&o.remove(),await Promise.all([ht(),ce()])}catch(a){alert("Assignment failed: "+(a.message||"Network error"))}}window.openAssignVesselModal=Oa;window.assignVesselToRoute=Pa;function gi(){const t=ie.reduce((n,l)=>n+(l.owned||0),0),e=ie.reduce((n,l)=>n+(l.deployed||0),0),i=ko(ie),o=t-e;document.getElementById("eq-count").textContent=t+" UNITS",document.getElementById("eq-summary").innerHTML=`
            ...
            ${d>0?`<span class="eq-tier-hdr__count">${m}/${d}</span>`:'<span class="eq-tier-hdr__none">NONE OWNED</span>'}
        </div>`,v)for(const u of c){const _=a[u.key],b=_?.owned||0,p=_?.deployed||0,h=_?.condition||0,x=u.maintenancePerUnit*b,k=b-p,I=b>0&&k===0,T=b>0&&h<65,$=Ri(h),C=_?.assigned_projects||[],L=C.length>0?C.map(A=>A.contract_name||"Project").join(", ").slice(0,30):b>0&&p>0?p+" project"+(p>1?"s":""):"—";s+=`<div class="eq-row${b===0?" unowned":""}">`,s+=`<div class="eq-row__top">
                    ...
                    ${b>0?`<div class="eq-row__right">
                        ...
                        <div class="eq-detail__cell" style="flex:0.7">
                            ...
                            <div class="eq-detail__value" style="color:var(--red)">${q(x)}<span style="font-size:7px;color:var(--text-dim)">/t</span></div>
                        </div>
        ...
        <div class="eq-footer__tiers">${r}</div>`}function Da(t){Gt=Gt===t?-1:t,gi()}async function no(){if(!f)return;const{data:t,error:e}=await g.from("corp_equipment").select("equipment_key, tier, owned, deployed, condition, maintenance_per_tick, assigned_projects").eq("faction_id",f.id);e?(console.warn("Failed to load equipment:",e.message),ie=[]):ie=t||[],gi()}async function Ba(){const{data:{user:t}}=await g.auth.getUser();if(!t){window.location.href="login.html";return}const e=new URLSearchParams(location.search).get("faction_id");if(!!e){const{data:d,error:m}=await g.from("factions").select("*").eq("id",e).single();m?console.warn("[Inspector] faction fetch failed:",m.message):d?.faction_type==="corporation"&&(f=d)}if(!f){const{data:d}=await g.from("factions").select("*").or(`id.eq.${t.id},linked_user_id.eq.${t.id}`);$e=(d||[]).filter(u=>u.nation_id);const m=sessionStorage.getItem("active_faction_id");if(f=$e.find(u=>u.id===m)||$e.find(u=>u.faction_type==="corporation")||$e[0],!f){await g.auth.signOut(),window.location.href="login.html";return}if(f.faction_type!=="corporation"){window.location.href="dashboard.html";return}if(f.corp_sector!=="Shipping"){const u=Oi[f.corp_sector];if(u){window.location.href=u;return}}}const[o,a]=await Promise.all([f.nation_id?g.from("nations").select("*").eq("id",f.nation_id).single():Promise.resolve({data:null}),g.from("shard").select("current_tick, current_date, next_tick_at, tick_interval_hours").eq("name","Alpha Shard").single()]);o.error&&console.warn("Nation load failed:",o.error.message),o.data&&(R=o.data),a.error&&console.warn("Shard load failed:",a.error.message),N=a.data;let s=0;if(f?.id){const{data:d}=await g.from("construction_contracts").select("id, contract_bids!inner(id)").eq("issuer_faction_id",f.id).in("status",["open","bidding"]);if(d)for(const m of d)s+=(m.contract_bids||[]).length}const r=document.getElementById("corp-topbar-container");if(r){const{renderCorpTopBar:d}=await $o(async()=>{const{renderCorpTopBar:u}=await import("./corp-topbar-CYaKZ_BF.js");return{renderCorpTopBar:u}},__vite__mapDeps([0,1])),m={};s>0&&(m.home={color:"#c8a832",title:s+" pending bid"+(s!==1?"s":"")+" on your projects"}),d(r,{faction:f,shard:N,activeTab:"operations",allUserFactions:$e,badges:m})}if(N){if(document.getElementById("game-date").textContent=N.current_date||"—",document.getElementById("tick-number").textContent=N.current_tick||"—",N.next_tick_at){const m=(Number(N.tick_interval_hours)||8)*36e5,u=new Date(N.next_tick_at).getTime(),b=u-m+m/2;Wt=new Date(b>Date.now()?b:u+m/2),No()}const d=document.querySelector("#tick-countdown")?.closest(".tick-item")?.querySelector(".tick-label");d&&(d.textContent="Next Corp Tick")}const n=document.getElementById("topbar-cash");n&&(n.textContent="CASH: "+eo(Number(f.corp_cash_reserves??0)));const l=document.getElementById("topbar-ap");l&&(l.style.display="none");const c=document.getElementById("nation-pill");c&&(c.textContent=(R?.name||f.nation||"—").toUpperCase());const v=document.getElementById("corp-faction-dropdown");if(v){let d="";for(const m of $e){const u=m.id===f.id,_=m.faction_type==="corporation"?"CORP":"PARTY",b=m.faction_type==="corporation"?"var(--teal)":"var(--amber)";d+=`<div class="corp-dd-item${u?" active":""}" onclick="switchToFaction('${m.id}', '${m.faction_type}')">
            ...
            </div>`}v.innerHTML=d}await Promise.all([bt(),ht(),ce(),bi(),co(),yi(),Ao()]),wo(f,R,N);try{await ho(g,{faction:f,nation:R,shard:N},"auto-services-container")}catch(d){console.error("[CorpOps] Auto-services init failed:",d)}document.getElementById("loading").style.display="none",document.getElementById("page-content").style.display="block"}async function ja(){await g.auth.signOut(),window.location.href="login.html"}function Fa(){const t=document.getElementById("corp-faction-dropdown");t&&t.classList.toggle("open")}function Ua(t,e){const i=document.getElementById("corp-faction-dropdown");if(i&&i.classList.remove("open"),sessionStorage.setItem("active_faction_id",t),e==="corporation"){const o=($e||[]).find(a=>a.id===t);window.location.href=Oi[o?.corp_sector]||"corp-operations.html"}else window.location.href="dashboard.html"}document.addEventListener("click",t=>{const e=document.getElementById("faction-switcher"),i=document.getElementById("corp-faction-dropdown");i&&e&&!e.contains(t.target)&&i.classList.remove("open")});document.addEventListener("keydown",t=>{t.key==="Escape"&&ot()});window.doLogout=ja;window.toggleCorpDropdown=Fa;window.switchToFaction=Ua;window.setFilter=Lo;window.arSetFilter=ya;window.arSelectRoute=ba;window.arClaimRoute=Aa;window.arApplyToService=Ca;window.raClose=vi;window.raSelectVessel=Ia;window.raSetRate=Sa;window.raSubmitApplication=qa;window.avToggle=Ma;window.avRelease=Na;window.openContractDetail=Yi;window.closeContractDetail=ot;window.toggleWhRow=Zo;window.toggleEqTier=Da;window.switchEmNation=ra;window.setEmType=la;window.setEmListing=da;window.setEmQty=ca;window.purchaseEquipment=pa;window.setPrMat=ia;window.setPrTier=oa;window.setPrQty=aa;window.purchaseMaterial=na;let ve=null,ge={},Y=120,_e=15,Zt={},je=[];async function Ha(){if(!Se)return;if(He[Se.id]){alert("You already have a bid on this contract. Retract it first if you want to re-bid.");return}ve=Se,Zt={};try{const{data:i}=await g.from("corp_material_inventory").select("material_key, quantity").eq("faction_id",f.id);for(const o of i||[])Zt[lt(o.material_key)]=Number(o.quantity||0)}catch{}je=[];try{const{data:i}=await g.from("contract_bids").select("faction_id, bid_price, estimated_quality, status, factions(faction_name, corp_ticker)").eq("contract_id",ve.id).in("status",["pending","won"]);je=(i||[]).filter(o=>o.faction_id!==f?.id).map(o=>({name:o.factions?.faction_name||"Unknown",ticker:o.factions?.corp_ticker||"???",price:Number(o.bid_price||0),quality:Number(o.estimated_quality||0),status:o.status}))}catch{}ge={};const t=ve.required_materials||{};for(const i of Object.keys(t))ge[i]="STD";const e=ve.required_workforce||{};Y=Number(e.general||0)+Number(e.skilled||0)||120,_e=15,ot(),$t()}function _i(){document.getElementById("bid-assembly-overlay")?.remove(),ve=null}function Va(t,e){ge[t]=e,$t()}function Ga(t){Y=t,$t()}function Wa(t){_e=t,$t()}function $t(){if(document.getElementById("bid-assembly-overlay")?.remove(),!ve)return;const t="'JetBrains Mono', monospace",e={surface:"var(--panel-main)",card:"var(--bg-panel)",border:"var(--panel-border)",accent:"#8b9a6b",accentBright:"#a3b07e",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",redDim:"#a44",yellow:"#ca5",text:"var(--panel-text)",muted:"#9e9a92",dim:"#6a6660"},i=ve,o=i.issuer_type==="GOVERNMENT",a=R?.name||f?.nation||"—",s=Number(i.budget_ceiling||0),r=Number(i.timeline_ticks||8),n=i.required_materials||{},l=Object.keys(n),c={LOW:.5,STD:1,HIGH:2},v={LOW:e.orange,STD:e.yellow,HIGH:e.greenBright},d={LOW:"Low",STD:"Standard",HIGH:"High"},m={concrete:36e4,steel:5e5,glass_facades:56e4,em_systems:64e4,lumber:24e4,heavy_parts:8e5,aggregate:16e4,asphalt:28e4},u=Zt||{};let _=0,b="";for(const D of l){const W=Number(n[D]||0),wi=ge[D]||"STD",ki=m[D]||3e5,uo=c[wi],yo=Math.round(ki*uo),Ei=W*yo;_+=Ei;const go=D.replace(/_/g," ").replace(/\b\w/g,be=>be.toUpperCase()),Ti=Number(u[D]||0),Tt=Math.max(0,W-Ti),_o=Tt===0?e.greenBright:Tt<W?e.yellow:e.red,xo=Tt===0?"✓ IN STOCK":`${Ti}/${W}`;b+=`
        <div style="display:flex;align-items:center;padding:5px 14px;border-bottom:1px solid ${e.border};">
            ...
            <div style="flex:1.2;display:flex;gap:2px;justify-content:center;">
                ${["LOW","STD","HIGH"].map(be=>{const Ct=wi===be,Ci=v[be],bo=E(Math.round(ki*c[be]));return`<span onclick="bidSetGrade('${D}','${be}')" style="padding:2px 6px;font-family:${t};font-size:7px;font-weight:700;cursor:pointer;color:${Ct?"#000":e.dim};background:${Ct?Ci:"transparent"};border:1px solid ${Ct?Ci:e.border}" title="${bo}/unit">${d[be]}</span>`}).join("")}
            </div>
            <div style="flex:0.8;text-align:right"><span style="font-family:${t};font-size:10px;color:${e.text}">${E(Ei)}</span></div>
        </div>`}const p=i.required_workforce||{},h=Number(p.general||0)+Number(p.skilled||0)||100,x=Math.max(40,Math.round(h*.5)),k=h*2,I=[x,Math.round(h*.75),h,Math.round(h*1.5),k],T=Math.max(0,Math.min(1,(Y-x)/(k-x||1))),$=r,C=Math.round(4.5-T*8),L=Math.max(Math.round($*.6),$+C),A=C>0?`+${C}mo`:C<0?`${C}mo`:"On schedule",j=C>0?e.red:C<0?e.greenBright:e.yellow,P=15200,S=Y*P*L,z=s,U=[{name:"Municipal Zoning Approval",cost:18e4,ticks:2,required:!0},{name:"Structural Engineering Cert.",cost:24e4,ticks:3,required:!0},{name:"Environmental Impact Assessment",cost:34e4,ticks:8,required:z>2e7},{name:"Seismic Resilience Compliance",cost:21e4,ticks:4,required:z>5e7},{name:"Heritage Conservation Review",cost:16e4,ticks:6,required:!1},{name:"Fire Safety Certification",cost:12e4,ticks:2,required:z>1e7}].filter(D=>D.required),w=new Set(["Municipal Zoning Approval","Structural Engineering Cert."]),M=U.filter(D=>!w.has(D.name)).reduce((D,W)=>D+W.cost,0),B=4e5,H=_+S+M+B,X=Math.round(H*(_e/100)),pe=H+X,V=pe>s,kt=X,xe=V?0:Math.max(0,Math.min(100,Math.round(100-pe/s*100+30))),$i=xe>70?e.greenBright:xe>40?e.yellow:xe>0?e.orange:e.red,mo=V?"OVER CEILING":xe>70?"STRONG":xe>40?"COMPETITIVE":xe>20?"WEAK":"UNLIKELY",Et=Object.values(ge),fe=Et.length>0?Math.round(Et.reduce((D,W)=>D+(W==="HIGH"?85:W==="STD"?65:45),0)/Et.length):50,at=fe>=75?e.greenBright:fe>=50?e.yellow:fe>=25?e.orange:e.red,vo=fe>=75?"EXCELLENT":fe>=50?"FAIR":fe>=25?"POOR":"BAD",Oe=document.createElement("div");Oe.id="bid-assembly-overlay",Oe.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.7);display:flex;align-items:center;justify-content:center;z-index:9999;",Oe.addEventListener("click",D=>{D.target===Oe&&_i()}),Oe.innerHTML=`
    <div style="width:740px;max-height:94vh;background:${e.surface};border:1px solid ${e.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        ...
        <div style="flex:1;display:flex;overflow:hidden;">
            ...
            <div style="flex:1;border-right:1px solid ${e.border};overflow:auto;">
                ...
                <div style="padding:8px 14px;border-bottom:1px solid ${e.border};">
                    <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px;">
                        ...
                        <div style="display:flex;gap:3px;">
                            ${I.map(D=>`<span onclick="bidSetWorkers(${D})" style="padding:2px 8px;font-family:${t};font-size:8px;font-weight:700;cursor:pointer;color:${Y===D?"#000":e.dim};background:${Y===D?e.accent:"transparent"};border:1px solid ${Y===D?e.accent:e.border}">${D}</span>`).join("")}
                        </div>
                    </div>
                    <div style="display:flex;justify-content:space-between;">
                        <span style="font-family:${t};font-size:8px;color:${e.dim}">${Y} × $${P.toLocaleString()}/tick × ${L} ticks</span>
                    ...
                    <div style="display:flex;justify-content:space-between;margin-top:6px;padding-top:6px;border-top:1px solid ${e.border};">
                        ...
                        <span style="font-family:${t};font-size:10px;font-weight:700;color:${j}">${L}mo <span style="font-size:8px;opacity:0.7">(${A})</span></span>
                    </div>
                </div>
                ...
                <div style="display:flex;justify-content:space-between;padding:5px 14px;border-bottom:1px solid ${e.border};background:rgba(139,154,107,0.02);">
                    ...
                    <span style="font-family:${t};font-size:11px;font-weight:700;color:${e.text}">${E(M)}</span>
                </div>
            ...
            <div style="width:280px;display:flex;flex-direction:column;overflow:auto;">
                ...
                ${[{l:"Materials",v:_},{l:"Labor",v:S},{l:"Permits",v:M},{l:"Overhead",v:B}].map(D=>`<div style="display:flex;justify-content:space-between;padding:4px 14px;border-bottom:1px solid ${e.border};">
                ...
                <div style="padding:10px 14px;border-bottom:1px solid ${e.border};">
                    <div style="display:flex;justify-content:space-between;margin-bottom:6px;">
                        ...
                        <span style="font-family:${t};font-size:16px;font-weight:700;color:${e.gold}">${_e}%</span>
                    </div>
                    <input type="range" min="0" max="40" step="1" value="${_e}" oninput="bidSetMarkup(+this.value)" style="width:100%;accent-color:${e.gold};height:6px;" />
                ...
                <div style="padding:10px 14px;border-bottom:1px solid ${e.border};background:${V?"rgba(204,85,85,0.04)":"rgba(200,168,50,0.03)"};">
                    ...
                    <div style="font-family:${t};font-size:22px;font-weight:700;color:${V?e.red:e.gold}">${E(pe)}</div>
                ...
                <div style="padding:8px 14px;border-bottom:1px solid ${e.border};">
                    ...
                    <div style="width:100%;height:4px;background:${e.border}"><div style="width:${xe}%;height:100%;background:${$i}"></div></div>
                </div>
                <div style="padding:8px 14px;border-bottom:1px solid ${e.border};">
                    <div style="display:flex;justify-content:space-between;margin-bottom:4px;">
                        <span style="font-family:${t};font-size:8px;color:${e.dim}">QUALITY ESTIMATE</span>
                        <div style="display:flex;align-items:baseline;gap:4px;">
                            <span style="font-family:${t};font-size:11px;font-weight:700;color:${at}">${fe}</span>
                    ...
                    <div style="width:100%;height:4px;background:${e.border}"><div style="width:${fe}%;height:100%;background:${at}"></div></div>
        ...
        <div style="padding:10px 16px;border-top:1px solid ${e.border};background:${e.card};display:flex;justify-content:space-between;align-items:center;flex-shrink:0;">
            <div style="display:flex;gap:12px;">
                <div><div style="font-family:${t};font-size:7px;color:${e.dim}">YOUR BID</div><div style="font-family:${t};font-size:14px;font-weight:700;color:${V?e.red:e.gold}">${E(pe)}</div></div>
                ...
                <div><div style="font-family:${t};font-size:7px;color:${e.dim}">QUALITY</div><div style="font-family:${t};font-size:14px;font-weight:700;color:${at}">${fe}</div></div>
            </div>
            <div style="display:flex;gap:8px;">
    ...
    </div>`,document.body.appendChild(Oe)}let zt=!1;async function Ya(){if(zt||!ve)return;const t=ve,e=t.required_materials||{},i=Object.keys(e),o=Number(t.budget_ceiling||0),a=Number(t.timeline_ticks||8),s={concrete:36e4,steel:5e5,glass_facades:56e4,em_systems:64e4,lumber:24e4,heavy_parts:8e5,aggregate:16e4,asphalt:28e4},r={LOW:.5,STD:1,HIGH:2};let n=0;for(const P of i){const S=Number(e[P]||0),z=ge[P]||"STD",F=s[P]||3e5;n+=S*Math.round(F*r[z])}const l=15200,c=t.required_workforce||{},v=Number(c.general||0)+Number(c.skilled||0)||100,d=Math.max(40,Math.round(v*.5)),m=v*2,u=Math.max(0,Math.min(1,(Y-d)/(m-d||1))),_=Math.round(4.5-u*8),b=Math.max(Math.round(a*.6),a+_),p=Y*l*b,h=o,x=[{name:"Municipal Zoning Approval",cost:18e4,required:!0},{name:"Structural Engineering Cert.",cost:24e4,required:!0},{name:"Environmental Impact Assessment",cost:34e4,required:h>2e7},{name:"Seismic Resilience Compliance",cost:21e4,required:h>5e7},{name:"Fire Safety Certification",cost:12e4,required:h>1e7}],k=new Set(["Municipal Zoning Approval","Structural Engineering Cert."]),I=x.filter(P=>P.required&&!k.has(P.name)).reduce((P,S)=>P+S.cost,0),$=n+p+I+4e5,C=Math.round($*(_e/100)),L=$+C;if(L>o){alert("Bid exceeds budget ceiling. Reduce costs or markup.");return}const A=Object.values(ge),j=A.length>0?Math.round(A.reduce((P,S)=>P+(S==="HIGH"?85:S==="STD"?65:45),0)/A.length):50;if(confirm('Submit bid for "'+t.name+`"?
...
Once submitted, your bid cannot be changed.`)){zt=!0;try{const{data:P}=await g.from("shard").select("current_tick").eq("name","Alpha Shard").single(),S=P?.current_tick||0,z={};for(const U of i)z[U]=ge[U]||"STD";const{error:F}=await g.from("contract_bids").insert({contract_id:t.id,faction_id:f.id,bid_price:L,material_grades:z,labor_count:Y,markup_pct:_e,estimated_cost:$,estimated_quality:j,status:"pending",submitted_at_tick:S});if(F)throw F;t.status==="open"&&await g.from("construction_contracts").update({status:"bidding"}).eq("id",t.id).eq("status","open"),_i(),alert(`Bid submitted successfully!
...
This action cannot be undone.`)){Rt=!0;try{const o=i-e,{error:a}=await g.from("factions").update({corp_cash_reserves:o}).eq("id",f.id);if(a)throw a;const{error:s}=await g.from("contract_bids").delete().eq("contract_id",t).eq("faction_id",f.id);if(s)throw s;f.corp_cash_reserves=o,typeof subUpdateTopbarCash=="function"&&subUpdateTopbarCash(o),alert("Bid retracted. $1M penalty applied."),ot(),await Le()}catch(o){alert("Failed to retract bid: "+(o.message||"Unknown error"))}finally{Rt=!1}}}window.retractBid=Qa;let et=[],Te=0,de=null,Ot=!1,Pt=!1,Dt=!1;async function Ka(){if(!Se||Pt)return;Pt=!0,de=Se,Te=0;const{data:t,error:e}=await g.from("contract_bids").select("*, factions(faction_name, corp_ticker, corp_subsector)").eq("contract_id",de.id).in("status",["pending","won"]).order("bid_price",{ascending:!0});if(Pt=!1,e){alert("Failed to load bids: "+e.message);return}et=(t||[]).map(i=>({...i,corp:i.factions?.faction_name||"Unknown",abbr:i.factions?.corp_ticker||"???",subsector:i.factions?.corp_subsector||"—"})),ot(),so()}function wt(){document.getElementById("bid-review-overlay")?.remove(),de=null}function Ja(t){Te=t,so()}async function Xa(){if(Ot||et.length===0)return;const t=et[Te];if(!(!t?.id||!t.faction_id)&&confirm("Accept bid from "+t.corp+`?

Bid Price: `+E(t.bid_price)+`
Quality: `+t.estimated_quality+`/100
Workers: `+t.labor_count+`

This will award the contract. The project begins immediately.`)){Ot=!0;try{const{data:e}=await g.from("shard").select("current_tick").eq("name","Alpha Shard").single(),i=e?.current_tick||0,{error:o}=await g.from("contract_bids").update({status:"won"}).eq("id",t.id);if(o)throw o;const{error:a}=await g.from("contract_bids").update({status:"lost"}).eq("contract_id",de.id).neq("id",t.id);if(a)throw a;const{error:s}=await g.from("construction_contracts").update({status:"awarded",awarded_to_faction:t.faction_id,awarded_at_tick:i}).eq("id",de.id);if(s)throw s;wt(),alert("Contract awarded to "+t.corp+`!

Bid: `+E(t.bid_price)+`
Project begins immediately.`),typeof Le=="function"&&await Le()}catch(e){alert("Failed to accept bid: "+(e.message||e))}finally{Ot=!1}}}async function Za(){if(!(!de||Dt)&&confirm(`Decline all bids and cancel this project?

No bids will be accepted. The contract will be removed.`)){Dt=!0;try{const{error:t}=await g.from("contract_bids").update({status:"lost"}).eq("contract_id",de.id);if(t)throw t;const{error:e}=await g.from("construction_contracts").update({status:"expired"}).eq("id",de.id);if(e)throw e;wt(),alert("All bids declined. Contract cancelled."),typeof Le=="function"&&await Le()}catch(t){alert("Failed: "+(t.message||t))}finally{Dt=!1}}}function so(){if(document.getElementById("bid-review-overlay")?.remove(),!de||et.length===0)return;const t="'JetBrains Mono', monospace",e={surface:"var(--panel-main)",card:"var(--bg-panel)",border:"var(--panel-border)",accent:"#8b9a6b",accentBright:"#a3b07e",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",yellow:"#ca5",text:"var(--panel-text)",muted:"#9e9a92",dim:"#6a6660"},i=de,o=et;Te>=o.length&&(Te=0);const a=o[Te],s=Number(i.budget_ceiling||0),r=Number(i.timeline_ticks||36),n=Math.min(...o.map(u=>u.bid_price)),l=Math.max(...o.map(u=>u.estimated_quality||0));let c="";for(let u=0;u<o.length;u++){const _=o[u],b=u===Te,p=_.bid_price===n,h=(_.estimated_quality||0)===l,x=_.bid_price>s;c+=`
    ...
    <div style="width:640px;max-height:92vh;background:${e.surface};border:1px solid ${e.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        ...
        <div style="font-family:var(--font-mono);font-size:12px;font-weight:700;color:${p.color};margin-top:1px;">${p.value}</div>
    </div>`).join("");const m=N?.current_tick||0;let u="";for(const p of s){const h=Math.max(1,Number(p.build_ticks)||1),x=Number(p.delivery_tick)||0,k=Number(p.ordered_at_tick)||0,I=Math.max(0,x-m),T=Math.max(0,Math.min(h,m-k)),$=Math.max(0,Math.min(100,Math.round(T/h*100))),C=Ae[p.vessel_class]||{color:"#9e9a92",label:(p.vessel_class||"?").toUpperCase()},L=I===0?"Delivering this tick":`Delivery in ${I} tick${I!==1?"s":""}`;u+=`<div style="border-bottom:1px solid var(--border-0);border-left:2px solid var(--amber);">
            <div style="padding:7px 14px;">
        ...
        </div>`}a.length===0&&s.length===0?i.innerHTML='<div style="flex:1;display:flex;align-items:center;justify-content:center;font-family:var(--font-mono);font-size:9px;color:var(--text-dim);text-align:center;line-height:1.8;">No vessels in fleet.<br>Purchase ships to begin operations.</div>':a.length===0?i.innerHTML=u:i.innerHTML=u+a.map((p,h)=>{const x=Ze===h,k=Ae[p.vessel_class]||{color:"#666",label:"?"},I=en[p.status]||{color:"#666",label:"?"},T=ro(p.condition),$=tn(p.fuel),C=p.condition<50||p.fuel<20,L=p.status==="in_transit",A=p.status==="dry_dock",j=N?.current_tick||0,P=Math.max(0,Math.floor((j-(p.built_at_tick||0))/12));let S=`<div onclick="flSelectVessel(${h})" style="border-bottom:1px solid var(--border-0);cursor:pointer;border-left:2px solid ${C?p.condition<50?T:$:"transparent"};background:${x?k.color+"06":"transparent"};">
                ...
                <div style="flex:1;padding:3px 6px;text-align:right;">
            ...
            </div>`,A&&p.drydock_until_tick){const F=Math.max(0,p.drydock_until_tick-j);S+=`<div style="margin-top:4px;padding:3px 8px;background:rgba(204,136,68,0.06);border:1px solid rgba(204,136,68,0.15);display:flex;justify-content:space-between;align-items:center;">
                    ...
                    <div style="padding:5px 8px;background:var(--bg-0);border:1px solid var(--border-0);margin-bottom:6px;">`;const F=[{label:"VESSEL CLASS",value:p.vessel_class},{label:"BUILT",value:"Tick "+(p.built_at_tick||0)},{label:"FUEL CAPACITY",value:(p.fuel_capacity||0).toLocaleString()+" tons"},{label:"LAST REFURBISH",value:p.last_refurbish_tick?"Tick "+p.last_refurbish_tick:"N/A"}];for(let H=0;H<F.length;H++)S+=`<div style="display:flex;justify-content:space-between;padding:2px 0;${H<3?"border-bottom:1px solid var(--border-0);":""}">
                    ...
                    </div>`;S+="</div>";const U=L||A,w=Math.round((p.purchase_price||3e6)*.08*(1+(100-p.condition)/100)),M=Math.round((p.fuel_capacity||1e3)*50*(1-p.fuel/100)),B=Math.round((p.purchase_price||3e6)*(p.condition/100)*.6);if(S+=`<div style="display:flex;gap:4px;">
                    ...
                    <div onclick="${L?"":"flRefuel('"+p.id+"',"+M+")"}" style="flex:1;padding:5px 0;text-align:center;cursor:${L?"not-allowed":"pointer"};font-family:var(--font-mono);font-size:7px;font-weight:700;letter-spacing:0.5px;color:${L?"var(--text-dim)":"#c86a4a"};border:1px solid ${L?"var(--border-0)":"rgba(200,106,74,0.3)"};opacity:${L?.35:1};">REFUEL<br><span style="font-weight:400;font-size:6px;">from ${E(M)}</span></div>
                ...
                </div>`,!L){const H=Ge&&Ge[p.id],X=dt&&dt[p.id];S+='<div style="display:flex;gap:4px;margin-top:4px;">',H?S+=`<div style="flex:1;display:flex;gap:2px;">
...
The insurer (`+E(s)+" coverage) has been notified. Claim details are visible in the events feed.")}window.flRequestInsurance=ln;window.flFileClaim=dn;const ei={fuel_depot:{label:"FUEL DEPOT",color:"#c86a4a",icon:"⛽",desc:"Bunkering facility — refuel at base cost, earn revenue from visiting fleets."},dry_dock:{label:"DRY DOCK",color:"#c84",icon:"🔧",desc:"Repair & maintenance dock — dock at base cost, earn revenue from visiting fleets."}},cn=[{type:"fuel_depot",name:"Fuel Depot — Standard",cost:105e6,maint:85e3,style:"Basic",desc:"Bulk fuel storage and bunkering facility."},{type:"fuel_depot",name:"Fuel Depot — Advanced",cost:14e7,maint:11e4,style:"Modern",desc:"High-capacity fuel terminal with pipeline infrastructure."},{type:"dry_dock",name:"Dry Dock — Standard",cost:85e6,maint:15e4,style:"Basic",desc:"Ship repair and maintenance facility."},{type:"dry_dock",name:"Dry Dock — Advanced",cost:115e6,maint:2e5,style:"Modern",desc:"Full-service shipyard with drydock and crane facilities."}];let ut=[];async function co(){if(!f)return;const{data:t}=await g.from("corp_properties").select("*, nations!nation_id(name)").eq("faction_id",f.id).in("type",["fuel_depot","dry_dock"]).eq("is_active",!0).order("created_at",{ascending:!1});ut=t||[],pn()}function pn(){const t=document.getElementById("pf-count"),e=document.getElementById("pf-list"),i=document.getElementById("pf-footer");if(!t||!e||!i)return;const o=ut;if(t.textContent=o.length+" FACILIT"+(o.length===1?"Y":"IES"),o.length===0)e.innerHTML=`<div style="padding:20px;text-align:center;">
        ...
        </div>`}let jt=!1;async function fn(t){if(jt||!f||!N)return;const e=cn.filter(p=>p.type===t);if(e.length===0)return;const i=ei[t],o=f.nation_id,a=R?.name||f?.nation||"Home Nation",s=R?.capital||"Port City",r=[{id:o,name:a,capital:s,label:"National HQ"}],{data:n}=await g.from("corp_properties").select("nation_id, name, city, nations!nation_id(name, capital)").eq("faction_id",f.id).eq("type","regional_hq").eq("is_active",!0);for(const p of n||[])p.nation_id!==o&&r.push({id:p.nation_id,name:p.nations?.name||p.city||"Unknown",capital:p.nations?.capital||p.city||"Port City",label:p.name||"Subsidiary"});let l=r[0];if(r.length>1){let p=i.label+` — SELECT LOCATION
`+"─".repeat(30)+`
`;p+=`Build in which nation?

`;for(let k=0;k<r.length;k++){const I=r[k],T=ut.filter($=>$.type===t&&$.nation_id===I.id).length;p+=k+1+". "+I.name+"  ("+I.label+")",T>0&&(p+="  ["+T+" existing]"),p+=`
`}p+=`
...
This will create a construction contract that construction corporations can bid on. Payment occurs when the contract is awarded.`))return;jt=!0;const _=N.current_tick||0,b=(N.current_date||"").match(/\d{4}/)?.[0]||"2015";try{const{count:p}=await g.from("construction_contracts").select("id",{count:"exact",head:!0}).eq("nation_id",l.id).eq("issuer_type","PRIVATE"),x=`PVT-P${(p||0)+1}-${b}`,k=u.style==="Modern",I={concrete:k?60:40,steel:k?50:30,heavy_parts:k?30:20,aggregate:k?30:20},T={trucks:5,mixers:5,excavators:5},$={general:k?240:160,skilled:k?100:60},C=k?6:4,{error:L}=await g.from("construction_contracts").insert({nation_id:l.id,template_key:t,sector:"industrial",name:u.name,project_type:i.label,project_subtype:u.style,description:`${u.name} at ${l.capital} Port — commissioned by ${f.faction_name}. ${u.desc}`,project_code:x,budget_ceiling:u.cost,timeline_ticks:C,required_materials:I,required_equipment:T,required_workforce:$,status:"open",generated_at_tick:_,bidding_ends_tick:_+3,issuer_type:"PRIVATE",issuer_name:f.faction_name,issuer_faction_id:f.id});if(L)throw L;await co(),alert(`Construction contract posted!
...
Construction corporations in `+l.name+" can now bid on this project.")}catch(p){alert("Failed to post contract: "+(p.message||"Error"))}finally{jt=!1}}window.pfOpenBuild=fn;const xi={"Bulk Cargo":["Reefer","Bulk","Coastal"],"Container Freight":["Coastal","Container"],"Specialized Transport":["Tanker","LNG","Bulk"]};async function bi(){if(!f)return;const{data:t,error:e}=await g.from("ship_market_listings").select("*, nation:nation_id(id, name)").eq("status","available").order("asking_price",{ascending:!0});e&&console.warn("Failed to load ship market:",e.message),oi=t||[],ct=null,po()}function mn(t){ct=ct===t?null:t,po()}function vn(t){return(xi[f?.corp_subsector]||[]).includes(t)}function po(){const t=document.getElementById("sm-count"),e=document.getElementById("sm-list"),i=document.getElementById("sm-footer");if(!t||!e)return;const o=oi;t.textContent=o.length+" AVAILABLE",o.length===0?e.innerHTML='<div style="flex:1;display:flex;align-items:center;justify-content:center;font-family:var(--font-mono);font-size:9px;color:var(--text-dim);text-align:center;line-height:1.8;">No vessels on the market.<br>Check back next cycle.</div>':e.innerHTML=o.map((r,n)=>{const l=ct===n,c=Ae[r.vessel_class]||{color:"#666",label:"?"},v=r.seller_type==="CORP"?"#5a8aaa":"#8b9a6b",d=ro(r.condition),m=r.nation?.name||"—",u=vn(r.vessel_class);N?.current_tick;const _=r.age_ticks||0,b=Math.max(1,Math.floor(_/12)),p=m!==f?.nation?Number(f?.tariffs||R?.tariffs||0):0,h=Math.round(r.asking_price*p/100),x=r.asking_price+h;let k=`<div onclick="smSelectListing(${n})" style="border-bottom:1px solid var(--border-0);cursor:pointer;border-left:2px solid ${l?c.color:"transparent"};background:${l?c.color+"06":"transparent"};">
    ...
    </div>`,t.innerHTML=d}let Ve=!1;async function hn(){if(Ve||!f||!N)return;const t=it.trim();if(t.length<2)return;const e=Ke.find(b=>b.cls===ae)||Ke[0],i=Me[tt];if(!i)return;const o=Math.round(e.baseCost*i.costMod),a=Math.max(2,Math.round(e.baseBuild*i.buildMod)),s=Math.round(o*.5),r=o-s,n=N.current_tick||0,l=Number(f.corp_cash_reserves??0);if(l<s){alert("Insufficient cash for deposit. Need "+E(s)+".");return}if(!confirm("Commission "+ae+" from "+i.name+`?
