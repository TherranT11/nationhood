import{_supabase as gt}from"./supabase-client-qEAQbBjE.js";/* empty css                  */import{r as ea}from"./role-actions-fros7AI4.js";import{l as aa,d as Ae,i as ia}from"./common-C-5ANF5B.js";import{g as Bt,r as oa,m as na,a as sa}from"./political-actions-DsQwKOfA.js";import{ah as K,n as pe,h as rt,ae as Et,a3 as me,d as ra,ai as la,a8 as da}from"./government-structure-BV9odx-I.js";import{GAME_CONFIG as lt,FORMATION_DEADLINE_TICKS as te}from"./config-CKNXR-qR.js";import{f as ca}from"./no-confidence-C3okxeC-.js";import{e as pa,h as ma,f as Te}from"./elections-DoBEfEfx.js";import{d as fa,c as va,s as ua,a as Tt}from"./stats-tIiBSaQA.js";import{tickToDate as ga}from"./utils-A98FEun4.js";import"./preload-helper-BXl3LOEh.js";import"./corp-topbar-CPI0igZM.js";import"./bills-7Bj9DSmc.js";import"./corp-valuation-C0hsb2EQ.js";import"./budget-DnXKdpWV.js";import"./presidential-BzziMZww.js";const xt=[{id:"economic_reform",name:"Economic Reform",icon:"📈",tagline:"Growth-first neoliberal agenda",desc:"Prioritize GDP, attract foreign capital, lower corporate taxes. The rising tide theory — grow the pie and worry about slicing it later.",improve:["gdp_growth","foreign_investment","currency_strength","credit","service_output","manufacturing_output"],worsen:["income_inequality","poverty_rate","union_strength","income_tax"],tradeoff:"Income inequality tends to rise. Working class sees GDP numbers go up while their wages don't."},{id:"social_justice",name:"Social Justice",icon:"⚖️",tagline:"Redistribution and equity",desc:"Raise minimum wage, expand welfare, progressive taxation. Close the gap between rich and poor through direct intervention.",improve:["minimum_wage","poverty_rate","income_inequality","social_mobility","healthcare_accessibility","education_accessibility"],worsen:["foreign_investment","gdp_growth","corporate_tax"],tradeoff:"Capital flight risk. Foreign investors avoid high-tax environments. Growth may slow."},{id:"national_security",name:"National Security",icon:"🛡️",tagline:"Borders, military, order",desc:"Strengthen defense, tighten borders, expand police powers. Safety through strength.",improve:["stability","crime_rate","terrorism","political_violence","illegal_immigration"],worsen:["freedom_index","press_freedom","civil_unrest","polarization"],tradeoff:"Freedom index drops. Minority communities disproportionately affected. International criticism."},{id:"anti_corruption",name:"Anti-Corruption",icon:"🔍",tagline:"Clean government, institutional reform",desc:"Independent judiciary, transparent budgets, prosecute the connected. Popular with voters but powerful people fight back hard.",improve:["corruption","judicial_independence","press_freedom","legitimacy","efficiency"],worsen:["stability"],tradeoff:"Short-term chaos as exposing corruption shakes institutions. Your own party's skeletons may surface."},{id:"green_transition",name:"Green Transition",icon:"🌱",tagline:"Climate and environment",desc:"Renewable energy investment, carbon taxes, emissions targets. Save the planet — but the bill comes due now, not later.",improve:["renewable_energy_pct","pollution","carbon_emissions","energy_generation"],worsen:["fuel_prices","manufacturing_output","gdp_growth","cost_of_living"],tradeoff:"Energy costs spike during transition. Rural and industrial voters feel abandoned."},{id:"industrialization",name:"Industrialization",icon:"🏭",tagline:"Factories, exports, production",desc:"Build manufacturing capacity, create blue-collar jobs, develop physical infrastructure. The backbone of a real economy.",improve:["manufacturing_output","labor_force_participation","unemployment","physical_infrastructure","gdp_growth"],worsen:["pollution","carbon_emissions","arable_land","healthcare_quality"],tradeoff:"Environment gets destroyed. Long-term health costs from industrial pollution."},{id:"digital_modernization",name:"Digital Modernization",icon:"💻",tagline:"Tech economy, connectivity",desc:"Fiber everywhere, tech sector incentives, digital government services. Leap into the future — but not everyone makes the jump.",improve:["digital_infrastructure","service_output","higher_education","academic_immigration","efficiency"],worsen:["manufacturing_output","labor_force_participation","income_inequality","urbanization"],tradeoff:"Automation displaces workers. Rural communities left behind. Tech wealth concentrates in cities."},{id:"welfare_state",name:"Welfare State",icon:"🏥",tagline:"Universal services, safety net",desc:"Free healthcare, free education, generous pensions, unemployment insurance. Cradle to grave — funded by steep taxes on everyone.",improve:["healthcare_quality","healthcare_accessibility","education_accessibility","poverty_rate","standard_of_living","happiness"],worsen:["income_tax","corporate_tax","gdp_growth","foreign_investment"],tradeoff:"Massive fiscal cost. Tax burden on middle class, not just the rich. Sustainability questioned."},{id:"populist_nationalism",name:"Populist Nationalism",icon:"🇲",tagline:"The people vs. elites and outsiders",desc:"Restrict immigration, protect domestic industry, reject globalism. Our people first. Our jobs first. Our culture first.",improve:["immigration","illegal_immigration","manufacturing_output","minimum_wage","union_strength"],worsen:["foreign_investment","academic_immigration","freedom_index","press_freedom","polarization","ethnic_diversity"],tradeoff:"International isolation. Brain drain as educated professionals emigrate. Deep social polarization."},{id:"free_market",name:"Free Market Liberalism",icon:"🏛️",tagline:"Deregulate everything",desc:"Cut taxes, cut red tape, let the market decide winners and losers. Government is the problem, not the solution.",improve:["gdp_growth","foreign_investment","credit","service_output","currency_strength"],worsen:["union_strength","minimum_wage","healthcare_accessibility","income_inequality","poverty_rate"],tradeoff:"Growth at the cost of the working class. Social safety net erodes. Boom-bust volatility."},{id:"law_and_order",name:"Law & Order",icon:"⚔️",tagline:"Tough on crime, strong institutions",desc:"More police, harsher sentences, zero tolerance. Restore order to the streets. Criminals fear the state.",improve:["crime_rate","stability","political_violence","terrorism","drug_use"],worsen:["incarceration_rate","freedom_index","civil_unrest"],tradeoff:"Prison population explodes. Minority communities targeted. Policing costs balloon."},{id:"education_first",name:"Education First",icon:"🎓",tagline:"Human capital as the long game",desc:"Fund schools, universities, research institutions, teacher salaries. The 20-year bet that the next generation will be smarter and richer.",improve:["literacy","higher_education","education_accessibility","academic_immigration","social_mobility","labor_force_participation"],worsen:["income_tax","gdp_growth"],tradeoff:"Voters don't see results before next election. Brain drain if jobs don't exist for graduates."},{id:"healthcare_reform",name:"Healthcare Reform",icon:"💊",tagline:"Fix the hospitals",desc:"More beds, more doctors, better drugs, universal coverage. Nobody dies because they can't afford treatment.",improve:["healthcare_quality","healthcare_accessibility","beds_per_100k","lifespan","drug_use"],worsen:["income_tax","gdp_growth","cost_of_living"],tradeoff:"Pharmaceutical lobby fights back. Extremely expensive. Takes multiple cycles to show results."},{id:"housing_cost",name:"Housing & Cost of Living",icon:"🏠",tagline:"The kitchen-table platform",desc:"Rent controls, public housing, affordable food, price caps on essentials. People can't eat GDP growth.",improve:["housing_affordability","cost_of_living","standard_of_living","physical_infrastructure","urbanization"],worsen:["foreign_investment","gdp_growth"],tradeoff:"Property owners and developers become your enemies. Market distortions create shortages."},{id:"energy_independence",name:"Energy Independence",icon:"⛽",tagline:"Control your own power supply",desc:"Exploit domestic oil, gas, and minerals. No more dependency on foreign energy. Cheap fuel, strong economy, sovereign power.",improve:["energy_generation","oil_and_gas","rare_minerals","fuel_prices","manufacturing_output","gdp_growth"],worsen:["pollution","carbon_emissions","renewable_energy_pct","arable_land"],tradeoff:"Climate commitments broken. Green voters abandon you. Environmental debt for future generations."},{id:"open_society",name:"Open Society",icon:"🕊️",tagline:"Liberal democracy, civil liberties",desc:"Free press, open borders, multicultural embrace, strong civil rights. A beacon of freedom — and a target for those who fear it.",improve:["freedom_index","press_freedom","immigration","academic_immigration","ethnic_diversity","happiness","judicial_independence"],worsen:["stability","illegal_immigration","polarization","terrorism"],tradeoff:"Nationalist backlash. Rural-urban divide deepens. Security vulnerabilities from openness."}],ye={gdp_growth:"GDP Growth",inflation:"Inflation",interest_rates:"Interest Rates",currency_strength:"Currency Strength",foreign_investment:"Foreign Investment",credit:"Credit",income_tax:"Income Tax",corporate_tax:"Corporate Tax",sales_tax:"Sales Tax",unemployment:"Unemployment",labor_force_participation:"Labor Force Participation",minimum_wage:"Minimum Wage",union_strength:"Union Strength",poverty_rate:"Poverty Rate",income_inequality:"Income Inequality",healthcare_quality:"Healthcare Quality",healthcare_accessibility:"Healthcare Accessibility",beds_per_100k:"Beds per 100k",lifespan:"Lifespan",drug_use:"Drug Use",literacy:"Literacy",higher_education:"Higher Education",education_accessibility:"Education Accessibility",academic_immigration:"Academic Immigration",physical_infrastructure:"Physical Infrastructure",digital_infrastructure:"Digital Infrastructure",urbanization:"Urbanization",energy_generation:"Energy Generation",renewable_energy_pct:"Renewable Energy %",arable_land:"Arable Land",rare_minerals:"Rare Minerals",oil_and_gas:"Oil & Gas",fuel_prices:"Fuel Prices",pollution:"Pollution",carbon_emissions:"Carbon Emissions",standard_of_living:"Standard of Living",happiness:"Happiness",social_mobility:"Social Mobility",crime_rate:"Crime Rate",incarceration_rate:"Incarceration Rate",religiosity:"Religiosity",stability:"Stability",legitimacy:"Legitimacy",efficiency:"Efficiency",corruption:"Corruption",press_freedom:"Press Freedom",judicial_independence:"Judicial Independence",freedom_index:"Freedom Index",polarization:"Polarization",civil_unrest:"Civil Unrest",terrorism:"Terrorism",political_violence:"Political Violence",immigration:"Immigration",illegal_immigration:"Illegal Immigration",emigration:"Emigration",ethnic_diversity:"Ethnic Diversity",cost_of_living:"Cost of Living",housing_affordability:"Housing Affordability",manufacturing_output:"Manufacturing Output",service_output:"Service Output"},fe=new Set(["inflation","unemployment","poverty_rate","income_inequality","drug_use","pollution","carbon_emissions","crime_rate","incarceration_rate","corruption","polarization","civil_unrest","terrorism","political_violence","illegal_immigration","emigration","cost_of_living","fuel_prices"]),ya=new Set(["income_tax","corporate_tax","sales_tax"]);function be(e,t){const a=fe.has(e),i=ya.has(e);return t==="improve"?a?{arrow:"↓",color:"#5cc55c"}:i?{arrow:"↑",color:"#c84"}:{arrow:"↑",color:"#5cc55c"}:a?{arrow:"↑",color:"#c55"}:i?{arrow:"↓",color:"#5cc55c"}:{arrow:"↓",color:"#c55"}}function xe(e){switch(e){case 0:return{momentum:12,penalty:0,label:"+12",color:"#5cc55c",note:"Unclaimed — full momentum"};case 1:return{momentum:6,penalty:6,label:"+6",color:"#ca5",note:"Contested by 1 rival — reduced momentum"};case 2:return{momentum:4,penalty:4,label:"+4",color:"#c84",note:"Crowded (2 rivals) — minimal momentum"};default:return{momentum:2,penalty:2,label:"+2",color:"#c84",note:`Crowded (${e} rivals) — minimal momentum`}}}function ba(e,t){return e.map(a=>{const i=xt.find(o=>o.id===a.platform_key);if(!i)return{...a,stats:[]};const n=i.improve.map(o=>{const r=a.baseline_stats?.[o],c=a.target_stats?.[o],d=Number(t?.[o]??50),l=fe.has(o);if(r==null||c==null)return{stat:o,baseline:d,target:d,current:d,progress:0,met:!1};const m=Math.abs(c-r),s=l?Math.max(0,r-d):Math.max(0,d-r),p=m>0?Math.min(1,s/m):1,f=l?d<=c:d>=c;return{stat:o,baseline:r,target:c,current:d,progress:p,met:f}});return{...a,stats:n,platformDef:i}})}const xa=["Former union organizer. Knows how to mobilize a crowd.","Disbarred attorney. Understands the legal system from the inside.","Investigative journalist. Uncovered three government scandals before going private.","Ex-military intelligence. Trained in information warfare.","Community activist. Built grassroots networks across two provinces.","Former government auditor. Knows where the money hides.","Political science professor. Publishes on institutional corruption.","NGO director. Ran anti-corruption campaigns across the continent.","Former prosecutor. Left the justice ministry over political interference.","Labor rights campaigner. Organized the dockworkers' strike of 2014.","Freelance political consultant. Has worked for opposition parties in three nations.","Student movement leader. Led the university protests. Young and fearless.","Retired diplomat. Leverages international connections for domestic pressure.","Whistleblower advocate. Runs a secure tip line used by civil servants.","Former police detective. Turned against the system after a cover-up."];function vt(e){return e>=75?{label:"Exceptional",color:"#5cc55c",desc:"Elite operative. Lawsuits are devastating, intelligence is razor-sharp."}:e>=60?{label:"Strong",color:"#a3b07e",desc:"Experienced and reliable. Can handle most opposition tasks effectively."}:e>=45?{label:"Competent",color:"#ca5",desc:"Gets the job done. Occasional missteps under pressure."}:e>=30?{label:"Developing",color:"#c84",desc:"Green but eager. Results are inconsistent. Cheap to hire."}:{label:"Weak",color:"#c55",desc:"Liability risk. May botch sensitive operations. Rock-bottom price for a reason."}}function ha(e){var t=Math.max(0,e-20)/65,a=12e4+t*28e4;return Math.round(a/25e3)*25e3}function jt(e,t){return e+Math.floor(Math.random()*(t-e+1))}function he(e){return e[Math.floor(Math.random()*e.length)]}function _a(e,t){var a=[],i=new Set,n=jt(5,7),o=Bt(t),r=o.firstNames||[],c=o.lastNames||[];if(r.length===0||c.length===0)return[];for(var d=xa.slice().sort(function(){return Math.random()-.5}),l=0;l<n;l++){var m,s,p,f=0;do m=he(r),s=he(c),p=m+" "+s,f++;while(i.has(p)&&f<20);i.add(p);var v=jt(20,85),g=jt(25,60),h=d[l%d.length],x=ha(v);a.push({nation_id:e,first_name:m,last_name:s,age:g,skill:v,background:h,hire_cost:x,status:"available"})}return a.sort(function(b,u){return u.skill-b.skill}),a}async function Ne(e,t,a){var{data:i}=await e.from("nations").select("government_type").eq("id",t).maybeSingle();if(K(i)){var{data:n}=await e.from("factions").select("seats").eq("id",a).maybeSingle();return ee({partyId:a,partySeats:n?.seats,admin:null,ministryHolder:!1,nation:i})}var[o,r]=await Promise.all([pe(e,t).catch(function(g){return console.warn("[Agitator] fetchActiveCoalition failed:",g?.message||g),null}),e.from("administrations").select("id, coalition_parties, stats_at_start, started_at_tick, pm_party_id, pm_party_name, president_party_id").eq("nation_id",t).is("ended_at_tick",null).order("started_at_tick",{ascending:!1}).limit(1).maybeSingle()]);if(r.error)return console.error("[Agitator] Failed to check governing status:",r.error.message),{isGoverning:!1,isOpposition:!0,label:"OPPOSITION",administration:null};var c=r.data,d=o,l=rt(i),m=l?"president_party_id":"pm_party_id",s=Array.isArray(d?.party_ids)?d.party_ids.map(function(g){return{party_id:g}}):[];if(c&&d){!c[m]&&d.lead_party_id&&(c[m]=d.lead_party_id);var p=Array.isArray(c.coalition_parties)?c.coalition_parties:[];p.length===0&&s.length>0&&(c.coalition_parties=s)}else!c&&d&&(c={pm_party_id:null,president_party_id:null,coalition_parties:s},c[m]=d.lead_party_id||null);var f=!1;if(l){var{count:v}=await e.from("ministries").select("*",{count:"exact",head:!0}).eq("nation_id",t).eq("party_id",a).eq("is_active",!0);f=(v||0)>0}return ee({partyId:a,partySeats:null,admin:c,ministryHolder:f,nation:i})}function wa(e,t,a,i){return ee({partyId:e?.id,partySeats:e?.seats,admin:t,ministryHolder:a?a.has(e?.id):!1,nation:i})}function ee({partyId:e,partySeats:t,admin:a,ministryHolder:i,nation:n}){if(K(n)){var o=Number(t||0)>=1;return{isGoverning:o,isOpposition:!o,label:o?"LOYAL":"DISSIDENT",administration:null}}if(!a)return{isGoverning:!1,isOpposition:!0,label:"OPPOSITION",administration:null};var r=Array.isArray(a.coalition_parties)?a.coalition_parties:[],c=r.some(function(s){return s?typeof s=="string"?s===e:typeof s=="object"?(s.party_id||s.id)===e:!1:!1}),d=a.pm_party_id===e,l=a.president_party_id===e,m=d||c||l||rt(n)&&!!i;return{isGoverning:m,isOpposition:!m,label:m?"GOVERNING":"OPPOSITION",administration:a}}async function ze(e,t){var{data:a,error:i}=await e.from("faction_agitators").select("*").eq("faction_id",t).eq("status","active").maybeSingle();return i?(console.error("[Agitator] Failed to fetch agitator:",i.message),null):a}async function $a(e,t,a){var{data:i,error:n}=await e.from("agitator_pool").select("*").eq("nation_id",t).eq("status","available").order("skill",{ascending:!1});if(n)return console.error("[Agitator] Failed to fetch pool:",n.message),[];if(i&&i.length>0)return i;var o=_a(t,a),{data:r,error:c}=await e.from("agitator_pool").insert(o).select("*");return c?(console.error("[Agitator] Failed to insert pool:",c.message),[]):(r||[]).sort(function(d,l){return l.skill-d.skill})}async function ka(e,t,a,i){var n=await ze(e,t);if(n)return{success:!1,agitator:null,error:"You already have an active agitator."};var{data:o,error:r}=await e.from("faction_agitators").insert({faction_id:t,first_name:a.first_name,last_name:a.last_name,age:a.age,skill:a.skill,background:a.background,status:"active",hired_at_tick:i}).select("*").single();if(r)return console.error("[Agitator] Failed to hire:",r.message),{success:!1,agitator:null,error:r.message};var{error:c}=await e.from("agitator_pool").update({status:"hired",hired_by_faction_id:t}).eq("id",a.id);return c&&console.error("[Agitator] Failed to mark pool candidate as hired:",c.message),{success:!0,agitator:o,error:null}}const Nt=[{key:"finance",label:"Finance",icon:"💰"},{key:"defense",label:"Defense",icon:"🛡️"},{key:"education",label:"Education",icon:"🎓"},{key:"healthcare",label:"Health",icon:"🏥"},{key:"interior",label:"Interior",icon:"🏛️"},{key:"foreign",label:"Foreign",icon:"🌐"},{key:"justice",label:"Justice",icon:"⚖️"},{key:"labor",label:"Labor",icon:"🔨"},{key:"trade",label:"Trade",icon:"📦"},{key:"energy",label:"Energy",icon:"⚡"},{key:"transportation",label:"Transport",icon:"🚂"},{key:"agriculture",label:"Agriculture",icon:"🌾"}],Re=[{key:"misuse_of_funds",label:"Misuse of Public Funds",desc:"Alleging budget went somewhere it shouldn't."},{key:"civil_rights",label:"Violation of Civil Rights",desc:"Alleging government overreach or suppression."},{key:"negligence",label:"Breach of Duty / Negligence",desc:"Alleging a ministry failed its mandate."},{key:"corruption",label:"Corruption / Self-Dealing",desc:"Alleging officials enriched themselves."}];function ve(e){return e<=5?{tier:1,label:"Clean Government",color:"#c55"}:e<=10?{tier:2,label:"Minor Corruption",color:"#ca5"}:e<=20?{tier:3,label:"Significant Corruption",color:"#c84"}:{tier:4,label:"Systemic Corruption",color:"#5cc55c"}}const nt={1:{resolution:"FRIVOLOUS SUIT",filer:{momentum:-5,governance:-2},gov:{momentum:3,governance:1}},2:{resolution:"PARTIAL WIN",filer:{momentum:3,governance:0},gov:{momentum:-2,governance:-2}},3:{resolution:"MAJOR WIN",filer:{momentum:7,governance:2},gov:{momentum:-5,governance:-5}},4:{resolution:"DEVASTATING WIN",filer:{momentum:12,governance:5},gov:{momentum:-10,governance:-8}}},_e={1:{filing:"{party} files lawsuit against {ministry} alleging {basis}.",discovery:"Lawsuit discovery phase produces routine documents. No irregularities found in {ministry}.",evidence:"Legal team reviews {ministry} records. Auditors confirm standard procedures.",pre_trial:"Judge signals skepticism toward {party}'s claims. Case appears thin.",resolution:"{ministry} lawsuit dismissed. Courts find no evidence of wrongdoing. {party} criticized for wasting court resources."},2:{filing:"{party} files lawsuit against {ministry} alleging {basis}.",discovery:"{party}'s lawsuit uncovers irregular procurement contracts in {ministry}.",evidence:"Documents reveal {ministry} awarded no-bid contracts to connected firms.",pre_trial:"Judge allows case to proceed. {ministry} officials ordered to testify.",resolution:"{ministry} lawsuit concludes with partial ruling. Irregular contracts confirmed but no criminal charges filed."},3:{filing:"{party} files lawsuit against {ministry} alleging {basis}.",discovery:"{party}'s lawsuit exposes hidden accounts linked to {ministry} officials.",evidence:"Leaked documents show systematic overbilling in {ministry}. Millions unaccounted for.",pre_trial:"Multiple {ministry} officials refuse to testify. Judge threatens contempt.",resolution:"{ministry} scandal confirmed. Court finds evidence of systematic corruption. {party} vindicated."},4:{filing:"{party} files lawsuit against {ministry} alleging {basis}.",discovery:"{party}'s lawsuit reveals {ministry} ran parallel budget invisible to parliament.",evidence:"Court-ordered audit exposes network of shell companies receiving {ministry} funds.",pre_trial:"Prosecutors request criminal referral. Multiple {ministry} officials implicated.",resolution:"Devastating verdict: {ministry} operated criminal enterprise. Officials face prosecution. Government in crisis."}};function wt(e,t){var a=e;for(var i in t)a=a.split("{"+i+"}").join(t[i]);return a}async function Ea(e,t){var{factionId:a,nationId:i,agitatorId:n,targetMinistry:o,basis:r,currentTick:c,partyName:d,administration:l}=t,m,s,p;if(r==="civil_rights"){var f=Number(l?.stats_at_start?.freedom_index??50),{data:v,error:g}=await e.from("nations").select("freedom_index").eq("id",i).single();if(g)return{success:!1,lawsuit:null,tier:0,error:"Failed to fetch freedom index data."};s=Number(v?.freedom_index??50),m=f,p=Math.max(0,m-s)}else{var h=Number(l?.stats_at_start?.corruption??50),{data:v,error:g}=await e.from("nations").select("corruption").eq("id",i).single();if(g)return{success:!1,lawsuit:null,tier:0,error:"Failed to fetch corruption data."};s=Number(v?.corruption??50),m=h,p=Math.max(0,s-m)}var h=m,x=s,b=ve(p),u=nt[b.tier],$=c+8,L=Nt.find(function(R){return R.key===o}),M=L?"Ministry of "+L.label:o,C=Re.find(function(R){return R.key===r}),k=C?C.label:r,{data:I,error:z}=await e.from("lawsuits").insert({faction_id:a,nation_id:i,agitator_id:n,target_ministry:o,basis:r,filed_at_tick:c,resolves_at_tick:$,corruption_at_start:h,corruption_at_filing:x,corruption_growth:p,tier:b.tier,status:"active",resolution:null,momentum_effect:u.filer.momentum,governance_effect:u.filer.governance,gov_momentum_effect:u.gov.momentum,gov_governance_effect:u.gov.governance}).select("*").single();if(z)return{success:!1,lawsuit:null,tier:0,error:z.message};var E=_e[b.tier]||_e[1],P={party:d||"Opposition",ministry:M,basis:k},S=[{event_tick:c,event_type:"filing",headline:wt(E.filing,P)},{event_tick:c+2,event_type:"discovery",headline:wt(E.discovery,P)},{event_tick:c+5,event_type:"evidence",headline:wt(E.evidence,P)},{event_tick:c+7,event_type:"pre_trial",headline:wt(E.pre_trial,P)},{event_tick:$,event_type:"resolution",headline:wt(E.resolution,P)}],A=S.map(function(R){return{lawsuit_id:I.id,nation_id:i,event_tick:R.event_tick,event_type:R.event_type,headline:R.headline,is_fired:R.event_tick===c}}),{error:N}=await e.from("lawsuit_events").insert(A);N&&console.error("[Lawsuits] Failed to insert milestone events:",N.message);var{error:T}=await e.from("event_log").insert({nation_id:i,event_name:"LAWSUIT FILED",event_type:"lawsuit",category:"political",description_chosen:S[0].headline,fired_at_tick:c,faction_id:a||null,effects_applied:{lawsuit_id:I.id,tier:b.tier,target_ministry:M,basis:k,milestone:"filing"}});return T&&console.warn("[Lawsuits] event_log insert (filing) failed:",T.message),{success:!0,lawsuit:I,tier:b.tier,error:null}}async function Ca(e,t){var{data:a,error:i}=await e.from("lawsuits").select("*").eq("faction_id",t).order("filed_at_tick",{ascending:!1}).limit(10);return i?(console.error("[Lawsuits] Failed to fetch lawsuits:",i.message),[]):a||[]}let w=null,y=null,X="leader",et=[],zt=[],j=null,D=null,pt=!1,F=null,ae=[],bt=!1,G=null,at=!1,kt=[],Mt=!1,qt=!1,Pt=new Set;function _(e){if(!e)return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML}function Q(e,t){return((e||"?")[0]+(t||"?")[0]).toUpperCase()}const Fe=[{id:"leader",title:"LEADER",fullTitle:"Party Leader",color:"#c8a832"},{id:"deputy",title:"DEPUTY",fullTitle:"Deputy Party Leader",color:"#8b9a6b"},{id:"chief",title:"CHIEF OF STAFF",fullTitle:"Chief of Staff",color:"#5cc55c"},{id:"campaign",title:"CAMPAIGN MGR",fullTitle:"Campaign Manager",color:"#c84"},{id:"comms",title:"COMMS DIR",fullTitle:"Communications Director",color:"#5a8aaa"},{id:"agitator",title:"AGITATOR",fullTitle:"Opposition Coordinator",color:"#d44a4a",oppositionOnly:!0}],Ht=[{perSeat:5e3,momDivisor:10},{perSeat:4e3,momDivisor:8},{perSeat:3e3,momDivisor:6},{perSeat:2e3,momDivisor:5},{perSeat:1e3,momDivisor:5}];let mt=0,Rt=0,ie=!1;async function Ia(){if(!w||!y?.faction?.id||!y?.shard?.current_tick)return;const{count:e,error:t}=await w.from("campaign_actions").select("id",{count:"exact",head:!0}).eq("party_id",y.faction.id).eq("action_type","fundraise").eq("tick_performed",y.shard.current_tick);mt=!t&&e!=null?e:0}async function Ma(){if(Rt=0,ie=!1,!w||!y?.nation?.id||!y?.shard?.current_tick)return;const e=y.shard.current_tick,t=F?.pm_party_id;try{const{data:a}=await w.from("bills").select("id").eq("nation_id",y.nation.id).eq("bill_type","no_confidence").in("status",["committee","floor"]).limit(1);if(ie=!!(a&&a.length),t){const{data:i}=await w.from("campaign_actions").select("tick_performed").eq("nation_id",y.nation.id).eq("action_type","no_confidence_filed").eq("target_id",t).order("tick_performed",{ascending:!1}).limit(1).maybeSingle();if(i){const n=e-Number(i.tick_performed||0),o=typeof lt<"u"&&lt.NO_CONFIDENCE_COOLDOWN_TICKS||12;Rt=Math.max(0,o-n)}}}catch(a){console.warn("[PartyActions] loadNoConfidenceState failed:",a?.message||a)}}function Oe(e,t){const a=Ht[Math.min(t,Ht.length-1)],i=e*a.perSeat,n=Math.max(1,Math.floor(e/a.momDivisor));return{raised:i,momCost:n,perSeat:a.perSeat,tierIdx:Math.min(t,Ht.length-1)}}const Be=[{id:"fundraise",name:"Fundraise",desc:"Raise party funds proportional to your seat count. Each use yields less money and costs more momentum. Momentum cannot drop below 1.",cost:"MOMENTUM",costColor:"#c84",moneyCost:0,tags:["FINANCIAL","CAMPAIGN"],locked:!1},{id:"statement",name:"Issue Statement",desc:"Public declaration on an issue. Shifts party positioning and voter bloc reactions. Media covers it. Other parties may respond.",cost:"$20k",costColor:"#c8a832",moneyCost:2e4,tags:["PUBLIC","NARRATIVE"],locked:!1},{id:"platform",name:"Set Party Platform",desc:"Choose a political focus. Defines which stats you promise to change. Awards momentum based on how many rivals share the same platform.",cost:"$120k",costColor:"#c8a832",moneyCost:12e4,tags:["STRATEGIC"],locked:!1},{id:"call_early_elections",name:"Call Early Elections",desc:"Dissolve the legislature and call snap elections. PM-only. Government enters caretaker status; election fires after a short formation window. Momentum impact is tiered by Gov. Approval: >50 boosts PM party (+3), <35 boosts opposition (+5 each) and +3 stability, 35–50 is neutral.",cost:"$0",costColor:"var(--text-dim)",moneyCost:0,tags:["LEGISLATIVE","PM ONLY"],locked:!1},{id:"resign_as_pm",name:"Resign as Prime Minister",desc:"Step down from the Prime Minister seat. PM-only. Coalition enters caretaker status and has a 3-tick window to nominate a successor via the cabinet panel. If a new PM is installed the administration continues under new leadership; otherwise a snap election fires. Cost: −3 Momentum, −0.05 Credibility, −3 Stability, 12-tick bar from PM on your party.",cost:"$0",costColor:"var(--text-dim)",moneyCost:0,tags:["GOVERNMENT","PM ONLY"],locked:!1},{id:"no_confidence",name:"Vote of No Confidence",desc:"File a motion of no confidence against the Prime Minister. If a simple majority votes YES, the government falls and snap elections are triggered. PASS: +15 Momentum to you, -10 Momentum + -10 Governance to the PM’s party. FAIL: -10 Momentum to you. 12-tick cooldown on the targeted PM party.",cost:"$0",costColor:"var(--text-dim)",moneyCost:0,tags:["LEGISLATIVE","OPPOSITION"],locked:!1},{id:"leave_coalition",name:"Leave Coalition",desc:"Walk out of the current governing coalition. Any ministries your party holds are vacated. You drop from governing to opposition. Coalition flips to minority if your exit drops it below the majority threshold. Cost: −3 Momentum to you, −5 Momentum to the PM’s party. 12-tick cooldown. PM’s party cannot use this — resign first.",cost:"−3 MOM",costColor:"#c84",moneyCost:0,tags:["GOVERNMENT","RISKY"],locked:!1},{id:"disband_party",name:"Disband Party",desc:"Voluntarily dissolve your party. Your seats are vacated and sit empty until the next election (no backfill or redistribution). All party funds and momentum are lost. You are removed from every nation chat. Cannot be undone. 24-tick cooldown per user. Cannot be used while Prime Minister, sitting President, or reigning Monarch — step down first.",cost:"IRREVERSIBLE",costColor:"#c55",moneyCost:0,tags:["IRREVERSIBLE"],locked:!1}],Sa=[{id:"fundraise",name:"Fundraise",desc:"Raise royal treasury funds proportional to your seat count. Each use yields less money and costs more momentum.",cost:"MOMENTUM",costColor:"#c84",moneyCost:0,tags:["FINANCIAL","CAMPAIGN"],locked:!1},{id:"grant_seats",name:"Grant Seats",desc:"Grant parliamentary seats to a noble house. Sharing power increases legitimacy (+0.5 per seat). Hoarding >70% of seats causes tyranny decay.",cost:"FREE",costColor:"#5cc55c",moneyCost:0,tags:["ROYAL","STRUCTURAL"],locked:!1},{id:"revoke_seats",name:"Revoke Seats",desc:"Revoke seats from a noble house. Costs $100k and -1 Legitimacy per seat revoked. Use sparingly — the people do not forget.",cost:"$100k/seat",costColor:"#d44a4a",moneyCost:1e5,tags:["ROYAL","OFFENSIVE"],locked:!1},{id:"statement",name:"Royal Decree",desc:"Issue a public declaration on an issue. Shifts positioning and voter bloc reactions. Media covers it.",cost:"$20k",costColor:"#c8a832",moneyCost:2e4,tags:["PUBLIC","NARRATIVE"],locked:!1},{id:"appoint_pm",name:"Appoint Prime Minister",desc:"Choose a party to lead the government as Prime Minister. The PM can then assign cabinet ministries. You may appoint your own party.",cost:"FREE",costColor:"#5cc55c",moneyCost:0,tags:["ROYAL","STRUCTURAL"],locked:!1}],Dt={PUBLIC:"#8b9a6b",NARRATIVE:"#5a8aaa",STRATEGIC:"#c8a832",INTERNAL:"#c84",COALITION:"#5aaa8a",RISKY:"#c55",PARLIAMENTARY:"#8b9a6b",FINANCIAL:"#5a8aaa",INTELLIGENCE:"#5a8aaa",DEFENSIVE:"#5cc55c",CAMPAIGN:"#c84",VOTER:"#c8a832",OFFENSIVE:"#c84",REACTIVE:"#ca5",STRUCTURAL:"#9e9a92",ROYAL:"#c8a832",LEGAL:"#5a8aaa"},we=[{id:"economy",label:"Economy & Jobs",icon:"💰"},{id:"healthcare",label:"Healthcare",icon:"🏥"},{id:"education",label:"Education",icon:"🎓"},{id:"security",label:"National Security",icon:"🛡️"},{id:"environment",label:"Environment",icon:"🌱"},{id:"corruption",label:"Anti-Corruption",icon:"🔍"},{id:"infrastructure",label:"Infrastructure",icon:"🏗️"},{id:"immigration",label:"Immigration",icon:"🌐"},{id:"housing",label:"Housing & Cost of Living",icon:"🏠"},{id:"crime",label:"Crime & Justice",icon:"⚖️"},{id:"labor",label:"Labor & Workers",icon:"🔨"},{id:"foreign_policy",label:"Foreign Policy",icon:"🕊️"}],$e=["{party_name} Calls for Action on {topic}","{leader_name}: '{topic}' Must Be National Priority","{leader_name} Pledges Bold Agenda on {topic}","{party_name} Leader Addresses Nation on {topic}"];async function De(e,t){w=e,y=t;const a=document.getElementById("pa-actions-root");if(!a)return;const i=t.faction;if(!i){a.innerHTML='<div style="display:flex;align-items:center;justify-content:center;min-height:300px;color:var(--text-dim);">No faction data.</div>';return}try{const{data:s}=await w.from("factions").select("momentum, party_funds, seats, action_points, bloc_id").eq("id",i.id).single();s&&(i.momentum=s.momentum??i.momentum,i.party_funds=s.party_funds??i.party_funds,i.seats=s.seats??i.seats,i.action_points=s.action_points??i.action_points,i.bloc_id=s.bloc_id??null)}catch(s){console.warn("[PartyActions] faction refresh failed, using cached state:",s)}const[n,o,r,c,d,l]=await Promise.all([w.from("faction_platforms").select("*").eq("faction_id",i.id).order("slot"),w.from("faction_platforms").select("*").eq("nation_id",t.nation?.id),ze(w,i.id),Ne(w,t.nation?.id,i.id),w.from("faction_electoral_standing").select("ideological_alignment, visibility, raw_appeal").eq("faction_id",i.id).eq("nation_id",t.nation?.id).maybeSingle(),pe(w,t.nation?.id)]);t.nation&&(t.nation.__coalition_status=l?.status||null),n.error&&console.error("[PartyActions] Failed to load faction platforms:",n.error.message),o.error&&console.error("[PartyActions] Failed to load nation platforms:",o.error.message),et=n.data||[],zt=o.data||[],j=r,pt=c.isOpposition,F=c.administration,d.data,await Ia(),await Ma();const{data:m}=await w.from("faction_deputies").select("*").eq("faction_id",i.id).eq("status","active").maybeSingle();D=m||null,j&&(ae=await Ca(w,i.id)),await Ct(i.id,t.nation?.id),H(a)}function Ge(e){return e?{isPM:!!F&&F.pm_party_id===e.id,isPresident:y?.nation?.hos_election_method==="elected"&&F?.president_party_id===e.id,isMonarchActing:K(y?.nation)&&y?.nation?.monarch_faction_id===e.id}:{isPM:!1,isPresident:!1,isMonarchActing:!1}}async function Ct(e,t){if(!e||!t){G=null,at=!1,kt=[];return}try{const{data:a,error:i}=await w.from("bloc_invitations").select("id, bloc_id, invited_by_faction_id, created_at_tick, status, bloc:bloc_id(id,name,leader_faction_id), inviter:invited_by_faction_id(id,faction_name,party_color)").eq("invited_faction_id",e).eq("status","pending").order("created_at_tick",{ascending:!1});if(i)throw i;kt=a||[];const n=y?.faction?.bloc_id||null;if(n){const{data:o,error:r}=await w.from("blocs").select("*").eq("id",n).is("dissolved_at_tick",null).maybeSingle();if(r)throw r;if(o){const{data:c}=await w.from("factions").select("id, faction_name, seats, party_color, leader_first_name, leader_last_name").eq("bloc_id",o.id).order("seats",{ascending:!1});G={...o,members:c||[]},at=o.leader_faction_id===e}else G=null,at=!1}else G=null,at=!1}catch(a){console.warn("[PartyActions] loadBlocState failed:",a?.message||a)}}function je(e){if(!G)return"";const t=at?`<span style="margin-left:6px;font-family:var(--font-mono);font-size:7px;color:${e};letter-spacing:0.08em;">LEADER</span>`:"";return`<span class="pa-bloc-tag" style="display:inline-flex;align-items:center;padding:2px 8px;background:${e}18;border:1px solid ${e}55;color:${e};font-family:var(--font-mono);font-size:9px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;">
    ...
    </div>`}function He(e){if(!kt||kt.length===0)return"";const t=i=>(Array.isArray(i)?i[0]:i)||null;return`<div style="margin:10px 0 4px;">${kt.map(i=>{const n=t(i.bloc),o=t(i.inviter),r=n?.name||"a bloc",c=o?.faction_name||"A party leader",d=o?.party_color||e,l=Pt.has(i.id);return`<div style="margin:6px 0;padding:8px 12px;border:1px solid ${d}55;border-left:3px solid ${d};background:${d}08;display:flex;align-items:center;justify-content:space-between;gap:10px;">
            <div style="flex:1;">
                ...
                <div style="font-size:11px;color:var(--text-bright);margin-top:2px;">
                    <strong>${_(c)}</strong> invites you to join <strong>${_(r)}</strong>.
                </div>
            </div>
        ...
        </div>`}).join("")}</div>`}async function ue(e){const{data:t}=await w.from("factions").select("bloc_id, momentum").eq("id",e).single();t&&(y.faction.bloc_id=t.bloc_id||null,t.momentum!=null&&(y.faction.momentum=t.momentum))}async function La(e,t,a){try{const i=y?.faction?.id;if(!i)throw new Error("No active faction");const n=t==="accept"?"accept_bloc_invite":"decline_bloc_invite",o=t==="accept"?"p_accepting_faction_id":"p_declining_faction_id",{data:r,error:c}=await w.rpc(n,{p_invitation_id:e,[o]:i});if(c)throw c;if(r&&r.success===!1)throw new Error(r.error||"Unknown error");await ue(i),await Ct(i,y.nation?.id),H(a)}catch(i){console.error("[PartyActions] respondToBlocInvite failed:",i),alert(t==="accept"?`Could not accept invitation: ${i.message||i}`:`Could not decline invitation: ${i.message||i}`)}}async function Pa(e){if(!G||qt)return;const t=G,a=at?`Leaving ${t.name} will DISSOLVE the entire bloc. All ${t.members?.length||0} members will be removed and pending invitations rescinded.

Proceed?`:`Leave the ${t.name} bloc?`;if(confirm(a)){qt=!0;try{const{data:i,error:n}=await w.rpc("leave_bloc",{p_faction_id:y.faction.id});if(n)throw n;if(i&&i.success===!1)throw new Error(i.error||"Unknown error");await ue(y.faction.id),await Ct(y.faction.id,y.nation?.id),H(e)}catch(i){console.error("[PartyActions] leave_bloc failed:",i),alert(`Could not leave bloc: ${i.message||i}`)}finally{qt=!1}}}function Aa(e){if(!e)return[];const t=ra.map(a=>{const i=Number(e[a.key]||0);return{label:i<0?a.leftLabel:a.rightLabel,magnitude:Math.abs(i)}});return t.sort((a,i)=>i.magnitude-a.magnitude),t.slice(0,2).filter(a=>a.magnitude>0)}async function Ta(e){const t=document.getElementById("pa-bloc-modal");if(!t||G)return;const a=y.faction,i=a?.color||"#c8a832";t.innerHTML=`
    ...
    `,t.classList.add("active");const n=new Set;let o=[];const r=()=>t.classList.remove("active");document.getElementById("pa-bloc-close")?.addEventListener("click",r),document.getElementById("pa-bloc-cancel")?.addEventListener("click",r),t.addEventListener("click",s=>{s.target===t&&r()});try{const s=y.nation?.id,{data:p}=await w.from("factions").select("id, faction_name, seats, party_color, leader_first_name, leader_last_name, leader_age, bloc_id").eq("nation_id",s).eq("faction_type","party").is("abandoned_at",null),f=(p||[]).filter(b=>b.id!==a.id),v=f.map(b=>b.id),{data:g}=v.length>0?await w.from("faction_ideology").select("*").in("faction_id",v):{data:[]},h=new Map((g||[]).map(b=>[b.faction_id,b]));o=f;const x=document.getElementById("pa-bloc-party-list");if(!x)return;if(f.length===0){x.innerHTML='<div style="padding:10px;font-family:var(--font-mono);font-size:9px;color:var(--text-dim);">No other parties in this nation.</div>';return}x.innerHTML=f.map(b=>{const u=h.get(b.id),$=Aa(u),L=$.length>0?$.map(I=>`<span style="padding:1px 6px;background:var(--bg-card);border:1px solid var(--border-mid);font-family:var(--font-mono);font-size:8px;color:var(--text-secondary);">${_(I.label)}</span>`).join(" "):'<span style="font-family:var(--font-mono);font-size:8px;color:var(--text-dim);font-style:italic;">No ideology data</span>',M=b.party_color||"#7a7a7a",C=b.leader_first_name&&b.leader_last_name?`${b.leader_first_name} ${b.leader_last_name}`:"Party Leader",k=b.bloc_id?"Already in a bloc":null;return`<label class="pa-bloc-party-row" data-party-id="${_(b.id)}" data-ineligible="${k?"1":"0"}"
                style="display:flex;align-items:center;gap:10px;padding:8px 10px;border:1px solid var(--border-mid);border-left:3px solid ${M};cursor:${k?"not-allowed":"pointer"};opacity:${k?"0.45":"1"};">
                <input type="checkbox" class="pa-bloc-party-check" ${k?"disabled":""} style="margin:0;">
                <div style="flex:1;display:flex;flex-direction:column;gap:2px;">
                    <div style="display:flex;align-items:baseline;gap:8px;">
                        <span style="font-family:var(--font-mono);font-size:11px;font-weight:700;color:var(--text-bright);">${_(b.faction_name)}</span>
                        <span style="font-family:var(--font-mono);font-size:8px;color:var(--text-dim);">${b.seats||0} seats</span>
                    </div>
                    <div style="font-size:9px;color:var(--text-secondary);">${_(C)}</div>
            ...
            </label>`}).join(""),x.addEventListener("change",b=>{const u=b.target.closest(".pa-bloc-party-row");if(!u)return;if(u.dataset.ineligible==="1"){b.target.checked=!1;return}const $=u.dataset.partyId;b.target.checked?n.add($):n.delete($),m()})}catch(s){console.error("[PartyActions] Create Bloc modal fetch failed:",s);const p=document.getElementById("pa-bloc-party-list");p&&(p.innerHTML=`<div style="padding:10px;font-family:var(--font-mono);font-size:9px;color:var(--red);">Failed to load parties: ${_(s.message||String(s))}</div>`)}const c=document.getElementById("pa-bloc-name"),d=document.getElementById("pa-bloc-submit"),l=document.getElementById("pa-bloc-name-count"),m=()=>{const s=(c?.value||"").trim();l&&(l.textContent=`${s.length} / 40`),d&&(d.disabled=!(s.length>0&&n.size>0)||Mt)};c?.addEventListener("input",m),d?.addEventListener("click",async()=>{if(Mt)return;const s=(c?.value||"").trim();if(!(s.length===0||n.size===0)){Mt=!0,d.disabled=!0,d.textContent="Creating...";try{const{data:p,error:f}=await w.rpc("create_bloc",{p_leader_faction_id:a.id,p_name:s,p_invitee_faction_ids:Array.from(n)});if(f)throw f;if(p&&p.success===!1)throw new Error(p.error||"Unknown error");y.faction.party_funds=Math.max(0,(y.faction.party_funds||0)-1e5),await ue(a.id),r(),await Ct(a.id,y.nation?.id),H(e)}catch(p){console.error("[PartyActions] create_bloc failed:",p),alert(`Could not create bloc: ${p.message||p}`),d.disabled=!1,d.textContent="Create Bloc & Send Invites"}finally{Mt=!1}}})}async function Na(e){if(!G||!at)return;const t=document.getElementById("pa-bloc-modal");if(!t)return;const a=y.faction?.color||"#c8a832";t.innerHTML=`
        <div class="pa-modal" style="width:520px;max-height:75vh;overflow:hidden;display:flex;flex-direction:column;">
        ...
        </div>`,t.classList.add("active");const i=()=>t.classList.remove("active");document.getElementById("pa-blinv-close")?.addEventListener("click",i),document.getElementById("pa-blinv-cancel")?.addEventListener("click",i),t.addEventListener("click",r=>{r.target===t&&i()});const n=y.nation?.id,o=document.getElementById("pa-blinv-list");if(!(!o||!n))try{const{data:r,error:c}=await w.from("factions").select("id, faction_name, seats, party_color, bloc_id").eq("nation_id",n).eq("faction_type","party").is("abandoned_at",null).is("bloc_id",null);if(c){o.innerHTML=`<div style="padding:10px;font-family:var(--font-mono);font-size:9px;color:var(--red);">Failed to load parties: ${_(c.message)}</div>`;return}const d=(r||[]).filter(l=>l.id!==y.faction.id);if(d.length===0){o.innerHTML='<div style="padding:10px;font-family:var(--font-mono);font-size:9px;color:var(--text-dim);">No eligible parties to invite.</div>';return}o.innerHTML=d.map(l=>{const m=l.party_color||"#888";return`<div class="pa-blinv-row" data-faction-id="${_(l.id)}" style="padding:8px 10px;border:1px solid ${m}33;border-left:3px solid ${m};display:flex;justify-content:space-between;align-items:center;cursor:pointer;background:var(--bg-card);">
                <div>
            ...
            </div>`}).join(""),o.addEventListener("click",async l=>{const m=l.target.closest(".pa-blinv-send");if(!m)return;const s=m.dataset.factionId;if(s){m.disabled=!0,m.textContent="Sending…";try{const{error:p}=await w.rpc("invite_to_bloc",{p_bloc_id:G.id,p_invitee_faction_id:s});if(p)throw p;m.textContent="Invited",await Ct(y.faction.id,y.nation?.id),H(e)}catch(p){console.warn("[PartyActions] invite_to_bloc failed:",p),alert(`Could not invite: ${p.message||p}`),m.disabled=!1,m.textContent="Invite"}}})}catch(r){console.warn("[PartyActions] openInviteToBlocModal threw:",r),o.innerHTML='<div style="padding:10px;font-family:var(--font-mono);font-size:9px;color:var(--red);">Unexpected error.</div>'}}function H(e){const t=y.faction,a=y.nation,i=K(a),n=i&&a?.monarch_faction_id===t?.id,o=t.color||"#c8a832",r=t.leader_first_name&&t.leader_last_name?`${t.leader_first_name} ${t.leader_last_name}`:"Unknown Leader",c=t.seats||0,d=a?.total_seats||120,l=d>0?Math.round(c/d*100):0;t.action_points,t.approval_rating;const m=t.momentum??50,s=t.party_funds??0,p=ba(et,a),f=[];for(let x=1;x<=3;x++){const b=et.find(u=>u.slot===x);if(b){const u=xt.find(C=>C.id===b.platform_key),$=p.find(C=>C.id===b.id),L=$?$.stats.filter(C=>C.met).length:0,M=$?$.stats.length:0;f.push({name:u?.name||b.platform_key,status:b.status,metCount:L,totalCount:M,slot:x})}else f.push(null)}const v=f.map(x=>{if(!x)return{label:"No Platform"};const b=x.status==="fulfilled"?" ✓":x.status==="failed"?" ✗":x.status==="abated"?" —":"",u=x.status==="fulfilled"?"fulfilled":x.status==="failed"?"failed":x.status==="abated"?"abated":"filled",$=x.totalCount>0?` (${x.metCount}/${x.totalCount})`:"";return{label:x.name+$+b,statusClass:u,title:`${x.metCount} of ${x.totalCount} stats on target`}}),g="$"+(s>=1e6?(s/1e6).toFixed(1)+"M":s>=1e3?Math.round(s/1e3)+"k":s),h=Math.round(Number(i?y.nation?.legitimacy??y.nation?.gov_approval??50:y.nation?.gov_approval??0));ea(e,{title:n?"Royal Court":"Party Actions",entityName:t.faction_name,entityColor:o,stats:[{label:"Party Funds",value:g,color:"var(--accent)"},{label:"Momentum",value:Number(m).toFixed(1),color:m>0?"var(--text-bright)":"var(--red)"},{label:i?"Legitimacy":"Nat. Approval",value:String(h),color:"var(--green)"}],statusBarItems:[{type:"count",label:"Seats",big:String(c),bigColor:o,dim1:`/ ${d}`,dim2:`(${l}%)`},{type:"list",label:"Platforms",items:v}],rolesContainerId:"pa-leaders",panelContainerId:"pa-actions-panel",extraHtml:`
        ...
        `}),document.getElementById("pa-leaders").innerHTML=za(r,o,t),document.getElementById("pa-actions-panel").innerHTML=Ra(r,o,t),document.getElementById("pa-leaders")?.addEventListener("click",x=>{const b=x.target.closest(".pa-leader-card");if(!b||b.classList.contains("vacant"))return;const u=b.dataset.role;u&&u!==X&&(X=u,H(e))}),document.getElementById("pa-actions-panel")?.addEventListener("click",x=>{const b=x.target.closest(".pa-action-item");if(!b||b.classList.contains("locked"))return;const u=b.dataset.actionId;u==="fundraise"?oi(e):u==="grant_seats"?Xa(e):u==="revoke_seats"?Qa(e):u==="rally"?Ga(e):u==="statement"?ni(e):u==="platform"?si(e):u==="file_lawsuit"?Wa(e):u==="appoint_pm"?Ja(e):u==="modernize"?qa(e):u==="rebrand"?Ha(e):u==="no_confidence"?ii():u==="call_early_elections"?Za():u==="resign_as_pm"?ei():u==="leave_coalition"?ti():u==="disband_party"?ai():u==="create_bloc"?Ta(e):u==="leave_bloc"?Pa(e):u==="invite_to_bloc"&&Na(e)}),document.getElementById("pa-actions-panel")?.addEventListener("click",async x=>{const b=x.target.closest(".pa-bloc-invite-btn");if(!b)return;const u=b.dataset.inviteId,$=b.dataset.decision;if(!(!u||!$)&&!Pt.has(u)){Pt.add(u);try{await La(u,$,e)}finally{Pt.delete(u)}}}),document.getElementById("pa-hire-agitator-btn")?.addEventListener("click",()=>Ie(e)),document.getElementById("pa-hire-agitator-panel")?.addEventListener("click",x=>{x.target.closest("#pa-hire-agitator-btn")||Ie(e)}),document.getElementById("pa-hire-deputy-btn")?.addEventListener("click",()=>Ee(e)),document.getElementById("pa-hire-deputy-panel")?.addEventListener("click",x=>{x.target.closest("#pa-hire-deputy-btn")||Ee(e)})}function za(e,t,a){const i=K(y.nation)&&y.nation?.monarch_faction_id===a?.id;return Fe.map(n=>{const o=n.id==="leader",r=n.id==="agitator",c=X===n.id;let d,l,m,s,p;if(o){d=!1,l=e,m=Q(a.leader_first_name,a.leader_last_name),s=Be.length;const g=K(y.nation);if(g&&y.nation?.monarch_faction_id===a.id)p={text:(y.nation?.monarch_title||"KING").toUpperCase(),color:"#c8a832"};else if(g)p={text:"NOBLE HOUSE",color:"#8b9a6b"};else{const x=F?.pm_party_id===a.id,b=y.nation?.hos_election_method==="elected"&&F?.president_party_id===a.id;x?p={text:"PRIME MINISTER",color:"#5cc55c"}:b?p={text:"PRESIDENT",color:"#5cc55c"}:pt?p={text:"OPPOSITION",color:"#c84"}:p={text:"GOVERNING",color:"#8b9a6b"}}}else r&&j?(d=!1,l=`${j.first_name} ${j.last_name}`,m=Q(j.first_name,j.last_name),s=1):r&&!j?(d=!1,l="Not Hired",m="+",s=0):n.id==="deputy"&&D?(d=!1,l=`${D.first_name} ${D.last_name}`,m=Q(D.first_name,D.last_name),s=1):n.id==="deputy"&&!D?(d=!1,l="Not Hired",m="+",s=0):n.id==="campaign"?(d=!1,l="Campaign Mgr",m="CM",s=Ue.length):(d=!0,l="Vacant",m="—",s=0);const f=n.oppositionOnly&&!pt;return`
            <div class="pa-leader-card ${c?"active":""} ${d?"vacant":""} ${f?"vacant":""}"
                 data-role="${n.id}"
                 style="${c?`border-left-color:${n.color};`:""}${f?"opacity:0.35;":""}">
                ${n.oppositionOnly?`<div style="position:absolute;top:0;right:0;font-family:var(--font-mono);font-size:5px;font-weight:700;letter-spacing:0.04em;padding:1px 4px;color:${f?"var(--text-dim)":"#d44a4a"};background:${f?"rgba(100,100,100,0.1)":"rgba(212,74,74,0.1)"};border:1px solid ${f?"rgba(100,100,100,0.2)":"rgba(212,74,74,0.2)"};border-top:none;border-right:none;">${f?"IN GOVERNMENT":"OPPOSITION ONLY"}</div>`:""}
                <div class="pa-leader-top">
                    <div class="pa-leader-avatar" style="color:${n.color};background:${n.color}15;border-color:${n.color}33;">${m}</div>
                    <div class="pa-leader-info">
                        <div class="pa-leader-role">
                            <span class="pa-leader-role-label" style="color:${n.color};">${o&&i?(y.nation?.monarch_title||"King").toUpperCase():n.title}</span>
    ...
    `}function Ra(e,t,a){const i=K(y.nation),n=i&&y.nation?.monarch_faction_id===a?.id,o=Fe.find(u=>u.id===X);if(!o)return"";const r=X==="leader",c=X==="agitator",d=X==="campaign",l=X==="deputy";if(!r&&!c&&!d&&!l)return`
        ...
        `;if(c&&j)return Va(o);if(l&&!D)return`
        ...
        `;if(l&&D)return Ba(o);if(d)return ja(o,a);const s=Q(a.leader_first_name,a.leader_last_name),p=a.leader_age?`, Age ${a.leader_age}`:"",f=a.seats||0,v=a.momentum??0,b=(K(y.nation)&&y.nation?.monarch_faction_id===a.id?Sa:Be).map(u=>{const $=u.tags.map(I=>`<span class="pa-action-tag" style="color:${Dt[I]||"var(--text-dim)"};">${I}</span>`).join("");let L="",M=u.cost,C=u.costColor,k=u.locked;if(u.id==="no_confidence")if(!!F&&F.pm_party_id===a.id)k=!0,u.lockReason="Your party is the Prime Minister — file from another party.";else if(ie)k=!0,u.lockReason="A motion of no confidence is already pending in Parliament.";else if(Rt>0){k=!0;const z=Rt;u.lockReason=`Cooldown: ${z} tick${z!==1?"s":""} remaining before another motion can be filed against this PM party.`}else!F||!F.pm_party_id?(k=!0,u.lockReason="No active Prime Minister to file against."):u.lockReason="";else if(u.id==="call_early_elections"||u.id==="resign_as_pm"){const I=y.nation,z=Et(I),E=!!F&&F.pm_party_id===a.id;z?E?y.nation&&y.nation.__coalition_status==="caretaker"?(k=!0,u.lockReason="Government is already in caretaker mode."):u.lockReason="":(k=!0,u.lockReason="Prime Minister’s party only."):(k=!0,u.lockReason="Only parliamentary and semi-presidential systems have a PM seat.")}else if(u.id==="leave_coalition"){const I=y.nation,z=Et(I),E=!!F&&F.pm_party_id===a.id;z?pt?(k=!0,u.lockReason="You are in opposition."):E?(k=!0,u.lockReason="Prime Minister’s party cannot leave — resign first."):u.lockReason="":(k=!0,u.lockReason="Only available in parliamentary systems.")}else if(u.id==="disband_party"){const I=Ge(a);I.isPM?(k=!0,u.lockReason="You are Prime Minister — resign before disbanding."):I.isPresident?(k=!0,u.lockReason="You are the sitting President — step down before disbanding."):I.isMonarchActing?(k=!0,u.lockReason="The reigning monarch cannot disband the royal house."):u.lockReason=""}else if(u.id==="fundraise"){const I=Oe(f,mt);M=`-${I.momCost} MOM`,C="#c84",L=`<div style="margin-top:4px;font-family:var(--font-mono);font-size:8px;color:var(--text-dim);display:flex;gap:12px;">
            ...
            <div class="pa-action-item ${k?"locked":""}" data-action-id="${u.id}">
                <div class="pa-action-top">
                    ...
                    <div class="pa-action-right">
                        <span class="pa-action-cost" style="color:${C};">${M}</span>
                    </div>
                </div>
        ...
        <div class="pa-detail-header">
            <div class="pa-detail-left">
                <div class="pa-detail-avatar" style="color:${o.color};background:${o.color}15;border-color:${o.color}33;">${s}</div>
                <div>
                    <div style="display:flex;align-items:baseline;gap:6px;flex-wrap:wrap;">
                        <span style="font-family:var(--font-mono);font-size:20px;font-weight:700;color:${o.color};">${n?(y.nation?.monarch_title||"KING").toUpperCase():o.title}</span>
                    ...
                    <div class="pa-detail-meta">${n?_((y.nation?.monarch_title||"King")+" of "+(y.nation?.name||"")):_(o.fullTitle)+" &middot; "+_(a.faction_name)}${p}${(()=>{if(n)return' <span style="color:#c8a832;font-weight:700;"> &middot; '+(y.nation?.monarch_title||"MONARCH").toUpperCase()+"</span>";if(i)return' <span style="color:#8b9a6b;font-weight:700;"> &middot; NOBLE HOUSE</span>';const u=F?.pm_party_id===a.id,$=y.nation?.hos_election_method==="elected"&&F?.president_party_id===a.id;return u?' <span style="color:#5cc55c;font-weight:700;"> &middot; PRIME MINISTER</span>':$?' <span style="color:#5cc55c;font-weight:700;"> &middot; PRESIDENT</span>':pt?' <span style="color:#c84;font-weight:700;"> &middot; OPPOSITION</span>':' <span style="color:#8b9a6b;font-weight:700;"> &middot; GOVERNING</span>'})()}</div>
                </div>
            </div>
        </div>
        ${He(t)}
        ...
        <div class="pa-detail-header">
            <div class="pa-detail-left">
                ...
                <div>
                    ...
                    <div class="pa-detail-meta">${_(e.fullTitle)} &middot; Age ${D.age} &middot; Skill: <span style="color:${n.color};font-weight:700;">${D.skill}</span></div>
                </div>
            </div>
        </div>
        ${He(a)}
    ...
    `}function Da(e){const t=Bt(e),a=t.firstNames||[],i=t.lastNames||[];if(a.length===0||i.length===0)return[];const n=5+Math.floor(Math.random()*3),o=new Set,r=[];for(let c=0;c<n;c++){let d,l,m,s=0;do d=a[Math.floor(Math.random()*a.length)],l=i[Math.floor(Math.random()*i.length)],m=d+" "+l,s++;while(o.has(m)&&s<20);o.add(m);const p=20+Math.floor(Math.random()*66),f=28+Math.floor(Math.random()*30),v=Math.max(0,p-20)/65,g=Math.round((125e3+v*525e3)/25e3)*25e3;r.push({first_name:d,last_name:l,age:f,skill:p,hire_cost:g})}return r.sort((c,d)=>d.skill-c.skill)}async function Ee(e){const t=document.getElementById("pa-deputy-modal");if(!t)return;const a=y.nation?.name,i=Da(a);let n=null;function o(){const r=n!=null?i[n]:null,c=r?vt(r.skill):null,d=i.map((s,p)=>{const f=n===p,v=vt(s.skill);return`<div class="pa-hire-row ${f?"selected":""}" data-idx="${p}">
                <div style="width:32px;height:32px;border-radius:50%;background:#8b9a6b15;border:1px solid #8b9a6b33;display:flex;align-items:center;justify-content:center;font-family:var(--font-mono);font-size:10px;font-weight:700;color:#8b9a6b;flex-shrink:0;">${Q(s.first_name,s.last_name)}</div>
                <div style="flex:1;min-width:0;">
                    <div style="font-size:11px;font-weight:600;color:${f?"var(--text-bright)":"var(--text-secondary)"};">${_(s.first_name)} ${_(s.last_name)}</div>
                    <div style="display:flex;align-items:center;gap:3px;margin-top:2px;">
                        <div style="flex:1;height:2px;background:var(--border-mid);max-width:60px;"><div style="height:100%;width:${s.skill}%;background:${v.color};"></div></div>
                        <span style="font-family:var(--font-mono);font-size:8px;color:${v.color};">${s.skill}</span>
                    </div>
                </div>
                    ...
                    <div style="display:flex;gap:12px;margin-bottom:14px;">
                        <div style="flex:1;padding:8px 10px;background:var(--bg-card);border:1px solid var(--border-main);">
                            ...
                            <div style="display:flex;align-items:center;gap:6px;">
                                <div style="flex:1;height:3px;background:var(--border-mid);"><div style="height:100%;width:${r.skill}%;background:${c.color};"></div></div>
                                <span style="font-family:var(--font-mono);font-size:14px;font-weight:700;color:${c.color};">${r.skill}</span>
                            </div>
        ...
        `;const m=()=>t.classList.remove("active");document.getElementById("pa-dep-close")?.addEventListener("click",m),t.onclick=s=>{s.target===t&&m()},document.getElementById("pa-dep-list")?.addEventListener("click",s=>{const p=s.target.closest(".pa-hire-row");p&&(n=parseInt(p.dataset.idx,10),o())}),document.getElementById("pa-dep-hire-confirm")?.addEventListener("click",async()=>{if(n==null)return;const s=i[n],p=y.faction?.party_funds||0;if(p<s.hire_cost){alert("Not enough funds.");return}const f=document.getElementById("pa-dep-hire-confirm");f&&(f.disabled=!0,f.textContent="Hiring...");try{const v=p-s.hire_cost,g=y.shard?.current_tick||0,{data:h,error:x}=await w.from("faction_deputies").insert({faction_id:y.faction.id,first_name:s.first_name,last_name:s.last_name,age:s.age,skill:s.skill,status:"active",hired_at_tick:g}).select("*").single();if(x){alert("Failed: "+x.message);return}await w.from("factions").update({party_funds:v}).eq("id",y.faction.id),y.faction.party_funds=v,D=h,X="deputy",m(),H(e)}catch(v){console.error("[Deputy] Hire error:",v)}finally{f&&(f.disabled=!1)}})}t.classList.add("active"),o()}function Ga(e){const t=document.getElementById("pa-rally-modal");if(!t||!D)return;const i=y.faction.party_funds||0;let n=null,o=null;function r(){const c=ke.map((m,s)=>{const p=i>=m.cost,f=n===s;return`<div class="pa-action-item ${f?"selected":""} ${p?"":"locked"}" data-tier="${s}" style="cursor:${p?"pointer":"not-allowed"};${f?"border-color:#8b9a6b;background:rgba(139,154,107,0.06);":""}">
                <div class="pa-action-top">
            ...
            <div class="pa-modal" style="width:520px;">
                ...
                <div class="pa-modal-footer">
                    ...
                    ${o?"":`<button class="pa-modal-btn pa-modal-btn--submit" id="rally-submit" style="background:#8b9a6b;" ${n==null?"disabled":""}>Hold Rally</button>`}
                </div>
            </div>
        `;const l=()=>{t.classList.remove("active"),o&&H(e)};document.getElementById("rally-close")?.addEventListener("click",l),document.getElementById("rally-cancel")?.addEventListener("click",l),t.onclick=m=>{m.target===t&&l()},document.getElementById("rally-tiers")?.addEventListener("click",m=>{const s=m.target.closest("[data-tier]");!s||s.classList.contains("locked")||(n=parseInt(s.dataset.tier,10),r())}),document.getElementById("rally-submit")?.addEventListener("click",async()=>{if(n==null||o)return;const m=ke[n],{data:s}=await w.from("factions").select("party_funds, momentum").eq("id",y.faction.id).single(),p=s?.party_funds||0;if(p<m.cost){alert("Not enough funds.");return}y.faction.party_funds=p,y.faction.momentum=s?.momentum??y.faction.momentum;const f=document.getElementById("rally-submit");f&&(f.disabled=!0,f.textContent="Rolling...");try{const v=1+Math.floor(Math.random()*6),g=Oa(v,m.bonus),h=p-m.cost,x=Math.max(1,(y.faction.momentum||0)+g.momentum);await w.from("factions").update({party_funds:h,momentum:x}).eq("id",y.faction.id);const b=y.shard?.current_tick||0;await w.from("campaign_actions").insert({party_id:y.faction.id,nation_id:y.nation?.id,action_type:"rally",ap_cost:0,money_cost:m.cost,tick_performed:b,result:{dieRoll:v,bonus:m.bonus,total:v+m.bonus,momentum:g.momentum,momentumDelta:g.momentum,label:g.label,outcomeName:g.label}}),y.faction.party_funds=h,y.faction.momentum=x,sessionStorage.removeItem("nationhood_state"),o={...g,dieRoll:v,bonus:m.bonus,total:v+m.bonus},r()}catch(v){console.error("[Rally] Error:",v),alert("Rally failed.")}})}t.classList.add("active"),r()}const Ue=[{id:"modernize",name:"Modernize Image",desc:"Upload a custom logo to refresh your party's brand. Grants +1 Momentum/tick while a custom logo is active. Quick and affordable.",cost:"$50k",costColor:"#5a8aaa",moneyCost:5e4,tags:["CAMPAIGN","BRANDING"],locked:!1},{id:"rebrand",name:"Rebrand Party",desc:'Change your party name, abbreviation, color, logo, and description. Costly but grants a "Fresh Start" modifier. Nuclear option after scandal or major defeat.',cost:"$150k",costColor:"#c84",moneyCost:15e4,tags:["CAMPAIGN","STRUCTURAL"],locked:!1}],Ce=[{id:"crimson",hex:"#c43a3a",name:"Crimson"},{id:"scarlet",hex:"#d45a2a",name:"Scarlet"},{id:"amber",hex:"#c8a832",name:"Amber"},{id:"gold",hex:"#d4a017",name:"Gold"},{id:"olive",hex:"#8a9a4a",name:"Olive"},{id:"emerald",hex:"#2a8a4a",name:"Emerald"},{id:"forest",hex:"#3a6a3a",name:"Forest"},{id:"teal_c",hex:"#2a8a7a",name:"Teal"},{id:"sky",hex:"#4a8aba",name:"Sky"},{id:"cobalt",hex:"#3a5a9a",name:"Cobalt"},{id:"navy",hex:"#2a3a6a",name:"Navy"},{id:"violet",hex:"#7a4a9a",name:"Violet"},{id:"plum",hex:"#8a3a7a",name:"Plum"},{id:"rose",hex:"#ba4a6a",name:"Rose"},{id:"slate",hex:"#5a6a7a",name:"Slate"},{id:"iron",hex:"#4a4a4a",name:"Iron"}],oe=[{emoji:"🏛️",name:"Parliament"},{emoji:"⚖️",name:"Scales"},{emoji:"🗽",name:"Liberty"},{emoji:"🕊️",name:"Dove"},{emoji:"🦅",name:"Eagle"},{emoji:"🦁",name:"Lion"},{emoji:"🐻",name:"Bear"},{emoji:"🐉",name:"Dragon"},{emoji:"🐘",name:"Elephant"},{emoji:"🏔️",name:"Mountain"},{emoji:"🌊",name:"Wave"},{emoji:"🔥",name:"Flame"},{emoji:"⭐",name:"Star"},{emoji:"🌟",name:"Glow Star"},{emoji:"💎",name:"Diamond"},{emoji:"🛡️",name:"Shield"},{emoji:"⚔️",name:"Swords"},{emoji:"🏗️",name:"Builder"},{emoji:"🌿",name:"Leaf"},{emoji:"🌾",name:"Wheat"},{emoji:"🔨",name:"Hammer"},{emoji:"⚡",name:"Lightning"},{emoji:"🎯",name:"Target"},{emoji:"🏴",name:"Flag"},{emoji:"🚩",name:"Red Flag"},{emoji:"✊",name:"Fist"},{emoji:"🤝",name:"Handshake"},{emoji:"📜",name:"Scroll"},{emoji:"🗳️",name:"Ballot"},{emoji:"👑",name:"Crown"}];function ja(e,t){const a=Ue.map(i=>{const n=i.tags.map(o=>`<span class="pa-action-tag" style="color:${Dt[o]||"var(--text-dim)"};">${o}</span>`).join("");return`
    ...
    `}function qa(e){const t=document.getElementById("pa-modernize-modal");if(!t)return;const a=y.faction;let i=null,n=a.custom_logo_url||null,o=!1;function r(){const c=!!n,l=Number(a.party_funds??0)>=5e4,m=!!i&&l&&!o;t.innerHTML=`
            <div class="pa-modal" style="width:440px;">
                ...
                <div class="pa-modal-body" style="display:flex;flex-direction:column;align-items:center;gap:16px;padding:24px 20px;">
                    <div style="width:80px;height:80px;border:2px dashed ${c?"var(--accent)":"var(--border-mid)"};border-radius:8px;display:flex;align-items:center;justify-content:center;overflow:hidden;background:var(--bg-card);">
                        ${n?`<img src="${_(n)}" style="width:100%;height:100%;object-fit:cover;">`:'<span style="font-size:24px;color:var(--text-dim);">+</span>'}
                    </div>
                    <div style="text-align:center;">
        ...
        `,document.getElementById("mod-close")?.addEventListener("click",()=>t.classList.remove("active")),document.getElementById("mod-cancel")?.addEventListener("click",()=>t.classList.remove("active")),t.onclick=s=>{s.target===t&&t.classList.remove("active")},document.getElementById("mod-file-input")?.addEventListener("change",s=>{const p=s.target.files?.[0];if(p){if(p.size>2*1024*1024){alert("Logo must be under 2MB.");return}i=p,n=URL.createObjectURL(p),r()}}),document.getElementById("mod-submit")?.addEventListener("click",async()=>{if(o||!i)return;o=!0;const s=document.getElementById("mod-submit");s&&(s.disabled=!0,s.textContent="Uploading...");try{const p=i.name.split(".").pop()?.toLowerCase()||"png",f=`${a.id}/logo_${Date.now()}.${p}`,{error:v}=await w.storage.from("party-logos").upload(f,i,{cacheControl:"3600",upsert:!0,contentType:i.type});if(v)throw new Error("Upload failed: "+v.message);const{data:g}=w.storage.from("party-logos").getPublicUrl(f),h=g?.publicUrl;if(!h)throw new Error("Failed to get logo URL");const x=Math.max(0,Number(a.party_funds??0)-5e4),{error:b}=await w.from("factions").update({custom_logo_url:h,party_funds:x}).eq("id",a.id);if(b)throw b;a.custom_logo_url=h,a.party_funds=x,t.classList.remove("active"),alert("Logo updated! Your party now earns +1 Momentum/tick from the modernized image."),H(e)}catch(p){alert("Modernize failed: "+(p.message||"Error")),o=!1,s&&(s.disabled=!1,s.textContent="Modernize — $50k")}})}t.classList.add("active"),r()}function Ha(e){const t=document.getElementById("pa-rebrand-modal");if(!t)return;const a=y.faction;y.nation;const i=a.momentum??50;(y._allParties||[]).filter(p=>p.id!==a.id);const n={current:a.party_color||"#4a8aba"},o={current:0},r={current:a.custom_logo_url||null},c={current:null},d={current:!!a.custom_logo_url},l={current:!1};function m(){return n.current}function s(){const p=m(),f=Ce.find(M=>M.hex===p)?.name||"Custom",v=oe[o.current]?.emoji||"🏛️",g=d.current&&(r.current||c.current),h=r.current||(c.current?URL.createObjectURL(c.current):null),x=document.getElementById("rb-name")?.value??a.faction_name??"",b=document.getElementById("rb-abbr")?.value??a.abbreviation??"",u=document.getElementById("rb-desc")?.value??"",$=Ce.map(M=>{const C=p===M.hex;return`<div class="rb-color-swatch ${C?"selected":""}" data-hex="${M.hex}" style="background:${M.hex};${C?`box-shadow:0 0 8px ${M.hex}44;border:2px solid var(--text-bright);`:""}">
                ${C?'<span style="font-size:10px;color:#fff;text-shadow:0 1px 2px rgba(0,0,0,0.5);">✓</span>':""}
            </div>`}).join(""),L=oe.map((M,C)=>{const k=o.current===C;return`<div class="rb-logo-item ${k?"selected":""}" data-idx="${C}" style="${k?`background:${p}15;border:2px solid ${p};box-shadow:0 0 6px ${p}33;`:""}">
                ${M.emoji}
                ...
                <div style="display:flex;">
                    ...
                    <div style="flex:1;padding:14px 20px;border-right:1px solid var(--border-main);">
                        ...
                        <div style="margin-bottom:14px;">
                            ...
                            <input class="pa-modal-input" id="rb-abbr" value="${_(b)}" maxlength="4" style="width:100px;font-size:15px;font-weight:700;letter-spacing:2px;text-transform:uppercase;text-align:center;color:${p};">
                    ...
                    <div style="width:240px;padding:14px 16px;display:flex;flex-direction:column;gap:10px;flex-shrink:0;">
                        ...
                        <div style="background:var(--bg-card);border:1px solid var(--border-main);border-left:3px solid ${p};padding:10px;">
                            <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px;">
                                ...
                                <div>
                                    ...
                                    <div style="font-family:var(--font-mono);font-size:11px;font-weight:700;color:${p};letter-spacing:1px;">${_(b||"???")}</div>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div style="display:flex;gap:3px;flex-wrap:wrap;">
                                <span style="font-family:var(--font-mono);font-size:8px;font-weight:700;padding:2px 6px;color:${p};background:${p}0a;border:1px solid ${p}25;">${_(b)}</span>
        ...
        `}t._rbCustomLogoFile=null,t._rbCustomLogoUrl=r.current,t._rbUseCustomLogo=d.current,s(),t.classList.add("active"),t.addEventListener("change",function(f){if(f.target.id==="rb-logo-file"){const v=f.target.files?.[0];if(!v)return;if(v.size>2*1024*1024){alert("Logo must be under 2MB. Selected file: "+(v.size/(1024*1024)).toFixed(1)+"MB"),f.target.value="";return}if(!["image/png","image/jpeg","image/svg+xml","image/webp"].includes(v.type)){alert("Unsupported file type. Use PNG, JPG, SVG, or WebP."),f.target.value="";return}c.current=v,r.current=null,d.current=!0,t._rbCustomLogoFile=v,t._rbCustomLogoUrl=null,t._rbUseCustomLogo=!0,s()}}),t.addEventListener("click",function p(f){if(f.target===t||f.target.closest("#rb-close")||f.target.closest("#rb-cancel")){t.classList.remove("active"),t.removeEventListener("click",p);return}const v=f.target.closest(".rb-color-swatch");if(v){n.current=v.dataset.hex,s();return}const g=f.target.closest(".rb-logo-item");if(g){o.current=parseInt(g.dataset.idx)||0,d.current=!1,t._rbUseCustomLogo=!1,s();return}if(f.target.closest("#rb-remove-logo")){r.current=null,c.current=null,d.current=!1,t._rbCustomLogoFile=null,t._rbCustomLogoUrl=null,t._rbUseCustomLogo=!1,s();return}if(f.target.closest("#rb-submit")){const h=document.getElementById("rb-name")?.value?.trim()||"",x=document.getElementById("rb-abbr")?.value?.trim()||"";if(h.length<3||x.length<2){alert("Name must be 3+ chars, abbreviation 2-4 chars.");return}l.current=!0,s();return}if(f.target.closest("#rb-back")){l.current=!1,s();return}if(f.target.closest("#rb-confirm")){Ua(t,e,p);return}})}async function Ua(e,t,a){const i=y.faction,n=document.getElementById("rb-name")?.value?.trim()||"",o=document.getElementById("rb-abbr")?.value?.trim()||"";document.getElementById("rb-desc")?.value?.trim();const r=document.querySelector(".rb-color-swatch.selected")?.dataset?.hex||i.party_color,c=document.querySelector(".rb-logo-item.selected")?.dataset?.idx,d=c!=null?oe[parseInt(c)]?.emoji:null,l=e._rbCustomLogoFile,m=e._rbUseCustomLogo,s=e._rbCustomLogoUrl,p=document.getElementById("rb-confirm");p&&(p.disabled=!0,p.textContent="Rebranding...");try{const f=y.shard?.current_tick||0;let v=s;if(m&&l){const u=l.name.split(".").pop()?.toLowerCase()||"png",$=`${i.id}/logo_${Date.now()}.${u}`,{data:L,error:M}=await w.storage.from("party-logos").upload($,l,{cacheControl:"3600",upsert:!0,contentType:l.type});if(M){console.error("[Rebrand] Logo upload failed:",M.message),alert("Logo upload failed: "+M.message);return}const{data:C}=w.storage.from("party-logos").getPublicUrl($);v=C?.publicUrl||null}else m||(v=null);const g=15e4,h=i.party_funds||0;if(h<g){alert(`Not enough funds. You have $${Math.round(h/1e3)}k, need $150k.`);return}const x=h-g,b=Math.max(1,(i.momentum||0)-10);await w.from("factions").update({party_funds:x,momentum:b,faction_name:n,abbreviation:o.toUpperCase(),party_color:r,party_logo:m?null:d,custom_logo_url:v,rebrand_cooldown_until_tick:f+120}).eq("id",i.id),await w.from("campaign_actions").insert({party_id:i.id,nation_id:y.nation?.id,action_type:"rebrand",ap_cost:3,money_cost:0,tick_performed:f,result:{oldName:i.faction_name,newName:n,oldAbbr:i.abbreviation,newAbbr:o,oldColor:i.party_color,newColor:r}}),i.party_funds=x,i.momentum=b,i.faction_name=n,i.abbreviation=o.toUpperCase(),i.party_color=r,i.party_logo=m?null:d,i.custom_logo_url=v,e.classList.remove("active"),e.removeEventListener("click",a),H(t)}catch(f){console.error("[PartyActions] Rebrand error:",f),alert("Failed to rebrand: "+(f.message||f))}finally{p&&(p.disabled=!1,p.textContent="⚠ Confirm Rebrand")}}const Ya=[{id:"file_lawsuit",name:"File Lawsuit",desc:"Sue a government ministry alleging corruption or negligence. 8-tick timeline with milestone events. Outcome depends on actual corruption growth since government took office.",cost:"$250k",costColor:"#c8a832",moneyCost:25e4,tags:["LEGAL","OFFENSIVE"],locked:!1}];function Va(e){const t=j,a=Q(t.first_name,t.last_name),i=vt(t.skill),n=pt?'<span style="color:#5cc55c;margin-left:6px;">✓ IN OPPOSITION</span>':'<span style="color:#c84;margin-left:6px;">⚠ IN GOVERNMENT (actions limited)</span>',o=Ya.map(r=>{const c=r.tags.map(d=>`<span class="pa-action-tag" style="color:${Dt[d]||"var(--text-dim)"};">${d}</span>`).join("");return`
        ...
        <div class="pa-detail-header">
            <div class="pa-detail-left">
                ...
                <div>
                    ...
                    <div class="pa-detail-meta">${_(e.fullTitle)}, Age ${t.age}${n}</div>
                </div>
            </div>
            <div style="text-align:right;">
    ...
    `}function Ka(){if(ae.length===0)return"";const e=y.shard?.current_tick||0;return`
        <div class="pa-ls-section">
            <div class="pa-ls-section-title">Legal Actions</div>
            ${ae.map(a=>{const i=Nt.find(x=>x.key===a.target_ministry),n=i?i.label:a.target_ministry,o=i?i.icon:"⚖️",r=ve(a.corruption_growth||0),c=nt[a.tier]||nt[1],d=a.status==="active",l=Math.max(0,e-a.filed_at_tick),m=8,s=Math.min(1,l/m),p=Math.max(0,a.resolves_at_tick-e),f=[{tick:0,label:"Filed",type:"filing"},{tick:2,label:"Discovery",type:"discovery"},{tick:5,label:"Evidence",type:"evidence"},{tick:7,label:"Pre-trial",type:"pre_trial"},{tick:8,label:"Verdict",type:"resolution"}],v=f.map(x=>{const b=a.filed_at_tick+x.tick,u=e>=b,$=e>=b&&(x.tick===8||e<a.filed_at_tick+f[f.indexOf(x)+1]?.tick),L=x.tick/m*100;return`<div class="pa-ls-milestone ${u?"passed":""} ${$?"current":""}" style="left:${L}%;" title="${x.label} (Tick ${b})">
                <div class="pa-ls-milestone-dot"></div>
                <div class="pa-ls-milestone-label">${x.label}</div>
            </div>`}).join("");let g="";if(!d){const x=c===nt[1]?"FRIVOLOUS":c===nt[2]?"PARTIAL WIN":c===nt[3]?"MAJOR WIN":"DEVASTATING",b=a.tier===1?"var(--red)":a.tier===2?"#ca5":a.tier===3?"#c84":"var(--green)";g=`<span class="pa-ls-tier-badge" style="color:${b};border-color:${b}44;background:${b}0a;">${x}</span>`}const h=d?"":`
            ...
            <div class="pa-ls-card ${d?"active":"resolved"}">
                <div class="pa-ls-header">
                    <div style="display:flex;align-items:center;gap:6px;">
                        ...
                        <span style="font-size:11px;font-weight:700;color:var(--text-bright);">${_(n)}</span>
                    ...
                    <div style="font-family:var(--font-mono);font-size:8px;color:var(--text-dim);">
                        ${d?`${p} ticks left`:`Resolved tick ${a.resolves_at_tick}`}
                    </div>
                </div>
                ${d?`
    ...
    `}let Ut=!1;async function Ie(e){const t=document.getElementById("pa-hire-modal");if(!t)return;const a=y.nation?.id,i=y.nation?.name;if(!a||!i)return;t.innerHTML='<div class="pa-modal"><div style="padding:40px;text-align:center;color:var(--text-dim);font-family:var(--font-mono);font-size:10px;">Searching for candidates...</div></div>',t.classList.add("active");const n=await $a(w,a,i);let o=null;function r(){const c=o!=null?n[o]:null,d=c?vt(c.skill):null,l=n.map((p,f)=>{const v=o===f,g=vt(p.skill);return`<div class="pa-hire-row ${v?"selected":""}" data-idx="${f}">
                ...
                <div style="padding:16px 20px;">
                    <div style="display:flex;align-items:center;gap:12px;margin-bottom:12px;">
                        <div style="width:48px;height:48px;border-radius:50%;background:#d44a4a15;border:1px solid #d44a4a33;display:flex;align-items:center;justify-content:center;font-family:var(--font-mono);font-size:16px;font-weight:700;color:#d44a4a;">${Q(c.first_name,c.last_name)}</div>
                        <div>
                            <div style="font-size:16px;font-weight:700;color:var(--text-bright);">${_(c.first_name)} ${_(c.last_name)}</div>
                    ...
                    <div style="display:flex;gap:12px;margin-bottom:14px;">
                        <div style="flex:1;padding:8px 10px;background:var(--bg-card);border:1px solid var(--border-main);">
                            <div style="font-family:var(--font-mono);font-size:7px;color:var(--text-dim);letter-spacing:0.06em;margin-bottom:3px;">SKILL</div>
                            <div style="display:flex;align-items:center;gap:6px;">
                                <div style="flex:1;height:3px;background:var(--border-mid);"><div style="height:100%;width:${c.skill}%;background:${d.color};"></div></div>
                                <span style="font-family:var(--font-mono);font-size:14px;font-weight:700;color:${d.color};">${c.skill}</span>
                            </div>
                    ...
                    <div style="margin-bottom:14px;">
                        ...
                        <div style="font-size:10px;color:var(--text-secondary);line-height:1.6;font-style:italic;">${_(c.background)}</div>
                    </div>
                ...
                <div style="padding:10px 20px;border-top:1px solid var(--border-main);background:var(--bg-card);display:flex;justify-content:flex-end;">
                    ...
                    <button class="pa-modal-btn pa-modal-btn--submit" id="pa-hire-confirm" style="background:#d44a4a;"${(y.faction?.party_funds||0)<c.hire_cost?' disabled title="Not enough funds"':""}>Hire ${_(c.first_name)}</button>
                </div>
            ...
            <div style="width:100%;max-width:700px;background:var(--bg-panel);border:1px solid var(--border-mid);box-shadow:0 20px 60px rgba(0,0,0,0.5);display:flex;flex-direction:column;max-height:80vh;">
                <div class="pa-modal-header">
                    <div class="pa-modal-header-left">
                        ...
                        <span style="font-family:var(--font-mono);font-size:8px;color:var(--text-dim);margin-left:8px;">${n.length} candidates</span>
                    </div>
        ...
        `;const s=()=>t.classList.remove("active");document.getElementById("pa-hire-close")?.addEventListener("click",s),t.onclick=p=>{p.target===t&&s()},document.getElementById("pa-hire-list")?.addEventListener("click",p=>{const f=p.target.closest(".pa-hire-row");f&&(o=parseInt(f.dataset.idx,10),r())}),document.getElementById("pa-hire-confirm")?.addEventListener("click",async()=>{if(Ut||o==null)return;Ut=!0;const p=document.getElementById("pa-hire-confirm");p&&(p.disabled=!0,p.textContent="Hiring...");try{const f=y.shard?.current_tick||0,v=n[o],g=v.hire_cost||0,h=y.faction?.party_funds||0;if(g>0&&h<g){alert(`Not enough funds. You have $${Math.round(h/1e3)}k, need $${Math.round(g/1e3)}k.`);return}if(g>0){const b=h-g,{error:u}=await w.from("factions").update({party_funds:b}).eq("id",y.faction.id);if(u){alert("Failed to deduct funds.");return}y.faction.party_funds=b}const x=await ka(w,y.faction?.id,v,f);if(!x.success){alert(x.error||"Failed to hire agitator.");return}j=x.agitator,X="agitator",s(),H(e)}catch(f){console.error("[PartyActions] Hire agitator error:",f)}finally{Ut=!1,p&&(p.disabled=!1)}})}r()}let St=!1;function Wa(e){const t=document.getElementById("pa-lawsuit-modal");if(!t)return;if(!F){alert("No active government to file against.");return}const a=y.faction,i=j;let n=null,o=null;function r(){const c=n&&o,d=Nt.map(s=>{const p=n===s.key;return`<div class="pa-lawsuit-target ${p?"selected":""}" data-target="${s.key}">
                <span style="font-size:18px;">${s.icon}</span>
                <span style="font-size:12px;font-weight:600;color:${p?"var(--text-bright)":"var(--text-secondary)"};">${_(s.label)}</span>
            </div>`}).join(""),l=Re.map(s=>{const p=o===s.key;return`<div class="pa-lawsuit-basis ${p?"selected":""}" data-basis="${s.key}">
                <div style="display:flex;align-items:center;gap:10px;">
                    ...
                    <div>
                        <div style="font-size:14px;font-weight:600;color:${p?"var(--text-bright)":"var(--text-secondary)"};">${_(s.label)}</div>
                        <div style="font-size:11px;color:var(--text-dim);margin-top:2px;">${_(s.desc)}</div>
                    </div>
                </div>
            </div>`}).join("");t.innerHTML=`
        ...
        `;const m=()=>t.classList.remove("active");document.getElementById("pa-lawsuit-close")?.addEventListener("click",m),document.getElementById("pa-lawsuit-cancel")?.addEventListener("click",m),t.onclick=s=>{s.target===t&&m()},document.getElementById("pa-lawsuit-targets")?.addEventListener("click",s=>{const p=s.target.closest(".pa-lawsuit-target");p&&(n=p.dataset.target,r())}),document.getElementById("pa-lawsuit-bases")?.addEventListener("click",s=>{const p=s.target.closest(".pa-lawsuit-basis");p&&(o=p.dataset.basis,r())}),document.getElementById("pa-lawsuit-submit")?.addEventListener("click",async()=>{if(St||!n||!o)return;St=!0;const s=document.getElementById("pa-lawsuit-submit");s&&(s.disabled=!0,s.textContent="Filing...");try{const{data:f}=await w.from("factions").select("party_funds").eq("id",a.id).single(),v=f?.party_funds||0;if(v<25e4){alert(`Not enough funds. You have $${Math.round(v/1e3)}k, need $250k.`),St=!1,s&&(s.disabled=!1,s.textContent="File Lawsuit");return}const g=v-25e4;await w.from("factions").update({party_funds:g}).eq("id",a.id),a.party_funds=g,sessionStorage.removeItem("nationhood_state");const h=y.shard?.current_tick||0,x=await Ea(w,{factionId:a?.id,nationId:y.nation?.id,agitatorId:i?.id,targetMinistry:n,basis:o,currentTick:h,partyName:a?.faction_name||"Opposition",administration:F});if(!x.success){alert(x.error||"Failed to file lawsuit.");return}const b=ve(x.lawsuit?.corruption_growth||0),u=nt[x.tier]||nt[1];m(),alert(`Lawsuit filed against ${Nt.find($=>$.key===n)?.label||n}.
The case is now under investigation. Results will be determined when it resolves in 8 ticks.`),H(e)}catch(p){console.error("[PartyActions] File lawsuit error:",p),alert("An error occurred. Please try again.")}finally{St=!1,s&&(s.disabled=!1,s.textContent="File Lawsuit")}})}t.classList.add("active"),r()}async function Ja(e){const t=document.getElementById("pa-appoint-pm-modal");if(!t)return;const a=y.nation;y.faction;const{data:i}=await w.from("factions").select("id, faction_name, abbreviation, party_color, seats, leader_first_name, leader_last_name, leader_age").eq("nation_id",a.id).eq("faction_type","party").is("abandoned_at",null).order("seats",{ascending:!1}),n=i||[];let o=null,r=!1;const{data:c}=await w.from("head_of_government").select("faction_id, first_name, last_name, factions(faction_name)").eq("nation_id",a.id).eq("active",!0).maybeSingle();function d(){const l=n.find(v=>v.id===o),m=c?`${c.first_name} ${c.last_name}`:null,s=c?.factions?.faction_name||null,p=c&&o===c.faction_id;t.innerHTML=`
            <div class="pa-modal" style="width:500px;">
                ...
                <div style="padding:8px 20px;border-bottom:1px solid var(--border-main);font-size:12px;color:var(--text-secondary);line-height:1.5;">
                    ...
                    ${m?`<div style="margin-top:4px;font-family:var(--font-mono);font-size:9px;color:var(--text-dim);">Current PM: <strong style="color:var(--text-bright);">${_(m)}</strong> (${_(s||"?")})</div>`:'<div style="margin-top:4px;font-family:var(--font-mono);font-size:9px;color:var(--amber);">No Prime Minister appointed.</div>'}
                </div>
                <div class="pa-modal-body" style="max-height:300px;overflow-y:auto;">
                    <div class="pa-modal-step-label">Select a Party</div>
                    <div style="display:flex;flex-direction:column;gap:4px;">
                        ${n.map(v=>{const g=v.id===o,h=c&&v.id===c.faction_id,x=v.leader_first_name&&v.leader_last_name?`${v.leader_first_name} ${v.leader_last_name}`:"?";return`<div class="pa-action-item ${g?"selected":""}" data-party-id="${v.id}" style="cursor:pointer;${g?`border-color:${v.party_color||"#888"};background:${v.party_color||"#888"}08;`:""}">
                ...
                <div class="pa-modal-footer">
                    ...
                    <button class="pa-modal-btn pa-modal-btn--submit" id="apm-confirm" ${!l||r||p?"disabled":""} style="background:#c8a832;">${l?p?"Already PM":`Appoint ${_(l.faction_name)}`:"Select a party"}</button>
                </div>
            </div>
        `;const f=()=>t.classList.remove("active");document.getElementById("apm-close")?.addEventListener("click",f),document.getElementById("apm-cancel")?.addEventListener("click",f),t.onclick=v=>{v.target===t&&f()},t.querySelector(".pa-modal-body")?.addEventListener("click",v=>{const g=v.target.closest("[data-party-id]");g&&(o=g.dataset.partyId,d())}),document.getElementById("apm-confirm")?.addEventListener("click",async()=>{if(!o||r)return;const v=n.find(h=>h.id===o);if(!v||!confirm(`Appoint ${v.leader_first_name} ${v.leader_last_name} of ${v.faction_name} as Prime Minister?`))return;r=!0;const g=document.getElementById("apm-confirm");g&&(g.disabled=!0,g.textContent="Appointing...");try{const h=y.shard?.current_tick||0;await na(w,{nationId:a.id,factionId:o,firstName:v.leader_first_name||"Unknown",lastName:v.leader_last_name||"Unknown",age:v.leader_age||50,currentTick:h});let x=0;const b=a.monarch_faction_id,u=c?.faction_id||null,$=u&&u!==b&&u!==o,L=o!==b&&o!==u;if($&&(x-=4),L&&(x+=3),x!==0){const C=Number(a.legitimacy??50),k=Math.max(0,Math.min(100,C+x));try{await w.from("nations").update({legitimacy:k}).eq("id",a.id),a.legitimacy=k}catch{}}try{await w.from("event_log").insert({nation_id:a.id,event_name:`${a.monarch_title||"King"} appoints Prime Minister`,category:"government",description_chosen:`${a.monarch_title||"The King"} has appointed ${v.leader_first_name} ${v.leader_last_name} of ${v.faction_name} as Prime Minister.`,fired_at_tick:h})}catch{}f();const M=x>0?`

Legitimacy +${x}.`:x<0?`

Legitimacy ${x}.`:"";alert(`${v.leader_first_name} ${v.leader_last_name} of ${v.faction_name} has been appointed Prime Minister.${M}`),H(e)}catch(h){alert("Failed to appoint PM: "+(h.message||"Error")),r=!1,g&&(g.disabled=!1,g.textContent=`Appoint ${_(v.faction_name)}`)}})}t.classList.add("active"),d()}async function Xa(e){const t=document.getElementById("pa-royal-modal");if(!t)return;const a=y.nation,i=y.faction,n=i.seats||0,o=a?.total_seats||100,{data:r}=await w.from("factions").select("id, faction_name, abbreviation, party_color, seats").eq("nation_id",a.id).eq("faction_type","party").is("abandoned_at",null).order("faction_name"),c=(r||[]).filter(p=>p.id!==i.id);let d=null;const l=Math.max(0,n-1);let m=Math.min(5,l||1);function s(){const p=c.find(v=>v.id===d);t.innerHTML=`
            <div class="pa-modal" style="width:560px;">
                ...
                <div style="padding:8px 20px;border-bottom:1px solid var(--border-main);font-size:12px;color:var(--text-secondary);line-height:1.5;">
                    ...
                    You currently hold <strong>${n}</strong> of ${o} seats.
                    ${n/o>.7?'<div style="color:#d44a4a;font-weight:700;margin-top:4px;">⚠ You hold >70% of seats — tyranny legitimacy decay active!</div>':""}
                </div>
                <div class="pa-modal-body">
                    <div class="pa-modal-step-label">Select Noble House</div>
                    <div style="display:flex;flex-direction:column;gap:4px;">
                        ${c.length>0?c.map(v=>{const g=v.id===d;return`<div class="pa-action-item ${g?"selected":""}" data-faction-id="${v.id}" style="cursor:pointer;${g?`border-color:${v.party_color||"#888"};background:${v.party_color||"#888"}08;`:""}">
                                <div style="display:flex;justify-content:space-between;align-items:center;">
                                    <div style="display:flex;align-items:center;gap:8px;">
                                        <div style="width:8px;height:8px;background:${v.party_color||"#888"};"></div>
                    ...
                    ${p?`
                        <div style="margin-top:14px;">
                            ...
                            <div style="font-family:var(--font-mono);font-size:10px;color:var(--text-dim);margin-top:4px;">
                                ...
                                &middot; Your seats after: ${n-m} &middot; Their seats after: ${(p.seats||0)+m}
                            </div>
                        </div>
                    `:""}
                </div>
                <div class="pa-modal-footer">
                    ...
                    <button class="pa-modal-btn pa-modal-btn--submit" id="royal-grant" ${p?"":"disabled"} style="background:#c8a832;">Grant ${m} Seats</button>
                </div>
            </div>
        `;const f=()=>t.classList.remove("active");document.getElementById("royal-close")?.addEventListener("click",f),document.getElementById("royal-cancel")?.addEventListener("click",f),t.onclick=v=>{v.target===t&&f()},t.querySelector(".pa-modal-body")?.addEventListener("click",v=>{const g=v.target.closest("[data-faction-id]");g&&(d=g.dataset.factionId,s())}),document.getElementById("grant-slider")?.addEventListener("input",v=>{m=parseInt(v.target.value)||1,document.getElementById("grant-count").textContent=m;const g=document.getElementById("royal-grant");g&&(g.textContent=`Grant ${m} Seats`)}),document.getElementById("royal-grant")?.addEventListener("click",async()=>{if(!d||bt)return;bt=!0;const v=document.getElementById("royal-grant");v&&(v.disabled=!0,v.textContent="Granting...");try{const{data:g}=await w.from("factions").select("id, faction_name, seats").eq("nation_id",a.id).eq("faction_type","party").is("abandoned_at",null),h=(g||[]).find(S=>S.id===i.id),x=(g||[]).find(S=>S.id===d);if(!h||!x){alert("Faction not found.");return}const b=(g||[]).reduce((S,A)=>S+Math.max(0,A.seats||0),0),u=new Map;for(const S of g||[])u.set(S.id,Math.max(0,S.seats||0));let $=m;const L=Math.max(0,(u.get(i.id)||0)-1),M=Math.min($,L);if(M>0&&(u.set(i.id,(u.get(i.id)||0)-M),$-=M),$>0){const S=(g||[]).filter(N=>N.id!==i.id&&N.id!==d&&(u.get(N.id)||0)>0);let A=S.reduce((N,T)=>N+(u.get(T.id)||0),0);for(const N of S){if($<=0||A<=0)break;const T=Math.round($*(u.get(N.id)||0)/A),R=Math.min(T,u.get(N.id)||0,$);R>0&&(u.set(N.id,(u.get(N.id)||0)-R),A-=R,$-=R)}if($>0)for(const N of S){if($<=0)break;const T=u.get(N.id)||0,R=Math.min($,T);R>0&&(u.set(N.id,T-R),$-=R)}}const C=m-$;if(C<=0){alert("No seats available to grant.");return}u.set(d,(u.get(d)||0)+C);let k=0;for(const S of u.values())k+=S;if(k!==b){console.error("[GrantSeats] Conservation violated",{sumBefore:b,sumAfter:k,grantAmount:m,actualGrant:C}),alert("Internal error: seat totals would not balance. Aborting.");return}const I=[];for(const S of g||[]){const A=Math.max(0,S.seats||0),N=u.get(S.id)||0;A!==N&&I.push({id:S.id,seats:N})}for(const S of I){const{error:A}=await w.from("factions").update({seats:S.seats}).eq("id",S.id);if(A){alert("Failed to grant seats: "+A.message);return}}const z=C*.5,E=Math.min(100,(Number(a.legitimacy)||50)+z),{error:P}=await w.from("nations").update({legitimacy:E}).eq("id",a.id);if(P){alert("Failed to update legitimacy.");return}i.seats=u.get(i.id)||0,a.legitimacy=E;try{const S=c.find(A=>A.id===d);await w.from("event_log").insert({nation_id:a.id,event_name:`${a.monarch_title||"King"} grants ${C} seats to ${S?.faction_name||"unknown"}`,category:"government",description_chosen:`The ${a.monarch_title||"King"} has granted ${C} parliamentary seat${C!==1?"s":""} to ${S?.faction_name}. Legitimacy +${z.toFixed(1)}.`,fired_at_tick:y.shard?.current_tick||0})}catch{}f(),H(e)}catch(g){console.error("[GrantSeats] Error:",g),alert("Failed to grant seats.")}finally{bt=!1}})}t.classList.add("active"),s()}async function Qa(e){const t=document.getElementById("pa-royal-modal");if(!t)return;const a=y.nation,i=y.faction,{data:n}=await w.from("factions").select("id, faction_name, abbreviation, party_color, seats").eq("nation_id",a.id).eq("faction_type","party").is("abandoned_at",null).order("faction_name"),o=(n||[]).filter(l=>l.id!==i.id&&(l.seats||0)>0);let r=null,c=1;function d(){const l=o.find(g=>g.id===r),m=l&&l.seats||0,p=c*1e5,f=i.party_funds||0;t.innerHTML=`
            <div class="pa-modal" style="width:560px;">
                <div class="pa-modal-header">
                    <div class="pa-modal-header-left">
                        <div class="pa-modal-dot" style="background:#d44a4a;"></div>
                ...
                <div class="pa-modal-body">
                    <div class="pa-modal-step-label">Select Noble House</div>
                    <div style="display:flex;flex-direction:column;gap:4px;">
                        ${o.length>0?o.map(g=>{const h=g.id===r;return`<div class="pa-action-item ${h?"selected":""}" data-faction-id="${g.id}" style="cursor:pointer;${h?"border-color:#d44a4a;background:rgba(212,74,74,0.04);":""}">
                                <div style="display:flex;justify-content:space-between;align-items:center;">
                                    <div style="display:flex;align-items:center;gap:8px;">
                    ...
                    ${l?`
                        <div style="margin-top:14px;">
                            ...
                            <div style="display:flex;align-items:center;gap:12px;">
                                <input type="range" min="1" max="${m}" value="${c}" id="revoke-slider" style="flex:1;">
                ...
                <div class="pa-modal-footer">
                    <button class="pa-modal-btn pa-modal-btn--cancel" id="royal-cancel">Cancel</button>
                    <button class="pa-modal-btn pa-modal-btn--submit" id="royal-revoke" ${!l||f<p?"disabled":""} style="background:#d44a4a;">Revoke ${c} Seats</button>
                </div>
            </div>
        `;const v=()=>t.classList.remove("active");document.getElementById("royal-close")?.addEventListener("click",v),document.getElementById("royal-cancel")?.addEventListener("click",v),t.onclick=g=>{g.target===t&&v()},t.querySelector(".pa-modal-body")?.addEventListener("click",g=>{const h=g.target.closest("[data-faction-id]");h&&(r=h.dataset.factionId,c=1,d())}),document.getElementById("revoke-slider")?.addEventListener("input",g=>{c=parseInt(g.target.value)||1,document.getElementById("revoke-count").textContent=c;const h=document.getElementById("royal-revoke");h&&(h.textContent=`Revoke ${c} Seats`)}),document.getElementById("royal-revoke")?.addEventListener("click",async()=>{if(!r||bt)return;bt=!0;const g=document.getElementById("royal-revoke");g&&(g.disabled=!0,g.textContent="Revoking...");try{const h=c*1e5,{data:x}=await w.from("factions").select("id, faction_name, seats, party_funds").eq("nation_id",a.id).eq("faction_type","party").is("abandoned_at",null),b=(x||[]).find(T=>T.id===i.id),u=(x||[]).find(T=>T.id===r);if(!b||!u){alert("Faction not found.");return}const $=b.party_funds||0;if($<h){alert("Not enough funds.");return}const L=(x||[]).reduce((T,R)=>T+Math.max(0,R.seats||0),0),M=Math.min(c,u.seats||0);if(M<=0){alert("Target has no seats to revoke.");return}const C=$-h,k=(b.seats||0)+M,I=(u.seats||0)-M,z=M,E=Math.max(0,(Number(a.legitimacy)||50)-z),P=L-(b.seats||0)-(u.seats||0)+k+I;if(P!==L){console.error("[RevokeSeats] Conservation violated",{sumBefore:L,sumAfter:P,take:M}),alert("Internal error: seat totals would not balance. Aborting.");return}const{error:S}=await w.from("factions").update({seats:k,party_funds:C}).eq("id",i.id);if(S){alert("Failed to revoke seats: "+S.message);return}const{error:A}=await w.from("factions").update({seats:I}).eq("id",r);if(A){alert("Failed to revoke seats: "+A.message);return}const{error:N}=await w.from("nations").update({legitimacy:E}).eq("id",a.id);if(N){alert("Failed to update legitimacy.");return}i.seats=k,i.party_funds=C,a.legitimacy=E,sessionStorage.removeItem("nationhood_state");try{await w.from("event_log").insert({nation_id:a.id,event_name:`${a.monarch_title||"King"} revokes ${M} seats from ${u.faction_name||"unknown"}`,category:"political",description_chosen:`The ${a.monarch_title||"King"} has revoked ${M} seat${M!==1?"s":""} from ${u.faction_name}. Legitimacy -${z}.`,fired_at_tick:y.shard?.current_tick||0})}catch{}v(),H(e)}catch(h){console.error("[RevokeSeats] Error:",h),alert("Failed to revoke seats.")}finally{bt=!1}})}t.classList.add("active"),d()}let Yt=!1;async function Za(){if(Yt||!y?.faction?.id||!y?.nation?.id)return;if(!Et(y.nation)){alert("Early elections are only available in parliamentary and semi-presidential systems.");return}const e=F?.pm_party_id;if(!e||e!==y.faction.id){alert("Prime Minister’s party only.");return}if(confirm(`⚡ CALL EARLY ELECTIONS?
...
Proceed?`)){Yt=!0;try{const t=Array.isArray(F?.party_ids)?F.party_ids:F?.pm_party_id?[F.pm_party_id]:[],a=await pa(w,y.nation.id,e,t);if(a&&a.success===!1){alert("Could not call early elections: "+(a.error||"unknown error"));return}alert("⚡ Early elections called. Government is now in caretaker status."),window.location.reload()}catch(t){console.error("[PartyActions] Call early elections failed:",t),alert("Failed to call early elections: "+(t?.message||"unknown error"))}finally{Yt=!1}}}let Vt=!1;async function ti(){if(!Vt&&y?.faction?.id&&confirm(`LEAVE COALITION?
...
Proceed?`)){Vt=!0;try{const{data:e,error:t}=await w.rpc("leave_coalition",{p_faction_id:y.faction.id});if(t)throw t;if(e&&e.success===!1)throw new Error(e.error||"Unknown error");const a=e?.became_minority?`

The government is now a minority.`:"",i=(e?.ministries_vacated||0)>0?`

${e.ministries_vacated} ministr${e.ministries_vacated===1?"y":"ies"} vacated.`:"";alert("You have left the coalition."+a+i),window.location.reload()}catch(e){console.error("[PartyActions] Leave Coalition failed:",e),alert("Failed to leave coalition: "+(e?.message||e))}finally{Vt=!1}}}let Kt=!1;async function ei(){if(Kt||!y?.faction?.id||!y?.nation?.id)return;if(!Et(y.nation)){alert("Resignation is only available in parliamentary and semi-presidential systems.");return}const e=F?.pm_party_id;if(!e||e!==y.faction.id){alert("Prime Minister’s party only.");return}if(confirm(`⚠ RESIGN AS PRIME MINISTER?
...
Proceed?`)){Kt=!0;try{const{data:t}=await w.from("shard").select("current_tick").eq("name","Alpha Shard").single(),a=t?.current_tick||y.shard?.current_tick||0;(await oa(w,y.nation.id,y.faction.id,a))?.result==="election_called"?alert("You have resigned. Snap election scheduled as fallback if no successor is nominated."):alert("You have resigned. Coalition has a short window to nominate a successor before a snap election fires."),window.location.reload()}catch(t){console.error("[PartyActions] Resign PM failed:",t),alert("Failed to resign: "+(t?.message||"unknown error"))}finally{Kt=!1}}}let Wt=!1;async function ai(){if(Wt||!y?.faction?.id)return;const e=y.faction,t=e.faction_name||"this party",a=e.seats||0,i=Number(e.momentum||0).toFixed(1),n=Math.round(Number(e.party_funds||0)),o=n>=1e3?"$"+n.toLocaleString():"$"+n;if(!confirm("DISBAND "+t.toUpperCase()+`?
...
This action CANNOT be undone.`))return;if(prompt('Type "DISBAND" to confirm dissolution of '+t+":")!=="DISBAND"){alert("Disband cancelled.");return}Wt=!0;try{const{data:c,error:d}=await w.rpc("disband_party",{p_faction_id:e.id});if(d)throw d;if(c&&c.success===!1)throw new Error(c.error||"Unknown error");sessionStorage.removeItem("active_faction_id"),sessionStorage.removeItem("nationhood_state");const{data:{user:l}}=await w.auth.getUser();if(l){const{data:m}=await w.from("factions").select("id, faction_type").or(`id.eq.${l.id},linked_user_id.eq.${l.id}`),s=(m||[]).find(f=>f.faction_type==="party"),p=(m||[]).find(f=>f.faction_type==="corporation");if(s){sessionStorage.setItem("active_faction_id",s.id),alert(t+` has been disbanded.
...
You have no remaining factions.`),window.location.href="faction-select.html"}catch(c){console.error("[PartyActions] Disband failed:",c),alert("Disband failed: "+(c?.message||c))}finally{Wt=!1}}let Jt=!1;async function ii(){if(Jt||!y?.faction?.id||!y?.nation?.id)return;const e=y.faction,t=y.nation,a=me(t);if(!Et(t)){alert("A vote of no confidence is only possible in a parliamentary or semi-presidential system.");return}const{data:i}=await w.from("head_of_government").select("faction_id, last_name").eq("nation_id",t.id).eq("active",!0).maybeSingle(),n=i?.faction_id||t.ruling_faction_id||null,o=i?.last_name||null;if(!n){alert("No active Prime Minister to file against.");return}if(n===e.id){alert("Your party is the Prime Minister — you cannot file a vote of no confidence against yourself.");return}const r=y.faction?.seats!=null?Number(y.faction.seats):0;if(r<1){alert("Your party needs at least 1 seat in the legislature to file a motion.");return}const{data:c}=await w.from("shard").select("current_tick").eq("name","Alpha Shard").single(),d=c?.current_tick||y.shard?.current_tick||0,{data:l}=await w.from("bills").select("id").eq("nation_id",t.id).eq("bill_type","no_confidence").in("status",["committee","floor"]).limit(1);if(l&&l.length>0){alert("A motion of no confidence is already pending.");return}const{data:m}=await w.from("campaign_actions").select("tick_performed").eq("nation_id",t.id).eq("action_type","no_confidence_filed").eq("target_id",n).order("tick_performed",{ascending:!1}).limit(1).maybeSingle();if(m){const f=d-Number(m.tick_performed||0);if(f<lt.NO_CONFIDENCE_COOLDOWN_TICKS){const v=lt.NO_CONFIDENCE_COOLDOWN_TICKS-f;alert(`Cooldown: ${v} tick${v!==1?"s":""} remaining before another motion can be filed against this PM party.`);return}}const s=o?a?`Motion of No Confidence in PM ${o}`:`Motion of No Confidence in the ${o} Government`:"Motion of No Confidence in the Government",p=a?`IF IT PASSES:
...
Proceed?`)){Jt=!0;try{const f=await ca(w,{faction:e,nation:t,pmFactionId:n,pmLastName:o,isSemiPres:a,tick:d,mySeats:r});if(!f.ok){alert("Failed to file motion: "+f.error);return}alert(`⚡ "${f.motionName}" has been filed!

Voting is now open for ${lt.NO_CONFIDENCE_VOTING_TICKS} ticks.`),window.location.href=`bill.html?id=${f.billId}`}catch(f){console.error("[PartyActions] No confidence file failed:",f),alert("Failed to file motion: "+(f?.message||"unknown error"))}finally{Jt=!1}}}let Xt=!1;async function oi(e){if(Xt)return;const t=y.faction,a=t.seats||0,i=Math.max(1,t.momentum??0);if(a<=0){alert("Your party has no seats — nothing to fundraise from.");return}const n=Oe(a,mt);if(i-n.momCost<1){alert(`Not enough momentum. You need ${n.momCost} momentum (current: ${Math.round(i)}, floor: 1). Try again next tick when momentum recovers.`);return}Xt=!0;try{const{data:o}=await w.from("factions").select("party_funds, momentum").eq("id",t.id).single();o&&(t.party_funds=o.party_funds??0,t.momentum=o.momentum??0);const r=Math.max(1,t.momentum??0),c=y.shard?.current_tick||0,d=Math.max(1,r-n.momCost),l=(t.party_funds||0)+n.raised,{error:m}=await w.from("factions").update({momentum:d,party_funds:l}).eq("id",t.id);if(m){alert("Fundraise failed: "+m.message);return}await w.from("campaign_actions").insert({party_id:t.id,nation_id:y.nation?.id,action_type:"fundraise",ap_cost:0,money_cost:0,tick_performed:c,result:{momentumDelta:-n.momCost,raised:n.raised,perSeat:n.perSeat,momCost:n.momCost,useNumber:mt+1,seats:a}}),t.momentum=d,t.party_funds=l,sessionStorage.removeItem("nationhood_state"),mt++,H(e)}catch(o){console.error("[PartyActions] Fundraise error:",o),alert("Fundraise failed.")}finally{Xt=!1}}function ni(e){const t=document.getElementById("pa-statement-modal");if(!t)return;const a=y.faction,i=a?.color||"#c8a832",n=a?.leader_first_name&&a?.leader_last_name?`${a.leader_first_name} ${a.leader_last_name}`:"Party Leader",o=we.map(m=>`<div class="pa-topic-card" data-topic="${m.id}" style="padding:8px 10px;cursor:pointer;border:1px solid var(--border-mid);display:flex;align-items:center;gap:8px;transition:all 0.12s;">
        ...
        <div class="pa-modal" style="width:520px;">
            ...
            <div style="padding:8px 16px;border-bottom:1px solid var(--border-main);background:${i}08;display:flex;align-items:center;gap:8px;">
                ...
                <span style="font-family:var(--font-mono);font-size:9px;font-weight:700;color:${i};">${_(n)}</span>
    ...
    `,t.classList.add("active");let r=null,c=!1;const d=()=>t.classList.remove("active");document.getElementById("pa-stmt-close")?.addEventListener("click",d),document.getElementById("pa-stmt-cancel")?.addEventListener("click",d),t.addEventListener("click",m=>{m.target===t&&d()}),document.getElementById("pa-stmt-topics")?.addEventListener("click",m=>{const s=m.target.closest(".pa-topic-card");s&&(r=s.dataset.topic,document.querySelectorAll(".pa-topic-card").forEach(p=>{const f=p.dataset.topic===r;p.style.borderColor=f?i:"var(--border-mid)",p.style.background=f?i+"0a":"";const v=p.querySelector("span:last-child");v&&(v.style.color=f?"var(--text-bright)":"var(--text-secondary)")}),l())});const l=()=>{const m=document.getElementById("pa-stmt-body")?.value?.trim()||"",s=document.getElementById("pa-stmt-submit"),p=document.getElementById("pa-stmt-charcount");p&&(p.textContent=`${m.length} characters`),s&&(s.disabled=!(r&&m.length>=10))};document.getElementById("pa-stmt-body")?.addEventListener("input",l),document.getElementById("pa-stmt-submit")?.addEventListener("click",async()=>{if(c)return;const m=document.getElementById("pa-stmt-body")?.value?.trim();if(!r||!m||m.length<10)return;c=!0;const s=document.getElementById("pa-stmt-submit");s&&(s.disabled=!0,s.textContent="Issuing...");try{const p=y.shard?.current_tick||0,v=we.find(z=>z.id===r)?.label||r,g=2e4,{data:h}=await w.from("factions").select("party_funds").eq("id",a.id).single(),x=h?.party_funds||0;if(x<g){alert(`Not enough funds. You have $${Math.round(x/1e3)}k, need $20k.`);return}const b=x-g,{error:u}=await w.from("factions").update({party_funds:b}).eq("id",a.id);if(u){alert("Failed to deduct funds: "+u.message);return}a.party_funds=b;const L=$e[Math.floor(Math.random()*$e.length)].replace("{party_name}",a.faction_name||"Unknown Party").replace("{leader_name}",n).replace("{topic}",v),{error:M}=await w.from("campaign_actions").insert({party_id:a.id,nation_id:y.nation?.id,action_type:"issue_statement",ap_cost:1,money_cost:0,tick_performed:p,result:{topic:r,topicLabel:v,headline:L,body:m,leaderName:n}});M&&console.error("[PartyActions] Statement log failed:",M.message);const{error:C}=await w.from("valdorian_articles").insert({nation_id:y.nation?.id,event_type:"issue_statement",tier:3,section:"politics",headline:L,subheadline:v,lede:m.substring(0,200)+(m.length>200?"...":""),body_paragraphs:JSON.stringify(m.split(/\n\n+/).filter(z=>z.trim())),quotes:JSON.stringify([{posture:"assertive",text:m.substring(0,150)}]),byline_reporter:"Political Desk",topic_tags:JSON.stringify([r]),source_event_id:"statement_"+Date.now(),tick:p});C&&console.error("[PartyActions] Article creation failed:",C.message);const{error:k}=await w.from("event_log").insert({nation_id:y.nation?.id,event_name:L,category:"political",description_chosen:`${a.faction_name} issues the following statement regarding ${v}: "${m}"`,fired_at_tick:p});k&&console.warn("[Statement] event_log insert failed:",k.message);const{error:I}=await w.from("admin_timeline_events").insert({nation_id:y.nation?.id,tick:p,type:"communications",title:"Statement Issued",description:`${n} issued a public statement on ${v}: "${m.substring(0,120)}${m.length>120?"...":""}"`});I&&console.warn("[Statement] timeline insert failed:",I.message),d(),H(e)}catch(p){console.error("[PartyActions] Statement error:",p),alert("Failed to issue statement. Please try again.")}finally{c=!1,s&&(s.disabled=!1,s.textContent="Issue Statement")}})}const Ft=20;function si(e){const t=document.getElementById("pa-platform-modal");if(!t)return;const a=y.faction;y.nation;const i=a?.color||"#c8a832";let n=null,o=!1;const r={};for(const l of zt)l.faction_id!==a?.id&&(r[l.platform_key]=(r[l.platform_key]||0)+1);const c=new Set(et.map(l=>l.platform_key));function d(){const l=xt.find(f=>f.id===n),m=l?xe(r[l.id]||0):null;l&&zt.filter(f=>f.platform_key===l.id&&f.faction_id!==a?.id);const s=xt.map(f=>{const v=n===f.id,g=c.has(f.id),h=xe(r[f.id]||0),x=r[f.id]||0;return`<div class="pa-plat-card ${v?"selected":""} ${g?"adopted":""}" data-plat="${f.id}">
            ...
            </div>`;else{const f=l.improve.map(b=>{const u=be(b,"improve");return`<span style="display:inline-flex;align-items:center;gap:3px;font-family:var(--font-mono);font-size:8px;padding:2px 6px;background:rgba(92,204,92,0.05);border:1px solid rgba(92,204,92,0.15);color:${u.color};white-space:nowrap;">${u.arrow} ${ye[b]||b}</span>`}).join(""),v=l.worsen.map(b=>{const u=be(b,"worsen");return`<span style="display:inline-flex;align-items:center;gap:3px;font-family:var(--font-mono);font-size:8px;padding:2px 6px;background:rgba(204,85,85,0.05);border:1px solid rgba(204,85,85,0.15);color:${u.color};white-space:nowrap;">${u.arrow} ${ye[b]||b}</span>`}).join(""),g=c.has(l.id),h=et.length;let x;g?x=`<div style="font-family:var(--font-mono);font-size:10px;font-weight:700;color:${i};display:flex;align-items:center;gap:6px;">✓ CURRENT PLATFORM</div>`:h>=3?x='<div style="font-family:var(--font-mono);font-size:9px;color:var(--red);">All 3 platform slots are full.</div>':o?x=`<div style="display:flex;align-items:center;gap:8px;">
        ...
        `,document.getElementById("pa-plat-close")?.addEventListener("click",()=>t.classList.remove("active")),t.onclick=f=>{f.target===t&&t.classList.remove("active")},document.getElementById("pa-plat-grid")?.addEventListener("click",f=>{const v=f.target.closest(".pa-plat-card");v&&(n=v.dataset.plat,o=!1,d())}),document.getElementById("pa-plat-adopt")?.addEventListener("click",()=>{o=!0,d()}),document.getElementById("pa-plat-conf-cancel")?.addEventListener("click",()=>{o=!1,d()}),document.getElementById("pa-plat-conf-yes")?.addEventListener("click",()=>ri(e,n))}t.classList.add("active"),d()}let Lt=!1;async function ri(e,t){if(Lt)return;Lt=!0;const a=document.getElementById("pa-platform-modal"),i=y.faction,n=y.nation;if(!i||!n||!t){Lt=!1;return}const o=xt.find(l=>l.id===t);if(!o)return;const r={},c={},d=l=>fe.has(l);for(const l of o.improve){const m=Number(n[l]??50);r[l]=m,d(l)?c[l]=Math.max(0,m-Ft):c[l]=Math.min(100,m+Ft)}try{const l=y.shard?.current_tick||0,{data:m,error:s}=await w.rpc("adopt_platform",{p_faction_id:i.id,p_nation_id:n.id,p_platform_key:t,p_tick:l,p_baseline_stats:r,p_target_stats:c});if(s){console.error("[PartyActions] Platform adoption failed:",s.message),alert("Failed to adopt platform: "+s.message);return}if(m&&!m.success){alert(m.error||"Failed to adopt platform.");return}const p=m?.slot||et.length+1;et.push({faction_id:i.id,nation_id:n.id,platform_key:t,slot:p,adopted_at_tick:l,baseline_stats:r,target_stats:c,status:"active"}),zt.push(et[et.length-1]),i&&m?.momentum_gained&&(i.momentum=(i.momentum||0)+m.momentum_gained),i&&(i.action_points=Math.max(0,(i.action_points||0)-2)),a?.classList.remove("active"),H(e)}catch(l){console.error("[PartyActions] Platform adoption error:",l),alert("An error occurred. Please try again.")}finally{Lt=!1}}let ht=null,Ye={isGoverning:!1,statusLabel:"OPPOSITION",administration:null,governanceScore:0,governanceDeltas:[],governanceMultiplier:1,governanceDecayCycles:0,ticksInPower:0,myFaction:null,allParties:[],rivalParties:[],strongholdsByParty:{},recentActivity:[],caucuses:[],nextElection:null,nextElectionTicks:null};function V(e){if(!e)return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML}const li=[...fa,...va];function di(e,t,a,i){const n=i-(a||i);if(!t)return{score:0,deltas:[],decayCycles:0,multiplier:1,ticksInPower:n};let o=0,r=0;const c=[];for(const s of li){const p=ua(s);if(p===0)continue;const f=Number(t[s]??0),v=Number(e[s]??0),g=v-f;if(g===0)continue;const h=g*p,x=h>0;c.push({key:s,start:f,now:v,delta:g,signed:h,dir:p,isGood:x}),o+=h,r++}let d=r>0?o/r:0;const l=Math.floor(n/24),m=d>0?Math.pow(.97,l):1;return d*=m,{score:Math.round(d*10)/10,deltas:c,decayCycles:l,multiplier:m,ticksInPower:n}}function ci(e,t,a){const i={};for(const n of e)i[n.id]=ma(n.id,t,a,3);return i}async function pi(e,t,a){ht=t;const i=document.getElementById(a);if(!i)return;const n=t.faction,o=t.nation,r=o?.id,c=n?.id;if(!n||!r){i.innerHTML='<div style="padding:40px;text-align:center;color:var(--text-dim);font-family:var(--font-mono);font-size:10px;">No faction data.</div>';return}i.innerHTML='<div style="padding:40px;text-align:center;color:var(--text-dim);font-family:var(--font-mono);font-size:10px;">Loading party overview...</div>';try{const d=t.shard?.current_tick||0,[l,m,s,p,f,v,g,h]=await Promise.all([Ne(e,r,c),e.from("factions").select("*").eq("nation_id",r).eq("faction_type","party"),e.from("sectors").select("id, sector_key, name, weight, base_turnout, is_active").eq("nation_id",r).eq("is_active",!0).order("display_order"),e.from("campaign_actions").select("*").eq("party_id",c).order("tick_performed",{ascending:!1}).limit(20),e.from("caucus_factions").select("*").eq("party_id",c).eq("is_active",!0),e.from("elections").select("*").eq("nation_id",r).eq("status","scheduled").order("election_tick",{ascending:!0}).limit(5),e.from("ministries").select("party_id").eq("nation_id",r).eq("is_active",!0),aa(r)]);m.error&&console.error("[PartyOverview] Parties fetch error:",m.error.message),s.error&&console.error("[PartyOverview] Sectors fetch error:",s.error.message),p.error&&console.error("[PartyOverview] Activity fetch error:",p.error.message),f.error&&console.error("[PartyOverview] Caucus fetch error:",f.error.message),v.error&&console.error("[PartyOverview] Election fetch error:",v.error.message);const x=m.data||[],b=s.data||[],u=l.administration,$=new Set((g.data||[]).map(P=>P.party_id).filter(Boolean));let L=[];if(x.length>0&&b.length>0){const P=x.map(N=>N.id),{data:S,error:A}=await e.from("faction_sector_popularity").select("faction_id, sector_id, popularity").in("faction_id",P);A&&console.error("[PartyOverview] Popularity fetch error:",A.message),L=S||[]}const M=ci(x,b,L);let C={score:0,deltas:[],decayCycles:0,multiplier:1,ticksInPower:0};u&&u.stats_at_start&&(C=di(o,u.stats_at_start,u.started_at_tick,d));const k=v.data||[],I=k[0]||null,z=I?Math.max(0,I.election_tick-d):null;let E=null;I&&o&&rt(o)&&(E=k.some(S=>S.election_type==="presidential"&&S.election_tick===I.election_tick)?"General":"Midterm"),Ye={isGoverning:l.isGoverning,statusLabel:l.label,administration:u,ministryPartyIds:$,governanceScore:C.score,governanceDeltas:C.deltas.sort((P,S)=>Math.abs(S.signed)-Math.abs(P.signed)),governanceMultiplier:C.multiplier,governanceDecayCycles:C.decayCycles,ticksInPower:C.ticksInPower,myFaction:n,allParties:x,rivalParties:x.filter(P=>P.id!==c),blocMap:h,strongholdsByParty:M,recentActivity:p.data||[],caucuses:f.data||[],nextElection:I,nextElectionTicks:z,nextElectionLabel:E},Ve(i)}catch(d){console.error("[PartyOverview] Init error:",d),i.innerHTML='<div style="padding:40px;text-align:center;color:var(--red);font-family:var(--font-mono);font-size:10px;">Failed to load party overview.</div>'}}let ot=[];function Ve(e){const t=Ye,a=t.myFaction,i=ht.nation,n=a?.party_color||a?.color||"#c8a832";ht.shard?.current_tick,ot.length===0&&(ot=[a?.id,...t.rivalParties.map(m=>m.id)]),t.administration?.admin_name||t.isGoverning;const o=t.statusLabel,r=t.isGoverning?"var(--green)":"var(--orange)",c=a?.seats||0,d=i?.total_seats||100,l=a?.momentum??50;e.innerHTML=`<div class="po-page">
        ${mi(t,n,c,d,l)}
    ...
    </div>`,e.querySelectorAll(".po-legend-item").forEach(m=>{m.addEventListener("click",()=>{const s=m.dataset.partyId;s!==a?.id&&(ot.includes(s)?ot=ot.filter(p=>p!==s):ot.push(s),Ve(e))})})}function mi(e,t,a,i,n){const o=e.governanceScore,r=o>=0?"var(--green)":"var(--red)",c=e.isGoverning?e.administration?.admin_name||"Government":"Opposition",d=(ht.nation?.government_type||"").toLowerCase().includes("monarchy"),l=d?"No elections":e.nextElectionTicks!=null?e.nextElectionTicks:"—",m=d?"var(--text-dim)":typeof l=="number"&&l<=3?"var(--red)":"var(--text-bright)",s=d?"NEXT ELECTION":e.nextElectionLabel?"NEXT "+e.nextElectionLabel.toUpperCase():"NEXT ELECTION";return`<div class="po-summary">
        <div class="po-summary-cell" style="display:flex;flex-direction:row;align-items:center;gap:8px;">
            ...
            <div>
                <div style="font-size:11px;font-weight:700;color:var(--text-bright);">${V(c)}</div>
        ...
        <div class="po-summary-cell" style="text-align:center;">
            ...
            <div style="display:flex;align-items:baseline;justify-content:center;gap:3px;">
                <span class="po-summary-value" style="color:var(--orange);">${n}</span>
        ...
        <div class="po-summary-cell" style="text-align:center;">
            ...
            <div class="po-summary-value" style="color:${m};">${l}${typeof l=="number"?" ticks":""}</div>
        </div>
    </div>`}function fi(e,t,a,i,n){const o=t?.leader_first_name&&t?.leader_last_name?`${t.leader_first_name} ${t.leader_last_name}`:"Unknown",r=((t?.leader_first_name||"?")[0]+(t?.leader_last_name||"?")[0]).toUpperCase();t?.leader_age&&`${t.leader_age}`;const c=t?.approval_rating??0;return`<div class="po-card po-identity" style="border-left-color:${a};">
        <div class="po-identity-inner">
            ...
            <div style="flex:1;min-width:0;">
                <div style="display:flex;align-items:center;gap:6px;margin-bottom:2px;flex-wrap:wrap;">
                    ...
                    <span class="po-identity-badge" style="color:${n};background:${n}0a;border-color:${n}44;">${i}</span>
    ...
    </div>`}function vi(e){const t=e.governanceDeltas,a=e.governanceScore,i=a>=0?"var(--green)":"var(--red)",o=(e.governanceDecayCycles>0&&a>0?`Decay: ${((1-e.governanceMultiplier)*100).toFixed(1)}% (${e.governanceDecayCycles} cycles)`:"")||(t.length>0?`${t.length} modifier${t.length===1?"":"s"}`:""),r=t.map((c,d)=>{const l=c.isGood?"var(--green)":"var(--red)",m=c.delta>0?"+":"",s=c.key.replace(/_/g," ").replace(/\b\w/g,p=>p.toUpperCase());return`<div class="po-gov-row" style="${d<t.length-1?"border-bottom:1px solid rgba(200,196,184,0.03);":""}">
            <span class="po-gov-stat">${V(s)}</span>
            <span class="po-gov-val">${c.start.toFixed(1)}</span>
            <span class="po-gov-val">${c.now.toFixed(1)}</span>
            <span class="po-gov-delta" style="color:${l};">${m}${c.delta.toFixed(1)}</span>
    ...
    </div>`}function ui(e,t,a){const i=[{id:t?.id,name:"You",color:a},...e.rivalParties.map(d=>({id:d.id,name:d.abbreviation||d.faction_name?.slice(0,3)||"?",color:d.party_color||"#666"}))],n=i.map(d=>{const l=ot.includes(d.id);return`<div class="po-legend-item ${l?"active":"inactive"}" data-party-id="${d.id}" style="${l?`background:${d.color}12;border-color:${d.color}44;`:""}">
            <div class="po-legend-dot" style="background:${l?d.color:"var(--text-dim)"};"></div>
            <span class="po-legend-name">${V(d.name)}</span>
        </div>`}).join(""),o=new Set(ot);let r=0;for(const d of o){const l=e.strongholdsByParty[d]||[];for(const m of l)m.contribution>r&&(r=m.contribution)}r<=0&&(r=1);const c=i.filter(d=>o.has(d.id)).map(d=>{const l=e.strongholdsByParty[d.id]||[],m=d.color||"#666",s=l.length>0?l.map(p=>{const f=Math.max(8,p.contribution/r*100);return`<div class="po-stronghold-chip" style="border-color:${m}44;background:${m}10;">
                        <div class="po-stronghold-chip-bar" style="width:${f}%;background:${m};"></div>
                        <span class="po-stronghold-chip-label">${V(p.name)}</span>
                ...
                <div class="po-stronghold-chips">${s}</div>
            </div>`}).join("");return`<div class="po-card">
        <div class="po-card-header">
        ...
        <div style="padding:8px 12px;">
            <div class="po-legend">${n}</div>
            ${c||'<div style="padding:8px 0;font-size:9px;color:var(--text-dim);font-family:var(--font-mono);">No parties to display.</div>'}
        </div>
    </div>`}function gi(e){const t=(e.caucuses||[]).filter(n=>n.name&&n.name!=="Unnamed");if(t.length===0)return`<div class="po-card">
            <div class="po-card-header">
                <span class="po-card-title">INTERNAL CAUCUSES</span>
                <span class="po-card-subtitle">None</span>
            </div>
        </div>`;const a=e.faction?.seats||0,i=t.map(n=>{const o=n.relationship_score??50,r=o>60?"var(--green)":o>40?"var(--amber)":"var(--red)",c=Math.round((n.seat_share||0)*a),d=(n.dominant_axis||"").replace(/_/g,"/"),l=n.wing_end==="left"?d.split("/")[0]:d.split("/")[1]||"";return`<div class="po-caucus-row">
            <div>
                <div class="po-caucus-name">${V(n.name)}</div>
        ...
        ${i}
    </div>`}function yi(e,t){const i=Math.round(t*8/100*10)/10,n=Math.min(100,Math.max(0,t)),o=t>=60?"var(--green)":t>=30?"var(--orange)":"var(--red)";return`<div class="po-card">
        <div class="po-card-header">
        ...
        <div style="padding:10px 12px;">
            ...
            <div style="width:100%;height:4px;background:var(--border-main);">
                <div style="height:100%;width:${n}%;background:${o};"></div>
            </div>
    ...
    </div>`}function bi(e){const t=e.recentActivity||[],a=ht.shard?.current_tick||0;if(t.length===0)return`<div class="po-card" style="flex:1;">
            <div class="po-card-header">
        ...
        <div style="max-height:380px;overflow-y:auto;">${t.map(o=>{const r=a-(o.tick_performed||0),c=r===0?"0t":r+"t",d=o.result||{},l=d.momentumDelta||d.momentum_delta||d.momentum||(d.momCost?-d.momCost:0)||(d.effects||[]).reduce((v,g)=>v+(g.stat==="Momentum"?g.value:0),0)||0,m=l>0?"+":"",s=l>0?"var(--green)":l<0?"var(--red)":"var(--text-dim)";let f=i[o.action_type]||o.action_type?.replace(/_/g," ")||"?";return o.action_type==="rally"?f="Rally: "+(d.outcomeName||d.label||"Unknown")+(l?" ("+m+l+")":""):o.action_type==="press_conference"?f="Press Conference ("+m+l+")":o.action_type==="attack"?f="Attack on "+(d.targetName||"rival"):o.action_type==="issue_statement"?f="Issued statement"+(l?" ("+m+l+")":""):o.action_type==="take_stance"?f="Took stance on "+(d.issueLabel||"issue"):o.action_type==="ideological_pivot"?f="Ideology shift: "+(d.targetAxis||""):o.action_type==="poll_now"&&(f="Polled (margin: "+(d.pollMargin||"?")+")"),`<div style="padding:5px 12px;border-bottom:1px solid rgba(200,196,184,0.03);display:flex;justify-content:space-between;align-items:center;">
            ...
            <div style="display:flex;align-items:center;gap:8px;flex-shrink:0;">
                <span style="font-family:var(--font-mono);font-size:9px;font-weight:700;color:${s};">${l!==0?m+l:"—"}</span>
                <span style="font-family:var(--font-mono);font-size:7px;color:var(--text-dim);width:20px;text-align:right;">${c}</span>
            </div>
        </div>`}).join("")}</div>
    </div>`}function xi(e,t){const a=e.rivalParties,i=e.administration,n=ht.nation,o=i?.pm_party_id,r=n?.total_seats||100,c=a.map(d=>{const l=d.party_color||"#666",m=d.abbreviation||d.faction_name?.slice(0,3)?.toUpperCase()||"?",s=d.leader_first_name&&d.leader_last_name?`${d.leader_first_name} ${d.leader_last_name}`:"Unknown",p=d.seats||0,f=wa(d,i,e.ministryPartyIds,n);let v=f.label;const g=f.isGoverning?"var(--green)":"var(--orange)";f.isGoverning&&f.label==="GOVERNING"&&(d.id===o?v="GOVERNING — LEAD":v="GOVERNING — JUNIOR");const h=p-(t?.seats||0),x=h>0?"var(--green)":h<0?"var(--red)":"var(--text-dim)",b=e.strongholdsByParty?.[d.id]||[],u=b.length>0?`<div style="display:flex;flex-wrap:wrap;gap:4px;">${b.map($=>`<span style="font-family:var(--font-mono);font-size:9px;padding:2px 6px;border:1px solid ${l}44;background:${l}10;color:var(--text-bright);white-space:nowrap;">${V($.name)}</span>`).join("")}</div>`:'<div style="font-family:var(--font-mono);font-size:9px;color:var(--text-dim);">Unaligned</div>';return`<div style="padding:12px 16px;border-bottom:1px solid var(--border-main);">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px;">
                <div style="display:flex;align-items:center;gap:8px;">
                    <div style="width:36px;height:36px;background:${l}15;border:1px solid ${l}33;display:flex;align-items:center;justify-content:center;font-family:var(--font-mono);font-size:12px;font-weight:700;color:${l};">${V(m)}</div>
                    <div>
                        <div style="font-size:15px;font-weight:700;color:var(--text-bright);">${V(d.faction_name)}</div>
                        <div style="font-family:var(--font-mono);font-size:11px;color:var(--text-dim);">${V(s)}</div>
                    </div>
                </div>
                <div style="display:flex;flex-direction:column;align-items:flex-end;gap:3px;">
                    <span style="font-family:var(--font-mono);font-size:9px;font-weight:700;padding:2px 7px;color:${g};background:${g}0a;border:1px solid ${g}44;white-space:nowrap;">${v}</span>
    ...
    </div>`}function hi(e){return`<div class="po-card" style="padding:8px 12px;">
    ...
    </div>`}function _i(){return`<div style="background:var(--bg-card);border:1px solid var(--border-main);padding:8px 12px;">
    ...
    </div>`}let B=null,O=null,yt=!1,_t=null,q=[],ft=[],tt=0,ne={},ge=[],Ke=null,it=0,Ot=null,st=0,ct=[],Qt=!1,$t=null,Y={},Zt=!1;function U(e){if(!e)return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML}async function We(e,t){B=e,O=t;const a=t.nation,i=t.faction;if(!a||!i)return{needed:!1};const[n,o,r,c,d,l,m]=await Promise.all([e.from("elections").select("id, election_type, election_tick, status").eq("nation_id",a.id).eq("status","completed").order("election_tick",{ascending:!1}).limit(1).maybeSingle(),e.from("shard").select("current_tick").eq("name","Alpha Shard").single(),pe(e,a.id),e.from("factions").select("id, faction_name, abbreviation, party_color, seats, bloc_id").eq("nation_id",a.id).eq("faction_type","party").is("abandoned_at",null).order("seats",{ascending:!1}),e.from("head_of_government").select("id").eq("nation_id",a.id).eq("active",!0).limit(1).maybeSingle(),e.from("elections").select("election_tick, election_type").eq("nation_id",a.id).eq("status","scheduled").order("election_tick",{ascending:!0}),e.from("faction_platforms").select("faction_id, platform_key, slot").eq("nation_id",a.id).eq("status","active").order("slot",{ascending:!0})]);st=o.data?.current_tick??0,q=c.data||[],tt=q.reduce((g,h)=>g+(h.seats||0),0),it=Math.ceil(tt/2)+1,ge=l?.data||[],Ke=r||null,ne={},m?.error&&console.warn("[CoalitionFormation] faction_platforms query failed:",m.error.message);for(const g of m?.data||[])(ne[g.faction_id]||=[]).push(g.platform_key);const s=n.data,p=r||null,f=!!d.data,v=!!p||f;return rt(a)?(yt=!1,{needed:!1}):(s&&!v?(yt=!0,_t=s.id,Ot=s.election_tick):(yt=!v,s&&(_t=s.id,Ot=s.election_tick)),{needed:yt})}function wi(){const e=O?.nation;if(!e||K(e))return"";const t=rt(e),a=ge[0]||null,i=a?.election_tick??null,n=a?.election_type||"parliamentary",o=t?n==="presidential"?"General":"Midterm":"Parliamentary",r=Number(st)||0,c=i!=null?Math.max(0,i-r):null,d=c==null?null:`${c} Month${c===1?"":"s"}`,l=i!=null?ga(i):"TBD",m=Number(e.total_seats)||0,s=Number(e.parliamentary_term_ticks)||Number(e.election_frequency)||24,p=`${s} Month${s===1?"":"s"}`,f=e.name||"Unknown",v=e.flag_url||`assets/flags/${f}.png`,g=[d,`Type: ${o}`].filter(Boolean).map(u=>`<div class="cf-eh-stat-sub">${U(u)}</div>`).join(""),h=Ke?.status||null,x=h?h.charAt(0).toUpperCase()+h.slice(1):null;return`<div class="cf-election-header">
    ...
    </div>`}function $i(){const e=O?.nation;if(!e||K(e))return"";const t=Number(e.total_seats)||0;if(t<=0)return"";const a=q.filter(s=>(s.seats||0)>0).slice().sort((s,p)=>(p.seats||0)-(s.seats||0)),i=a.reduce((s,p)=>s+(p.seats||0),0),n=Math.max(0,t-i),o=Math.ceil(t/2)+1,r=o/t*100,c=a.map(s=>{const p=(s.seats||0)/t*100,f=s.party_color||"var(--text-dim)";return`<div class="cf-em-seg" style="width:${p}%;background:${U(f)};" title="${U(s.faction_name)}: ${s.seats} seats"></div>`}).join(""),d=n>0?`<div class="cf-em-seg cf-em-seg--stake" style="width:${n/t*100}%;">
               <span class="cf-em-stake-label">${n} SEATS AT STAKE</span>
           </div>`:"",l=a.map(s=>{const p=s.party_color||"var(--text-dim)";return`<div class="cf-em-chip">
            <span class="cf-em-swatch" style="background:${U(p)};"></span>
            <span class="cf-em-chip-name">${U(s.faction_name)}</span>
            <span class="cf-em-chip-count">${s.seats}</span>
            <span class="cf-em-chip-unit">seats</span>
        </div>`}).join(""),m=n>0?`<div class="cf-em-chip">
               <span class="cf-em-swatch cf-em-swatch--stake"></span>
               <span class="cf-em-chip-name">At Stake</span>
               <span class="cf-em-chip-count">${n}</span>
               <span class="cf-em-chip-unit">seats</span>
        ...
        </div>`;return}if(!_t){const b=ge[0]?.election_tick,u=b!=null?Math.max(0,b-st):"?";e.innerHTML=`${t}${i}
        <div class="cf-page">
            <div class="cf-no-formation">
        ...
        </div>`;return}await Si();const n=O.faction,o=Ot!==null?Math.max(0,st-Ot):0,r=Math.max(0,te-o),c=Math.min(100,o/te*100),d=o*2;let l="safe";r<=1?l="critical":r<=2&&(l="warning");const m=l==="critical"?"⚠️":l==="warning"?"⏳":"🤝",s=l==="critical"?"No Government — Snap Election Imminent":l==="warning"?"Coalition Formation — Time Running Out":"Coalition Formation In Progress",p=l==="critical"?"Form a government immediately or face snap elections":l==="warning"?"Parties are negotiating — the deadline is approaching":"Parties are negotiating a coalition — propose or join one below",f=q.find(b=>b.id===n.id)?.seats||0,v=f>0,g=ft.some(b=>b.proposed_by===n.id);let h="";if(!v)h='<div class="cf-note">Your party has <strong>0 seats</strong>. You cannot propose a coalition, but you may be invited to one.</div>';else if(g)h='<div class="cf-note">You have already submitted a proposal for this election.</div>';else{const b=$=>($||[]).map(L=>L.replace(/_/g," ")).join(", "),u=q.map($=>{const L=$.id===n.id,M=$.seats||0,C=$.party_color||"#888",I=(ne[$.id]||[]).map(E=>xt.find(P=>P.id===E)).filter(Boolean).map(E=>`<div class="cf-platform">
            ...
            </div>`).join(""),z=I?`<div class="cf-check-platforms">${I}</div>`:'<div class="cf-check-platforms cf-check-platforms--empty">No adopted platforms.</div>';return`<div class="cf-party-check ${L?"checked disabled":""}" data-party-id="${$.id}" style="border-left:3px solid ${C};">
        ...
        <div class="cf-proposals-grid">${ft.map(b=>{const u=q.find(N=>N.id===b.proposed_by),$=b.party_ids||[],L=$.reduce((N,T)=>N+(q.find(R=>R.id===T)?.seats||0),0),M=tt?Math.round(L/tt*100):0,C=L>=it,k=$.map(N=>{const T=q.find(R=>R.id===N);return`<span class="cf-party-chip" style="border-left:2px solid ${T?.party_color||"#888"};">${U(T?.faction_name||"?")} · ${T?.seats||0}</span>`}).join("");let I="";b.iAmSupporting?I='<span class="cf-status cf-status--supporting">✓ SUPPORTING</span>':b.iAmInvited?I='<span class="cf-status cf-status--invited">INVITED</span>':I='<span class="cf-status cf-status--locked">NOT INVITED</span>';const z=b.iAmInvited&&!b.iAmSupporting?`<button class="cf-support-btn" data-formation-id="${b.id}" data-action="support">Support This Coalition</button>`:b.iAmSupporting?`<button class="cf-withdraw-btn" data-formation-id="${b.id}" data-action="withdraw">Withdraw Support</button>`:"",E=b.supportCount>=b.coalitionSize,P=$t===b.id,S=E&&b.iAmInvited&&!P,A=E&&P;return`<div class="cf-proposal-card ${b.iAmSupporting?"supporting":""} ${b.iAmInvited?"":"not-invited"}">
                <div class="cf-proposal-title">${U(u?.faction_name||"Unknown")} Coalition ${I}</div>
                <div class="cf-proposal-seats">Seats: <span style="color:${C?"var(--green)":"var(--red)"};">${L}</span> (${M}%) ${C?"✓":"— below threshold"}</div>
                ...
                ${z}
                ${S?`<button class="cf-support-btn" data-formation-id="${b.id}" data-action="configure" style="margin-top:6px;background:var(--green);color:#000;border-color:var(--green);">Configure Government &amp; Assign Ministries</button>`:""}
                ${A?Ci(b):""}
            </div>`}).join("")}</div>
    `:"";e.innerHTML=`${t}${i}
    <div class="cf-page">
        ...
        <div class="cf-banner cf-banner--${l}">
            <div class="cf-banner-header">
                ...
                <div>
                    <div class="cf-banner-title">${s}</div>
                    <div class="cf-banner-subtitle">${p}</div>
                </div>
            </div>
            <div class="cf-countdown">
                <div class="cf-countdown-track"><div class="cf-countdown-fill cf-countdown-fill--${l}" style="width:${c}%;"></div></div>
        ...
        ${h}
        ${x}
    </div>`,ct=[n.id],Li(e)}const ki={prime_minister:"Prime Minister",interior:"Interior",foreign:"Foreign Affairs",defense:"Defense",finance:"Finance",education:"Education",healthcare:"Healthcare",labor:"Labor",justice:"Justice",trade:"Trade",energy:"Energy",transportation:"Transportation",security:"Security"};function Ei(e){const t=["prime_minister","interior","foreign","defense","finance","education","healthcare","labor","justice","trade","energy","transportation"],a=["interior","foreign","defense","finance","education","healthcare","labor","justice","trade","energy","transportation"];return me(e)?t:rt(e)?a:t}function Ci(e){const t=(e.party_ids||[]).map(l=>q.find(m=>m.id===l)).filter(Boolean),a=(e.party_ids||[]).includes(O.faction?.id);Y={...e.ministry_assignments||{}};const n=O.faction?.id,o=Y.prime_minister,r=o===n;let c=`<div style="padding:12px 16px;border-top:1px solid var(--border-main);background:var(--bg-card);">
        ...
        <div style="font-size:11px;color:var(--text-dim);margin-bottom:12px;">All coalition members can assign ministries. The party selected as Prime Minister clicks Form Government.</div>`;for(const l of la){const m=ki[l]||l,s=l==="prime_minister",p=Y[l];a&&(c+=`<div style="display:flex;align-items:center;gap:8px;padding:6px 0;border-bottom:1px solid rgba(42,42,36,0.2);">
                <span style="width:140px;font-family:var(--font-mono);font-size:10px;font-weight:${s?"700":"400"};color:${s?"var(--accent)":"var(--text-secondary)"};letter-spacing:0.5px;">${m}</span>
            ...
            </div>`)}const d=!!Y.prime_minister;if(d&&r)c+=`<div style="margin-top:14px;display:flex;justify-content:flex-end;">
        ...
        </div>`;else if(d&&!r){const l=t.find(m=>m.id===o);c+=`<div style="margin-top:14px;padding:8px 12px;background:rgba(92,204,92,0.04);border:1px solid rgba(92,204,92,0.12);font-family:var(--font-mono);font-size:10px;color:var(--text-dim);">
        ...
        </div>`;return c+="</div>",c}async function Ii(e,t){if(Zt)return;const a=Y.prime_minister;if(!a){alert("You must assign a Prime Minister first.");return}console.log("[Coalition] handleFormGovernment called. Assignments:",JSON.stringify(Y)),console.log("[Coalition] Formation:",e.id,"PM party:",a),Zt=!0;const i=document.getElementById("cf-form-gov-btn");i&&(i.disabled=!0,i.textContent="FORMING...");try{const n=O.nation,o=n.id,r=Bt(n?.name)||{},c=r.firstNames||["Alex","Maria","Carlos"],d=r.lastNames||["Garcia","Torres","Silva"],l={};for(const[h,x]of Object.entries(Y||{}))x&&(l[h]={first_name:c[Math.floor(Math.random()*c.length)],last_name:d[Math.floor(Math.random()*d.length)],age:35+Math.floor(Math.random()*25)});const{error:m}=await B.from("government_formations").update({ministry_assignments:Y,minister_names:l}).eq("id",e.id);if(m)throw new Error("Failed to save assignments: "+m.message);let s=!1;try{const h=Tt?Tt(null,n):{},{error:x}=await B.rpc("finalize_government_formation",{p_formation_id:e.id,p_caller_faction_id:O.faction.id,p_ministry_baselines:h||{}});if(x)throw x;s=!0}catch(h){console.warn("[Coalition] RPC failed, using fallback:",h.message)}s||await Mi(e),await B.from("government_formations").update({status:"formed",formed_at:new Date().toISOString()}).eq("id",e.id);const f=Ei(n).length,{count:v}=await B.from("ministries").select("id",{count:"exact",head:!0}).eq("nation_id",o).eq("is_active",!0),{count:g}=await B.from("ministries").select("id",{count:"exact",head:!0}).eq("nation_id",o).eq("is_active",!0).is("party_id",null);(!v||v<f||g&&g>0)&&(console.warn(`[Coalition] Ministry invariant check failed (expected=${f}, active=${v||0}, vacant=${g||0}) — populating from assignments`),await Je(o));try{const h={id:e.id,party_ids:e.party_ids||[],lead_party_id:Y.prime_minister};await Te(B,o,O.nation,"election",h,q,st,O.shard?.current_date||"",Number(O.nation?.gov_approval??50))}catch(h){console.warn("[Coalition] Post-finalization administration rollover failed (non-fatal):",h.message)}await sa(B,o,a,st,{skipCoalitionCheck:!0}),yt=!1,alert("Government formed successfully!"),await ut(t)}catch(n){console.error("[Coalition] Form government failed:",n),alert("Failed to form government: "+(n.message||n))}finally{Zt=!1,i&&(i.disabled=!1,i.textContent="FORM GOVERNMENT")}}async function Mi(e){const t=O.nation.id,{error:a}=await B.from("government_formations").update({status:"cancelled"}).eq("nation_id",t).eq("status","active").neq("id",e.id);a&&console.warn("[Coalition] Failed to cancel rival formations:",a.message);const{error:i}=await B.from("government_formations").update({status:"formed",formed_at:new Date().toISOString()}).eq("id",e.id);if(i)throw i;const{error:n}=await B.from("nations").update({failed_formation_attempts:0}).eq("id",t);n&&console.warn("[Coalition] Failed to reset formation attempts:",n.message),await Je(t);try{const o={id:e.id,party_ids:e.party_ids||[],lead_party_id:Y.prime_minister};await Te(B,t,O.nation,"election",o,q,st,O.shard?.current_date||"",Number(O.nation?.gov_approval??50))}catch(o){console.warn("[Coalition] Administration rollover failed (non-fatal):",o.message)}try{const o=Y.prime_minister,r=q.find(d=>d.id===o),c=(e.party_ids||[]).map(d=>{const l=q.find(m=>m.id===d);return l?`${l.faction_name} (${l.seats||0})`:null}).filter(Boolean).join(", ");await B.from("event_log").insert({nation_id:t,event_name:"Coalition Government Formed",category:"government",fired_at_tick:st,description_used:`${r?.faction_name||"PM party"} formed a coalition government with: ${c}`,description_chosen:`${r?.faction_name||"PM party"} formed a coalition government with: ${c}`})}catch(o){console.warn("[Coalition] event_log insert failed (non-fatal):",o.message)}}async function Je(e){let t=0;for(const[a,i]of Object.entries(Y)){if(!i)continue;const n=Bt(O.nation?.name)||{},o=n.firstNames||["Alex","Maria","Carlos"],r=n.lastNames||["Garcia","Torres","Silva"],c=o[Math.floor(Math.random()*o.length)],d=r[Math.floor(Math.random()*r.length)],l=35+Math.floor(Math.random()*25),m=Tt?Tt(a,O.nation):{},{data:s,error:p}=await B.from("ministries").update({party_id:i,minister_first_name:c,minister_last_name:d,minister_age:l,minister_approval:50,stat_baselines:m,is_active:!0}).eq("nation_id",e).eq("ministry_key",a).select("id");if(p)console.error(`[Coalition] FAILED to update ministry ${a}:`,p.message);else if(!s||s.length===0){const{error:f}=await B.from("ministries").insert({nation_id:e,ministry_key:a,ministry_name:da[a]||a,party_id:i,minister_first_name:c,minister_last_name:d,minister_age:l,minister_approval:50,stat_baselines:m,is_active:!0});f?console.error(`[Coalition] FAILED to insert ministry ${a}:`,f.message):t++}else t++}console.log(`[Coalition] Updated ${t} ministries for nation ${e}`)}async function Si(){if(!_t){ft=[];return}const{data:e}=await B.from("government_formations").select("*").eq("election_id",_t).eq("status","active").order("created_at",{ascending:!0}),t=[];for(const a of e||[]){const{data:i}=await B.from("government_formation_support").select("faction_id, supports").eq("formation_id",a.id),n=a.party_ids||[],r=(i||[]).filter(s=>n.includes(s.faction_id)).filter(s=>s.supports).length,c=n.length,l=(i||[]).find(s=>s.faction_id===O.faction?.id)?.supports===!0,m=n.includes(O.faction?.id);t.push({...a,supportCount:r,coalitionSize:c,iAmSupporting:l,iAmInvited:m})}ft=t}let Me=!1;function Li(e){Me||(Me=!0,e.addEventListener("click",async t=>{const a=t.target.closest(".cf-party-check:not(.disabled)");if(a){const n=a.dataset.partyId,r=q.find(l=>l.id===n)?.bloc_id||null,c=!ct.includes(n),d=r?q.filter(l=>l.bloc_id===r).map(l=>l.id):[n];for(const l of d){const m=ct.indexOf(l);c&&m===-1&&ct.push(l),!c&&m>-1&&ct.splice(m,1);const s=e.querySelector(`.cf-party-check[data-party-id="${l}"]`);if(!s)continue;s.classList.toggle("checked",c);const p=s.querySelector(".cf-check-box");p&&(p.textContent=c?"✓":"")}Pi();return}if(t.target.closest("#cf-propose-btn")){await Ai(e);return}const i=t.target.closest(".cf-support-btn, .cf-withdraw-btn");if(i){const n=i.dataset.formationId,o=i.dataset.action;if(o==="configure"){$t=n;const r=ft.find(c=>c.id===n);r&&(Y={...r.ministry_assignments||{}}),await ut(e)}else await Ti(n,o==="support",e);return}if(t.target.closest("#cf-form-gov-btn")){const n=ft.find(o=>o.id===$t);n&&await Ii(n,e);return}}),e.addEventListener("change",t=>{const a=t.target.closest(".cf-ministry-select");if(!a)return;const i=a.dataset.ministry,n=a.value||null;Y[i]=n,$t&&B.from("government_formations").update({ministry_assignments:Y}).eq("id",$t).then(({error:r})=>{r&&console.warn("[Coalition] Failed to save assignment:",r.message)});const o=document.getElementById("cf-form-gov-btn");if(o){const r=!!Y.prime_minister;o.disabled=!r,o.style.color=r?"#000":"var(--text-dim)",o.style.background=r?"var(--green)":"var(--bg-body)",o.style.borderColor=r?"var(--green)":"var(--border-main)",o.style.cursor=r?"pointer":"not-allowed"}}))}function Pi(){const e=document.getElementById("cf-preview-seats"),t=document.getElementById("cf-preview-pct"),a=document.getElementById("cf-preview-threshold");if(!e)return;const i=ct.reduce((r,c)=>r+(q.find(d=>d.id===c)?.seats||0),0),n=tt?Math.round(i/tt*100):0,o=i>=it;e.textContent=i,e.style.color=o?"var(--green)":"var(--text-bright)",t.textContent=n,a.textContent=o?`✓ Meets ${it}-seat threshold`:`— needs ${it} seats`,a.style.color=o?"var(--green)":"var(--text-dim)"}async function Ai(e){if(Qt)return;const t=O.faction;if((q.find(r=>r.id===t.id)?.seats||0)===0)return;const i=[...new Set(ct)],n=i.reduce((r,c)=>r+(q.find(d=>d.id===c)?.seats||0),0);if(n<it){alert(`Coalition needs ${it} seats. Currently: ${n}.`);return}Qt=!0;const o=document.getElementById("cf-propose-btn");o&&(o.disabled=!0,o.textContent="Submitting...");try{const{data:r}=await B.from("shard").select("current_date").eq("name","Alpha Shard").single(),{data:c,error:d}=await B.from("government_formations").insert({nation_id:O.nation.id,election_id:_t,proposed_by:t.id,party_ids:i,status:"active",game_year:r?.current_date||""}).select().single();if(d){alert("Error: "+d.message);return}const{error:l}=await B.from("government_formation_support").upsert({formation_id:c.id,faction_id:t.id,supports:!0},{onConflict:"formation_id,faction_id"});l&&console.warn("[Coalition] Auto-support insert failed:",l.message),await ut(e)}catch(r){console.error("[Coalition] Create proposal error:",r),alert("Failed to create proposal: "+(r.message||r))}finally{Qt=!1}}async function Ti(e,t,a){try{const{error:i}=await B.from("government_formation_support").upsert({formation_id:e,faction_id:O.faction?.id,supports:t},{onConflict:"formation_id,faction_id"});i&&console.error("[Coalition] Toggle support error:",i.message),await ut(a)}catch(i){console.error("[Coalition] Toggle support error:",i)}}let At=null,dt=[],se=[],re=null;function J(e){if(!e)return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML}function Se(e){return e>=1e6?(e/1e6).toFixed(2)+"M":e>=1e3?Math.round(e/1e3)+"k":String(e)}function Ni(e){return["January","February","March","April","May","June","July","August","September","October","November","December"][e%12]+", "+(2e3+Math.floor(e/12))}function zi(e,t){if((e.election_type||"parliamentary")==="presidential")return{label:"Presidential Election",color:"#5a8aaa"};const i=t?.end_reason||"";return i.includes("no_confidence")||i.includes("vnc")?{label:"Vote of No Confidence",color:"#d44a4a"}:i.includes("snap")||i.includes("dissolved")||i.includes("early")?{label:"Early Elections Called",color:"#c84"}:{label:"General Election",color:"#8b9a6b"}}async function Ri(e,t){At=t;const a=document.getElementById("pa-past-elections-root");if(!a)return;a.innerHTML='<div style="padding:40px;text-align:center;color:var(--text-dim);font-family:var(--font-mono);font-size:12px;">Loading election history...</div>';const i=t.nation?.id;if(!i){a.innerHTML='<div style="padding:40px;text-align:center;color:var(--text-dim);font-family:var(--font-mono);font-size:12px;">No nation data.</div>';return}const[n,o,r]=await Promise.all([e.from("elections").select("id, election_tick, election_type, status, results, created_at").eq("nation_id",i).eq("status","completed").order("election_tick",{ascending:!1}),e.from("administrations").select("*").eq("nation_id",i).order("started_at_tick",{ascending:!1}),e.from("factions").select("id, faction_name, abbreviation, party_color, seats").eq("nation_id",i).eq("faction_type","party").is("abandoned_at",null)]);dt=n.data||[],se=o.data||[];const c=r.data||[],d={};for(const l of c)d[l.id]=l;for(const l of dt){const m=l.results?.votes||[];for(const s of m){const p=d[s.party_id];p?(s.color=p.party_color||"#666",s.abbreviation=p.abbreviation||s.party_name?.slice(0,3)?.toUpperCase()||"?"):(s.color="#666",s.abbreviation=s.party_name?.slice(0,3)?.toUpperCase()||"?")}}Fi(a),Xe(a)}function Fi(e){e.addEventListener("click",t=>{const a=t.target.closest("[data-election-id]");if(a){const i=a.dataset.electionId;re=re===i?null:i,Xe(e)}})}function Xe(e,t){if(dt.length===0){e.innerHTML=`<div style="padding:12px 16px;">
        ...
        </div>`;return}const a=At.faction?.id,i=At.nation?.total_seats||100,n=Math.ceil(i/2)+1,o=dt.map((r,c)=>{const d=re===r.id,l=(r.results?.votes||[]).sort((k,I)=>(I.seats||0)-(k.seats||0)),m=l.slice(0,3),s=r.results?.turnout_pct??0,p=r.results?.total_votes_cast??0,f=Ni(r.election_tick),v=se.find(k=>k.started_at_tick>=r.election_tick&&k.started_at_tick<=r.election_tick+5),g=se.find(k=>k.ended_at_tick!=null&&k.ended_at_tick>=r.election_tick-2&&k.ended_at_tick<=r.election_tick+2),h=zi(r,g),x=rt(At.nation),b=x?"President":"PM",u=v?.prime_minister||"Unknown",$=v?.pm_party_id&&l.find(k=>k.party_id===v.pm_party_id)?.color||"#888",M=(c<dt.length-1?dt[c+1]:null)?.results?.votes||[];let C=`<div data-election-id="${r.id}" style="
            ...
            <div class="pe-row-head" style="padding:12px 20px;cursor:pointer;display:flex;align-items:center;justify-content:space-between;gap:10px;">
                ...
                <div class="pe-row-head-right" style="display:flex;align-items:center;gap:10px;flex-shrink:0;">
                    <div class="pe-leader-meta" style="font-family:var(--font-mono);font-size:10px;color:var(--text-dim);">
                        ${b}: <span style="color:${$};font-weight:700;">${J(u)}</span>
                    </div>
                    <span style="font-family:var(--font-mono);font-size:12px;color:var(--text-dim);">${d?"▲":"▼"}</span>
                </div>
            </div>
        </div>`;if(d){const k=l.map(E=>`<div style="width:${E.seats/i*100}%;background:${E.color};height:100%;display:flex;align-items:center;justify-content:center;font-family:var(--font-mono);font-size:${E.seats>=8?9:6}px;font-weight:700;color:#000;">${E.seats>=5?E.seats:""}</div>`).join(""),I=l.map(E=>{const P=E.party_id===a,S=M.find(R=>R.party_id===E.party_id),A=S?E.seats-(S.seats||0):null,T=E.seats/i*100-(E.vote_percentage||0);return`<div class="pe-tbl-row" style="display:flex;align-items:center;padding:8px 0;border-bottom:1px solid rgba(200,196,184,0.03);${P?`background:${E.color}08;`:""}">
                ...
                </div>`}).join("");let z="";if(v){const E=v.coalition_parties||[],P=v.total_seats||E.reduce((W,It)=>W+(It.seats||0),0),S=P>=n,A=S?"Majority Coalition":"Minority Coalition",N=v.ended_at_tick?v.end_reason||"Ended":"Current Government",T=v.ended_at_tick?"var(--text-dim)":"#5c5",R=v.ended_at_tick?Math.abs(v.ended_at_tick-v.started_at_tick)+" ticks":"Ongoing",Ze=E.map(W=>{const It=l.find(Gt=>Gt.party_id===W.party_id)?.color||"#666";return`<div style="width:${P>0?(W.seats||0)/P*100:0}%;background:${It};height:100%;"></div>`}).join(""),ta=E.map(W=>`<div style="display:flex;align-items:center;gap:4px;">
                    ...
                    </div>`).join("");z=`<div style="margin:0 20px 16px;background:var(--bg-card);border:1px solid var(--border-main);border-left:3px solid ${$};">
                    <div style="padding:12px 16px;">
                        ...
                        <div style="display:flex;align-items:center;gap:10px;margin-bottom:10px;">
                            <div style="width:36px;height:36px;background:${$}15;border:1.5px solid ${$};display:flex;align-items:center;justify-content:center;font-family:var(--font-mono);font-size:11px;font-weight:700;color:${$};">${J(u.split(" ").map(W=>W[0]).join(""))}</div>
                            <div>
                                <div style="font-size:14px;font-weight:700;color:var(--text-bright);">${J(u)}</div>
                                <div style="font-family:var(--font-mono);font-size:9px;color:var(--text-dim);">${x?"President":"Prime Minister"} &middot; ${J(v.pm_party_name||"")} &middot; ${A}</div>
                            </div>
                        </div>
                        ...
                        <div style="display:flex;gap:10px;align-items:center;">
                            ...
                            <span style="font-family:var(--font-mono);font-size:10px;font-weight:700;color:${S?"#5c5":"#c84"};">${P} seats ${S?"(majority +"+(P-n)+")":"(minority, "+(n-P)+" short)"}</span>
                        </div>
                    </div>
                ...
                <div style="padding:10px 20px;border-bottom:1px solid var(--border-main);">
                    ...
                    <div style="position:relative;height:0;">
                        <div style="position:absolute;bottom:0;left:${n/i*100}%;font-family:var(--font-mono);font-size:8px;color:var(--text-dim);transform:translateX(-50%);">▲ ${n} majority</div>
                    </div>
                </div>
    ...
    </div>`}let Z=null,le=!1,Le=!1,de=!1,Pe=!1,ce=!1;function Qe(e){document.querySelectorAll(".pa-subtab").forEach(t=>t.classList.toggle("active",t.dataset.panel===e)),document.querySelectorAll(".pa-panel").forEach(t=>t.classList.toggle("active",t.id==="panel-"+e)),sessionStorage.setItem("party_subtab",e),e==="actions"&&!le&&Z&&(le=!0,De(gt,Z)),e==="parties"&&!Le&&Z&&(Le=!0,pi(gt,Z,"pa-parties-root")),e==="election"&&!de&&Z&&(de=!0,ce?ut(document.getElementById("pa-election-root")):We(gt,Z).then(()=>{ce=!0,ut(document.getElementById("pa-election-root"))})),e==="past-elections"&&!Pe&&Z&&(Pe=!0,Ri(gt,Z))}document.getElementById("pa-subtabs").addEventListener("click",e=>{const t=e.target.closest(".pa-subtab");!t||t.classList.contains("active")||Qe(t.dataset.panel)});ia("politics",async e=>{Z=e,We(gt,e).then(({needed:a})=>{if(ce=!0,a){const i=document.querySelector('.pa-subtab[data-panel="election"]');i&&!i.querySelector(".pa-subtab-badge")&&(i.innerHTML+='<span class="pa-subtab-badge"></span>');const n=document.querySelector('.nav-tab[data-tab="politics"]');n&&!n.querySelector(".pa-subtab-badge")&&(n.innerHTML+='<span class="pa-subtab-badge"></span>')}de&&ut(document.getElementById("pa-election-root"))});const t=sessionStorage.getItem("party_subtab");t&&t!=="actions"?Qe(t):(le=!0,await De(gt,e))});
