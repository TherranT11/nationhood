import{_}from"./supabase-client-BXEzLDpS.js";import{e as g}from"./utils-C2W-HleY.js";import{initMessaging as Bi}from"./messaging-B5Fng3EZ.js";import{c as qi,a as ht,E as Re,b as Qe,d as ei,e as Ni,f as Ri,h as Qt}from"./equipment-DsuDdEne.js";const ti={LOW:"#c84",STD:"#ca5",HIGH:"#5c5"},de=[{key:"concrete",name:"Concrete",category:"RAW",tiers:{LOW:{requirements:[]},STD:{requirements:[{stat:"manufacturing_output",min:20}]},HIGH:{requirements:[{stat:"manufacturing_output",min:50},{stat:"higher_education",min:40}]}},priceDrivers:["manufacturing_output","inflation","fuel_prices","urbanization"]},{key:"steel",name:"Steel",category:"RAW",tiers:{LOW:{requirements:[{stat:"manufacturing_output",min:10}]},STD:{requirements:[{stat:"manufacturing_output",min:35},{stat:"rare_minerals",min:20}]},HIGH:{requirements:[{stat:"manufacturing_output",min:60},{stat:"rare_minerals",min:40},{stat:"higher_education",min:45}]}},priceDrivers:["manufacturing_output","rare_minerals","inflation","fuel_prices"]},{key:"lumber",name:"Lumber",category:"RAW",tiers:{LOW:{requirements:[{stat:"arable_land",min:10}]},STD:{requirements:[{stat:"arable_land",min:30},{stat:"physical_infrastructure",min:20}]},HIGH:{requirements:[{stat:"arable_land",min:50},{stat:"manufacturing_output",min:30}]}},priceDrivers:["arable_land","physical_infrastructure","inflation"]},{key:"aggregate",name:"Aggregate",category:"RAW",tiers:{LOW:{requirements:[]},STD:{requirements:[{stat:"rare_minerals",min:15},{stat:"physical_infrastructure",min:20}]},HIGH:{requirements:[{stat:"rare_minerals",min:35},{stat:"manufacturing_output",min:25}]}},priceDrivers:["rare_minerals","physical_infrastructure","inflation"]},{key:"em",name:"E&M Systems",category:"MANUFACTURED",tiers:{LOW:{requirements:[{stat:"manufacturing_output",min:15}]},STD:{requirements:[{stat:"manufacturing_output",min:40},{stat:"digital_infrastructure",min:25}]},HIGH:{requirements:[{stat:"manufacturing_output",min:55},{stat:"digital_infrastructure",min:50},{stat:"energy_generation",min:40}]}},priceDrivers:["manufacturing_output","digital_infrastructure","inflation","energy_generation"]},{key:"glass",name:"Glass & Facades",category:"MANUFACTURED",tiers:{LOW:{requirements:[{stat:"manufacturing_output",min:20}]},STD:{requirements:[{stat:"manufacturing_output",min:40},{stat:"standard_of_living",min:35}]},HIGH:{requirements:[{stat:"manufacturing_output",min:60},{stat:"digital_infrastructure",min:40},{stat:"higher_education",min:50}]}},priceDrivers:["manufacturing_output","standard_of_living","inflation"]},{key:"asphalt",name:"Asphalt",category:"RAW",tiers:{LOW:{requirements:[{stat:"oil_and_gas",min:10}]},STD:{requirements:[{stat:"oil_and_gas",min:30},{stat:"manufacturing_output",min:25}]},HIGH:{requirements:[{stat:"oil_and_gas",min:45},{stat:"manufacturing_output",min:40},{stat:"physical_infrastructure",min:40}]}},priceDrivers:["oil_and_gas","manufacturing_output","inflation","fuel_prices"]},{key:"heavy",name:"Heavy Machinery Parts",category:"MANUFACTURED",tiers:{LOW:{requirements:[{stat:"manufacturing_output",min:40},{stat:"rare_minerals",min:30}]},STD:{requirements:[{stat:"manufacturing_output",min:60},{stat:"rare_minerals",min:45},{stat:"higher_education",min:40}]},HIGH:{requirements:[{stat:"manufacturing_output",min:75},{stat:"rare_minerals",min:60},{stat:"higher_education",min:55},{stat:"digital_infrastructure",min:45}]}},priceDrivers:["manufacturing_output","rare_minerals","higher_education","digital_infrastructure"]}];function he(i,e,t){const a=de.find(l=>l.key===i);if(!a)return{available:!1,failedStat:"unknown_material"};const n=a.tiers[e];if(!n)return{available:!1,failedStat:"unknown_tier"};for(const l of n.requirements){const s=Number(t?.[l.stat]??0);if(s<l.min)return{available:!1,failedStat:l.stat,failedMin:l.min,nationValue:s}}return{available:!0}}function zt(i,e,t){const n={concrete:{LOW:200,STD:300,HIGH:500},steel:{LOW:400,STD:700,HIGH:1200},lumber:{LOW:80,STD:130,HIGH:200},aggregate:{LOW:40,STD:60,HIGH:100},em:{LOW:400,STD:700,HIGH:1200},glass:{LOW:300,STD:500,HIGH:900},asphalt:{LOW:120,STD:200,HIGH:350},heavy:{LOW:800,STD:1400,HIGH:2400}}[i]?.[e];if(!n)return 0;const l=de.find(d=>d.key===i);if(!l)return n;let s=1;for(const d of l.priceDrivers){const r=Number(t?.[d]??50);d==="inflation"||d==="fuel_prices"?s*=1+(r-50)/200:s*=1-(r-50)/250}return s=Math.max(.4,Math.min(2.5,s)),Math.round(n*s)}function ii(i,e,t){const n={concrete:{LOW:5e3,STD:3e3,HIGH:1e3},steel:{LOW:2e3,STD:1500,HIGH:500},lumber:{LOW:8e3,STD:4e3,HIGH:1500},aggregate:{LOW:15e3,STD:6e3,HIGH:2e3},em:{LOW:1e3,STD:700,HIGH:300},glass:{LOW:1500,STD:800,HIGH:300},asphalt:{LOW:4e3,STD:2e3,HIGH:800},heavy:{LOW:400,STD:200,HIGH:80}}[i]?.[e]||0,s=de.find(o=>o.key===i)?.priceDrivers?.[0],r=.3+(s?Number(t?.[s]??50):50)/50*.7;return Math.round(n*r)}const Lt=["LOW","STD","HIGH"],wt={LOW:"Low",STD:"Standard",HIGH:"High"};let Le=[],f=null,k=null,P=null,Ce=[],Ne={},ee=[],j={},kt=-1,D="concrete",H="STD",we=500,te=[],Et=0,Y="trucks",ae=0,oe=1,ye=[],ke=null,Ve=[],Tt=null,We=null,Ct="ALL",It="TIMELINE";function B(i){return Math.abs(i)>=1e6?"$"+(i/1e6).toFixed(1)+"M":Math.abs(i)>=1e3?"$"+(i/1e3).toFixed(0)+"k":"$"+i}function Pi(i){if(i>=12){const e=Math.floor(i/12),t=i%12;return t>0?e+"y "+t+"mo":e+"y"}return i+" ticks"}function K(i){return Math.abs(i)>=1e9?"$"+(i/1e9).toFixed(1)+"B":Math.abs(i)>=1e6?"$"+(i/1e6).toFixed(0)+"M":Math.abs(i)>=1e3?"$"+(i/1e3).toFixed(0)+"k":"$"+i}function Ke(i){return i==="civil_engineering"?"CIVIL":i==="industrial"?"INDUSTRIAL":i==="mega_project"?"MEGA":i?.toUpperCase()||"—"}function ni(i){return i==="civil_engineering"?"light":i==="industrial"?"heavy":i==="mega_project"?"mega":"light"}function Oi(){We&&clearInterval(We),We=setInterval(()=>{if(!Tt)return;const i=Tt-Date.now();if(i<=0){document.getElementById("tick-countdown").textContent="Tick due...",clearInterval(We);return}const e=Math.floor(i/36e5),t=Math.floor(i%36e5/6e4),a=Math.floor(i%6e4/1e3);document.getElementById("tick-countdown").textContent=e+"h "+t+"m "+a+"s"},1e3)}function Di(){document.body.classList.toggle("light-mode");const i=document.getElementById("theme-toggle");i.textContent=document.body.classList.contains("light-mode")?"Dark":"Light"}function Hi(i,e){i==="type"&&(Ct=e),i==="sort"&&(It=e),document.querySelectorAll(`.filter-pill[data-filter="${i}"]`).forEach(t=>{t.classList.toggle("active",t.dataset.value===e)}),oi()}function ai(i){return!(!f||i.sector==="mega_project"&&f.corp_subsector!=="Megaprojects"||i.sector==="industrial"&&!["Heavy Infrastructure","Megaprojects"].includes(f.corp_subsector))}function oi(){const i=document.getElementById("oc-list");let e=[...Ce];if(Ct==="GOVERNMENT"?e=e.filter(n=>n.issuer_type==="GOVERNMENT"):Ct==="PRIVATE"&&(e=e.filter(n=>n.issuer_type==="PRIVATE")),It==="TIMELINE"&&e.sort((n,l)=>(n.timeline_ticks||0)-(l.timeline_ticks||0)),It==="BUDGET"&&e.sort((n,l)=>(l.budget_ceiling||0)-(n.budget_ceiling||0)),document.getElementById("oc-count").textContent=e.length+" AVAILABLE",e.length===0){i.innerHTML=`
            ...
            </div>`;return}const t=P?.current_tick||0;let a="";for(const n of e){const l=n.issuer_type==="GOVERNMENT",s=l?"gov":"private",d=ai(n),r=d?"":" locked",o=ni(n.sector),c=Ke(n.sector),m=(n.timeline_ticks||0)>18?" warn":"",p=n.bidding_ends_tick?Math.max(0,n.bidding_ends_tick-t):"?";a+=`
            <div class="oc-item${r}" data-contract-id="${n.id}">
                ...
                <div class="oc-item__stats">
                    ...
                    <div class="oc-stat">
                        ...
                        <div class="oc-stat__value${m}">${Pi(n.timeline_ticks||0)}</div>
                    </div>
                    <div class="oc-stat">
            ...
            </div>`}i.innerHTML=a,i.querySelectorAll(".oc-item:not(.locked)").forEach(n=>{n.addEventListener("click",()=>{const l=n.dataset.contractId,s=Ce.find(d=>d.id===l);s&&si(s)})})}let ce=null;function si(i){ce=i;const e=document.getElementById("cd-overlay"),t=i.issuer_type==="GOVERNMENT",a=t?"gov":"private",n=(k?.name||f.nation||"—").toUpperCase(),l=ai(i);document.getElementById("cd-header-left").innerHTML=`
    ...
    `;const s=document.getElementById("cd-blueprint");i.blueprint_svg?(s.innerHTML=i.blueprint_svg,s.style.display=""):(s.innerHTML=sn(i),s.style.display="");const d=i.permits_required||[],r=i.required_equipment||i.equipment_required||[],o=i.required_materials||i.materials_estimated||{},m={civil_engineering:"Civil Engineering",industrial:"Industrial Construction",mega_project:"Megaprojects"}[i.sector]||i.spec_category||i.sector||"—";let p="var(--teal)";i.sector==="industrial"&&(p="var(--orange)"),i.sector==="mega_project"&&(p="var(--red)");let u=B(i.budget_ceiling||i.budget||0),y=(i.timeline_ticks||i.timeline_months||0)+" Months",v="";v+=`
        <div class="cd-issue">
    ...
    `,e.classList.add("open"),document.body.style.overflow="hidden"}function Je(i){i&&i.target&&i.target!==document.getElementById("cd-overlay")||(document.getElementById("cd-overlay").classList.remove("open"),document.body.style.overflow="",ce=null)}const ji=[{key:"concrete",name:"Concrete",unit:"units"},{key:"steel",name:"Steel",unit:"units"},{key:"lumber",name:"Lumber",unit:"units"},{key:"aggregate",name:"Aggregate",unit:"units"},{key:"em_systems",name:"E&M Systems",unit:"units"},{key:"glass_facades",name:"Glass & Facades",unit:"units"},{key:"asphalt",name:"Asphalt",unit:"units"},{key:"heavy_parts",name:"Heavy Machinery Parts",unit:"units"}],Ui=[{key:"work_trucks",name:"Work Trucks",tier:1},{key:"excavators",name:"Excavators",tier:1},{key:"bulldozers",name:"Bulldozers",tier:1},{key:"concrete_mixers",name:"Concrete Mixers",tier:1},{key:"tower_cranes",name:"Tower Cranes",tier:2},{key:"heavy_haulers",name:"Heavy Haulers",tier:2},{key:"pile_drivers",name:"Pile Drivers",tier:2},{key:"asphalt_plants",name:"Asphalt Plants",tier:2}],ri={LOW:.7,STANDARD:1,HIGH:1.4},li={LOW:35,STANDARD:65,HIGH:90},ct=15;let U=null;function Gi(i){if(!i)return;const e=i.required_materials||{},t=i.required_equipment||[],a=i.required_workforce||{},n={concrete:18e4,steel:25e4,lumber:12e4,aggregate:8e4,em_systems:32e4,glass_facades:28e4,asphalt:14e4,heavy_parts:4e5},l=ji.filter(c=>e[c.key]>0).map(c=>({...c,qty:e[c.key],basePrice:n[c.key]||2e5,grade:c.key==="aggregate"?"LOW":"STANDARD",highDisabled:!1})),s=Ui.filter(c=>t.includes(c.key)).map(c=>({...c,owned:(te||[]).some(m=>m.equipment_key===c.key&&m.quantity>0)})),d=(a.general||100)+(a.skilled||20),r=i.budget_ceiling||1e8,o=Math.round(r*.03);U={contract:i,budgetCeiling:r,materials:l,laborCount:d,laborRate:15200,estimatedTicks:i.timeline_ticks||8,equipment:s,permits:[],overhead:o,markupPct:15,competitors:[],playerRep:f?.standing||50,requiredWorkforce:a},document.getElementById("bid-title").textContent="BID ASSEMBLY",document.getElementById("bid-subtitle").textContent=(i.name||"Contract")+" — "+Ke(i.sector)+" — "+(i.issuer_name||"Government"),document.getElementById("bid-overlay").classList.add("open"),document.body.style.overflow="hidden",Xe()}function di(i){i&&i.target!==document.getElementById("bid-overlay")||(document.getElementById("bid-overlay").classList.remove("open"),document.body.style.overflow="",U=null)}function N(i){return Math.abs(i)>=1e9?"$"+(i/1e9).toFixed(2)+"B":Math.abs(i)>=1e6?"$"+(i/1e6).toFixed(2)+"M":Math.abs(i)>=1e3?"$"+(i/1e3).toFixed(0)+"k":"$"+i.toLocaleString()}function Wi(i,e){if(!U)return;const t=U.materials[i];e==="HIGH"&&t.highDisabled||(t.grade=e,Xe())}function Fi(i){U&&(U.laborCount=i,Xe())}function Vi(i){U&&(U.markupPct=Number(i),Xe())}function Xe(){if(!U)return;const i=U;let e=0;for(const M of i.materials)M.lineCost=Math.round(M.qty*M.basePrice*ri[M.grade]),e+=M.lineCost;const t=Math.round(i.laborCount*i.laborRate*i.estimatedTicks),a=Math.round(i.equipment.filter(M=>M.owned).length*12e3*i.estimatedTicks);let n=0;const l=i.overhead,s=e+t+a+n+l,d=Math.round(s*i.markupPct/100),r=s+d,o=r>i.budgetCeiling,c=d,m=Math.round(i.materials.reduce((M,R)=>M+li[R.grade],0)/i.materials.length),p=m>=80?"STRONG":m>=60?"PROMISING":m>=40?"UNCERTAIN":"POOR",u=m>=80?"var(--green)":m>=60?"var(--teal)":m>=40?"var(--orange)":"var(--red)",y=i.budgetCeiling>0?r/i.budgetCeiling:1,v=Math.max(0,Math.min(100,Math.round((1-y)*150))),h=v>=70?"STRONG":v>=40?"COMPETITIVE":v>=15?"WEAK":"UNLIKELY",$=v>=70?"var(--green)":v>=40?"var(--teal)":v>=15?"var(--orange)":"var(--red)",w=Math.round(s*(1-ct/100)),A=Math.round(s*(1+ct/100));let x="";x+='<div class="bid-section"><div class="bid-section__title">Materials</div>',i.materials.forEach((M,R)=>{const q=V=>{const X=M.grade===V,Ue=V==="HIGH"&&M.highDisabled;return`<button class="bid-grade-btn ${X?V==="LOW"?"active-low":V==="HIGH"?"active-high":"active":""} ${Ue?"disabled":""}" onclick="setBidGrade(${R},'${V}')">${V[0]}</button>`};x+=`<div class="bid-mat-row">
    ...
    `}function en(i,e,t,a,n,l,s){const d=pt(i.awardedTick+i.totalTicks);pt(i.awardedTick+i.totalTicks);const r=pt(i.awardedTick),o=[{label:"Budget",value:K(i.budget),sub:`${a}% spent`,color:t},{label:"Spent",value:K(i.spent),color:"var(--red)"},{label:"Remaining",value:K(n),color:"var(--green)"},{label:"Quality",value:`${i.quality}/100`,sub:i.qualityLabel,color:i.quality>=70?"var(--green)":i.quality>=50?"var(--amber)":"var(--red)"},{label:"Workforce",value:`${i.laborCount}/${i.wfNeeded}`,sub:`Bid: ${i.laborCount}`,color:i.laborCount<i.wfNeeded?"var(--orange)":"var(--text-bright)"},{label:"Remaining",value:`${l} ticks`,sub:s?"OVERDUE":`Deadline: ${d}`,color:s?"var(--red)":"var(--text-bright)"}];let c="";c+=`<div style="padding:0 16px"><div class="pm-section">
        ...
        <div class="pm-manager">
            ...
            </div>`;c+="</div></div>"}return c}function tn(i){if(i.events.length===0)return'<div class="pm-evt-empty">No events have occurred on this project yet.<br>Events will appear here as construction progresses.</div>';let e="";for(let t=0;t<i.events.length;t++){const a=i.events[t],n=i.expandedEvent===t,l=a.status==="ACTIVE",s=Kt[a.type]||Kt.WEATHER,d=Jt[a.severity]||Jt.LOW;if(e+=`<div class="pm-evt ${l?"pm-evt--active":"pm-evt--resolved"}" style="${l?`border-left-color:${s.color}`:""}">`,e+=`<div class="pm-evt__header" onclick="pmToggleEvent(${t})" style="${n?`background:${s.bg}`:""}">`,e+=`<div class="pm-evt__row1">
        ...
        </div>`}return e}function an(i){if(i.equipment.length===0)return'<div class="pm-evt-empty">No equipment deployed to this project.</div>';let e='<div class="pm-tab-header">Deployed Equipment</div>';for(const t of i.equipment){const a=t.condition>=75?"var(--green)":t.condition>=50?"var(--amber)":t.condition>=25?"var(--orange)":"var(--red)",n=t.condition<60;e+=`<div class="pm-eq">
        ...
        </div>`}return e}function pt(i){return`${["January","February","March","April","May","June","July","August","September","October","November","December"][i%12]}, ${2e3+Math.floor(i/12)}`}window.openProjectModal=Qi;window.closeProjectModal=Ki;window.pmSetTab=Ji;window.pmToggleEvent=Xi;window.pmSelectResponse=Zi;async function ci(i){if(!L)return;const{data:e,error:t}=await _.from("construction_events").select("*").eq("contract_id",i).order("fired_at_tick",{ascending:!1});t?(console.warn("Failed to load project events:",t.message),L.events=[]):L.events=(e||[]).map(a=>({id:a.id,type:a.type,severity:a.severity,tick:a.fired_at_tick,title:a.title,desc:a.description,impact:a.impact,status:a.status==="ACTIVE"?"ACTIVE":"RESOLVED",resolution:a.resolution,responses:a.responses||[]})),Ee()}let mt=!1;async function on(i,e){if(!(mt||!L)){mt=!0;try{const{data:t,error:a}=await _.rpc("resolve_construction_event",{p_event_id:i,p_response_key:e});if(a){console.error("Failed to resolve event:",a.message),alert("Failed to submit response: "+a.message);return}const n=typeof t=="string"?JSON.parse(t):t;if(n?.error){alert("Error: "+n.error);return}await ci(L.project.id),await pi(),n?.quality_applied&&n.quality_applied!==0&&(L.quality=Math.max(0,Math.min(100,L.quality+n.quality_applied)),L.qualityLabel=L.quality>=80?"STRONG":L.quality>=60?"PROMISING":L.quality>=40?"FAIR":"UNCERTAIN"),Ee()}finally{mt=!1}}}window.confirmEventResponse=on;function ue(i,e,t){const a=t?` style="color:${t}"`:"";return`<div class="cd-detail-row">
        <span class="cd-detail-row__label">${g(i)}</span>
        <span class="cd-detail-row__value"${a}>${g(e)}</span>
    </div>`}function sn(i){const e={bg:"#1a2a3a",line:"#3a6a8a",dim:"#2a4a5a",accent:"#5a9aba",text:"#4a8aaa"},t=i.drawing_number||i.contract_number+"-A1",a=P?.current_date||"",n=a?a.replace(/,\s*/," "):"",l=i.spec_category==="Heavy Infrastructure",s=i.spec_category==="Megaproject";let d=g(i.project_subtype||i.project_type||"STRUCTURE"),r=l?"80.0m":s?"200.0m":"60.0m",o=l?"40.0m":s?"100.0m":"20.0m";return`<svg viewBox="0 0 680 200" style="width:100%;display:block;background:${e.bg}">
        <!-- Grid -->
        ...
        <g transform="translate(470,172)">
        ...
        </div>`}i.innerHTML=l,e.style.display=ee.length>0?"":"none",ee.length>0&&(document.getElementById("ap-total-crew").textContent=ee.length,document.getElementById("ap-total-budget").textContent=K(a),document.getElementById("ap-total-spent").textContent=K(n))}async function pi(){if(!f)return;const{data:i,error:e}=await _.from("construction_contracts").select("*, contract_bids!inner(bid_price, material_grades, labor_count, estimated_cost, estimated_quality)").eq("awarded_to_faction",f.id).in("status",["awarded","in_progress"]).eq("contract_bids.faction_id",f.id).order("awarded_at_tick",{ascending:!0});e?(console.warn("Failed to load active projects:",e.message),ee=[]):ee=i||[],ln()}const mi=3e4;function fi(){let i=0,e=0;for(const t of de)for(const a of Lt){const n=j[t.key]?.[a];n&&(i+=n.qty,e+=n.value)}return{totalUnits:i,totalValue:e}}function Bt(){const i=document.getElementById("wh-list"),{totalUnits:e,totalValue:t}=fi();document.getElementById("wh-count").textContent=e.toLocaleString()+" UNITS",document.getElementById("wh-total-value").textContent=B(t);const a=Math.round(e/mi*100),n=document.getElementById("wh-capacity");n.textContent=a+"%",n.style.color=a>80?"var(--red)":a>50?"var(--orange)":"var(--green)";let l="";for(let s=0;s<de.length;s++){const d=de[s],r=kt===s,o=j[d.key]?.LOW||{qty:0,value:0},c=j[d.key]?.STD||{qty:0,value:0},m=j[d.key]?.HIGH||{qty:0,value:0},p=o.qty+c.qty+m.qty,u=o.value+c.value+m.value,y=p===0,v=he(d.key,"LOW",k),h=he(d.key,"STD",k),$=he(d.key,"HIGH",k),w=o.qty>0?"wh-dot wh-dot--low":"wh-dot wh-dot--empty",A=c.qty>0?"wh-dot wh-dot--std":"wh-dot wh-dot--empty",x=$.available?m.qty>0?"wh-dot wh-dot--high":"wh-dot wh-dot--empty":"wh-dot wh-dot--locked";if(l+='<div class="wh-row">',l+=`<div class="wh-row__collapsed${r?" expanded":""}" onclick="toggleWhRow(${s})">
            ...
            <span class="wh-row__val${y?" empty":""}">${u>0?B(u):"—"}</span>
                ...
                <span class="wh-expand__hdr-label" style="width:55px;text-align:right">$/UNIT</span>
                    ...
                    </div>`);l+="</div>"}l+="</div>"}i.innerHTML=l}function dn(i){kt=kt===i?-1:i,Bt()}async function cn(){if(!f)return;const{data:i,error:e}=await _.from("corp_warehouse").select("material_key, quality_tier, quantity, total_value").eq("faction_id",f.id);if(j={},e)console.warn("Failed to load warehouse:",e.message);else if(i)for(const t of i)j[t.material_key]||(j[t.material_key]={}),j[t.material_key][t.quality_tier]={qty:t.quantity||0,value:Number(t.total_value)||0};Bt()}const pn={manufacturing_output:"base production",rare_minerals:"raw input",inflation:"price modifier",fuel_prices:"transport cost",urbanization:"demand pressure",arable_land:"base production",physical_infrastructure:"transport",digital_infrastructure:"component quality",energy_generation:"electrical supply",standard_of_living:"demand tier",oil_and_gas:"base input",higher_education:"engineering"};function ui(){const i=(k?.name||f?.nation||"—").toUpperCase();document.getElementById("pr-nation-badge").textContent="LOCAL — "+i;const e=Number(f?.corp_cash_reserves)||0;document.getElementById("pr-cash").textContent=B(e);const{totalUnits:t}=fi(),a=Math.round(t/mi*100),n=document.getElementById("pr-wh-capacity");n.textContent=a+"%",n.style.color=a>80?"var(--red)":a>50?"var(--orange)":"var(--green)",yi(),qt(),Ze()}function yi(){const i=document.getElementById("pr-mat-grid");let e="";for(const t of de){const a=D===t.key,n=Lt.every(s=>!he(t.key,s,k).available),l="pr-mat-btn"+(a?" active":"")+(n?" all-locked":"");e+=`<span class="${l}" onclick="setPrMat('${t.key}')">${g(t.name)}</span>`}i.innerHTML=e}function qt(){const i=document.getElementById("pr-tier-bar");let e='<span class="pr-tier-label">GRADE</span>';for(const t of Lt){const a=he(D,t,k),n=H===t,l=a.available?zt(D,t,k):null,s=ti[t],d=!a.available,r="pr-tier-btn"+(n?" active":"")+(d?" locked":"");e+=`<div class="${r}" onclick="${d?"":`setPrTier('${t}')`}">
            <div class="pr-tier-btn__label">
                <div class="wh-dot" style="width:5px;height:5px;background:${s};border-radius:1px;"></div>
                <span class="pr-tier-btn__name" style="color:${n?"var(--text-bright)":"var(--text-dim)"}">${wt[t]}</span>
            </div>
        ...
        </div>`;return}const a=zt(D,H,k),n=ii(D,H,k),l=a*we,s=n>3e3?"LOW":n>1e3?"MODERATE":"HIGH",d=s==="LOW"?"var(--green)":s==="MODERATE"?"var(--amber)":"var(--red)",r=Number(k?.inflation??50),o=r>55?"up":r<45?"down":"flat",c=o==="up"?"&#9650;":o==="down"?"&#9660;":"&#8212;",m=o==="up"?"var(--red)":o==="down"?"var(--green)":"var(--text-dim)";let p="";p+=`<div style="padding:8px 14px;border-bottom:1px solid var(--border-0);">
        ...
        <div class="pr-drivers__title">Price Drivers (${g(k?.name||"—")})</div>`;for(const $ of t.priceDrivers){const w=Number(k?.[$]??50),A=w>=50?"var(--green)":w>=30?"var(--amber)":w>=15?"var(--orange)":"var(--red)",x=pn[$]||$;p+=`<div class="pr-driver-row">
        ...
        </div>`}p+="</div>";const y=(Number(f?.corp_cash_reserves)||0)>=l,v=we>n,h=ti[H];p+=`<div class="pr-order">
        ...
        <div class="pr-order__box">
            <div class="pr-order__header">
                <div style="display:flex;align-items:center;gap:6px;">
                    ...
                    <span style="font-family:var(--font-mono);font-size:9px;color:${h}">${wt[H]}</span>
                </div>
        ...
        </div></div>`;return}ae>=ye.length&&(ae=0);let e="";for(let a=0;a<ye.length;a++){const n=ye[a],l=ae===a,s=n.sellerType==="LOCAL"?"var(--teal)":"#5a8aaa",d=ei(n.condition);e+=`<div class="em-listing${l?" selected":""}" style="${l?"border-left-color:"+s:""}" onclick="setEmListing(${a})">`,e+=`<div class="em-listing__row1">
            <div style="display:flex;align-items:center;gap:6px">
        ...
        </div></div>`}i.innerHTML=e}async function gn(i){if(!i)ke=null;else{let t=Ve.find(a=>a.id===i);if(!t)try{const{data:a}=await _.from("nations").select("*").eq("id",i).single();t=a}catch{}ke=t||null}ae=0,oe=1;const e=document.getElementById("em-nation-select");e&&(e.value=i||""),et()}function xn(i){Y=i,ae=0,oe=1,et()}function bn(i){ae=i,oe=1,Nt()}function $n(i){oe=i,Nt()}let yt=!1;async function _n(){if(yt)return;const i=ye[ae];if(!i||!f)return;const e=Qe(Y);if(!e)return;const t=oe,a=i.price*t,n=Number(f.corp_cash_reserves)||0;if(a>n){alert("Insufficient cash reserves.");return}if(t>i.available){alert("Not enough units available.");return}const l=document.querySelector(".em-purchase-btn");l&&(l.disabled=!0,l.textContent="..."),yt=!0;try{const s=n-a,{error:d}=await _.from("factions").update({corp_cash_reserves:s}).eq("id",f.id);if(d)throw d;const r=!i.deliveryTicks||i.deliveryTicks===0;if(r){const c=te.find(A=>A.equipment_key===Y),m=(c?.owned||0)+t,p=c?.purchase_price_avg||0,u=c?.owned||0,y=u>0?Math.round((p*u+i.price*t)/m):i.price,v=e.maintenancePerUnit*m,h=c?.condition||100,$=Math.round((h*u+i.condition*t)/m),{error:w}=await _.from("corp_equipment").upsert({faction_id:f.id,nation_id:f.nation_id,equipment_key:Y,tier:e.tier,owned:m,deployed:c?.deployed||0,condition:$,maintenance_per_tick:v,purchase_price_avg:y,last_purchased_tick:P?.current_tick||null,updated_at:new Date().toISOString()},{onConflict:"faction_id,equipment_key"});if(w){const{error:A}=await _.from("factions").update({corp_cash_reserves:n}).eq("id",f.id);throw A&&console.error("Cash refund failed:",A.message),w}c?(c.owned=m,c.condition=$,c.maintenance_per_tick=v):te.push({equipment_key:Y,tier:e.tier,owned:m,deployed:0,condition:$,maintenance_per_tick:v,assigned_projects:[]})}else{const c=(P?.current_tick||0)+i.deliveryTicks,{error:m}=await _.from("corp_equipment_deliveries").insert({faction_id:f.id,equipment_key:Y,quantity:t,condition:i.condition,delivery_tick:c,source_nation_id:i.sourceNationId||null,seller_name:i.seller,price_paid:a});if(m){const{error:p}=await _.from("factions").update({corp_cash_reserves:n}).eq("id",f.id);throw p&&console.error("Cash refund failed:",p.message),m}}f.corp_cash_reserves=s,Rt(),et();const o=document.getElementById("pr-cash");o&&(o.textContent=B(s)),l&&(l.textContent=r?"PURCHASED":"ORDERED",setTimeout(()=>{l.isConnected&&(l.disabled=!1,l.textContent="PURCHASE")},1500))}catch(s){l&&(l.disabled=!1,l.textContent="PURCHASE"),alert("Purchase failed: "+(s.message||"Unknown error"))}finally{yt=!1}}let hn=-1,Be=[],Mt=[],gi=[];function vt(i){return Math.abs(i)>=1e6?"$"+(i/1e6).toFixed(1)+"M":Math.abs(i)>=1e3?"$"+(i/1e3).toFixed(0)+"k":"$"+i.toLocaleString()}function wn(i,e,t){if(t)return"var(--orange)";const a=i/(e||1)*100;return a>50?"var(--green)":a>25?"var(--amber)":"var(--red)"}function kn(){const i=document.getElementById("pm-list"),e=Be.length,t=Mt.length,a=gi.length,n=Be.filter(r=>r.expiring_soon).length;document.getElementById("pm-active-count").textContent=`(${e})`,document.getElementById("pm-pending-count").textContent=`(${t})`,document.getElementById("pm-apply-count").textContent=`(${a})`;const l=document.getElementById("pm-badges");let s="";n>0&&(s+=`<span class="pm-badge pm-badge--expiring">${n} EXPIRING</span>`),t>0&&(s+=`<span class="pm-badge pm-badge--pending">${t} PENDING</span>`),l.innerHTML=s;const d=Be.reduce((r,o)=>r+(o.cost||0),0)+Mt.reduce((r,o)=>r+(o.cost||0),0);document.getElementById("pm-total-cost").textContent=vt(d),document.getElementById("pm-footer-active").textContent=e,document.getElementById("pm-footer-pending").textContent=t;{if(e===0){i.innerHTML=`<div class="pm-empty">
            ...
            </div>`;return}let r="";Be.forEach((o,c)=>{const m=hn===c,p=wn(o.ticks_left,o.total_ticks,o.expiring_soon),u=Math.min(o.ticks_left/(o.total_ticks||1)*100,100);r+=`<div class="pm-item ${o.expiring_soon?"pm-item--expiring":""} ${m?"expanded":""}" onclick="togglePmExpand(${c})">
            ...
            <div class="dl-item__inner" style="border-left:2px solid ${v}">
                ...
                <div class="dl-summary-bar">
                    <div class="dl-summary-cell" style="flex:1;">
                        ...
                        <div style="display:flex;align-items:center;gap:4px;margin-top:2px;">
                            <span class="dl-summary-value" style="color:${Xt(d.quality_score)}">${d.quality_score}</span>
                ...
                </div>`,o){const $=d.inspection||{};s+='<div style="margin-top:8px;">',s+='<div class="dl-section-label">Inspection Report</div>',["materials","structural","systems"].forEach(T=>{const C=$[T]||{score:0,issues:[]},S=Xt(C.score),E=Math.min(C.score/100*100,100);s+=`<div class="dl-inspect-row">
        ...
        <div class="eq-summary__cell">
        ...
        </div>`;const n={};for(const d of te)n[d.equipment_key]=d;let l="";for(let d=1;d<=3;d++){const r=Re[d],o=ht(d),c=Et===d,m=o.reduce((u,y)=>u+(n[y.key]?.owned||0),0),p=o.reduce((u,y)=>u+(n[y.key]?.deployed||0),0);if(l+=`<div class="eq-tier-hdr" onclick="toggleEqTier(${d})">
            ...
            ${m>0?`<span class="eq-tier-hdr__count">${p}/${m}</span>`:'<span class="eq-tier-hdr__none">NONE OWNED</span>'}
        </div>`,c)for(const u of o){const y=n[u.key],v=y?.owned||0,h=y?.deployed||0,$=y?.condition||0,w=u.maintenancePerUnit*v,A=v-h,x=v>0&&A===0,T=v>0&&$<65,C=ei($),S=y?.assigned_projects||[],E=S.length>0?S.map(M=>M.contract_name||"Project").join(", ").slice(0,30):v>0&&h>0?h+" project"+(h>1?"s":""):"—";l+=`<div class="eq-row${v===0?" unowned":""}">`,l+=`<div class="eq-row__top">
                    ...
                    </div>`:l+='<div class="eq-row__hint">Purchase from Equipment Market →</div>',l+="</div>"}}document.getElementById("eq-list").innerHTML=l;const s=[1,2,3].map(d=>{const r=Re[d],o=ht(d).reduce((c,m)=>c+(n[m.key]?.owned||0),0);return`<div class="eq-footer__tier-box" style="border-color:${o>0?r.color+"33":"var(--border-0)"};background:${o>0?r.color+"0a":"transparent"}">
        ...
        <div class="eq-footer__tiers">${s}</div>`}function Mn(i){Et=Et===i?-1:i,Rt()}async function Sn(){if(!f)return;const{data:i,error:e}=await _.from("corp_equipment").select("equipment_key, tier, owned, deployed, condition, maintenance_per_tick, assigned_projects").eq("faction_id",f.id);e?(console.warn("Failed to load equipment:",e.message),te=[]):te=i||[],Rt()}async function An(){const{data:{user:i}}=await _.auth.getUser();if(!i){window.location.href="login.html";return}const{data:e}=await _.from("factions").select("*").or(`id.eq.${i.id},linked_user_id.eq.${i.id}`);Le=(e||[]).filter(o=>o.nation_id);const t=sessionStorage.getItem("active_faction_id");if(f=Le.find(o=>o.id===t)||Le.find(o=>o.faction_type==="corporation")||Le[0],!f){await _.auth.signOut(),window.location.href="login.html";return}if(f.faction_type!=="corporation"){window.location.href="dashboard.html";return}const[a,n]=await Promise.all([f.nation_id?_.from("nations").select("*").eq("id",f.nation_id).single():Promise.resolve({data:null}),_.from("shard").select("current_tick, current_date, next_tick_at, tick_interval_hours").eq("name","Alpha Shard").single()]);a.error&&console.warn("Nation load failed:",a.error.message),a.data&&(k=a.data),n.error&&console.warn("Shard load failed:",n.error.message),P=n.data;const l=f.corp_ticker||f.abbreviation||"";if(document.getElementById("corp-logo").textContent=l.slice(0,2)||"—",document.getElementById("corp-name-bar").textContent=f.faction_name||"Unnamed Corp",P){if(document.getElementById("game-date").textContent=P.current_date||"—",document.getElementById("tick-number").textContent=P.current_tick||"—",P.next_tick_at){const c=(Number(P.tick_interval_hours)||8)*36e5,m=new Date(P.next_tick_at).getTime(),u=m-c+c/2;Tt=new Date(u>Date.now()?u:m+c/2),Oi()}const o=document.querySelector("#tick-countdown")?.closest(".tick-item")?.querySelector(".tick-label");o&&(o.textContent="Next Corp Tick")}document.getElementById("corp-name-badge").textContent=(l?"["+l+"]":f.faction_name||"Corp")+" ▾";const s=document.getElementById("topbar-cash");if(s){const o=Number(f.corp_cash_reserves??0),c=o>=1e9?"$"+(o/1e9).toFixed(1)+"B":o>=1e6?"$"+(o/1e6).toFixed(1)+"M":"$"+Math.round(o/1e3)+"k";s.textContent="CASH: "+c}const d=f.action_points??0;document.getElementById("topbar-ap").innerHTML='<span class="topbar-ap__count">'+d+" AP</span>",document.getElementById("nation-pill").textContent=(k?.name||f.nation||"—").toUpperCase();const r=document.getElementById("corp-faction-dropdown");if(r){let o="";for(const c of Le){const m=c.id===f.id,p=c.faction_type==="corporation"?"CORP":"PARTY",u=c.faction_type==="corporation"?"var(--teal)":"var(--amber)";o+=`<div class="corp-dd-item${m?" active":""}" onclick="switchToFaction('${c.id}', '${c.faction_type}')">
            ...
            </div>`}r.innerHTML=o}await Promise.all([pe(),pi(),cn(),Sn(),En(),In()]);try{const{data:o}=await _.from("nations").select("*").order("name");Ve=o||[]}catch{Ve=[]}if(ui(),et(),Bi(f,k,P),document.getElementById("loading").style.display="none",document.getElementById("page-content").style.display="block",new URLSearchParams(window.location.search).get("tab")==="expansion"){const o=document.querySelector('[data-tab="expansion"]');o&&bi({preventDefault:()=>{},target:o})}}async function zn(){await _.auth.signOut(),window.location.href="login.html"}function Ln(){const i=document.getElementById("corp-faction-dropdown");i&&i.classList.toggle("open")}function Bn(i,e){const t=document.getElementById("corp-faction-dropdown");t&&t.classList.remove("open"),sessionStorage.setItem("active_faction_id",i),e==="corporation"?window.location.href="corp-operations.html":window.location.href="dashboard.html"}document.addEventListener("click",i=>{const e=document.getElementById("faction-switcher"),t=document.getElementById("corp-faction-dropdown");t&&e&&!e.contains(i.target)&&t.classList.remove("open")});document.addEventListener("keydown",i=>{i.key==="Escape"&&Je()});window.doLogout=zn;window.toggleTheme=Di;window.toggleCorpDropdown=Ln;window.switchToFaction=Bn;window.setFilter=Hi;window.openContractDetail=si;window.closeContractDetail=Je;window.placeBid=rn;window.toggleWhRow=dn;window.toggleEqTier=Mn;window.switchEmNation=gn;window.setEmType=xn;window.setEmListing=bn;window.setEmQty=$n;window.purchaseEquipment=_n;window.setPrMat=mn;window.setPrTier=fn;window.setPrQty=un;window.purchaseMaterial=yn;let W={general:0,skilled:0,innovative:0},gt=!1;const Pe=[{id:"general",label:"General Workforce",multiplier:2,color:"#8b9a6b",factionKey:"corp_general_workforce"},{id:"skilled",label:"Skilled Workforce",multiplier:3,color:"#c8a832",factionKey:"corp_skilled_workforce"},{id:"innovative",label:"Innovative Workforce",multiplier:6,color:"#c84",factionKey:"corp_innovative_workforce"}];function xi(i){const e=Number(k?.minimum_wage??50),t=Number(k?.inflation??50),a=Number(k?.standard_of_living??50),n=e/100*48e3,l=1+(t-50)/100*.5,s=1+(a-50)/100*.5;return Math.round(n*i*l*s)}function b(i){const e=Math.abs(i),t=i<0?"-":"";return e>=1e9?t+"$"+(e/1e9).toFixed(2)+"B":e>=1e6?t+"$"+(e/1e6).toFixed(2)+"M":e>=1e3?t+"$"+(e/1e3).toFixed(1)+"k":t+"$"+e.toLocaleString()}async function bi(i){i.preventDefault(),document.getElementById("operations-content").style.display="none";const e=document.getElementById("expansion-content");e.style.display="flex",e.style.justifyContent="center",e.style.gap="12px",e.style.alignItems="flex-start",e.style.flexWrap="wrap",document.querySelectorAll(".corp-nav__tab").forEach(t=>t.classList.remove("active")),i.target.classList.add("active"),tt(),Pn(),await He(),await Pt(),it(),await Yn(),nt(),ki(),await Jn(),at()}function $i(i){i&&i.preventDefault(),document.getElementById("operations-content").style.display="flex",document.getElementById("expansion-content").style.display="none",document.querySelectorAll(".corp-nav__tab").forEach(e=>e.classList.remove("active")),document.querySelector('[data-tab="operations"]')?.classList.add("active")}function _i(){return F.reduce((e,t)=>{const a=Number(t.capacity||0),n=Number(t.condition||0)/100;return e+Math.floor(a*n)},0)+500}function qn(i,e){const t=Pe.find(l=>l.id===i),a=Number(f?.[t.factionKey]??0),n=W[i]+e;if(!(a+n<0)){if(e>0){const l=Pe.reduce((d,r)=>{const o=Number(f?.[r.factionKey]??0),c=r.id===i?n:W[r.id];return d+o+c},0),s=_i();if(l>s)return}W[i]=n,tt()}}function Nn(i){i?W[i]=0:W={general:0,skilled:0,innovative:0},tt()}async function Rn(){if(gt||!Object.values(W).some(n=>n!==0))return;let e=0;for(const n of Pe){const l=W[n.id];l>0&&(e+=l*xi(n.multiplier)*.1)}const t=Number(f?.corp_cash_reserves??0);if(e>t){alert("Insufficient cash reserves. Hiring cost: "+b(e)+", available: "+b(t));return}const a=e>0?`Confirm workforce changes?

Hiring fee: `+b(e)+" (deducted from cash reserves)":`Confirm workforce changes?

Firing workers — no cost.`;if(confirm(a)){gt=!0;try{const n={};for(const d of Pe){const r=Number(f?.[d.factionKey]??0);n[d.factionKey]=Math.max(0,r+W[d.id])}e>0&&(n.corp_cash_reserves=Math.max(0,t-Math.round(e)));const{error:l}=await _.from("factions").update(n).eq("id",f.id);if(l)throw l;Object.assign(f,n),W={general:0,skilled:0,innovative:0};const s=document.getElementById("topbar-cash");if(s){const d=Number(f.corp_cash_reserves??0);s.textContent="CASH: "+(d>=1e6?"$"+(d/1e6).toFixed(1)+"M":"$"+Math.round(d/1e3)+"k")}tt()}catch(n){alert("Error: "+n.message)}finally{gt=!1}}}function tt(){const i=document.getElementById("hf-card-container");if(!i)return;const e="'JetBrains Mono', monospace",t={bg:"#121210",surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",greenBright:"#5c5",red:"#c55",redDim:"#a44",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},a=Number(k?.minimum_wage??50),n=Number(k?.inflation??50),l=Number(k?.standard_of_living??50),s=a/100*48e3,d=(1+(n-50)/100*.5).toFixed(2),r=(1+(l-50)/100*.5).toFixed(2),o=k?.name||f?.nation||"Nation",c=Object.values(W).some(w=>w!==0),m=_i();let p=0,u=0,y=0,v=0,h="";for(const w of Pe){const A=Number(f?.[w.factionKey]??0),x=W[w.id],T=A+x,C=xi(w.multiplier),S=x>0,E=A*C,M=T*C,R=M-E;p+=A,u+=T,y+=E,v+=M;const q=x!==0?S?"rgba(92,204,92,0.02)":"rgba(204,85,85,0.02)":"transparent";h+=`
    ...
    </div>`}function On(i){G=G===i?null:i,it()}let xt=!1;async function Dn(){if(G===null||xt)return;const i=Ie[G];if(!i)return;const e=Number(f?.corp_cash_reserves??0);if(i.adjusted_cost>e){alert(`Insufficient cash reserves.
...
All construction corporations in `+e+" can now bid on this project.")}catch(i){alert("Failed to submit project: "+i.message)}finally{bt=!1}}}function wi(){if(document.getElementById("cp-modal-overlay")?.remove(),!Ot)return;const i="'JetBrains Mono', monospace",e={surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",redDim:"#a44",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},t=hi(),a=k?.name||f?.nation||"Nation",n=be[I.style]?.repGain||1,l=n>=4?e.gold:n>=3?e.greenBright:n>=2?e.accent:e.dim,s=Object.entries(be).map(([o,c])=>{const m=I.style===o;return`<div onclick="cpSetField('style','${o}')" style="padding:5px 6px;cursor:pointer;text-align:center;background:${m?c.color+"18":"transparent"};border:1px solid ${m?c.color+"44":e.border};">
...
This cannot be undone.`)){Se=!0;try{await _.from("corp_properties").update({is_active:!1}).eq("id",i);const s=Number(f?.corp_cash_reserves??0)+n;await _.from("factions").update({corp_cash_reserves:s}).eq("id",f.id),f.corp_cash_reserves=s;const r=(await _.from("shard").select("current_tick").eq("name","Alpha Shard").single()).data?.current_tick||0;await _.from("available_properties").insert({nation_id:f.nation_id,catalog_id:e.catalog_id||null,name:e.name,type:e.type,style:e.style,capacity:e.capacity,price:Math.round(n*1.1),monthly_maintenance:e.monthly_maintenance,condition:e.condition,city:e.city,generated_at_tick:r,expires_at_tick:r+6,status:"available"});const o=document.getElementById("topbar-cash");o&&(o.textContent="CASH: "+(s>=1e6?"$"+(s/1e6).toFixed(1)+"M":"$"+Math.round(s/1e3)+"k")),await He(),je(),await Pt(),it(),alert('Sold "'+e.name+'" for '+b(n))}catch(l){alert("Sale failed: "+l.message)}finally{Se=!1}}}window.propRefurbish=Wn;window.propSell=Fn;let qe=0;function ki(){const i=document.getElementById("manage-subsidiaries-container");if(!i)return;const e="'JetBrains Mono', monospace",t={surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",blue:"#5a9abf",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",greenDark:"#2a5a3a",red:"#c55",yellow:"#ca5",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},a=F.filter(r=>r.type==="regional_hq");qe>=a.length&&(qe=0);const n=a[qe]||null;let l="";a.length===0&&(l=`<div style="padding:30px 14px;text-align:center;font-family:${e};font-size:10px;color:${t.dim}">No subsidiaries established.<br>Use Create Subsidiary to expand.</div>`);let s=0;for(let r=0;r<a.length;r++){const o=a[r],c=r===qe,m=Number(o.purchase_price||0);s+=m;const p=Oe.find(u=>u.id===o.nation_id)?.name||o.city||"—";l+=`
    ...
    </div>`}async function Vn(i){const e=F.find(a=>a.id===i);if(!e)return;const t=Math.round((e.purchase_price||0)*.6*(e.condition||50)/100);if(confirm('Dissolve subsidiary "'+e.name+`"?

Assets liquidated at 60% × condition: `+b(t)+`
All operations in this nation cease.

This cannot be undone.`))try{await _.from("corp_properties").update({is_active:!1}).eq("id",i);const a=Number(f?.corp_cash_reserves??0)+t;await _.from("factions").update({corp_cash_reserves:a}).eq("id",f.id),f.corp_cash_reserves=a;const n=document.getElementById("topbar-cash");n&&(n.textContent="CASH: "+(a>=1e6?"$"+(a/1e6).toFixed(1)+"M":"$"+Math.round(a/1e3)+"k")),qe=0,await He(),je(),ki(),nt(),alert("Subsidiary dissolved. Received: "+b(t))}catch(a){alert("Failed: "+a.message)}}window.subDissolve=Vn;let Oe=[],se=null,$t=!1;async function Yn(){const{data:i}=await _.from("nations").select("*").order("name");Oe=(i||[]).filter(e=>e.id!==f?.nation_id)}function St(i){const t=u=>Number(i[u]??50),a=t("standard_of_living"),n=t("cost_of_living"),l=t("corporate_tax"),s=t("minimum_wage"),d=t("urbanization"),r=t("union_strength"),o=t("corruption"),c=t("unemployment"),m=t("stability"),p=5e7*(1+(a-50)/100*.4)*(1+(n-50)/100*.3)*(1+(l-50)/100*.2)*(1+(s-50)/100*.15)*(1+(d-50)/100*.1)*(1+(r-50)/100*.1)*(1-(o-50)/100*.15)*(1-(c-50)/100*.1)*(1+(50-m)/100*.3);return Math.round(Math.max(1e7,p))}function Qn(i){se=se===i?null:i,nt()}async function Kn(){if($t||!se)return;const i=Oe.find(n=>n.id===se);if(!i)return;if(F.find(n=>n.nation_id===i.id&&n.type==="regional_hq")){alert("You already have a subsidiary in "+i.name);return}const t=St(i),a=Number(f?.corp_cash_reserves??0);if(t>a){alert("Insufficient cash. Entry cost: "+b(t)+", available: "+b(a));return}if(confirm("Establish subsidiary in "+i.name+`?
...
Regional HQ created with `+s+"% condition.")}catch(n){alert("Failed: "+n.message)}finally{$t=!1}}}function nt(){const i=document.getElementById("create-subsidiary-container");if(!i)return;const e="'JetBrains Mono', monospace",t={surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",blue:"#5a9abf",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},a=new Set(F.filter(r=>r.type==="regional_hq").map(r=>r.nation_id)),n=Oe.filter(r=>!a.has(r.id)),l=se?n.find(r=>r.id===se):null;let s="";for(const r of n){const o=r.id===se,c=St(r),m=Number(r.standard_of_living??50),p=Number(r.stability??50),u=c>6e7?t.red:c>4e7?t.orange:t.greenBright;s+=`
    ...
    </div>`}window.corpSelect=Xn;window.corpFilterNation=Zn;window.corpSort=ea;let ie=null,re={},Q=120,le=15,At={},Me=[];async function ta(){if(!ce)return;ie=ce,At={};try{const{data:t}=await _.from("corp_material_inventory").select("material_key, quantity").eq("faction_id",f.id);for(const a of t||[])At[a.material_key]=Number(a.quantity||0)}catch{}Me=[];try{const{data:t}=await _.from("contract_bids").select("faction_id, bid_price, estimated_quality, status, factions(faction_name, corp_ticker)").eq("contract_id",ie.id).in("status",["pending","won"]);Me=(t||[]).filter(a=>a.faction_id!==f?.id).map(a=>({name:a.factions?.faction_name||"Unknown",ticker:a.factions?.corp_ticker||"???",price:Number(a.bid_price||0),quality:Number(a.estimated_quality||0),status:a.status}))}catch{}re={};const i=ie.required_materials||{};for(const t of Object.keys(i))re[t]="STD";const e=ie.required_workforce||{};Q=Number(e.general||0)+Number(e.skilled||0)||120,le=15,Je(),ot()}function Ht(){document.getElementById("bid-assembly-overlay")?.remove(),ie=null}function ia(i,e){re[i]=e,ot()}function na(i){Q=i,ot()}function aa(i){le=i,ot()}function ot(){if(document.getElementById("bid-assembly-overlay")?.remove(),!ie)return;const i="'JetBrains Mono', monospace",e={surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",accentBright:"#a3b07e",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",redDim:"#a44",yellow:"#ca5",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},t=ie,a=t.issuer_type==="GOVERNMENT",n=k?.name||f?.nation||"—",l=Number(t.budget_ceiling||0),s=Number(t.timeline_ticks||8),d=t.required_materials||{},r=Object.keys(d),o={LOW:.5,STD:1,HIGH:2},c={LOW:e.orange,STD:e.yellow,HIGH:e.greenBright},m={LOW:"Low",STD:"Standard",HIGH:"High"},p={concrete:36e4,steel:5e5,glass_facades:56e4,em_systems:64e4,lumber:24e4,heavy_parts:8e5,aggregate:16e4,asphalt:28e4},u=At||{};let y=0,v="";for(const z of r){const O=Number(d[z]||0),Gt=re[z]||"STD",Wt=p[z]||3e5,Ii=o[Gt],Mi=Math.round(Wt*Ii),Ft=O*Mi;y+=Ft;const Si=z.replace(/_/g," ").replace(/\b\w/g,fe=>fe.toUpperCase()),Vt=Number(u[z]||0),lt=Math.max(0,O-Vt),Ai=lt===0?e.greenBright:lt<O?e.yellow:e.red,zi=lt===0?"✓ IN STOCK":`${Vt}/${O}`;v+=`
        <div style="display:flex;align-items:center;padding:5px 14px;border-bottom:1px solid ${e.border};">
            <div style="flex:1.2">
                <span style="font-size:11px;color:${e.text}">${Si}</span>
                <div style="font-family:${i};font-size:7px;color:${Ai};margin-top:1px">${zi}</div>
            </div>
            ...
            <div style="flex:1.2;display:flex;gap:2px;justify-content:center;">
                ${["LOW","STD","HIGH"].map(fe=>{const dt=Gt===fe,Yt=c[fe],Li=b(Math.round(Wt*o[fe]));return`<span onclick="bidSetGrade('${z}','${fe}')" style="padding:2px 6px;font-family:${i};font-size:7px;font-weight:700;cursor:pointer;color:${dt?"#000":e.dim};background:${dt?Yt:"transparent"};border:1px solid ${dt?Yt:e.border}" title="${Li}/unit">${m[fe]}</span>`}).join("")}
            </div>
            <div style="flex:0.8;text-align:right"><span style="font-family:${i};font-size:10px;color:${e.text}">${b(Ft)}</span></div>
        </div>`}const h=15200,$=Q*h*s,w=l,x=[{name:"Municipal Zoning Approval",cost:18e4,ticks:2,required:!0},{name:"Structural Engineering Cert.",cost:24e4,ticks:3,required:!0},{name:"Environmental Impact Assessment",cost:34e4,ticks:8,required:w>2e7},{name:"Seismic Resilience Compliance",cost:21e4,ticks:4,required:w>5e7},{name:"Heritage Conservation Review",cost:16e4,ticks:6,required:!1},{name:"Fire Safety Certification",cost:12e4,ticks:2,required:w>1e7}].filter(z=>z.required),T=new Set(["Municipal Zoning Approval","Structural Engineering Cert."]),C=x.filter(z=>!T.has(z.name)).reduce((z,O)=>z+O.cost,0),S=4e5,E=y+$+C+S,M=Math.round(E*(le/100)),R=E+M,q=R>l,V=M,X=q?0:Math.max(0,Math.min(100,Math.round(100-R/l*100+30))),Ue=X>70?e.greenBright:X>40?e.yellow:X>0?e.orange:e.red,jt=q?"OVER CEILING":X>70?"STRONG":X>40?"COMPETITIVE":X>20?"WEAK":"UNLIKELY",rt=Object.values(re),me=rt.length>0?Math.round(rt.reduce((z,O)=>z+(O==="HIGH"?85:O==="STD"?65:45),0)/rt.length):50,Ge=me>=75?e.greenBright:me>=55?e.yellow:e.orange,Ti=me>=75?"STRONG":me>=55?"PROMISING":"UNCERTAIN",Ut=t.required_workforce||{},ze=Number(Ut.general||0)+Number(Ut.skilled||0)||100,Ci=[Math.max(40,Math.round(ze*.7)),Math.max(60,Math.round(ze*.85)),ze,Math.round(ze*1.15),Math.round(ze*1.3)],Te=document.createElement("div");Te.id="bid-assembly-overlay",Te.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.7);display:flex;align-items:center;justify-content:center;z-index:9999;",Te.addEventListener("click",z=>{z.target===Te&&Ht()}),Te.innerHTML=`
            ...
            <div style="flex:1;border-right:1px solid ${e.border};overflow:auto;">
                ...
                <div style="padding:8px 14px;border-bottom:1px solid ${e.border};">
                    <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px;">
                        ...
                        <div style="display:flex;gap:3px;">
                            ${Ci.map(z=>`<span onclick="bidSetWorkers(${z})" style="padding:2px 8px;font-family:${i};font-size:8px;font-weight:700;cursor:pointer;color:${Q===z?"#000":e.dim};background:${Q===z?e.accent:"transparent"};border:1px solid ${Q===z?e.accent:e.border}">${z}</span>`).join("")}
                        </div>
                    </div>
                    <div style="display:flex;justify-content:space-between;">
            ...
            <div style="width:280px;display:flex;flex-direction:column;overflow:auto;">
                ...
                <div style="padding:8px 14px;border-bottom:1px solid ${e.border};">
                    <div style="display:flex;justify-content:space-between;margin-bottom:4px;">
                        ...
                        <span style="font-family:${i};font-size:11px;font-weight:700;color:${Ue}">${jt}</span>
                    </div>
                ...
                <div style="padding:8px 14px;border-bottom:1px solid ${e.border};">
                    <div style="display:flex;justify-content:space-between;margin-bottom:4px;">
                        ...
                        <div style="display:flex;align-items:baseline;gap:4px;">
                            ...
                            <span style="font-family:${i};font-size:8px;font-weight:700;color:${Ge}">${Ti}</span>
                        </div>
                    </div>
...
Lowest qualified bid wins.`),typeof pe=="function"&&await pe()}catch(x){alert("Bid submission failed: "+x.message)}finally{Ae=!1}}}window.openBidAssembly=ta;window.closeBidAssembly=Ht;window.bidSetGrade=ia;window.bidSetWorkers=na;window.bidSetMarkup=aa;window.submitBidAssembly=oa;let De=[],_e=0,J=null,_t=!1;async function sa(){if(!ce)return;J=ce,_e=0;const{data:i}=await _.from("contract_bids").select("*, factions(faction_name, corp_ticker, corp_subsector)").eq("contract_id",J.id).in("status",["pending","won"]).order("bid_price",{ascending:!0});De=(i||[]).map(e=>({...e,corp:e.factions?.faction_name||"Unknown",abbr:e.factions?.corp_ticker||"???",subsector:e.factions?.corp_subsector||"—",reputation:50,track:[]})),Je(),Ei()}function st(){document.getElementById("bid-review-overlay")?.remove(),J=null}function ra(i){_e=i,Ei()}async function la(){if(_t||De.length===0)return;const i=De[_e];if(i&&confirm("Accept bid from "+i.corp+`?

Bid Price: `+b(i.bid_price)+`
Quality: `+i.estimated_quality+`/100
Workers: `+i.labor_count+`

This will award the contract. The project begins immediately.`)){_t=!0;try{const{data:e}=await _.from("shard").select("current_tick").eq("name","Alpha Shard").single(),t=e?.current_tick||0;await _.from("contract_bids").update({status:"won"}).eq("id",i.id),await _.from("contract_bids").update({status:"lost"}).eq("contract_id",J.id).neq("id",i.id),await _.from("construction_contracts").update({status:"awarded",awarded_to_faction:i.faction_id,awarded_at_tick:t}).eq("id",J.id),st(),alert("Contract awarded to "+i.corp+`!

Bid: `+b(i.bid_price)+`
Project begins immediately.`),typeof pe=="function"&&await pe()}catch(e){alert("Failed to accept bid: "+e.message)}finally{_t=!1}}}async function da(){if(J&&confirm(`Decline all bids and cancel this project?

No bids will be accepted. The contract will be removed.`))try{await _.from("contract_bids").update({status:"lost"}).eq("contract_id",J.id),await _.from("construction_contracts").update({status:"expired"}).eq("id",J.id),st(),alert("All bids declined. Contract cancelled."),typeof pe=="function"&&await pe()}catch(i){alert("Failed: "+i.message)}}function Ei(){if(document.getElementById("bid-review-overlay")?.remove(),!J||De.length===0)return;const i="'JetBrains Mono', monospace",e={surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",accentBright:"#a3b07e",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",yellow:"#ca5",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},t=J,a=De;_e>=a.length&&(_e=0);const n=a[_e],l=Number(t.budget_ceiling||0),s=Number(t.timeline_ticks||36),d=Math.min(...a.map(u=>u.bid_price));Math.max(...a.map(u=>u.reputation));const r=Math.max(...a.map(u=>u.estimated_quality||0));let o="";for(let u=0;u<a.length;u++){const y=a[u],v=u===_e,h=y.bid_price===d,$=(y.estimated_quality||0)===r,w=y.bid_price>l;o+=`
    ...
    </div>`,document.body.appendChild(p)}window.openBidReview=sa;window.closeBidReview=st;window.reviewSelectBid=ra;window.acceptBid=la;window.declineAllBids=da;window.switchToExpansion=bi;window.switchToOperations=$i;window.hfSetChange=qn;window.hfReset=Nn;window.hfConfirm=Rn;document.querySelector('[data-tab="operations"]')?.addEventListener("click",function(i){this.classList.contains("active")||(i.preventDefault(),$i(i))});An();
