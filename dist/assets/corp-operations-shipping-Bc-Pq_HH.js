...
import{_supabase as v}from"./supabase-client-CiYoFhIh.js";/* empty css                    */import{c as Ge,i as ba,a as _a,l as ha,M as qt,Q as kn,b as En,d as cn,e as li,f as di,g as $a,h as wa}from"./corp-shipping-data-CcJ84lK3.js";import{_ as ka}from"./preload-helper-BXl3LOEh.js";import{e as b}from"./utils-CY90Gazr.js";import{initMessaging as Ea}from"./messaging-BUrQna7p.js";import{c as Ca,a as pn,E as Bt,b as $o,d as ci,e as za,f as Sa,h as oi}from"./equipment-DsuDdEne.js";import{a as Ta,E as so,b as ro,g as Ia}from"./corp-executives-1DOHMXWp.js";import"./elections-Cn1LYWzr.js";import"./config-fKhFNVuq.js";import"./government-types-D9n0pQb0.js";import"./ideology-Ngkkb21f.js";import"./stats-tIiBSaQA.js";let we=[],d=null,z=null,S=null,st=[],bt={},K=[],Z={},fn=-1;const Aa={em:"em_systems",glass:"glass_facades",heavy:"heavy_parts"},lo=o=>Aa[o]||o;let de="concrete",J="STD",he=500,ie=[],pi={},mn=0,Ot=[],Pt=[],ft=0,ke=null,Ce=-1,ce=[],Dt=null,Tt={},co={},Cn=[],po=null,fe="trucks",Ee=0,ze=1,qe=[],Ve=null,fi=[],un=null,Zt=null,yn="ALL",vn="TIMELINE";function O(o){return Math.abs(o)>=1e6?"$"+(o/1e6).toFixed(1)+"M":Math.abs(o)>=1e3?"$"+(o/1e3).toFixed(0)+"k":"$"+o}function Ma(o){if(o>=12){const e=Math.floor(o/12),t=o%12;return t>0?e+"y "+t+"mo":e+"y"}return o+" ticks"}function mi(o){return!o||o.length===0?"":o.map(e=>{const t=pi[e];if(!t)return"";const i=t.reputation_bonus>0?"var(--green)":t.reputation_bonus<0?"var(--red)":"var(--text-dim)",n=t.reputation_bonus>0?"+"+t.reputation_bonus:t.reputation_bonus<0?String(t.reputation_bonus):"";return`<span style="display:inline-flex;align-items:center;gap:3px;padding:2px 6px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:3px;font-family:var(--font-mono);font-size:7px;color:var(--text-secondary);">${t.icon||"📍"} ${b(t.name)}${n?` <span style="color:${i};font-weight:700;">${n} REP</span>`:""}</span>`}).filter(Boolean).join(" ")}function me(o){return Math.abs(o)>=1e9?"$"+(o/1e9).toFixed(1)+"B":Math.abs(o)>=1e6?"$"+(o/1e6).toFixed(0)+"M":Math.abs(o)>=1e3?"$"+(o/1e3).toFixed(0)+"k":"$"+o}function zn(o){return o==="civil_engineering"?"CIVIL":o==="industrial"?"INDUSTRIAL":o==="mega_project"?"MEGA":o?.toUpperCase()||"—"}function ui(o){return o==="civil_engineering"?"light":o==="industrial"?"heavy":o==="mega_project"?"mega":"light"}function Na(){Zt&&clearInterval(Zt),Zt=setInterval(()=>{if(!un)return;const o=un-Date.now();if(o<=0){document.getElementById("tick-countdown").textContent="Tick due...",clearInterval(Zt);return}const e=Math.floor(o/36e5),t=Math.floor(o%36e5/6e4),i=Math.floor(o%6e4/1e3);document.getElementById("tick-countdown").textContent=e+"h "+t+"m "+i+"s"},1e3)}function Ra(){document.body.classList.toggle("light-mode");const o=document.getElementById("theme-toggle");o.textContent=document.body.classList.contains("light-mode")?"Dark":"Light"}function La(o,e){o==="type"&&(yn=e),o==="sort"&&(vn=e),document.querySelectorAll(`.filter-pill[data-filter="${o}"]`).forEach(t=>{t.classList.toggle("active",t.dataset.value===e)}),vi()}const ni={"Civil Engineering":"civil_engineering","Industrial Construction":"industrial",Megaprojects:"mega_project"};function yi(o){if(!d)return!1;if(ni[d.corp_subsector]===o.sector)return!0;const t=(V||[]).filter(i=>i.type==="regional_hq"&&i.is_active&&i.nation_id===o.nation_id);for(const i of t)if(ni[i.subsector]===o.sector)return!0;return!1}function vi(){const o=document.getElementById("oc-list");let e=[...st];if(yn==="GOVERNMENT"?e=e.filter(n=>n.issuer_type==="GOVERNMENT"):yn==="PRIVATE"&&(e=e.filter(n=>n.issuer_type==="PRIVATE")),vn==="TIMELINE"&&e.sort((n,a)=>(n.timeline_ticks||0)-(a.timeline_ticks||0)),vn==="BUDGET"&&e.sort((n,a)=>(a.budget_ceiling||0)-(n.budget_ceiling||0)),document.getElementById("oc-count").textContent=e.length+" AVAILABLE",e.length===0){o.innerHTML=`
            <div class="oc-empty">
            ...
            </div>`;return}const t=S?.current_tick||0;let i="";for(const n of e){const a=n.issuer_type==="GOVERNMENT",s=a?"gov":"private",r=yi(n),c=r?"":" locked",p=ui(n.sector),f=zn(n.sector),l=(n.timeline_ticks||0)>18?" warn":"",m=n.bidding_ends_tick?Math.max(0,n.bidding_ends_tick-t):"?";i+=`
            ...
            </div>`}o.innerHTML=i,o.querySelectorAll(".oc-item:not(.locked)").forEach(n=>{n.addEventListener("click",()=>{const a=n.dataset.contractId,s=st.find(r=>r.id===a);s&&gi(s)})})}let We=null;function gi(o){We=o;const e=document.getElementById("cd-overlay"),t=o.issuer_type==="GOVERNMENT",i=t?"gov":"private",n=(z?.name||d.nation||"—").toUpperCase(),a=yi(o);document.getElementById("cd-header-left").innerHTML=`
    ...
    `;const s=document.getElementById("cd-blueprint");o.blueprint_svg?(s.innerHTML=o.blueprint_svg,s.style.display=""):(s.innerHTML=Xa(o),s.style.display="");const r=o.permits_required||[],c=o.required_equipment||o.equipment_required||{},p=Array.isArray(c)?c.map(A=>({key:A,qty:1})):Object.entries(c).map(([A,P])=>({key:A,qty:P})),f=o.required_materials||o.materials_estimated||{},m={civil_engineering:"Civil Engineering",industrial:"Industrial Construction",mega_project:"Megaprojects"}[o.sector]||o.spec_category||o.sector||"—";let u="var(--teal)";o.sector==="industrial"&&(u="var(--orange)"),o.sector==="mega_project"&&(u="var(--red)");let y=O(o.budget_ceiling||o.budget||0),x=(o.timeline_ticks||o.timeline_months||0)+" Months",g="";g+=`
        <div class="cd-issue">
            ...
            </div>`}g+="</div></div>"}g+='<div class="cd-details">',o.project_type&&(g+=Le("Type",o.project_type)),o.project_subtype&&(g+=Le("Sub-Type",o.project_subtype)),g+=Le("Specialization",m,u),g+=Le("Total Budget",y,"var(--green)"),g+=Le("Timeline",x),g+=Le("Nation",z?.name||d.nation||"—"),o.region&&(g+=Le("Region",o.region)),g+="</div>",r.length>0&&(g+=`
            <div class="cd-items">
                <div class="cd-section-label">Permits Required</div>
                <div class="cd-items__list">
                    ${r.map(A=>{const P=A.status==="approved"?"approved":"required",U=A.status==="approved"?"&#10003;":"&#9675;";return`<div class="cd-chip ${P}">
            ...
            </div>`),document.getElementById("cd-content").innerHTML=g;const h=r.filter(A=>A.status==="approved").length,k=r.length-h,I=p.length,T=[];for(const A of p){const P=ie.find(U=>U.equipment_key===A.key);P&&P.owned>=A.qty||T.push(A)}const w=T.length,C=o.required_materials||{},L=typeof C=="object"&&!Array.isArray(C)?Object.entries(C):[],E=[];for(const[A,P]of L){const U=Z[A]||{},W=(U.LOW?.qty||0)+(U.STD?.qty||0)+(U.HIGH?.qty||0);W<P&&E.push({key:A,need:P,have:W})}const R=A=>A.replace(/_/g," ").replace(/\b\w/g,P=>P.toUpperCase());let M="";if(I>0)if(w===0)M+='<span class="cd-footer__badge ok">ALL EQUIPMENT MET</span>';else{const A=T.map(P=>R(P.key)).join(", ");M+=`<span class="cd-footer__badge bad" title="${b(A)}">${w} SHORT: ${b(A)}</span>`}if(L.length>0)if(E.length===0)M+='<span class="cd-footer__badge ok">ALL MATERIALS MET</span>';else{const A=E.map(P=>R(P.key)+" ("+P.have+"/"+P.need+")").join(", ");M+=`<span class="cd-footer__badge bad" title="${b(A)}">${E.length} MAT SHORT: ${b(A)}</span>`}r.length>0&&(k===0?M+='<span class="cd-footer__badge ok">ALL PERMITS APPROVED</span>':M+=`<span class="cd-footer__badge warn">${k} PERMITS PENDING</span>`);const B=a,F=o.issuer_faction_id===d?.id,j=o.status==="bidding",X=bt[o.id];document.getElementById("cd-footer").innerHTML=`
    ...
    `,e.classList.add("open"),document.body.style.overflow="hidden"}function Vt(o){o&&o.target&&o.target!==document.getElementById("cd-overlay")||(document.getElementById("cd-overlay").classList.remove("open"),document.body.style.overflow="",We=null)}const De=["Permits","Planning","Foundation","Structural","Systems","Finishing","Delivery"],ii={WEATHER:{color:"var(--blue)",bg:"var(--blue-faint)",border:"var(--blue-border)"},SUPPLY:{color:"var(--gold)",bg:"var(--gold-faint)",border:"var(--gold-border)"},LABOR:{color:"var(--orange)",bg:"var(--orange-faint)",border:"var(--orange-border)"},REGULATORY:{color:"var(--red)",bg:"var(--red-faint)",border:"var(--red-border)"},EQUIPMENT:{color:"var(--amber)",bg:"var(--amber-faint)",border:"var(--amber-border)"},POLITICAL:{color:"var(--teal)",bg:"var(--teal-faint)",border:"var(--teal-border)"}},ai={LOW:"var(--green)",MODERATE:"var(--amber)",HIGH:"var(--orange)",CRITICAL:"var(--red)"};let q=null;async function tt(o){const e=K.find(A=>A.id===o);if(!e)return;const t=Array.isArray(e.contract_bids)?e.contract_bids[0]:e.contract_bids,i=S?.current_tick||0,n=e.awarded_at_tick||i,a=e.timeline_ticks||8,s=Math.max(0,i-n),r=Math.min(100,s/a*100);let c=Math.min(De.length-1,Math.floor(r/(100/De.length)));const p=Math.round(r%(100/De.length)/(100/De.length)*100),f=e.required_materials||{},l=t?.material_grades||{};let m=[];try{const{data:A}=await v.from("project_material_allocations").select("material_key, quality_tier, quantity, consumed").eq("contract_id",e.id);m=A||[]}catch{}const u={};for(const A of m)u[A.material_key]||(u[A.material_key]={totalAllocated:0,totalConsumed:0,tiers:{}}),u[A.material_key].totalAllocated+=A.quantity,u[A.material_key].totalConsumed+=A.consumed,u[A.material_key].tiers[A.quality_tier]={qty:A.quantity,consumed:A.consumed};const y=Object.entries(f).map(([A,P])=>{const U=l[A]||"STD",W=u[A]||{totalAllocated:0,totalConsumed:0,tiers:{}};return{key:A,name:A.replace(/_/g," ").replace(/\b\w/g,se=>se.toUpperCase()),grade:U,required:Number(P),allocated:W.totalAllocated,consumed:W.totalConsumed,tiers:W.tiers,warehouseStock:Z[A]||{}}}),x=e.required_equipment||{},g=e.equipment_condition||{},h=(Array.isArray(x)?x.map(A=>[A,1]):Object.entries(x)).map(([A,P])=>{const U=ie.find(H=>H.equipment_key===A),se=(U?.assigned_projects||[]).find(H=>H.contract_id===e.id),ge=se?se.units:0;return{key:A,name:A.replace(/_/g," ").replace(/\b\w/g,H=>H.toUpperCase()),required:Number(P)||1,ownedTotal:U?.owned||0,deployed:U?.deployed||0,available:Math.max(0,(U?.owned||0)-(U?.deployed||0)),assignedToProject:ge,condition:g[A]??(U?.condition||100)}}),k=e.budget_ceiling||0,I=t?.estimated_cost||0,T=Math.round(I*Math.min(1,s/a)),w=t?.estimated_quality||65,C=w>=75?"EXCELLENT":w>=50?"FAIR":w>=25?"POOR":"BAD",L=e.required_workforce||{},E=e.workers_assigned||{},R=(L.general||0)+(L.skilled||0)+(L.innovative||0),M=(E.general||0)+(E.skilled||0)+(E.innovative||0),B=t?.labor_count||R,F=Number(d?.corp_general_workforce??0),j=Number(d?.corp_skilled_workforce??0),X=Number(d?.corp_innovative_workforce??0);q={project:e,bid:t,tab:"overview",expandedEvent:-1,selectedResponse:null,currentTick:i,awardedTick:n,totalTicks:a,ticksElapsed:s,phaseIdx:c,phaseProgress:p,materials:y,equipment:h,budget:k,estCost:I,spent:T,quality:w,qualityLabel:C,laborCount:B,wfNeeded:R,wfAssigned:M,reqWf:L,assignedWf:E,corpGeneral:F,corpSkilled:j,corpInnovative:X,events:[]},document.getElementById("pm-overlay").classList.add("open"),document.body.style.overflow="hidden",xi(e.id).then(()=>Ke()),Ke()}let G=!1;async function qa(o,e,t){if(!(G||!q||!d)){G=!0;try{const{data:i,error:n}=await v.rpc("allocate_material_to_project",{p_contract_id:q.project.id,p_faction_id:d.id,p_material_key:o,p_quality_tier:e,p_quantity:t});if(n){alert("Allocation failed: "+n.message);return}if(i&&!i.success){alert(i.error||"Allocation failed");return}await _i(),await tt(q.project.id)}catch(i){alert("Allocation error: "+i.message)}finally{G=!1}}}async function Ba(o,e,t){if(!(G||!q||!d)){G=!0;try{const{data:i,error:n}=await v.rpc("deallocate_material_from_project",{p_contract_id:q.project.id,p_faction_id:d.id,p_material_key:o,p_quality_tier:e,p_quantity:t});if(n){alert("Return failed: "+n.message);return}if(i&&!i.success){alert(i.error||"Return failed");return}await _i(),await tt(q.project.id)}catch(i){alert("Return error: "+i.message)}finally{G=!1}}}async function Oa(o,e){if(!(G||!q||!d)){G=!0;try{const t=q.project,i=t.workers_assigned||{},n=Number(i[o]||0),a=Number((t.required_workforce||{})[o]||0),s=Number(d?.["corp_"+o+"_workforce"]??0);let r=0;for(const u of K||[])u.id!==t.id&&(r+=Number((u.workers_assigned||{})[o]||0));const c=Math.max(0,s-r-n),p=Math.min(e,a-n,c);if(p<=0){alert(c<=0?"No "+o+" workers available in pool":"Already fully staffed for "+o);return}const f={...i,[o]:n+p},{error:l}=await v.from("construction_contracts").update({workers_assigned:f}).eq("id",t.id);if(l){alert("Assign failed: "+l.message);return}const m=K.find(u=>u.id===t.id);m&&(m.workers_assigned=f),await tt(t.id)}catch(t){alert("Assign error: "+t.message)}finally{G=!1}}}async function Pa(o,e){if(!(G||!q||!d)){G=!0;try{const t=q.project,i=t.workers_assigned||{},n=Number(i[o]||0),a=Math.min(e,n);if(a<=0){alert("No "+o+" assigned");return}const s={...i,[o]:n-a},{error:r}=await v.from("construction_contracts").update({workers_assigned:s}).eq("id",t.id);if(r){alert("Unassign failed: "+r.message);return}const c=K.find(p=>p.id===t.id);c&&(c.workers_assigned=s),await tt(t.id)}catch(t){alert("Unassign error: "+t.message)}finally{G=!1}}}async function Da(o,e){if(!(G||!q||!d)){G=!0;try{const t=ie.find(c=>c.equipment_key===o);if(!t){alert("Equipment not found in inventory.");return}const i=Math.max(0,(t.owned||0)-(t.deployed||0));if(i<e){alert("Not enough available "+o+" ("+i+" available).");return}const n=(t.deployed||0)+e,a=[...t.assigned_projects||[]],s=a.find(c=>c.contract_id===q.project.id);s?s.units+=e:a.push({contract_id:q.project.id,contract_name:q.project.name,units:e});const{error:r}=await v.from("corp_equipment").update({deployed:n,assigned_projects:a}).eq("faction_id",d.id).eq("equipment_key",t.equipment_key);if(r){alert("Deploy failed: "+r.message);return}await zi(),await tt(q.project.id)}catch(t){alert("Deploy error: "+t.message)}finally{G=!1}}}async function ja(o){if(!(G||!q||!d)){G=!0;try{const e=ie.find(r=>r.equipment_key===o);if(!e){alert("Equipment not found.");return}const t=[...e.assigned_projects||[]],i=t.findIndex(r=>r.contract_id===q.project.id);if(i===-1){alert("Equipment not deployed to this project.");return}const n=t[i].units;t.splice(i,1);const a=Math.max(0,(e.deployed||0)-n),{error:s}=await v.from("corp_equipment").update({deployed:a,assigned_projects:t}).eq("faction_id",d.id).eq("equipment_key",e.equipment_key);if(s){alert("Undeploy failed: "+s.message);return}await zi(),await tt(q.project.id)}catch(e){alert("Undeploy error: "+e.message)}finally{G=!1}}}function Fa(o){o&&o.target!==document.getElementById("pm-overlay")||(document.getElementById("pm-overlay").classList.remove("open"),document.body.style.overflow="",q=null)}function Ua(o){q&&(q.tab=o,q.expandedEvent=-1,q.selectedResponse=null,Ke())}function Ha(o){q&&(q.expandedEvent=q.expandedEvent===o?-1:o,q.selectedResponse=null,Ke())}function Ga(o){q&&(q.selectedResponse=q.selectedResponse===o?null:o,Ke())}function Ke(){if(!q)return;const o=q,e=o.project,t=e.issuer_type==="GOVERNMENT",i=zn(e.sector),n=d?.nation||"Nation",a=o.awardedTick+o.totalTicks,s=Math.max(0,a-o.currentTick),r=o.currentTick>a,c=o.budget>0?Math.round(o.spent/o.budget*100):0,p=c>85?"var(--red)":c>60?"var(--amber)":"var(--teal)",f=o.budget-o.spent,l=o.events.filter(g=>g.status==="ACTIVE").length;document.getElementById("pm-header").innerHTML=`
...
Insurance corps will see this in their Deal Flow.`);if(t===null)return;const i=t.trim()||"Construction Insurance",n=S.current_tick||0,{error:a}=await v.from("finance_loan_requests").insert({requesting_faction_id:d.id,nation_id:d.nation_id,request_type:"insurance",insured_contract_id:o,amount:e,term_months:0,purpose:i,status:"open",created_tick:n,expires_tick:n+12});if(a){a.message.includes("duplicate")||a.message.includes("unique")?alert("Insurance already requested for this project."):alert("Failed to request insurance: "+a.message);return}alert("Insurance request posted to Deal Flow. Insurance corporations can now offer coverage."),await bi()}window.requestInsurance=Ka;window.openProjectModal=tt;window.closeProjectModal=Fa;window.pmSetTab=Ua;window.pmToggleEvent=Ha;window.pmSelectResponse=Ga;window.pmAllocateMaterial=qa;window.pmDeallocateMaterial=Ba;window.pmDeployEquipment=Da;window.pmUndeployEquipment=ja;window.pmAssignWorkers=Oa;window.pmUnassignWorkers=Pa;async function xi(o){if(!q)return;const{data:e,error:t}=await v.from("construction_events").select("*").eq("contract_id",o).order("fired_at_tick",{ascending:!1});t?(console.warn("Failed to load project events:",t.message),q.events=[]):q.events=(e||[]).map(i=>({id:i.id,type:i.type,severity:i.severity,tick:i.fired_at_tick,title:i.title,desc:i.description,impact:i.impact,status:i.status==="ACTIVE"?"ACTIVE":"RESOLVED",resolution:i.resolution,responses:i.responses||[]})),Ke()}let Fo=!1;async function Ja(o,e){if(!(Fo||!q)){Fo=!0;try{const{data:t,error:i}=await v.rpc("resolve_construction_event",{p_event_id:o,p_response_key:e});if(i){console.error("Failed to resolve event:",i.message),alert("Failed to submit response: "+i.message);return}const n=typeof t=="string"?JSON.parse(t):t;if(n?.error){alert("Error: "+n.error);return}await xi(q.project.id),await bi(),n?.quality_applied&&n.quality_applied!==0&&(q.quality=Math.max(0,Math.min(100,q.quality+n.quality_applied)),q.qualityLabel=q.quality>=75?"EXCELLENT":q.quality>=50?"FAIR":q.quality>=25?"POOR":"BAD"),Ke()}finally{Fo=!1}}}window.confirmEventResponse=Ja;function Le(o,e,t){const i=t?` style="color:${t}"`:"";return`<div class="cd-detail-row">
        ...
        <g transform="translate(470,172)">
            ...
            <span class="wh-row__val${y?" empty":""}">${u>0?O(u):"—"}</span>
        ...
        </div>`}o.innerHTML=e}function Eo(){const o=document.getElementById("pr-content"),e=Ge(de,J,z),t=qt.find(T=>T.key===de);if(!t)return;if(!e.available){o.innerHTML=`<div class="pr-locked-panel">
            <div class="pr-locked-box">
                <div class="pr-locked-box__title">QUALITY TIER UNAVAILABLE</div>
                <div class="pr-locked-box__desc">
                    ${b(t.name)} — ${cn[J]} grade
                    is not produced domestically in ${b(z?.name||"—")}.
                </div>
        ...
        </div>`;return}const i=En(de,J,z),n=li(de,J,z),a=i*he,s=n>3e3?"LOW":n>1e3?"MODERATE":"HIGH",r=s==="LOW"?"var(--green)":s==="MODERATE"?"var(--amber)":"var(--red)",c=Number(z?.inflation??50),p=c>55?"up":c<45?"down":"flat",f=p==="up"?"&#9650;":p==="down"?"&#9660;":"&#8212;",l=p==="up"?"var(--red)":p==="down"?"var(--green)":"var(--text-dim)";let m="";m+=`<div style="padding:8px 14px;border-bottom:1px solid var(--border-0);">
        ...
        <div class="pr-drivers__title">Price Drivers (${b(z?.name||"—")})</div>`;for(const T of t.priceDrivers){const w=Number(z?.[T]??50),C=w>=50?"var(--green)":w>=30?"var(--amber)":w>=15?"var(--orange)":"var(--red)",L=ts[T]||T;m+=`<div class="pr-driver-row">
        ...
        </div>`}m+="</div>";const y=(Number(d?.corp_cash_reserves)||0)>=a,x=he>n,{totalUnits:g}=ko(),$=wo-g,h=he>$,k=$<=0,I=di[J];m+=`<div class="pr-order">
        ...
        <div class="pr-order__box">
            ...
            <div class="pr-qty-row">
                ...
                <div class="pr-qty-btns">
                    ${[100,250,500,1e3].map(T=>`<span class="pr-qty-btn${he===T?" active":""}" onclick="setPrQty(${T})">${T>=1e3?T/1e3+"k":T}</span>`).join("")}
                </div>
            </div>
    ...
    </div>`,o.innerHTML=m}function ns(o){de=o,J="STD";for(const e of["STD","HIGH","LOW"])if(Ge(o,e,z).available){J=e;break}hi(),Tn(),Eo()}function is(o){J=o,Tn(),Eo()}function as(o){he=o,Eo()}let Uo=!1;async function ss(){if(Uo||!d||!z)return;const o=En(de,J,z),e=li(de,J,z),t=o*he,i=Number(d.corp_cash_reserves)||0;if(t>i){alert("Insufficient cash reserves.");return}if(he>e){alert("Exceeds available supply this tick.");return}const{totalUnits:n}=ko(),a=wo-n;if(a<=0){alert("Warehouse is full. Cannot purchase more materials.");return}if(he>a){alert(`Warehouse can only hold ${a.toLocaleString()} more units. Reduce quantity.`);return}Uo=!0;const s=document.querySelector(".pr-purchase-btn");s&&(s.disabled=!0,s.textContent="...");try{const r=i-t,{error:c}=await v.from("factions").update({corp_cash_reserves:r}).eq("id",d.id);if(c)throw c;const p=lo(de),f=Z[p]?.[J],l=(f?.qty||0)+he,m=(f?.value||0)+t,{error:u}=await v.from("corp_warehouse").upsert({faction_id:d.id,nation_id:d.nation_id,material_key:p,quality_tier:J,quantity:l,total_value:m,last_purchased_tick:S?.current_tick||null,updated_at:new Date().toISOString()},{onConflict:"faction_id,material_key,quality_tier"});if(u){const{error:y}=await v.from("factions").update({corp_cash_reserves:i}).eq("id",d.id);throw y&&console.error("Cash refund failed after warehouse error:",y.message),u}d.corp_cash_reserves=r,Z[p]||(Z[p]={}),Z[p][J]={qty:l,value:m},Sn(),os(),s&&(s.textContent="PURCHASED",setTimeout(()=>{s.isConnected&&(s.disabled=!1,s.textContent="PURCHASE")},1500))}catch(r){s&&(s.disabled=!1,s.textContent="PURCHASE"),alert("Purchase failed: "+(r.message||"Unknown error"))}finally{Uo=!1}}function $i(o){const e=Ve||z;if(!e)return[];const t=$o(o);if(!t)return[];const i=za(o,e),n=[],a=Number(e?.inflation??50),s=Number(e?.fuel_prices??50);Number(e?.manufacturing_output??50);const r=Ve&&z&&Ve.id!==z.id;let c=null;if(r&&(c=Sa(e,z)),i.newAvailable>0){const p=oi(o,e),f=t.basePrice,l=Math.round(f*((a-50)/200)),m=Math.round(f*((s-50)/300));let u=p;const y=[{label:"Base price",value:O(f)},l!==0?{label:`Inflation (${a})`,mod:(l>=0?"+":"")+O(Math.abs(l))}:null,m!==0?{label:`Fuel transport (${s})`,mod:(m>=0?"+":"")+O(Math.abs(m))}:null].filter(Boolean),x=p-f-l-m;if(x!==0&&!r&&y.push({label:"Demand/scarcity",mod:(x>=0?"+":"")+O(Math.abs(x))}),r&&c){const g=Math.round(p*c.tariff),$=Math.round(p*c.transport);u=p+g+$,y.push({label:`Import tariff (${Math.round(c.tariff*100)}%)`,mod:"+"+O(g)}),y.push({label:`Transport (${c.deliveryTicks} tick${c.deliveryTicks>1?"s":""})`,mod:"+"+O($)})}n.push({seller:r?`${e.name} Buyers`:"Local Buyers",sellerType:"LOCAL",nation:e.name||"—",distance:r?c?.deliveryTicks||1:0,condition:100,price:Math.round(u),available:i.newAvailable,delivery:r?c.deliveryTicks+" tick"+(c.deliveryTicks>1?"s":""):"Immediate",deliveryTicks:r?c.deliveryTicks:0,used:!1,priceFactors:y,sourceNationId:e.id})}if(i.usedAvailable>0){const p=i.usedCondition,f=oi(o,e,{used:!0,condition:p});let l=f;const m=[{label:"Base price",value:O(t.basePrice)},{label:`Condition (${p}%)`,mod:"-"+O(Math.max(0,t.basePrice-f))}];if(r&&c){const u=Math.round(f*c.tariff),y=Math.round(f*c.transport);l=f+u+y,m.push({label:`Import tariff (${Math.round(c.tariff*100)}%)`,mod:"+"+O(u)}),m.push({label:`Transport (${c.deliveryTicks} tick${c.deliveryTicks>1?"s":""})`,mod:"+"+O(y)})}n.push({seller:r?`${e.name} Buyers`:"Local Buyers",sellerType:"LOCAL",nation:e.name||"—",distance:r?c?.deliveryTicks||1:0,condition:p,price:Math.round(l),available:i.usedAvailable,delivery:r?c.deliveryTicks+" tick"+(c.deliveryTicks>1?"s":""):"Immediate",deliveryTicks:r?c.deliveryTicks:0,used:!0,priceFactors:m,sourceNationId:e.id})}return n}function In(){const o=Number(d?.corp_cash_reserves)||0;document.getElementById("em-cash").textContent=O(o);const e=$o(fe),t=Bt[e?.tier||1],i=document.getElementById("em-tier-badge");i&&(i.textContent=t.tag,i.style.color=t.color),i.style.background=t.color+"0a",i.style.border="1px solid "+t.color+"33";const n=document.getElementById("em-nation-select");if(n&&n.options.length===0){const r=z?.name||d?.nation||"—";let c=`<option value="">${b(r)} (HQ)</option>`;for(const p of fi)p.id!==z?.id&&(c+=`<option value="${p.id}">${b(p.name)}</option>`);n.innerHTML=c}const a=document.getElementById("em-import-tag"),s=Ve&&z&&Ve.id!==z.id;a&&(a.style.display=s?"":"none"),rs(),An()}function rs(){let o="";for(let e=1;e<=3;e++){const t=Bt[e],i=pn(e),n=e===3?"em-selector__grid em-selector__grid--t3":"em-selector__grid em-selector__grid--t12";o+=`<div class="em-selector__row">
            ...
            <div class="${n}">`;for(const a of i){const s=fe===a.key,r=$i(a.key).length>0;o+=`<span class="em-selector__btn${s?" active":""}${r?"":" no-listings"}"
                ...
                onclick="setEmType('${a.key}')">${b(a.name)}</span>`}o+="</div></div>"}document.getElementById("em-selector").innerHTML=`<div class="em-selector">${o}</div>`}function An(){const o=document.getElementById("em-content");if(qe=$i(fe),qe.length===0){o.innerHTML=`<div class="em-no-listings"><div class="em-no-listings__box">
        ...
        </div></div>`;return}Ee>=qe.length&&(Ee=0);let e="";for(let i=0;i<qe.length;i++){const n=qe[i],a=Ee===i,s=n.sellerType==="LOCAL"?"var(--teal)":"#5a8aaa",r=ci(n.condition);e+=`<div class="em-listing${a?" selected":""}" style="${a?"border-left-color:"+s:""}" onclick="setEmListing(${i})">`,e+=`<div class="em-listing__row1">
            <div style="display:flex;align-items:center;gap:6px">
            ...
            <div class="em-stat-cell" style="flex:1.2">
                ...
                <div class="em-stat-cell__value" style="font-size:11px;color:var(--text-bright);margin-top:2px">${O(n.price)}</div>
            </div>
            ...
            </div>`),e+="</div>"}const t=qe[Ee];if(t){const i=$o(fe),n=Bt[i?.tier||1],a=Math.min(t.available,4),s=t.price*ze,r=(Number(d?.corp_cash_reserves)||0)>=s;e+=`<div class="em-purchase"><div class="em-purchase__box">
            ...
            <div class="em-purchase__qty">
                ...
                <div class="em-purchase__qty-btns">
                    ${Array.from({length:a},(c,p)=>p+1).map(c=>`<span class="em-qty-btn${ze===c?" active":""}" style="${ze===c?"background:"+n.color+";border-color:"+n.color:""}" onclick="setEmQty(${c})">${c}</span>`).join("")}
                </div>
            ...
            <div class="em-purchase__total">
                <div>
                    ...
                    <div class="em-purchase__total-value">${O(s)}</div>
        ...
        </div></div>`}o.innerHTML=e}async function ls(o){if(!o)Ve=null;else{let t=fi.find(i=>i.id===o);if(!t)try{const{data:i}=await v.from("nations").select("*").eq("id",o).single();t=i}catch{}Ve=t||null}Ee=0,ze=1;const e=document.getElementById("em-nation-select");e&&(e.value=o||""),In()}function ds(o){fe=o,Ee=0,ze=1,In()}function cs(o){Ee=o,ze=1,An()}function ps(o){ze=o,An()}let Ho=!1;async function fs(){if(Ho)return;const o=qe[Ee];if(!o||!d)return;const e=$o(fe);if(!e)return;const t=ze,i=o.price*t,n=Number(d.corp_cash_reserves)||0;if(i>n){alert("Insufficient cash reserves.");return}if(t>o.available){alert("Not enough units available.");return}const a=document.querySelector(".em-purchase-btn");a&&(a.disabled=!0,a.textContent="..."),Ho=!0;try{const s=n-i,{error:r}=await v.from("factions").update({corp_cash_reserves:s}).eq("id",d.id);if(r)throw r;const c=!o.deliveryTicks||o.deliveryTicks===0;if(c){const f=ie.find(k=>k.equipment_key===fe),l=(f?.owned||0)+t,m=f?.purchase_price_avg||0,u=f?.owned||0,y=u>0?Math.round((m*u+o.price*t)/l):o.price,x=e.maintenancePerUnit*l,g=f?.condition||100,$=Math.round((g*u+o.condition*t)/l),{error:h}=await v.from("corp_equipment").upsert({faction_id:d.id,nation_id:d.nation_id,equipment_key:fe,tier:e.tier,owned:l,deployed:f?.deployed||0,condition:$,maintenance_per_tick:x,purchase_price_avg:y,last_purchased_tick:S?.current_tick||null,updated_at:new Date().toISOString()},{onConflict:"faction_id,equipment_key"});if(h){const{error:k}=await v.from("factions").update({corp_cash_reserves:n}).eq("id",d.id);throw k&&console.error("Cash refund failed:",k.message),h}f?(f.owned=l,f.condition=$,f.maintenance_per_tick=x):ie.push({equipment_key:fe,tier:e.tier,owned:l,deployed:0,condition:$,maintenance_per_tick:x,assigned_projects:[]})}else{const f=(S?.current_tick||0)+o.deliveryTicks,{error:l}=await v.from("corp_equipment_deliveries").insert({faction_id:d.id,equipment_key:fe,quantity:t,condition:o.condition,delivery_tick:f,source_nation_id:o.sourceNationId||null,seller_name:o.seller,price_paid:i});if(l){const{error:m}=await v.from("factions").update({corp_cash_reserves:n}).eq("id",d.id);throw m&&console.error("Cash refund failed:",m.message),l}}d.corp_cash_reserves=s,On(),In();const p=document.getElementById("pr-cash");p&&(p.textContent=O(s)),a&&(a.textContent=c?"PURCHASED":"ORDERED",setTimeout(()=>{a.isConnected&&(a.disabled=!1,a.textContent="PURCHASE")},1500))}catch(s){a&&(a.disabled=!1,a.textContent="PURCHASE"),alert("Purchase failed: "+(s.message||"Unknown error"))}finally{Ho=!1}}let ms=-1,rt=[],fo=[],gn=[];function Go(o){return Math.abs(o)>=1e6?"$"+(o/1e6).toFixed(1)+"M":Math.abs(o)>=1e3?"$"+(o/1e3).toFixed(0)+"k":"$"+o.toLocaleString()}function us(o,e,t){if(t)return"var(--orange)";const i=o/(e||1)*100;return i>50?"var(--green)":i>25?"var(--amber)":"var(--red)"}function si(){const o=document.getElementById("pm-list"),e=rt.length,t=fo.length,i=gn.length,n=rt.filter(c=>c.expiring_soon).length;document.getElementById("pm-active-count").textContent=`(${e})`,document.getElementById("pm-pending-count").textContent=`(${t})`,document.getElementById("pm-apply-count").textContent=`(${i})`;const a=document.getElementById("pm-badges");let s="";n>0&&(s+=`<span class="pm-badge pm-badge--expiring">${n} EXPIRING</span>`),t>0&&(s+=`<span class="pm-badge pm-badge--pending">${t} PENDING</span>`),a.innerHTML=s;const r=rt.reduce((c,p)=>c+(p.cost||0),0)+fo.reduce((c,p)=>c+(p.cost||0),0);document.getElementById("pm-total-cost").textContent=Go(r),document.getElementById("pm-footer-active").textContent=e,document.getElementById("pm-footer-pending").textContent=t;{if(e===0){o.innerHTML=`<div class="pm-empty">
    ...
    <div style="width:520px;background:${e.surface};border:1px solid ${e.border};display:flex;flex-direction:column;overflow:hidden;max-height:90vh;">
        ...
        <div style="padding:14px 20px;overflow:auto;flex:1;">
            ...
            <div style="margin-bottom:14px;">
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:5px;">
                    ...
                    <span style="font-family:${o};font-size:16px;font-weight:700;color:${e.gold};">${O(_e)}/trip</span>
                </div>
                <input type="range" min="${u}" max="${y}" step="${Math.max(1e3,Math.round(n*.02))}" value="${_e}"
                ...
                <div style="display:flex;justify-content:space-between;font-family:${o};font-size:8px;color:${e.dim};margin-top:3px;">
                    <span>50% market (${O(u)})</span>
                    <span style="color:${e.muted};">Market: ${O(n)}</span>
                    <span>150% premium (${O(y)})</span>
                </div>
            </div>`,m+=`
            <div style="margin-bottom:14px;">
                ...
                <div style="background:${e.card};border:1px solid ${e.border};padding:8px 10px;">
                    <div style="display:flex;justify-content:space-between;padding:3px 0;border-bottom:1px solid ${e.border};">
                        ...
                        <span style="font-family:${o};font-size:10px;font-weight:700;color:${e.green};">${O(_e)}</span>
                    </div>
                    <div style="display:flex;justify-content:space-between;padding:3px 0;">
                        <span style="font-family:${o};font-size:9px;color:${e.dim};">Est. Fuel Cost (~15%)</span>
                        <span style="font-family:${o};font-size:10px;color:${e.red};">-${O(a)}</span>
                    </div>
                    <div style="display:flex;justify-content:space-between;padding:3px 0;border-bottom:1px solid ${e.border};">
                        <span style="font-family:${o};font-size:9px;color:${e.dim};">Est. Maintenance (~8%)</span>
                        <span style="font-family:${o};font-size:10px;color:${e.red};">-${O(s)}</span>
                    </div>
                    <div style="display:flex;justify-content:space-between;padding:5px 0;">
                        <span style="font-family:${o};font-size:10px;font-weight:700;color:${e.text};">NET PROFIT</span>
                        <span style="font-family:${o};font-size:14px;font-weight:700;color:${c};">${r>=0?"+":""}${O(r)}</span>
                    </div>
                </div>
            </div>
    ...
    </div>`;const x=document.createElement("div");x.id="ra-modal-overlay",x.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.7);display:flex;align-items:center;justify-content:center;z-index:9999;",x.innerHTML=m,x.addEventListener("click",g=>{g.target===x&&qn()}),document.body.appendChild(x)}async function Es(){if(eo||!_t||!ht||!d||!S)return;eo=!0;const o=_t,e=5e4,{data:t}=await v.from("factions").select("corp_cash_reserves").eq("id",d.id).single(),i=Number(t?.corp_cash_reserves??0);if(i<e){alert("Not enough funds. Application fee: $50k. You have $"+Math.round(i/1e3)+"k."),eo=!1;return}try{const n=i-e,{error:a}=await v.from("factions").update({corp_cash_reserves:n}).eq("id",d.id);if(a){alert("Failed to deduct fee.");return}const{error:s}=await v.from("shipping_applications").insert({route_id:o.id,faction_id:d.id,proposed_rate:_e,application_fee:e,status:"pending",applied_at_tick:S.current_tick});if(s){await v.from("factions").update({corp_cash_reserves:i}).eq("id",d.id);const r=s.code==="23505"||/duplicate key|idx_shipping_applications_unique/i.test(s.message||"");alert(r?"You already have a pending or approved application on this route. Withdraw it from Route Applications before applying again.":"Application failed: "+s.message);return}try{await v.from("event_log").insert({nation_id:o.origin_nation_id,event_name:d.faction_name+" applied to service "+(o.origin_port||"?")+" → "+(o.destination_port||"?"),category:"corporate",description_chosen:d.faction_name+" submitted a shipping application for the "+(o.goods_name||"trade")+" route at a proposed rate of "+O(_e)+"/trip. Vessel: "+(ce.find(r=>r.id===ht)?.vessel_name||"Unknown"),fired_at_tick:S.current_tick})}catch(r){console.warn("[Shipping] Event log failed:",r?.message||r)}qn(),await Mn(),ee=-1,await Co(),alert("Application submitted! The government will review your application.")}catch(n){alert("Application failed: "+(n.message||"Network error"))}finally{eo=!1}}async function Cs(){if(!(Wo||ee<0||!d||!S)){var o=Rn(),e=o[ee];if(e){var t=Number(d.shipping_fleet_capacity??0),i=Number(d.shipping_fleet_deployed??0);if(i>=t){alert("No available vessels. Fleet capacity: "+t+", deployed: "+i+".");return}Wo=!0;var n=document.getElementById("ar-claim-btn");n.textContent="CLAIMING...",n.className="ar-claim-btn";try{var{data:a,error:s}=await v.rpc("claim_shipping_route",{p_faction_id:d.id,p_route_id:e.id,p_current_tick:S.current_tick});if(s){alert("Claim failed: "+s.message);return}if(a&&!a.success){alert(a.error||"Claim failed.");return}if(a?.claim_id){var r=(ce||[]).find(function(m){return m.status==="in_port"&&!m.active_claim_id&&m.fuel>=10});if(r){var{error:c}=await v.from("corp_vessels").update({status:"in_transit",active_claim_id:a.claim_id,current_port_nation_id:null}).eq("id",r.id);c&&console.warn("Failed to assign vessel to route:",c.message)}else console.warn("Route claimed but no available vessel with fuel >= 10% to assign.")}try{var p=e.origin_nation?.name||e.origin_nation_id||"Unknown",f=e.destination_nation?.name||e.destination_nation_id||"Unknown",l=e.goods_type||e.cargo_type||"goods";await v.from("event_log").insert({nation_id:d.nation_id,event_name:"Shipping Route Signed",category:"corporate",description_chosen:d.faction_name+" has just signed an agreement to ship "+l+" between "+p+" and "+f+".",fired_at_tick:S.current_tick||0})}catch{}await Mn(),ee=-1,await Promise.all([Co(),zo(),ve()])}catch(m){alert("Claim failed: "+(m.message||"Network error"))}finally{Wo=!1,n.textContent="CLAIM ROUTE",n.className="ar-claim-btn"+(ee>=0?" active":"")}}}}let Be=[],Ei="ready",At=null,yo=-1;async function zo(){if(!d)return;const o=await ha(v,d.id);Be=o.claims,Ei=o.state,At=o.error,At&&console.warn("Failed to load active voyages:",At.message),Ci()}function zs(o){yo=yo===o?-1:o,Ci()}async function Ss(o){if(!(Yo||!d||!S)){Yo=!0;try{var{data:e,error:t}=await v.rpc("release_shipping_route",{p_faction_id:d.id,p_claim_id:o,p_current_tick:S.current_tick});if(t){alert("Release failed: "+t.message);return}if(e&&!e.success){alert(e.error||"Release failed.");return}var{error:i}=await v.from("corp_vessels").update({status:"in_port",active_claim_id:null}).eq("active_claim_id",o).eq("faction_id",d.id);i&&console.warn("Failed to free vessel on release:",i.message),yo=-1,await Mn(),await Promise.all([Co(),zo(),ve()])}catch(n){alert("Release failed: "+(n.message||"Network error"))}finally{Yo=!1}}}function Ci(){const o=S?.current_tick||0,e=Number(d?.shipping_fleet_capacity??0),t=Number(d?.shipping_fleet_deployed??0),i=d?.corp_subsector||"--";document.getElementById("av-count").textContent=Be.length+" ACTIVE";const n=Be.reduce((f,l)=>f+Number(l.total_revenue||0),0),a=Be.reduce((f,l)=>f+(l.transits_completed||0),0),s=a>0?Math.round(n/a):0;document.getElementById("av-summary").innerHTML=`
        ...
        <div class="eq-summary__cell">
        ...
        </div>`;const n={};for(const r of ie)n[r.equipment_key]=r;let a="";for(let r=1;r<=3;r++){const c=Bt[r],p=pn(r),f=mn===r,l=p.reduce((u,y)=>u+(n[y.key]?.owned||0),0),m=p.reduce((u,y)=>u+(n[y.key]?.deployed||0),0);if(a+=`<div class="eq-tier-hdr" onclick="toggleEqTier(${r})">
            ...
            ${l>0?`<span class="eq-tier-hdr__count">${m}/${l}</span>`:'<span class="eq-tier-hdr__none">NONE OWNED</span>'}
                    ...
                    </div>`:a+='<div class="eq-row__hint">Purchase from Equipment Market →</div>',a+="</div>"}}document.getElementById("eq-list").innerHTML=a;const s=[1,2,3].map(r=>{const c=Bt[r],p=pn(r).reduce((f,l)=>f+(n[l.key]?.owned||0),0);return`<div class="eq-footer__tier-box" style="border-color:${p>0?c.color+"33":"var(--border-0)"};background:${p>0?c.color+"0a":"transparent"}">
        ...
        <div class="eq-footer__tiers">${s}</div>`}function As(o){mn=mn===o?-1:o,On()}async function zi(){if(!d)return;const{data:o,error:e}=await v.from("corp_equipment").select("equipment_key, tier, owned, deployed, condition, maintenance_per_tick, assigned_projects").eq("faction_id",d.id);e?(console.warn("Failed to load equipment:",e.message),ie=[]):ie=o||[],On()}async function Ms(){const{data:{user:o}}=await v.auth.getUser();if(!o){window.location.href="login.html";return}const{data:e}=await v.from("factions").select("*").or(`id.eq.${o.id},linked_user_id.eq.${o.id}`);we=(e||[]).filter(u=>u.nation_id);const t=sessionStorage.getItem("active_faction_id");if(d=we.find(u=>u.id===t)||we.find(u=>u.faction_type==="corporation")||we[0],!d){await v.auth.signOut(),window.location.href="login.html";return}if(d.faction_type!=="corporation"){window.location.href="dashboard.html";return}const i=new URLSearchParams(window.location.search).get("tab"),n=i==="expansion"||i==="actions";if(d.corp_sector!=="Shipping"&&!n){const y={Finance:"corp-operations-finance.html",Construction:"corp-operations.html"}[d.corp_sector];if(y){window.location.href=y;return}}const[a,s]=await Promise.all([d.nation_id?v.from("nations").select("*").eq("id",d.nation_id).single():Promise.resolve({data:null}),v.from("shard").select("current_tick, current_date, next_tick_at, tick_interval_hours").eq("name","Alpha Shard").single()]);a.error&&console.warn("Nation load failed:",a.error.message),a.data&&(z=a.data),s.error&&console.warn("Shard load failed:",s.error.message),S=s.data;let r=0;if(d?.id){const{data:u}=await v.from("construction_contracts").select("id, contract_bids!inner(id)").eq("issuer_faction_id",d.id).in("status",["open","bidding"]);if(u)for(const y of u)r+=(y.contract_bids||[]).length}const c=document.getElementById("corp-topbar-container");if(c){const{renderCorpTopBar:u}=await ka(async()=>{const{renderCorpTopBar:g}=await import("./corp-topbar-BGmUeelO.js");return{renderCorpTopBar:g}},__vite__mapDeps([0,1])),y=new URLSearchParams(window.location.search).get("tab")||"operations",x={};r>0&&(x.home={color:"#c8a832",title:r+" pending bid"+(r!==1?"s":"")+" on your projects"}),u(c,{faction:d,shard:S,activeTab:y,allUserFactions:we,badges:x})}if(S){if(document.getElementById("game-date").textContent=S.current_date||"—",document.getElementById("tick-number").textContent=S.current_tick||"—",S.next_tick_at){const y=(Number(S.tick_interval_hours)||8)*36e5,x=new Date(S.next_tick_at).getTime(),$=x-y+y/2;un=new Date($>Date.now()?$:x+y/2),Na()}const u=document.querySelector("#tick-countdown")?.closest(".tick-item")?.querySelector(".tick-label");u&&(u.textContent="Next Corp Tick")}const p=document.getElementById("topbar-cash");p&&(p.textContent="CASH: "+wi(Number(d.corp_cash_reserves??0)));const f=document.getElementById("topbar-ap");f&&(f.style.display="none");const l=document.getElementById("nation-pill");l&&(l.textContent=(z?.name||d.nation||"—").toUpperCase());const m=document.getElementById("corp-faction-dropdown");if(m){let u="";for(const y of we){const x=y.id===d.id,g=y.faction_type==="corporation"?"CORP":"PARTY",$=y.faction_type==="corporation"?"var(--teal)":"var(--amber)";u+=`<div class="corp-dd-item${x?" active":""}" onclick="switchToFaction('${y.id}', '${y.faction_type}')">
    ...
    </div>`,i+='<div style="display:flex;gap:8px;">',i+='<div style="width:262px;display:flex;flex-direction:column;gap:5px;flex-shrink:0;">';for(let n=0;n<so.length;n++){const a=so[n],s=ro[a],r=Me(a),c=ft===n,p=s.color,f=!r;if(i+=`<div onclick="actSelectExec(${n})" style="
            padding:10px 12px;
    ...
    </div>`,o.innerHTML=a,o.querySelectorAll("[onmouseenter]").forEach(s=>{s.addEventListener("mouseenter",function(){const r=this.querySelector(".act-exec-btn");r&&(r.style.display="block")}),s.addEventListener("mouseleave",function(){const r=this.querySelector(".act-exec-btn");r&&(r.style.display="none")})})}function Ps(o,e,t,i,n){const a=S?.current_tick||0,s=Math.max(0,n-a),r=Math.round(i*(s/12)),c=`FIRE ${e}: ${t}
...
This action CANNOT be undone.`))return;if(prompt('Type "BANKRUPT" to confirm bankruptcy of '+a+":")!=="BANKRUPT"){alert("Bankruptcy cancelled.");return}Ko=!0;try{async function m(B){const{error:F}=await B;if(F)throw F}const u=Number(n.corp_cash_reserves)||0,{data:y}=await v.from("corp_properties").select("purchase_price, condition").eq("faction_id",e);let x=0;for(const B of y||[])x+=Math.round(Number(B.purchase_price||0)*(Number(B.condition||0)/100));const g=u+x,$=Number(n.corp_loans)||0,h=g-$,k=Math.round(h*1.3),I=Math.max(0,Math.round(k*Us)),{data:T}=await v.from("finance_active_loans").select("*").eq("borrower_faction_id",e).in("status",["current","late","delinquent"]).order("started_tick",{ascending:!0});let w=0;for(const B of T||[]){const F=B.principal-B.total_paid;if(F<=0)continue;const j=Math.min(F,I-w);if(j<=0)break;const{data:X}=await v.from("factions").select("corp_cash_reserves").eq("id",B.lender_faction_id).single();X&&await m(v.from("factions").update({corp_cash_reserves:(Number(X.corp_cash_reserves)||0)+j}).eq("id",B.lender_faction_id)),await m(v.from("finance_active_loans").update({status:"repaid",total_paid:B.total_paid+j,completed_tick:c}).eq("id",B.id)),w+=j}await m(v.from("contract_bids").delete().eq("faction_id",e)),await m(v.from("construction_contracts").update({status:"expired"}).eq("issuer_faction_id",e).in("status",["open","bidding"])),await m(v.from("corp_equipment_deliveries").delete().eq("faction_id",e)),await m(v.from("corp_equipment").delete().eq("faction_id",e)),await m(v.from("corp_properties").delete().eq("faction_id",e)),await v.from("corp_material_inventory").delete().eq("faction_id",e),await v.from("corp_warehouse").delete().eq("faction_id",e),await v.from("corp_executives").delete().eq("faction_id",e),await v.from("faction_agitators").delete().eq("faction_id",e),await m(v.from("factions").delete().eq("id",e));const C=w>0?" $"+w.toLocaleString()+" was repaid to creditors.":"";await m(v.from("event_log").insert({nation_id:n.nation_id,faction_id:e,event_name:a+" — Bankruptcy",description_used:a+" has officially filed for bankruptcy. It has laid off its executive staff and ceased operations."+C,category:"business",trigger_key:"corp_bankruptcy",effects_applied:{corp_name:a,sector:n.corp_sector,user_id:o.id,loan_payback:w,valuation:k},fired_at_tick:c})),sessionStorage.removeItem("active_faction_id"),sessionStorage.removeItem("nationhood_state");const{data:L}=await v.from("factions").select("id, faction_type").or(`id.eq.${o.id},linked_user_id.eq.${o.id}`),E=(L||[]).find(B=>B.faction_type==="party"),R=(L||[]).find(B=>B.faction_type==="corporation"),M=w>0?`
...
Please try again or contact support.`)}finally{Ko=!1}}const Bi=[{id:"equipment",label:"Equipment Acquisition",desc:"Purchase vehicles, cranes, or heavy machinery",icon:"&#9881;"},{id:"working",label:"Working Capital",desc:"Bridge financing for active project costs",icon:"$"},{id:"property",label:"Property Purchase",desc:"Acquire office, warehouse, or HQ building",icon:"&#9632;"},{id:"subsidiary",label:"Subsidiary Expansion",desc:"Fund new subsidiary establishment",icon:"&#9672;"},{id:"materials",label:"Material Procurement",desc:"Bulk material purchase for upcoming projects",icon:"&#9638;"}],Jo=[{id:"none",label:"None",desc:"Unsecured — lenders may charge higher rates",risk:"HIGH",riskColor:"#c84"},{id:"equipment",label:"Equipment",desc:"Financed equipment serves as collateral",risk:"MODERATE",riskColor:"#ca5"},{id:"property",label:"Property",desc:"Corporate property lien",risk:"LOW",riskColor:"#8b9a6b"},{id:"full",label:"Full Assets",desc:"All corporate assets — maximum lender security",risk:"MINIMAL",riskColor:"#5c5"}];let te=25e7,jt="equipment",vt=48,pe="equipment",go="",St=[];function Oi(){te=25e7,jt="equipment",vt=48,pe="equipment",go="",document.getElementById("lr-overlay").style.display="flex",Qs(),kt()}function Pi(){document.getElementById("lr-overlay").style.display="none"}function Gs(o){te=Math.max(1e6,Math.min(5e9,Number(o)||0)),kt()}function Vs(o){jt=o,kt()}function Ws(o){vt=o,kt()}function Ys(o){pe=o,kt()}async function Qs(){if(!d)return;const{data:o}=await v.from("factions").select("id, faction_name, abbreviation, corp_ticker, corp_company_type").eq("faction_type","corporation").eq("corp_sector","Finance").is("abandoned_at",null).neq("id",d.id);St=o||[],kt()}function kt(){const o=document.getElementById("lr-modal-content");if(!o)return;const e=Number(d?.corp_cash_reserves??0),t=Number(d?.corp_loans??0),i=Number(d?.corp_reputation??50),n=d?.faction_name||"Corporation",a=(d?.abbreviation||d?.corp_ticker||"??").toUpperCase(),s=t+te,r=s>e*3?"#c55":s>e*1.5?"#c84":s>e?"#ca5":"#5c5",c=s>e*3?"DANGEROUS":s>e*1.5?"HEAVY":s>e?"MODERATE":"HEALTHY",p=pe==="none"?"10-16%":pe==="equipment"?"7-12%":pe==="property"?"5-9%":"4-7%",l=Math.round(te*(pe==="none"?.13:pe==="equipment"?.095:pe==="property"?.07:.055)/12+te/vt),m=Jo.find(y=>y.id===pe)||Jo[0];let u="";u+=`<div style="padding:10px 16px;border-bottom:1px solid #2a2a24;background:#1c1c18;flex-shrink:0;">
    ...
    <div style="display:flex;gap:0;border-bottom:1px solid #2a2a24;">
        ...
        <div style="display:flex;flex-direction:column;gap:3px;">`;for(const y of Bi){const x=jt===y.id;u+=`<div onclick="lrSetPurpose('${y.id}')" style="display:flex;align-items:center;gap:8px;padding:5px 10px;cursor:pointer;background:${x?"rgba(90,138,170,0.06)":"transparent"};border:1px solid ${x?"#5a8aaa44":"#2a2a24"};border-left:2px solid ${x?"#5a8aaa":"transparent"};">
        ...
        <div style="font-family:var(--font-mono);font-size:8px;letter-spacing:1.5px;color:#6a6660;text-transform:uppercase;margin-bottom:6px;">This request will be sent to</div>`,St.length>0){u+='<div style="display:flex;flex-direction:column;gap:3px;">';for(const y of St){const x=(y.corp_company_type||"").toLowerCase()==="state"?"#c84":(y.corp_company_type||"").toLowerCase()==="public"?"#5c5":"#c8a832";u+=`<div style="display:flex;align-items:center;gap:6px;padding:4px 8px;background:#1c1c18;border:1px solid #2a2a24;">
        ...
        <div style="display:flex;gap:12px;">
            ...
            <div><div style="font-family:var(--font-mono);font-size:7px;color:#6a6660;letter-spacing:0.8px;">SENT TO</div><div style="font-family:var(--font-mono);font-size:12px;font-weight:700;color:#9e9a92;">${St.length} lender${St.length!==1?"s":""}</div></div>
        </div>
        <div style="display:flex;gap:6px;">
        ...
        </div>`);for(let s=0;s<i.length;s++){const r=i[s],c=Ce===s,p=ut(r.skill);a+=`<div onclick="esSelectCandidate(${s})" style="
            padding:10px 14px;
            border-bottom:1px solid #2a2a24;
    ...
    <div style="width:570px;background:${e.surface};border:1px solid ${e.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;max-height:90vh;">
        ...
        <div style="padding:14px 20px;overflow:auto;flex:1;">
            ...
            <div style="margin-bottom:14px;">
                ...
                ${N.type==="Regional HQ"?`<div style="margin-top:8px;">
                    ...
                    <select id="cp-nation-select" onchange="cpSetField('nationId', this.value); cpSetField('nationName', this.options[this.selectedIndex].text)"
                        ...
                        ${_n.map(p=>`<option value="${p.id}" ${N.nationId===p.id?"selected":""}>${p.name}</option>`).join("")}
                    </select>
            ...
            <div style="margin-bottom:14px;">
                ...
                <div style="margin-top:5px;font-family:${o};font-size:10px;color:${gt[N.style].color}">${gt[N.style].desc}</div>
            </div>
            ...
            <div style="padding:8px 10px;background:rgba(139,154,107,0.04);border:1px solid rgba(139,154,107,0.12);">
                ...
                <div style="font-family:${o};font-size:9px;color:${e.dim};margin-top:3px">${N.style} style · ${n===5?"Maximum prestige":n>=4?"Impressive presence":n>=3?"Strong statement":n>=2?"Solid investment":"Functional addition"}</div>
            </div>
...
Parent: `+_(i)+" → "+_(p)+`
Subsidiary: `+_(n)+" → "+_(f))){ae=!0;try{await Promise.all([v.from("factions").update({corp_cash_reserves:p}).eq("id",d.id),v.from("corp_properties").update({sub_cash:f}).eq("id",o)]),d.corp_cash_reserves=p,t.sub_cash=f,Xe(p),Qt(),alert((e?"Withdrew ":"Injected ")+_(c)+(e?" from ":" into ")+t.name+".")}catch(l){alert("Failed: "+l.message)}finally{ae=!1}}}function zr(o){Zi(o,!1)}function Sr(o){Zi(o,!0)}async function Tr(o){if(ae)return;const e=V.find(x=>x.id===o);if(!e)return;const t=Ki(e);t.nation;const i=No(e.nation_id),n=t.valuation,a=t.cash,s=t.reputation,r=t.subsector,c=Math.round(n*2.25),p=Math.round(s*.1),f=Math.round(s*.2),l=So(),m=Ye.reduce((x,g)=>x+Number(d?.[g.factionKey]??0),0),u=Math.max(0,l-m),y=Number(d?.corp_cash_reserves??0);if(c>y){alert(`Insufficient cash to acquire subsidiary.
...
Properties: `+i.length+" transferred to parent")}catch(x){alert("Merge failed: "+x.message)}finally{ae=!1}}}window.subDissolve=Cr;window.subInjectCapital=zr;window.subWithdraw=Sr;window.subMerge=Tr;window.subSell=_r;window.subPutForSale=hr;window.subPlaceBid=$r;window.subViewBids=wr;window.subCancelSale=Er;window.selectSubsidiary=function(o){ct=o,Qt()};let Et=[],Nt={},ue=null,tn=!1,Ze="",Ft="",et="",Ae="";const ea={Construction:4,Finance:5,Shipping:4},Ir=["Construction","Shipping","Finance"],ta={Construction:[{id:"civil",name:"Civil Engineering",mod:0},{id:"industrial",name:"Industrial Construction",mod:.25},{id:"mega",name:"Megaprojects",mod:.4}],Shipping:[{id:"bulk_cargo",name:"Bulk Cargo",mod:0},{id:"container_freight",name:"Container Freight",mod:.2},{id:"specialized_transport",name:"Specialized Transport",mod:.35}],Finance:[{id:"banking",name:"Banking",mod:0},{id:"insurance",name:"Insurance",mod:.15},{id:"investment",name:"Investment Management",mod:.3}],Technology:[{id:"software",name:"Software Development",mod:0},{id:"hardware",name:"Hardware Manufacturing",mod:.2},{id:"telecom",name:"Telecommunications",mod:.35}],Energy:[{id:"oil_gas",name:"Oil & Gas",mod:0},{id:"renewables",name:"Renewables",mod:.2},{id:"mining",name:"Mining",mod:.3}],Healthcare:[{id:"pharma",name:"Pharmaceuticals",mod:0},{id:"hospitals",name:"Hospital Systems",mod:.2},{id:"biotech",name:"Biotechnology",mod:.35}]};async function Ar(){const{data:o,error:e}=await v.from("nations").select("*").order("name");e&&console.warn("[Subsidiary] Failed to load nations:",e.message),Et=(o||[]).filter(i=>i.id!==d?.nation_id);const{data:t}=await v.from("factions").select("nation_id").eq("faction_type","corporation").is("abandoned_at",null);Nt={};for(const i of t||[])i.nation_id&&(Nt[i.nation_id]=(Nt[i.nation_id]||0)+1);et=d?.corp_sector||"",Ae=d?.corp_subsector||""}function oa(){const o=et||d?.corp_sector||"";return ta[o]||[{id:"general",name:o||"General",mod:0}]}function Mr(o){et=o;const e=ta[o];Ae=e?e[0].name:"",Kt()}function na(){const o=d?.corp_sector||"";return et===o?1:ea[et]||4}function Nr(){const e=oa().find(t=>t.name===Ae);return e?e.mod:0}function hn(o){const e=Number(o.standard_of_living??50);return Math.max(.5,Math.round(e/50*100)/100)}function ia(o){const t=na(),i=1+Nr(),n=hn(o);return Math.round(Math.max(1e7,5e7*t*i*n))}function Rr(o){const e=Nt[o]||0;return e<=1?{label:"HIGH",color:"#5c5"}:e<=3?{label:"MODERATE",color:"#ca5"}:{label:"LOW",color:"#c55"}}function Lr(o){if(ue=ue===o?null:o,ue){const e=Et.find(t=>t.id===ue);Ze=(d?.faction_name||"Subsidiary")+" "+(e?.name||"")}else Ze="";Kt()}function qr(o){Ae=o,Kt()}function Br(o){Ze=o}function Or(o){Ft=o.toUpperCase().slice(0,4)}async function Pr(){if(tn||!ue)return;const o=Et.find(s=>s.id===ue);if(!o)return;const e=(Ze||"").trim(),t=(Ft||"").trim();if(!e){alert("Please enter a corporation name for the subsidiary.");return}if(t.length<2){alert("Please enter an abbreviation (2-4 chars).");return}if(V.find(s=>s.nation_id===o.id&&s.type==="regional_hq")){alert("You already have a subsidiary in "+o.name);return}const n=ia(o),a=Number(d?.corp_cash_reserves??0);if(n>a){alert("Insufficient cash. Entry cost: "+_(n)+", available: "+_(a));return}if(confirm("Establish subsidiary in "+o.name+`?
...
Deducted from cash reserves.`)){tn=!0;try{const r=(await v.from("shard").select("current_tick").eq("name","Alpha Shard").single()).data?.current_tick||0,c=85+Math.floor(Math.random()*16),p=Math.round(n*.005),{error:f}=await v.from("corp_properties").insert({faction_id:d.id,nation_id:o.id,name:e,type:"regional_hq",style:"Modern",capacity:500,purchase_price:n,monthly_maintenance:p,condition:c,city:o.capital||o.name,purchased_at_tick:r,is_active:!0,subsector:Ae||d?.corp_subsector||null});if(f)throw f;const l=Math.max(0,a-n);await v.from("factions").update({corp_cash_reserves:l}).eq("id",d.id),d.corp_cash_reserves=l,Xe(l);const m=et||d?.corp_sector||"Unknown";try{await v.from("event_log").insert({nation_id:o.id,event_name:"New Subsidiary Established",category:"corporate",description_chosen:`${d.faction_name} has invested ${_(n)} to establish ${e}, a new ${m} corporation in ${o.name}.`,fired_at_tick:S?.current_tick||0})}catch{}try{const{data:u}=await v.from("nations").select("gdp_growth").eq("id",o.id).single();u&&await v.from("nations").update({gdp_growth:Math.min(100,Number(u.gdp_growth||50)+.2)}).eq("id",o.id)}catch{}ue=null,Ze="",Ft="",await Yt(),alert('Subsidiary "'+e+'" established in '+o.name+`!

Cost: `+_(n)+`
Regional HQ created with `+c+"% condition.")}catch(s){alert("Failed: "+s.message)}finally{tn=!1}}}function Kt(){const o=document.getElementById("create-subsidiary-container");if(!o)return;const e="'JetBrains Mono', monospace",t={bg:"#121210",surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",accentBright:"#a3b07e",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",yellow:"#ca5",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},i=d?.corp_sector||"General",n=d?.corp_subsector||"",a=oa(),s=a.find(E=>E.name===Ae)||a[0],r=new Set(V.filter(E=>E.type==="regional_hq").map(E=>E.nation_id)),c=Et.filter(E=>!r.has(E.id)),p=ue?c.find(E=>E.id===ue):null,f=Ze.trim().length>0&&Ft.trim().length>=2&&p!==null,l=et||i,m=na();let u=`
    <div style="padding:6px 14px;border-bottom:1px solid ${t.border};">
        ...
        <div style="display:flex;gap:3px;">
            ${Ir.map(E=>{const R=E===l,M=E===i,B=M?1:ea[E]||4,F=M?t.greenBright:t.orange;return`<div onclick="subSetSector('${E}')" style="flex:1;padding:5px 4px;text-align:center;cursor:pointer;background:${R?t.accent+"18":"transparent"};border:1px solid ${R?t.accent+"44":t.border};">
                    <div style="font-family:${e};font-size:9px;font-weight:700;color:${R?t.accentBright:t.dim}">${E}</div>
                    <div style="font-family:${e};font-size:7px;margin-top:2px;color:${F}">${M?"PARENT · ×1":"×"+B+" COST"}</div>
                </div>`}).join("")}
        </div>
    ...
    <div style="padding:6px 14px;border-bottom:1px solid ${t.border};">
        ...
        <div style="display:flex;gap:3px;">
            ${a.map(E=>{const R=E.name===Ae,M=E.name===n;return`<div onclick="subSetSubsector('${E.name.replace(/'/g,"\\'")}')" style="flex:1;padding:5px 4px;text-align:center;cursor:pointer;background:${R?t.accent+"18":"transparent"};border:1px solid ${R?t.accent+"44":t.border};">
    ...
    </div>`,x="";if(c.length===0)x=`<div style="padding:20px;text-align:center;font-family:${e};font-size:10px;color:${t.dim}">Subsidiaries in all available nations.</div>`;else for(const E of c){const R=E.id===ue,M=Rr(E.id),B=Nt[E.id]||0,F=Math.round(Number(E.standard_of_living??50)),j=hn(E);x+=`
    ...
    <div style="padding:6px 16px;border-bottom:1px solid ${t.border};background:${t.card};display:flex;gap:12px;align-items:center;flex-shrink:0;">
        <div style="display:flex;gap:3px;align-items:center;">
            ...
            ${n.map(u=>`<span onclick="corpFilterNation('${u}')" style="padding:3px 8px;font-family:${e};font-size:8px;font-weight:700;cursor:pointer;color:${be===u?"#000":t.dim};background:${be===u?t.accent:"transparent"};border:1px solid ${be===u?t.accent:t.border}">${u}</span>`).join("")}
        </div>
        <div style="flex:1"></div>
        <div style="display:flex;gap:3px;align-items:center;">
            <span style="font-family:${e};font-size:8px;color:${t.dim};letter-spacing:0.8px">SORT</span>
            ${["REPUTATION","REVENUE","VALUATION"].map(u=>`<span onclick="corpSort('${u}')" style="padding:3px 8px;font-family:${e};font-size:8px;font-weight:700;cursor:pointer;color:${Oe===u?"#000":t.dim};background:${Oe===u?t.accent:"transparent"};border:1px solid ${Oe===u?t.accent:t.border}">${u}</span>`).join("")}
        </div>
    </div>`;o.innerHTML=`
    <div style="width:760px;height:450px;background:${t.surface};border:1px solid ${t.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        <div style="padding:8px 14px;border-bottom:1px solid ${t.border};display:flex;justify-content:space-between;align-items:center;flex-shrink:0;">
    ...
    </div>`}window.corpSelect=jr;window.corpInvestigate=Hr;window.corpFilterNation=Fr;window.corpSort=Ur;let $e=null,Te={},Q=120,Ie=15,$n={},pt=[];async function Gr(){if(!We)return;if(bt[We.id]){alert("You already have a bid on this contract. Retract it first if you want to re-bid.");return}$e=We,$n={};try{const{data:t}=await v.from("corp_material_inventory").select("material_key, quantity").eq("faction_id",d.id);for(const i of t||[])$n[lo(i.material_key)]=Number(i.quantity||0)}catch{}pt=[];try{const{data:t}=await v.from("contract_bids").select("faction_id, bid_price, estimated_quality, status, factions(faction_name, corp_ticker)").eq("contract_id",$e.id).in("status",["pending","won"]);pt=(t||[]).filter(i=>i.faction_id!==d?.id).map(i=>({name:i.factions?.faction_name||"Unknown",ticker:i.factions?.corp_ticker||"???",price:Number(i.bid_price||0),quality:Number(i.estimated_quality||0),status:i.status}))}catch{}Te={};const o=$e.required_materials||{};for(const t of Object.keys(o))Te[t]="STD";const e=$e.required_workforce||{};Q=Number(e.general||0)+Number(e.skilled||0)||120,Ie=15,Vt(),qo()}function Vn(){document.getElementById("bid-assembly-overlay")?.remove(),$e=null}function Vr(o,e){Te[o]=e,qo()}function Wr(o){Q=o,qo()}function Yr(o){Ie=o,qo()}function qo(){if(document.getElementById("bid-assembly-overlay")?.remove(),!$e)return;const o="'JetBrains Mono', monospace",e={surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",accentBright:"#a3b07e",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",redDim:"#a44",yellow:"#ca5",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},t=$e,i=t.issuer_type==="GOVERNMENT",n=z?.name||d?.nation||"—",a=Number(t.budget_ceiling||0),s=Number(t.timeline_ticks||8),r=t.required_materials||{},c=Object.keys(r),p={LOW:.5,STD:1,HIGH:2},f={LOW:e.orange,STD:e.yellow,HIGH:e.greenBright},l={LOW:"Low",STD:"Standard",HIGH:"High"},m={concrete:36e4,steel:5e5,glass_facades:56e4,em_systems:64e4,lumber:24e4,heavy_parts:8e5,aggregate:16e4,asphalt:28e4},u=$n||{};let y=0,x="";for(const D of c){const Y=Number(r[D]||0),Jn=Te[D]||"STD",Xn=m[D]||3e5,ma=p[Jn],ua=Math.round(Xn*ma),Zn=Y*ua;y+=Zn;const ya=D.replace(/_/g," ").replace(/\b\w/g,Re=>Re.toUpperCase()),ei=Number(u[D]||0),Do=Math.max(0,Y-ei),va=Do===0?e.greenBright:Do<Y?e.yellow:e.red,ga=Do===0?"✓ IN STOCK":`${ei}/${Y}`;x+=`
        ...
        </div>`}const g=t.required_workforce||{},$=Number(g.general||0)+Number(g.skilled||0)||100,h=Math.max(40,Math.round($*.5)),k=$*2,I=[h,Math.round($*.75),$,Math.round($*1.5),k],T=Math.max(0,Math.min(1,(Q-h)/(k-h||1))),w=s,C=Math.round(4.5-T*8),L=Math.max(Math.round(w*.6),w+C),E=C>0?`+${C}mo`:C<0?`${C}mo`:"On schedule",R=C>0?e.red:C<0?e.greenBright:e.yellow,M=15200,B=Q*M*L,F=a,X=[{name:"Municipal Zoning Approval",cost:18e4,ticks:2,required:!0},{name:"Structural Engineering Cert.",cost:24e4,ticks:3,required:!0},{name:"Environmental Impact Assessment",cost:34e4,ticks:8,required:F>2e7},{name:"Seismic Resilience Compliance",cost:21e4,ticks:4,required:F>5e7},{name:"Heritage Conservation Review",cost:16e4,ticks:6,required:!1},{name:"Fire Safety Certification",cost:12e4,ticks:2,required:F>1e7}].filter(D=>D.required),A=new Set(["Municipal Zoning Approval","Structural Engineering Cert."]),P=X.filter(D=>!A.has(D.name)).reduce((D,Y)=>D+Y.cost,0),U=4e5,W=y+B+P+U,se=Math.round(W*(Ie/100)),ge=W+se,H=ge>a,Oo=se,Ne=H?0:Math.max(0,Math.min(100,Math.round(100-ge/a*100+30))),Kn=Ne>70?e.greenBright:Ne>40?e.yellow:Ne>0?e.orange:e.red,pa=H?"OVER CEILING":Ne>70?"STRONG":Ne>40?"COMPETITIVE":Ne>20?"WEAK":"UNLIKELY",Po=Object.values(Te),xe=Po.length>0?Math.round(Po.reduce((D,Y)=>D+(Y==="HIGH"?85:Y==="STD"?65:45),0)/Po.length):50,Xt=xe>=75?e.greenBright:xe>=50?e.yellow:xe>=25?e.orange:e.red,fa=xe>=75?"EXCELLENT":xe>=50?"FAIR":xe>=25?"POOR":"BAD",ot=document.createElement("div");ot.id="bid-assembly-overlay",ot.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.7);display:flex;align-items:center;justify-content:center;z-index:9999;",ot.addEventListener("click",D=>{D.target===ot&&Vn()}),ot.innerHTML=`
    <div style="width:740px;max-height:94vh;background:${e.surface};border:1px solid ${e.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        ...
        <div style="flex:1;display:flex;overflow:hidden;">
            ...
            <div style="flex:1;border-right:1px solid ${e.border};overflow:auto;">
                ...
                ${X.map(D=>{const Y=A.has(D.name);return`<div style="display:flex;align-items:center;padding:4px 14px;border-bottom:1px solid ${e.border};">
            ...
            <div style="width:280px;display:flex;flex-direction:column;overflow:auto;">
                ...
                ${[{l:"Materials",v:y},{l:"Labor",v:B},{l:"Permits",v:P},{l:"Overhead",v:U}].map(D=>`<div style="display:flex;justify-content:space-between;padding:4px 14px;border-bottom:1px solid ${e.border};">
                ...
                <div style="padding:8px 14px;border-bottom:1px solid ${e.border};">
                    <div style="display:flex;justify-content:space-between;">
                        ...
                        <span style="font-family:${o};font-size:14px;font-weight:700;color:${Oo>0?e.greenBright:e.dim}">+${_(Oo)}</span>
                    </div>
                </div>
                ...
                <div style="padding:8px 14px;border-bottom:1px solid ${e.border};">
                    ...
                    <div style="width:100%;height:4px;background:${e.border}"><div style="width:${Ne}%;height:100%;background:${Kn}"></div></div>
                </div>
                <div style="padding:8px 14px;border-bottom:1px solid ${e.border};">
                    <div style="display:flex;justify-content:space-between;margin-bottom:4px;">
                        <span style="font-family:${o};font-size:8px;color:${e.dim}">QUALITY ESTIMATE</span>
                        <div style="display:flex;align-items:baseline;gap:4px;">
                            <span style="font-family:${o};font-size:11px;font-weight:700;color:${Xt}">${xe}</span>
                    ...
                    <div style="width:100%;height:4px;background:${e.border}"><div style="width:${xe}%;height:100%;background:${Xt}"></div></div>
        ...
        <div style="padding:10px 16px;border-top:1px solid ${e.border};background:${e.card};display:flex;justify-content:space-between;align-items:center;flex-shrink:0;">
            <div style="display:flex;gap:12px;">
                ...
                <div><div style="font-family:${o};font-size:7px;color:${e.dim}">EST. PROFIT</div><div style="font-family:${o};font-size:14px;font-weight:700;color:${e.greenBright}">+${_(Oo)}</div></div>
                <div><div style="font-family:${o};font-size:7px;color:${e.dim}">QUALITY</div><div style="font-family:${o};font-size:14px;font-weight:700;color:${Xt}">${xe}</div></div>
            </div>
            <div style="display:flex;gap:8px;">
    ...
    </div>`,document.body.appendChild(ot)}let on=!1;async function Qr(){if(on||!$e)return;const o=$e,e=o.required_materials||{},t=Object.keys(e),i=Number(o.budget_ceiling||0),n=Number(o.timeline_ticks||8),a={concrete:36e4,steel:5e5,glass_facades:56e4,em_systems:64e4,lumber:24e4,heavy_parts:8e5,aggregate:16e4,asphalt:28e4},s={LOW:.5,STD:1,HIGH:2};let r=0;for(const M of t){const B=Number(e[M]||0),F=Te[M]||"STD",j=a[M]||3e5;r+=B*Math.round(j*s[F])}const c=15200,p=o.required_workforce||{},f=Number(p.general||0)+Number(p.skilled||0)||100,l=Math.max(40,Math.round(f*.5)),m=f*2,u=Math.max(0,Math.min(1,(Q-l)/(m-l||1))),y=Math.round(4.5-u*8),x=Math.max(Math.round(n*.6),n+y),g=Q*c*x,$=i,h=[{name:"Municipal Zoning Approval",cost:18e4,required:!0},{name:"Structural Engineering Cert.",cost:24e4,required:!0},{name:"Environmental Impact Assessment",cost:34e4,required:$>2e7},{name:"Seismic Resilience Compliance",cost:21e4,required:$>5e7},{name:"Fire Safety Certification",cost:12e4,required:$>1e7}],k=new Set(["Municipal Zoning Approval","Structural Engineering Cert."]),I=h.filter(M=>M.required&&!k.has(M.name)).reduce((M,B)=>M+B.cost,0),w=r+g+I+4e5,C=Math.round(w*(Ie/100)),L=w+C;if(L>i){alert("Bid exceeds budget ceiling. Reduce costs or markup.");return}const E=Object.values(Te),R=E.length>0?Math.round(E.reduce((M,B)=>M+(B==="HIGH"?85:B==="STD"?65:45),0)/E.length):50;if(confirm('Submit bid for "'+o.name+`"?
...
Once submitted, your bid cannot be changed.`)){on=!0;try{const{data:M}=await v.from("shard").select("current_tick").eq("name","Alpha Shard").single(),B=M?.current_tick||0,F={};for(const X of t)F[X]=Te[X]||"STD";const{error:j}=await v.from("contract_bids").insert({contract_id:o.id,faction_id:d.id,bid_price:L,material_grades:F,labor_count:Q,markup_pct:Ie,estimated_cost:w,estimated_quality:R,status:"pending",submitted_at_tick:B});if(j)throw j;o.status==="open"&&await v.from("construction_contracts").update({status:"bidding"}).eq("id",o.id).eq("status","open"),Vn(),alert(`Bid submitted successfully!
...
No bids will be accepted. The contract will be removed.`)){rn=!0;try{const{error:o}=await v.from("contract_bids").update({status:"lost"}).eq("contract_id",ye.id);if(o)throw o;const{error:e}=await v.from("construction_contracts").update({status:"expired"}).eq("id",ye.id);if(e)throw e;Bo(),alert("All bids declined. Contract cancelled."),typeof Je=="function"&&await Je()}catch(o){alert("Failed: "+(o.message||o))}finally{rn=!1}}}function aa(){if(document.getElementById("bid-review-overlay")?.remove(),!ye||Ut.length===0)return;const o="'JetBrains Mono', monospace",e={surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",accentBright:"#a3b07e",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",yellow:"#ca5",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},t=ye,i=Ut;He>=i.length&&(He=0);const n=i[He],a=Number(t.budget_ceiling||0),s=Number(t.timeline_ticks||36),r=Math.min(...i.map(u=>u.bid_price)),c=Math.max(...i.map(u=>u.estimated_quality||0));let p="";for(let u=0;u<i.length;u++){const y=i[u],x=u===He,g=y.bid_price===r,$=(y.estimated_quality||0)===c,h=y.bid_price>a;p+=`
    ...
    <div style="width:640px;max-height:92vh;background:${e.surface};border:1px solid ${e.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        ...
        <div style="font-family:var(--font-mono);font-size:12px;font-weight:700;color:${l.color};margin-top:1px;">${l.value}</div>
    </div>`).join(""),n.length===0?t.innerHTML='<div style="flex:1;display:flex;align-items:center;justify-content:center;font-family:var(--font-mono);font-size:9px;color:var(--text-dim);text-align:center;line-height:1.8;">No vessels in fleet.<br>Purchase ships to begin operations.</div>':t.innerHTML=n.map((l,m)=>{const u=Dt===m,y=$t[l.vessel_class]||{color:"#666",label:"?"},x=tl[l.status]||{color:"#666",label:"?"},g=sa(l.condition),$=ol(l.fuel),h=l.condition<50||l.fuel<20,k=l.status==="in_transit",I=l.status==="dry_dock",T=S?.current_tick||0,w=Math.max(0,Math.floor((T-(l.built_at_tick||0))/12));let C=`<div onclick="flSelectVessel(${m})" style="border-bottom:1px solid var(--border-0);cursor:pointer;border-left:2px solid ${h?l.condition<50?g:$:"transparent"};background:${u?y.color+"06":"transparent"};">
                ...
                <div style="flex:1;padding:3px 6px;text-align:right;">
                    ...
                    </div>`;C+="</div>";const R=k||I,M=Math.round((l.purchase_price||3e6)*.08*(1+(100-l.condition)/100)),B=Math.round((l.fuel_capacity||1e3)*50*(1-l.fuel/100)),F=Math.round((l.purchase_price||3e6)*(l.condition/100)*.6);if(C+=`<div style="display:flex;gap:4px;">
                    ...
                    <div onclick="${k?"":"flRefuel('"+l.id+"',"+B+")"}" style="flex:1;padding:5px 0;text-align:center;cursor:${k?"not-allowed":"pointer"};font-family:var(--font-mono);font-size:7px;font-weight:700;letter-spacing:0.5px;color:${k?"var(--text-dim)":"#c86a4a"};border:1px solid ${k?"var(--border-0)":"rgba(200,106,74,0.3)"};opacity:${k?.35:1};">REFUEL<br><span style="font-weight:400;font-size:6px;">from ${_(B)}</span></div>
...
The insurer (`+_(a)+" coverage) has been notified. Claim details are visible in the events feed.")}window.flRequestInsurance=ll;window.flFileClaim=dl;const wn={fuel_depot:{label:"FUEL DEPOT",color:"#c86a4a",icon:"⛽",desc:"Bunkering facility — refuel at base cost, earn revenue from visiting fleets."},dry_dock:{label:"DRY DOCK",color:"#c84",icon:"🔧",desc:"Repair & maintenance dock — dock at base cost, earn revenue from visiting fleets."}},cl=[{type:"fuel_depot",name:"Fuel Depot — Standard",cost:105e6,maint:85e3,style:"Basic",desc:"Bulk fuel storage and bunkering facility."},{type:"fuel_depot",name:"Fuel Depot — Advanced",cost:14e7,maint:11e4,style:"Modern",desc:"High-capacity fuel terminal with pipeline infrastructure."},{type:"dry_dock",name:"Dry Dock — Standard",cost:85e6,maint:15e4,style:"Basic",desc:"Ship repair and maintenance facility."},{type:"dry_dock",name:"Dry Dock — Advanced",cost:115e6,maint:2e5,style:"Modern",desc:"Full-service shipyard with drydock and crane facilities."}];let ho=[];async function la(){if(!d)return;const{data:o}=await v.from("corp_properties").select("*").eq("faction_id",d.id).in("type",["fuel_depot","dry_dock"]).eq("is_active",!0).order("created_at",{ascending:!1});ho=o||[],pl()}function pl(){const o=document.getElementById("pf-count"),e=document.getElementById("pf-list"),t=document.getElementById("pf-footer");if(!o||!e||!t)return;const i=ho;if(o.textContent=i.length+" FACILIT"+(i.length===1?"Y":"IES"),i.length===0)e.innerHTML=`<div style="padding:20px;text-align:center;">
        ...
        </div>`}let dn=!1;async function fl(o){if(dn||!d||!S)return;const e=cl.filter(g=>g.type===o);if(e.length===0)return;const t=wn[o],i=d.nation_id,n=z?.name||d?.nation||"Home Nation",a=z?.capital||"Port City",s=[{id:i,name:n,capital:a,label:"National HQ"}],{data:r}=await v.from("corp_properties").select("nation_id, name, city, nations!nation_id(name, capital)").eq("faction_id",d.id).eq("type","regional_hq").eq("is_active",!0);for(const g of r||[])g.nation_id!==i&&s.push({id:g.nation_id,name:g.nations?.name||g.city||"Unknown",capital:g.nations?.capital||g.city||"Port City",label:g.name||"Subsidiary"});let c=s[0];if(s.length>1){let g=t.label+` — SELECT LOCATION
`+"─".repeat(30)+`
...
This will create a construction contract that construction corporations can bid on. Payment occurs when the contract is awarded.`))return;dn=!0;const y=S.current_tick||0,x=(S.current_date||"").match(/\d{4}/)?.[0]||"2015";try{const{count:g}=await v.from("construction_contracts").select("id",{count:"exact",head:!0}).eq("nation_id",c.id).eq("issuer_type","PRIVATE"),h=`PVT-P${(g||0)+1}-${x}`,k=u.style==="Modern",I={concrete:k?60:40,steel:k?50:30,heavy_parts:k?30:20,aggregate:k?30:20},T={trucks:5,mixers:5,excavators:5},w={general:k?240:160,skilled:k?100:60},C=k?6:4,{error:L}=await v.from("construction_contracts").insert({nation_id:c.id,template_key:o,sector:"industrial",name:u.name,project_type:t.label,project_subtype:u.style,description:`${u.name} at ${c.capital} Port — commissioned by ${d.faction_name}. ${u.desc}`,project_code:h,budget_ceiling:u.cost,timeline_ticks:C,required_materials:I,required_equipment:T,required_workforce:w,status:"open",generated_at_tick:y,bidding_ends_tick:y+3,issuer_type:"PRIVATE",issuer_name:d.faction_name,issuer_faction_id:d.id});if(L)throw L;await la(),alert(`Construction contract posted!
