import{_ as m}from"./supabase-client-BXEzLDpS.js";import{c as G,e as g}from"./utils-C2W-HleY.js";const H={Melizea:"assets/flags/Melizea.png",Avelia:"assets/flags/Avelia1.png",Sangreza:"assets/flags/sangreza.png",Montequilla:"assets/flags/Montequilla.png","San Estrella":"assets/flags/sanestrella.png",Palvera:"assets/flags/Palvera.png",Calveth:"assets/flags/Calveth.png",Flandis:"assets/flags/Flandis.png"},f=["#5b9bd5","#d48a3c","#5aafa5","#8b7ec8","#5cb85c","#d9534f","#c8a64e"],Y={Liberty:"#3b82f6",Equality:"#ef4444",Tradition:"#a855f7",Progress:"#22c55e",Security:"#f59e0b",Freedom:"#06b6d4",Globalism:"#14b8a6",Nationalism:"#f97316",Individualism:"#eab308",Collectivism:"#ec4899"};let B=null,C=[],v=null,P="Crucera",y={},u={},I={};const N=new Set;async function J(){try{const{data:{user:e}}=await m.auth.getUser();if(!e){window.location.href="login.html";return}if(B=e,sessionStorage.getItem("pending_faction_type")==="corp"){window.location.href="corp-setup.html";return}const t=sessionStorage.getItem("pending_faction_type")==="party",{data:n}=await m.from("factions").select("id, nation_id, faction_type").eq("id",e.id).maybeSingle();if(n&&n.nation_id&&!(t&&n.faction_type==="corporation")){window.location.href="dashboard.html";return}await V(),document.getElementById("loading").style.display="none";const i=document.getElementById("page-content");i.style.display="flex"}catch(e){document.getElementById("loading").textContent="FAILED TO LOAD — PLEASE REFRESH";const t=document.getElementById("error-message");t&&(t.textContent=e.message||"Unknown error",t.style.display="block")}}function K(e){P=e,document.querySelectorAll(".continent-tab").forEach(t=>{t.classList.toggle("active",t.dataset.continent===e)}),O(C,y,u,I)}async function V(){const[e,t,n,i]=await Promise.all([m.from("nations").select("*, nation_profiles(flag_url)"),m.from("factions").select("id, faction_type, faction_name, abbreviation, seats, nation_id, party_color, ideology_value_1, ideology_value_2").eq("faction_type","party"),m.from("active_crises").select("nation_id, crisis_id, crisis_templates(name)"),m.from("faction_ideology").select("faction_id, liberty_equality, tradition_progress, security_freedom, globalism_nationalism, individualism_collectivism")]),r=e.data||[],l=t.data||[],s=n.data||[],c=i.data||[];y={},u={},I={};for(const o of l)y[o.nation_id]||(y[o.nation_id]=[]),y[o.nation_id].push(o);for(const o of s)u[o.nation_id]||(u[o.nation_id]=[]),u[o.nation_id].push(o);for(const o of c)I[o.faction_id]=o;C=r,O(r,y,u,I)}function T(e){return e==="Presidential"||e==="Semi-Presidential"?"gov-presidential":"gov-democracy"}function k(e){const t=typeof e=="string"?e:e?.government_type,n=typeof e=="object"?e?.hos_election_method:null;return t==="Presidential"?"PRESIDENTIAL":t==="Semi-Presidential"?"SEMI-PRESIDENTIAL":n==="hereditary"?"CONSTITUTIONAL MONARCHY":"PARLIAMENTARY"}function Q(e){if(!e)return"";const t=[{key:"liberty_equality",neg:"Liberty",pos:"Equality"},{key:"tradition_progress",neg:"Tradition",pos:"Progress"},{key:"security_freedom",neg:"Security",pos:"Freedom"},{key:"globalism_nationalism",neg:"Globalism",pos:"Nationalism"},{key:"individualism_collectivism",neg:"Individualism",pos:"Collectivism"}],n=[];for(const i of t){const r=e[i.key]||0;Math.abs(r)>=20&&n.push(r<0?i.neg:i.pos)}return n.slice(0,2).join(", ")}function W(e){return e?e.split(", ").map(t=>{const n=Y[t];return n?`<span style="color:${n}">${g(t)}</span>`:g(t)}).join('<span style="color:var(--text-dim)">, </span>'):""}function O(e,t,n,i){const r=document.getElementById("nations-grid"),l=e.filter(s=>(s.continent||"Crucera")===P);if(l.length===0){r.innerHTML='<div style="font-family:var(--font-mono);font-size:10px;color:var(--text-dim);text-align:center;padding:40px 0;grid-column:1/-1;">No nations in this continent yet.</div>';return}r.innerHTML=l.map(s=>{const c=t[s.id]||[],o=n[s.id]||[],p=s.total_seats||100,b=s.max_parties||8,$=G(c,s.id),h=$>=b,E=s.nation_profiles,x=(Array.isArray(E)?E[0]?.flag_url:E?.flag_url)||s.flag_url||H[s.name]||`assets/flags/${s.name}.png`,R=T(s.government_type),F=k(s),U=N.has(s.id),S=[...c].sort((a,d)=>(d.seats||0)-(a.seats||0)),M=c.reduce((a,d)=>a+(d.seats||0),0),q=S.filter(a=>a.seats>0).map((a,d)=>{const w=(a.seats/p*100).toFixed(1),L=a.party_color||f[d%f.length];return`<div class="seat-bar__segment" style="width:${w}%;background:${L};" title="${g(a.faction_name)}: ${a.seats} seats"></div>`}).join(""),D=S.filter(a=>a.seats>0).map((a,d)=>`<span class="seat-legend-item"><span class="seat-legend-dot" style="background:${a.party_color||f[d%f.length]};"></span>${g(a.abbreviation||"?")} ${a.seats}</span>`).join(""),j=S.map((a,d)=>{const w=a.party_color||f[d%f.length],L=i[a.id],A=a.ideology_value_1&&a.ideology_value_2?`${a.ideology_value_1}, ${a.ideology_value_2}`:Q(L);return`
        <div class="party-row">
        ...
        <div class="nation-card__body">
          ...
          <div class="seat-bar">
            ...
            <div class="seat-bar__track">
              ${q}
              ${M<p?'<div class="seat-bar__empty"></div>':""}
            </div>
