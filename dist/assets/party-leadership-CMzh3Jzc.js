import{_supabase as f}from"./supabase-client-CiYoFhIh.js";/* empty css                  */import{i as J}from"./common-AI9RRvLI.js";import{e as y}from"./utils-oN1e812_.js";import{deductAP as U}from"./config-BdOpHGNJ.js";import{i as P,j as L,k as B,l as I,I as D,m as z,N as V,C as A,g as E,n as W}from"./political-actions-CWimzYIQ.js";import{f as H}from"./government-types-CNjNcIHN.js";import"./preload-helper-BXl3LOEh.js";import"./government-structure-DVzKGcwP.js";import"./factions-1eoRseVF.js";import"./corp-topbar-ClQJCe3f.js";import"./stats-CBT3qQox.js";let p=null,i=null,x=null,h={leader:[]},m={leader:null},C={leader:null},w=!1,$=null;J("politics",async t=>{const{nation:e,faction:a,shard:s}=t;if(p=e,i=a,x=s,!e||!a){document.getElementById("pl-container").innerHTML='<div style="padding:40px;text-align:center;color:var(--text-dim);font-family:var(--font-mono);font-size:10px;">No nation or party found.</div>';return}await Y(),await Q(),S()});async function Y(){if(i.leader_first_name&&i.leader_last_name&&(m.leader={firstName:i.leader_first_name,lastName:i.leader_last_name,age:i.leader_age||null,electability:i.electability??50,ideology:i.leader_ideology||null,positiveTraits:i.leader_positive_traits||[],negativeTraits:i.leader_negative_traits||[]},(!i.leader_positive_traits||i.leader_positive_traits.length===0)&&(!i.leader_negative_traits||i.leader_negative_traits.length===0))){const t=P(p?.name||"",E,1,"leader");if(t.length>0){const e=t[0];m.leader.positiveTraits=e.positiveTraits||[],m.leader.negativeTraits=e.negativeTraits||[],await f.from("factions").update({leader_positive_traits:m.leader.positiveTraits,leader_negative_traits:m.leader.negativeTraits}).eq("id",i.id),i.leader_positive_traits=m.leader.positiveTraits,i.leader_negative_traits=m.leader.negativeTraits,console.log("[PartyLeadership] Auto-backfilled traits for current leader:",m.leader.positiveTraits,m.leader.negativeTraits)}}}function O(){const t=m.leader;return t?{firstName:t.firstName,lastName:t.lastName,age:t.age||45,ideology:t.ideology||"PROGRESS",positiveTraits:t.positiveTraits||[],negativeTraits:t.negativeTraits||[],apCost:0,costBreakdown:{positiveTotal:0,negativeTotal:0,rawCost:0,apCost:0},isCurrent:!0,electability:t.electability??50}:null}async function j(t,e,a){const{error:s}=await f.from("leadership_candidates").upsert({faction_id:t,role:e,candidates:a,generated_at:new Date().toISOString()},{onConflict:"faction_id,role"});s&&console.warn(`Failed to persist ${e} candidates (non-blocking):`,s.message)}async function Q(){const t=p.name||"",e=i.id;let a=null;const s=`leadership_candidates_${e}_leader`,{data:d,error:n}=await f.from("leadership_candidates").select("candidates, last_refresh_tick").eq("faction_id",e).eq("role","leader").maybeSingle();if(!n&&d&&Array.isArray(d.candidates)&&d.candidates.length>0){a=d.candidates,$=d.last_refresh_tick;try{sessionStorage.setItem(s,JSON.stringify(a))}catch{}}else{try{const c=sessionStorage.getItem(s);if(c){const v=JSON.parse(c);Array.isArray(v)&&v.length>0&&(a=v)}}catch{}if(!a){a=P(t,E,3,"leader"),await j(e,"leader",a);try{sessionStorage.setItem(s,JSON.stringify(a))}catch{}}}h.leader=a;const o=O();o&&h.leader.unshift(o),C.leader=null}function S(){const t=document.getElementById("pl-container"),e=h.leader,a=C.leader,s=a!==null?e[a]:null;let d="",n="";if(s&&!s.isCurrent){const o=L(s.apCost),c=B(s.apCost);d=`<span class="pl-header-cost" style="color:${o}">${c}</span>`,n='<button class="pl-appoint-btn" onclick="window._appointLeader()">Appoint Party Leader</button>'}t.innerHTML=`
        <div class="pl-header">
    ...
    `}function X(t,e){return!t||t.length===0?'<div style="padding:20px;text-align:center;color:var(--text-dim);font-family:var(--font-mono);font-size:9px;">No candidates available.</div>':t.map((a,s)=>{const d=s===e,n=L(a.apCost),o=B(a.apCost),c=a.ideology||"",v=D[c]||"#888",_=c?c.charAt(0)+c.slice(1).toLowerCase():"Unknown",g=a.electability!=null?I(a.electability):null,u=a.isCurrent?'<span class="pl-current-pill">CURRENT</span>':"";return`
            <div class="pl-list-row ${d?"active":""}" onclick="window._selectCandidate(${s})">
                ...
                <div class="pl-list-meta">
                    <span class="pl-list-ideology">
                        <span class="pl-ideology-dot" style="background:${v}"></span>
                        <span style="color:${v}">${_}</span>
                    </span>
        ...
        <div class="pl-identity">
            ...
            <div class="pl-cost-box" style="background:${c};border:1px solid ${v}">
