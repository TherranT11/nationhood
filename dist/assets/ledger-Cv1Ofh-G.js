import{_supabase as A}from"./supabase-client-CiYoFhIh.js";/* empty css                  */import{i as M}from"./common-AI9RRvLI.js";import{c as H,a as B}from"./stats-Nd7eW9dF.js";import"./preload-helper-BXl3LOEh.js";import"./government-structure-DVzKGcwP.js";import"./government-types-CNjNcIHN.js";import"./factions-1eoRseVF.js";import"./corp-topbar-ClQJCe3f.js";import"./utils-oN1e812_.js";let L=null,u=[],C=null,k="fiscal",_="single",f=[],g="gdp_growth",$="fiscal",D="";function v(t){if(!t)return"";const n=document.createElement("div");return n.textContent=t,n.innerHTML}const G=new Set(["budget","debt"]),z=[{key:"fuel_energy",name:"Fuel & Energy",icon:"⛽"},{key:"minerals",name:"Minerals",icon:"⛏️"},{key:"manufactured_goods",name:"Manufactured",icon:"🏭"},{key:"technology",name:"Technology",icon:"💻"},{key:"arms",name:"Arms",icon:"⚔️"},{key:"grains_staples",name:"Grains & Staples",icon:"🌾"},{key:"livestock_dairy",name:"Livestock & Dairy",icon:"🥬"},{key:"fruits_vegetables",name:"Fruits & Veg",icon:"🍎"},{key:"cash_crops",name:"Cash Crops",icon:"🌿"},{key:"tourism",name:"Tourism",icon:"✈️"},{key:"services_finance",name:"Services & Finance",icon:"🏦"}];function E(t,n){if(t==null)return"—";if(typeof t=="string")return t;if(G.has(n)){const e=Math.abs(t),l=n==="budget";return e>=1e12?"$"+(t/1e12).toFixed(l?0:1)+"T":e>=1e9?"$"+(t/1e9).toFixed(l?0:1)+"B":e>=1e6?"$"+(t/1e6).toFixed(l?0:1)+"M":e>=1e3?"$"+Math.round(t/1e3)+"k":"$"+(l?Math.round(t):t)}return t.toFixed(1)}const R=new Set(H),O=new Set(B);function T(t){return R.has(t)?!0:O.has(t)?!1:null}const w=[{id:"fiscal",name:"Fiscal",stats:[{id:"budget",name:"Budget"},{id:"debt",name:"Debt"},{id:"gdp_growth",name:"GDP Growth"},{id:"income_tax",name:"Income Tax"},{id:"corporate_tax",name:"Corporate Tax"},{id:"cost_of_living",name:"Cost of Living"}]},{id:"governance",name:"Governance",stats:[{id:"state_apparatus",name:"State Apparatus"},{id:"public_approval",name:"Public Approval"},{id:"crown_authority",name:"Crown Authority"},{id:"corruption",name:"Corruption"}]},{id:"stability",name:"Stability",stats:[{id:"unrest",name:"Unrest"},{id:"crime",name:"Crime"}]},{id:"population",name:"Population",stats:[{id:"population",name:"Population"},{id:"immigration",name:"Immigration"}]},{id:"wellbeing",name:"Wellbeing",stats:[{id:"health",name:"Health"},{id:"education",name:"Education"},{id:"standard_of_living",name:"Standard of Living"}]},{id:"productive",name:"Production",stats:[{id:"infrastructure",name:"Infrastructure"},{id:"industry",name:"Industry"},{id:"farmland",name:"Farmland"},{id:"service_sector",name:"Service Sector"},{id:"workforce",name:"Workforce"},{id:"energy",name:"Energy"},{id:"minerals",name:"Minerals"}]},{id:"international",name:"International",stats:[{id:"power",name:"Power"}]},{id:"goods",name:"Goods",stats:[]}];function j(t,n){const e=T(n),l=u.map(o=>({id:o.id,val:Number(o[n]??0)}));return l.sort((o,m)=>e!==!1?m.val-o.val:o.val-m.val),l.findIndex(o=>o.id===t)+1}function P(t,n){return t<=3?"var(--accent)":t<=Math.ceil(n*.5)?"var(--green)":t<=Math.ceil(n*.75)?"var(--amber)":"var(--red)"}async function U(t,n){L=n;const e=document.getElementById("ledger-root");if(!e)return;e.innerHTML='<div style="padding:40px;text-align:center;color:var(--text-dim);font-family:var(--font-mono);font-size:17px;">Loading ledger...</div>';const{data:l,error:o}=await t.from("nations").select("*").order("name");if(o){console.error("[Ledger] Failed to load nations:",o.message),e.innerHTML='<div style="padding:40px;text-align:center;color:var(--red);font-size:17px;">Failed to load data.</div>';return}u=l||[],C=n.nation?.id||(u[0]?.id??null),f=[C].filter(Boolean),V(e),h(e)}function F(t){return t.flag_url||`assets/flags/${t.name}.png`}function V(t){t.addEventListener("click",n=>{const e=n.target.closest(".lg-mode-btn");if(e){_=e.dataset.mode,h(t);return}const l=n.target.closest(".lg-nation-row");if(l){C=l.dataset.nationId,h(t);return}const o=n.target.closest(".lg-cat-btn");if(o){k=o.dataset.cat,h(t);return}const m=n.target.closest(".lg-comp-nation");if(m){const s=m.dataset.nationId;f.includes(s)?f.length>1&&(f=f.filter(i=>i!==s)):f.length<4&&f.push(s),h(t);return}const x=n.target.closest(".lg-rank-cat");if(x){if($=x.dataset.cat,$==="goods")g=z[0].key;else{const s=w.find(i=>i.id===$);s&&s.stats.length>0&&(g=s.stats[0].id)}h(t);return}const r=n.target.closest(".lg-rank-stat");if(r){g=r.dataset.stat,h(t);return}}),t.addEventListener("input",n=>{n.target.matches(".lg-search input")&&(D=n.target.value,h(t))})}function h(t){const n=w.reduce((l,o)=>l+o.stats.length,0)+z.length;t.innerHTML=`<div class="lg-page">
    ...
    </div>`;const e=t.querySelector(".lg-search input");e&&(e.value=D)}function Y(){const t=L.nation?.id,n=D?u.filter(i=>i.name.toLowerCase().includes(D.toLowerCase())):u,e=u.find(i=>i.id===C),l=w.find(i=>i.id===k),o=u.length,m=n.map(i=>{const b=i.id===C,a=i.id===t;return`<div class="lg-nation-row ${b?"active":""}" data-nation-id="${i.id}">
        ...
        </div>`:s=(l?.stats||[]).map(i=>{if(!e)return"";const b=Number(e[i.id]??0);T(i.id);const a=j(e.id,i.id),d=o>1?(o-a)/(o-1)*100:50,y=d>75?"var(--green)":d>50?"var(--amber)":d>25?"var(--orange)":"var(--red)";return`<div class="lg-stat-row">
    ...
    </div>`}function W(){const t=w.find(r=>r.id===k),n=L.nation?.id,e=u.map(r=>{const s=f.includes(r.id);return`<div class="lg-comp-nation" data-nation-id="${r.id}" style="
        ...
        </div>`;const m=t?.stats||[],x=m.map((r,s)=>{const i=f.map(c=>({id:c,val:Number(u.find(p=>p.id===c)?.[r.id]??0)})),b=T(r.id),a=i.filter(c=>!isNaN(c.val));let d=null;a.length>0&&b!==null&&(d=b?a.reduce((c,p)=>p.val>c.val?p:c).id:a.reduce((c,p)=>p.val<c.val?p:c).id);const y=f.map(c=>{const p=i.find(I=>I.id===c),N=p?p.val:0,S=c===d;return`<div style="flex:1;text-align:center;">
    ...
    </div>`}function K(){const t=L.nation?.id,n=w.find(a=>a.id===$),e=$==="goods",l=e?{name:"Goods"}:n?.stats.find(a=>a.id===g),o=e?null:T(g),m=e?[...u]:[...u].sort((a,d)=>{const y=Number(a[g]??0),c=Number(d[g]??0);return o!==!1?c-y:y-c}),x=e?1:m.length>0?Math.max(...m.map(a=>Math.abs(Number(a[g]??0))),1):1,r=w.map(a=>`<div class="lg-rank-cat" data-cat="${a.id}" style="
        ...
        ">${v(a.name.toUpperCase())}</div>`).join("");if(e)return`<div>
            ...
            <div style="padding:32px;text-align:center;color:var(--text-dim);font-style:italic;">Goods trade is being rebuilt — no data yet.</div>
        </div>`;const i=(n?.stats||[]).map(a=>`<div class="lg-rank-stat" data-stat="${a.id}" style="
