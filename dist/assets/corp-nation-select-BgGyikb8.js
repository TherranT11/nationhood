import{_ as o}from"./supabase-client-BXEzLDpS.js";import{e as m}from"./utils-C2W-HleY.js";import{d as A}from"./elections-CFC87mOS.js";import{g as L}from"./equipment-DsuDdEne.js";import{h as $}from"./government-types-BwzErBjP.js";import"./config-fKhFNVuq.js";import"./ideology-DgnKVc_l.js";import"./stats-DqgGwtpW.js";import"./government-structure-C6CQ8K_6.js";const B={Melizea:"assets/flags/Melizea.png",Avelia:"assets/flags/Avelia1.png",Sangreza:"assets/flags/sangreza.png",Montequilla:"assets/flags/Montequilla.png","San Estrella":"assets/flags/sanestrella.png",Palvera:"assets/flags/Palvera.png",Calveth:"assets/flags/Calveth.png",Flandis:"assets/flags/Flandis.png"},M={Melizea:"A nation inspired by Spanish culture and language.",Sangreza:"A nation inspired by Spanish culture and language.","San Estrella":"A nation inspired by Spanish culture and language.",Palvera:"A nation inspired by Spanish culture and language.",Montequilla:"A nation inspired by Spanish culture and language.",Avelia:"A nation inspired by a hybrid of Spanish and Italian culture and language.",Calveth:"A nation inspired by Danish culture and language.",Flandis:"A nation inspired by Dutch culture and language."};let g=null,a=null,S=[],l={},f=null,E="Crucera",p=null,r="",d="";async function P(){const{data:{user:e}}=await o.auth.getUser();if(!e){window.location.href="login.html";return}g=e;const n=sessionStorage.getItem("corp_setup");if(!n){window.location.href="corp-setup.html";return}if(a=JSON.parse(n),!a.sector||!a.subsector){window.location.href="corp-setup.html";return}q();const[t,s]=await Promise.all([o.from("nations").select("*, nation_profiles(flag_url)").order("name"),o.from("factions").select("id, nation_id, corp_subsector").eq("faction_type","corporation").eq("corp_subsector",a.subsector)]);S=t.data||[];const u=s.data||[];l={};for(const i of u)l[i.nation_id]||(l[i.nation_id]=[]),l[i.nation_id].push(i);I(),document.getElementById("loading").style.display="none",document.getElementById("page-content").style.display="flex"}function q(){const e=document.getElementById("corp-summary-tags"),n=[a.sector,a.subsector,a.companyType];a.corpName&&n.push(a.corpName),a.ticker&&n.push(a.ticker),e.innerHTML=n.map(t=>`<span class="corp-summary__tag">${m(t)}</span>`).join("")}function F(e){const n=(l[e]||[]).length;return n<=1?{label:"High Demand",cls:"demand-badge--high"}:n===2?{label:"Moderate",cls:"demand-badge--moderate"}:{label:"Low Demand",cls:"demand-badge--low"}}function z(e){return $(e)?"gov-presidential":"gov-democracy"}function D(e){return $(e)?"Presidential":e.hos_election_method==="hereditary"?"Constitutional Monarchy":"Parliamentary"}function I(){const e=document.getElementById("nations-grid"),n=S.filter(t=>(t.continent||"Crucera")===E);if(n.length===0){e.innerHTML='<div style="font-family:var(--font-mono);font-size:10px;color:var(--text-dim);text-align:center;padding:40px 0;grid-column:1/-1;">No nations in this continent yet.</div>';return}e.innerHTML=n.map(t=>{const s=t.nation_profiles,i=(Array.isArray(s)?s[0]?.flag_url:s?.flag_url)||t.flag_url||B[t.name]||"",h=z(t),k=D(t),_=F(t.id),y=(l[t.id]||[]).length,v=f===t.id,x=t.population?t.population.toLocaleString():"—",N=t.gdp?"$"+(t.gdp/1e9).toFixed(1)+"B":"—",b=t.stability!=null?Math.round(t.stability):"—";return`
        ...
        `}).join("")}function U(e){f=e,I(),G()}function G(){const e=document.getElementById("details-panel");e.classList.add("active"),e.innerHTML=`
