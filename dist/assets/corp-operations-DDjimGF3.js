import{_}from"./supabase-client-BXEzLDpS.js";import{e as x}from"./utils-C2W-HleY.js";import{initMessaging as ln}from"./messaging-B5Fng3EZ.js";import{c as dn,a as Gt,E as Ye,b as st,d as Ti,e as cn,f as pn,h as $i}from"./equipment-DsuDdEne.js";const Ci={LOW:"#c84",STD:"#ca5",HIGH:"#5c5"},ue=[{key:"concrete",name:"Concrete",category:"RAW",tiers:{LOW:{requirements:[]},STD:{requirements:[{stat:"manufacturing_output",min:20}]},HIGH:{requirements:[{stat:"manufacturing_output",min:50},{stat:"higher_education",min:40}]}},priceDrivers:["manufacturing_output","inflation","fuel_prices","urbanization"]},{key:"steel",name:"Steel",category:"RAW",tiers:{LOW:{requirements:[{stat:"manufacturing_output",min:10}]},STD:{requirements:[{stat:"manufacturing_output",min:35},{stat:"rare_minerals",min:20}]},HIGH:{requirements:[{stat:"manufacturing_output",min:60},{stat:"rare_minerals",min:40},{stat:"higher_education",min:45}]}},priceDrivers:["manufacturing_output","rare_minerals","inflation","fuel_prices"]},{key:"lumber",name:"Lumber",category:"RAW",tiers:{LOW:{requirements:[{stat:"arable_land",min:10}]},STD:{requirements:[{stat:"arable_land",min:30},{stat:"physical_infrastructure",min:20}]},HIGH:{requirements:[{stat:"arable_land",min:50},{stat:"manufacturing_output",min:30}]}},priceDrivers:["arable_land","physical_infrastructure","inflation"]},{key:"aggregate",name:"Aggregate",category:"RAW",tiers:{LOW:{requirements:[]},STD:{requirements:[{stat:"rare_minerals",min:15},{stat:"physical_infrastructure",min:20}]},HIGH:{requirements:[{stat:"rare_minerals",min:35},{stat:"manufacturing_output",min:25}]}},priceDrivers:["rare_minerals","physical_infrastructure","inflation"]},{key:"em",name:"E&M Systems",category:"MANUFACTURED",tiers:{LOW:{requirements:[{stat:"manufacturing_output",min:15}]},STD:{requirements:[{stat:"manufacturing_output",min:40},{stat:"digital_infrastructure",min:25}]},HIGH:{requirements:[{stat:"manufacturing_output",min:55},{stat:"digital_infrastructure",min:50},{stat:"energy_generation",min:40}]}},priceDrivers:["manufacturing_output","digital_infrastructure","inflation","energy_generation"]},{key:"glass",name:"Glass & Facades",category:"MANUFACTURED",tiers:{LOW:{requirements:[{stat:"manufacturing_output",min:20}]},STD:{requirements:[{stat:"manufacturing_output",min:40},{stat:"standard_of_living",min:35}]},HIGH:{requirements:[{stat:"manufacturing_output",min:60},{stat:"digital_infrastructure",min:40},{stat:"higher_education",min:50}]}},priceDrivers:["manufacturing_output","standard_of_living","inflation"]},{key:"asphalt",name:"Asphalt",category:"RAW",tiers:{LOW:{requirements:[{stat:"oil_and_gas",min:10}]},STD:{requirements:[{stat:"oil_and_gas",min:30},{stat:"manufacturing_output",min:25}]},HIGH:{requirements:[{stat:"oil_and_gas",min:45},{stat:"manufacturing_output",min:40},{stat:"physical_infrastructure",min:40}]}},priceDrivers:["oil_and_gas","manufacturing_output","inflation","fuel_prices"]},{key:"heavy",name:"Heavy Machinery Parts",category:"MANUFACTURED",tiers:{LOW:{requirements:[{stat:"manufacturing_output",min:40},{stat:"rare_minerals",min:30}]},STD:{requirements:[{stat:"manufacturing_output",min:60},{stat:"rare_minerals",min:45},{stat:"higher_education",min:40}]},HIGH:{requirements:[{stat:"manufacturing_output",min:75},{stat:"rare_minerals",min:60},{stat:"higher_education",min:55},{stat:"digital_infrastructure",min:45}]}},priceDrivers:["manufacturing_output","rare_minerals","higher_education","digital_infrastructure"]}];function Ie(i,e,t){const n=ue.find(s=>s.key===i);if(!n)return{available:!1,failedStat:"unknown_material"};const o=n.tiers[e];if(!o)return{available:!1,failedStat:"unknown_tier"};for(const s of o.requirements){const a=Number(t?.[s.stat]??0);if(a<s.min)return{available:!1,failedStat:s.stat,failedMin:s.min,nationValue:a}}return{available:!0}}function ei(i,e,t){const o={concrete:{LOW:200,STD:300,HIGH:500},steel:{LOW:400,STD:700,HIGH:1200},lumber:{LOW:80,STD:130,HIGH:200},aggregate:{LOW:40,STD:60,HIGH:100},em:{LOW:400,STD:700,HIGH:1200},glass:{LOW:300,STD:500,HIGH:900},asphalt:{LOW:120,STD:200,HIGH:350},heavy:{LOW:800,STD:1400,HIGH:2400}}[i]?.[e];if(!o)return 0;const s=ue.find(d=>d.key===i);if(!s)return o;let a=1;for(const d of s.priceDrivers){const l=Number(t?.[d]??50);d==="inflation"||d==="fuel_prices"?a*=1+(l-50)/200:a*=1-(l-50)/250}return a=Math.max(.4,Math.min(2.5,a)),Math.round(o*a)}function Ii(i,e,t){const o={concrete:{LOW:5e3,STD:3e3,HIGH:1e3},steel:{LOW:2e3,STD:1500,HIGH:500},lumber:{LOW:8e3,STD:4e3,HIGH:1500},aggregate:{LOW:15e3,STD:6e3,HIGH:2e3},em:{LOW:1e3,STD:700,HIGH:300},glass:{LOW:1500,STD:800,HIGH:300},asphalt:{LOW:4e3,STD:2e3,HIGH:800},heavy:{LOW:400,STD:200,HIGH:80}}[i]?.[e]||0,a=ue.find(r=>r.key===i)?.priceDrivers?.[0],l=.3+(a?Number(t?.[a]??50):50)/50*.7;return Math.round(o*l)}const ti=["LOW","STD","HIGH"],Wt={LOW:"Low",STD:"Standard",HIGH:"High"};let We=[],f=null,S=null,O=null,qe=[],je={},ie=[],F={},Ft=-1,H="concrete",j="STD",ne=500,oe=[],Vt=0,J="trucks",ce=0,pe=1,$e=[],Se=null,ot=[],Yt=null,tt=null,Qt="ALL",Kt="TIMELINE";function N(i){return Math.abs(i)>=1e6?"$"+(i/1e6).toFixed(1)+"M":Math.abs(i)>=1e3?"$"+(i/1e3).toFixed(0)+"k":"$"+i}function mn(i){if(i>=12){const e=Math.floor(i/12),t=i%12;return t>0?e+"y "+t+"mo":e+"y"}return i+" ticks"}function X(i){return Math.abs(i)>=1e9?"$"+(i/1e9).toFixed(1)+"B":Math.abs(i)>=1e6?"$"+(i/1e6).toFixed(0)+"M":Math.abs(i)>=1e3?"$"+(i/1e3).toFixed(0)+"k":"$"+i}function rt(i){return i==="civil_engineering"?"CIVIL":i==="industrial"?"INDUSTRIAL":i==="mega_project"?"MEGA":i?.toUpperCase()||"—"}function Si(i){return i==="civil_engineering"?"light":i==="industrial"?"heavy":i==="mega_project"?"mega":"light"}function fn(){tt&&clearInterval(tt),tt=setInterval(()=>{if(!Yt)return;const i=Yt-Date.now();if(i<=0){document.getElementById("tick-countdown").textContent="Tick due...",clearInterval(tt);return}const e=Math.floor(i/36e5),t=Math.floor(i%36e5/6e4),n=Math.floor(i%6e4/1e3);document.getElementById("tick-countdown").textContent=e+"h "+t+"m "+n+"s"},1e3)}function un(){document.body.classList.toggle("light-mode");const i=document.getElementById("theme-toggle");i.textContent=document.body.classList.contains("light-mode")?"Dark":"Light"}function yn(i,e){i==="type"&&(Qt=e),i==="sort"&&(Kt=e),document.querySelectorAll(`.filter-pill[data-filter="${i}"]`).forEach(t=>{t.classList.toggle("active",t.dataset.value===e)}),Ai()}const _i={"Civil Engineering":"civil_engineering","Industrial Construction":"industrial",Megaprojects:"mega_project"};function Mi(i){if(!f)return!1;if(_i[f.corp_subsector]===i.sector)return!0;const t=(U||[]).filter(n=>n.type==="regional_hq"&&n.is_active&&n.nation_id===i.nation_id);for(const n of t)if(_i[n.subsector]===i.sector)return!0;return!1}function Ai(){const i=document.getElementById("oc-list");let e=[...qe];if(Qt==="GOVERNMENT"?e=e.filter(o=>o.issuer_type==="GOVERNMENT"):Qt==="PRIVATE"&&(e=e.filter(o=>o.issuer_type==="PRIVATE")),Kt==="TIMELINE"&&e.sort((o,s)=>(o.timeline_ticks||0)-(s.timeline_ticks||0)),Kt==="BUDGET"&&e.sort((o,s)=>(s.budget_ceiling||0)-(o.budget_ceiling||0)),document.getElementById("oc-count").textContent=e.length+" AVAILABLE",e.length===0){i.innerHTML=`
            ...
            </div>`;return}const t=O?.current_tick||0;let n="";for(const o of e){const s=o.issuer_type==="GOVERNMENT",a=s?"gov":"private",d=Mi(o),l=d?"":" locked",r=Si(o.sector),c=rt(o.sector),m=(o.timeline_ticks||0)>18?" warn":"",p=o.bidding_ends_tick?Math.max(0,o.bidding_ends_tick-t):"?";n+=`
            <div class="oc-item${l}" data-contract-id="${o.id}">
                ...
                <div class="oc-item__stats">
                    ...
                    <div class="oc-stat">
                        ...
                        <div class="oc-stat__value${m}">${mn(o.timeline_ticks||0)}</div>
                    </div>
                    <div class="oc-stat">
    ...
    `;const a=document.getElementById("cd-blueprint");i.blueprint_svg?(a.innerHTML=i.blueprint_svg,a.style.display=""):(a.innerHTML=Ln(i),a.style.display="");const d=i.permits_required||[],l=i.required_equipment||i.equipment_required||[],r=i.required_materials||i.materials_estimated||{},m={civil_engineering:"Civil Engineering",industrial:"Industrial Construction",mega_project:"Megaprojects"}[i.sector]||i.spec_category||i.sector||"—";let p="var(--teal)";i.sector==="industrial"&&(p="var(--orange)"),i.sector==="mega_project"&&(p="var(--red)");let u=N(i.budget_ceiling||i.budget||0),y=(i.timeline_ticks||i.timeline_months||0)+" Months",v="";v+=`
        <div class="cd-issue">
            ...
            </div>`),v+='<div class="cd-details">',i.project_type&&(v+=xe("Type",i.project_type)),i.project_subtype&&(v+=xe("Sub-Type",i.project_subtype)),v+=xe("Specialization",m,p),v+=xe("Total Budget",u,"var(--green)"),v+=xe("Timeline",y),v+=xe("Nation",S?.name||f.nation||"—"),i.region&&(v+=xe("Region",i.region)),v+="</div>",d.length>0&&(v+=`
            <div class="cd-items">
            ...
            </div>`),document.getElementById("cd-content").innerHTML=v;const h=d.filter(w=>w.status==="approved").length,T=d.length-h,E=l.filter(w=>w.owned).length,A=l.length-E;let $="";l.length>0&&(A===0?$+='<span class="cd-footer__badge ok">ALL EQUIPMENT MET</span>':$+=`<span class="cd-footer__badge bad">${A} EQUIPMENT MISSING</span>`),d.length>0&&(T===0?$+='<span class="cd-footer__badge ok">ALL PERMITS APPROVED</span>':$+=`<span class="cd-footer__badge warn">${T} PERMITS PENDING</span>`);const C=s;(f.action_points??0)>=2;const b=i.issuer_faction_id===f?.id,I=i.status==="bidding",k=je[i.id];document.getElementById("cd-footer").innerHTML=`
        <div class="cd-footer__badges">${$}</div>
    ...
    `,e.classList.add("open"),document.body.style.overflow="hidden"}function Je(i){i&&i.target&&i.target!==document.getElementById("cd-overlay")||(document.getElementById("cd-overlay").classList.remove("open"),document.body.style.overflow="",se=null)}const vn=[{key:"concrete",name:"Concrete",unit:"units"},{key:"steel",name:"Steel",unit:"units"},{key:"lumber",name:"Lumber",unit:"units"},{key:"aggregate",name:"Aggregate",unit:"units"},{key:"em_systems",name:"E&M Systems",unit:"units"},{key:"glass_facades",name:"Glass & Facades",unit:"units"},{key:"asphalt",name:"Asphalt",unit:"units"},{key:"heavy_parts",name:"Heavy Machinery Parts",unit:"units"}],gn=[{key:"work_trucks",name:"Work Trucks",tier:1},{key:"excavators",name:"Excavators",tier:1},{key:"bulldozers",name:"Bulldozers",tier:1},{key:"concrete_mixers",name:"Concrete Mixers",tier:1},{key:"tower_cranes",name:"Tower Cranes",tier:2},{key:"heavy_haulers",name:"Heavy Haulers",tier:2},{key:"pile_drivers",name:"Pile Drivers",tier:2},{key:"asphalt_plants",name:"Asphalt Plants",tier:2}],Li={LOW:.7,STANDARD:1,HIGH:1.4},Bi={LOW:35,STANDARD:65,HIGH:90},St=15;let V=null;function bn(i){if(!i)return;const e=i.required_materials||{},t=i.required_equipment||[],n=i.required_workforce||{},o={concrete:18e4,steel:25e4,lumber:12e4,aggregate:8e4,em_systems:32e4,glass_facades:28e4,asphalt:14e4,heavy_parts:4e5},s=vn.filter(c=>e[c.key]>0).map(c=>({...c,qty:e[c.key],basePrice:o[c.key]||2e5,grade:c.key==="aggregate"?"LOW":"STANDARD",highDisabled:!1})),a=gn.filter(c=>t.includes(c.key)).map(c=>({...c,owned:(oe||[]).some(m=>m.equipment_key===c.key&&m.quantity>0)})),d=(n.general||100)+(n.skilled||20),l=i.budget_ceiling||1e8,r=Math.round(l*.03);V={contract:i,budgetCeiling:l,materials:s,laborCount:d,laborRate:15200,estimatedTicks:i.timeline_ticks||8,equipment:a,permits:[],overhead:r,markupPct:15,competitors:[],playerRep:f?.standing||50,requiredWorkforce:n},document.getElementById("bid-title").textContent="BID ASSEMBLY",document.getElementById("bid-subtitle").textContent=(i.name||"Contract")+" — "+rt(i.sector)+" — "+(i.issuer_name||"Government"),document.getElementById("bid-overlay").classList.add("open"),document.body.style.overflow="hidden",lt()}function Ni(i){i&&i.target!==document.getElementById("bid-overlay")||(document.getElementById("bid-overlay").classList.remove("open"),document.body.style.overflow="",V=null)}function R(i){return Math.abs(i)>=1e9?"$"+(i/1e9).toFixed(2)+"B":Math.abs(i)>=1e6?"$"+(i/1e6).toFixed(2)+"M":Math.abs(i)>=1e3?"$"+(i/1e3).toFixed(0)+"k":"$"+i.toLocaleString()}function xn(i,e){if(!V)return;const t=V.materials[i];e==="HIGH"&&t.highDisabled||(t.grade=e,lt())}function $n(i){V&&(V.laborCount=i,lt())}function _n(i){V&&(V.markupPct=Number(i),lt())}function lt(){if(!V)return;const i=V;let e=0;for(const w of i.materials)w.lineCost=Math.round(w.qty*w.basePrice*Li[w.grade]),e+=w.lineCost;const t=Math.round(i.laborCount*i.laborRate*i.estimatedTicks),n=Math.round(i.equipment.filter(w=>w.owned).length*12e3*i.estimatedTicks);let o=0;const s=i.overhead,a=e+t+n+o+s,d=Math.round(a*i.markupPct/100),l=a+d,r=l>i.budgetCeiling,c=d,m=Math.round(i.materials.reduce((w,q)=>w+Bi[q.grade],0)/i.materials.length),p=m>=80?"STRONG":m>=60?"PROMISING":m>=40?"UNCERTAIN":"POOR",u=m>=80?"var(--green)":m>=60?"var(--teal)":m>=40?"var(--orange)":"var(--red)",y=i.budgetCeiling>0?l/i.budgetCeiling:1,v=Math.max(0,Math.min(100,Math.round((1-y)*150))),h=v>=70?"STRONG":v>=40?"COMPETITIVE":v>=15?"WEAK":"UNLIKELY",T=v>=70?"var(--green)":v>=40?"var(--teal)":v>=15?"var(--orange)":"var(--red)",E=Math.round(a*(1-St/100)),A=Math.round(a*(1+St/100));let $="";$+='<div class="bid-section"><div class="bid-section__title">Materials</div>',i.materials.forEach((w,q)=>{const L=P=>{const K=w.grade===P,ye=P==="HIGH"&&w.highDisabled;return`<button class="bid-grade-btn ${K?P==="LOW"?"active-low":P==="HIGH"?"active-high":"active":""} ${ye?"disabled":""}" onclick="setBidGrade(${q},'${P}')">${P[0]}</button>`};$+=`<div class="bid-mat-row">
        ...
        </div>`}),$+=`<div class="bid-line-total"><span class="bid-line-total__label">MATERIALS TOTAL</span><span class="bid-line-total__value">${R(e)}</span></div></div>`;const C=(i.requiredWorkforce?.general||80)+(i.requiredWorkforce?.skilled||20),b=[Math.round(C*.8),C,Math.round(C*1.2),Math.round(C*1.4),Math.round(C*1.6)];$+='<div class="bid-section"><div class="bid-section__title">Labor</div>',$+='<div class="bid-labor-presets">',b.forEach(w=>{$+=`<button class="bid-labor-btn ${i.laborCount===w?"active":""}" onclick="setBidLabor(${w})">${w}</button>`}),$+="</div>";const I=i.requiredWorkforce||{};$+=`<div class="bid-labor-formula">Required: ${I.general||"?"} general + ${I.skilled||"?"} skilled<br>`,$+=`${i.laborCount} workers × ${R(i.laborRate)}/tick × ${i.estimatedTicks} ticks = <strong>${R(t)}</strong></div>`,$+=`<div class="bid-line-total"><span class="bid-line-total__label">LABOR TOTAL</span><span class="bid-line-total__value">${R(t)}</span></div></div>`,$+='<div class="bid-section"><div class="bid-section__title">Equipment</div>',i.equipment.forEach(w=>{const q=w.owned?"bid-equip-row__status--owned":"bid-equip-row__status--missing",L=w.owned?"✓ OWNED":"✗ NOT OWNED";$+=`<div class="bid-equip-row"><span class="bid-equip-row__name">${x(w.name)}</span><span class="bid-equip-row__status ${q}">${L}</span></div>`}),$+=`<div class="bid-line-total"><span class="bid-line-total__label">MAINTENANCE (${i.estimatedTicks}t)</span><span class="bid-line-total__value">${R(n)}</span></div></div>`,$+='<div class="bid-section"><div class="bid-section__title">Permits</div>',$+='<div style="font-family:var(--font-mono);font-size:9px;color:var(--text-dim);padding:8px 0;">No permits required yet.</div>',$+='<div class="bid-line-total"><span class="bid-line-total__label">PERMITS TOTAL</span><span class="bid-line-total__value">$0</span></div></div>',$+='<div class="bid-section"><div class="bid-section__title">Overhead &amp; Contingency</div>',$+='<div style="font-family:var(--font-mono);font-size:9px;color:var(--text-dim);">Site management, insurance, admin</div>',$+=`<div class="bid-line-total"><span class="bid-line-total__label">OVERHEAD</span><span class="bid-line-total__value">${R(s)}</span></div></div>`,document.getElementById("bid-left").innerHTML=$;let k="";k+='<div class="bid-section"><div class="bid-section__title">Cost Summary</div>',k+=`<div class="bid-summary-row"><span class="bid-summary-row__label">Materials</span><span class="bid-summary-row__value">${R(e)}</span></div>`,k+=`<div class="bid-summary-row"><span class="bid-summary-row__label">Labor</span><span class="bid-summary-row__value">${R(t)}</span></div>`,k+=`<div class="bid-summary-row"><span class="bid-summary-row__label">Equipment Maint.</span><span class="bid-summary-row__value">${R(n)}</span></div>`,k+=`<div class="bid-summary-row"><span class="bid-summary-row__label">Permits</span><span class="bid-summary-row__value">${R(o)}</span></div>`,k+=`<div class="bid-summary-row"><span class="bid-summary-row__label">Overhead</span><span class="bid-summary-row__value">${R(s)}</span></div>`,k+=`<div class="bid-cost-total"><span class="bid-cost-total__label">ESTIMATED COST</span><span class="bid-cost-total__value">${R(a)}</span></div>`,k+=`<div class="bid-accuracy">⚠ Estimate accuracy: ±${St}%<br>Actual cost range: ${R(E)} — ${R(A)}</div>`,k+="</div>",k+='<div class="bid-section"><div class="bid-section__title">Markup</div>',k+=`<div class="bid-slider-wrap">
    ...
    </div>`,k+='<div class="bid-section" style="margin-top:8px;"><div class="bid-section__title">Competing Bids</div>',i.competitors.forEach(w=>{k+=`<div class="bid-competitor"><span class="bid-competitor__name">${x(w.name)}</span><span class="bid-competitor__rep">Rep ${w.rep}</span></div>`}),k+=`<div class="bid-competitor" style="color:var(--gold);"><span class="bid-competitor__name">You</span><span class="bid-competitor__rep">Rep ${i.playerRep}</span></div>`,k+="</div>",document.getElementById("bid-right").innerHTML=k,document.getElementById("bid-footer-price").textContent=R(l),document.getElementById("bid-footer-price").style.color=r?"var(--red)":"var(--gold)",document.getElementById("bid-footer-profit").textContent="+"+R(c),document.getElementById("bid-footer-quality").textContent=m+"/100",document.getElementById("bid-footer-quality").style.color=u,document.getElementById("bid-submit-btn").disabled=r}window.openBidModal=bn;window.closeBidModal=Ni;window.setBidGrade=xn;window.setBidLabor=$n;window.setBidMarkup=_n;async function hn(){if(!V||!f||He)return;const i=V,e=i.contract;let t=0;const n={};for(const m of i.materials)t+=Math.round(m.qty*m.basePrice*Li[m.grade]),n[m.key]=m.grade;const o=Math.round(i.laborCount*i.laborRate*i.estimatedTicks),s=Math.round(i.equipment.filter(m=>m.owned).length*12e3*i.estimatedTicks),a=t+o+s+i.overhead,d=Math.round(a*i.markupPct/100),l=a+d,r=Math.round(i.materials.reduce((m,p)=>m+Bi[p.grade],0)/(i.materials.length||1));if(l>i.budgetCeiling){alert("Bid exceeds budget ceiling. Lower your costs or markup.");return}const c=document.getElementById("bid-submit-btn");c.disabled=!0,c.textContent="SUBMITTING...",He=!0;try{const{data:m}=await _.from("shard").select("current_tick").eq("name","Alpha Shard").single(),p=m?.current_tick||0,{data:u}=await _.from("contract_bids").select("id").eq("contract_id",e.id).eq("faction_id",f.id).maybeSingle();if(u){const{error:v}=await _.from("contract_bids").update({bid_price:l,material_grades:n,labor_count:i.laborCount,markup_pct:i.markupPct,estimated_cost:a,estimated_quality:r,submitted_at_tick:p}).eq("id",u.id);if(v)throw v}else{const{error:v}=await _.from("contract_bids").insert({contract_id:e.id,faction_id:f.id,bid_price:l,material_grades:n,labor_count:i.laborCount,markup_pct:i.markupPct,estimated_cost:a,estimated_quality:r,status:"pending",submitted_at_tick:p});if(v)throw v}Ni();const y=document.getElementById("oc-count");if(y){const v=y.textContent;y.textContent="✓ BID SUBMITTED",y.style.color="var(--green)",setTimeout(()=>{y.textContent=v,y.style.color=""},2e3)}await le()}catch(m){console.error("Bid submission failed:",m),alert("Failed to submit bid: "+(m.message||"Unknown error")),c.disabled=!1,c.textContent="SUBMIT BID"}finally{He=!1}}window.submitBid=hn;const we=["Permits","Planning","Foundation","Structural","Systems","Finishing","Delivery"],hi={WEATHER:{color:"var(--blue)",bg:"var(--blue-faint)",border:"var(--blue-border)"},SUPPLY:{color:"var(--gold)",bg:"var(--gold-faint)",border:"var(--gold-border)"},LABOR:{color:"var(--orange)",bg:"var(--orange-faint)",border:"var(--orange-border)"},REGULATORY:{color:"var(--red)",bg:"var(--red-faint)",border:"var(--red-border)"},EQUIPMENT:{color:"var(--amber)",bg:"var(--amber-faint)",border:"var(--amber-border)"},POLITICAL:{color:"var(--teal)",bg:"var(--teal-faint)",border:"var(--teal-border)"}},wi={LOW:"var(--green)",MODERATE:"var(--amber)",HIGH:"var(--orange)",CRITICAL:"var(--red)"};let B=null;function wn(i){const e=ie.find(I=>I.id===i);if(!e)return;const t=Array.isArray(e.contract_bids)?e.contract_bids[0]:e.contract_bids,n=O?.current_tick||0,o=e.awarded_at_tick||n,s=e.timeline_ticks||8,a=Math.max(0,n-o),d=Math.min(100,a/s*100);let l=Math.min(we.length-1,Math.floor(d/(100/we.length)));const r=Math.round(d%(100/we.length)/(100/we.length)*100),c=e.required_materials||{},m=t?.material_grades||{},p=Object.entries(c).map(([I,k])=>{const w=m[I]||"STANDARD",q=Math.round(k*(d/100)*(.6+Math.random()*.4));return{key:I,name:I.replace(/_/g," ").replace(/\b\w/g,L=>L.toUpperCase()),grade:w,allocated:k,used:Math.min(q,k)}}),y=(e.required_equipment||[]).map(I=>({key:I,name:I.replace(/_/g," ").replace(/\b\w/g,k=>k.toUpperCase()),qty:1+Math.floor(Math.random()*3),condition:55+Math.floor(Math.random()*40)})),v=e.budget_ceiling||0,h=t?.estimated_cost||0,T=Math.round(h*Math.min(1,a/s)),E=t?.estimated_quality||65,A=E>=80?"STRONG":E>=60?"PROMISING":E>=40?"FAIR":"UNCERTAIN",$=e.required_workforce||{},C=($.general||0)+($.skilled||0),b=t?.labor_count||C;B={project:e,bid:t,tab:"overview",expandedEvent:-1,selectedResponse:null,currentTick:n,awardedTick:o,totalTicks:s,ticksElapsed:a,phaseIdx:l,phaseProgress:r,materials:p,equipment:y,budget:v,estCost:h,spent:T,quality:E,qualityLabel:A,laborCount:b,wfNeeded:C,events:[]},document.getElementById("pm-overlay").classList.add("open"),document.body.style.overflow="hidden",qi(e.id).then(()=>Ae()),Ae()}function kn(i){i&&i.target!==document.getElementById("pm-overlay")||(document.getElementById("pm-overlay").classList.remove("open"),document.body.style.overflow="",B=null)}function En(i){B&&(B.tab=i,B.expandedEvent=-1,B.selectedResponse=null,Ae())}function Tn(i){B&&(B.expandedEvent=B.expandedEvent===i?-1:i,B.selectedResponse=null,Ae())}function Cn(i){B&&(B.selectedResponse=B.selectedResponse===i?null:i,Ae())}function Ae(){if(!B)return;const i=B,e=i.project,t=e.issuer_type==="GOVERNMENT",n=rt(e.sector),o=f?.nation||"Nation",s=i.awardedTick+i.totalTicks,a=Math.max(0,s-i.currentTick),d=i.currentTick>s,l=i.budget>0?Math.round(i.spent/i.budget*100):0,r=l>85?"var(--red)":l>60?"var(--amber)":"var(--teal)",c=i.budget-i.spent,m=i.events.filter(h=>h.status==="ACTIVE").length;document.getElementById("pm-header").innerHTML=`
    ...
    `}function In(i,e,t,n,o,s,a){const d=Mt(i.awardedTick+i.totalTicks);Mt(i.awardedTick+i.totalTicks);const l=Mt(i.awardedTick),r=[{label:"Budget",value:X(i.budget),sub:`${n}% spent`,color:t},{label:"Spent",value:X(i.spent),color:"var(--red)"},{label:"Remaining",value:X(o),color:"var(--green)"},{label:"Quality",value:`${i.quality}/100`,sub:i.qualityLabel,color:i.quality>=70?"var(--green)":i.quality>=50?"var(--amber)":"var(--red)"},{label:"Workforce",value:`${i.laborCount}/${i.wfNeeded}`,sub:`Bid: ${i.laborCount}`,color:i.laborCount<i.wfNeeded?"var(--orange)":"var(--text-bright)"},{label:"Remaining",value:`${s} ticks`,sub:a?"OVERDUE":`Deadline: ${d}`,color:a?"var(--red)":"var(--text-bright)"}];let c="";c+=`<div style="padding:0 16px"><div class="pm-section">
        ...
        </div>`}return e}function Mt(i){return`${["January","February","March","April","May","June","July","August","September","October","November","December"][i%12]}, ${2e3+Math.floor(i/12)}`}window.openProjectModal=wn;window.closeProjectModal=kn;window.pmSetTab=En;window.pmToggleEvent=Tn;window.pmSelectResponse=Cn;async function qi(i){if(!B)return;const{data:e,error:t}=await _.from("construction_events").select("*").eq("contract_id",i).order("fired_at_tick",{ascending:!1});t?(console.warn("Failed to load project events:",t.message),B.events=[]):B.events=(e||[]).map(n=>({id:n.id,type:n.type,severity:n.severity,tick:n.fired_at_tick,title:n.title,desc:n.description,impact:n.impact,status:n.status==="ACTIVE"?"ACTIVE":"RESOLVED",resolution:n.resolution,responses:n.responses||[]})),Ae()}let At=!1;async function zn(i,e){if(!(At||!B)){At=!0;try{const{data:t,error:n}=await _.rpc("resolve_construction_event",{p_event_id:i,p_response_key:e});if(n){console.error("Failed to resolve event:",n.message),alert("Failed to submit response: "+n.message);return}const o=typeof t=="string"?JSON.parse(t):t;if(o?.error){alert("Error: "+o.error);return}await qi(B.project.id),await Ri(),o?.quality_applied&&o.quality_applied!==0&&(B.quality=Math.max(0,Math.min(100,B.quality+o.quality_applied)),B.qualityLabel=B.quality>=80?"STRONG":B.quality>=60?"PROMISING":B.quality>=40?"FAIR":"UNCERTAIN"),Ae()}finally{At=!1}}}window.confirmEventResponse=zn;function xe(i,e,t){const n=t?` style="color:${t}"`:"";return`<div class="cd-detail-row">
        ...
        <g transform="translate(470,172)">
    ...
    </svg>`}let zt=!1;async function Bn(){if(zt||!se||!f)return;if((f.action_points??0)<2){alert("You need at least 2 AP to place a bid.");return}zt=!0;const i=document.querySelector(".cd-btn.primary");i&&(i.disabled=!0,i.textContent="...");try{const{data:e,error:t}=await _.rpc("deduct_ap",{p_faction_id:f.id,p_cost:2});if(t)throw t;if(e<0){const o=-e-1;f.action_points=o,document.getElementById("topbar-ap").innerHTML='<span class="topbar-ap__count">'+o+" AP</span>",i&&(i.disabled=!1,i.textContent="BID"),alert("Insufficient AP. You have "+o+" AP, need 2.");return}const{error:n}=await _.from("corp_contract_bids").insert({contract_id:se.id,faction_id:f.id,nation_id:f.nation_id,ap_spent:2,created_at_tick:O?.current_tick||null});if(n)throw await _.rpc("deduct_ap",{p_faction_id:f.id,p_cost:-2}),f.action_points=e+2,document.getElementById("topbar-ap").innerHTML='<span class="topbar-ap__count">'+(e+2)+" AP</span>",n;f.action_points=e,document.getElementById("topbar-ap").innerHTML='<span class="topbar-ap__count">'+e+" AP</span>",i&&(i.textContent="BID PLACED")}catch(e){i&&(i.disabled=!1,i.textContent="BID"),e.code==="23505"?alert("You have already placed a bid on this contract."):alert("Failed to place bid: "+(e.message||"Unknown error"))}finally{zt=!1}}async function le(){if(!f||!f.nation_id)return;const{data:i,error:e}=await _.from("construction_contracts").select("*").in("status",["open","bidding"]).order("generated_at_tick",{ascending:!1});if(e?(console.warn("Failed to load contracts:",e.message),qe=[]):qe=i||[],je={},f&&qe.length>0){const t=qe.map(o=>o.id),{data:n}=await _.from("contract_bids").select("contract_id, bid_price, estimated_quality, status").eq("faction_id",f.id).in("contract_id",t);for(const o of n||[])je[o.contract_id]=o}Ai()}function Nn(){const i=document.getElementById("ap-list"),e=document.getElementById("ap-footer");if(document.getElementById("ap-count").textContent=ie.length+" ACTIVE",ie.length===0){i.innerHTML=`<div class="ap-empty">
            <div class="ap-empty__text">No active projects.<br>Win a contract bid to start<br>your first construction project.</div>
        </div>`,e.style.display="none";return}const t=O?.current_tick||0;let n=0,o=0,s="";for(const a of ie){const d=a.issuer_type==="GOVERNMENT",l=d?"gov":"private",r=Array.isArray(a.contract_bids)?a.contract_bids[0]:a.contract_bids,c=r?.bid_price||0,m=r?.estimated_cost||0,p=r?.estimated_quality||0,u=a.budget_ceiling||0,y=a.awarded_at_tick||t,v=y+(a.timeline_ticks||8),h=Math.max(0,v-t),T=Math.max(0,t-y),E=a.timeline_ticks||8,A=Math.min(100,Math.round(T/E*100)),$=t>v;Si(a.sector);const C=rt(a.sector);n+=u,o+=c,s+=`<div class="ap-item" onclick="openProjectModal('${a.id}')">
            <div class="ap-item__row1">
                <div class="ap-item__info">
                    <div class="ap-item__name">${x(a.name)}</div>
                    <div style="font-family:var(--font-mono);font-size:8px;color:var(--text-dim);">${x(a.issuer_name||"—")} · ${C}</div>
                </div>
            ...
            <div class="ap-budget">
                <div class="ap-budget__header">
                    ...
                    <span class="ap-budget__values" style="color:${$?"var(--red)":"var(--teal)"}">
                        ${T}/${E} ticks ${$?'<span style="color:var(--red);font-weight:700;"> OVERDUE</span>':""}
                    </span>
                </div>
                <div class="ap-budget__bar">
                    <div class="ap-budget__fill" style="width:${A}%;background:${$?"var(--red)":"var(--teal)"}"></div>
                </div>
            </div>
            <div class="ap-details">
                ...
                <div class="ap-detail-cell" style="flex:1">
                    ...
                    <div class="ap-detail-cell__value" style="font-size:10px;font-weight:700;color:${$?"var(--red)":"var(--text-bright)"}">${h} ticks</div>
                </div>
            </div>
        </div>`}i.innerHTML=s,e.style.display=ie.length>0?"":"none",ie.length>0&&(document.getElementById("ap-total-crew").textContent=ie.length,document.getElementById("ap-total-budget").textContent=X(n),document.getElementById("ap-total-spent").textContent=X(o))}async function Ri(){if(!f)return;const{data:i,error:e}=await _.from("construction_contracts").select("*, contract_bids!inner(bid_price, material_grades, labor_count, estimated_cost, estimated_quality)").eq("awarded_to_faction",f.id).in("status",["awarded","in_progress"]).eq("contract_bids.faction_id",f.id).order("awarded_at_tick",{ascending:!0});e?(console.warn("Failed to load active projects:",e.message),ie=[]):ie=i||[],Nn()}const dt=3e4;function ct(){let i=0,e=0;for(const t of ue)for(const n of ti){const o=F[t.key]?.[n];o&&(i+=o.qty,e+=o.value)}return{totalUnits:i,totalValue:e}}function ii(){const i=document.getElementById("wh-list"),{totalUnits:e,totalValue:t}=ct();document.getElementById("wh-count").textContent=e.toLocaleString()+" UNITS",document.getElementById("wh-total-value").textContent=N(t);const n=Math.round(e/dt*100),o=document.getElementById("wh-capacity");o.textContent=n+"%",o.style.color=n>80?"var(--red)":n>50?"var(--orange)":"var(--green)";let s="";for(let a=0;a<ue.length;a++){const d=ue[a],l=Ft===a,r=F[d.key]?.LOW||{qty:0,value:0},c=F[d.key]?.STD||{qty:0,value:0},m=F[d.key]?.HIGH||{qty:0,value:0},p=r.qty+c.qty+m.qty,u=r.value+c.value+m.value,y=p===0,v=Ie(d.key,"LOW",S),h=Ie(d.key,"STD",S),T=Ie(d.key,"HIGH",S),E=r.qty>0?"wh-dot wh-dot--low":"wh-dot wh-dot--empty",A=c.qty>0?"wh-dot wh-dot--std":"wh-dot wh-dot--empty",$=T.available?m.qty>0?"wh-dot wh-dot--high":"wh-dot wh-dot--empty":"wh-dot wh-dot--locked";if(s+='<div class="wh-row">',s+=`<div class="wh-row__collapsed${l?" expanded":""}" onclick="toggleWhRow(${a})">
            ...
            </div>`;const C=[{key:"LOW",label:"Low",data:r,avail:v,color:"var(--orange)",dotClass:"wh-dot--low"},{key:"STD",label:"Standard",data:c,avail:h,color:"var(--amber)",dotClass:"wh-dot--std"},{key:"HIGH",label:"High",data:m,avail:T,color:"var(--green)",dotClass:"wh-dot--high"}];for(const b of C){const I=!b.avail.available,k=b.data.qty>0,w=k?"$"+Math.round(b.data.value/b.data.qty):"—";s+=`<div class="wh-grade${I?" unavailable":""}">
                    <div class="wh-grade__label">
                        <div class="wh-dot ${b.dotClass}" style="width:5px;height:5px"></div>
                        <span class="wh-grade__name" style="color:${I?"var(--red)":b.color}">${b.label}</span>
        ...
        </div>`}i.innerHTML=e}function pt(){const i=document.getElementById("pr-content"),e=Ie(H,j,S),t=ue.find(C=>C.key===H);if(!t)return;if(!e.available){i.innerHTML=`<div class="pr-locked-panel">
        ...
        <div class="pr-drivers__title">Price Drivers (${x(S?.name||"—")})</div>`;for(const C of t.priceDrivers){const b=Number(S?.[C]??50),I=b>=50?"var(--green)":b>=30?"var(--amber)":b>=15?"var(--orange)":"var(--red)",k=Pn[C]||C;p+=`<div class="pr-driver-row">
            <span class="pr-driver-row__stat">${x(C)}</span>
            <div class="pr-driver-row__bar">
                <div class="pr-driver-row__fill" style="width:${b}%;background:${I}"></div>
            </div>
            <span class="pr-driver-row__val">${b}</span>
            <span class="pr-driver-row__effect">${x(k)}</span>
        </div>`}p+="</div>";const y=(Number(f?.corp_cash_reserves)||0)>=s,v=ne>o,{totalUnits:h}=ct(),T=dt-h,E=ne>T,A=T<=0,$=Ci[j];p+=`<div class="pr-order">
        ...
        <div class="pr-order__box">
            <div class="pr-order__header">
                <div style="display:flex;align-items:center;gap:6px;">
                    ...
                    <span style="font-family:var(--font-mono);font-size:9px;color:${$}">${Wt[j]}</span>
                </div>
            ...
            <div class="pr-qty-row">
                ...
                <div class="pr-qty-btns">
                    ${[100,250,500,1e3].map(C=>`<span class="pr-qty-btn${ne===C?" active":""}" onclick="setPrQty(${C})">${C>=1e3?C/1e3+"k":C}</span>`).join("")}
                </div>
            </div>
    ...
    </div>`,i.innerHTML=p}function On(i){H=i,j="STD";for(const e of["STD","HIGH","LOW"])if(Ie(i,e,S).available){j=e;break}Oi(),ni(),pt()}function Dn(i){j=i,ni(),pt()}function Hn(i){ne=i,pt()}let Lt=!1;async function jn(){if(Lt||!f||!S)return;const i=ei(H,j,S),e=Ii(H,j,S),t=i*ne,n=Number(f.corp_cash_reserves)||0;if(t>n){alert("Insufficient cash reserves.");return}if(ne>e){alert("Exceeds available supply this tick.");return}const{totalUnits:o}=ct(),s=dt-o;if(s<=0){alert("Warehouse is full. Cannot purchase more materials.");return}if(ne>s){alert(`Warehouse can only hold ${s.toLocaleString()} more units. Reduce quantity.`);return}Lt=!0;const a=document.querySelector(".pr-purchase-btn");a&&(a.disabled=!0,a.textContent="...");try{const d=n-t,{error:l}=await _.from("factions").update({corp_cash_reserves:d}).eq("id",f.id);if(l)throw l;const r=F[H]?.[j],c=(r?.qty||0)+ne,m=(r?.value||0)+t,{error:p}=await _.from("corp_warehouse").upsert({faction_id:f.id,nation_id:f.nation_id,material_key:H,quality_tier:j,quantity:c,total_value:m,last_purchased_tick:O?.current_tick||null,updated_at:new Date().toISOString()},{onConflict:"faction_id,material_key,quality_tier"});if(p){const{error:u}=await _.from("factions").update({corp_cash_reserves:n}).eq("id",f.id);throw u&&console.error("Cash refund failed after warehouse error:",u.message),p}f.corp_cash_reserves=d,F[H]||(F[H]={}),F[H][j]={qty:c,value:m},ii(),Pi(),a&&(a.textContent="PURCHASED",setTimeout(()=>{a.isConnected&&(a.disabled=!1,a.textContent="PURCHASE")},1500))}catch(d){a&&(a.disabled=!1,a.textContent="PURCHASE"),alert("Purchase failed: "+(d.message||"Unknown error"))}finally{Lt=!1}}function Di(i){const e=Se||S;if(!e)return[];const t=st(i);if(!t)return[];const n=cn(i,e),o=[],s=Number(e?.inflation??50),a=Number(e?.fuel_prices??50);Number(e?.manufacturing_output??50);const d=Se&&S&&Se.id!==S.id;let l=null;if(d&&(l=pn(e,S)),n.newAvailable>0){const r=$i(i,e),c=t.basePrice,m=Math.round(c*((s-50)/200)),p=Math.round(c*((a-50)/300));let u=r;const y=[{label:"Base price",value:N(c)},m!==0?{label:`Inflation (${s})`,mod:(m>=0?"+":"")+N(Math.abs(m))}:null,p!==0?{label:`Fuel transport (${a})`,mod:(p>=0?"+":"")+N(Math.abs(p))}:null].filter(Boolean),v=r-c-m-p;if(v!==0&&!d&&y.push({label:"Demand/scarcity",mod:(v>=0?"+":"")+N(Math.abs(v))}),d&&l){const h=Math.round(r*l.tariff),T=Math.round(r*l.transport);u=r+h+T,y.push({label:`Import tariff (${Math.round(l.tariff*100)}%)`,mod:"+"+N(h)}),y.push({label:`Transport (${l.deliveryTicks} tick${l.deliveryTicks>1?"s":""})`,mod:"+"+N(T)})}o.push({seller:d?`${e.name} Buyers`:"Local Buyers",sellerType:"LOCAL",nation:e.name||"—",distance:d?l?.deliveryTicks||1:0,condition:100,price:Math.round(u),available:n.newAvailable,delivery:d?l.deliveryTicks+" tick"+(l.deliveryTicks>1?"s":""):"Immediate",deliveryTicks:d?l.deliveryTicks:0,used:!1,priceFactors:y,sourceNationId:e.id})}if(n.usedAvailable>0){const r=n.usedCondition,c=$i(i,e,{used:!0,condition:r});let m=c;const p=[{label:"Base price",value:N(t.basePrice)},{label:`Condition (${r}%)`,mod:"-"+N(Math.max(0,t.basePrice-c))}];if(d&&l){const u=Math.round(c*l.tariff),y=Math.round(c*l.transport);m=c+u+y,p.push({label:`Import tariff (${Math.round(l.tariff*100)}%)`,mod:"+"+N(u)}),p.push({label:`Transport (${l.deliveryTicks} tick${l.deliveryTicks>1?"s":""})`,mod:"+"+N(y)})}o.push({seller:d?`${e.name} Buyers`:"Local Buyers",sellerType:"LOCAL",nation:e.name||"—",distance:d?l?.deliveryTicks||1:0,condition:r,price:Math.round(m),available:n.usedAvailable,delivery:d?l.deliveryTicks+" tick"+(l.deliveryTicks>1?"s":""):"Immediate",deliveryTicks:d?l.deliveryTicks:0,used:!0,priceFactors:p,sourceNationId:e.id})}return o}function mt(){const i=Number(f?.corp_cash_reserves)||0;document.getElementById("em-cash").textContent=N(i);const e=st(J),t=Ye[e?.tier||1],n=document.getElementById("em-tier-badge");n&&(n.textContent=t.tag,n.style.color=t.color),n.style.background=t.color+"0a",n.style.border="1px solid "+t.color+"33";const o=document.getElementById("em-nation-select");if(o&&o.options.length===0){const d=S?.name||f?.nation||"—";let l=`<option value="">${x(d)} (HQ)</option>`;for(const r of ot)r.id!==S?.id&&(l+=`<option value="${r.id}">${x(r.name)}</option>`);o.innerHTML=l}const s=document.getElementById("em-import-tag"),a=Se&&S&&Se.id!==S.id;s&&(s.style.display=a?"":"none"),Un(),oi()}function Un(){let i="";for(let e=1;e<=3;e++){const t=Ye[e],n=Gt(e),o=e===3?"em-selector__grid em-selector__grid--t3":"em-selector__grid em-selector__grid--t12";i+=`<div class="em-selector__row">
            ...
            </div>`),e+="</div>"}const t=$e[ce];if(t){const n=st(J),o=Ye[n?.tier||1],s=Math.min(t.available,4),a=t.price*pe,d=(Number(f?.corp_cash_reserves)||0)>=a;e+=`<div class="em-purchase"><div class="em-purchase__box">
            ...
            <div class="em-purchase__total">
        ...
        </div></div>`}i.innerHTML=e}async function Gn(i){if(!i)Se=null;else{let t=ot.find(n=>n.id===i);if(!t)try{const{data:n}=await _.from("nations").select("*").eq("id",i).single();t=n}catch{}Se=t||null}ce=0,pe=1;const e=document.getElementById("em-nation-select");e&&(e.value=i||""),mt()}function Wn(i){J=i,ce=0,pe=1,mt()}function Fn(i){ce=i,pe=1,oi()}function Vn(i){pe=i,oi()}let Bt=!1;async function Yn(){if(Bt)return;const i=$e[ce];if(!i||!f)return;const e=st(J);if(!e)return;const t=pe,n=i.price*t,o=Number(f.corp_cash_reserves)||0;if(n>o){alert("Insufficient cash reserves.");return}if(t>i.available){alert("Not enough units available.");return}const s=document.querySelector(".em-purchase-btn");s&&(s.disabled=!0,s.textContent="..."),Bt=!0;try{const a=o-n,{error:d}=await _.from("factions").update({corp_cash_reserves:a}).eq("id",f.id);if(d)throw d;const l=!i.deliveryTicks||i.deliveryTicks===0;if(l){const c=oe.find(A=>A.equipment_key===J),m=(c?.owned||0)+t,p=c?.purchase_price_avg||0,u=c?.owned||0,y=u>0?Math.round((p*u+i.price*t)/m):i.price,v=e.maintenancePerUnit*m,h=c?.condition||100,T=Math.round((h*u+i.condition*t)/m),{error:E}=await _.from("corp_equipment").upsert({faction_id:f.id,nation_id:f.nation_id,equipment_key:J,tier:e.tier,owned:m,deployed:c?.deployed||0,condition:T,maintenance_per_tick:v,purchase_price_avg:y,last_purchased_tick:O?.current_tick||null,updated_at:new Date().toISOString()},{onConflict:"faction_id,equipment_key"});if(E){const{error:A}=await _.from("factions").update({corp_cash_reserves:o}).eq("id",f.id);throw A&&console.error("Cash refund failed:",A.message),E}c?(c.owned=m,c.condition=T,c.maintenance_per_tick=v):oe.push({equipment_key:J,tier:e.tier,owned:m,deployed:0,condition:T,maintenance_per_tick:v,assigned_projects:[]})}else{const c=(O?.current_tick||0)+i.deliveryTicks,{error:m}=await _.from("corp_equipment_deliveries").insert({faction_id:f.id,equipment_key:J,quantity:t,condition:i.condition,delivery_tick:c,source_nation_id:i.sourceNationId||null,seller_name:i.seller,price_paid:n});if(m){const{error:p}=await _.from("factions").update({corp_cash_reserves:o}).eq("id",f.id);throw p&&console.error("Cash refund failed:",p.message),m}}f.corp_cash_reserves=a,ai(),mt();const r=document.getElementById("pr-cash");r&&(r.textContent=N(a)),s&&(s.textContent=l?"PURCHASED":"ORDERED",setTimeout(()=>{s.isConnected&&(s.disabled=!1,s.textContent="PURCHASE")},1500))}catch(a){s&&(s.disabled=!1,s.textContent="PURCHASE"),alert("Purchase failed: "+(a.message||"Unknown error"))}finally{Bt=!1}}let Qn=-1,Fe=[],Jt=[],Hi=[];function Nt(i){return Math.abs(i)>=1e6?"$"+(i/1e6).toFixed(1)+"M":Math.abs(i)>=1e3?"$"+(i/1e3).toFixed(0)+"k":"$"+i.toLocaleString()}function Kn(i,e,t){if(t)return"var(--orange)";const n=i/(e||1)*100;return n>50?"var(--green)":n>25?"var(--amber)":"var(--red)"}function Jn(){const i=document.getElementById("pm-list"),e=Fe.length,t=Jt.length,n=Hi.length,o=Fe.filter(l=>l.expiring_soon).length;document.getElementById("pm-active-count").textContent=`(${e})`,document.getElementById("pm-pending-count").textContent=`(${t})`,document.getElementById("pm-apply-count").textContent=`(${n})`;const s=document.getElementById("pm-badges");let a="";o>0&&(a+=`<span class="pm-badge pm-badge--expiring">${o} EXPIRING</span>`),t>0&&(a+=`<span class="pm-badge pm-badge--pending">${t} PENDING</span>`),s.innerHTML=a;const d=Fe.reduce((l,r)=>l+(r.cost||0),0)+Jt.reduce((l,r)=>l+(r.cost||0),0);document.getElementById("pm-total-cost").textContent=Nt(d),document.getElementById("pm-footer-active").textContent=e,document.getElementById("pm-footer-pending").textContent=t;{if(e===0){i.innerHTML=`<div class="pm-empty">
            ...
            </div>`;return}let l="";Fe.forEach((r,c)=>{const m=Qn===c,p=Kn(r.ticks_left,r.total_ticks,r.expiring_soon),u=Math.min(r.ticks_left/(r.total_ticks||1)*100,100);l+=`<div class="pm-item ${r.expiring_soon?"pm-item--expiring":""} ${m?"expanded":""}" onclick="togglePmExpand(${c})">
                <div class="pm-item__inner">
                    ...
                    <div class="pm-bar"><div class="pm-bar__fill" style="width:${u}%;background:${p}"></div></div>`,m&&(l+=`<div class="pm-detail">
            ...
            <div class="dl-item__inner" style="border-left:2px solid ${v}">
                ...
                <div class="dl-summary-bar">
                    ...
                    <div class="dl-summary-cell" style="flex:1.3;">
                        ...
                        <div class="dl-summary-value" style="color:${p?"var(--green)":"var(--red)"};margin-top:2px;">${p?"+":""}${de(m)}</div>
                    </div>
                </div>`,r){const T=d.inspection||{};a+='<div style="margin-top:8px;">',a+='<div class="dl-section-label">Inspection Report</div>',["materials","structural","systems"].forEach(C=>{const b=T[C]||{score:0,issues:[]},I=ki(b.score),k=Math.min(b.score/100*100,100);a+=`<div class="dl-inspect-row">
                    <div class="dl-inspect-row__header">
                        <span class="dl-inspect-row__label">${x(C.charAt(0).toUpperCase()+C.slice(1))}</span>
                        <div class="dl-inspect-row__score-area">
                            <div class="dl-inspect-bar"><div class="dl-inspect-bar__fill" style="width:${k}%;background:${I}"></div></div>
                            <span class="dl-inspect-row__score" style="color:${I}">${b.score}</span>
                        </div>
                    </div>
                ...
                ${(E.issues||[]).map(C=>`<div class="dl-inspect-issue dl-inspect-issue--red">${x(C)}</div>`).join("")}
            </div>`,a+='<div class="dl-section-label" style="margin-top:8px;">Material Quality Impact</div>',a+='<div style="display:flex;gap:4px;flex-wrap:wrap;margin-bottom:8px;">',(d.materials_used||[]).forEach(C=>{const b=C.grade==="HIGH"?"var(--green)":C.grade==="STANDARD"?"var(--amber)":"var(--orange)",I=C.impact==="positive"?"▲":C.impact==="negative"?"▼":"–",k=C.impact==="positive"?"var(--green)":C.impact==="negative"?"var(--red)":"var(--text-dim)";a+=`<div class="dl-mat-tag">
                    <span class="dl-mat-tag__name">${x(C.name)}</span>
                    <div class="dl-mat-tag__dot" style="background:${b}"></div>
                    <span class="dl-mat-tag__grade" style="color:${b}">${x(C.grade)}</span>
                    <span class="dl-mat-tag__impact" style="color:${k}">${I}</span>
        ...
        </div>`;const o={};for(const d of oe)o[d.equipment_key]=d;let s="";for(let d=1;d<=3;d++){const l=Ye[d],r=Gt(d),c=Vt===d,m=r.reduce((u,y)=>u+(o[y.key]?.owned||0),0),p=r.reduce((u,y)=>u+(o[y.key]?.deployed||0),0);if(s+=`<div class="eq-tier-hdr" onclick="toggleEqTier(${d})">
            ...
            ${m>0?`<span class="eq-tier-hdr__count">${p}/${m}</span>`:'<span class="eq-tier-hdr__none">NONE OWNED</span>'}
        </div>`,c)for(const u of r){const y=o[u.key],v=y?.owned||0,h=y?.deployed||0,T=y?.condition||0,E=u.maintenancePerUnit*v,A=v-h,$=v>0&&A===0,C=v>0&&T<65,b=Ti(T),I=y?.assigned_projects||[],k=I.length>0?I.map(w=>w.contract_name||"Project").join(", ").slice(0,30):v>0&&h>0?h+" project"+(h>1?"s":""):"—";s+=`<div class="eq-row${v===0?" unowned":""}">`,s+=`<div class="eq-row__top">
                    ...
                    ${v>0?`<div class="eq-row__right">
                            <div style="display:flex;gap:3px">
                                <span class="eq-row__free" style="color:${$?"var(--orange)":"var(--green)"}">${A}</span>
                    ...
                    </div>`:s+='<div class="eq-row__hint">Purchase from Equipment Market →</div>',s+="</div>"}}document.getElementById("eq-list").innerHTML=s;const a=[1,2,3].map(d=>{const l=Ye[d],r=Gt(d).reduce((c,m)=>c+(o[m.key]?.owned||0),0);return`<div class="eq-footer__tier-box" style="border-color:${r>0?l.color+"33":"var(--border-0)"};background:${r>0?l.color+"0a":"transparent"}">
        ...
        <div class="eq-footer__tiers">${a}</div>`}function io(i){Vt=Vt===i?-1:i,ai()}async function no(){if(!f)return;const{data:i,error:e}=await _.from("corp_equipment").select("equipment_key, tier, owned, deployed, condition, maintenance_per_tick, assigned_projects").eq("faction_id",f.id);e?(console.warn("Failed to load equipment:",e.message),oe=[]):oe=i||[],ai()}async function oo(){const{data:{user:i}}=await _.auth.getUser();if(!i){window.location.href="login.html";return}const{data:e}=await _.from("factions").select("*").or(`id.eq.${i.id},linked_user_id.eq.${i.id}`);We=(e||[]).filter(r=>r.nation_id);const t=sessionStorage.getItem("active_faction_id");if(f=We.find(r=>r.id===t)||We.find(r=>r.faction_type==="corporation")||We[0],!f){await _.auth.signOut(),window.location.href="login.html";return}if(f.faction_type!=="corporation"){window.location.href="dashboard.html";return}const[n,o]=await Promise.all([f.nation_id?_.from("nations").select("*").eq("id",f.nation_id).single():Promise.resolve({data:null}),_.from("shard").select("current_tick, current_date, next_tick_at, tick_interval_hours").eq("name","Alpha Shard").single()]);n.error&&console.warn("Nation load failed:",n.error.message),n.data&&(S=n.data),o.error&&console.warn("Shard load failed:",o.error.message),O=o.data;const s=f.corp_ticker||f.abbreviation||"";if(document.getElementById("corp-logo").textContent=s.slice(0,2)||"—",document.getElementById("corp-name-bar").textContent=f.faction_name||"Unnamed Corp",O){if(document.getElementById("game-date").textContent=O.current_date||"—",document.getElementById("tick-number").textContent=O.current_tick||"—",O.next_tick_at){const c=(Number(O.tick_interval_hours)||8)*36e5,m=new Date(O.next_tick_at).getTime(),u=m-c+c/2;Yt=new Date(u>Date.now()?u:m+c/2),fn()}const r=document.querySelector("#tick-countdown")?.closest(".tick-item")?.querySelector(".tick-label");r&&(r.textContent="Next Corp Tick")}document.getElementById("corp-name-badge").textContent=(s?"["+s+"]":f.faction_name||"Corp")+" ▾";const a=document.getElementById("topbar-cash");if(a){const r=Number(f.corp_cash_reserves??0),c=r>=1e9?"$"+(r/1e9).toFixed(1)+"B":r>=1e6?"$"+(r/1e6).toFixed(1)+"M":"$"+Math.round(r/1e3)+"k";a.textContent="CASH: "+c}const d=f.action_points??0;document.getElementById("topbar-ap").innerHTML='<span class="topbar-ap__count">'+d+" AP</span>",document.getElementById("nation-pill").textContent=(S?.name||f.nation||"—").toUpperCase();const l=document.getElementById("corp-faction-dropdown");if(l){let r="";for(const c of We){const m=c.id===f.id,p=c.faction_type==="corporation"?"CORP":"PARTY",u=c.faction_type==="corporation"?"var(--teal)":"var(--amber)";r+=`<div class="corp-dd-item${m?" active":""}" onclick="switchToFaction('${c.id}', '${c.faction_type}')">
...
Firing workers — no cost.`;if(confirm(s)){qt=!0;try{const a={};for(const r of Me){const c=Number(f?.[r.factionKey]??0);a[r.factionKey]=Math.max(0,c+W[r.id])}e>0&&(a.corp_cash_reserves=Math.max(0,t-Math.round(e)));const{error:d}=await _.from("factions").update(a).eq("id",f.id);if(d)throw d;Object.assign(f,a),W={general:0,skilled:0,innovative:0};const l=document.getElementById("topbar-cash");if(l){const r=Number(f.corp_cash_reserves??0);l.textContent="CASH: "+(r>=1e6?"$"+(r/1e6).toFixed(1)+"M":"$"+Math.round(r/1e3)+"k")}ut()}catch(a){alert("Error: "+a.message)}finally{qt=!1}}}function ut(){const i=document.getElementById("hf-card-container");if(!i)return;const e="'JetBrains Mono', monospace",t={bg:"#121210",surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",greenBright:"#5c5",red:"#c55",redDim:"#a44",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},n=Number(S?.minimum_wage??50),o=Number(S?.inflation??50),s=Number(S?.standard_of_living??50),a=n/100*48e3,d=(1+(o-50)/100*.5).toFixed(2),l=(1+(s-50)/100*.5).toFixed(2),r=S?.name||f?.nation||"Nation",c=Object.values(W).some(E=>E!==0),m=ft();let p=0,u=0,y=0,v=0,h="";for(const E of Me){const A=Number(f?.[E.factionKey]??0),$=W[E.id],C=A+$,b=ji(E.multiplier),I=$>0,k=A*b,w=C*b,q=w-k;p+=A,u+=C,y+=k,v+=w;const L=$!==0?I?"rgba(92,204,92,0.02)":"rgba(204,85,85,0.02)":"transparent";h+=`
        <div style="padding:10px 14px;border-bottom:1px solid ${t.border};background:${L};">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px;">
                ...
                <div style="display:flex;align-items:baseline;gap:4px;">
                    ...
                    ${$!==0?`<span style="font-family:${e};font-size:10px;color:${t.dim}">→</span>
            ...
            <div style="display:flex;align-items:center;gap:4px;">
                ...
                <div style="flex:1;text-align:center;padding:2px 0;background:${$!==0?t.card:"transparent"};border:1px solid ${$!==0?t.border:"transparent"}">
                    ${$!==0?`<div style="display:flex;align-items:center;justify-content:center;gap:6px;">
                        <span style="font-family:${e};font-size:12px;font-weight:700;color:${I?t.greenBright:t.red}">${I?"+":""}${$}</span>
            ...
            ${$!==0?`<div style="margin-top:6px;padding:4px 8px;background:${t.bg};border:1px solid ${t.border};display:flex;justify-content:space-between;align-items:center;">
    ...
    </div>`}let U=[];async function Xe(){if(!f?.id)return;const{data:i}=await _.from("corp_properties").select("*").eq("faction_id",f.id).eq("is_active",!0).order("type",{ascending:!1}).order("purchased_at_tick",{ascending:!1});U=i||[]}function yt(){const i=document.getElementById("property-card-container");if(!i)return;const e="'JetBrains Mono', monospace",t={surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",green:"#4a8",red:"#c55",gold:"#c8a832",orange:"#c84",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},n=(S?.name||f?.nation||"Nation").toUpperCase(),o=1+(Number(S?.inflation??50)-50)/100*.3;let s="",a=0,d=0;const l=S?.name||f?.nation||"Home Nation",r=5e7,c=1+(Number(S?.inflation??50)-50)/100*.3,m=.8+Number(S?.stability??50)/100*.4,p=Math.round(r*c*m),u=Math.round(p*.005);a+=p,d+=u,s+=`
    <div style="padding:8px 12px;border-bottom:1px solid ${t.border};">
    ...
    </div>`}function fo(i){Q=Q===i?null:i,vt()}let Rt=!1;async function uo(){if(Q===null||Rt)return;const i=Re[Q];if(!i)return;const e=Number(f?.corp_cash_reserves??0);if(i.adjusted_cost>e){alert(`Insufficient cash reserves.
...
All construction corporations in `+e+" can now bid on this project.")}catch(i){alert("Failed to submit project: "+i.message)}finally{Pt=!1}}}function Fi(){if(document.getElementById("cp-modal-overlay")?.remove(),!ri)return;const i="'JetBrains Mono', monospace",e={surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",redDim:"#a44",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},t=Wi(),n=S?.name||f?.nation||"Nation",o=Ee[M.style]?.repGain||1,s=o>=4?e.gold:o>=3?e.greenBright:o>=2?e.accent:e.dim,a=Object.entries(Ee).map(([r,c])=>{const m=M.style===r;return`<div onclick="cpSetField('style','${r}')" style="padding:5px 6px;cursor:pointer;text-align:center;background:${m?c.color+"18":"transparent"};border:1px solid ${m?c.color+"44":e.border};">
        ...
        <div style="padding:12px 16px;overflow:auto;flex:1;">
            ...
            <div style="margin-bottom:12px;">
                ...
                <div style="display:flex;gap:4px;">
                    ${["Regional HQ","Office Building",...f?.corp_sector==="Construction"?["Warehouse"]:[]].map(r=>`<span onclick="cpSetField('type','${r}')" style="flex:1;text-align:center;padding:5px 0;font-family:${i};font-size:9px;font-weight:700;cursor:pointer;color:${M.type===r?"#000":e.dim};background:${M.type===r?r==="Warehouse"?e.orange:e.accent:"transparent"};border:1px solid ${M.type===r?r==="Warehouse"?e.orange:e.accent:e.border}">${r}</span>`).join("")}
    ...
    </div>`,document.body.appendChild(d);const l=document.getElementById("cp-name-input");l&&l.addEventListener("input",r=>{M.name=r.target.value}),d.addEventListener("click",r=>{r.target===d&&li()})}function bo(){const i=document.getElementById("cp-name-input");if(i&&(M.name=i.value),!M.name.trim()){alert("Please enter a building name.");return}go()}window.cpClose=li;window.cpSetField=vo;window.cpSubmitFromModal=bo;window.npSelect=fo;window.npBuyProperty=uo;window.npOpenConstructionModal=yo;let De=!1;async function xo(i){if(De)return;const e=U.find(d=>d.id===i);if(!e)return;const t=1+(Number(S?.inflation??50)-50)/100*.3,n=Math.round((e.purchase_price||0)*.1*t),o=Number(f?.corp_cash_reserves??0);if(n>o){alert("Insufficient cash. Refurbishment costs "+g(n)+" (inflation-adjusted), you have "+g(o));return}if(e.condition>=95){alert("Property is already in excellent condition ("+e.condition+"%).");return}const s=5+Math.floor(Math.random()*21),a=Math.min(100,e.condition+s);if(confirm('Refurbish "'+e.name+`"?

Cost: `+g(n)+`
Expected improvement: +`+s+"% condition ("+e.condition+"% → "+a+"%)")){De=!0;try{await _.from("corp_properties").update({condition:a}).eq("id",i);const d=Math.max(0,o-n);await _.from("factions").update({corp_cash_reserves:d}).eq("id",f.id),f.corp_cash_reserves=d;const l=document.getElementById("topbar-cash");l&&(l.textContent="CASH: "+(d>=1e6?"$"+(d/1e6).toFixed(1)+"M":"$"+Math.round(d/1e3)+"k")),await Xe(),yt(),alert("Refurbished! Condition: "+e.condition+"% → "+a+"%")}catch(d){alert("Refurbishment failed: "+d.message)}finally{De=!1}}}async function $o(i){if(De)return;const e=U.find(s=>s.id===i);if(!e)return;const t=1+(Number(S?.inflation??50)-50)/100*.3,n=(e.condition||50)/100,o=Math.round((e.purchase_price||0)*.6*n*t);if(confirm('Sell "'+e.name+`"?

Sale value: `+g(o)+" (60% × "+e.condition+`% condition × inflation)

The property will go back on the market for 6 ticks.
This cannot be undone.`)){De=!0;try{await _.from("corp_properties").update({is_active:!1}).eq("id",i);const a=Number(f?.corp_cash_reserves??0)+o;await _.from("factions").update({corp_cash_reserves:a}).eq("id",f.id),f.corp_cash_reserves=a;const l=(await _.from("shard").select("current_tick").eq("name","Alpha Shard").single()).data?.current_tick||0;await _.from("available_properties").insert({nation_id:f.nation_id,catalog_id:e.catalog_id||null,name:e.name,type:e.type,style:e.style,capacity:e.capacity,price:Math.round(o*1.1),monthly_maintenance:e.monthly_maintenance,condition:e.condition,city:e.city,generated_at_tick:l,expires_at_tick:l+6,status:"available"});const r=document.getElementById("topbar-cash");r&&(r.textContent="CASH: "+(a>=1e6?"$"+(a/1e6).toFixed(1)+"M":"$"+Math.round(a/1e3)+"k")),await Xe(),yt(),await si(),vt(),alert('Sold "'+e.name+'" for '+g(o))}catch(s){alert("Sale failed: "+s.message)}finally{De=!1}}}window.propRefurbish=xo;window.propSell=$o;const he={SALE:.8,DISSOLVE:.6,REVENUE_BASE:.02,GDP_NEUTRAL:30,DEFAULT_REPUTATION:25};function _o(i){if(!i)return 0;const e=i.trim().replace(/[$,]/g,""),t=e.match(/^([\d.]+)\s*[Mm]$/),n=e.match(/^([\d.]+)\s*[Kk]$/);return Math.round(t?parseFloat(t[1])*1e6:n?parseFloat(n[1])*1e3:parseFloat(e))}function Ue(i){const e=document.getElementById("topbar-cash");e&&(e.textContent="CASH: "+(i>=1e6?"$"+(i/1e6).toFixed(1)+"M":"$"+Math.round(i/1e3)+"k"))}function ho(i){return Ge.find(e=>e.id===i)?.name||"—"}function di(i){return U.filter(e=>e.nation_id===i)}async function ci(){Pe=0,await Xe(),yt(),gt(),bt()}let re=!1,Pe=0,it={};async function wo(){if(f?.id)try{const{data:i}=await _.from("construction_contracts").select("nation_id").eq("awarded_to_faction",f.id).in("status",["in_progress","awarded"]);it={};for(const e of i||[])e.nation_id&&(it[e.nation_id]=(it[e.nation_id]||0)+1)}catch{}}function Vi(i){const e=di(i.nation_id),t=e.reduce((y,v)=>y+Number(v.purchase_price||0),0),n=e.reduce((y,v)=>y+Number(v.capacity||0),0),o=it[i.nation_id]||0,s=Ge.find(y=>y.id===i.nation_id),a=(i.name||"").trim().split(/\s+/),d=a.length>=2?a.map(y=>y[0]).join("").toUpperCase().slice(0,4):(i.name||"SUB").slice(0,4).toUpperCase(),l=Number(i.sub_cash||0),r=Number(s?.gdp_growth??50),c=l*he.REVENUE_BASE,m=(r-he.GDP_NEUTRAL)/100,p=he.DEFAULT_REPUTATION/100,u=l>0?Math.round(c*(1+m)*p):0;return{id:i.id,name:i.name,abbr:d,nation:s?.name||i.city||"—",nationId:i.nation_id,sector:f?.corp_sector||"General",subsector:i.subsector||f?.corp_subsector||"—",revenue:u,debt:0,cash:l,reputation:he.DEFAULT_REPUTATION,valuation:t,workforce:n,projects:o,established:i.created_at?new Date(i.created_at).getFullYear().toString():"—",trend:r>=40&&l>0?"up":r>=he.GDP_NEUTRAL&&l>0?"flat":"down",profitable:u>0}}function gt(){const i=document.getElementById("manage-subsidiaries-container");if(!i)return;const e="'JetBrains Mono', monospace",t={surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",greenDark:"#2a5a3a",red:"#c55",redDim:"#a44",yellow:"#ca5",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},o=U.filter(c=>c.type==="regional_hq").map(Vi);Pe>=o.length&&(Pe=0);const s=o[Pe]||null;let a="";o.length===0&&(a=`<div style="padding:30px 14px;text-align:center;font-family:${e};font-size:10px;color:${t.dim}">No subsidiaries established.<br>Use Create Subsidiary to expand.</div>`);let d=0,l=0;for(let c=0;c<o.length;c++){const m=o[c],p=c===Pe;d+=m.revenue,l+=m.valuation;const u=m.trend==="up"?t.greenBright:m.trend==="down"?t.red:t.dim,y=m.trend==="up"?"▲":m.trend==="down"?"▼":"–";a+=`
        <div onclick="selectSubsidiary(${c})" style="display:flex;align-items:center;padding:7px 14px;border-bottom:1px solid ${t.border};cursor:pointer;border-left:2px solid ${p?t.accent:"transparent"};background:${p?"rgba(139,154,107,0.03)":"transparent"};">
            ...
            <span style="width:55px;font-family:${e};font-size:9px;font-weight:700;color:${m.profitable?t.greenBright:t.redDim};text-align:right">${g(m.revenue)}</span>
            ...
            <span style="width:55px;font-family:${e};font-size:9px;color:${t.muted};text-align:right">${g(m.valuation)}</span>
...
This cannot be undone.`)){re=!0;try{const u=r.map(v=>v.id);await _.from("corp_properties").update({is_active:!1,sub_cash:0}).in("id",u);const y=Number(f?.corp_cash_reserves??0)+p;await _.from("factions").update({corp_cash_reserves:y}).eq("id",f.id),f.corp_cash_reserves=y,Ue(y),await ci(),alert("Subsidiary "+a+". "+r.length+` properties liquidated.
Total received: `+g(p))}catch(u){alert("Failed: "+u.message)}finally{re=!1}}}function ko(i){Yi(i,"sell")}function Eo(i){Yi(i,"dissolve")}async function Qi(i,e){if(re)return;const t=U.find(m=>m.id===i);if(!t)return;const n=Number(f?.corp_cash_reserves??0),o=Number(t.sub_cash||0),s=e?"WITHDRAW":"INJECT CAPITAL";if(e&&o<=0){alert("This subsidiary has no cash to withdraw.");return}const a=e?o:n,d=prompt(s+(e?" from ":" into ")+t.name+`
...
Parent: `+g(n)+" → "+g(r)+`
Subsidiary: `+g(o)+" → "+g(c))){re=!0;try{await Promise.all([_.from("factions").update({corp_cash_reserves:r}).eq("id",f.id),_.from("corp_properties").update({sub_cash:c}).eq("id",i)]),f.corp_cash_reserves=r,t.sub_cash=c,Ue(r),gt(),alert((e?"Withdrew ":"Injected ")+g(l)+(e?" from ":" into ")+t.name+".")}catch(m){alert("Failed: "+m.message)}finally{re=!1}}}function To(i){Qi(i,!1)}function Co(i){Qi(i,!0)}async function Io(i){if(re)return;const e=U.find(v=>v.id===i);if(!e)return;const t=Vi(e);t.nation;const n=di(e.nation_id),o=t.valuation,s=t.cash,a=t.reputation,d=t.subsector,l=Math.round(o*2.25),r=Math.round(a*.1),c=Math.round(a*.2),m=ft(),p=Me.reduce((v,h)=>v+Number(f?.[h.factionKey]??0),0),u=Math.max(0,m-p),y=Number(f?.corp_cash_reserves??0);if(l>y){alert(`Insufficient cash to acquire subsidiary.
...
This cannot be undone.`)){re=!0;try{const v=f.nation_id;if(n.length>0){const I=n.filter(w=>w.id!==e.id).map(w=>w.id);if(I.length>0){const{error:w}=await _.from("corp_properties").update({nation_id:v,type:"office"}).in("id",I);if(w)throw w}const{error:k}=await _.from("corp_properties").update({nation_id:v,type:"office",sub_cash:0,subsector:null}).eq("id",e.id);if(k)throw k}const h=y-l+s,E=Number(f?.corp_general_workforce??0)+u,A=Math.random()>=.5?r:-c,$=Number(f?.standing??50),C=Math.max(0,Math.min(100,$+A)),{error:b}=await _.from("factions").update({corp_cash_reserves:h,corp_general_workforce:E,standing:C}).eq("id",f.id);if(b)throw b;f.corp_cash_reserves=h,f.corp_general_workforce=E,f.standing=C,Ue(h),await ci(),alert(`Merger complete!

"`+e.name+`" absorbed into your corporation.
Cost: `+g(l)+" | Cash absorbed: "+g(s)+`
Reputation `+(A>=0?"+":"")+A+" (now "+C+`)
Workers hired: +`+u.toLocaleString()+` general workforce
Properties: `+n.length+" transferred to parent")}catch(v){alert("Merge failed: "+v.message)}finally{re=!1}}}window.subDissolve=Eo;window.subInjectCapital=To;window.subWithdraw=Co;window.subMerge=Io;window.subSell=ko;window.selectSubsidiary=function(i){Pe=i,gt()};let Ge=[],Ve={},Z=null,Ot=!1,ze="",Qe="",Le="";const So={Construction:[{id:"civil",name:"Civil Engineering",mod:0},{id:"industrial",name:"Industrial Construction",mod:.25},{id:"mega",name:"Megaprojects",mod:.4}],Finance:[{id:"banking",name:"Banking",mod:0},{id:"insurance",name:"Insurance",mod:.15},{id:"investment",name:"Investment Management",mod:.3}],Technology:[{id:"software",name:"Software Development",mod:0},{id:"hardware",name:"Hardware Manufacturing",mod:.2},{id:"telecom",name:"Telecommunications",mod:.35}],Energy:[{id:"oil_gas",name:"Oil & Gas",mod:0},{id:"renewables",name:"Renewables",mod:.2},{id:"mining",name:"Mining",mod:.3}],Healthcare:[{id:"pharma",name:"Pharmaceuticals",mod:0},{id:"hospitals",name:"Hospital Systems",mod:.2},{id:"biotech",name:"Biotechnology",mod:.35}]};async function Mo(){const{data:i,error:e}=await _.from("nations").select("*").order("name");e&&console.warn("[Subsidiary] Failed to load nations:",e.message),Ge=(i||[]).filter(n=>n.id!==f?.nation_id);const{data:t}=await _.from("factions").select("nation_id").eq("faction_type","corporation").is("abandoned_at",null);Ve={};for(const n of t||[])n.nation_id&&(Ve[n.nation_id]=(Ve[n.nation_id]||0)+1);Le=f?.corp_subsector||""}function Ki(){const i=f?.corp_sector||"";return So[i]||[{id:"general",name:i||"General",mod:0}]}function Ao(){const e=Ki().find(t=>t.name===Le);return e?e.mod:0}function Xt(i){const e=Number(i.standard_of_living??50);return Math.max(.5,Math.round(e/50*100)/100)}function Ji(i){const t=1+Ao(),n=Xt(i);return Math.round(Math.max(1e7,5e7*t*n))}function zo(i){const e=Ve[i]||0;return e<=1?{label:"HIGH",color:"#5c5"}:e<=3?{label:"MODERATE",color:"#ca5"}:{label:"LOW",color:"#c55"}}function Lo(i){if(Z=Z===i?null:i,Z){const e=Ge.find(t=>t.id===Z);ze=(f?.faction_name||"Subsidiary")+" "+(e?.name||"")}else ze="";bt()}function Bo(i){Le=i,bt()}function No(i){ze=i}function qo(i){Qe=i.toUpperCase().slice(0,4)}async function Ro(){if(Ot||!Z)return;const i=Ge.find(a=>a.id===Z);if(!i)return;const e=(ze||"").trim(),t=(Qe||"").trim();if(!e){alert("Please enter a corporation name for the subsidiary.");return}if(t.length<2){alert("Please enter an abbreviation (2-4 chars).");return}if(U.find(a=>a.nation_id===i.id&&a.type==="regional_hq")){alert("You already have a subsidiary in "+i.name);return}const o=Ji(i),s=Number(f?.corp_cash_reserves??0);if(o>s){alert("Insufficient cash. Entry cost: "+g(o)+", available: "+g(s));return}if(confirm("Establish subsidiary in "+i.name+`?
...
Deducted from cash reserves.`)){Ot=!0;try{const d=(await _.from("shard").select("current_tick").eq("name","Alpha Shard").single()).data?.current_tick||0,l=85+Math.floor(Math.random()*16),r=Math.round(o*.005),{error:c}=await _.from("corp_properties").insert({faction_id:f.id,nation_id:i.id,name:e,type:"regional_hq",style:"Modern",capacity:500,purchase_price:o,monthly_maintenance:r,condition:l,city:i.capital||i.name,purchased_at_tick:d,is_active:!0,subsector:Le||f?.corp_subsector||null});if(c)throw c;const m=Math.max(0,s-o);await _.from("factions").update({corp_cash_reserves:m}).eq("id",f.id),f.corp_cash_reserves=m,Ue(m),Z=null,ze="",Qe="",await ci(),alert('Subsidiary "'+e+'" established in '+i.name+`!

Cost: `+g(o)+`
Regional HQ created with `+l+"% condition.")}catch(a){alert("Failed: "+a.message)}finally{Ot=!1}}}function bt(){const i=document.getElementById("create-subsidiary-container");if(!i)return;const e="'JetBrains Mono', monospace",t={bg:"#121210",surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",accentBright:"#a3b07e",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",yellow:"#ca5",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},n=f?.corp_sector||"General",o=f?.corp_subsector||"",s=Ki(),a=s.find(b=>b.name===Le)||s[0],d=new Set(U.filter(b=>b.type==="regional_hq").map(b=>b.nation_id)),l=Ge.filter(b=>!d.has(b.id)),r=Z?l.find(b=>b.id===Z):null,c=ze.trim().length>0&&Qe.trim().length>=2&&r!==null;let m=`
    ...
    <div style="padding:6px 14px;border-bottom:1px solid ${t.border};">
        ...
        <div style="display:flex;gap:3px;">
            ${s.map(b=>{const I=b.name===Le,k=b.name===o;return`<div onclick="subSetSubsector('${b.name.replace(/'/g,"\\'")}')" style="flex:1;padding:5px 4px;text-align:center;cursor:pointer;background:${I?t.accent+"18":"transparent"};border:1px solid ${I?t.accent+"44":t.border};">
                    <div style="font-family:${e};font-size:8px;font-weight:700;color:${I?t.accentBright:t.dim}">${b.name}</div>
    ...
    </div>`,u="";if(l.length===0)u=`<div style="padding:20px;text-align:center;font-family:${e};font-size:10px;color:${t.dim}">Subsidiaries in all available nations.</div>`;else for(const b of l){const I=b.id===Z,k=zo(b.id),w=Ve[b.id]||0,q=Math.round(Number(b.standard_of_living??50)),L=Xt(b);u+=`
            <div onclick="subSelectNation('${b.id}')" style="display:flex;align-items:center;padding:4px 8px;margin-bottom:2px;cursor:pointer;background:${I?"rgba(139,154,107,0.04)":"transparent"};border:1px solid ${I?t.accent+"44":t.border};border-left:${I?"2px solid "+t.accent:"2px solid transparent"};">
                <div style="flex:1;">
                    <div style="display:flex;align-items:center;gap:6px;">
                        <span style="font-size:11px;font-weight:600;color:${I?t.text:t.muted}">${b.name}</span>
    ...
    <div style="padding:6px 14px;border-bottom:1px solid ${t.border};">
        ...
        <div>
            ...
            <input type="text" value="${(Qe||"").replace(/"/g,"&quot;")}" oninput="subSetAbbr(this.value)" placeholder="${(f?.faction_name||"CORP").slice(0,2).toUpperCase()+(r?.name||"XX").slice(0,2).toUpperCase()}" maxlength="4" style="width:80px;padding:5px 8px;font-family:${e};font-size:12px;font-weight:700;color:${t.gold};background:${t.card};border:1px solid ${t.border};outline:none;text-align:center;letter-spacing:2px;" />
        </div>
    ...
    <div style="padding:6px 14px;border-bottom:1px solid ${t.border};">
        ...
        <div style="background:${t.card};border:1px solid ${t.border};padding:6px 8px;">
            ${v.map((b,I)=>`<div style="display:flex;align-items:center;gap:6px;padding:2px 0;${I<v.length-1?"border-bottom:1px solid "+t.border:""}">
    ...
    </div>`;const T=5e7,E=a.mod,A=r?Xt(r):null,$=r?Ji(r):null;let C=`
    <div style="background:${t.bg};border:1px solid ${t.border};padding:6px 8px;margin-bottom:6px;">
        ...
        <div style="display:flex;justify-content:space-between;padding:3px 0;">
            ...
            <span style="font-family:${e};font-size:14px;font-weight:700;color:${t.gold}">${r?g($):"—"}</span>
        </div>
    </div>`;i.innerHTML=`
    <div style="width:380px;height:450px;background:${t.surface};border:1px solid ${t.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        <div style="padding:8px 14px;border-bottom:1px solid ${t.border};display:flex;justify-content:space-between;align-items:center;flex-shrink:0;">
    ...
    <div style="width:760px;height:450px;background:${t.surface};border:1px solid ${t.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
    ...
    </div>`}window.corpSelect=Oo;window.corpFilterNation=Do;window.corpSort=Ho;let ae=null,me={},G=120,fe=15,Zt={},Oe=[];async function jo(){if(!se)return;if(je[se.id]){alert("You already have a bid on this contract. Retract it first if you want to re-bid.");return}ae=se,Zt={};try{const{data:t}=await _.from("corp_material_inventory").select("material_key, quantity").eq("faction_id",f.id);for(const n of t||[])Zt[n.material_key]=Number(n.quantity||0)}catch{}Oe=[];try{const{data:t}=await _.from("contract_bids").select("faction_id, bid_price, estimated_quality, status, factions(faction_name, corp_ticker)").eq("contract_id",ae.id).in("status",["pending","won"]);Oe=(t||[]).filter(n=>n.faction_id!==f?.id).map(n=>({name:n.factions?.faction_name||"Unknown",ticker:n.factions?.corp_ticker||"???",price:Number(n.bid_price||0),quality:Number(n.estimated_quality||0),status:n.status}))}catch{}me={};const i=ae.required_materials||{};for(const t of Object.keys(i))me[t]="STD";const e=ae.required_workforce||{};G=Number(e.general||0)+Number(e.skilled||0)||120,fe=15,Je(),$t()}function pi(){document.getElementById("bid-assembly-overlay")?.remove(),ae=null}function Uo(i,e){me[i]=e,$t()}function Go(i){G=i,$t()}function Wo(i){fe=i,$t()}function $t(){if(document.getElementById("bid-assembly-overlay")?.remove(),!ae)return;const i="'JetBrains Mono', monospace",e={surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",accentBright:"#a3b07e",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",redDim:"#a44",yellow:"#ca5",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},t=ae,n=t.issuer_type==="GOVERNMENT",o=S?.name||f?.nation||"—",s=Number(t.budget_ceiling||0),a=Number(t.timeline_ticks||8),d=t.required_materials||{},l=Object.keys(d),r={LOW:.5,STD:1,HIGH:2},c={LOW:e.orange,STD:e.yellow,HIGH:e.greenBright},m={LOW:"Low",STD:"Standard",HIGH:"High"},p={concrete:36e4,steel:5e5,glass_facades:56e4,em_systems:64e4,lumber:24e4,heavy_parts:8e5,aggregate:16e4,asphalt:28e4},u=Zt||{};let y=0,v="";for(const z of l){const D=Number(d[z]||0),yi=me[z]||"STD",vi=p[z]||3e5,tn=r[yi],nn=Math.round(vi*tn),gi=D*nn;y+=gi;const on=z.replace(/_/g," ").replace(/\b\w/g,be=>be.toUpperCase()),bi=Number(u[z]||0),Ct=Math.max(0,D-bi),an=Ct===0?e.greenBright:Ct<D?e.yellow:e.red,sn=Ct===0?"✓ IN STOCK":`${bi}/${D}`;v+=`
        <div style="display:flex;align-items:center;padding:5px 14px;border-bottom:1px solid ${e.border};">
            ...
            <div style="flex:1.2;display:flex;gap:2px;justify-content:center;">
                ${["LOW","STD","HIGH"].map(be=>{const It=yi===be,xi=c[be],rn=g(Math.round(vi*r[be]));return`<span onclick="bidSetGrade('${z}','${be}')" style="padding:2px 6px;font-family:${i};font-size:7px;font-weight:700;cursor:pointer;color:${It?"#000":e.dim};background:${It?xi:"transparent"};border:1px solid ${It?xi:e.border}" title="${rn}/unit">${m[be]}</span>`}).join("")}
            </div>
            <div style="flex:0.8;text-align:right"><span style="font-family:${i};font-size:10px;color:${e.text}">${g(gi)}</span></div>
        </div>`}const h=t.required_workforce||{},T=Number(h.general||0)+Number(h.skilled||0)||100,E=Math.max(40,Math.round(T*.5)),A=T*2,$=[E,Math.round(T*.75),T,Math.round(T*1.5),A],C=Math.max(0,Math.min(1,(G-E)/(A-E||1))),b=a,I=Math.round(4.5-C*8),k=Math.max(Math.round(b*.6),b+I),w=I>0?`+${I}mo`:I<0?`${I}mo`:"On schedule",q=I>0?e.red:I<0?e.greenBright:e.yellow,L=15200,P=G*L*k,K=s,Be=[{name:"Municipal Zoning Approval",cost:18e4,ticks:2,required:!0},{name:"Structural Engineering Cert.",cost:24e4,ticks:3,required:!0},{name:"Environmental Impact Assessment",cost:34e4,ticks:8,required:K>2e7},{name:"Seismic Resilience Compliance",cost:21e4,ticks:4,required:K>5e7},{name:"Heritage Conservation Review",cost:16e4,ticks:6,required:!1},{name:"Fire Safety Certification",cost:12e4,ticks:2,required:K>1e7}].filter(z=>z.required),mi=new Set(["Municipal Zoning Approval","Structural Engineering Cert."]),ht=Be.filter(z=>!mi.has(z.name)).reduce((z,D)=>z+D.cost,0),wt=4e5,kt=y+P+ht+wt,fi=Math.round(kt*(fe/100)),Ze=kt+fi,Y=Ze>s,Et=fi,ve=Y?0:Math.max(0,Math.min(100,Math.round(100-Ze/s*100+30))),ui=ve>70?e.greenBright:ve>40?e.yellow:ve>0?e.orange:e.red,Zi=Y?"OVER CEILING":ve>70?"STRONG":ve>40?"COMPETITIVE":ve>20?"WEAK":"UNLIKELY",Tt=Object.values(me),ge=Tt.length>0?Math.round(Tt.reduce((z,D)=>z+(D==="HIGH"?85:D==="STD"?65:45),0)/Tt.length):50,et=ge>=75?e.greenBright:ge>=55?e.yellow:e.orange,en=ge>=75?"STRONG":ge>=55?"PROMISING":"UNCERTAIN",Ne=document.createElement("div");Ne.id="bid-assembly-overlay",Ne.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.7);display:flex;align-items:center;justify-content:center;z-index:9999;",Ne.addEventListener("click",z=>{z.target===Ne&&pi()}),Ne.innerHTML=`
            ...
            <div style="flex:1;border-right:1px solid ${e.border};overflow:auto;">
                ...
                <div style="padding:8px 14px;border-bottom:1px solid ${e.border};">
                    <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px;">
                        ...
                        <div style="display:flex;gap:3px;">
                            ${$.map(z=>`<span onclick="bidSetWorkers(${z})" style="padding:2px 8px;font-family:${i};font-size:8px;font-weight:700;cursor:pointer;color:${G===z?"#000":e.dim};background:${G===z?e.accent:"transparent"};border:1px solid ${G===z?e.accent:e.border}">${z}</span>`).join("")}
                        </div>
                    </div>
                    <div style="display:flex;justify-content:space-between;">
                ...
                ${Be.map(z=>{const D=mi.has(z.name);return`<div style="display:flex;align-items:center;padding:4px 14px;border-bottom:1px solid ${e.border};">
    ...
    </div>`,document.body.appendChild(Ne)}let He=!1;async function Fo(){if(He||!ae)return;const i=ae,e=i.required_materials||{},t=Object.keys(e),n=Number(i.budget_ceiling||0),o=Number(i.timeline_ticks||8),s={concrete:36e4,steel:5e5,glass_facades:56e4,em_systems:64e4,lumber:24e4,heavy_parts:8e5,aggregate:16e4,asphalt:28e4},a={LOW:.5,STD:1,HIGH:2};let d=0;for(const L of t){const P=Number(e[L]||0),K=me[L]||"STD",ye=s[L]||3e5;d+=P*Math.round(ye*a[K])}const l=15200,r=i.required_workforce||{},c=Number(r.general||0)+Number(r.skilled||0)||100,m=Math.max(40,Math.round(c*.5)),p=c*2,u=Math.max(0,Math.min(1,(G-m)/(p-m||1))),y=Math.round(4.5-u*8),v=Math.max(Math.round(o*.6),o+y),h=G*l*v,T=n,E=[{name:"Municipal Zoning Approval",cost:18e4,required:!0},{name:"Structural Engineering Cert.",cost:24e4,required:!0},{name:"Environmental Impact Assessment",cost:34e4,required:T>2e7},{name:"Seismic Resilience Compliance",cost:21e4,required:T>5e7},{name:"Fire Safety Certification",cost:12e4,required:T>1e7}],A=new Set(["Municipal Zoning Approval","Structural Engineering Cert."]),$=E.filter(L=>L.required&&!A.has(L.name)).reduce((L,P)=>L+P.cost,0),b=d+h+$+4e5,I=Math.round(b*(fe/100)),k=b+I;if(k>n){alert("Bid exceeds budget ceiling. Reduce costs or markup.");return}const w=Object.values(me),q=w.length>0?Math.round(w.reduce((L,P)=>L+(P==="HIGH"?85:P==="STD"?65:45),0)/w.length):50;if(confirm('Submit bid for "'+i.name+`"?
...
Once submitted, your bid cannot be changed.`)){He=!0;try{const{data:L}=await _.from("shard").select("current_tick").eq("name","Alpha Shard").single(),P=L?.current_tick||0,K={};for(const Be of t)K[Be]=me[Be]||"STD";const{error:ye}=await _.from("contract_bids").insert({contract_id:i.id,faction_id:f.id,bid_price:k,material_grades:K,labor_count:G,markup_pct:fe,estimated_cost:b,estimated_quality:q,status:"pending",submitted_at_tick:P});if(ye)throw ye;i.status==="open"&&await _.from("construction_contracts").update({status:"bidding"}).eq("id",i.id).eq("status","open"),pi(),alert(`Bid submitted successfully!
...
Lowest qualified bid wins.`),typeof le=="function"&&await le()}catch(L){alert("Bid submission failed: "+L.message)}finally{He=!1}}}window.openBidAssembly=jo;window.closeBidAssembly=pi;window.bidSetGrade=Uo;window.bidSetWorkers=Go;window.bidSetMarkup=Wo;window.submitBidAssembly=Fo;let Dt=!1;async function Vo(i){if(Dt)return;const e=1e6,t=Number(f?.corp_cash_reserves??0);if(t<e){alert("Cannot retract — you need at least $1M in cash reserves to cover the retraction penalty.");return}if(confirm(`Retract your bid?

This will cost $1M as a retraction penalty.
This action cannot be undone.`)){Dt=!0;try{const n=t-e,{error:o}=await _.from("factions").update({corp_cash_reserves:n}).eq("id",f.id);if(o)throw o;const{error:s}=await _.from("contract_bids").delete().eq("contract_id",i).eq("faction_id",f.id);if(s)throw s;f.corp_cash_reserves=n,typeof Ue=="function"&&Ue(n),alert("Bid retracted. $1M penalty applied."),Je(),await le()}catch(n){alert("Failed to retract bid: "+(n.message||"Unknown error"))}finally{Dt=!1}}}window.retractBid=Vo;let Ke=[],Ce=0,ee=null,Ht=!1,jt=!1,Ut=!1;async function Yo(){if(!se||jt)return;jt=!0,ee=se,Ce=0;const{data:i,error:e}=await _.from("contract_bids").select("*, factions(faction_name, corp_ticker, corp_subsector)").eq("contract_id",ee.id).in("status",["pending","won"]).order("bid_price",{ascending:!0});if(jt=!1,e){alert("Failed to load bids: "+e.message);return}Ke=(i||[]).map(t=>({...t,corp:t.factions?.faction_name||"Unknown",abbr:t.factions?.corp_ticker||"???",subsector:t.factions?.corp_subsector||"—"})),Je(),Xi()}function _t(){document.getElementById("bid-review-overlay")?.remove(),ee=null}function Qo(i){Ce=i,Xi()}async function Ko(){if(Ht||Ke.length===0)return;const i=Ke[Ce];if(!(!i?.id||!i.faction_id)&&confirm("Accept bid from "+i.corp+`?

Bid Price: `+g(i.bid_price)+`
Quality: `+i.estimated_quality+`/100
Workers: `+i.labor_count+`

This will award the contract. The project begins immediately.`)){Ht=!0;try{const{data:e}=await _.from("shard").select("current_tick").eq("name","Alpha Shard").single(),t=e?.current_tick||0,{error:n}=await _.from("contract_bids").update({status:"won"}).eq("id",i.id);if(n)throw n;const{error:o}=await _.from("contract_bids").update({status:"lost"}).eq("contract_id",ee.id).neq("id",i.id);if(o)throw o;const{error:s}=await _.from("construction_contracts").update({status:"awarded",awarded_to_faction:i.faction_id,awarded_at_tick:t}).eq("id",ee.id);if(s)throw s;_t(),alert("Contract awarded to "+i.corp+`!
