...
import{_supabase as g}from"./supabase-client-CiYoFhIh.js";/* empty css                    *//* empty css                         */import{c as Ge,i as ka,a as Ea,l as Ca,M as Bt,Q as Cn,b as Tn,d as fn,e as fi,f as mi,g as Ta,h as Sa}from"./corp-shipping-data-CcJ84lK3.js";import{_ as za}from"./preload-helper-BXl3LOEh.js";import{e as x}from"./utils-CY90Gazr.js";import{initMessaging as Ia}from"./messaging-BUrQna7p.js";import{c as Na,a as mn,E as Pt,b as ko,d as ui,e as Aa,f as Ma,h as ai}from"./equipment-DsuDdEne.js";import{a as Ra,E as lo,b as co,g as La}from"./corp-executives-BOrCkuAI.js";import"./political-actions-BF080n5r.js";import"./config-CRvw5bg0.js";import"./government-types-D9n0pQb0.js";import"./ideology-BqLjustE.js";import"./stats-tIiBSaQA.js";let $e=[],d=null,I=null,z=null,dt=[],wt={},J=[],Z={},un=-1;const qa={em:"em_systems",glass:"glass_facades",heavy:"heavy_parts"},po=o=>qa[o]||o;let de="concrete",X="STD",_e=500,ae=[],vi={},vn=0,Dt=[],jt=[],vt=0,we=null,Ce=-1,ce=[],yi=[],Ft=null,It={},fo={},Sn=[],mo=null,fe="trucks",ke=0,Te=1,qe=[],Ve=null,gi=[],yn=null,to=null,gn="ALL",xn="TIMELINE";function O(o){return Math.abs(o)>=1e6?"$"+(o/1e6).toFixed(1)+"M":Math.abs(o)>=1e3?"$"+(o/1e3).toFixed(0)+"k":"$"+o}function Oa(o){if(o>=12){const e=Math.floor(o/12),t=o%12;return t>0?e+"y "+t+"mo":e+"y"}return o+" ticks"}function xi(o){return!o||o.length===0?"":o.map(e=>{const t=vi[e];if(!t)return"";const n=t.reputation_bonus>0?"var(--green)":t.reputation_bonus<0?"var(--red)":"var(--text-dim)",i=t.reputation_bonus>0?"+"+t.reputation_bonus:t.reputation_bonus<0?String(t.reputation_bonus):"";return`<span style="display:inline-flex;align-items:center;gap:3px;padding:2px 6px;background: var(--border-hair);border:1px solid var(--border-0);border-radius:3px;font-family:var(--font-mono);font-size:7px;color:var(--text-secondary);">${t.icon||"📍"} ${x(t.name)}${i?` <span style="color:${n};font-weight:700;">${i} REP</span>`:""}</span>`}).filter(Boolean).join(" ")}function me(o){return Math.abs(o)>=1e9?"$"+(o/1e9).toFixed(1)+"B":Math.abs(o)>=1e6?"$"+(o/1e6).toFixed(0)+"M":Math.abs(o)>=1e3?"$"+(o/1e3).toFixed(0)+"k":"$"+o}function zn(o){return o==="civil_engineering"?"CIVIL":o==="industrial"?"INDUSTRIAL":o==="mega_project"?"MEGA":o?.toUpperCase()||"—"}function bi(o){return o==="civil_engineering"?"light":o==="industrial"?"heavy":o==="mega_project"?"mega":"light"}function Ba(){to&&clearInterval(to),to=setInterval(()=>{if(!yn)return;const o=yn-Date.now();if(o<=0){document.getElementById("tick-countdown").textContent="Tick due...",clearInterval(to);return}const e=Math.floor(o/36e5),t=Math.floor(o%36e5/6e4),n=Math.floor(o%6e4/1e3);document.getElementById("tick-countdown").textContent=e+"h "+t+"m "+n+"s"},1e3)}function Pa(o,e){o==="type"&&(gn=e),o==="sort"&&(xn=e),document.querySelectorAll(`.filter-pill[data-filter="${o}"]`).forEach(t=>{t.classList.toggle("active",t.dataset.value===e)}),hi()}const ri={"Civil Engineering":"civil_engineering","Industrial Construction":"industrial",Megaprojects:"mega_project"};function _i(o){if(!d)return!1;if(ri[d.corp_subsector]===o.sector)return!0;const t=(Y||[]).filter(n=>n.type==="regional_hq"&&n.is_active&&n.nation_id===o.nation_id);for(const n of t)if(ri[n.subsector]===o.sector)return!0;return!1}function hi(){const o=document.getElementById("oc-list");let e=[...dt];if(gn==="GOVERNMENT"?e=e.filter(i=>i.issuer_type==="GOVERNMENT"):gn==="PRIVATE"&&(e=e.filter(i=>i.issuer_type==="PRIVATE")),xn==="TIMELINE"&&e.sort((i,a)=>(i.timeline_ticks||0)-(a.timeline_ticks||0)),xn==="BUDGET"&&e.sort((i,a)=>(a.budget_ceiling||0)-(i.budget_ceiling||0)),document.getElementById("oc-count").textContent=e.length+" AVAILABLE",e.length===0){o.innerHTML=`
            ...
            </div>`;return}const t=z?.current_tick||0;let n="";for(const i of e){const a=i.issuer_type==="GOVERNMENT",r=a?"gov":"private",s=_i(i),l=s?"":" locked",c=bi(i.sector),f=zn(i.sector),p=(i.timeline_ticks||0)>18?" warn":"",u=i.bidding_ends_tick?Math.max(0,i.bidding_ends_tick-t):"?";n+=`
    ...
    `;const r=document.getElementById("cd-blueprint");o.blueprint_svg?(r.innerHTML=o.blueprint_svg,r.style.display=""):(r.innerHTML=or(o),r.style.display="");const s=o.permits_required||[],l=o.required_equipment||o.equipment_required||{},c=Array.isArray(l)?l.map(N=>({key:N,qty:1})):Object.entries(l).map(([N,P])=>({key:N,qty:P})),f=o.required_materials||o.materials_estimated||{},u={civil_engineering:"Civil Engineering",industrial:"Industrial Construction",mega_project:"Megaprojects"}[o.sector]||o.spec_category||o.sector||"—";let m="var(--teal)";o.sector==="industrial"&&(m="var(--orange)"),o.sector==="mega_project"&&(m="var(--red)");let v=O(o.budget_ceiling||o.budget||0),b=(o.timeline_ticks||o.timeline_months||0)+" Months",y="";y+=`
        <div class="cd-issue">
            ...
            <div style="display:flex;flex-direction:column;gap:6px;">`;for(const N of $){const P=vi[N];if(!P)continue;const F=P.reputation_bonus>0?"var(--green)":P.reputation_bonus<0?"var(--red)":"var(--text-dim)",G=P.cost_multiplier>1?"+"+Math.round((P.cost_multiplier-1)*100)+"% cost":P.cost_multiplier<1?Math.round((1-P.cost_multiplier)*100)+"% cheaper":"",ee=P.reputation_bonus!==0?(P.reputation_bonus>0?"+":"")+P.reputation_bonus+" rep":"",ge=P.required_permits||[];y+=`<div style="padding:6px 10px;background: var(--border-hair);border:1px solid var(--border-hair);border-radius:4px;">
                <div style="display:flex;align-items:center;justify-content:space-between;">
                    <span style="font-weight:600;font-size:0.78rem;color:var(--text-primary);">${P.icon||"📍"} ${x(P.name)}</span>
                ...
                <div style="font-size:0.65rem;color:var(--text-dim);margin-top:2px;">${x(P.description||"")}</div>
            ...
            </div>`}y+="</div></div>"}y+='<div class="cd-details">',o.project_type&&(y+=Le("Type",o.project_type)),o.project_subtype&&(y+=Le("Sub-Type",o.project_subtype)),y+=Le("Specialization",u,m),y+=Le("Total Budget",v,"var(--green)"),y+=Le("Timeline",b),y+=Le("Nation",I?.name||d.nation||"—"),o.region&&(y+=Le("Region",o.region)),y+="</div>",s.length>0&&(y+=`
            <div class="cd-items">
                <div class="cd-section-label">Permits Required</div>
                <div class="cd-items__list">
                    ${s.map(N=>{const P=N.status==="approved"?"approved":"required",F=N.status==="approved"?"&#10003;":"&#9675;";return`<div class="cd-chip ${P}">
            ...
            </div>`),document.getElementById("cd-content").innerHTML=y;const h=s.filter(N=>N.status==="approved").length,E=s.length-h,k=c.length,T=[];for(const N of c){const P=ae.find(F=>F.equipment_key===N.key);P&&P.owned>=N.qty||T.push(N)}const w=T.length,S=o.required_materials||{},A=typeof S=="object"&&!Array.isArray(S)?Object.entries(S):[],C=[];for(const[N,P]of A){const F=Z[N]||{},G=(F.LOW?.qty||0)+(F.STD?.qty||0)+(F.HIGH?.qty||0);G<P&&C.push({key:N,need:P,have:G})}const q=N=>N.replace(/_/g," ").replace(/\b\w/g,P=>P.toUpperCase());let L="";if(k>0)if(w===0)L+='<span class="cd-footer__badge ok">ALL EQUIPMENT MET</span>';else{const N=T.map(P=>q(P.key)).join(", ");L+=`<span class="cd-footer__badge bad" title="${x(N)}">${w} SHORT: ${x(N)}</span>`}if(A.length>0)if(C.length===0)L+='<span class="cd-footer__badge ok">ALL MATERIALS MET</span>';else{const N=C.map(P=>q(P.key)+" ("+P.have+"/"+P.need+")").join(", ");L+=`<span class="cd-footer__badge bad" title="${x(N)}">${C.length} MAT SHORT: ${x(N)}</span>`}s.length>0&&(E===0?L+='<span class="cd-footer__badge ok">ALL PERMITS APPROVED</span>':L+=`<span class="cd-footer__badge warn">${E} PERMITS PENDING</span>`);const M=a,U=o.issuer_faction_id===d?.id,j=o.status==="bidding",H=wt[o.id];document.getElementById("cd-footer").innerHTML=`
        ...
        <div class="cd-footer__actions">
            ...
            ${U?`<button class="cd-btn primary" onclick="openBidReview()" style="background:#c8a832;border-color:#c8a832;"
                    ${j?"":"disabled"} title="${j?"Review submitted bids":"No bids received yet"}">REVIEW BIDS</button>`:H?`<button class="cd-btn primary" onclick="retractBid('${o.id}')" style="background:#c55;border-color:#c55;"
                        title="Retract your bid ($1M penalty)">RETRACT BID</button>`:`<button class="cd-btn primary" onclick="openBidAssembly()" ${M?"":"disabled"}
                        title="${M?"Assemble and submit a bid":"Not qualified for this contract"}">BID</button>`}
        </div>
    `,e.classList.add("open"),document.body.style.overflow="hidden"}function Yt(o){o&&o.target&&o.target!==document.getElementById("cd-overlay")||(document.getElementById("cd-overlay").classList.remove("open"),document.body.style.overflow="",We=null)}const De=["Permits","Planning","Foundation","Structural","Systems","Finishing","Delivery"],si={WEATHER:{color:"var(--blue)",bg:"var(--blue-faint)",border:"var(--blue-border)"},SUPPLY:{color:"var(--gold)",bg:"var(--gold-faint)",border:"var(--gold-border)"},LABOR:{color:"var(--orange)",bg:"var(--orange-faint)",border:"var(--orange-border)"},REGULATORY:{color:"var(--red)",bg:"var(--red-faint)",border:"var(--red-border)"},EQUIPMENT:{color:"var(--amber)",bg:"var(--amber-faint)",border:"var(--amber-border)"},POLITICAL:{color:"var(--teal)",bg:"var(--teal-faint)",border:"var(--teal-border)"}},li={LOW:"var(--green)",MODERATE:"var(--amber)",HIGH:"var(--orange)",CRITICAL:"var(--red)"};let B=null;async function it(o){const e=J.find(N=>N.id===o);if(!e)return;const t=Array.isArray(e.contract_bids)?e.contract_bids[0]:e.contract_bids,n=z?.current_tick||0,i=e.awarded_at_tick||n,a=e.timeline_ticks||8,r=Math.max(0,n-i),s=Math.min(100,r/a*100);let l=Math.min(De.length-1,Math.floor(s/(100/De.length)));const c=Math.round(s%(100/De.length)/(100/De.length)*100),f=e.required_materials||{},p=t?.material_grades||{};let u=[];try{const{data:N}=await g.from("project_material_allocations").select("material_key, quality_tier, quantity, consumed").eq("contract_id",e.id);u=N||[]}catch{}const m={};for(const N of u)m[N.material_key]||(m[N.material_key]={totalAllocated:0,totalConsumed:0,tiers:{}}),m[N.material_key].totalAllocated+=N.quantity,m[N.material_key].totalConsumed+=N.consumed,m[N.material_key].tiers[N.quality_tier]={qty:N.quantity,consumed:N.consumed};const v=Object.entries(f).map(([N,P])=>{const F=p[N]||"STD",G=m[N]||{totalAllocated:0,totalConsumed:0,tiers:{}};return{key:N,name:N.replace(/_/g," ").replace(/\b\w/g,ee=>ee.toUpperCase()),grade:F,required:Number(P),allocated:G.totalAllocated,consumed:G.totalConsumed,tiers:G.tiers,warehouseStock:Z[N]||{}}}),b=e.required_equipment||{},y=e.equipment_condition||{},h=(Array.isArray(b)?b.map(N=>[N,1]):Object.entries(b)).map(([N,P])=>{const F=ae.find(V=>V.equipment_key===N),ee=(F?.assigned_projects||[]).find(V=>V.contract_id===e.id),ge=ee?ee.units:0;return{key:N,name:N.replace(/_/g," ").replace(/\b\w/g,V=>V.toUpperCase()),required:Number(P)||1,ownedTotal:F?.owned||0,deployed:F?.deployed||0,available:Math.max(0,(F?.owned||0)-(F?.deployed||0)),assignedToProject:ge,condition:y[N]??(F?.condition||100)}}),E=e.budget_ceiling||0,k=t?.estimated_cost||0,T=Math.round(k*Math.min(1,r/a)),w=t?.estimated_quality||65,S=w>=75?"EXCELLENT":w>=50?"FAIR":w>=25?"POOR":"BAD",A=e.required_workforce||{},C=e.workers_assigned||{},q=(A.general||0)+(A.skilled||0)+(A.innovative||0),L=(C.general||0)+(C.skilled||0)+(C.innovative||0),M=t?.labor_count||q,U=Number(d?.corp_general_workforce??0),j=Number(d?.corp_skilled_workforce??0),H=Number(d?.corp_innovative_workforce??0);B={project:e,bid:t,tab:"overview",expandedEvent:-1,selectedResponse:null,currentTick:n,awardedTick:i,totalTicks:a,ticksElapsed:r,phaseIdx:l,phaseProgress:c,materials:v,equipment:h,budget:E,estCost:k,spent:T,quality:w,qualityLabel:S,laborCount:M,wfNeeded:q,wfAssigned:L,reqWf:A,assignedWf:C,corpGeneral:U,corpSkilled:j,corpInnovative:H,events:[]},document.getElementById("pm-overlay").classList.add("open"),document.body.style.overflow="hidden",wi(e.id).then(()=>Xe()),Xe()}let W=!1;async function Da(o,e,t){if(!(W||!B||!d)){W=!0;try{const{data:n,error:i}=await g.rpc("allocate_material_to_project",{p_contract_id:B.project.id,p_faction_id:d.id,p_material_key:o,p_quality_tier:e,p_quantity:t});if(i){alert("Allocation failed: "+i.message);return}if(n&&!n.success){alert(n.error||"Allocation failed");return}await Ei(),await it(B.project.id)}catch(n){alert("Allocation error: "+n.message)}finally{W=!1}}}async function ja(o,e,t){if(!(W||!B||!d)){W=!0;try{const{data:n,error:i}=await g.rpc("deallocate_material_from_project",{p_contract_id:B.project.id,p_faction_id:d.id,p_material_key:o,p_quality_tier:e,p_quantity:t});if(i){alert("Return failed: "+i.message);return}if(n&&!n.success){alert(n.error||"Return failed");return}await Ei(),await it(B.project.id)}catch(n){alert("Return error: "+n.message)}finally{W=!1}}}async function Fa(o,e){if(!(W||!B||!d)){W=!0;try{const t=B.project,n=t.workers_assigned||{},i=Number(n[o]||0),a=Number((t.required_workforce||{})[o]||0),r=Number(d?.["corp_"+o+"_workforce"]??0);let s=0;for(const m of J||[])m.id!==t.id&&(s+=Number((m.workers_assigned||{})[o]||0));const l=Math.max(0,r-s-i),c=Math.min(e,a-i,l);if(c<=0){alert(l<=0?"No "+o+" workers available in pool":"Already fully staffed for "+o);return}const f={...n,[o]:i+c},{error:p}=await g.from("construction_contracts").update({workers_assigned:f}).eq("id",t.id);if(p){alert("Assign failed: "+p.message);return}const u=J.find(m=>m.id===t.id);u&&(u.workers_assigned=f),await it(t.id)}catch(t){alert("Assign error: "+t.message)}finally{W=!1}}}async function Ua(o,e){if(!(W||!B||!d)){W=!0;try{const t=B.project,n=t.workers_assigned||{},i=Number(n[o]||0),a=Math.min(e,i);if(a<=0){alert("No "+o+" assigned");return}const r={...n,[o]:i-a},{error:s}=await g.from("construction_contracts").update({workers_assigned:r}).eq("id",t.id);if(s){alert("Unassign failed: "+s.message);return}const l=J.find(c=>c.id===t.id);l&&(l.workers_assigned=r),await it(t.id)}catch(t){alert("Unassign error: "+t.message)}finally{W=!1}}}async function Ha(o,e){if(!(W||!B||!d)){W=!0;try{const t=ae.find(l=>l.equipment_key===o);if(!t){alert("Equipment not found in inventory.");return}const n=Math.max(0,(t.owned||0)-(t.deployed||0));if(n<e){alert("Not enough available "+o+" ("+n+" available).");return}const i=(t.deployed||0)+e,a=[...t.assigned_projects||[]],r=a.find(l=>l.contract_id===B.project.id);r?r.units+=e:a.push({contract_id:B.project.id,contract_name:B.project.name,units:e});const{error:s}=await g.from("corp_equipment").update({deployed:i,assigned_projects:a}).eq("faction_id",d.id).eq("equipment_key",t.equipment_key);if(s){alert("Deploy failed: "+s.message);return}await Ai(),await it(B.project.id)}catch(t){alert("Deploy error: "+t.message)}finally{W=!1}}}async function Ga(o){if(!(W||!B||!d)){W=!0;try{const e=ae.find(s=>s.equipment_key===o);if(!e){alert("Equipment not found.");return}const t=[...e.assigned_projects||[]],n=t.findIndex(s=>s.contract_id===B.project.id);if(n===-1){alert("Equipment not deployed to this project.");return}const i=t[n].units;t.splice(n,1);const a=Math.max(0,(e.deployed||0)-i),{error:r}=await g.from("corp_equipment").update({deployed:a,assigned_projects:t}).eq("faction_id",d.id).eq("equipment_key",e.equipment_key);if(r){alert("Undeploy failed: "+r.message);return}await Ai(),await it(B.project.id)}catch(e){alert("Undeploy error: "+e.message)}finally{W=!1}}}function Va(o){o&&o.target!==document.getElementById("pm-overlay")||(document.getElementById("pm-overlay").classList.remove("open"),document.body.style.overflow="",B=null)}function Wa(o){B&&(B.tab=o,B.expandedEvent=-1,B.selectedResponse=null,Xe())}function Ya(o){B&&(B.expandedEvent=B.expandedEvent===o?-1:o,B.selectedResponse=null,Xe())}function Qa(o){B&&(B.selectedResponse=B.selectedResponse===o?null:o,Xe())}function Xe(){if(!B)return;const o=B,e=o.project,t=e.issuer_type==="GOVERNMENT",n=zn(e.sector),i=d?.nation||"Nation",a=o.awardedTick+o.totalTicks,r=Math.max(0,a-o.currentTick),s=o.currentTick>a,l=o.budget>0?Math.round(o.spent/o.budget*100):0,c=l>85?"var(--red)":l>60?"var(--amber)":"var(--teal)",f=o.budget-o.spent,p=o.events.filter(y=>y.status==="ACTIVE").length;document.getElementById("pm-header").innerHTML=`
...
Insurance corps will see this in their Deal Flow.`);if(t===null)return;const n=t.trim()||"Construction Insurance",i=z.current_tick||0,{error:a}=await g.from("finance_loan_requests").insert({requesting_faction_id:d.id,nation_id:d.nation_id,request_type:"insurance",insured_contract_id:o,amount:e,term_months:0,purpose:n,status:"open",created_tick:i,expires_tick:i+12});if(a){a.message.includes("duplicate")||a.message.includes("unique")?alert("Insurance already requested for this project."):alert("Failed to request insurance: "+a.message);return}alert("Insurance request posted to Deal Flow. Insurance corporations can now offer coverage."),await ki()}window.requestInsurance=er;window.openProjectModal=it;window.closeProjectModal=Va;window.pmSetTab=Wa;window.pmToggleEvent=Ya;window.pmSelectResponse=Qa;window.pmAllocateMaterial=Da;window.pmDeallocateMaterial=ja;window.pmDeployEquipment=Ha;window.pmUndeployEquipment=Ga;window.pmAssignWorkers=Fa;window.pmUnassignWorkers=Ua;async function wi(o){if(!B)return;const{data:e,error:t}=await g.from("construction_events").select("*").eq("contract_id",o).order("fired_at_tick",{ascending:!1});t?(console.warn("Failed to load project events:",t.message),B.events=[]):B.events=(e||[]).map(n=>({id:n.id,type:n.type,severity:n.severity,tick:n.fired_at_tick,title:n.title,desc:n.description,impact:n.impact,status:n.status==="ACTIVE"?"ACTIVE":"RESOLVED",resolution:n.resolution,responses:n.responses||[]})),Xe()}let Ho=!1;async function tr(o,e){if(!(Ho||!B)){Ho=!0;try{const{data:t,error:n}=await g.rpc("resolve_construction_event",{p_event_id:o,p_response_key:e});if(n){console.error("Failed to resolve event:",n.message),alert("Failed to submit response: "+n.message);return}const i=typeof t=="string"?JSON.parse(t):t;if(i?.error){alert("Error: "+i.error);return}await wi(B.project.id),await ki(),i?.quality_applied&&i.quality_applied!==0&&(B.quality=Math.max(0,Math.min(100,B.quality+i.quality_applied)),B.qualityLabel=B.quality>=75?"EXCELLENT":B.quality>=50?"FAIR":B.quality>=25?"POOR":"BAD"),Xe()}finally{Ho=!1}}}window.confirmEventResponse=tr;function Le(o,e,t){const n=t?` style="color:${t}"`:"";return`<div class="cd-detail-row">
        ...
        <g transform="translate(470,172)">
        ...
        </div>`,e.style.display="none";return}const t=z?.current_tick||0;let n=0,i=0,a="";for(const r of J){const s=r.issuer_type==="GOVERNMENT",l=s?"gov":"private",c=Array.isArray(r.contract_bids)?r.contract_bids[0]:r.contract_bids,f=c?.bid_price||0,p=c?.estimated_cost||0,u=c?.estimated_quality||0,m=r.budget_ceiling||0,v=r.awarded_at_tick||t,b=r.stalled_ticks||0,y=Math.max(0,t-v),$=Math.max(0,y-b),h=r.timeline_ticks||8,E=Math.max(0,h-$),k=Math.min(100,Math.round($/h*100)),T=$>h,w=b>0;let S="";if(w){const C=r.required_workforce||{},q=r.workers_assigned||{},L=[];(Number(q.general)||0)<(Number(C.general)||0)&&L.push("General: "+(Number(q.general)||0)+"/"+(Number(C.general)||0)),(Number(q.skilled)||0)<(Number(C.skilled)||0)&&L.push("Skilled: "+(Number(q.skilled)||0)+"/"+(Number(C.skilled)||0)),(Number(q.innovative)||0)<(Number(C.innovative)||0)&&L.push("Innovative: "+(Number(q.innovative)||0)+"/"+(Number(C.innovative)||0)),L.length>0?S="Workers needed — "+L.join(", "):S="Materials needed — allocate from warehouse"}bi(r.sector);const A=zn(r.sector);n+=m,i+=f,a+=`<div class="ap-item" onclick="openProjectModal('${r.id}')">
            ...
            <div class="ap-budget">
                <div class="ap-budget__header">
                    <span class="ap-budget__label">PROGRESS${w?' <span style="color:var(--orange);font-weight:700;font-size:7px;">⚠ STALLED ('+b+" ticks) — "+x(S)+"</span>":""}</span>
                ...
                <div class="ap-budget__bar">
                    <div class="ap-budget__fill" style="width:${k}%;background:${T?"var(--red)":w?"var(--orange)":"var(--teal)"}"></div>
                </div>
            </div>
            <div class="ap-details">
                ...
                <div class="ap-detail-cell" style="flex:1">
                    ...
                    <div class="ap-detail-cell__value" style="font-size:10px;font-weight:700;color:${T?"var(--red)":"var(--text-bright)"}">${E} ticks</div>
                </div>
                <div class="ap-detail-cell" style="flex:0.7;text-align:center">
            ...
            <span class="wh-row__val${v?" empty":""}">${m>0?O(m):"—"}</span>
            ...
            </div>`;const T=[{key:"LOW",label:"Low",data:c,avail:b,color:"var(--orange)",dotClass:"wh-dot--low"},{key:"STD",label:"Standard",data:f,avail:y,color:"var(--amber)",dotClass:"wh-dot--std"},{key:"HIGH",label:"High",data:p,avail:$,color:"var(--green)",dotClass:"wh-dot--high"}];for(const w of T){const S=!w.avail.available,A=w.data.qty>0,C=A?"$"+Math.round(w.data.value/w.data.qty):"—";a+=`<div class="wh-grade${S?" unavailable":""}">
                    <div class="wh-grade__label">
                        <div class="wh-dot ${w.dotClass}" style="width:5px;height:5px"></div>
                        <span class="wh-grade__name" style="color:${S?"var(--red)":w.color}">${w.label}</span>
        ...
        </div>`}o.innerHTML=e}function To(){const o=document.getElementById("pr-content"),e=Ge(de,X,I),t=Bt.find(T=>T.key===de);if(!t)return;if(!e.available){o.innerHTML=`<div class="pr-locked-panel">
            <div class="pr-locked-box">
                <div class="pr-locked-box__title">QUALITY TIER UNAVAILABLE</div>
                <div class="pr-locked-box__desc">
                    ${x(t.name)} — ${fn[X]} grade
                    is not produced domestically in ${x(I?.name||"—")}.
                </div>
        ...
        </div>`;return}const n=Tn(de,X,I),i=fi(de,X,I),a=n*_e,r=i>3e3?"LOW":i>1e3?"MODERATE":"HIGH",s=r==="LOW"?"var(--green)":r==="MODERATE"?"var(--amber)":"var(--red)",l=Number(I?.inflation??50),c=l>55?"up":l<45?"down":"flat",f=c==="up"?"&#9650;":c==="down"?"&#9660;":"&#8212;",p=c==="up"?"var(--red)":c==="down"?"var(--green)":"var(--text-dim)";let u="";u+=`<div style="padding:8px 14px;border-bottom:1px solid var(--border-0);">
        ...
        <div class="pr-drivers__title">Price Drivers (${x(I?.name||"—")})</div>`;for(const T of t.priceDrivers){const w=Number(I?.[T]??50),S=w>=50?"var(--green)":w>=30?"var(--amber)":w>=15?"var(--orange)":"var(--red)",A=ar[T]||T;u+=`<div class="pr-driver-row">
            <span class="pr-driver-row__stat">${x(T)}</span>
            <div class="pr-driver-row__bar">
                <div class="pr-driver-row__fill" style="width:${w}%;background:${S}"></div>
            </div>
            <span class="pr-driver-row__val">${w}</span>
            <span class="pr-driver-row__effect">${x(A)}</span>
        </div>`}u+="</div>";const v=(Number(d?.corp_cash_reserves)||0)>=a,b=_e>i,{totalUnits:y}=Co(),$=Eo-y,h=_e>$,E=$<=0,k=mi[X];u+=`<div class="pr-order">
        ...
        <div class="pr-order__box">
            <div class="pr-order__header">
                <div style="display:flex;align-items:center;gap:6px;">
                    ...
                    <span style="font-family:var(--font-mono);font-size:9px;color:${k}">${fn[X]}</span>
                </div>
            ...
            <div class="pr-order__total">
                <div>
                    ...
                    <div class="pr-order__total-value">${O(a)}</div>
                </div>
    ...
    </div>`,o.innerHTML=u}function sr(o){de=o,X="STD";for(const e of["STD","HIGH","LOW"])if(Ge(o,e,I).available){X=e;break}Ci(),Nn(),To()}function lr(o){X=o,Nn(),To()}function dr(o){_e=o,To()}let Go=!1;async function cr(){if(Go||!d||!I)return;const o=Tn(de,X,I),e=fi(de,X,I),t=o*_e,n=Number(d.corp_cash_reserves)||0;if(t>n){alert("Insufficient cash reserves.");return}if(_e>e){alert("Exceeds available supply this tick.");return}const{totalUnits:i}=Co(),a=Eo-i;if(a<=0){alert("Warehouse is full. Cannot purchase more materials.");return}if(_e>a){alert(`Warehouse can only hold ${a.toLocaleString()} more units. Reduce quantity.`);return}Go=!0;const r=document.querySelector(".pr-purchase-btn");r&&(r.disabled=!0,r.textContent="...");try{const s=n-t,{error:l}=await g.from("factions").update({corp_cash_reserves:s}).eq("id",d.id);if(l)throw l;const c=po(de),f=Z[c]?.[X],p=(f?.qty||0)+_e,u=(f?.value||0)+t,{error:m}=await g.from("corp_warehouse").upsert({faction_id:d.id,nation_id:d.nation_id,material_key:c,quality_tier:X,quantity:p,total_value:u,last_purchased_tick:z?.current_tick||null,updated_at:new Date().toISOString()},{onConflict:"faction_id,material_key,quality_tier"});if(m){const{error:v}=await g.from("factions").update({corp_cash_reserves:n}).eq("id",d.id);throw v&&console.error("Cash refund failed after warehouse error:",v.message),m}d.corp_cash_reserves=s,Z[c]||(Z[c]={}),Z[c][X]={qty:p,value:u},In(),rr(),r&&(r.textContent="PURCHASED",setTimeout(()=>{r.isConnected&&(r.disabled=!1,r.textContent="PURCHASE")},1500))}catch(s){r&&(r.disabled=!1,r.textContent="PURCHASE"),alert("Purchase failed: "+(s.message||"Unknown error"))}finally{Go=!1}}function Ti(o){const e=Ve||I;if(!e)return[];const t=ko(o);if(!t)return[];const n=Aa(o,e),i=[],a=Number(e?.inflation??50),r=Number(e?.fuel_prices??50);Number(e?.manufacturing_output??50);const s=Ve&&I&&Ve.id!==I.id;let l=null;if(s&&(l=Ma(e,I)),n.newAvailable>0){const c=ai(o,e),f=t.basePrice,p=Math.round(f*((a-50)/200)),u=Math.round(f*((r-50)/300));let m=c;const v=[{label:"Base price",value:O(f)},p!==0?{label:`Inflation (${a})`,mod:(p>=0?"+":"")+O(Math.abs(p))}:null,u!==0?{label:`Fuel transport (${r})`,mod:(u>=0?"+":"")+O(Math.abs(u))}:null].filter(Boolean),b=c-f-p-u;if(b!==0&&!s&&v.push({label:"Demand/scarcity",mod:(b>=0?"+":"")+O(Math.abs(b))}),s&&l){const y=Math.round(c*l.tariff),$=Math.round(c*l.transport);m=c+y+$,v.push({label:`Import tariff (${Math.round(l.tariff*100)}%)`,mod:"+"+O(y)}),v.push({label:`Transport (${l.deliveryTicks} tick${l.deliveryTicks>1?"s":""})`,mod:"+"+O($)})}i.push({seller:s?`${e.name} Buyers`:"Local Buyers",sellerType:"LOCAL",nation:e.name||"—",distance:s?l?.deliveryTicks||1:0,condition:100,price:Math.round(m),available:n.newAvailable,delivery:s?l.deliveryTicks+" tick"+(l.deliveryTicks>1?"s":""):"Immediate",deliveryTicks:s?l.deliveryTicks:0,used:!1,priceFactors:v,sourceNationId:e.id})}if(n.usedAvailable>0){const c=n.usedCondition,f=ai(o,e,{used:!0,condition:c});let p=f;const u=[{label:"Base price",value:O(t.basePrice)},{label:`Condition (${c}%)`,mod:"-"+O(Math.max(0,t.basePrice-f))}];if(s&&l){const m=Math.round(f*l.tariff),v=Math.round(f*l.transport);p=f+m+v,u.push({label:`Import tariff (${Math.round(l.tariff*100)}%)`,mod:"+"+O(m)}),u.push({label:`Transport (${l.deliveryTicks} tick${l.deliveryTicks>1?"s":""})`,mod:"+"+O(v)})}i.push({seller:s?`${e.name} Buyers`:"Local Buyers",sellerType:"LOCAL",nation:e.name||"—",distance:s?l?.deliveryTicks||1:0,condition:c,price:Math.round(p),available:n.usedAvailable,delivery:s?l.deliveryTicks+" tick"+(l.deliveryTicks>1?"s":""):"Immediate",deliveryTicks:s?l.deliveryTicks:0,used:!0,priceFactors:u,sourceNationId:e.id})}return i}function An(){const o=Number(d?.corp_cash_reserves)||0;document.getElementById("em-cash").textContent=O(o);const e=ko(fe),t=Pt[e?.tier||1],n=document.getElementById("em-tier-badge");n&&(n.textContent=t.tag,n.style.color=t.color),n.style.background=t.color+"0a",n.style.border="1px solid "+t.color+"33";const i=document.getElementById("em-nation-select");if(i&&i.options.length===0){const s=I?.name||d?.nation||"—";let l=`<option value="">${x(s)} (HQ)</option>`;for(const c of gi)c.id!==I?.id&&(l+=`<option value="${c.id}">${x(c.name)}</option>`);i.innerHTML=l}const a=document.getElementById("em-import-tag"),r=Ve&&I&&Ve.id!==I.id;a&&(a.style.display=r?"":"none"),pr(),Mn()}function pr(){let o="";for(let e=1;e<=3;e++){const t=Pt[e],n=mn(e),i=e===3?"em-selector__grid em-selector__grid--t3":"em-selector__grid em-selector__grid--t12";o+=`<div class="em-selector__row">
        ...
        </div></div>`;return}ke>=qe.length&&(ke=0);let e="";for(let n=0;n<qe.length;n++){const i=qe[n],a=ke===n,r=i.sellerType==="LOCAL"?"var(--teal)":"#5a8aaa",s=ui(i.condition);e+=`<div class="em-listing${a?" selected":""}" style="${a?"border-left-color:"+r:""}" onclick="setEmListing(${n})">`,e+=`<div class="em-listing__row1">
            <div style="display:flex;align-items:center;gap:6px">
            ...
            <div class="em-stat-cell" style="flex:1.2">
                ...
                <div class="em-stat-cell__value" style="font-size:11px;color:var(--text-bright);margin-top:2px">${O(i.price)}</div>
            </div>
            ...
            </div>`),e+="</div>"}const t=qe[ke];if(t){const n=ko(fe),i=Pt[n?.tier||1],a=Math.min(t.available,4),r=t.price*Te,s=(Number(d?.corp_cash_reserves)||0)>=r;e+=`<div class="em-purchase"><div class="em-purchase__box">
            <div class="em-purchase__header">
                ...
                <span class="em-purchase__price">${O(t.price)}/unit</span>
            </div>
            ...
            <div class="em-purchase__total">
                <div>
                    ...
                    <div class="em-purchase__total-value">${O(r)}</div>
    ...
    <div style="width:520px;background:${e.surface};border:1px solid ${e.border};display:flex;flex-direction:column;overflow:hidden;max-height:90vh;">
        ...
        <div style="padding:14px 20px;overflow:auto;flex:1;">
            ...
            <div style="display:flex;gap:0;background:${e.card};border:1px solid ${e.border};margin-bottom:14px;">
                ...
                <div style="flex:1;padding:4px 8px;border-right:1px solid ${e.border};">
                    ...
                    <div style="font-family:${o};font-size:9px;font-weight:700;color:${e.text};margin-top:1px;">${O(Number(t.trade_volume||0))}</div>
                </div>
            ...
            ${(()=>{const k=t.destDepot;if(!k)return"";const T=t.destination_port||"this port",w="$"+Math.round(k.cost).toLocaleString()+" / refuel";let S,A;return k.tier==="own"?(S=`${T} has your Fuel Depot (${x(k.ownerName||d.faction_name||"your corp")}) — ${w}.`,A=e.green):k.tier==="other"?(S=`${T} has a Fuel Depot (${x(k.ownerName||"another corp")}) — ${w}.`,A=e.gold):(S=`${T} has no fuel depot — paying ${w} to the government-owned depot.`,A=e.orange),`<div style="padding:7px 10px;margin-bottom:14px;background:${e.card};border:1px solid ${e.border};border-left:2px solid ${A};font-family:${o};font-size:9px;color:${e.text};line-height:1.5;">
                    <span style="color:${e.dim};font-size:7px;font-weight:700;letter-spacing:0.5px;">FUEL AT DESTINATION</span><br>
                    ${S}
                </div>`})()}

            ${(()=>{const k=!!t.trade_agreement_id,T=k?1.2:.7,w=k?e.green:e.dim,S=k?`ACTIVE TRADE AGREEMENT${t.trade_agreement_name?" · "+x(t.trade_agreement_name):""}`:"OPEN-MARKET ROUTE",A=k?`Revenue = your bid × ${T.toFixed(1)} (agreement bonus).`:`Revenue = your bid × ${T.toFixed(1)} (organic route penalty). Agreement-backed lanes pay more.`;return`<div style="padding:7px 10px;margin-bottom:14px;background:${e.card};border:1px solid ${e.border};border-left:2px solid ${w};font-family:${o};font-size:9px;color:${e.text};line-height:1.5;">
                    <span style="color:${e.dim};font-size:7px;font-weight:700;letter-spacing:0.5px;">${S}</span><br>
                    ${A}
                </div>`})()}

            <div style="font-family:${o};font-size:10px;color:${e.dim};letter-spacing:1px;margin-bottom:6px;">SELECT VESSEL</div>`;if(r.length===0)b+=`<div style="padding:14px;text-align:center;background:${e.card};border:1px solid ${e.border};margin-bottom:14px;">
        ...
        </div>`;else{b+='<div style="display:flex;flex-direction:column;gap:4px;margin-bottom:14px;">';for(const k of r){const T=Ye===k.id,w=k.condition>=75?e.green:k.condition>=50?e.gold:e.orange,S=k.fuel>=60?e.green:k.fuel>=30?e.gold:e.red;b+=`<div onclick="raSelectVessel('${k.id}')" style="padding:8px 10px;background:${T?e.accent+"12":e.card};border:1px solid ${T?e.accent+"44":e.border};cursor:pointer;">
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:4px;">
                    <span style="font-size:11px;font-weight:600;color:${e.text};">${x(k.vessel_name)}</span>
                    <span style="font-family:${o};font-size:7px;font-weight:700;padding:1px 5px;color:${n.color};background:${n.color}12;border:1px solid ${n.color}25;">${k.vessel_class.toUpperCase()}</span>
                </div>
                <div style="display:flex;gap:12px;font-family:${o};font-size:8px;">
                    <span style="color:${e.dim};">Condition: <span style="color:${w};font-weight:700;">${k.condition}%</span></span>
                    <span style="color:${e.dim};">Fuel: <span style="color:${S};font-weight:700;">${k.fuel}%</span></span>
                    <span style="color:${e.dim};">Capacity: <span style="color:${e.text};font-weight:700;">${(k.capacity_dwt||0).toLocaleString()} ${k.capacity_unit||"DWT"}</span></span>
                </div>
            </div>`}b+="</div>"}const y=25e4,$=75e4;b+=`
            <div style="margin-bottom:14px;">
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:5px;">
                    <span style="font-family:${o};font-size:10px;color:${e.dim};letter-spacing:1px;">PROPOSED SERVICE RATE</span>
                    <span style="font-family:${o};font-size:16px;font-weight:700;color:${e.gold};">${O(Ee)}/trip</span>
                </div>
                <input type="range" min="${y}" max="${$}" step="5000" value="${Ee}"
                ...
                <div style="display:flex;justify-content:space-between;font-family:${o};font-size:8px;color:${e.dim};margin-top:3px;">
                    <span>Floor (${O(y)})</span>
                    <span style="color:${e.muted};">Mid-market (${O(5e5)})</span>
                    <span>Ceiling (${O($)})</span>
                </div>
            </div>`;const h=t.destDepot?.tier==="own"?"own depot":t.destDepot?.tier==="other"?"other corp's depot +15%":"state depot 3×";b+=`
            <div style="margin-bottom:14px;">
                ...
                <div style="background:${e.card};border:1px solid ${e.border};padding:8px 10px;">
                    <div style="display:flex;justify-content:space-between;padding:3px 0;border-bottom:1px solid ${e.border};">
                        ...
                        <span style="font-family:${o};font-size:10px;color:${e.text};">${O(c.bid)}</span>
                    </div>
                    <div style="display:flex;justify-content:space-between;padding:3px 0;border-bottom:1px solid ${e.border};">
                        <span style="font-family:${o};font-size:9px;color:${e.dim};">Revenue ×${i} (${t.trade_agreement_id?"agreement":"organic"})</span>
                        <span style="font-family:${o};font-size:10px;font-weight:700;color:${e.green};">${O(c.revenue)}</span>
                    </div>
                    <div style="display:flex;justify-content:space-between;padding:3px 0;border-bottom:1px solid ${e.border};">
                        <span style="font-family:${o};font-size:9px;color:${e.dim};">Fuel at destination (${h})</span>
                        <span style="font-family:${o};font-size:10px;color:${e.red};">-${O(c.fuelPerTrip)}</span>
                    </div>
                    <div style="display:flex;justify-content:space-between;padding:5px 0;">
                        <span style="font-family:${o};font-size:10px;font-weight:700;color:${e.text};">NET PER TRIP</span>
                        <span style="font-family:${o};font-size:14px;font-weight:700;color:${f};">${c.netPerTrip>=0?"+":""}${O(c.netPerTrip)}</span>
                    </div>
                </div>
            </div>

            <div style="margin-bottom:14px;">
                <div style="font-family:${o};font-size:10px;color:${e.dim};letter-spacing:1px;margin-bottom:6px;">FLEET OVERHEAD (ONGOING)</div>
                <div style="background:${e.card};border:1px solid ${e.border};padding:8px 10px;">
                    ${s?`<div style="display:flex;justify-content:space-between;padding:3px 0;border-bottom:1px solid ${e.border};">
                              <span style="font-family:${o};font-size:9px;color:${e.dim};">Vessel maintenance · ${x(s.vessel_class||"?")}</span>
                              <span style="font-family:${o};font-size:10px;color:${e.text};">${O(p)} / tick</span>
                           </div>
                           <div style="display:flex;justify-content:space-between;padding:3px 0;border-bottom:1px solid ${e.border};">
                              <span style="font-family:${o};font-size:9px;color:${e.dim};">Accrues during ${u}-tick transit</span>
                              <span style="font-family:${o};font-size:10px;color:${e.text};">${O(m)}</span>
                           </div>
                           <div style="display:flex;justify-content:space-between;padding:5px 0;">
                              <span style="font-family:${o};font-size:9px;color:${e.dim};">Net per trip vs. maint accrued</span>
                              <span style="font-family:${o};font-size:10px;font-weight:700;color:${v?e.green:e.red};">${v?"covers":"short by "+O(Math.max(0,m-c.netPerTrip))}</span>
                           </div>`:`<div style="font-family:${o};font-size:9px;color:${e.dim};line-height:1.5;">Select a vessel to see its per-tick maintenance cost. Maintenance is charged on every corp tick to every vessel regardless of activity, so higher-class ships need higher-paying routes to break even.</div>`}
                </div>
            </div>
    ...
    </div>`;const E=document.createElement("div");E.id="ra-modal-overlay",E.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.7);display:flex;align-items:center;justify-content:center;z-index:9999;",E.innerHTML=b,E.addEventListener("click",k=>{k.target===E&&Bn()}),document.body.appendChild(E)}async function Lr(){if(oo||!et||!Ye||!d||!z)return;oo=!0;const o=et,e=5e4,{data:t}=await g.from("factions").select("corp_cash_reserves").eq("id",d.id).single(),n=Number(t?.corp_cash_reserves??0);if(n<e){alert("Not enough funds. Application fee: $50k. You have $"+Math.round(n/1e3)+"k."),oo=!1;return}try{const i=n-e,{error:a}=await g.from("factions").update({corp_cash_reserves:i}).eq("id",d.id);if(a){alert("Failed to deduct fee.");return}const r={route_id:o.id,faction_id:d.id,vessel_id:Ye,proposed_rate:Ee,application_fee:e,status:"pending",applied_at_tick:z.current_tick};let{error:s}=await g.from("shipping_applications").insert(r);if(s&&/vessel_id/i.test(s.message||"")){const{vessel_id:l,...c}=r;s=(await g.from("shipping_applications").insert(c)).error}if(s){await g.from("factions").update({corp_cash_reserves:n}).eq("id",d.id);const l=s.code==="23505"||/duplicate key|idx_shipping_applications_unique/i.test(s.message||"");alert(l?"You already have a pending or approved application on this route. Withdraw it from Route Applications before applying again.":"Application failed: "+s.message);return}try{await g.from("event_log").insert({nation_id:o.origin_nation_id,event_name:d.faction_name+" applied to service "+(o.origin_port||"?")+" → "+(o.destination_port||"?"),category:"corporate",description_chosen:d.faction_name+" submitted a shipping application for the "+(o.goods_name||"trade")+" route at a proposed rate of "+O(Ee)+"/trip. Vessel: "+(ce.find(l=>l.id===Ye)?.vessel_name||"Unknown"),fired_at_tick:z.current_tick})}catch(l){console.warn("[Shipping] Event log failed:",l?.message||l)}Bn(),await Rn(),te=-1,await So(),alert("Application submitted! The government will review your application.")}catch(i){alert("Application failed: "+(i.message||"Network error"))}finally{oo=!1}}async function qr(){if(!(Qo||te<0||!d||!z)){var o=qn(),e=o[te];if(e){var t=Number(d.shipping_fleet_capacity??0),n=Number(d.shipping_fleet_deployed??0);if(n>=t){alert("No available vessels. Fleet capacity: "+t+", deployed: "+n+".");return}Qo=!0;var i=document.getElementById("ar-claim-btn");i.textContent="CLAIMING...",i.className="ar-claim-btn";try{var{data:a,error:r}=await g.rpc("claim_shipping_route",{p_faction_id:d.id,p_route_id:e.id,p_current_tick:z.current_tick});if(r){alert("Claim failed: "+r.message);return}if(a&&!a.success){alert(a.error||"Claim failed.");return}if(a?.claim_id){var s=(ce||[]).find(function(u){return u.status==="in_port"&&!u.active_claim_id&&u.fuel>=10});if(s){var{error:l}=await g.from("corp_vessels").update({status:"in_transit",active_claim_id:a.claim_id,current_port_nation_id:null}).eq("id",s.id);l&&console.warn("Failed to assign vessel to route:",l.message)}else console.warn("Route claimed but no available vessel with fuel >= 10% to assign.")}try{var c=e.origin_nation?.name||e.origin_nation_id||"Unknown",f=e.destination_nation?.name||e.destination_nation_id||"Unknown",p=e.goods_type||e.cargo_type||"goods";await g.from("event_log").insert({nation_id:d.nation_id,event_name:"Shipping Route Signed",category:"corporate",description_chosen:d.faction_name+" has just signed an agreement to ship "+p+" between "+c+" and "+f+".",fired_at_tick:z.current_tick||0})}catch{}await Rn(),te=-1,await Promise.all([So(),zo(),ye()])}catch(u){alert("Claim failed: "+(u.message||"Network error"))}finally{Qo=!1,i.textContent="CLAIM ROUTE",i.className="ar-claim-btn"+(te>=0?" active":"")}}}}let Oe=[],Ii="ready",At=null,go=-1;async function zo(){if(!d)return;const o=await Ca(g,d.id);Oe=o.claims,Ii=o.state,At=o.error,At&&console.warn("Failed to load active voyages:",At.message),Ni()}function Or(o){go=go===o?-1:o,Ni()}async function Br(o){if(!(Ko||!d||!z)){Ko=!0;try{var{data:e,error:t}=await g.rpc("release_shipping_route",{p_faction_id:d.id,p_claim_id:o,p_current_tick:z.current_tick});if(t){alert("Release failed: "+t.message);return}if(e&&!e.success){alert(e.error||"Release failed.");return}var{error:n}=await g.from("corp_vessels").update({status:"in_port",active_claim_id:null}).eq("active_claim_id",o).eq("faction_id",d.id);n&&console.warn("Failed to free vessel on release:",n.message),go=-1,await Rn(),await Promise.all([So(),zo(),ye()])}catch(i){alert("Release failed: "+(i.message||"Network error"))}finally{Ko=!1}}}function Ni(){const o=z?.current_tick||0,e=Number(d?.shipping_fleet_capacity??0),t=Number(d?.shipping_fleet_deployed??0),n=d?.corp_subsector||"--";document.getElementById("av-count").textContent=Oe.length+" ACTIVE";const i=Oe.reduce((f,p)=>f+Number(p.total_revenue||0),0),a=Oe.reduce((f,p)=>f+(p.transits_completed||0),0),r=a>0?Math.round(i/a):0;document.getElementById("av-summary").innerHTML=`
...
Deductible:  ${i.deductible_pct||10}%`;if(!confirm(c))return;const f=t?"auto":"deal",p=z?.current_tick||0,{data:u,error:m}=await g.from("insurance_claims").insert({policy_id:i.id,policy_source:f,claimant_faction_id:d.id,insurer_faction_id:i.lender_faction_id,insured_vessel_id:e.vessel_id,claim_amount:l,claim_reason:e.description||`${a} — incident ${e.incident_type}`,policy_terms:i.policy_terms||null,deductible_pct:Number(i.deductible_pct)||10,status:"filed",filed_at_tick:p}).select("id").single();if(m){alert("Failed to file claim: "+m.message);return}const{error:v}=await g.from("vessel_incidents").update({status:"filed",filed_at_tick:p,filed_claim_id:u?.id||null}).eq("id",e.id);v&&console.warn("[VesselIncidents] incident update after file failed:",v.message);try{await g.from("event_log").insert({nation_id:e.nation_id||d.nation_id,faction_id:d.id,event_name:`${d.faction_name||"A corporation"} filed an insurance claim`,category:"corporate",description_chosen:`${d.faction_name||"Corporation"} filed a claim on ${a} for $${Math.round(l).toLocaleString()}.`,fired_at_tick:p})}catch{}await Dn()}catch(t){console.error("[VesselIncidents] fileClaim error:",t),alert("File claim failed: "+(t?.message||"unknown error"))}finally{gt=!1}}}window.viFileClaim=Dr;async function jr(o){if(!gt&&confirm("Dismiss this incident without filing a claim? The vessel remains in whatever state the tick processor left it.")){gt=!0;try{const{error:e}=await g.from("vessel_incidents").update({status:"dismissed",filed_at_tick:z?.current_tick||0}).eq("id",o);if(e){alert("Dismiss failed: "+e.message);return}await Dn()}finally{gt=!1}}}window.viDismissIncident=jr;function Fr(o,e){const t=(ce||[]).filter(function(a){return a.status==="in_port"&&!a.active_claim_id&&a.fuel>=15&&a.condition>=20});let n;t.length===0?n='<div style="padding:20px;text-align:center;font-family:var(--font-mono);font-size:11px;color:var(--text-dim);">No available vessels.<br>Ships must be in port with 15%+ fuel and 20%+ condition.</div>':n=t.map(function(a,r){var s=a.fuel>50?"#5c5":a.fuel>20?"#ca5":"#c55",l=a.condition>50?"#5c5":a.condition>30?"#ca5":"#c55";return`<div style="padding:10px 14px;border-bottom:1px solid var(--border-0);cursor:pointer;display:flex;justify-content:space-between;align-items:center;" onclick="assignVesselToRoute('`+o+"','"+a.id+`')"><div><div style="font-size:14px;font-weight:700;color:var(--text-bright);">`+x(a.vessel_name||"Unnamed")+'</div><div style="font-family:var(--font-mono);font-size:10px;color:var(--text-dim);">'+x(a.vessel_class||"?")+" · "+(a.capacity_dwt||0).toLocaleString()+' DWT</div></div><div style="display:flex;gap:14px;align-items:center;"><div style="text-align:center"><div style="font-family:var(--font-mono);font-size:7px;color:var(--text-dim);">FUEL</div><div style="font-family:var(--font-mono);font-size:13px;font-weight:700;color:'+s+'">'+a.fuel+'%</div></div><div style="text-align:center"><div style="font-family:var(--font-mono);font-size:7px;color:var(--text-dim);">COND</div><div style="font-family:var(--font-mono);font-size:13px;font-weight:700;color:'+l+'">'+a.condition+'%</div></div><div style="font-family:var(--font-mono);font-size:11px;font-weight:700;color:var(--teal);padding:4px 12px;border:1px solid var(--teal);cursor:pointer;">ASSIGN</div></div></div>'}).join("");var i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:9999;display:flex;align-items:center;justify-content:center;",i.onclick=function(a){a.target===i&&i.remove()},i.innerHTML='<div style="width:560px;max-width:95vw;max-height:80vh;background:var(--bg-panel);border:1px solid var(--border-main);display:flex;flex-direction:column;"><div style="padding:12px 16px;border-bottom:1px solid var(--border-main);background:var(--bg-card);display:flex;justify-content:space-between;align-items:center;"><span style="font-family:var(--font-mono);font-size:13px;font-weight:700;letter-spacing:1px;color:var(--teal);">ASSIGN VESSEL</span><span style="font-family:var(--font-mono);font-size:10px;color:var(--text-dim);">'+t.length+' available</span></div><div style="flex:1;overflow-y:auto;">'+n+`</div><div style="padding:10px 16px;border-top:1px solid var(--border-main);background:var(--bg-card);text-align:right;"><button onclick="this.closest('div[style*=fixed]').remove()" style="padding:6px 16px;font-family:var(--font-mono);font-size:10px;font-weight:700;color:var(--text-dim);background:transparent;border:1px solid var(--border-main);cursor:pointer;">CANCEL</button></div></div>`,document.body.appendChild(i)}async function Ur(o,e){try{var{error:t}=await g.from("corp_vessels").update({status:"in_port",active_claim_id:o}).eq("id",e).eq("faction_id",d.id);if(t){alert("Assignment failed: "+t.message);return}var n=document.querySelector('div[style*="position:fixed"][style*="z-index:9999"]');n&&n.remove(),await Promise.all([zo(),ye()])}catch(i){alert("Assignment failed: "+(i.message||"Network error"))}}window.openAssignVesselModal=Fr;window.assignVesselToRoute=Ur;function jn(){const o=ae.reduce((s,l)=>s+(l.owned||0),0),e=ae.reduce((s,l)=>s+(l.deployed||0),0),t=Na(ae),n=o-e;document.getElementById("eq-count").textContent=o+" UNITS",document.getElementById("eq-summary").innerHTML=`
            ...
            ${p>0?`<span class="eq-tier-hdr__count">${u}/${p}</span>`:'<span class="eq-tier-hdr__none">NONE OWNED</span>'}
        </div>`,f)for(const m of c){const v=i[m.key],b=v?.owned||0,y=v?.deployed||0,$=v?.condition||0,h=m.maintenancePerUnit*b,E=b-y,k=b>0&&E===0,T=b>0&&$<65,w=ui($),S=v?.assigned_projects||[],A=S.length>0?S.map(C=>C.contract_name||"Project").join(", ").slice(0,30):b>0&&y>0?y+" project"+(y>1?"s":""):"—";a+=`<div class="eq-row${b===0?" unowned":""}">`,a+=`<div class="eq-row__top">
                    ...
                    ${b>0?`<div class="eq-row__right">
                            <div style="display:flex;gap:3px">
                                <span class="eq-row__free" style="color:${k?"var(--orange)":"var(--green)"}">${E}</span>
        ...
        <div>
            ...
            <div class="eq-footer__maint-value">${O(t)}</div>
        </div>
        <div class="eq-footer__tiers">${r}</div>`}function Hr(o){vn=vn===o?-1:o,jn()}async function Ai(){if(!d)return;const{data:o,error:e}=await g.from("corp_equipment").select("equipment_key, tier, owned, deployed, condition, maintenance_per_tick, assigned_projects").eq("faction_id",d.id);e?(console.warn("Failed to load equipment:",e.message),ae=[]):ae=o||[],jn()}async function Gr(){const{data:{user:o}}=await g.auth.getUser();if(!o){window.location.href="login.html";return}const{data:e}=await g.from("factions").select("*").or(`id.eq.${o.id},linked_user_id.eq.${o.id}`);$e=(e||[]).filter(m=>m.nation_id);const t=sessionStorage.getItem("active_faction_id");if(d=$e.find(m=>m.id===t)||$e.find(m=>m.faction_type==="corporation")||$e[0],!d){await g.auth.signOut(),window.location.href="login.html";return}if(d.faction_type!=="corporation"){window.location.href="dashboard.html";return}const n=new URLSearchParams(window.location.search).get("tab"),i=n==="expansion"||n==="actions";if(d.corp_sector!=="Shipping"&&!i){const v={Finance:"corp-operations-finance.html",Construction:"corp-operations.html"}[d.corp_sector];if(v){window.location.href=v;return}}const[a,r]=await Promise.all([d.nation_id?g.from("nations").select("*").eq("id",d.nation_id).single():Promise.resolve({data:null}),g.from("shard").select("current_tick, current_date, next_tick_at, tick_interval_hours").eq("name","Alpha Shard").single()]);a.error&&console.warn("Nation load failed:",a.error.message),a.data&&(I=a.data),r.error&&console.warn("Shard load failed:",r.error.message),z=r.data;let s=0;if(d?.id){const{data:m}=await g.from("construction_contracts").select("id, contract_bids!inner(id)").eq("issuer_faction_id",d.id).in("status",["open","bidding"]);if(m)for(const v of m)s+=(v.contract_bids||[]).length}const l=document.getElementById("corp-topbar-container");if(l){const{renderCorpTopBar:m}=await za(async()=>{const{renderCorpTopBar:y}=await import("./corp-topbar-C3V4L7WY.js");return{renderCorpTopBar:y}},__vite__mapDeps([0,1])),v=new URLSearchParams(window.location.search).get("tab")||"operations",b={};s>0&&(b.home={color:"#c8a832",title:s+" pending bid"+(s!==1?"s":"")+" on your projects"}),m(l,{faction:d,shard:z,activeTab:v,allUserFactions:$e,badges:b})}if(z){if(document.getElementById("game-date").textContent=z.current_date||"—",document.getElementById("tick-number").textContent=z.current_tick||"—",z.next_tick_at){const v=(Number(z.tick_interval_hours)||8)*36e5,b=new Date(z.next_tick_at).getTime(),$=b-v+v/2;yn=new Date($>Date.now()?$:b+v/2),Ba()}const m=document.querySelector("#tick-countdown")?.closest(".tick-item")?.querySelector(".tick-label");m&&(m.textContent="Next Corp Tick")}const c=document.getElementById("topbar-cash");c&&(c.textContent="CASH: "+Si(Number(d.corp_cash_reserves??0)));const f=document.getElementById("topbar-ap");f&&(f.style.display="none");const p=document.getElementById("nation-pill");p&&(p.textContent=(I?.name||d.nation||"—").toUpperCase());const u=document.getElementById("corp-faction-dropdown");if(u){let m="";for(const v of $e){const b=v.id===d.id,y=v.faction_type==="corporation"?"CORP":"PARTY",$=v.faction_type==="corporation"?"var(--teal)":"var(--amber)";m+=`<div class="corp-dd-item${b?" active":""}" onclick="switchToFaction('${v.id}', '${v.faction_type}')">
    ...
    </div>`,o.innerHTML=a,o.querySelectorAll("[onmouseenter]").forEach(r=>{r.addEventListener("mouseenter",function(){const s=this.querySelector(".act-exec-btn");s&&(s.style.display="block")}),r.addEventListener("mouseleave",function(){const s=this.querySelector(".act-exec-btn");s&&(s.style.display="none")})})}function Xr(o,e,t,n,i){const a=z?.current_tick||0,r=Math.max(0,i-a),s=Math.round(n*(r/12)),l=`FIRE ${e}: ${t}
...
Are you sure?`;confirm(l)&&Zr(o,e,s)}async function Zr(o,e,t){try{const n=Number(d?.corp_cash_reserves??0);if(n<t){alert(`Insufficient funds. You need $${(t/1e6).toFixed(2)}M but only have $${(n/1e6).toFixed(2)}M.`);return}const i=n-t,{error:a}=await g.from("factions").update({corp_cash_reserves:i}).eq("id",d.id);if(a){alert("Failed to process payout: "+a.message);return}const{error:r}=await g.from("corp_executives").update({status:"fired",updated_at:new Date().toISOString()}).eq("id",o);if(r){await g.from("factions").update({corp_cash_reserves:n}).eq("id",d.id),alert("Failed to fire executive: "+r.message);return}d.corp_cash_reserves=i,Dt=Dt.filter(s=>s.id!==o),kt()}catch(n){console.error("[CorpOps] Fire executive error:",n),alert("An error occurred.")}}function es(o,e){if((Bi[e]||[]).find(n=>n.id===o)?.cooldown==="once/tick"&&Kr(o)){alert("This action can only be used once per tick. Wait for the next tick.");return}switch(o){case"statement":return Di();case"loan":return Ui();case"restructure":return Gi();case"rebrand":return Vi();case"donate":return Wi();case"bankruptcy":return ji()}}let hn=!1;function Di(){if(hn)return;hn=!0;const o=document.createElement("div");o.id="stmt-overlay",o.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:600;display:flex;align-items:center;justify-content:center;",o.onclick=function(l){l.target===o&&Fn()};const e=d?.faction_name||"Corporation",t=(d?.abbreviation||d?.corp_ticker||"??").toUpperCase(),n=Number(d?.corp_cash_reserves??0),i=Ae("CEO"),a=i?`${i.first_name} ${i.last_name}`:"CEO";o.innerHTML=`<div onclick="event.stopPropagation()" style="width:480px;background:var(--panel-main);border:1px solid var(--panel-border);display:flex;flex-direction:column;overflow:hidden;">
    ...
    </div>`,document.body.appendChild(o);const r=document.getElementById("stmt-text"),s=document.getElementById("stmt-chars");r&&s&&(r.addEventListener("input",function(){s.textContent=this.value.length+"/500"}),r.focus())}function Fn(){const o=document.getElementById("stmt-overlay");o&&o.remove(),hn=!1}let Tt=!1;async function ts(){if(!d||!z||Tt)return;const o=document.getElementById("stmt-text"),e=document.getElementById("stmt-error"),t=(o?.value||"").trim();if(!t){e&&(e.textContent="Statement cannot be empty.",e.style.display="block");return}if(t.length>500){e&&(e.textContent="Statement too long (max 500 chars).",e.style.display="block");return}const n=Ae("CEO"),i=n?n.skill:50,a=Math.round(2e4*Qt(i)),r=Number(d.corp_cash_reserves??0);if(r<a){e&&(e.textContent="Insufficient cash. Need "+_(a)+".",e.style.display="block");return}Tt=!0;const s=document.getElementById("stmt-submit-btn");s&&(s.style.opacity="0.4",s.style.pointerEvents="none");const l=d.faction_name||"Corporation",c=n?`${n.first_name} ${n.last_name}`:"CEO",f=z.current_tick||0,{error:p}=await g.from("factions").update({corp_cash_reserves:r-a}).eq("id",d.id);if(p){Tt=!1,e&&(e.textContent="Failed to deduct cost: "+p.message,e.style.display="block"),s&&(s.style.opacity="1",s.style.pointerEvents="auto");return}const{error:u}=await g.from("event_log").insert({nation_id:d.nation_id,faction_id:d.id,event_name:l+" — Press Release",description_used:c+", CEO of "+l+': "'+t.replace(/[<>"]/g,"")+'"',category:"business",trigger_key:"ceo_statement",effects_applied:{cost:a,ceo:c,skill:i},fired_at_tick:f});if(u){await g.from("factions").update({corp_cash_reserves:r}).eq("id",d.id),Tt=!1,e&&(e.textContent="Failed to publish: "+u.message,e.style.display="block"),s&&(s.style.opacity="1",s.style.pointerEvents="auto");return}d.corp_cash_reserves=r-a,Tt=!1,bt("statement"),Fn()}const pi=24,os=.5;async function ns(o,e){const t=e-pi,{data:n}=await g.from("event_log").select("fired_at_tick, effects_applied").eq("trigger_key","corp_bankruptcy").gte("fired_at_tick",t).order("fired_at_tick",{ascending:!1}).limit(20),i=(n||[]).find(r=>r.effects_applied?.user_id===o),a=i?Math.max(0,i.fired_at_tick+pi-e):0;return{onCooldown:a>0,ticksLeft:a}}let Xo=!1;async function ji(){if(Xo)return;const{data:{user:o}}=await g.auth.getUser();if(!o){alert("Not logged in.");return}const e=d?.id||sessionStorage.getItem("active_faction_id");if(!e){alert("No active faction selected.");return}const{data:t,error:n}=await g.from("factions").select("*").eq("id",e).eq("faction_type","corporation").is("abandoned_at",null).single();if(n||!t){alert("No active corporation found. It may have already been dissolved.");return}const i=t,a=i.faction_name||"this corporation",{data:r,error:s}=await g.from("shard").select("current_tick").eq("name","Alpha Shard").single();if(s||!r){alert("Failed to read game tick. Please try again.");return}const l=r.current_tick||0,{onCooldown:c,ticksLeft:f}=await ns(o.id,l);if(c){alert("Bankruptcy is on cooldown. You must wait "+f+" more tick"+(f!==1?"s":"")+" before declaring bankruptcy again.");return}if(!confirm("DECLARE BANKRUPTCY — "+a.toUpperCase()+`?
...
This action CANNOT be undone.`))return;if(prompt('Type "BANKRUPT" to confirm bankruptcy of '+a+":")!=="BANKRUPT"){alert("Bankruptcy cancelled.");return}Xo=!0;try{async function u(M){const{error:U}=await M;if(U)throw U}const m=Number(i.corp_cash_reserves)||0,{data:v}=await g.from("corp_properties").select("purchase_price, condition").eq("faction_id",e);let b=0;for(const M of v||[])b+=Math.round(Number(M.purchase_price||0)*(Number(M.condition||0)/100));const y=m+b,$=Number(i.corp_loans)||0,h=y-$,E=Math.round(h*1.3),k=Math.max(0,Math.round(E*os)),{data:T}=await g.from("finance_active_loans").select("*").eq("borrower_faction_id",e).in("status",["current","late","delinquent"]).order("started_tick",{ascending:!0});let w=0;for(const M of T||[]){const U=M.principal-M.total_paid;if(U<=0)continue;const j=Math.min(U,k-w);if(j<=0)break;const{data:H}=await g.from("factions").select("corp_cash_reserves").eq("id",M.lender_faction_id).single();H&&await u(g.from("factions").update({corp_cash_reserves:(Number(H.corp_cash_reserves)||0)+j}).eq("id",M.lender_faction_id)),await u(g.from("finance_active_loans").update({status:"repaid",total_paid:M.total_paid+j,completed_tick:l}).eq("id",M.id)),w+=j}await u(g.from("contract_bids").delete().eq("faction_id",e)),await u(g.from("construction_contracts").update({status:"expired"}).eq("issuer_faction_id",e).in("status",["open","bidding"])),await u(g.from("corp_equipment_deliveries").delete().eq("faction_id",e)),await u(g.from("corp_equipment").delete().eq("faction_id",e)),await u(g.from("corp_properties").delete().eq("faction_id",e)),await g.from("corp_material_inventory").delete().eq("faction_id",e),await g.from("corp_warehouse").delete().eq("faction_id",e),await g.from("corp_executives").delete().eq("faction_id",e),await g.from("faction_agitators").delete().eq("faction_id",e),await u(g.from("factions").delete().eq("id",e));const S=w>0?" $"+w.toLocaleString()+" was repaid to creditors.":"";await u(g.from("event_log").insert({nation_id:i.nation_id,faction_id:e,event_name:a+" — Bankruptcy",description_used:a+" has officially filed for bankruptcy. It has laid off its executive staff and ceased operations."+S,category:"business",trigger_key:"corp_bankruptcy",effects_applied:{corp_name:a,sector:i.corp_sector,user_id:o.id,loan_payback:w,valuation:E},fired_at_tick:l})),sessionStorage.removeItem("active_faction_id"),sessionStorage.removeItem("nationhood_state");const{data:A}=await g.from("factions").select("id, faction_type").or(`id.eq.${o.id},linked_user_id.eq.${o.id}`),C=(A||[]).find(M=>M.faction_type==="party"),q=(A||[]).find(M=>M.faction_type==="corporation"),L=w>0?`
$`+w.toLocaleString()+" repaid to creditors.":"";C?(sessionStorage.setItem("active_faction_id",C.id),alert(a+" has declared bankruptcy."+L+`
...
Please try again or contact support.`)}finally{Xo=!1}}const Fi=[{id:"equipment",label:"Equipment Acquisition",desc:"Purchase vehicles, cranes, or heavy machinery",icon:"&#9881;"},{id:"working",label:"Working Capital",desc:"Bridge financing for active project costs",icon:"$"},{id:"property",label:"Property Purchase",desc:"Acquire office, warehouse, or HQ building",icon:"&#9632;"},{id:"subsidiary",label:"Subsidiary Expansion",desc:"Fund new subsidiary establishment",icon:"&#9672;"},{id:"materials",label:"Material Procurement",desc:"Bulk material purchase for upcoming projects",icon:"&#9638;"}],Zo=[{id:"none",label:"None",desc:"Unsecured — lenders may charge higher rates",risk:"HIGH",riskColor:"#c84"},{id:"equipment",label:"Equipment",desc:"Financed equipment serves as collateral",risk:"MODERATE",riskColor:"#ca5"},{id:"property",label:"Property",desc:"Corporate property lien",risk:"LOW",riskColor:"#8b9a6b"},{id:"full",label:"Full Assets",desc:"All corporate assets — maximum lender security",risk:"MINIMAL",riskColor:"#5c5"}];let oe=25e7,Ut="equipment",_t=48,pe="equipment",bo="",zt=[];function Ui(){oe=25e7,Ut="equipment",_t=48,pe="equipment",bo="",document.getElementById("lr-overlay").style.display="flex",ls(),Et()}function Hi(){document.getElementById("lr-overlay").style.display="none"}function is(o){oe=Math.max(1e6,Math.min(5e9,Number(o)||0)),Et()}function as(o){Ut=o,Et()}function rs(o){_t=o,Et()}function ss(o){pe=o,Et()}async function ls(){if(!d)return;const{data:o}=await g.from("factions").select("id, faction_name, abbreviation, corp_ticker, corp_company_type").eq("faction_type","corporation").eq("corp_sector","Finance").is("abandoned_at",null).neq("id",d.id);zt=o||[],Et()}function Et(){const o=document.getElementById("lr-modal-content");if(!o)return;const e=Number(d?.corp_cash_reserves??0),t=Number(d?.corp_loans??0),n=Number(d?.corp_reputation??50),i=d?.faction_name||"Corporation",a=(d?.abbreviation||d?.corp_ticker||"??").toUpperCase(),r=t+oe,s=r>e*3?"#c55":r>e*1.5?"#c84":r>e?"#ca5":"#5c5",l=r>e*3?"DANGEROUS":r>e*1.5?"HEAVY":r>e?"MODERATE":"HEALTHY",c=pe==="none"?"10-16%":pe==="equipment"?"7-12%":pe==="property"?"5-9%":"4-7%",p=Math.round(oe*(pe==="none"?.13:pe==="equipment"?.095:pe==="property"?.07:.055)/12+oe/_t),u=Zo.find(v=>v.id===pe)||Zo[0];let m="";m+=`<div style="padding:10px 16px;border-bottom:1px solid var(--panel-border);background:var(--bg-panel);flex-shrink:0;">
    ...
    </div>`,m+='<div id="lr-error" style="padding:4px 16px;font-family:var(--font-mono);font-size:8px;color:#c55;display:none;"></div>',o.innerHTML=m}let no=!1;async function ds(){if(!d||!z||no)return;const o=document.getElementById("lr-error");if(oe<1e6){o.textContent="Minimum loan amount is $1M.",o.style.display="block";return}if(oe>5e9){o.textContent="Maximum loan amount is $5B.",o.style.display="block";return}const t=((Fi.find(r=>r.id===Ut)||{}).label||Ut)+(bo?" — "+bo:""),n=document.getElementById("lr-submit-btn");no=!0,n.style.opacity="0.5",n.style.pointerEvents="none";const i=z.current_tick||0,{error:a}=await g.from("finance_loan_requests").insert({requesting_faction_id:d.id,nation_id:d.nation_id,amount:oe,term_months:_t,purpose:t,created_tick:i,expires_tick:i+5});if(n.style.opacity="1",n.style.pointerEvents="auto",a){no=!1,o.textContent="Failed to submit: "+a.message,o.style.display="block",n.style.opacity="1",n.style.pointerEvents="auto";return}no=!1,Hi()}function Gi(){if(!d)return;const o=Number(d.corp_loans??0),e=Number(d.corp_reputation??50),t=Number(d.corp_general_workforce??0),n=Number(d.corp_skilled_workforce??0),i=Number(d.corp_innovative_workforce??0),a=t+n+i;if(a===0){alert("Cannot restructure — no employees to lay off.");return}const r=Ae("COO"),s=r?r.skill:50,l=Qt(s),c=10+Math.floor(Math.random()*11),f=Math.round(a*c/100),p=Math.round(o*.07),u=Math.round(p*(2-l)),m=3+Math.floor(Math.random()*10),v=Math.max(1,Math.round(m*l)),b=Math.round(t/a*f),y=Math.round(n/a*f),$=Math.max(0,Math.min(i,f-b-y)),h=document.createElement("div");h.id="restr-overlay",h.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:600;display:flex;align-items:center;justify-content:center;",h.onclick=function(E){E.target===h&&Un()},h.innerHTML=`<div onclick="event.stopPropagation()" style="width:440px;background:var(--panel-main);border:1px solid var(--panel-border);display:flex;flex-direction:column;overflow:hidden;">
        <div style="padding:10px 16px;border-bottom:1px solid var(--panel-border);background:var(--bg-panel);">
            <div style="display:flex;justify-content:space-between;align-items:center;">
                <div style="display:flex;align-items:center;gap:8px;">
    ...
    </div>`,l+='<div id="donate-error" style="padding:6px 20px;font-family:var(--font-mono);font-size:10px;color:#c55;display:none;"></div>',l+="</div>",o.innerHTML=l}let st=!1;async function us(){if(!d||!z||Se<0||st)return;const o=Fe[Se];if(!o)return;const e=Number(z?.current_tick||0);if(new Set($e.map(w=>w.id)).has(o.id)){const w=document.getElementById("donate-error");w&&(w.textContent="You cannot donate to your own party.",w.style.display="block");return}const n=Ae("Lobbyist"),i=n?n.skill:50,a=Math.round(1e6*Qt(i)),r=1e5,s=2,{data:l,error:c}=await g.from("factions").select("corp_cash_reserves, last_donation_tick").eq("id",d.id).single();if(c||!l){const w=document.getElementById("donate-error");w&&(w.textContent="Failed to verify cooldown: "+(c?.message||"unknown"),w.style.display="block");return}const f=Number(l.last_donation_tick??0);if(f===e){const w=document.getElementById("donate-error");w&&(w.textContent="Political Donation is on cooldown until next tick.",w.style.display="block"),bt("donate");return}const p=Number(l.corp_cash_reserves??0);if(p<a){const w=document.getElementById("donate-error");w&&(w.textContent="Insufficient cash. Need "+_(a)+", have "+_(p)+".",w.style.display="block");return}st=!0;const u=document.getElementById("donate-btn");u&&(u.style.opacity="0.4",u.style.pointerEvents="none");const m=Number(d.corp_reputation??50),v=Math.max(0,m-s),{data:b,error:y}=await g.from("factions").update({corp_cash_reserves:p-a,corp_reputation:v,last_donation_tick:e}).eq("id",d.id).eq("last_donation_tick",f).select("id");if(y){const w=document.getElementById("donate-error");st=!1,w&&(w.textContent="Failed: "+y.message,w.style.display="block"),u&&(u.style.opacity="1",u.style.pointerEvents="auto");return}if(!b||b.length===0){const w=document.getElementById("donate-error");st=!1,w&&(w.textContent="Political Donation is on cooldown until next tick.",w.style.display="block"),u&&(u.style.opacity="1",u.style.pointerEvents="auto"),bt("donate");return}const{data:$}=await g.from("factions").select("party_funds").eq("id",o.id).single(),h=Number($?.party_funds??0),{error:E}=await g.from("factions").update({party_funds:h+r}).eq("id",o.id);if(E){await g.from("factions").update({corp_cash_reserves:p}).eq("id",d.id);const w=document.getElementById("donate-error");st=!1,w&&(w.textContent="Failed to transfer funds: "+E.message,w.style.display="block"),u&&(u.style.opacity="1",u.style.pointerEvents="auto");return}d.corp_cash_reserves=p-a,d.corp_reputation=v;const k=d.faction_name||"Corporation",{error:T}=await g.from("event_log").insert({nation_id:o.nation_id||d.nation_id,faction_id:d.id,event_name:k+" — Political Donation",description_chosen:k+" has donated "+_(a)+" to "+(o.faction_name||"a political party")+". The party receives "+_(r)+" in campaign funds. Corporate reputation decreases by "+s+".",category:"business",trigger_key:"corp_donation",effects_applied:{cost:a,recipient_faction_id:o.id,recipient_name:o.faction_name,funds_granted:r,reputation_loss:s,skill:i},fired_at_tick:e});T&&console.warn("Failed to log donation event:",T.message),st=!1,bt("donate"),Gn()}function vs(o){vt=o,kt()}async function ys(o){if(we=o,Ce=-1,document.getElementById("exec-search-overlay").style.display="flex",jt.length===0&&d?.nation_id){const{data:e}=await g.from("executive_pool").select("id").eq("nation_id",d.nation_id).limit(1);if(!e||e.length===0){const n=d.nation||"",i=La(d.nation_id,n),{error:a}=await g.from("executive_pool").insert(i);a&&console.warn("Failed to generate executive pool:",a.message)}const{data:t}=await g.from("executive_pool").select("*").eq("nation_id",d.nation_id).eq("status","available").order("skill",{ascending:!1});jt=t||[]}Ji()}function Qi(){document.getElementById("exec-search-overlay").style.display="none",we=null,Ce=-1}function Ki(o){return jt.filter(e=>e.status==="available"&&Array.isArray(e.specializations)&&e.specializations.includes(o)).sort((e,t)=>t.skill-e.skill)}function gs(o){Ce=o,Ji()}let ro=!1;async function xs(){if(!d||!z||!we||Ce<0||ro)return;const e=Ki(we)[Ce];if(!e)return;ro=!0;const t=z.current_tick||0,n=document.getElementById("es-hire-btn");n&&(n.style.opacity="0.4",n.style.pointerEvents="none");const{error:i}=await g.from("corp_executives").insert({faction_id:d.id,role:we,first_name:e.first_name,last_name:e.last_name,age:e.age,origin_nation:e.origin_nation,skill:e.skill,salary_per_year:e.required_salary,contract_years:e.required_years,contract_start_tick:t,contract_end_tick:t+e.required_years*12,status:"active"});if(i){ro=!1;const r=document.getElementById("es-error");r&&(r.textContent="Failed: "+i.message,r.style.display="block"),n&&(n.style.opacity="1",n.style.pointerEvents="auto");return}const{error:a}=await g.from("executive_pool").update({status:"hired",hired_by_faction_id:d.id}).eq("id",e.id);a&&console.warn("Failed to mark pool candidate as hired:",a.message),ro=!1,Qi(),await Oi(),vt=lo.indexOf(we),vt<0&&(vt=0),kt()}function Ji(){const o=document.getElementById("exec-search-content");if(!o||!we)return;const e=we,t=co[e],n=Ki(e),i=Ce>=0?n[Ce]:null;let a="";a+=`<div style="padding:12px 20px;border-bottom:1px solid var(--panel-border);background:var(--bg-panel);flex-shrink:0;">
        <div style="display:flex;justify-content:space-between;align-items:center;">
            <div style="display:flex;align-items:center;gap:10px;">
    ...
    </div>`,a+='<div id="es-error" style="padding:5px 20px;font-family:var(--font-mono);font-size:10px;color:#c55;display:none;"></div>',o.innerHTML=a}function Io(){return Y.reduce((e,t)=>{const n=Number(t.capacity||0),i=Number(t.condition||0)/100;return e+Math.floor(n*i)},0)+500}function bs(o,e){const t=Qe.find(a=>a.id===o),n=Number(d?.[t.factionKey]??0),i=ie[o]+e;if(!(n+i<0)){if(e>0){const a=Qe.reduce((s,l)=>{const c=Number(d?.[l.factionKey]??0),f=l.id===o?i:ie[l.id];return s+c+f},0),r=Io();if(a>r)return}ie[o]=i,No()}}function _s(o){o?ie[o]=0:ie={general:0,skilled:0,innovative:0},No()}async function hs(){if(Jo||!Object.values(ie).some(r=>r!==0))return;let e=0;for(const r of Qe){const s=ie[r.id];s>0&&(e+=s*Mi(r.multiplier)*.1)}const t=Number(d?.corp_cash_reserves??0);if(e>t){alert("Insufficient cash reserves. Hiring cost: "+_(e)+", available: "+_(t));return}const n=Qe.reduce((r,s)=>r+Number(d?.[s.factionKey]??0)+ie[s.id],0),i=Io();if(n>i){alert("Cannot hire beyond property capacity ("+i.toLocaleString()+"). You need more workplaces.");return}const a=e>0?`Confirm workforce changes?

Hiring fee: `+_(e)+" (deducted from cash reserves)":`Confirm workforce changes?

Firing workers — no cost.`;if(confirm(a)){Jo=!0;try{const r={};for(const c of Qe){const f=Number(d?.[c.factionKey]??0);r[c.factionKey]=Math.max(0,f+ie[c.id])}e>0&&(r.corp_cash_reserves=Math.max(0,t-Math.round(e)));const{error:s}=await g.from("factions").update(r).eq("id",d.id);if(s)throw s;Object.assign(d,r),ie={general:0,skilled:0,innovative:0};const l=document.getElementById("topbar-cash");if(l){const c=Number(d.corp_cash_reserves??0);l.textContent="CASH: "+(c>=1e6?"$"+(c/1e6).toFixed(1)+"M":"$"+Math.round(c/1e3)+"k")}No()}catch(r){alert("Error: "+r.message)}finally{Jo=!1}}}function No(){const o=document.getElementById("hf-card-container");if(!o)return;const e="'JetBrains Mono', monospace",t={bg:"var(--bg-card)",surface:"var(--panel-main)",card:"var(--bg-panel)",border:"var(--panel-border)",accent:"#8b9a6b",greenBright:"#5c5",red:"#c55",redDim:"#a44",text:"var(--panel-text)",muted:"#9e9a92",dim:"#6a6660"},n=Number(I?.minimum_wage??50),i=Number(I?.inflation??50),a=Number(I?.standard_of_living??50),r=n/100*48e3,s=(1+(i-50)/100*.5).toFixed(2),l=(1+(a-50)/100*.5).toFixed(2),c=I?.name||d?.nation||"Nation",f=Object.values(ie).some(h=>h!==0),p=Io();let u=0,m=0,v=0,b=0,y="";for(const h of Qe){const E=Number(d?.[h.factionKey]??0),k=ie[h.id],T=E+k,w=Mi(h.multiplier),S=k>0,A=E*w,C=T*w,q=C-A;u+=E,m+=T,v+=A,b+=C;const L=k!==0?S?"rgba(92,204,92,0.02)":"rgba(204,85,85,0.02)":"transparent";y+=`
        <div style="padding:10px 14px;border-bottom:1px solid ${t.border};background:${L};">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px;">
                ...
                <div style="display:flex;align-items:baseline;gap:4px;">
                    ...
                    ${k!==0?`<span style="font-family:${e};font-size:10px;color:${t.dim}">→</span>
            ...
            <div style="display:flex;align-items:center;gap:4px;">
                ...
                <div style="flex:1;text-align:center;padding:2px 0;background:${k!==0?t.card:"transparent"};border:1px solid ${k!==0?t.border:"transparent"}">
                    ${k!==0?`<div style="display:flex;align-items:center;justify-content:center;gap:6px;">
                        <span style="font-family:${e};font-size:12px;font-weight:700;color:${S?t.greenBright:t.red}">${S?"+":""}${k}</span>
            ...
            ${k!==0?`<div style="margin-top:6px;padding:4px 8px;background:${t.bg};border:1px solid ${t.border};display:flex;justify-content:space-between;align-items:center;">
    ...
    </div>`}function $s(){const o=document.getElementById("wf-summary-container");if(!o)return;const e="'JetBrains Mono', monospace",t={surface:"var(--panel-main)",card:"var(--bg-panel)",border:"var(--panel-border)",accent:"#8b9a6b",gold:"#c8a832",orange:"#c84",blue:"#5a9abf",text:"var(--panel-text)",muted:"#9e9a92",dim:"#6a6660",red:"#c55"},n=(I?.name||d?.nation||"Nation").toUpperCase(),i=Number(I?.minimum_wage??50),a=Number(I?.inflation??50),r=Number(I?.standard_of_living??50),s=i/100*48e3,l=1+(a-50)/100*.5,c=1+(r-50)/100*.5,f=[{label:"General Workforce",mult:2,color:t.accent,key:"corp_general_workforce",countColor:t.text},{label:"Skilled Workforce",mult:3,color:t.gold,key:"corp_skilled_workforce",countColor:t.blue},{label:"Innovative Workforce",mult:6,color:t.orange,key:"corp_innovative_workforce",countColor:t.gold}];let p=0,u=0,m="";for(const v of f){const b=Number(d?.[v.key]??0),y=Math.round(s*v.mult*l*c),$=b*y;p+=b,u+=$,m+=`
    ...
    </div>`}function ws(o){se=se===o?null:o,Ro()}let en=!1;async function ks(){if(se===null||en)return;const o=ft[se];if(!o)return;const e=Number(d?.corp_cash_reserves??0);if(o.adjusted_cost>e){alert(`Insufficient cash reserves.
...
All construction corporations in `+t+" can now bid on this project.")}catch(o){alert("Failed to submit project: "+o.message)}finally{tn=!1}}}function Zi(){if(document.getElementById("cp-modal-overlay")?.remove(),!Wn)return;const o="'JetBrains Mono', monospace",e={surface:"var(--panel-main)",card:"var(--bg-panel)",border:"var(--panel-border)",accent:"#8b9a6b",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",redDim:"#a44",text:"var(--panel-text)",muted:"#9e9a92",dim:"#6a6660"},t=Xi(),n=I?.name||d?.nation||"Nation",i=Math.ceil(t.adjusted/1e8*3),a=i>=4?e.gold:i>=3?e.greenBright:i>=2?e.accent:e.dim,r=Object.entries(ht).map(([c,f])=>{const p=R.style===c;return`<div onclick="cpSetField('style','${c}')" style="padding:5px 6px;cursor:pointer;text-align:center;background:${p?f.color+"18":"transparent"};border:1px solid ${p?f.color+"44":e.border};">
    ...
    <div style="width:570px;background:${e.surface};border:1px solid ${e.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;max-height:90vh;">
        ...
        <div style="padding:14px 20px;overflow:auto;flex:1;">
            ...
            <div style="margin-bottom:14px;">
                ...
                <input id="cp-name-input" value="${R.name.replace(/"/g,"&quot;")}" placeholder="e.g., McKenna Tower"
            ...
            <div style="margin-bottom:14px;">
                ...
                ${R.type==="Regional HQ"?`<div style="margin-top:8px;">
                    ...
                    <select id="cp-nation-select" onchange="cpSetField('nationId', this.value); cpSetField('nationName', this.options[this.selectedIndex].text)"
                        ...
                        ${$n.map(c=>`<option value="${c.id}" ${R.nationId===c.id?"selected":""}>${c.name}</option>`).join("")}
                    </select>
                ...
                ${R.type==="Warehouse"?`<div style="font-family:${o};font-size:9px;color:${e.orange};margin-top:5px;">Warehouse: 75% construction cost, stores up to $20M in materials</div>`:""}
                ${R.type==="Branch Office"?`<div style="font-family:${o};font-size:9px;color:#8a6aaa;margin-top:5px;">Branch Office: Increases lending capacity. +1 reputation per 200 employees. Enables cross-nation lending.</div>`:""}
                ${R.type==="Trading Floor"?`<div style="font-family:${o};font-size:9px;color:#8a6aaa;margin-top:5px;">Trading Floor: Enables secondary bond market. +1 reputation per 200 employees. Portfolio management bonuses.</div>`:""}
                ${R.type==="Claims Office"?`<div style="font-family:${o};font-size:9px;color:#8a6aaa;margin-top:5px;">Claims Office: Faster claim processing. +1 reputation per 200 employees. Local presence reduces premiums.</div>`:""}
            </div>

            <div style="margin-bottom:14px;">
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:5px;">
                    <span style="font-family:${o};font-size:10px;color:${e.dim};letter-spacing:1px;text-transform:uppercase">Size (Employees)</span>
                    <span style="font-family:${o};font-size:18px;font-weight:700;color:${e.text}">${R.size.toLocaleString()}</span>
                </div>
                <input type="range" min="500" max="18000" step="500" value="${R.size}" oninput="cpSetField('size',+this.value)"
            ...
            <div style="margin-bottom:14px;">
                ...
                <div style="margin-top:5px;font-family:${o};font-size:10px;color:${ht[R.style].color}">${ht[R.style].desc}</div>
            </div>

            <div style="margin-bottom:14px;">
                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:5px;">
                    <span style="font-family:${o};font-size:10px;color:${e.dim};letter-spacing:1px;text-transform:uppercase">Timeline</span>
                    <span style="font-family:${o};font-size:16px;font-weight:700;color:${e.text}">${R.timeline} months</span>
                </div>
                <input type="range" min="24" max="60" step="6" value="${R.timeline}" oninput="cpSetField('timeline',+this.value)"
                    style="width:100%;accent-color:${e.gold};height:5px;" />
                <div style="display:flex;justify-content:space-between;font-family:${o};font-size:9px;color:${e.dim};margin-top:3px">
            ...
            <div style="margin-bottom:14px;">
                ...
                <div style="background:${e.card};border:1px solid ${e.border};padding:10px 12px;">
                    <div style="display:flex;justify-content:space-between;padding:3px 0;border-bottom:1px solid ${e.border}">
                        <span style="font-family:${o};font-size:10px;color:${e.dim}">BASE (${R.size.toLocaleString()} × $100k × ${t.inflMod.toFixed(2)} × ${t.styleMod.toFixed(1)})</span>
                    ...
                    <div style="padding:8px 0">
                        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:4px">
                            ...
                            <span style="font-family:${o};font-size:13px;font-weight:700;color:${R.budgetMod>0?e.greenBright:R.budgetMod<0?e.red:e.dim}">${R.budgetMod>0?"+":""}${R.budgetMod}%</span>
                        </div>
                        <input type="range" min="-15" max="15" step="1" value="${R.budgetMod}" oninput="cpSetField('budgetMod',+this.value)"
                            style="width:100%;accent-color:${e.accent};height:5px;" />
                        <div style="display:flex;justify-content:space-between;font-family:${o};font-size:9px;color:${e.dim};margin-top:3px">
            ...
            <div style="padding:8px 10px;background:rgba(139,154,107,0.04);border:1px solid rgba(139,154,107,0.12);">
                ...
                <div style="font-family:${o};font-size:9px;color:${e.dim};margin-top:3px">${R.style} style · ${i===5?"Maximum prestige":i>=4?"Impressive presence":i>=3?"Strong statement":i>=2?"Solid investment":"Functional addition"}</div>
            </div>
...
Total received: `+_(u))}catch(m){alert("Failed: "+m.message)}finally{re=!1}}}function Ms(o){oa(o,"sell")}async function Rs(o){if(re)return;const e=Y.find(s=>s.id===o);if(!e)return;const t=ea(e.nation_id),i=Lo(e.nation_id).reduce((s,l)=>s+Math.round((l.purchase_price||0)*.8*(l.condition||50)/100),0),a=Number(e.sub_cash||0),r=Math.round(a*.05);if(confirm('PUT UP FOR SALE: "'+e.name+`"
...
This cannot be undone.`)){re=!0;try{const b=d.nation_id;if(n.length>0){const S=n.filter(C=>C.id!==e.id).map(C=>C.id);if(S.length===1){const{error:C}=await g.from("corp_properties").update({nation_id:b,type:"office"}).eq("id",S[0]);if(C)throw C}else if(S.length>1){const{error:C}=await g.from("corp_properties").update({nation_id:b,type:"office"}).in("id",S);if(C)throw C}const{error:A}=await g.from("corp_properties").update({nation_id:b,type:"office",sub_cash:0,subsector:null}).eq("id",e.id);if(A)throw A}const y=v-l+a,h=Number(d?.corp_general_workforce??0)+m,E=Math.random()>=.5?c:-f,k=Number(d?.standing??50),T=Math.max(0,Math.min(100,k+E)),{error:w}=await g.from("factions").update({corp_cash_reserves:y,corp_general_workforce:h,standing:T}).eq("id",d.id);if(w)throw w;d.corp_cash_reserves=y,d.corp_general_workforce=h,d.standing=T,tt(y),await Kt(),alert(`Merger complete!

"`+e.name+`" absorbed into your corporation.
Cost: `+_(l)+" | Cash absorbed: "+_(a)+`
Reputation `+(E>=0?"+":"")+E+" (now "+T+`)
Workers hired: +`+m.toLocaleString()+` general workforce
Properties: `+n.length+" transferred to parent")}catch(b){alert("Merge failed: "+b.message)}finally{re=!1}}}window.subDissolve=Ps;window.subInjectCapital=Ds;window.subWithdraw=js;window.subMerge=Fs;window.subSell=Ms;window.subPutForSale=Rs;window.subPlaceBid=Ls;window.subViewBids=qs;window.subCancelSale=Bs;window.selectSubsidiary=function(o){mt=o,Jt()};let Ct=[],Lt={},ue=null,nn=!1,ot="",Ht="",nt="",Ne="";const aa={Construction:4,Finance:5,Shipping:4},Us=["Construction","Shipping","Finance"],ra={Construction:[{id:"civil",name:"Civil Engineering",mod:0},{id:"industrial",name:"Industrial Construction",mod:.25},{id:"mega",name:"Megaprojects",mod:.4}],Shipping:[{id:"bulk_cargo",name:"Bulk Cargo",mod:0},{id:"container_freight",name:"Container Freight",mod:.2},{id:"specialized_transport",name:"Specialized Transport",mod:.35}],Finance:[{id:"banking",name:"Banking",mod:0},{id:"insurance",name:"Insurance",mod:.15},{id:"investment",name:"Investment Management",mod:.3}],Technology:[{id:"software",name:"Software Development",mod:0},{id:"hardware",name:"Hardware Manufacturing",mod:.2},{id:"telecom",name:"Telecommunications",mod:.35}],Energy:[{id:"oil_gas",name:"Oil & Gas",mod:0},{id:"renewables",name:"Renewables",mod:.2},{id:"mining",name:"Mining",mod:.3}],Healthcare:[{id:"pharma",name:"Pharmaceuticals",mod:0},{id:"hospitals",name:"Hospital Systems",mod:.2},{id:"biotech",name:"Biotechnology",mod:.35}]};async function Hs(){const{data:o,error:e}=await g.from("nations").select("*").order("name");e&&console.warn("[Subsidiary] Failed to load nations:",e.message),Ct=(o||[]).filter(n=>n.id!==d?.nation_id);const{data:t}=await g.from("factions").select("nation_id").eq("faction_type","corporation").is("abandoned_at",null);Lt={};for(const n of t||[])n.nation_id&&(Lt[n.nation_id]=(Lt[n.nation_id]||0)+1);nt=d?.corp_sector||"",Ne=d?.corp_subsector||""}function sa(){const o=nt||d?.corp_sector||"";return ra[o]||[{id:"general",name:o||"General",mod:0}]}function Gs(o){nt=o;const e=ra[o];Ne=e?e[0].name:"",Xt()}function la(){const o=d?.corp_sector||"";return nt===o?1:aa[nt]||4}function Vs(){const e=sa().find(t=>t.name===Ne);return e?e.mod:0}function wn(o){const e=Number(o.standard_of_living??50);return Math.max(.5,Math.round(e/50*100)/100)}function da(o){const t=la(),n=1+Vs(),i=wn(o);return Math.round(Math.max(1e7,5e7*t*n*i))}function Ws(o){const e=Lt[o]||0;return e<=1?{label:"HIGH",color:"#5c5"}:e<=3?{label:"MODERATE",color:"#ca5"}:{label:"LOW",color:"#c55"}}function Ys(o){if(ue=ue===o?null:o,ue){const e=Ct.find(t=>t.id===ue);ot=(d?.faction_name||"Subsidiary")+" "+(e?.name||"")}else ot="";Xt()}function Qs(o){Ne=o,Xt()}function Ks(o){ot=o}function Js(o){Ht=o.toUpperCase().slice(0,4)}async function Xs(){if(nn||!ue)return;const o=Ct.find(r=>r.id===ue);if(!o)return;const e=(ot||"").trim(),t=(Ht||"").trim();if(!e){alert("Please enter a corporation name for the subsidiary.");return}if(t.length<2){alert("Please enter an abbreviation (2-4 chars).");return}if(Y.find(r=>r.nation_id===o.id&&r.type==="regional_hq")){alert("You already have a subsidiary in "+o.name);return}const i=da(o),a=Number(d?.corp_cash_reserves??0);if(i>a){alert("Insufficient cash. Entry cost: "+_(i)+", available: "+_(a));return}if(confirm("Establish subsidiary in "+o.name+`?
...
Regional HQ created with `+l+"% condition.")}catch(r){alert("Failed: "+r.message)}finally{nn=!1}}}function Xt(){const o=document.getElementById("create-subsidiary-container");if(!o)return;const e="'JetBrains Mono', monospace",t={bg:"var(--bg-card)",surface:"var(--panel-main)",card:"var(--bg-panel)",border:"var(--panel-border)",accent:"#8b9a6b",accentBright:"#a3b07e",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",yellow:"#ca5",text:"var(--panel-text)",muted:"#9e9a92",dim:"#6a6660"},n=d?.corp_sector||"General",i=d?.corp_subsector||"",a=sa(),r=a.find(C=>C.name===Ne)||a[0],s=new Set(Y.filter(C=>C.type==="regional_hq").map(C=>C.nation_id)),l=Ct.filter(C=>!s.has(C.id)),c=ue?l.find(C=>C.id===ue):null,f=ot.trim().length>0&&Ht.trim().length>=2&&c!==null,p=nt||n,u=la();let m=`
    <div style="padding:6px 14px;border-bottom:1px solid ${t.border};">
        ...
        <div style="display:flex;gap:3px;">
            ${Us.map(C=>{const q=C===p,L=C===n,M=L?1:aa[C]||4,U=L?t.greenBright:t.orange;return`<div onclick="subSetSector('${C}')" style="flex:1;padding:5px 4px;text-align:center;cursor:pointer;background:${q?t.accent+"18":"transparent"};border:1px solid ${q?t.accent+"44":t.border};">
                    <div style="font-family:${e};font-size:9px;font-weight:700;color:${q?t.accentBright:t.dim}">${C}</div>
                    <div style="font-family:${e};font-size:7px;margin-top:2px;color:${U}">${L?"PARENT · ×1":"×"+M+" COST"}</div>
                </div>`}).join("")}
        </div>
    ...
    <div style="padding:6px 14px;border-bottom:1px solid ${t.border};">
        ...
        <div style="display:flex;gap:3px;">
            ${a.map(C=>{const q=C.name===Ne,L=C.name===i;return`<div onclick="subSetSubsector('${C.name.replace(/'/g,"\\'")}')" style="flex:1;padding:5px 4px;text-align:center;cursor:pointer;background:${q?t.accent+"18":"transparent"};border:1px solid ${q?t.accent+"44":t.border};">
                    <div style="font-family:${e};font-size:8px;font-weight:700;color:${q?t.accentBright:t.dim}">${C.name}</div>
                    <div style="font-family:${e};font-size:7px;margin-top:2px;color:${L?t.greenBright:C.mod>0?t.orange:t.dim}">${L?"SAME — ±0%":C.mod>0?"+"+Math.round(C.mod*100)+"%":"±0%"}</div>
                </div>`}).join("")}
        </div>
    </div>`,b="";if(l.length===0)b=`<div style="padding:20px;text-align:center;font-family:${e};font-size:10px;color:${t.dim}">Subsidiaries in all available nations.</div>`;else for(const C of l){const q=C.id===ue,L=Ws(C.id),M=Lt[C.id]||0,U=Math.round(Number(C.standard_of_living??50)),j=wn(C);b+=`
            <div onclick="subSelectNation('${C.id}')" style="display:flex;align-items:center;padding:4px 8px;margin-bottom:2px;cursor:pointer;background:${q?"rgba(139,154,107,0.04)":"transparent"};border:1px solid ${q?t.accent+"44":t.border};border-left:${q?"2px solid "+t.accent:"2px solid transparent"};">
                <div style="flex:1;">
                    <div style="display:flex;align-items:center;gap:6px;">
                        <span style="font-size:11px;font-weight:600;color:${q?t.text:t.muted}">${C.name}</span>
    ...
    <div style="padding:6px 14px;border-bottom:1px solid ${t.border};">
        ...
        <div style="background:${t.card};border:1px solid ${t.border};padding:6px 8px;">
            ${$.map((C,q)=>`<div style="display:flex;align-items:center;gap:6px;padding:2px 0;${q<$.length-1?"border-bottom:1px solid "+t.border:""}">
                <span style="font-family:${e};font-size:9px;color:${C.color};width:12px;text-align:center">${C.icon}</span>
                <span style="font-size:9px;color:${t.muted}">${C.rule}</span>
            </div>`).join("")}
        </div>
    </div>`;const E=5e7,k=r.mod,T=c?wn(c):null,w=c?da(c):null,S=Math.round(E*u*(1+k));let A=`
    <div style="background:${t.bg};border:1px solid ${t.border};padding:6px 8px;margin-bottom:6px;">
        ...
        <div style="display:flex;justify-content:space-between;padding:2px 0;border-bottom:1px solid ${t.border};">
            ...
            <span style="font-family:${e};font-size:9px;color:${c?T>1?t.orange:t.greenBright:t.dim}">${c?"×"+T.toFixed(2):"—"}</span>
        </div>
        <div style="display:flex;justify-content:space-between;padding:3px 0;">
            <span style="font-family:${e};font-size:9px;font-weight:700;color:${t.text}">TOTAL COST</span>
            <span style="font-family:${e};font-size:14px;font-weight:700;color:${t.gold}">${c?_(w):"~"+_(S)}</span>
        </div>
    </div>`;o.innerHTML=`
    <div style="width:380px;height:450px;background:${t.surface};border:1px solid ${t.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        <div style="padding:8px 14px;border-bottom:1px solid ${t.border};display:flex;justify-content:space-between;align-items:center;flex-shrink:0;">
    ...
    </div>`}window.corpSelect=el;window.corpInvestigate=nl;window.corpFilterNation=tl;window.corpSort=ol;let he=null,ze={},K=120,Ie=15,kn={},ut=[];async function il(){if(!We)return;if(wt[We.id]){alert("You already have a bid on this contract. Retract it first if you want to re-bid.");return}he=We,kn={};try{const{data:t}=await g.from("corp_material_inventory").select("material_key, quantity").eq("faction_id",d.id);for(const n of t||[])kn[po(n.material_key)]=Number(n.quantity||0)}catch{}ut=[];try{const{data:t}=await g.from("contract_bids").select("faction_id, bid_price, estimated_quality, status, factions(faction_name, corp_ticker)").eq("contract_id",he.id).in("status",["pending","won"]);ut=(t||[]).filter(n=>n.faction_id!==d?.id).map(n=>({name:n.factions?.faction_name||"Unknown",ticker:n.factions?.corp_ticker||"???",price:Number(n.bid_price||0),quality:Number(n.estimated_quality||0),status:n.status}))}catch{}ze={};const o=he.required_materials||{};for(const t of Object.keys(o))ze[t]="STD";const e=he.required_workforce||{};K=Number(e.general||0)+Number(e.skilled||0)||120,Ie=15,Yt(),Bo()}function Qn(){document.getElementById("bid-assembly-overlay")?.remove(),he=null}function al(o,e){ze[o]=e,Bo()}function rl(o){K=o,Bo()}function sl(o){Ie=o,Bo()}function Bo(){if(document.getElementById("bid-assembly-overlay")?.remove(),!he)return;const o="'JetBrains Mono', monospace",e={surface:"var(--panel-main)",card:"var(--bg-panel)",border:"var(--panel-border)",accent:"#8b9a6b",accentBright:"#a3b07e",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",redDim:"#a44",yellow:"#ca5",text:"var(--panel-text)",muted:"#9e9a92",dim:"#6a6660"},t=he,n=t.issuer_type==="GOVERNMENT",i=I?.name||d?.nation||"—",a=Number(t.budget_ceiling||0),r=Number(t.timeline_ticks||8),s=t.required_materials||{},l=Object.keys(s),c={LOW:.5,STD:1,HIGH:2},f={LOW:e.orange,STD:e.yellow,HIGH:e.greenBright},p={LOW:"Low",STD:"Standard",HIGH:"High"},u={concrete:36e4,steel:5e5,glass_facades:56e4,em_systems:64e4,lumber:24e4,heavy_parts:8e5,aggregate:16e4,asphalt:28e4},m=kn||{};let v=0,b="";for(const D of l){const Q=Number(s[D]||0),ei=ze[D]||"STD",ti=u[D]||3e5,xa=c[ei],ba=Math.round(ti*xa),oi=Q*ba;v+=oi;const _a=D.replace(/_/g," ").replace(/\b\w/g,Re=>Re.toUpperCase()),ni=Number(m[D]||0),Fo=Math.max(0,Q-ni),ha=Fo===0?e.greenBright:Fo<Q?e.yellow:e.red,$a=Fo===0?"✓ IN STOCK":`${ni}/${Q}`;b+=`
    ...
    <div style="width:740px;max-height:94vh;background:${e.surface};border:1px solid ${e.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        ...
        <div style="flex:1;display:flex;overflow:hidden;">
            ...
            <div style="flex:1;border-right:1px solid ${e.border};overflow:auto;">
                ...
                <div style="padding:8px 14px;border-bottom:1px solid ${e.border};">
                    <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px;">
                        ...
                        <div style="display:flex;gap:3px;">
                            ${k.map(D=>`<span onclick="bidSetWorkers(${D})" style="padding:2px 8px;font-family:${o};font-size:8px;font-weight:700;cursor:pointer;color:${K===D?"#000":e.dim};background:${K===D?e.accent:"transparent"};border:1px solid ${K===D?e.accent:e.border}">${D}</span>`).join("")}
                        </div>
                    </div>
                    <div style="display:flex;justify-content:space-between;">
                        <span style="font-family:${o};font-size:8px;color:${e.dim}">${K} × $${L.toLocaleString()}/tick × ${A} ticks</span>
                        <span style="font-family:${o};font-size:11px;font-weight:700;color:${e.text}">${_(M)}</span>
                    </div>
                    ...
                    <div style="display:flex;justify-content:space-between;margin-top:6px;padding-top:6px;border-top:1px solid ${e.border};">
                        ...
                        <span style="font-family:${o};font-size:10px;font-weight:700;color:${q}">${A}mo <span style="font-size:8px;opacity:0.7">(${C})</span></span>
                    </div>
                </div>
            ...
            <div style="width:280px;display:flex;flex-direction:column;overflow:auto;">
                ...
                ${[{l:"Materials",v},{l:"Labor",v:M},{l:"Permits",v:P},{l:"Overhead",v:F}].map(D=>`<div style="display:flex;justify-content:space-between;padding:4px 14px;border-bottom:1px solid ${e.border};">
    ...
    </div>`,document.body.appendChild(at)}let an=!1;async function ll(){if(an||!he)return;const o=he,e=o.required_materials||{},t=Object.keys(e),n=Number(o.budget_ceiling||0),i=Number(o.timeline_ticks||8),a={concrete:36e4,steel:5e5,glass_facades:56e4,em_systems:64e4,lumber:24e4,heavy_parts:8e5,aggregate:16e4,asphalt:28e4},r={LOW:.5,STD:1,HIGH:2};let s=0;for(const L of t){const M=Number(e[L]||0),U=ze[L]||"STD",j=a[L]||3e5;s+=M*Math.round(j*r[U])}const l=15200,c=o.required_workforce||{},f=Number(c.general||0)+Number(c.skilled||0)||100,p=Math.max(40,Math.round(f*.5)),u=f*2,m=Math.max(0,Math.min(1,(K-p)/(u-p||1))),v=Math.round(4.5-m*8),b=Math.max(Math.round(i*.6),i+v),y=K*l*b,$=n,h=[{name:"Municipal Zoning Approval",cost:18e4,required:!0},{name:"Structural Engineering Cert.",cost:24e4,required:!0},{name:"Environmental Impact Assessment",cost:34e4,required:$>2e7},{name:"Seismic Resilience Compliance",cost:21e4,required:$>5e7},{name:"Fire Safety Certification",cost:12e4,required:$>1e7}],E=new Set(["Municipal Zoning Approval","Structural Engineering Cert."]),k=h.filter(L=>L.required&&!E.has(L.name)).reduce((L,M)=>L+M.cost,0),w=s+y+k+4e5,S=Math.round(w*(Ie/100)),A=w+S;if(A>n){alert("Bid exceeds budget ceiling. Reduce costs or markup.");return}const C=Object.values(ze),q=C.length>0?Math.round(C.reduce((L,M)=>L+(M==="HIGH"?85:M==="STD"?65:45),0)/C.length):50;if(confirm('Submit bid for "'+o.name+`"?
...
Once submitted, your bid cannot be changed.`)){an=!0;try{const{data:L}=await g.from("shard").select("current_tick").eq("name","Alpha Shard").single(),M=L?.current_tick||0,U={};for(const H of t)U[H]=ze[H]||"STD";const{error:j}=await g.from("contract_bids").insert({contract_id:o.id,faction_id:d.id,bid_price:A,material_grades:U,labor_count:K,markup_pct:Ie,estimated_cost:w,estimated_quality:q,status:"pending",submitted_at_tick:M});if(j)throw j;o.status==="open"&&await g.from("construction_contracts").update({status:"bidding"}).eq("id",o.id).eq("status","open"),Qn(),alert(`Bid submitted successfully!
...
Lowest qualified bid wins.`),typeof Ze=="function"&&await Ze()}catch(L){alert("Bid submission failed: "+L.message)}finally{an=!1}}}window.openBidAssembly=il;window.closeBidAssembly=Qn;window.bidSetGrade=al;window.bidSetWorkers=rl;window.bidSetMarkup=sl;window.submitBidAssembly=ll;let rn=!1;async function dl(o){if(rn)return;const e=1e6,t=Number(d?.corp_cash_reserves??0);if(t<e){alert("Cannot retract — you need at least $1M in cash reserves to cover the retraction penalty.");return}if(confirm(`Retract your bid?

This will cost $1M as a retraction penalty.
This action cannot be undone.`)){rn=!0;try{const n=t-e,{error:i}=await g.from("factions").update({corp_cash_reserves:n}).eq("id",d.id);if(i)throw i;const{error:a}=await g.from("contract_bids").delete().eq("contract_id",o).eq("faction_id",d.id);if(a)throw a;d.corp_cash_reserves=n,typeof tt=="function"&&tt(n),alert("Bid retracted. $1M penalty applied."),Yt(),await Ze()}catch(n){alert("Failed to retract bid: "+(n.message||"Unknown error"))}finally{rn=!1}}}window.retractBid=dl;let Gt=[],He=0,ve=null,sn=!1,ln=!1,dn=!1;async function cl(){if(!We||ln)return;ln=!0,ve=We,He=0;const{data:o,error:e}=await g.from("contract_bids").select("*, factions(faction_name, corp_ticker, corp_subsector)").eq("contract_id",ve.id).in("status",["pending","won"]).order("bid_price",{ascending:!0});if(ln=!1,e){alert("Failed to load bids: "+e.message);return}Gt=(o||[]).map(t=>({...t,corp:t.factions?.faction_name||"Unknown",abbr:t.factions?.corp_ticker||"???",subsector:t.factions?.corp_subsector||"—"})),Yt(),ca()}function Po(){document.getElementById("bid-review-overlay")?.remove(),ve=null}function pl(o){He=o,ca()}async function fl(){if(sn||Gt.length===0)return;const o=Gt[He];if(!(!o?.id||!o.faction_id)&&confirm("Accept bid from "+o.corp+`?
...
Bid: `+_(o.bid_price)+`
Project begins immediately.`),typeof Ze=="function"&&await Ze()}catch(e){alert("Failed to accept bid: "+(e.message||e))}finally{sn=!1}}}async function ml(){if(!(!ve||dn)&&confirm(`Decline all bids and cancel this project?
...
No bids will be accepted. The contract will be removed.`)){dn=!0;try{const{error:o}=await g.from("contract_bids").update({status:"lost"}).eq("contract_id",ve.id);if(o)throw o;const{error:e}=await g.from("construction_contracts").update({status:"expired"}).eq("id",ve.id);if(e)throw e;Po(),alert("All bids declined. Contract cancelled."),typeof Ze=="function"&&await Ze()}catch(o){alert("Failed: "+(o.message||o))}finally{dn=!1}}}function ca(){if(document.getElementById("bid-review-overlay")?.remove(),!ve||Gt.length===0)return;const o="'JetBrains Mono', monospace",e={surface:"var(--panel-main)",card:"var(--bg-panel)",border:"var(--panel-border)",accent:"#8b9a6b",accentBright:"#a3b07e",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",yellow:"#ca5",text:"var(--panel-text)",muted:"#9e9a92",dim:"#6a6660"},t=ve,n=Gt;He>=n.length&&(He=0);const i=n[He],a=Number(t.budget_ceiling||0),r=Number(t.timeline_ticks||36),s=Math.min(...n.map(m=>m.bid_price)),l=Math.max(...n.map(m=>m.estimated_quality||0));let c="";for(let m=0;m<n.length;m++){const v=n[m],b=m===He,y=v.bid_price===s,$=(v.estimated_quality||0)===l,h=v.bid_price>a;c+=`
    ...
    <div style="width:640px;max-height:92vh;background:${e.surface};border:1px solid ${e.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        ...
        <div style="font-family:var(--font-mono);font-size:12px;font-weight:700;color:${y.color};margin-top:1px;">${y.value}</div>
    </div>`).join("");const u=z?.current_tick||0;let m="";for(const y of a){const $=Math.max(1,Number(y.build_ticks)||1),h=Number(y.delivery_tick)||0,E=Number(y.ordered_at_tick)||0,k=Math.max(0,h-u),T=Math.max(0,Math.min($,u-E)),w=Math.max(0,Math.min(100,Math.round(T/$*100))),S=Ke[y.vessel_class]||{color:"#9e9a92",label:(y.vessel_class||"?").toUpperCase()},A=k===0?"Delivering this tick":`Delivery in ${k} tick${k!==1?"s":""}`;m+=`<div style="border-bottom:1px solid var(--border-0);border-left:2px solid var(--amber);">
            <div style="padding:7px 14px;">
        ...
        </div>`}i.length===0&&a.length===0?t.innerHTML='<div style="flex:1;display:flex;align-items:center;justify-content:center;font-family:var(--font-mono);font-size:9px;color:var(--text-dim);text-align:center;line-height:1.8;">No vessels in fleet.<br>Purchase ships to begin operations.</div>':i.length===0?t.innerHTML=m:t.innerHTML=m+i.map((y,$)=>{const h=Ft===$,E=Ke[y.vessel_class]||{color:"#666",label:"?"},k=ul[y.status]||{color:"#666",label:"?"},T=pa(y.condition),w=vl(y.fuel),S=y.condition<50||y.fuel<20,A=y.status==="in_transit",C=y.status==="dry_dock",q=z?.current_tick||0,L=Math.max(0,Math.floor((q-(y.built_at_tick||0))/12));let M=`<div onclick="flSelectVessel(${$})" style="border-bottom:1px solid var(--border-0);cursor:pointer;border-left:2px solid ${S?y.condition<50?T:w:"transparent"};background:${h?E.color+"06":"transparent"};">
                <div style="padding:7px 14px;">`;M+=`<div style="display:flex;align-items:center;gap:5px;margin-bottom:3px;">
            ...
            </div>`;const U=y.current_port_nation_id?"In port":A?"At sea":"—";if(M+=`<div style="font-family:var(--font-mono);font-size:7px;color:var(--text-dim);margin-bottom:5px;">${x(U)}</div>`,M+=`<div style="display:flex;gap:8px;margin-bottom:4px;">
                <div style="flex:1;">
                    <div style="display:flex;justify-content:space-between;margin-bottom:2px;">
                        <span style="font-family:var(--font-mono);font-size:6px;color:var(--text-dim);letter-spacing:0.5px;">CONDITION</span>
                        <span style="font-family:var(--font-mono);font-size:8px;font-weight:700;color:${T};">${y.condition}%</span>
                    </div>
                    <div style="width:100%;height:3px;background:var(--border-0);"><div style="width:${y.condition}%;height:100%;background:${T};"></div></div>
                </div>
                <div style="flex:1;">
                    <div style="display:flex;justify-content:space-between;margin-bottom:2px;">
            ...
            </div>`,M+=`<div style="display:flex;gap:0;background:var(--bg-3);border:1px solid var(--border-0);">
                ...
                <div style="flex:1;padding:3px 6px;text-align:right;">
            ...
            </div>`,C&&y.drydock_until_tick){const j=Math.max(0,y.drydock_until_tick-q);M+=`<div style="margin-top:4px;padding:3px 8px;background:rgba(204,136,68,0.06);border:1px solid rgba(204,136,68,0.15);display:flex;justify-content:space-between;align-items:center;">
                    ...
                    </div>`;M+="</div>";const H=A||C,N=Math.round((y.purchase_price||3e6)*.08*(1+(100-y.condition)/100)),P=Math.round((y.fuel_capacity||1e3)*50*(1-y.fuel/100)),F=Math.round((y.purchase_price||3e6)*(y.condition/100)*.6);if(M+=`<div style="display:flex;gap:4px;">
                    ...
                    <div onclick="${A?"":"flRefuel('"+y.id+"',"+P+")"}" style="flex:1;padding:5px 0;text-align:center;cursor:${A?"not-allowed":"pointer"};font-family:var(--font-mono);font-size:7px;font-weight:700;letter-spacing:0.5px;color:${A?"var(--text-dim)":"#c86a4a"};border:1px solid ${A?"var(--border-0)":"rgba(200,106,74,0.3)"};opacity:${A?.35:1};">REFUEL<br><span style="font-weight:400;font-size:6px;">from ${_(P)}</span></div>
                    <div onclick="${H?"":"flSell('"+y.id+"','"+x(y.vessel_name).replace(/'/g,"")+"',"+F+")"}" style="flex:1;padding:5px 0;text-align:center;cursor:${H?"not-allowed":"pointer"};font-family:var(--font-mono);font-size:7px;font-weight:700;letter-spacing:0.5px;color:${H?"var(--text-dim)":"#c84"};border:1px solid ${H?"var(--border-0)":"rgba(204,136,68,0.3)"};opacity:${H?.35:1};">LIST<br><span style="font-weight:400;font-size:6px;">${_(F)}</span></div>
                </div>`,!A){const G=It&&It[y.id],ee=fo&&fo[y.id];M+='<div style="display:flex;gap:4px;margin-top:4px;">',G?M+=`<div style="flex:1;display:flex;gap:2px;">
                        ...
                        </div>`:ee?M+='<div style="flex:1;padding:4px 0;text-align:center;font-family:var(--font-mono);font-size:7px;font-weight:700;letter-spacing:0.5px;color:#ca5;border:1px solid rgba(202,165,50,0.2);background:rgba(202,165,50,0.04);">PENDING ⏳</div>':M+=`<div onclick="event.stopPropagation();flRequestInsurance('${y.id}','${x(y.vessel_name).replace(/'/g,"")}',${y.purchase_price||0})" style="flex:1;padding:4px 0;text-align:center;cursor:pointer;font-family:var(--font-mono);font-size:7px;font-weight:700;letter-spacing:0.5px;color:#aa7a5a;border:1px solid rgba(170,122,90,0.3);background:rgba(170,122,90,0.04);">INSURE</div>`,M+=`<div onclick="flRename('${y.id}','${x(y.vessel_name).replace(/'/g,"")}')" style="flex:1;padding:4px 0;text-align:center;cursor:pointer;font-family:var(--font-mono);font-size:7px;font-weight:700;letter-spacing:0.5px;color:var(--text-muted);border:1px solid var(--border-0);">RENAME</div>`,M+="</div>"}A&&(M+='<div style="font-family:var(--font-mono);font-size:7px;color:var(--text-dim);margin-top:4px;">⊘ Vessel at sea — actions available on arrival</div>'),C&&(M+='<div style="font-family:var(--font-mono);font-size:7px;color:var(--text-dim);margin-top:4px;">⊘ Vessel in dry dock — repairs in progress</div>'),M+="</div>"}return M+="</div></div>",M}).join("");const v={};for(const y of i)v[y.vessel_class]=(v[y.vessel_class]||0)+1;let b='<div style="display:flex;gap:6px;">';for(const[y,$]of Object.entries(Ke))v[y]&&(b+=`<div style="display:flex;align-items:center;gap:3px;">
...
The insurer (`+_(a)+" coverage) has been notified. Claim details are visible in the events feed.")}window.flRequestInsurance=hl;window.flFileClaim=$l;const En={fuel_depot:{label:"FUEL DEPOT",color:"#c86a4a",icon:"⛽",desc:"Bunkering facility — refuel at base cost, earn revenue from visiting fleets."},dry_dock:{label:"DRY DOCK",color:"#c84",icon:"🔧",desc:"Repair & maintenance dock — dock at base cost, earn revenue from visiting fleets."}},wl=[{type:"fuel_depot",name:"Fuel Depot — Standard",cost:105e6,maint:85e3,style:"Basic",desc:"Bulk fuel storage and bunkering facility."},{type:"fuel_depot",name:"Fuel Depot — Advanced",cost:14e7,maint:11e4,style:"Modern",desc:"High-capacity fuel terminal with pipeline infrastructure."},{type:"dry_dock",name:"Dry Dock — Standard",cost:85e6,maint:15e4,style:"Basic",desc:"Ship repair and maintenance facility."},{type:"dry_dock",name:"Dry Dock — Advanced",cost:115e6,maint:2e5,style:"Modern",desc:"Full-service shipyard with drydock and crane facilities."}];let wo=[];async function ma(){if(!d)return;const{data:o}=await g.from("corp_properties").select("*, nations!nation_id(name)").eq("faction_id",d.id).in("type",["fuel_depot","dry_dock"]).eq("is_active",!0).order("created_at",{ascending:!1});wo=o||[],kl()}function kl(){const o=document.getElementById("pf-count"),e=document.getElementById("pf-list"),t=document.getElementById("pf-footer");if(!o||!e||!t)return;const n=wo;if(o.textContent=n.length+" FACILIT"+(n.length===1?"Y":"IES"),n.length===0)e.innerHTML=`<div style="padding:20px;text-align:center;">
...
This will create a construction contract that construction corporations can bid on. Payment occurs when the contract is awarded.`))return;pn=!0;const v=z.current_tick||0,b=(z.current_date||"").match(/\d{4}/)?.[0]||"2015";try{const{count:y}=await g.from("construction_contracts").select("id",{count:"exact",head:!0}).eq("nation_id",l.id).eq("issuer_type","PRIVATE"),h=`PVT-P${(y||0)+1}-${b}`,E=m.style==="Modern",k={concrete:E?60:40,steel:E?50:30,heavy_parts:E?30:20,aggregate:E?30:20},T={trucks:5,mixers:5,excavators:5},w={general:E?240:160,skilled:E?100:60},S=E?6:4,{error:A}=await g.from("construction_contracts").insert({nation_id:l.id,template_key:o,sector:"industrial",name:m.name,project_type:t.label,project_subtype:m.style,description:`${m.name} at ${l.capital} Port — commissioned by ${d.faction_name}. ${m.desc}`,project_code:h,budget_ceiling:m.cost,timeline_ticks:S,required_materials:k,required_equipment:T,required_workforce:w,status:"open",generated_at_tick:v,bidding_ends_tick:v+3,issuer_type:"PRIVATE",issuer_name:d.faction_name,issuer_faction_id:d.id});if(A)throw A;await ma(),alert(`Construction contract posted!
...
Construction corporations in `+l.name+" can now bid on this project.")}catch(y){alert("Failed to post contract: "+(y.message||"Error"))}finally{pn=!1}}window.pfOpenBuild=El;const Kn={"Bulk Cargo":["Reefer","Bulk","Coastal"],"Container Freight":["Coastal","Container"],"Specialized Transport":["Tanker","LNG","Bulk"]};async function Jn(){if(!d)return;const{data:o,error:e}=await g.from("ship_market_listings").select("*, nation:nation_id(id, name)").eq("status","available").order("asking_price",{ascending:!0});e&&console.warn("Failed to load ship market:",e.message),Sn=o||[],mo=null,ua()}function Cl(o){mo=mo===o?null:o,ua()}function Tl(o){return(Kn[d?.corp_subsector]||[]).includes(o)}function ua(){const o=document.getElementById("sm-count"),e=document.getElementById("sm-list"),t=document.getElementById("sm-footer");if(!o||!e)return;const n=Sn;o.textContent=n.length+" AVAILABLE",n.length===0?e.innerHTML='<div style="flex:1;display:flex;align-items:center;justify-content:center;font-family:var(--font-mono);font-size:9px;color:var(--text-dim);text-align:center;line-height:1.8;">No vessels on the market.<br>Check back next cycle.</div>':e.innerHTML=n.map((r,s)=>{const l=mo===s,c=Ke[r.vessel_class]||{color:"#666",label:"?"},f=r.seller_type==="CORP"?"#5a8aaa":"#8b9a6b",p=pa(r.condition),u=r.nation?.name||"—",m=Tl(r.vessel_class);z?.current_tick;const v=r.age_ticks||0,b=Math.max(1,Math.floor(v/12)),y=u!==d?.nation?Number(d?.tariffs||I?.tariffs||0):0,$=Math.round(r.asking_price*y/100),h=r.asking_price+$;let E=`<div onclick="smSelectListing(${s})" style="border-bottom:1px solid var(--border-0);cursor:pointer;border-left:2px solid ${l?c.color:"transparent"};background:${l?c.color+"06":"transparent"};">
                ...
                <div style="flex:1;padding:3px 6px;text-align:right;">
                    ...
                    </div>`),m?E+=`<div onclick="event.stopPropagation();smPurchase('${r.id}',${h})" style="padding:4px 14px;text-align:center;font-family:var(--font-mono);font-size:8px;font-weight:700;letter-spacing:1px;color:#000;background:${c.color};cursor:pointer;">${_(h)} — PURCHASE</div>`:E+=`<div style="padding:4px 14px;text-align:center;font-family:var(--font-mono);font-size:8px;font-weight:700;letter-spacing:0.5px;color:var(--text-dim);border:1px solid var(--border-0);opacity:0.4;">⊘ ${r.vessel_class} not available for ${d?.corp_subsector||"your subsector"}</div>`,E+="</div>"),E+="</div></div>",E}).join("");const i=n.filter(r=>r.seller_type==="CORP").length,a=n.filter(r=>r.seller_type==="LOCAL").length;t.innerHTML=`<div style="display:flex;gap:6px;">
    ...
    </div>`,o.innerHTML=p}let St=!1;async function Rl(){if(St||!d||!z)return;const o=Wt.trim();if(o.length<2)return;const e=Ot.find(y=>y.cls===le)||Ot[0],t=Je[Vt];if(!t)return;const n=Math.round(e.baseCost*t.costMod),i=Math.max(2,Math.round(e.baseBuild*t.buildMod)),a=Math.round(n*.5),r=n-a,s=z.current_tick||0,l=Number(d.corp_cash_reserves??0);if(l<a){alert("Insufficient cash for deposit. Need "+_(a)+".");return}if(!confirm("Commission "+le+" from "+t.name+`?
...
Shipyard: `+t.name+`
Deposit: `+_(a)+`
Delivery: Tick `+(s+i))}window.smSelectListing=Cl;window.smPurchase=Sl;window.smOpenCommission=zl;window.smCloseCommission=va;window.commSetClass=Nl;window.commSetNation=Al;window.commSetName=Ml;window.smPlaceOrder=Rl;window.flSelectVessel=yl;window.flRefurbish=gl;window.flRefuel=xl;window.flSell=bl;window.flRename=_l;window.openBidReview=cl;window.closeBidReview=Po;window.reviewSelectBid=pl;window.acceptBid=fl;window.declineAllBids=ml;window.switchToActions=qi;window.actSelectExec=vs;window.actExecute=es;window.confirmFireExec=Xr;window.actOpenStatement=Di;window.actCloseStatement=Fn;window.actSubmitStatement=ts;window.actDeclareBankruptcy=ji;window.actOpenRestructure=Gi;window.actCloseRestructure=Un;window.actSubmitRestructure=cs;window.actOpenRebrand=Vi;window.actCloseRebrand=Hn;window.actSubmitRebrand=ps;window.actOpenDonation=Wi;window.actCloseDonation=Gn;window.actSubmitDonation=us;window.donateSelectParty=ms;window.lrOpen=Ui;window.lrClose=Hi;window.lrSubmit=ds;window.lrSetAmount=is;window.lrSetPurpose=as;window.lrSetTerm=rs;window.lrSetCollateral=ss;window.openExecSearch=ys;window.closeExecSearch=Qi;window.esSelectCandidate=gs;window.esHireCandidate=xs;window.switchToExpansion=Ri;window.switchToOperations=Li;window.hfSetChange=bs;window.hfReset=_s;window.hfConfirm=hs;document.addEventListener("click",function(o){const e=o.target.closest(".corp-nav-tab[href]:not([data-tab-action])");if(!e)return;const t=e.getAttribute("href");if(!t)return;const n=new URL(t,window.location.href);n.pathname!==window.location.pathname||n.searchParams.get("tab")||e.classList.contains("active")||(o.preventDefault(),Li(o))});Gr();
