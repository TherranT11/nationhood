import{_supabase as yt}from"./supabase-client-qEAQbBjE.js";/* empty css                  */import{r as oa}from"./role-actions-fros7AI4.js";import{l as na,d as ze,i as sa}from"./common-DmwJUj0E.js";import{g as Dt,U as ra,a9 as la,W as da}from"./political-actions-CoM-LDWz.js";import{d as V,f as fe,h as lt,o as Ct,c as ve,s as ca,M as pa}from"./government-structure-C17uG6rl.js";import{GAME_CONFIG as dt,FORMATION_DEADLINE_TICKS as ae}from"./config-CHsHqv7d.js";import{f as ma}from"./no-confidence-DFJc0-tL.js";import{i as fa,e as va,g as ua,j as Re}from"./elections-B2VCaQoZ.js";import{a as Nt}from"./stats-4gK98flh.js";import{tickToDate as ga}from"./utils-A98FEun4.js";import"./preload-helper-BXl3LOEh.js";import"./corp-topbar-BVNorCyj.js";import"./bills-XlFS1_7K.js";import"./corp-valuation-CXafACL8.js";import"./presidential-CiiUc8k5.js";const ht=[{id:"economic_reform",name:"Economic Reform",icon:"📈",tagline:"Growth-first neoliberal agenda",desc:"Prioritize GDP, attract foreign capital, lower corporate taxes. The rising tide theory — grow the pie and worry about slicing it later.",improve:["gdp_growth","foreign_investment","currency_strength","credit","service_output","manufacturing_output"],worsen:["income_inequality","poverty_rate","union_strength","income_tax"],tradeoff:"Income inequality tends to rise. Working class sees GDP numbers go up while their wages don't."},{id:"social_justice",name:"Social Justice",icon:"⚖️",tagline:"Redistribution and equity",desc:"Raise minimum wage, expand welfare, progressive taxation. Close the gap between rich and poor through direct intervention.",improve:["minimum_wage","poverty_rate","income_inequality","social_mobility","healthcare_accessibility","education_accessibility"],worsen:["foreign_investment","gdp_growth","corporate_tax"],tradeoff:"Capital flight risk. Foreign investors avoid high-tax environments. Growth may slow."},{id:"national_security",name:"National Security",icon:"🛡️",tagline:"Borders, military, order",desc:"Strengthen defense, tighten borders, expand police powers. Safety through strength.",improve:["stability","crime_rate","terrorism","political_violence","illegal_immigration"],worsen:["freedom_index","press_freedom","civil_unrest","polarization"],tradeoff:"Freedom index drops. Minority communities disproportionately affected. International criticism."},{id:"anti_corruption",name:"Anti-Corruption",icon:"🔍",tagline:"Clean government, institutional reform",desc:"Independent judiciary, transparent budgets, prosecute the connected. Popular with voters but powerful people fight back hard.",improve:["corruption","judicial_independence","press_freedom","legitimacy","efficiency"],worsen:["stability"],tradeoff:"Short-term chaos as exposing corruption shakes institutions. Your own party's skeletons may surface."},{id:"green_transition",name:"Green Transition",icon:"🌱",tagline:"Climate and environment",desc:"Renewable energy investment, carbon taxes, emissions targets. Save the planet — but the bill comes due now, not later.",improve:["renewable_energy_pct","pollution","carbon_emissions","energy_generation"],worsen:["fuel_prices","manufacturing_output","gdp_growth","cost_of_living"],tradeoff:"Energy costs spike during transition. Rural and industrial voters feel abandoned."},{id:"industrialization",name:"Industrialization",icon:"🏭",tagline:"Factories, exports, production",desc:"Build manufacturing capacity, create blue-collar jobs, develop physical infrastructure. The backbone of a real economy.",improve:["manufacturing_output","labor_force_participation","unemployment","physical_infrastructure","gdp_growth"],worsen:["pollution","carbon_emissions","arable_land","healthcare_quality"],tradeoff:"Environment gets destroyed. Long-term health costs from industrial pollution."},{id:"digital_modernization",name:"Digital Modernization",icon:"💻",tagline:"Tech economy, connectivity",desc:"Fiber everywhere, tech sector incentives, digital government services. Leap into the future — but not everyone makes the jump.",improve:["digital_infrastructure","service_output","higher_education","academic_immigration","efficiency"],worsen:["manufacturing_output","labor_force_participation","income_inequality","urbanization"],tradeoff:"Automation displaces workers. Rural communities left behind. Tech wealth concentrates in cities."},{id:"welfare_state",name:"Welfare State",icon:"🏥",tagline:"Universal services, safety net",desc:"Free healthcare, free education, generous pensions, unemployment insurance. Cradle to grave — funded by steep taxes on everyone.",improve:["healthcare_quality","healthcare_accessibility","education_accessibility","poverty_rate","standard_of_living","happiness"],worsen:["income_tax","corporate_tax","gdp_growth","foreign_investment"],tradeoff:"Massive fiscal cost. Tax burden on middle class, not just the rich. Sustainability questioned."},{id:"populist_nationalism",name:"Populist Nationalism",icon:"🇲",tagline:"The people vs. elites and outsiders",desc:"Restrict immigration, protect domestic industry, reject globalism. Our people first. Our jobs first. Our culture first.",improve:["immigration","illegal_immigration","manufacturing_output","minimum_wage","union_strength"],worsen:["foreign_investment","academic_immigration","freedom_index","press_freedom","polarization","ethnic_diversity"],tradeoff:"International isolation. Brain drain as educated professionals emigrate. Deep social polarization."},{id:"free_market",name:"Free Market Liberalism",icon:"🏛️",tagline:"Deregulate everything",desc:"Cut taxes, cut red tape, let the market decide winners and losers. Government is the problem, not the solution.",improve:["gdp_growth","foreign_investment","credit","service_output","currency_strength"],worsen:["union_strength","minimum_wage","healthcare_accessibility","income_inequality","poverty_rate"],tradeoff:"Growth at the cost of the working class. Social safety net erodes. Boom-bust volatility."},{id:"law_and_order",name:"Law & Order",icon:"⚔️",tagline:"Tough on crime, strong institutions",desc:"More police, harsher sentences, zero tolerance. Restore order to the streets. Criminals fear the state.",improve:["crime_rate","stability","political_violence","terrorism","drug_use"],worsen:["incarceration_rate","freedom_index","civil_unrest"],tradeoff:"Prison population explodes. Minority communities targeted. Policing costs balloon."},{id:"education_first",name:"Education First",icon:"🎓",tagline:"Human capital as the long game",desc:"Fund schools, universities, research institutions, teacher salaries. The 20-year bet that the next generation will be smarter and richer.",improve:["literacy","higher_education","education_accessibility","academic_immigration","social_mobility","labor_force_participation"],worsen:["income_tax","gdp_growth"],tradeoff:"Voters don't see results before next election. Brain drain if jobs don't exist for graduates."},{id:"healthcare_reform",name:"Healthcare Reform",icon:"💊",tagline:"Fix the hospitals",desc:"More beds, more doctors, better drugs, universal coverage. Nobody dies because they can't afford treatment.",improve:["healthcare_quality","healthcare_accessibility","beds_per_100k","lifespan","drug_use"],worsen:["income_tax","gdp_growth","cost_of_living"],tradeoff:"Pharmaceutical lobby fights back. Extremely expensive. Takes multiple cycles to show results."},{id:"housing_cost",name:"Housing & Cost of Living",icon:"🏠",tagline:"The kitchen-table platform",desc:"Rent controls, public housing, affordable food, price caps on essentials. People can't eat GDP growth.",improve:["housing_affordability","cost_of_living","standard_of_living","physical_infrastructure","urbanization"],worsen:["foreign_investment","gdp_growth"],tradeoff:"Property owners and developers become your enemies. Market distortions create shortages."},{id:"energy_independence",name:"Energy Independence",icon:"⛽",tagline:"Control your own power supply",desc:"Exploit domestic oil, gas, and minerals. No more dependency on foreign energy. Cheap fuel, strong economy, sovereign power.",improve:["energy_generation","oil_and_gas","rare_minerals","fuel_prices","manufacturing_output","gdp_growth"],worsen:["pollution","carbon_emissions","renewable_energy_pct","arable_land"],tradeoff:"Climate commitments broken. Green voters abandon you. Environmental debt for future generations."},{id:"open_society",name:"Open Society",icon:"🕊️",tagline:"Liberal democracy, civil liberties",desc:"Free press, open borders, multicultural embrace, strong civil rights. A beacon of freedom — and a target for those who fear it.",improve:["freedom_index","press_freedom","immigration","academic_immigration","ethnic_diversity","happiness","judicial_independence"],worsen:["stability","illegal_immigration","polarization","terrorism"],tradeoff:"Nationalist backlash. Rural-urban divide deepens. Security vulnerabilities from openness."}],he={gdp_growth:"GDP Growth",inflation:"Inflation",interest_rates:"Interest Rates",currency_strength:"Currency Strength",foreign_investment:"Foreign Investment",credit:"Credit",income_tax:"Income Tax",corporate_tax:"Corporate Tax",sales_tax:"Sales Tax",unemployment:"Unemployment",labor_force_participation:"Labor Force Participation",minimum_wage:"Minimum Wage",union_strength:"Union Strength",poverty_rate:"Poverty Rate",income_inequality:"Income Inequality",healthcare_quality:"Healthcare Quality",healthcare_accessibility:"Healthcare Accessibility",beds_per_100k:"Beds per 100k",lifespan:"Lifespan",drug_use:"Drug Use",literacy:"Literacy",higher_education:"Higher Education",education_accessibility:"Education Accessibility",academic_immigration:"Academic Immigration",physical_infrastructure:"Physical Infrastructure",digital_infrastructure:"Digital Infrastructure",urbanization:"Urbanization",energy_generation:"Energy Generation",renewable_energy_pct:"Renewable Energy %",arable_land:"Arable Land",rare_minerals:"Rare Minerals",oil_and_gas:"Oil & Gas",fuel_prices:"Fuel Prices",pollution:"Pollution",carbon_emissions:"Carbon Emissions",standard_of_living:"Standard of Living",happiness:"Happiness",social_mobility:"Social Mobility",crime_rate:"Crime Rate",incarceration_rate:"Incarceration Rate",religiosity:"Religiosity",stability:"Stability",legitimacy:"Legitimacy",efficiency:"Efficiency",corruption:"Corruption",press_freedom:"Press Freedom",judicial_independence:"Judicial Independence",freedom_index:"Freedom Index",polarization:"Polarization",civil_unrest:"Civil Unrest",terrorism:"Terrorism",political_violence:"Political Violence",immigration:"Immigration",illegal_immigration:"Illegal Immigration",emigration:"Emigration",ethnic_diversity:"Ethnic Diversity",cost_of_living:"Cost of Living",housing_affordability:"Housing Affordability",manufacturing_output:"Manufacturing Output",service_output:"Service Output"},ue=new Set(["unrest","crime","corruption","cost_of_living","debt"]),ya=new Set(["income_tax","corporate_tax"]);function _e(e,t){const a=ue.has(e),i=ya.has(e);return t==="improve"?a?{arrow:"↓",color:"#5cc55c"}:i?{arrow:"↑",color:"#c84"}:{arrow:"↑",color:"#5cc55c"}:a?{arrow:"↑",color:"#c55"}:i?{arrow:"↓",color:"#5cc55c"}:{arrow:"↓",color:"#c55"}}function we(e){switch(e){case 0:return{momentum:12,penalty:0,label:"+12",color:"#5cc55c",note:"Unclaimed — full momentum"};case 1:return{momentum:6,penalty:6,label:"+6",color:"#ca5",note:"Contested by 1 rival — reduced momentum"};case 2:return{momentum:4,penalty:4,label:"+4",color:"#c84",note:"Crowded (2 rivals) — minimal momentum"};default:return{momentum:2,penalty:2,label:"+2",color:"#c84",note:`Crowded (${e} rivals) — minimal momentum`}}}function ba(e,t){return e.map(a=>{const i=ht.find(n=>n.id===a.platform_key);if(!i)return{...a,stats:[]};const r=i.improve.map(n=>{const o=a.baseline_stats?.[n],p=a.target_stats?.[n],d=Number(t?.[n]??50),s=ue.has(n);if(o==null||p==null)return{stat:n,baseline:d,target:d,current:d,progress:0,met:!1};const m=Math.abs(p-o),l=s?Math.max(0,o-d):Math.max(0,d-o),c=m>0?Math.min(1,l/m):1,f=s?d<=p:d>=p;return{stat:n,baseline:o,target:p,current:d,progress:c,met:f}});return{...a,stats:r,platformDef:i}})}const xa=["Former union organizer. Knows how to mobilize a crowd.","Disbarred attorney. Understands the legal system from the inside.","Investigative journalist. Uncovered three government scandals before going private.","Ex-military intelligence. Trained in information warfare.","Community activist. Built grassroots networks across two provinces.","Former government auditor. Knows where the money hides.","Political science professor. Publishes on institutional corruption.","NGO director. Ran anti-corruption campaigns across the continent.","Former prosecutor. Left the justice ministry over political interference.","Labor rights campaigner. Organized the dockworkers' strike of 2014.","Freelance political consultant. Has worked for opposition parties in three nations.","Student movement leader. Led the university protests. Young and fearless.","Retired diplomat. Leverages international connections for domestic pressure.","Whistleblower advocate. Runs a secure tip line used by civil servants.","Former police detective. Turned against the system after a cover-up."];function ut(e){return e>=75?{label:"Exceptional",color:"#5cc55c",desc:"Elite operative. Lawsuits are devastating, intelligence is razor-sharp."}:e>=60?{label:"Strong",color:"#a3b07e",desc:"Experienced and reliable. Can handle most opposition tasks effectively."}:e>=45?{label:"Competent",color:"#ca5",desc:"Gets the job done. Occasional missteps under pressure."}:e>=30?{label:"Developing",color:"#c84",desc:"Green but eager. Results are inconsistent. Cheap to hire."}:{label:"Weak",color:"#c55",desc:"Liability risk. May botch sensitive operations. Rock-bottom price for a reason."}}function ha(e){var t=Math.max(0,e-20)/65,a=12e4+t*28e4;return Math.round(a/25e3)*25e3}function Ht(e,t){return e+Math.floor(Math.random()*(t-e+1))}function $e(e){return e[Math.floor(Math.random()*e.length)]}function _a(e,t){var a=[],i=new Set,r=Ht(5,7),n=Dt(t),o=n.firstNames||[],p=n.lastNames||[];if(o.length===0||p.length===0)return[];for(var d=xa.slice().sort(function(){return Math.random()-.5}),s=0;s<r;s++){var m,l,c,f=0;do m=$e(o),l=$e(p),c=m+" "+l,f++;while(i.has(c)&&f<20);i.add(c);var g=Ht(20,85),v=Ht(25,60),h=d[s%d.length],x=ha(g);a.push({nation_id:e,first_name:m,last_name:l,age:v,skill:g,background:h,hire_cost:x,status:"available"})}return a.sort(function(b,y){return y.skill-b.skill}),a}async function Fe(e,t,a){var{data:i}=await e.from("nations").select("government_type").eq("id",t).maybeSingle();if(V(i)){var{data:r}=await e.from("factions").select("seats").eq("id",a).maybeSingle();return ie({partyId:a,partySeats:r?.seats,admin:null,ministryHolder:!1,nation:i})}var[n,o,p,d]=await Promise.all([fe(e,t).catch(function(b){return console.warn("[Agitator] fetchActiveCoalition failed:",b?.message||b),null}),e.from("administrations").select("id, coalition_parties, stats_at_start, started_at_tick").eq("nation_id",t).is("ended_at_tick",null).order("started_at_tick",{ascending:!1}).limit(1).maybeSingle(),e.from("head_of_government").select("faction_id").eq("nation_id",t).eq("active",!0).maybeSingle(),e.from("presidents").select("faction_id").eq("nation_id",t).eq("is_active",!0).maybeSingle()]);if(o.error)return console.error("[Agitator] Failed to check governing status:",o.error.message),{isGoverning:!1,isOpposition:!0,label:"OPPOSITION",administration:null};var s=o.data,m=n,l=lt(i),c=p?.data?.faction_id||null,f=d?.data?.faction_id||null,g=Array.isArray(m?.party_ids)?m.party_ids.map(function(b){return{party_id:b}}):[];if(s){s.pm_party_id=c,s.president_party_id=f;var v=Array.isArray(s.coalition_parties)?s.coalition_parties:[];v.length===0&&g.length>0&&(s.coalition_parties=g)}else(m||c||f)&&(s={pm_party_id:c,president_party_id:f,coalition_parties:g});var h=!1;if(l){var{count:x}=await e.from("ministries").select("*",{count:"exact",head:!0}).eq("nation_id",t).eq("party_id",a).eq("is_active",!0);h=(x||0)>0}return ie({partyId:a,partySeats:null,admin:s,ministryHolder:h,nation:i})}function wa(e,t,a,i){return ie({partyId:e?.id,partySeats:e?.seats,admin:t,ministryHolder:a?a.has(e?.id):!1,nation:i})}function ie({partyId:e,partySeats:t,admin:a,ministryHolder:i,nation:r}){if(V(r)){var n=Number(t||0)>=1;return{isGoverning:n,isOpposition:!n,label:n?"LOYAL":"DISSIDENT",administration:null}}if(!a)return{isGoverning:!1,isOpposition:!0,label:"OPPOSITION",administration:null};var o=Array.isArray(a.coalition_parties)?a.coalition_parties:[],p=o.some(function(l){return l?typeof l=="string"?l===e:typeof l=="object"?(l.party_id||l.id)===e:!1:!1}),d=a.pm_party_id===e,s=a.president_party_id===e,m=d||p||s||lt(r)&&!!i;return{isGoverning:m,isOpposition:!m,label:m?"GOVERNING":"OPPOSITION",administration:a}}async function Oe(e,t){var{data:a,error:i}=await e.from("faction_agitators").select("*").eq("faction_id",t).eq("status","active").maybeSingle();return i?(console.error("[Agitator] Failed to fetch agitator:",i.message),null):a}async function $a(e,t,a){var{data:i,error:r}=await e.from("agitator_pool").select("*").eq("nation_id",t).eq("status","available").order("skill",{ascending:!1});if(r)return console.error("[Agitator] Failed to fetch pool:",r.message),[];if(i&&i.length>0)return i;var n=_a(t,a),{data:o,error:p}=await e.from("agitator_pool").insert(n).select("*");return p?(console.error("[Agitator] Failed to insert pool:",p.message),[]):(o||[]).sort(function(d,s){return s.skill-d.skill})}async function ka(e,t,a,i){var r=await Oe(e,t);if(r)return{success:!1,agitator:null,error:"You already have an active agitator."};var{data:n,error:o}=await e.from("faction_agitators").insert({faction_id:t,first_name:a.first_name,last_name:a.last_name,age:a.age,skill:a.skill,background:a.background,status:"active",hired_at_tick:i}).select("*").single();if(o)return console.error("[Agitator] Failed to hire:",o.message),{success:!1,agitator:null,error:o.message};var{error:p}=await e.from("agitator_pool").update({status:"hired",hired_by_faction_id:t}).eq("id",a.id);return p&&console.error("[Agitator] Failed to mark pool candidate as hired:",p.message),{success:!0,agitator:n,error:null}}const zt=[{key:"finance",label:"Finance",icon:"💰"},{key:"defense",label:"Defense",icon:"🛡️"},{key:"education",label:"Education",icon:"🎓"},{key:"healthcare",label:"Health",icon:"🏥"},{key:"interior",label:"Interior",icon:"🏛️"},{key:"foreign",label:"Foreign",icon:"🌐"},{key:"justice",label:"Justice",icon:"⚖️"},{key:"labor",label:"Labor",icon:"🔨"},{key:"trade",label:"Trade",icon:"📦"},{key:"energy",label:"Energy",icon:"⚡"},{key:"transportation",label:"Transport",icon:"🚂"},{key:"agriculture",label:"Agriculture",icon:"🌾"}],Be=[{key:"misuse_of_funds",label:"Misuse of Public Funds",desc:"Alleging budget went somewhere it shouldn't."},{key:"civil_rights",label:"Violation of Civil Rights",desc:"Alleging government overreach or suppression."},{key:"negligence",label:"Breach of Duty / Negligence",desc:"Alleging a ministry failed its mandate."},{key:"corruption",label:"Corruption / Self-Dealing",desc:"Alleging officials enriched themselves."}];function ge(e){return e<=5?{tier:1,label:"Clean Government",color:"#c55"}:e<=10?{tier:2,label:"Minor Corruption",color:"#ca5"}:e<=20?{tier:3,label:"Significant Corruption",color:"#c84"}:{tier:4,label:"Systemic Corruption",color:"#5cc55c"}}const st={1:{resolution:"FRIVOLOUS SUIT",filer:{momentum:-5},gov:{momentum:3}},2:{resolution:"PARTIAL WIN",filer:{momentum:3},gov:{momentum:-2}},3:{resolution:"MAJOR WIN",filer:{momentum:7},gov:{momentum:-5}},4:{resolution:"DEVASTATING WIN",filer:{momentum:12},gov:{momentum:-10}}},ke={1:{filing:"{party} files lawsuit against {ministry} alleging {basis}.",discovery:"Lawsuit discovery phase produces routine documents. No irregularities found in {ministry}.",evidence:"Legal team reviews {ministry} records. Auditors confirm standard procedures.",pre_trial:"Judge signals skepticism toward {party}'s claims. Case appears thin.",resolution:"{ministry} lawsuit dismissed. Courts find no evidence of wrongdoing. {party} criticized for wasting court resources."},2:{filing:"{party} files lawsuit against {ministry} alleging {basis}.",discovery:"{party}'s lawsuit uncovers irregular procurement contracts in {ministry}.",evidence:"Documents reveal {ministry} awarded no-bid contracts to connected firms.",pre_trial:"Judge allows case to proceed. {ministry} officials ordered to testify.",resolution:"{ministry} lawsuit concludes with partial ruling. Irregular contracts confirmed but no criminal charges filed."},3:{filing:"{party} files lawsuit against {ministry} alleging {basis}.",discovery:"{party}'s lawsuit exposes hidden accounts linked to {ministry} officials.",evidence:"Leaked documents show systematic overbilling in {ministry}. Millions unaccounted for.",pre_trial:"Multiple {ministry} officials refuse to testify. Judge threatens contempt.",resolution:"{ministry} scandal confirmed. Court finds evidence of systematic corruption. {party} vindicated."},4:{filing:"{party} files lawsuit against {ministry} alleging {basis}.",discovery:"{party}'s lawsuit reveals {ministry} ran parallel budget invisible to parliament.",evidence:"Court-ordered audit exposes network of shell companies receiving {ministry} funds.",pre_trial:"Prosecutors request criminal referral. Multiple {ministry} officials implicated.",resolution:"Devastating verdict: {ministry} operated criminal enterprise. Officials face prosecution. Government in crisis."}};function $t(e,t){var a=e;for(var i in t)a=a.split("{"+i+"}").join(t[i]);return a}async function Ea(e,t){var{factionId:a,nationId:i,agitatorId:r,targetMinistry:n,basis:o,currentTick:p,partyName:d,administration:s}=t,m,l,c;if(o==="civil_rights"){var f=Number(s?.stats_at_start?.freedom_index??50);l=50,m=f,c=Math.max(0,m-l)}else{var g=Number(s?.stats_at_start?.corruption??50);l=50,m=g,c=Math.max(0,l-m)}var g=m,v=l,h=ge(c),x=st[h.tier],b=p+8,y=zt.find(function(M){return M.key===n}),$=y?"Ministry of "+y.label:n,P=Be.find(function(M){return M.key===o}),S=P?P.label:o,{data:I,error:C}=await e.from("lawsuits").insert({faction_id:a,nation_id:i,agitator_id:r,target_ministry:n,basis:o,filed_at_tick:p,resolves_at_tick:b,corruption_at_start:g,corruption_at_filing:v,corruption_growth:c,tier:h.tier,status:"active",resolution:null,momentum_effect:x.filer.momentum,gov_momentum_effect:x.gov.momentum}).select("*").single();if(C)return{success:!1,lawsuit:null,tier:0,error:C.message};var k=ke[h.tier]||ke[1],A={party:d||"Opposition",ministry:$,basis:S},T=[{event_tick:p,event_type:"filing",headline:$t(k.filing,A)},{event_tick:p+2,event_type:"discovery",headline:$t(k.discovery,A)},{event_tick:p+5,event_type:"evidence",headline:$t(k.evidence,A)},{event_tick:p+7,event_type:"pre_trial",headline:$t(k.pre_trial,A)},{event_tick:b,event_type:"resolution",headline:$t(k.resolution,A)}],j=T.map(function(M){return{lawsuit_id:I.id,nation_id:i,event_tick:M.event_tick,event_type:M.event_type,headline:M.headline,is_fired:M.event_tick===p}}),{error:L}=await e.from("lawsuit_events").insert(j);L&&console.error("[Lawsuits] Failed to insert milestone events:",L.message);var{error:E}=await e.from("event_log").insert({nation_id:i,event_name:"LAWSUIT FILED",event_type:"lawsuit",category:"political",description_chosen:T[0].headline,fired_at_tick:p,faction_id:a||null,effects_applied:{lawsuit_id:I.id,tier:h.tier,target_ministry:$,basis:S,milestone:"filing"}});return E&&console.warn("[Lawsuits] event_log insert (filing) failed:",E.message),{success:!0,lawsuit:I,tier:h.tier,error:null}}async function Ca(e,t){var{data:a,error:i}=await e.from("lawsuits").select("*").eq("faction_id",t).order("filed_at_tick",{ascending:!1}).limit(10);return i?(console.error("[Lawsuits] Failed to fetch lawsuits:",i.message),[]):a||[]}let w=null,u=null,Q="leader",at=[],Rt=[],G=null,B=null,mt=!1,R=null,oe=[],xt=!1,D=null,it=!1,Et=[],St=!1,Ut=!1,At=new Set;function _(e){if(!e)return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML}function Z(e,t){return((e||"?")[0]+(t||"?")[0]).toUpperCase()}const De=[{id:"leader",title:"LEADER",fullTitle:"Party Leader",color:"#c8a832"},{id:"deputy",title:"DEPUTY",fullTitle:"Deputy Party Leader",color:"#8b9a6b"},{id:"chief",title:"CHIEF OF STAFF",fullTitle:"Chief of Staff",color:"#5cc55c"},{id:"campaign",title:"CAMPAIGN MGR",fullTitle:"Campaign Manager",color:"#c84"},{id:"comms",title:"COMMS DIR",fullTitle:"Communications Director",color:"#5a8aaa"},{id:"agitator",title:"AGITATOR",fullTitle:"Opposition Coordinator",color:"#d44a4a",oppositionOnly:!0}],Yt=[{perSeat:5e3,momDivisor:10},{perSeat:4e3,momDivisor:8},{perSeat:3e3,momDivisor:6},{perSeat:2e3,momDivisor:5},{perSeat:1e3,momDivisor:5}];let ft=0,Ft=0,ne=!1;async function Ia(){if(!w||!u?.faction?.id||!u?.shard?.current_tick)return;const{count:e,error:t}=await w.from("campaign_actions").select("id",{count:"exact",head:!0}).eq("party_id",u.faction.id).eq("action_type","fundraise").eq("tick_performed",u.shard.current_tick);ft=!t&&e!=null?e:0}async function Ma(){if(Ft=0,ne=!1,!w||!u?.nation?.id||!u?.shard?.current_tick)return;const e=u.shard.current_tick,t=R?.pm_party_id;try{const{data:a}=await w.from("bills").select("id").eq("nation_id",u.nation.id).eq("bill_type","no_confidence").in("status",["committee","floor"]).limit(1);if(ne=!!(a&&a.length),t){const{data:i}=await w.from("campaign_actions").select("tick_performed").eq("nation_id",u.nation.id).eq("action_type","no_confidence_filed").eq("target_id",t).order("tick_performed",{ascending:!1}).limit(1).maybeSingle();if(i){const r=e-Number(i.tick_performed||0),n=typeof dt<"u"&&dt.NO_CONFIDENCE_COOLDOWN_TICKS||12;Ft=Math.max(0,n-r)}}}catch(a){console.warn("[PartyActions] loadNoConfidenceState failed:",a?.message||a)}}function je(e,t){const a=Yt[Math.min(t,Yt.length-1)],i=e*a.perSeat,r=Math.max(1,Math.floor(e/a.momDivisor));return{raised:i,momCost:r,perSeat:a.perSeat,tierIdx:Math.min(t,Yt.length-1)}}const Ge=[{id:"fundraise",name:"Fundraise",desc:"Raise party funds proportional to your seat count. Each use yields less money and costs more momentum. Momentum cannot drop below 1.",cost:"MOMENTUM",costColor:"#c84",moneyCost:0,tags:["FINANCIAL","CAMPAIGN"],locked:!1},{id:"statement",name:"Issue Statement",desc:"Public declaration on an issue. Shifts party positioning and voter bloc reactions. Media covers it. Other parties may respond.",cost:"$20k",costColor:"#c8a832",moneyCost:2e4,tags:["PUBLIC","NARRATIVE"],locked:!1},{id:"platform",name:"Set Party Platform",desc:"Choose a political focus. Defines which stats you promise to change. Awards momentum based on how many rivals share the same platform.",cost:"$120k",costColor:"#c8a832",moneyCost:12e4,tags:["STRATEGIC"],locked:!1},{id:"call_early_elections",name:"Call Early Elections",desc:"Dissolve the legislature and call snap elections. PM-only. Government enters caretaker status; election fires after a short formation window. Momentum impact is tiered by Gov. Approval: >50 boosts PM party (+3), <35 boosts opposition (+5 each) and +3 stability, 35–50 is neutral.",cost:"$0",costColor:"var(--text-dim)",moneyCost:0,tags:["LEGISLATIVE","PM ONLY"],locked:!1},{id:"resign_as_pm",name:"Resign as Prime Minister",desc:"Step down from the Prime Minister seat. PM-only. Coalition enters caretaker status and has a 3-tick window to nominate a successor via the cabinet panel. If a new PM is installed the administration continues under new leadership; otherwise a snap election fires. Cost: −3 Momentum, −0.05 Credibility, −3 Stability, 12-tick bar from PM on your party.",cost:"$0",costColor:"var(--text-dim)",moneyCost:0,tags:["GOVERNMENT","PM ONLY"],locked:!1},{id:"no_confidence",name:"Vote of No Confidence",desc:"File a motion of no confidence against the Prime Minister. If a simple majority votes YES, the government falls and snap elections are triggered. PASS: +15 Momentum to you, -10 Momentum to the PM’s party. FAIL: -10 Momentum to you. 12-tick cooldown on the targeted PM party.",cost:"$0",costColor:"var(--text-dim)",moneyCost:0,tags:["LEGISLATIVE","OPPOSITION"],locked:!1},{id:"leave_coalition",name:"Leave Coalition",desc:"Walk out of the current governing coalition. Any ministries your party holds are vacated. You drop from governing to opposition. Coalition flips to minority if your exit drops it below the majority threshold. Cost: −3 Momentum to you, −5 Momentum to the PM’s party. 12-tick cooldown. PM’s party cannot use this — resign first.",cost:"−3 MOM",costColor:"#c84",moneyCost:0,tags:["GOVERNMENT","RISKY"],locked:!1},{id:"disband_party",name:"Disband Party",desc:"Voluntarily dissolve your party. Your seats are vacated and sit empty until the next election (no backfill or redistribution). All party funds and momentum are lost. You are removed from every nation chat. Cannot be undone. 24-tick cooldown per user. Cannot be used while Prime Minister, sitting President, or reigning Monarch — step down first.",cost:"IRREVERSIBLE",costColor:"#c55",moneyCost:0,tags:["IRREVERSIBLE"],locked:!1}],Sa=[{id:"fundraise",name:"Fundraise",desc:"Raise royal treasury funds proportional to your seat count. Each use yields less money and costs more momentum.",cost:"MOMENTUM",costColor:"#c84",moneyCost:0,tags:["FINANCIAL","CAMPAIGN"],locked:!1},{id:"grant_seats",name:"Grant Seats",desc:"Grant parliamentary seats to a noble house. Sharing power increases legitimacy (+0.5 per seat). Hoarding >70% of seats causes tyranny decay.",cost:"FREE",costColor:"#5cc55c",moneyCost:0,tags:["ROYAL","STRUCTURAL"],locked:!1},{id:"revoke_seats",name:"Revoke Seats",desc:"Revoke seats from a noble house. Costs $100k and -1 Legitimacy per seat revoked. Use sparingly — the people do not forget.",cost:"$100k/seat",costColor:"#d44a4a",moneyCost:1e5,tags:["ROYAL","OFFENSIVE"],locked:!1},{id:"statement",name:"Royal Decree",desc:"Issue a public declaration on an issue. Shifts positioning and voter bloc reactions. Media covers it.",cost:"$20k",costColor:"#c8a832",moneyCost:2e4,tags:["PUBLIC","NARRATIVE"],locked:!1},{id:"appoint_pm",name:"Appoint Prime Minister",desc:"Choose a party to lead the government as Prime Minister. The PM can then assign cabinet ministries. You may appoint your own party.",cost:"FREE",costColor:"#5cc55c",moneyCost:0,tags:["ROYAL","STRUCTURAL"],locked:!1}],jt={PUBLIC:"#8b9a6b",NARRATIVE:"#5a8aaa",STRATEGIC:"#c8a832",INTERNAL:"#c84",COALITION:"#5aaa8a",RISKY:"#c55",PARLIAMENTARY:"#8b9a6b",FINANCIAL:"#5a8aaa",INTELLIGENCE:"#5a8aaa",DEFENSIVE:"#5cc55c",CAMPAIGN:"#c84",VOTER:"#c8a832",OFFENSIVE:"#c84",REACTIVE:"#ca5",STRUCTURAL:"#9e9a92",ROYAL:"#c8a832",LEGAL:"#5a8aaa"},Ee=[{id:"economy",label:"Economy & Jobs",icon:"💰"},{id:"healthcare",label:"Healthcare",icon:"🏥"},{id:"education",label:"Education",icon:"🎓"},{id:"security",label:"National Security",icon:"🛡️"},{id:"environment",label:"Environment",icon:"🌱"},{id:"corruption",label:"Anti-Corruption",icon:"🔍"},{id:"infrastructure",label:"Infrastructure",icon:"🏗️"},{id:"immigration",label:"Immigration",icon:"🌐"},{id:"housing",label:"Housing & Cost of Living",icon:"🏠"},{id:"crime",label:"Crime & Justice",icon:"⚖️"},{id:"labor",label:"Labor & Workers",icon:"🔨"},{id:"foreign_policy",label:"Foreign Policy",icon:"🕊️"}],Ce=["{party_name} Calls for Action on {topic}","{leader_name}: '{topic}' Must Be National Priority","{leader_name} Pledges Bold Agenda on {topic}","{party_name} Leader Addresses Nation on {topic}"];async function qe(e,t){w=e,u=t;const a=document.getElementById("pa-actions-root");if(!a)return;const i=t.faction;if(!i){a.innerHTML='<div style="display:flex;align-items:center;justify-content:center;min-height:300px;color:var(--text-dim);">No faction data.</div>';return}try{const{data:l}=await w.from("factions").select("momentum, party_funds, seats, action_points, bloc_id").eq("id",i.id).single();l&&(i.momentum=l.momentum??i.momentum,i.party_funds=l.party_funds??i.party_funds,i.seats=l.seats??i.seats,i.action_points=l.action_points??i.action_points,i.bloc_id=l.bloc_id??null)}catch(l){console.warn("[PartyActions] faction refresh failed, using cached state:",l)}const[r,n,o,p,d,s]=await Promise.all([w.from("faction_platforms").select("*").eq("faction_id",i.id).order("slot"),w.from("faction_platforms").select("*").eq("nation_id",t.nation?.id),Oe(w,i.id),Fe(w,t.nation?.id,i.id),w.from("faction_electoral_standing").select("visibility, raw_appeal").eq("faction_id",i.id).eq("nation_id",t.nation?.id).maybeSingle(),fe(w,t.nation?.id)]);t.nation&&(t.nation.__coalition_status=s?.status||null),r.error&&console.error("[PartyActions] Failed to load faction platforms:",r.error.message),n.error&&console.error("[PartyActions] Failed to load nation platforms:",n.error.message),at=r.data||[],Rt=n.data||[],G=o,mt=p.isOpposition,R=p.administration,d.data,await Ia(),await Ma();const{data:m}=await w.from("faction_deputies").select("*").eq("faction_id",i.id).eq("status","active").maybeSingle();B=m||null,G&&(oe=await Ca(w,i.id)),await It(i.id,t.nation?.id),H(a)}function He(e){return e?{isPM:!!R&&R.pm_party_id===e.id,isPresident:u?.nation?.hos_election_method==="elected"&&R?.president_party_id===e.id,isMonarchActing:V(u?.nation)&&u?.nation?.monarch_faction_id===e.id}:{isPM:!1,isPresident:!1,isMonarchActing:!1}}async function It(e,t){if(!e||!t){D=null,it=!1,Et=[];return}try{const{data:a,error:i}=await w.from("bloc_invitations").select("id, bloc_id, invited_by_faction_id, created_at_tick, status, bloc:bloc_id(id,name,leader_faction_id), inviter:invited_by_faction_id(id,faction_name,party_color)").eq("invited_faction_id",e).eq("status","pending").order("created_at_tick",{ascending:!1});if(i)throw i;Et=a||[];const r=u?.faction?.bloc_id||null;if(r){const{data:n,error:o}=await w.from("blocs").select("*").eq("id",r).is("dissolved_at_tick",null).maybeSingle();if(o)throw o;if(n){const{data:p}=await w.from("factions").select("id, faction_name, seats, party_color, leader_first_name, leader_last_name").eq("bloc_id",n.id).order("seats",{ascending:!1});D={...n,members:p||[]},it=n.leader_faction_id===e}else D=null,it=!1}else D=null,it=!1}catch(a){console.warn("[PartyActions] loadBlocState failed:",a?.message||a)}}function Ue(e){if(!D)return"";const t=it?`<span style="margin-left:6px;font-family:var(--font-mono);font-size:7px;color:${e};letter-spacing:0.08em;">LEADER</span>`:"";return`<span class="pa-bloc-tag" style="display:inline-flex;align-items:center;padding:2px 8px;background:${e}18;border:1px solid ${e}55;color:${e};font-family:var(--font-mono);font-size:9px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;">
        ...
        </div>`}).join("")}</div>`}async function ye(e){const{data:t}=await w.from("factions").select("bloc_id, momentum").eq("id",e).single();t&&(u.faction.bloc_id=t.bloc_id||null,t.momentum!=null&&(u.faction.momentum=t.momentum))}async function La(e,t,a){try{const i=u?.faction?.id;if(!i)throw new Error("No active faction");const r=t==="accept"?"accept_bloc_invite":"decline_bloc_invite",n=t==="accept"?"p_accepting_faction_id":"p_declining_faction_id",{data:o,error:p}=await w.rpc(r,{p_invitation_id:e,[n]:i});if(p)throw p;if(o&&o.success===!1)throw new Error(o.error||"Unknown error");await ye(i),await It(i,u.nation?.id),H(a)}catch(i){console.error("[PartyActions] respondToBlocInvite failed:",i),alert(t==="accept"?`Could not accept invitation: ${i.message||i}`:`Could not decline invitation: ${i.message||i}`)}}async function Pa(e){if(!D||Ut)return;const t=D,a=it?`Leaving ${t.name} will DISSOLVE the entire bloc. All ${t.members?.length||0} members will be removed and pending invitations rescinded.

Proceed?`:`Leave the ${t.name} bloc?`;if(confirm(a)){Ut=!0;try{const{data:i,error:r}=await w.rpc("leave_bloc",{p_faction_id:u.faction.id});if(r)throw r;if(i&&i.success===!1)throw new Error(i.error||"Unknown error");await ye(u.faction.id),await It(u.faction.id,u.nation?.id),H(e)}catch(i){console.error("[PartyActions] leave_bloc failed:",i),alert(`Could not leave bloc: ${i.message||i}`)}finally{Ut=!1}}}async function Aa(e){const t=document.getElementById("pa-bloc-modal");if(!t||D)return;const a=u.faction,i=a?.color||"#c8a832";t.innerHTML=`
    ...
    `,t.classList.add("active");const r=new Set;let n=[];const o=()=>t.classList.remove("active");document.getElementById("pa-bloc-close")?.addEventListener("click",o),document.getElementById("pa-bloc-cancel")?.addEventListener("click",o),t.addEventListener("click",l=>{l.target===t&&o()});try{const l=u.nation?.id,{data:c}=await w.from("factions").select("id, faction_name, seats, party_color, leader_first_name, leader_last_name, leader_age, bloc_id").eq("nation_id",l).eq("faction_type","party").is("abandoned_at",null),f=(c||[]).filter(v=>v.id!==a.id);n=f;const g=document.getElementById("pa-bloc-party-list");if(!g)return;if(f.length===0){g.innerHTML='<div style="padding:10px;font-family:var(--font-mono);font-size:9px;color:var(--text-dim);">No other parties in this nation.</div>';return}g.innerHTML=f.map(v=>{const h=v.party_color||"#7a7a7a",x=v.leader_first_name&&v.leader_last_name?`${v.leader_first_name} ${v.leader_last_name}`:"Party Leader",b=v.bloc_id?"Already in a bloc":null;return`<label class="pa-bloc-party-row" data-party-id="${_(v.id)}" data-ineligible="${b?"1":"0"}"
        ...
        `}),document.getElementById("pa-leaders").innerHTML=Na(o,n,t),document.getElementById("pa-actions-panel").innerHTML=za(o,n,t),document.getElementById("pa-leaders")?.addEventListener("click",x=>{const b=x.target.closest(".pa-leader-card");if(!b||b.classList.contains("vacant"))return;const y=b.dataset.role;y&&y!==Q&&(Q=y,H(e))}),document.getElementById("pa-actions-panel")?.addEventListener("click",x=>{const b=x.target.closest(".pa-action-item");if(!b||b.classList.contains("locked"))return;const y=b.dataset.actionId;y==="fundraise"?ii(e):y==="grant_seats"?Ja(e):y==="revoke_seats"?Xa(e):y==="rally"?Da(e):y==="statement"?oi(e):y==="platform"?ni(e):y==="file_lawsuit"?Ka(e):y==="appoint_pm"?Wa(e):y==="modernize"?Ga(e):y==="rebrand"?qa(e):y==="no_confidence"?ai():y==="call_early_elections"?Qa():y==="resign_as_pm"?ti():y==="leave_coalition"?Za():y==="disband_party"?ei():y==="create_bloc"?Aa(e):y==="leave_bloc"?Pa(e):y==="invite_to_bloc"&&Ta(e)}),document.getElementById("pa-actions-panel")?.addEventListener("click",async x=>{const b=x.target.closest(".pa-bloc-invite-btn");if(!b)return;const y=b.dataset.inviteId,$=b.dataset.decision;if(!(!y||!$)&&!At.has(y)){At.add(y);try{await La(y,$,e)}finally{At.delete(y)}}}),document.getElementById("pa-hire-agitator-btn")?.addEventListener("click",()=>Le(e)),document.getElementById("pa-hire-agitator-panel")?.addEventListener("click",x=>{x.target.closest("#pa-hire-agitator-btn")||Le(e)}),document.getElementById("pa-hire-deputy-btn")?.addEventListener("click",()=>Me(e)),document.getElementById("pa-hire-deputy-panel")?.addEventListener("click",x=>{x.target.closest("#pa-hire-deputy-btn")||Me(e)})}function Na(e,t,a){const i=V(u.nation)&&u.nation?.monarch_faction_id===a?.id;return De.map(r=>{const n=r.id==="leader",o=r.id==="agitator",p=Q===r.id;let d,s,m,l,c;if(n){d=!1,s=e,m=Z(a.leader_first_name,a.leader_last_name),l=Ge.length;const v=V(u.nation);if(v&&u.nation?.monarch_faction_id===a.id)c={text:(u.nation?.monarch_title||"KING").toUpperCase(),color:"#c8a832"};else if(v)c={text:"NOBLE HOUSE",color:"#8b9a6b"};else{const x=R?.pm_party_id===a.id,b=u.nation?.hos_election_method==="elected"&&R?.president_party_id===a.id;x?c={text:"PRIME MINISTER",color:"#5cc55c"}:b?c={text:"PRESIDENT",color:"#5cc55c"}:mt?c={text:"OPPOSITION",color:"#c84"}:c={text:"GOVERNING",color:"#8b9a6b"}}}else o&&G?(d=!1,s=`${G.first_name} ${G.last_name}`,m=Z(G.first_name,G.last_name),l=1):o&&!G?(d=!1,s="Not Hired",m="+",l=0):r.id==="deputy"&&B?(d=!1,s=`${B.first_name} ${B.last_name}`,m=Z(B.first_name,B.last_name),l=1):r.id==="deputy"&&!B?(d=!1,s="Not Hired",m="+",l=0):r.id==="campaign"?(d=!1,s="Campaign Mgr",m="CM",l=Ke.length):(d=!0,s="Vacant",m="—",l=0);const f=r.oppositionOnly&&!mt;return`
    ...
    `}function za(e,t,a){const i=V(u.nation),r=i&&u.nation?.monarch_faction_id===a?.id,n=De.find(y=>y.id===Q);if(!n)return"";const o=Q==="leader",p=Q==="agitator",d=Q==="campaign",s=Q==="deputy";if(!o&&!p&&!d&&!s)return`
        ...
        `;if(p&&G)return Ya(n);if(s&&!B)return`
        ...
        `;if(s&&B)return Oa(n);if(d)return ja(n,a);const l=Z(a.leader_first_name,a.leader_last_name),c=a.leader_age?`, Age ${a.leader_age}`:"",f=a.seats||0,g=a.momentum??0,b=(V(u.nation)&&u.nation?.monarch_faction_id===a.id?Sa:Ge).map(y=>{const $=y.tags.map(k=>`<span class="pa-action-tag" style="color:${jt[k]||"var(--text-dim)"};">${k}</span>`).join("");let P="",S=y.cost,I=y.costColor,C=y.locked;if(y.id==="no_confidence"){const k=V(u.nation),A=!!R&&R.pm_party_id===a.id;if(k)C=!0,y.lockReason="Parliament cannot remove the Monarch’s Prime Minister. Only the Monarch can dismiss the PM.";else if(A)C=!0,y.lockReason="Your party is the Prime Minister — file from another party.";else if(ne)C=!0,y.lockReason="A motion of no confidence is already pending in Parliament.";else if(Ft>0){C=!0;const T=Ft;y.lockReason=`Cooldown: ${T} tick${T!==1?"s":""} remaining before another motion can be filed against this PM party.`}else!R||!R.pm_party_id?(C=!0,y.lockReason="No active Prime Minister to file against."):y.lockReason=""}else if(y.id==="call_early_elections"||y.id==="resign_as_pm"){const k=u.nation,A=Ct(k),T=V(k),j=!!R&&R.pm_party_id===a.id;T?(C=!0,y.lockReason=y.id==="call_early_elections"?"Elections are not held under absolute monarchy. The Monarch appoints the Prime Minister.":"Prime Ministers serve at the Monarch’s pleasure. The Monarch must replace the PM via the Appoint Prime Minister royal action."):A?j?u.nation&&u.nation.__coalition_status==="caretaker"?(C=!0,y.lockReason="Government is already in caretaker mode."):y.lockReason="":(C=!0,y.lockReason="Prime Minister’s party only."):(C=!0,y.lockReason="Only parliamentary and semi-presidential systems have a PM seat.")}else if(y.id==="leave_coalition"){const k=u.nation,A=Ct(k),T=!!R&&R.pm_party_id===a.id;A?mt?(C=!0,y.lockReason="You are in opposition."):T?(C=!0,y.lockReason="Prime Minister’s party cannot leave — resign first."):y.lockReason="":(C=!0,y.lockReason="Only available in parliamentary systems.")}else if(y.id==="disband_party"){const k=He(a);k.isPM?(C=!0,y.lockReason="You are Prime Minister — resign before disbanding."):k.isPresident?(C=!0,y.lockReason="You are the sitting President — step down before disbanding."):k.isMonarchActing?(C=!0,y.lockReason="The reigning monarch cannot disband the royal house."):y.lockReason=""}else if(y.id==="fundraise"){const k=je(f,ft);S=`-${k.momCost} MOM`,I="#c84",P=`<div style="margin-top:4px;font-family:var(--font-mono);font-size:8px;color:var(--text-dim);display:flex;gap:12px;">
            ...
            </div>`,g-k.momCost<1&&(C=!0,P+=`<div style="margin-top:3px;font-family:var(--font-mono);font-size:9px;color:var(--red);">Not enough momentum (need ${k.momCost}, have ${Number(g).toFixed(1)})</div>`)}return`
            <div class="pa-action-item ${C?"locked":""}" data-action-id="${y.id}">
                <div class="pa-action-top">
                    <div style="display:flex;align-items:center;gap:8px;">
                        <span class="pa-action-name">${_(y.name)}</span>
                ...
                <div class="pa-action-desc">${_(y.desc)}</div>
                ${P}
                ${y.locked&&y.lockReason?`<div style="margin-top:4px;font-family:var(--font-mono);font-size:7px;color:var(--orange);display:flex;align-items:center;gap:4px;"><span>⊘</span><span>${_(y.lockReason)}</span></div>`:""}
            </div>
        `}).join("");return`
        <div class="pa-detail-header">
            <div class="pa-detail-left">
                ...
                <div>
                    ...
                    <div class="pa-detail-meta">${r?_((u.nation?.monarch_title||"King")+" of "+(u.nation?.name||"")):_(n.fullTitle)+" &middot; "+_(a.faction_name)}${c}${(()=>{if(r)return' <span style="color:#c8a832;font-weight:700;"> &middot; '+(u.nation?.monarch_title||"MONARCH").toUpperCase()+"</span>";if(i)return' <span style="color:#8b9a6b;font-weight:700;"> &middot; NOBLE HOUSE</span>';const y=R?.pm_party_id===a.id,$=u.nation?.hos_election_method==="elected"&&R?.president_party_id===a.id;return y?' <span style="color:#5cc55c;font-weight:700;"> &middot; PRIME MINISTER</span>':$?' <span style="color:#5cc55c;font-weight:700;"> &middot; PRESIDENT</span>':mt?' <span style="color:#c84;font-weight:700;"> &middot; OPPOSITION</span>':' <span style="color:#8b9a6b;font-weight:700;"> &middot; GOVERNING</span>'})()}</div>
                </div>
            </div>
        </div>
        ${Ve(t)}
    ...
    `}function Ba(e){const t=Dt(e),a=t.firstNames||[],i=t.lastNames||[];if(a.length===0||i.length===0)return[];const r=5+Math.floor(Math.random()*3),n=new Set,o=[];for(let p=0;p<r;p++){let d,s,m,l=0;do d=a[Math.floor(Math.random()*a.length)],s=i[Math.floor(Math.random()*i.length)],m=d+" "+s,l++;while(n.has(m)&&l<20);n.add(m);const c=20+Math.floor(Math.random()*66),f=28+Math.floor(Math.random()*30),g=Math.max(0,c-20)/65,v=Math.round((125e3+g*525e3)/25e3)*25e3;o.push({first_name:d,last_name:s,age:f,skill:c,hire_cost:v})}return o.sort((p,d)=>d.skill-p.skill)}async function Me(e){const t=document.getElementById("pa-deputy-modal");if(!t)return;const a=u.nation?.name,i=Ba(a);let r=null;function n(){const o=r!=null?i[r]:null,p=o?ut(o.skill):null,d=i.map((l,c)=>{const f=r===c,g=ut(l.skill);return`<div class="pa-hire-row ${f?"selected":""}" data-idx="${c}">
                ...
                <div style="flex:1;min-width:0;">
                    ...
                    <div style="display:flex;align-items:center;gap:3px;margin-top:2px;">
                        <div style="flex:1;height:2px;background:var(--border-mid);max-width:60px;"><div style="height:100%;width:${l.skill}%;background:${g.color};"></div></div>
                        <span style="font-family:var(--font-mono);font-size:8px;color:${g.color};">${l.skill}</span>
                    </div>
                </div>
    ...
    `}function Ga(e){const t=document.getElementById("pa-modernize-modal");if(!t)return;const a=u.faction;let i=null,r=a.custom_logo_url||null,n=!1;function o(){const p=!!r,s=Number(a.party_funds??0)>=5e4,m=!!i&&s&&!n;t.innerHTML=`
        ...
        `,document.getElementById("mod-close")?.addEventListener("click",()=>t.classList.remove("active")),document.getElementById("mod-cancel")?.addEventListener("click",()=>t.classList.remove("active")),t.onclick=l=>{l.target===t&&t.classList.remove("active")},document.getElementById("mod-file-input")?.addEventListener("change",l=>{const c=l.target.files?.[0];if(c){if(c.size>2*1024*1024){alert("Logo must be under 2MB.");return}i=c,r=URL.createObjectURL(c),o()}}),document.getElementById("mod-submit")?.addEventListener("click",async()=>{if(n||!i)return;n=!0;const l=document.getElementById("mod-submit");l&&(l.disabled=!0,l.textContent="Uploading...");try{const c=i.name.split(".").pop()?.toLowerCase()||"png",f=`${a.id}/logo_${Date.now()}.${c}`,{error:g}=await w.storage.from("party-logos").upload(f,i,{cacheControl:"3600",upsert:!0,contentType:i.type});if(g)throw new Error("Upload failed: "+g.message);const{data:v}=w.storage.from("party-logos").getPublicUrl(f),h=v?.publicUrl;if(!h)throw new Error("Failed to get logo URL");const x=Math.max(0,Number(a.party_funds??0)-5e4),{error:b}=await w.from("factions").update({custom_logo_url:h,party_funds:x}).eq("id",a.id);if(b)throw b;a.custom_logo_url=h,a.party_funds=x,t.classList.remove("active"),alert("Logo updated! Your party now earns +1 Momentum/tick from the modernized image."),H(e)}catch(c){alert("Modernize failed: "+(c.message||"Error")),n=!1,l&&(l.disabled=!1,l.textContent="Modernize — $50k")}})}t.classList.add("active"),o()}function qa(e){const t=document.getElementById("pa-rebrand-modal");if(!t)return;const a=u.faction;u.nation;const i=a.momentum??50;(u._allParties||[]).filter(c=>c.id!==a.id);const r={current:a.party_color||"#4a8aba"},n={current:0},o={current:a.custom_logo_url||null},p={current:null},d={current:!!a.custom_logo_url},s={current:!1};function m(){return r.current}function l(){const c=m(),f=Se.find(S=>S.hex===c)?.name||"Custom",g=se[n.current]?.emoji||"🏛️",v=d.current&&(o.current||p.current),h=o.current||(p.current?URL.createObjectURL(p.current):null),x=document.getElementById("rb-name")?.value??a.faction_name??"",b=document.getElementById("rb-abbr")?.value??a.abbreviation??"",y=document.getElementById("rb-desc")?.value??"",$=Se.map(S=>{const I=c===S.hex;return`<div class="rb-color-swatch ${I?"selected":""}" data-hex="${S.hex}" style="background:${S.hex};${I?`box-shadow:0 0 8px ${S.hex}44;border:2px solid var(--text-bright);`:""}">
                ${I?'<span style="font-size:10px;color:#fff;text-shadow:0 1px 2px rgba(0,0,0,0.5);">✓</span>':""}
            </div>`}).join(""),P=se.map((S,I)=>{const C=n.current===I;return`<div class="rb-logo-item ${C?"selected":""}" data-idx="${I}" style="${C?`background:${c}15;border:2px solid ${c};box-shadow:0 0 6px ${c}33;`:""}">
                ${S.emoji}
                ...
                <div style="display:flex;">
                    ...
                    <div style="flex:1;padding:14px 20px;border-right:1px solid var(--border-main);">
                        ...
                        <div style="margin-bottom:14px;">
                            ...
                            <textarea class="pa-modal-input" id="rb-desc" rows="3" style="resize:vertical;font-family:var(--font-ui);font-size:11px;line-height:1.5;">${_(y)}</textarea>
                            <div style="font-family:var(--font-mono);font-size:7px;color:var(--text-dim);margin-top:2px;">${y.length}/200 · Visible to all</div>
                        </div>
                        <div style="margin-bottom:14px;">
                        ...
                        <div style="background:var(--bg-card);border:1px solid var(--border-main);border-left:3px solid ${c};padding:10px;">
                            <div style="display:flex;align-items:center;gap:8px;margin-bottom:6px;">
                                <div style="width:40px;height:40px;background:${c}15;border:1.5px solid ${c};display:flex;align-items:center;justify-content:center;font-size:22px;overflow:hidden;">
                                    ${v&&h?`<img src="${h}" style="width:100%;height:100%;object-fit:contain;" alt="">`:g}
                                </div>
                                <div>
                            ...
                            <div style="font-size:9px;color:var(--text-secondary);line-height:1.5;">${_(y||"No description...")}</div>
                        </div>
                        <div>
        ...
        `}t._rbCustomLogoFile=null,t._rbCustomLogoUrl=o.current,t._rbUseCustomLogo=d.current,l(),t.classList.add("active"),t.addEventListener("change",function(f){if(f.target.id==="rb-logo-file"){const g=f.target.files?.[0];if(!g)return;if(g.size>2*1024*1024){alert("Logo must be under 2MB. Selected file: "+(g.size/(1024*1024)).toFixed(1)+"MB"),f.target.value="";return}if(!["image/png","image/jpeg","image/svg+xml","image/webp"].includes(g.type)){alert("Unsupported file type. Use PNG, JPG, SVG, or WebP."),f.target.value="";return}p.current=g,o.current=null,d.current=!0,t._rbCustomLogoFile=g,t._rbCustomLogoUrl=null,t._rbUseCustomLogo=!0,l()}}),t.addEventListener("click",function c(f){if(f.target===t||f.target.closest("#rb-close")||f.target.closest("#rb-cancel")){t.classList.remove("active"),t.removeEventListener("click",c);return}const g=f.target.closest(".rb-color-swatch");if(g){r.current=g.dataset.hex,l();return}const v=f.target.closest(".rb-logo-item");if(v){n.current=parseInt(v.dataset.idx)||0,d.current=!1,t._rbUseCustomLogo=!1,l();return}if(f.target.closest("#rb-remove-logo")){o.current=null,p.current=null,d.current=!1,t._rbCustomLogoFile=null,t._rbCustomLogoUrl=null,t._rbUseCustomLogo=!1,l();return}if(f.target.closest("#rb-submit")){const h=document.getElementById("rb-name")?.value?.trim()||"",x=document.getElementById("rb-abbr")?.value?.trim()||"";if(h.length<3||x.length<2){alert("Name must be 3+ chars, abbreviation 2-4 chars.");return}s.current=!0,l();return}if(f.target.closest("#rb-back")){s.current=!1,l();return}if(f.target.closest("#rb-confirm")){Ha(t,e,c);return}})}async function Ha(e,t,a){const i=u.faction,r=document.getElementById("rb-name")?.value?.trim()||"",n=document.getElementById("rb-abbr")?.value?.trim()||"";document.getElementById("rb-desc")?.value?.trim();const o=document.querySelector(".rb-color-swatch.selected")?.dataset?.hex||i.party_color,p=document.querySelector(".rb-logo-item.selected")?.dataset?.idx,d=p!=null?se[parseInt(p)]?.emoji:null,s=e._rbCustomLogoFile,m=e._rbUseCustomLogo,l=e._rbCustomLogoUrl,c=document.getElementById("rb-confirm");c&&(c.disabled=!0,c.textContent="Rebranding...");try{const f=u.shard?.current_tick||0;let g=l;if(m&&s){const y=s.name.split(".").pop()?.toLowerCase()||"png",$=`${i.id}/logo_${Date.now()}.${y}`,{data:P,error:S}=await w.storage.from("party-logos").upload($,s,{cacheControl:"3600",upsert:!0,contentType:s.type});if(S){console.error("[Rebrand] Logo upload failed:",S.message),alert("Logo upload failed: "+S.message);return}const{data:I}=w.storage.from("party-logos").getPublicUrl($);g=I?.publicUrl||null}else m||(g=null);const v=15e4,h=i.party_funds||0;if(h<v){alert(`Not enough funds. You have $${Math.round(h/1e3)}k, need $150k.`);return}const x=h-v,b=Math.max(1,(i.momentum||0)-10);await w.from("factions").update({party_funds:x,momentum:b,faction_name:r,abbreviation:n.toUpperCase(),party_color:o,party_logo:m?null:d,custom_logo_url:g,rebrand_cooldown_until_tick:f+120}).eq("id",i.id),await w.from("campaign_actions").insert({party_id:i.id,nation_id:u.nation?.id,action_type:"rebrand",ap_cost:3,money_cost:0,tick_performed:f,result:{oldName:i.faction_name,newName:r,oldAbbr:i.abbreviation,newAbbr:n,oldColor:i.party_color,newColor:o}}),i.party_funds=x,i.momentum=b,i.faction_name=r,i.abbreviation=n.toUpperCase(),i.party_color=o,i.party_logo=m?null:d,i.custom_logo_url=g,e.classList.remove("active"),e.removeEventListener("click",a),H(t)}catch(f){console.error("[PartyActions] Rebrand error:",f),alert("Failed to rebrand: "+(f.message||f))}finally{c&&(c.disabled=!1,c.textContent="⚠ Confirm Rebrand")}}const Ua=[{id:"file_lawsuit",name:"File Lawsuit",desc:"Sue a government ministry alleging corruption or negligence. 8-tick timeline with milestone events. Outcome depends on actual corruption growth since government took office.",cost:"$250k",costColor:"#c8a832",moneyCost:25e4,tags:["LEGAL","OFFENSIVE"],locked:!1}];function Ya(e){const t=G,a=Z(t.first_name,t.last_name),i=ut(t.skill),r=mt?'<span style="color:#5cc55c;margin-left:6px;">✓ IN OPPOSITION</span>':'<span style="color:#c84;margin-left:6px;">⚠ IN GOVERNMENT (actions limited)</span>',n=Ua.map(o=>{const p=o.tags.map(d=>`<span class="pa-action-tag" style="color:${jt[d]||"var(--text-dim)"};">${d}</span>`).join("");return`
    ...
    `}function Va(){if(oe.length===0)return"";const e=u.shard?.current_tick||0;return`
        <div class="pa-ls-section">
            <div class="pa-ls-section-title">Legal Actions</div>
            ${oe.map(a=>{const i=zt.find(x=>x.key===a.target_ministry),r=i?i.label:a.target_ministry,n=i?i.icon:"⚖️",o=ge(a.corruption_growth||0),p=st[a.tier]||st[1],d=a.status==="active",s=Math.max(0,e-a.filed_at_tick),m=8,l=Math.min(1,s/m),c=Math.max(0,a.resolves_at_tick-e),f=[{tick:0,label:"Filed",type:"filing"},{tick:2,label:"Discovery",type:"discovery"},{tick:5,label:"Evidence",type:"evidence"},{tick:7,label:"Pre-trial",type:"pre_trial"},{tick:8,label:"Verdict",type:"resolution"}],g=f.map(x=>{const b=a.filed_at_tick+x.tick,y=e>=b,$=e>=b&&(x.tick===8||e<a.filed_at_tick+f[f.indexOf(x)+1]?.tick),P=x.tick/m*100;return`<div class="pa-ls-milestone ${y?"passed":""} ${$?"current":""}" style="left:${P}%;" title="${x.label} (Tick ${b})">
    ...
    `}let Vt=!1;async function Le(e){const t=document.getElementById("pa-hire-modal");if(!t)return;const a=u.nation?.id,i=u.nation?.name;if(!a||!i)return;t.innerHTML='<div class="pa-modal"><div style="padding:40px;text-align:center;color:var(--text-dim);font-family:var(--font-mono);font-size:10px;">Searching for candidates...</div></div>',t.classList.add("active");const r=await $a(w,a,i);let n=null;function o(){const p=n!=null?r[n]:null,d=p?ut(p.skill):null,s=r.map((c,f)=>{const g=n===f,v=ut(c.skill);return`<div class="pa-hire-row ${g?"selected":""}" data-idx="${f}">
                ...
                <div style="flex:1;min-width:0;">
                    <div style="font-size:11px;font-weight:600;color:${g?"var(--text-bright)":"var(--text-secondary)"};">${_(c.first_name)} ${_(c.last_name)}</div>
                    <div style="display:flex;align-items:center;gap:3px;margin-top:2px;">
        ...
        `;const l=()=>t.classList.remove("active");document.getElementById("pa-hire-close")?.addEventListener("click",l),t.onclick=c=>{c.target===t&&l()},document.getElementById("pa-hire-list")?.addEventListener("click",c=>{const f=c.target.closest(".pa-hire-row");f&&(n=parseInt(f.dataset.idx,10),o())}),document.getElementById("pa-hire-confirm")?.addEventListener("click",async()=>{if(Vt||n==null)return;Vt=!0;const c=document.getElementById("pa-hire-confirm");c&&(c.disabled=!0,c.textContent="Hiring...");try{const f=u.shard?.current_tick||0,g=r[n],v=g.hire_cost||0,h=u.faction?.party_funds||0;if(v>0&&h<v){alert(`Not enough funds. You have $${Math.round(h/1e3)}k, need $${Math.round(v/1e3)}k.`);return}if(v>0){const b=h-v,{error:y}=await w.from("factions").update({party_funds:b}).eq("id",u.faction.id);if(y){alert("Failed to deduct funds.");return}u.faction.party_funds=b}const x=await ka(w,u.faction?.id,g,f);if(!x.success){alert(x.error||"Failed to hire agitator.");return}G=x.agitator,Q="agitator",l(),H(e)}catch(f){console.error("[PartyActions] Hire agitator error:",f)}finally{Vt=!1,c&&(c.disabled=!1)}})}o()}let Lt=!1;function Ka(e){const t=document.getElementById("pa-lawsuit-modal");if(!t)return;if(!R){alert("No active government to file against.");return}const a=u.faction,i=G;let r=null,n=null;function o(){const p=r&&n,d=zt.map(l=>{const c=r===l.key;return`<div class="pa-lawsuit-target ${c?"selected":""}" data-target="${l.key}">
            ...
            </div>`}).join(""),s=Be.map(l=>{const c=n===l.key;return`<div class="pa-lawsuit-basis ${c?"selected":""}" data-basis="${l.key}">
                <div style="display:flex;align-items:center;gap:10px;">
...
The case is now under investigation. Results will be determined when it resolves in 8 ticks.`),H(e)}catch(c){console.error("[PartyActions] File lawsuit error:",c),alert("An error occurred. Please try again.")}finally{Lt=!1,l&&(l.disabled=!1,l.textContent="File Lawsuit")}})}t.classList.add("active"),o()}async function Wa(e){const t=document.getElementById("pa-appoint-pm-modal");if(!t)return;const a=u.nation,i=u.faction,{data:r}=await w.from("factions").select("id, faction_name, abbreviation, party_color, seats, leader_first_name, leader_last_name, leader_age").eq("nation_id",a.id).eq("faction_type","party").is("abandoned_at",null).order("seats",{ascending:!1}),n=r||[];let o=null,p=!1;const{data:d}=await w.from("head_of_government").select("faction_id, first_name, last_name, factions(faction_name)").eq("nation_id",a.id).eq("active",!0).maybeSingle();function s(){const m=n.find(v=>v.id===o),l=d?`${d.first_name} ${d.last_name}`:null,c=d?.factions?.faction_name||null,f=d&&o===d.faction_id;t.innerHTML=`
        ...
        `;const g=()=>t.classList.remove("active");document.getElementById("apm-close")?.addEventListener("click",g),document.getElementById("apm-cancel")?.addEventListener("click",g),t.onclick=v=>{v.target===t&&g()},t.querySelector(".pa-modal-body")?.addEventListener("click",v=>{const h=v.target.closest("[data-party-id]");h&&(o=h.dataset.partyId,s())}),document.getElementById("apm-confirm")?.addEventListener("click",async()=>{if(!o||p)return;const v=n.find(x=>x.id===o);if(!v||!confirm(`Appoint ${v.leader_first_name} ${v.leader_last_name} of ${v.faction_name} as Prime Minister?`))return;p=!0;const h=document.getElementById("apm-confirm");h&&(h.disabled=!0,h.textContent="Appointing...");try{const x=u.shard?.current_tick||0;await la(w,{nationId:a.id,factionId:o,firstName:v.leader_first_name||"Unknown",lastName:v.leader_last_name||"Unknown",age:v.leader_age||50,currentTick:x});try{await w.from("government_formations").update({status:"dissolved"}).eq("nation_id",a.id).in("status",["formed","caretaker","active"]);const{data:C}=await w.from("shard").select("current_date").eq("name","Alpha Shard").single();await w.from("government_formations").insert({nation_id:a.id,election_id:null,proposed_by:i.id,party_ids:[o],status:"formed",formation_type:"monarchy",formed_at:new Date().toISOString(),ministry_assignments:{prime_minister:o},game_year:C?.current_date||""})}catch(C){console.warn("[AppointPM] government_formations write failed (non-blocking — synthetic fallback still works):",C?.message||C)}let b=0;const y=a.monarch_faction_id,$=d?.faction_id||null,P=$&&$!==y&&$!==o,S=o!==y&&o!==$;if(P&&(b-=4),S&&(b+=3),b!==0){const C=Number(a.public_approval??50),k=Math.max(0,Math.min(100,C+b));try{await w.from("nations").update({public_approval:k}).eq("id",a.id),a.public_approval=k}catch{}}try{await w.from("event_log").insert({nation_id:a.id,event_name:`${a.monarch_title||"King"} appoints Prime Minister`,category:"government",description_chosen:`${a.monarch_title||"The King"} has appointed ${v.leader_first_name} ${v.leader_last_name} of ${v.faction_name} as Prime Minister.`,fired_at_tick:x})}catch{}g();const I=b>0?`

Legitimacy +${b}.`:b<0?`

Legitimacy ${b}.`:"";alert(`${v.leader_first_name} ${v.leader_last_name} of ${v.faction_name} has been appointed Prime Minister.${I}`),H(e)}catch(x){alert("Failed to appoint PM: "+(x.message||"Error")),p=!1,h&&(h.disabled=!1,h.textContent=`Appoint ${_(v.faction_name)}`)}})}t.classList.add("active"),s()}async function Ja(e){const t=document.getElementById("pa-royal-modal");if(!t)return;const a=u.nation,i=u.faction,r=i.seats||0,n=a?.total_seats||100,{data:o}=await w.from("factions").select("id, faction_name, abbreviation, party_color, seats").eq("nation_id",a.id).eq("faction_type","party").is("abandoned_at",null).order("faction_name"),p=(o||[]).filter(c=>c.id!==i.id);let d=null;const s=Math.max(0,r-1);let m=Math.min(5,s||1);function l(){const c=p.find(g=>g.id===d);t.innerHTML=`
            <div class="pa-modal" style="width:560px;">
                ...
                <div class="pa-modal-body">
                    ...
                    <div style="display:flex;flex-direction:column;gap:4px;">
                        ${p.length>0?p.map(g=>{const v=g.id===d;return`<div class="pa-action-item ${v?"selected":""}" data-faction-id="${g.id}" style="cursor:pointer;${v?`border-color:${g.party_color||"#888"};background:${g.party_color||"#888"}08;`:""}">
                                <div style="display:flex;justify-content:space-between;align-items:center;">
                                    <div style="display:flex;align-items:center;gap:8px;">
                                    ...
                                    <span style="font-family:var(--font-mono);font-size:13px;color:var(--text-dim);">${Math.max(0,g.seats||0)} seats</span>
                                </div>
        ...
        `;const f=()=>t.classList.remove("active");document.getElementById("royal-close")?.addEventListener("click",f),document.getElementById("royal-cancel")?.addEventListener("click",f),t.onclick=g=>{g.target===t&&f()},t.querySelector(".pa-modal-body")?.addEventListener("click",g=>{const v=g.target.closest("[data-faction-id]");v&&(d=v.dataset.factionId,l())}),document.getElementById("grant-slider")?.addEventListener("input",g=>{m=parseInt(g.target.value)||1,document.getElementById("grant-count").textContent=m;const v=document.getElementById("royal-grant");v&&(v.textContent=`Grant ${m} Seats`)}),document.getElementById("royal-grant")?.addEventListener("click",async()=>{if(!d||xt)return;xt=!0;const g=document.getElementById("royal-grant");g&&(g.disabled=!0,g.textContent="Granting...");try{const{data:v}=await w.from("factions").select("id, faction_name, seats").eq("nation_id",a.id).eq("faction_type","party").is("abandoned_at",null),h=(v||[]).find(L=>L.id===i.id),x=(v||[]).find(L=>L.id===d);if(!h||!x){alert("Faction not found.");return}const b=(v||[]).reduce((L,E)=>L+Math.max(0,E.seats||0),0),y=new Map;for(const L of v||[])y.set(L.id,Math.max(0,L.seats||0));let $=m;const P=Math.max(0,(y.get(i.id)||0)-1),S=Math.min($,P);if(S>0&&(y.set(i.id,(y.get(i.id)||0)-S),$-=S),$>0){const L=(v||[]).filter(M=>M.id!==i.id&&M.id!==d&&(y.get(M.id)||0)>0);let E=L.reduce((M,N)=>M+(y.get(N.id)||0),0);for(const M of L){if($<=0||E<=0)break;const N=Math.round($*(y.get(M.id)||0)/E),z=Math.min(N,y.get(M.id)||0,$);z>0&&(y.set(M.id,(y.get(M.id)||0)-z),E-=z,$-=z)}if($>0)for(const M of L){if($<=0)break;const N=y.get(M.id)||0,z=Math.min($,N);z>0&&(y.set(M.id,N-z),$-=z)}}const I=m-$;if(I<=0){alert("No seats available to grant.");return}y.set(d,(y.get(d)||0)+I);let C=0;for(const L of y.values())C+=L;if(C!==b){console.error("[GrantSeats] Conservation violated",{sumBefore:b,sumAfter:C,grantAmount:m,actualGrant:I}),alert("Internal error: seat totals would not balance. Aborting.");return}const k=[];for(const L of v||[]){const E=Math.max(0,L.seats||0),M=y.get(L.id)||0;E!==M&&k.push({id:L.id,seats:M})}for(const L of k){const{error:E}=await w.from("factions").update({seats:L.seats}).eq("id",L.id);if(E){alert("Failed to grant seats: "+E.message);return}}const A=I*.5,T=Math.min(100,(Number(a.public_approval)||50)+A),{error:j}=await w.from("nations").update({public_approval:T}).eq("id",a.id);if(j){alert("Failed to update public approval.");return}i.seats=y.get(i.id)||0,a.public_approval=T;try{const L=p.find(E=>E.id===d);await w.from("event_log").insert({nation_id:a.id,event_name:`${a.monarch_title||"King"} grants ${I} seats to ${L?.faction_name||"unknown"}`,category:"government",description_chosen:`The ${a.monarch_title||"King"} has granted ${I} parliamentary seat${I!==1?"s":""} to ${L?.faction_name}. Legitimacy +${A.toFixed(1)}.`,fired_at_tick:u.shard?.current_tick||0})}catch{}f(),H(e)}catch(v){console.error("[GrantSeats] Error:",v),alert("Failed to grant seats.")}finally{xt=!1}})}t.classList.add("active"),l()}async function Xa(e){const t=document.getElementById("pa-royal-modal");if(!t)return;const a=u.nation,i=u.faction,{data:r}=await w.from("factions").select("id, faction_name, abbreviation, party_color, seats").eq("nation_id",a.id).eq("faction_type","party").is("abandoned_at",null).order("faction_name"),n=(r||[]).filter(s=>s.id!==i.id&&(s.seats||0)>0);let o=null,p=1;function d(){const s=n.find(v=>v.id===o),m=s&&s.seats||0,c=p*1e5,f=i.party_funds||0;t.innerHTML=`
            <div class="pa-modal" style="width:560px;">
                <div class="pa-modal-header">
                    <div class="pa-modal-header-left">
                        <div class="pa-modal-dot" style="background:#d44a4a;"></div>
        ...
        `;const g=()=>t.classList.remove("active");document.getElementById("royal-close")?.addEventListener("click",g),document.getElementById("royal-cancel")?.addEventListener("click",g),t.onclick=v=>{v.target===t&&g()},t.querySelector(".pa-modal-body")?.addEventListener("click",v=>{const h=v.target.closest("[data-faction-id]");h&&(o=h.dataset.factionId,p=1,d())}),document.getElementById("revoke-slider")?.addEventListener("input",v=>{p=parseInt(v.target.value)||1,document.getElementById("revoke-count").textContent=p;const h=document.getElementById("royal-revoke");h&&(h.textContent=`Revoke ${p} Seats`)}),document.getElementById("royal-revoke")?.addEventListener("click",async()=>{if(!o||xt)return;xt=!0;const v=document.getElementById("royal-revoke");v&&(v.disabled=!0,v.textContent="Revoking...");try{const h=p*1e5,{data:x}=await w.from("factions").select("id, faction_name, seats, party_funds").eq("nation_id",a.id).eq("faction_type","party").is("abandoned_at",null),b=(x||[]).find(N=>N.id===i.id),y=(x||[]).find(N=>N.id===o);if(!b||!y){alert("Faction not found.");return}const $=b.party_funds||0;if($<h){alert("Not enough funds.");return}const P=(x||[]).reduce((N,z)=>N+Math.max(0,z.seats||0),0),S=Math.min(p,y.seats||0);if(S<=0){alert("Target has no seats to revoke.");return}const I=$-h,C=(b.seats||0)+S,k=(y.seats||0)-S,A=S,T=Math.max(0,(Number(a.public_approval)||50)-A),j=P-(b.seats||0)-(y.seats||0)+C+k;if(j!==P){console.error("[RevokeSeats] Conservation violated",{sumBefore:P,sumAfter:j,take:S}),alert("Internal error: seat totals would not balance. Aborting.");return}const{error:L}=await w.from("factions").update({seats:C,party_funds:I}).eq("id",i.id);if(L){alert("Failed to revoke seats: "+L.message);return}const{error:E}=await w.from("factions").update({seats:k}).eq("id",o);if(E){alert("Failed to revoke seats: "+E.message);return}const{error:M}=await w.from("nations").update({public_approval:T}).eq("id",a.id);if(M){alert("Failed to update public approval.");return}i.seats=C,i.party_funds=I,a.public_approval=T,sessionStorage.removeItem("nationhood_state");try{await w.from("event_log").insert({nation_id:a.id,event_name:`${a.monarch_title||"King"} revokes ${S} seats from ${y.faction_name||"unknown"}`,category:"political",description_chosen:`The ${a.monarch_title||"King"} has revoked ${S} seat${S!==1?"s":""} from ${y.faction_name}. Legitimacy -${A}.`,fired_at_tick:u.shard?.current_tick||0})}catch{}g(),H(e)}catch(h){console.error("[RevokeSeats] Error:",h),alert("Failed to revoke seats.")}finally{xt=!1}})}t.classList.add("active"),d()}let Kt=!1;async function Qa(){if(Kt||!u?.faction?.id||!u?.nation?.id)return;if(!Ct(u.nation)){alert("Early elections are only available in parliamentary and semi-presidential systems.");return}if(V(u.nation)){alert("Elections are not held under absolute monarchy.");return}const e=R?.pm_party_id;if(!e||e!==u.faction.id){alert("Prime Minister’s party only.");return}if(confirm(`⚡ CALL EARLY ELECTIONS?
...
Proceed?`)){Kt=!0;try{const t=Array.isArray(R?.party_ids)?R.party_ids:R?.pm_party_id?[R.pm_party_id]:[],a=await fa(w,u.nation.id,e,t);if(a&&a.success===!1){alert("Could not call early elections: "+(a.error||"unknown error"));return}alert("⚡ Early elections called. Government is now in caretaker status."),window.location.reload()}catch(t){console.error("[PartyActions] Call early elections failed:",t),alert("Failed to call early elections: "+(t?.message||"unknown error"))}finally{Kt=!1}}}let Wt=!1;async function Za(){if(!Wt&&u?.faction?.id&&confirm(`LEAVE COALITION?
...
Proceed?`)){Wt=!0;try{const{data:e,error:t}=await w.rpc("leave_coalition",{p_faction_id:u.faction.id});if(t)throw t;if(e&&e.success===!1)throw new Error(e.error||"Unknown error");const a=e?.became_minority?`

The government is now a minority.`:"",i=(e?.ministries_vacated||0)>0?`

${e.ministries_vacated} ministr${e.ministries_vacated===1?"y":"ies"} vacated.`:"";alert("You have left the coalition."+a+i),window.location.reload()}catch(e){console.error("[PartyActions] Leave Coalition failed:",e),alert("Failed to leave coalition: "+(e?.message||e))}finally{Wt=!1}}}let Jt=!1;async function ti(){if(Jt||!u?.faction?.id||!u?.nation?.id)return;if(!Ct(u.nation)){alert("Resignation is only available in parliamentary and semi-presidential systems.");return}if(V(u.nation)){alert("Prime Ministers serve at the Monarch’s pleasure. The Monarch must replace the PM via the Appoint Prime Minister royal action.");return}const e=R?.pm_party_id;if(!e||e!==u.faction.id){alert("Prime Minister’s party only.");return}if(confirm(`⚠ RESIGN AS PRIME MINISTER?

The PM seat vacates immediately. Coalition enters caretaker status with
a ${ae}-tick window to nominate a successor via the cabinet panel.
...
Proceed?`)){Jt=!0;try{const{data:t}=await w.from("shard").select("current_tick").eq("name","Alpha Shard").single(),a=t?.current_tick||u.shard?.current_tick||0;(await ra(w,u.nation.id,u.faction.id,a))?.result==="election_called"?alert("You have resigned. Snap election scheduled as fallback if no successor is nominated."):alert("You have resigned. Coalition has a short window to nominate a successor before a snap election fires."),window.location.reload()}catch(t){console.error("[PartyActions] Resign PM failed:",t),alert("Failed to resign: "+(t?.message||"unknown error"))}finally{Jt=!1}}}let Xt=!1;async function ei(){if(Xt||!u?.faction?.id)return;const e=u.faction,t=e.faction_name||"this party",a=e.seats||0,i=Number(e.momentum||0).toFixed(1),r=Math.round(Number(e.party_funds||0)),n=r>=1e3?"$"+r.toLocaleString():"$"+r;if(!confirm("DISBAND "+t.toUpperCase()+`?
...
Proceed?`)){Qt=!0;try{const f=await ma(w,{faction:e,nation:t,pmFactionId:r,pmLastName:n,isSemiPres:a,tick:d,mySeats:o});if(!f.ok){alert("Failed to file motion: "+f.error);return}alert(`⚡ "${f.motionName}" has been filed!

Voting is now open for ${dt.NO_CONFIDENCE_VOTING_TICKS} ticks.`),window.location.href=`bill.html?id=${f.billId}`}catch(f){console.error("[PartyActions] No confidence file failed:",f),alert("Failed to file motion: "+(f?.message||"unknown error"))}finally{Qt=!1}}}let Zt=!1;async function ii(e){if(Zt)return;const t=u.faction,a=t.seats||0,i=Math.max(1,t.momentum??0);if(a<=0){alert("Your party has no seats — nothing to fundraise from.");return}const r=je(a,ft);if(i-r.momCost<1){alert(`Not enough momentum. You need ${r.momCost} momentum (current: ${Math.round(i)}, floor: 1). Try again next tick when momentum recovers.`);return}Zt=!0;try{const{data:n}=await w.from("factions").select("party_funds, momentum").eq("id",t.id).single();n&&(t.party_funds=n.party_funds??0,t.momentum=n.momentum??0);const o=Math.max(1,t.momentum??0),p=u.shard?.current_tick||0,d=Math.max(1,o-r.momCost),s=(t.party_funds||0)+r.raised,{error:m}=await w.from("factions").update({momentum:d,party_funds:s}).eq("id",t.id);if(m){alert("Fundraise failed: "+m.message);return}await w.from("campaign_actions").insert({party_id:t.id,nation_id:u.nation?.id,action_type:"fundraise",ap_cost:0,money_cost:0,tick_performed:p,result:{momentumDelta:-r.momCost,raised:r.raised,perSeat:r.perSeat,momCost:r.momCost,useNumber:ft+1,seats:a}}),t.momentum=d,t.party_funds=s,sessionStorage.removeItem("nationhood_state"),ft++,H(e)}catch(n){console.error("[PartyActions] Fundraise error:",n),alert("Fundraise failed.")}finally{Zt=!1}}function oi(e){const t=document.getElementById("pa-statement-modal");if(!t)return;const a=u.faction,i=a?.color||"#c8a832",r=a?.leader_first_name&&a?.leader_last_name?`${a.leader_first_name} ${a.leader_last_name}`:"Party Leader",n=Ee.map(m=>`<div class="pa-topic-card" data-topic="${m.id}" style="padding:8px 10px;cursor:pointer;border:1px solid var(--border-mid);display:flex;align-items:center;gap:8px;transition:all 0.12s;">
    ...
    `,t.classList.add("active");let o=null,p=!1;const d=()=>t.classList.remove("active");document.getElementById("pa-stmt-close")?.addEventListener("click",d),document.getElementById("pa-stmt-cancel")?.addEventListener("click",d),t.addEventListener("click",m=>{m.target===t&&d()}),document.getElementById("pa-stmt-topics")?.addEventListener("click",m=>{const l=m.target.closest(".pa-topic-card");l&&(o=l.dataset.topic,document.querySelectorAll(".pa-topic-card").forEach(c=>{const f=c.dataset.topic===o;c.style.borderColor=f?i:"var(--border-mid)",c.style.background=f?i+"0a":"";const g=c.querySelector("span:last-child");g&&(g.style.color=f?"var(--text-bright)":"var(--text-secondary)")}),s())});const s=()=>{const m=document.getElementById("pa-stmt-body")?.value?.trim()||"",l=document.getElementById("pa-stmt-submit"),c=document.getElementById("pa-stmt-charcount");c&&(c.textContent=`${m.length} characters`),l&&(l.disabled=!(o&&m.length>=10))};document.getElementById("pa-stmt-body")?.addEventListener("input",s),document.getElementById("pa-stmt-submit")?.addEventListener("click",async()=>{if(p)return;const m=document.getElementById("pa-stmt-body")?.value?.trim();if(!o||!m||m.length<10)return;p=!0;const l=document.getElementById("pa-stmt-submit");l&&(l.disabled=!0,l.textContent="Issuing...");try{const c=u.shard?.current_tick||0,g=Ee.find(A=>A.id===o)?.label||o,v=2e4,{data:h}=await w.from("factions").select("party_funds").eq("id",a.id).single(),x=h?.party_funds||0;if(x<v){alert(`Not enough funds. You have $${Math.round(x/1e3)}k, need $20k.`);return}const b=x-v,{error:y}=await w.from("factions").update({party_funds:b}).eq("id",a.id);if(y){alert("Failed to deduct funds: "+y.message);return}a.party_funds=b;const P=Ce[Math.floor(Math.random()*Ce.length)].replace("{party_name}",a.faction_name||"Unknown Party").replace("{leader_name}",r).replace("{topic}",g),{error:S}=await w.from("campaign_actions").insert({party_id:a.id,nation_id:u.nation?.id,action_type:"issue_statement",ap_cost:1,money_cost:0,tick_performed:c,result:{topic:o,topicLabel:g,headline:P,body:m,leaderName:r}});S&&console.error("[PartyActions] Statement log failed:",S.message);const{error:I}=await w.from("valdorian_articles").insert({nation_id:u.nation?.id,event_type:"issue_statement",tier:3,section:"politics",headline:P,subheadline:g,lede:m.substring(0,200)+(m.length>200?"...":""),body_paragraphs:JSON.stringify(m.split(/\n\n+/).filter(A=>A.trim())),quotes:JSON.stringify([{posture:"assertive",text:m.substring(0,150)}]),byline_reporter:"Political Desk",topic_tags:JSON.stringify([o]),source_event_id:"statement_"+Date.now(),tick:c});I&&console.error("[PartyActions] Article creation failed:",I.message);const{error:C}=await w.from("event_log").insert({nation_id:u.nation?.id,event_name:P,category:"political",description_chosen:`${a.faction_name} issues the following statement regarding ${g}: "${m}"`,fired_at_tick:c});C&&console.warn("[Statement] event_log insert failed:",C.message);const{error:k}=await w.from("admin_timeline_events").insert({nation_id:u.nation?.id,tick:c,type:"communications",title:"Statement Issued",description:`${r} issued a public statement on ${g}: "${m.substring(0,120)}${m.length>120?"...":""}"`});k&&console.warn("[Statement] timeline insert failed:",k.message),d(),H(e)}catch(c){console.error("[PartyActions] Statement error:",c),alert("Failed to issue statement. Please try again.")}finally{p=!1,l&&(l.disabled=!1,l.textContent="Issue Statement")}})}const Ot=20;function ni(e){const t=document.getElementById("pa-platform-modal");if(!t)return;const a=u.faction;u.nation;const i=a?.color||"#c8a832";let r=null,n=!1;const o={};for(const s of Rt)s.faction_id!==a?.id&&(o[s.platform_key]=(o[s.platform_key]||0)+1);const p=new Set(at.map(s=>s.platform_key));function d(){const s=ht.find(f=>f.id===r),m=s?we(o[s.id]||0):null;s&&Rt.filter(f=>f.platform_key===s.id&&f.faction_id!==a?.id);const l=ht.map(f=>{const g=r===f.id,v=p.has(f.id),h=we(o[f.id]||0),x=o[f.id]||0;return`<div class="pa-plat-card ${g?"selected":""} ${v?"adopted":""}" data-plat="${f.id}">
                ${v?'<div class="pa-plat-active-badge">ACTIVE</div>':""}
                <div style="display:flex;align-items:center;gap:6px;margin-bottom:4px;">
                    <span style="font-size:14px;">${f.icon}</span>
                    <span style="font-size:10px;font-weight:700;color:${v?i:g?"var(--text-bright)":"var(--text-secondary)"};line-height:1.2;">${_(f.name)}</span>
                </div>
            ...
            </div>`;else{const f=s.improve.map(b=>{const y=_e(b,"improve");return`<span style="display:inline-flex;align-items:center;gap:3px;font-family:var(--font-mono);font-size:8px;padding:2px 6px;background:rgba(92,204,92,0.05);border:1px solid rgba(92,204,92,0.15);color:${y.color};white-space:nowrap;">${y.arrow} ${he[b]||b}</span>`}).join(""),g=s.worsen.map(b=>{const y=_e(b,"worsen");return`<span style="display:inline-flex;align-items:center;gap:3px;font-family:var(--font-mono);font-size:8px;padding:2px 6px;background:rgba(204,85,85,0.05);border:1px solid rgba(204,85,85,0.15);color:${y.color};white-space:nowrap;">${y.arrow} ${he[b]||b}</span>`}).join(""),v=p.has(s.id),h=at.length;let x;v?x=`<div style="font-family:var(--font-mono);font-size:10px;font-weight:700;color:${i};display:flex;align-items:center;gap:6px;">✓ CURRENT PLATFORM</div>`:h>=3?x='<div style="font-family:var(--font-mono);font-size:9px;color:var(--red);">All 3 platform slots are full.</div>':n?x=`<div style="display:flex;align-items:center;gap:8px;">
                ...
                <div style="flex:1;padding:12px 20px;overflow-y:auto;">
                    ...
                    <div style="margin-bottom:14px;">
                        ...
                        <div style="display:flex;flex-wrap:wrap;gap:4px;">${g}</div>
                    </div>
        ...
        `,document.getElementById("pa-plat-close")?.addEventListener("click",()=>t.classList.remove("active")),t.onclick=f=>{f.target===t&&t.classList.remove("active")},document.getElementById("pa-plat-grid")?.addEventListener("click",f=>{const g=f.target.closest(".pa-plat-card");g&&(r=g.dataset.plat,n=!1,d())}),document.getElementById("pa-plat-adopt")?.addEventListener("click",()=>{n=!0,d()}),document.getElementById("pa-plat-conf-cancel")?.addEventListener("click",()=>{n=!1,d()}),document.getElementById("pa-plat-conf-yes")?.addEventListener("click",()=>si(e,r))}t.classList.add("active"),d()}let Pt=!1;async function si(e,t){if(Pt)return;Pt=!0;const a=document.getElementById("pa-platform-modal"),i=u.faction,r=u.nation;if(!i||!r||!t){Pt=!1;return}const n=ht.find(s=>s.id===t);if(!n)return;const o={},p={},d=s=>ue.has(s);for(const s of n.improve){const m=Number(r[s]??50);o[s]=m,d(s)?p[s]=Math.max(0,m-Ot):p[s]=Math.min(100,m+Ot)}try{const s=u.shard?.current_tick||0,{data:m,error:l}=await w.rpc("adopt_platform",{p_faction_id:i.id,p_nation_id:r.id,p_platform_key:t,p_tick:s,p_baseline_stats:o,p_target_stats:p});if(l){console.error("[PartyActions] Platform adoption failed:",l.message),alert("Failed to adopt platform: "+l.message);return}if(m&&!m.success){alert(m.error||"Failed to adopt platform.");return}const c=m?.slot||at.length+1;at.push({faction_id:i.id,nation_id:r.id,platform_key:t,slot:c,adopted_at_tick:s,baseline_stats:o,target_stats:p,status:"active"}),Rt.push(at[at.length-1]),i&&m?.momentum_gained&&(i.momentum=(i.momentum||0)+m.momentum_gained),i&&(i.action_points=Math.max(0,(i.action_points||0)-2)),a?.classList.remove("active"),H(e)}catch(s){console.error("[PartyActions] Platform adoption error:",s),alert("An error occurred. Please try again.")}finally{Pt=!1}}let _t=null,We={isGoverning:!1,statusLabel:"OPPOSITION",administration:null,ticksInPower:0,myFaction:null,allParties:[],rivalParties:[],strongholdsByParty:{},recentActivity:[],caucuses:[],nextElection:null,nextElectionTicks:null};function K(e){if(!e)return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML}function ri(e,t,a){const i={};for(const r of e)i[r.id]=ua(r.id,t,a,3);return i}async function li(e,t,a){_t=t;const i=document.getElementById(a);if(!i)return;const r=t.faction,n=t.nation,o=n?.id,p=r?.id;if(!r||!o){i.innerHTML='<div style="padding:40px;text-align:center;color:var(--text-dim);font-family:var(--font-mono);font-size:10px;">No faction data.</div>';return}i.innerHTML='<div style="padding:40px;text-align:center;color:var(--text-dim);font-family:var(--font-mono);font-size:10px;">Loading party overview...</div>';try{const d=t.shard?.current_tick||0,[s,m,l,c,f,g,v,h]=await Promise.all([Fe(e,o,p),e.from("factions").select("*").eq("nation_id",o).eq("faction_type","party"),e.from("sectors").select("id, sector_key, name, weight, base_turnout, is_active").eq("nation_id",o).eq("is_active",!0).order("display_order"),e.from("campaign_actions").select("*").eq("party_id",p).order("tick_performed",{ascending:!1}).limit(20),Promise.resolve({data:[],error:null}),e.from("elections").select("*").eq("nation_id",o).eq("status","scheduled").order("election_tick",{ascending:!0}).limit(5),e.from("ministries").select("party_id").eq("nation_id",o).eq("is_active",!0),na(o)]);m.error&&console.error("[PartyOverview] Parties fetch error:",m.error.message),l.error&&console.error("[PartyOverview] Sectors fetch error:",l.error.message),c.error&&console.error("[PartyOverview] Activity fetch error:",c.error.message),f.error&&console.error("[PartyOverview] Caucus fetch error:",f.error.message),g.error&&console.error("[PartyOverview] Election fetch error:",g.error.message);const x=m.data||[],b=l.data||[],y=s.administration,$=new Set((v.data||[]).map(L=>L.party_id).filter(Boolean));let P=[];if(x.length>0&&b.length>0){const L=x.map(N=>N.id),{data:E,error:M}=await e.from("faction_sector_popularity").select("faction_id, sector_id, popularity").in("faction_id",L);M&&console.error("[PartyOverview] Popularity fetch error:",M.message),P=E||[]}const S=ri(x,b,P),I=va(p,b,P).sort((L,E)=>(E.popularity||0)-(L.popularity||0)),C=y?.started_at_tick!=null?Math.max(0,d-y.started_at_tick):0,k=g.data||[],A=k[0]||null,T=A?Math.max(0,A.election_tick-d):null;let j=null;A&&n&&lt(n)&&(j=k.some(E=>E.election_type==="presidential"&&E.election_tick===A.election_tick)?"General":"Midterm"),We={isGoverning:s.isGoverning,statusLabel:s.label,administration:y,ministryPartyIds:$,ticksInPower:C,myFaction:r,allParties:x,rivalParties:x.filter(L=>L.id!==p),blocMap:h,strongholdsByParty:S,mySectorContributions:I,recentActivity:c.data||[],caucuses:f.data||[],nextElection:A,nextElectionTicks:T,nextElectionLabel:j},Je(i)}catch(d){console.error("[PartyOverview] Init error:",d),i.innerHTML='<div style="padding:40px;text-align:center;color:var(--red);font-family:var(--font-mono);font-size:10px;">Failed to load party overview.</div>'}}let nt=[];function Je(e){const t=We,a=t.myFaction,i=_t.nation,r=a?.party_color||a?.color||"#c8a832";_t.shard?.current_tick,nt.length===0&&(nt=[a?.id,...t.rivalParties.map(m=>m.id)]),t.administration?.admin_name||t.isGoverning;const n=t.statusLabel,o=t.isGoverning?"var(--green)":"var(--orange)",p=a?.seats||0,d=i?.total_seats||100,s=a?.momentum??50;e.innerHTML=`<div class="po-page">
        ${di(t,r,p,d,s)}
    ...
    </div>`}function ci(e,t,a,i,r){const n=t?.leader_first_name&&t?.leader_last_name?`${t.leader_first_name} ${t.leader_last_name}`:"Unknown",o=((t?.leader_first_name||"?")[0]+(t?.leader_last_name||"?")[0]).toUpperCase();t?.leader_age&&`${t.leader_age}`;const p=t?.approval_rating??0;return`<div class="po-card po-identity" style="border-left-color:${a};">
    ...
    </div>`}function mi(e){const t=(e.caucuses||[]).filter(r=>r.name&&r.name!=="Unnamed");if(t.length===0)return`<div class="po-card">
            <div class="po-card-header">
        ...
        ${i}
    </div>`}function fi(e,t){const i=Math.round(t*8/100*10)/10,r=Math.min(100,Math.max(0,t)),n=t>=60?"var(--green)":t>=30?"var(--orange)":"var(--red)";return`<div class="po-card">
        <div class="po-card-header">
    ...
    </div>`}function vi(e){const t=e.recentActivity||[],a=_t.shard?.current_tick||0;if(t.length===0)return`<div class="po-card" style="flex:1;">
            <div class="po-card-header">
        ...
        <div style="max-height:380px;overflow-y:auto;">${t.map(n=>{const o=a-(n.tick_performed||0),p=o===0?"0t":o+"t",d=n.result||{},s=d.momentumDelta||d.momentum_delta||d.momentum||(d.momCost?-d.momCost:0)||(d.effects||[]).reduce((g,v)=>g+(v.stat==="Momentum"?v.value:0),0)||0,m=s>0?"+":"",l=s>0?"var(--green)":s<0?"var(--red)":"var(--text-dim)";let f=i[n.action_type]||n.action_type?.replace(/_/g," ")||"?";return n.action_type==="rally"?f="Rally: "+(d.outcomeName||d.label||"Unknown")+(s?" ("+m+s+")":""):n.action_type==="press_conference"?f="Press Conference ("+m+s+")":n.action_type==="attack"?f="Attack on "+(d.targetName||"rival"):n.action_type==="issue_statement"?f="Issued statement"+(s?" ("+m+s+")":""):n.action_type==="take_stance"?f="Took stance on "+(d.issueLabel||"issue"):n.action_type==="ideological_pivot"?f="Ideology shift: "+(d.targetAxis||""):n.action_type==="poll_now"&&(f="Polled (margin: "+(d.pollMargin||"?")+")"),`<div style="padding:5px 12px;border-bottom:1px solid rgba(200,196,184,0.03);display:flex;justify-content:space-between;align-items:center;">
    ...
    </div>`}function ui(e,t){const a=e.rivalParties,i=e.administration,r=_t.nation,n=i?.pm_party_id,o=r?.total_seats||100,p=a.map(d=>{const s=d.party_color||"#666",m=d.abbreviation||d.faction_name?.slice(0,3)?.toUpperCase()||"?",l=d.leader_first_name&&d.leader_last_name?`${d.leader_first_name} ${d.leader_last_name}`:"Unknown",c=d.seats||0,f=wa(d,i,e.ministryPartyIds,r);let g=f.label;const v=f.isGoverning?"var(--green)":"var(--orange)";f.isGoverning&&f.label==="GOVERNING"&&(d.id===n?g="GOVERNING — LEAD":g="GOVERNING — JUNIOR");const h=c-(t?.seats||0),x=h>0?"var(--green)":h<0?"var(--red)":"var(--text-dim)",b=e.strongholdsByParty?.[d.id]||[],y=b.length>0?`<div style="display:flex;flex-wrap:wrap;gap:4px;">${b.map($=>`<span style="font-family:var(--font-mono);font-size:9px;padding:2px 6px;border:1px solid ${s}44;background:${s}10;color:var(--text-bright);white-space:nowrap;">${K($.name)}</span>`).join("")}</div>`:'<div style="font-family:var(--font-mono);font-size:9px;color:var(--text-dim);">Unaligned</div>';return`<div style="padding:12px 16px;border-bottom:1px solid var(--border-main);">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px;">
                ...
                <div style="display:flex;flex-direction:column;align-items:flex-end;gap:3px;">
                    <span style="font-family:var(--font-mono);font-size:9px;font-weight:700;padding:2px 7px;color:${v};background:${v}0a;border:1px solid ${v}44;white-space:nowrap;">${g}</span>
                    ${ze(d.bloc_id,e.blocMap)}
                </div>
            </div>
    ...
    </div>`}function gi(){return`<div style="background:var(--bg-card);border:1px solid var(--border-main);padding:8px 12px;">
    ...
    </div>`}let O=null,F=null,bt=!1,wt=null,q=[],vt=[],et=0,re={},be=[],Xe=null,ot=0,Bt=null,rt=0,pt=[],te=!1,kt=null,Y={},ee=!1;function U(e){if(!e)return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML}async function Qe(e,t){O=e,F=t;const a=t.nation,i=t.faction;if(!a||!i)return{needed:!1};const[r,n,o,p,d,s]=await Promise.all([e.from("elections").select("id, election_type, election_tick, status").eq("nation_id",a.id).eq("status","completed").order("election_tick",{ascending:!1}).limit(1).maybeSingle(),e.from("shard").select("current_tick").eq("name","Alpha Shard").single(),fe(e,a.id),e.from("factions").select("id, faction_name, abbreviation, party_color, seats, bloc_id").eq("nation_id",a.id).eq("faction_type","party").is("abandoned_at",null).order("seats",{ascending:!1}),e.from("elections").select("election_tick, election_type").eq("nation_id",a.id).eq("status","scheduled").order("election_tick",{ascending:!0}),e.from("faction_platforms").select("faction_id, platform_key, slot").eq("nation_id",a.id).eq("status","active").order("slot",{ascending:!0})]);rt=n.data?.current_tick??0,q=p.data||[],et=q.reduce((f,g)=>f+(g.seats||0),0),ot=Math.ceil(et/2)+1,be=d?.data||[],Xe=o||null,re={},s?.error&&console.warn("[CoalitionFormation] faction_platforms query failed:",s.error.message);for(const f of s?.data||[])(re[f.faction_id]||=[]).push(f.platform_key);const m=r.data,c=!!(o||null);return lt(a)?(bt=!1,{needed:!1}):(m&&!c?(bt=!0,wt=m.id,Bt=m.election_tick):(bt=!c,m&&(wt=m.id,Bt=m.election_tick)),{needed:bt})}function yi(){const e=F?.nation;if(!e||V(e))return"";const t=lt(e),a=be[0]||null,i=a?.election_tick??null,r=a?.election_type||"parliamentary",n=t?r==="presidential"?"General":"Midterm":"Parliamentary",o=Number(rt)||0,p=i!=null?Math.max(0,i-o):null,d=p==null?null:`${p} Month${p===1?"":"s"}`,s=i!=null?ga(i):"TBD",m=Number(e.total_seats)||0,l=Number(e.parliamentary_term_ticks)||Number(e.election_frequency)||24,c=`${l} Month${l===1?"":"s"}`,f=e.name||"Unknown",g=e.flag_url||`assets/flags/${f}.png`,v=[d,`Type: ${n}`].filter(Boolean).map(y=>`<div class="cf-eh-stat-sub">${U(y)}</div>`).join(""),h=Xe?.status||null,x=h?h.charAt(0).toUpperCase()+h.slice(1):null;return`<div class="cf-election-header">
        <div class="cf-eh-left">
            ...
            <div class="cf-eh-title-row">
                <img class="cf-eh-flag" src="${U(g)}" alt="${U(f)} flag" onerror="this.style.display='none'">
        ...
        </div>`;return}const t=yi(),a=bi(),i=a?`<div class="cf-makeup-row">
               <div class="cf-makeup-left"></div>
               <div class="cf-makeup-right">${a}</div>
           </div>`:"";if(lt(F.nation)){const b=ve(F.nation);e.innerHTML=`${t}${i}
        <div class="cf-page">
            <div class="cf-no-formation">
                <div class="cf-no-icon">&#127979;</div>
        ...
        </div>`;return}if(!wt){const b=be[0]?.election_tick,y=b!=null?Math.max(0,b-rt):"?";e.innerHTML=`${t}${i}
        <div class="cf-page">
            <div class="cf-no-formation">
                <div class="cf-no-icon" style="font-size:2rem;">&#9878;</div>
                <div class="cf-no-title">No Government</div>
                <div class="cf-no-desc">No election has been held yet. The first election is in <strong style="color:var(--accent);">${y}</strong> tick${y!==1?"s":""}.</div>
            </div>
        </div>`;return}await ki();const r=F.faction,n=Bt!==null?Math.max(0,rt-Bt):0,o=Math.max(0,ae-n),p=Math.min(100,n/ae*100),d=n*2;let s="safe";o<=1?s="critical":o<=2&&(s="warning");const m=s==="critical"?"⚠️":s==="warning"?"⏳":"🤝",l=s==="critical"?"No Government — Snap Election Imminent":s==="warning"?"Coalition Formation — Time Running Out":"Coalition Formation In Progress",c=s==="critical"?"Form a government immediately or face snap elections":s==="warning"?"Parties are negotiating — the deadline is approaching":"Parties are negotiating a coalition — propose or join one below",f=q.find(b=>b.id===r.id)?.seats||0,g=f>0,v=vt.some(b=>b.proposed_by===r.id);let h="";if(!g)h='<div class="cf-note">Your party has <strong>0 seats</strong>. You cannot propose a coalition, but you may be invited to one.</div>';else if(v)h='<div class="cf-note">You have already submitted a proposal for this election.</div>';else{const b=$=>($||[]).map(P=>P.replace(/_/g," ")).join(", "),y=q.map($=>{const P=$.id===r.id,S=$.seats||0,I=$.party_color||"#888",k=(re[$.id]||[]).map(T=>ht.find(j=>j.id===T)).filter(Boolean).map(T=>`<div class="cf-platform">
            ...
            <div class="cf-propose-section">
                ...
                <div class="cf-party-grid" id="cf-party-grid">${y}</div>
    ...
    <div class="cf-page">
        ...
        ${h}
        ${x}
    </div>`,pt=[r.id],Ei(e)}const xi={prime_minister:"Prime Minister",interior:"Interior",foreign:"Foreign Affairs",defense:"Defense",finance:"Finance",education:"Education",healthcare:"Healthcare",labor:"Labor",justice:"Justice",trade:"Trade",energy:"Energy",transportation:"Transportation",security:"Security"};function hi(e){const t=["prime_minister","interior","foreign","defense","finance","education","healthcare","labor","justice","trade","energy","transportation"],a=["interior","foreign","defense","finance","education","healthcare","labor","justice","trade","energy","transportation"];return ve(e)?t:lt(e)?a:t}function _i(e){const t=(e.party_ids||[]).map(s=>q.find(m=>m.id===s)).filter(Boolean),a=(e.party_ids||[]).includes(F.faction?.id);Y={...e.ministry_assignments||{}};const r=F.faction?.id,n=Y.prime_minister,o=n===r;let p=`<div style="padding:12px 16px;border-top:1px solid var(--border-main);background:var(--bg-card);">
        ...
        <div style="font-size:11px;color:var(--text-dim);margin-bottom:12px;">All coalition members can assign ministries. The party selected as Prime Minister clicks Form Government.</div>`;for(const s of ca){const m=xi[s]||s,l=s==="prime_minister",c=Y[s];a&&(p+=`<div style="display:flex;align-items:center;gap:8px;padding:6px 0;border-bottom:1px solid rgba(42,42,36,0.2);">
        ...
        </div>`;return p+="</div>",p}async function wi(e,t){if(ee)return;const a=Y.prime_minister;if(!a){alert("You must assign a Prime Minister first.");return}console.log("[Coalition] handleFormGovernment called. Assignments:",JSON.stringify(Y)),console.log("[Coalition] Formation:",e.id,"PM party:",a),ee=!0;const i=document.getElementById("cf-form-gov-btn");i&&(i.disabled=!0,i.textContent="FORMING...");try{const r=F.nation,n=r.id,o=Dt(r?.name)||{},p=o.firstNames||["Alex","Maria","Carlos"],d=o.lastNames||["Garcia","Torres","Silva"],s={};for(const[x,b]of Object.entries(Y||{}))b&&(s[x]={first_name:p[Math.floor(Math.random()*p.length)],last_name:d[Math.floor(Math.random()*d.length)],age:35+Math.floor(Math.random()*25)});const{error:m}=await O.from("government_formations").update({ministry_assignments:Y,minister_names:s}).eq("id",e.id);if(m)throw new Error("Failed to save assignments: "+m.message);let l=!1;try{const x=Nt?Nt(null,r):{},{error:b}=await O.rpc("finalize_government_formation",{p_formation_id:e.id,p_caller_faction_id:F.faction.id,p_ministry_baselines:x||{}});if(b)throw b;l=!0}catch(x){console.warn("[Coalition] RPC failed, using fallback:",x.message)}l||await $i(e),await O.from("government_formations").update({status:"formed",formed_at:new Date().toISOString()}).eq("id",e.id),await O.from("government_formations").update({status:"dissolved"}).eq("nation_id",n).neq("id",e.id).in("status",["active","caretaker","formed"]);const f=hi(r).length,{count:g}=await O.from("ministries").select("id",{count:"exact",head:!0}).eq("nation_id",n).eq("is_active",!0),{count:v}=await O.from("ministries").select("id",{count:"exact",head:!0}).eq("nation_id",n).eq("is_active",!0).is("party_id",null);(!g||g<f||v&&v>0)&&(console.warn(`[Coalition] Ministry invariant check failed (expected=${f}, active=${g||0}, vacant=${v||0}) — populating from assignments`),await Ze(n));const h={id:e.id,party_ids:e.party_ids||[],lead_party_id:Y.prime_minister};await Re(O,n,F.nation,"election",h,q,rt,F.shard?.current_date||"",Number(F.nation?.gov_approval??50)),await da(O,n,a,rt,{skipCoalitionCheck:!0}),bt=!1,alert("Government formed successfully!"),await gt(t)}catch(r){console.error("[Coalition] Form government failed:",r),alert("Failed to form government: "+(r.message||r))}finally{ee=!1,i&&(i.disabled=!1,i.textContent="FORM GOVERNMENT")}}async function $i(e){const t=F.nation.id,{error:a}=await O.from("government_formations").update({status:"cancelled"}).eq("nation_id",t).eq("status","active").neq("id",e.id);a&&console.warn("[Coalition] Failed to cancel rival formations:",a.message);const{error:i}=await O.from("government_formations").update({status:"formed",formed_at:new Date().toISOString()}).eq("id",e.id);if(i)throw i;const{error:r}=await O.from("nations").update({failed_formation_attempts:0}).eq("id",t);r&&console.warn("[Coalition] Failed to reset formation attempts:",r.message),await Ze(t);const n={id:e.id,party_ids:e.party_ids||[],lead_party_id:Y.prime_minister};await Re(O,t,F.nation,"election",n,q,rt,F.shard?.current_date||"",Number(F.nation?.gov_approval??50));try{const o=Y.prime_minister,p=q.find(s=>s.id===o),d=(e.party_ids||[]).map(s=>{const m=q.find(l=>l.id===s);return m?`${m.faction_name} (${m.seats||0})`:null}).filter(Boolean).join(", ");await O.from("event_log").insert({nation_id:t,event_name:"Coalition Government Formed",category:"government",fired_at_tick:rt,description_used:`${p?.faction_name||"PM party"} formed a coalition government with: ${d}`,description_chosen:`${p?.faction_name||"PM party"} formed a coalition government with: ${d}`})}catch(o){console.warn("[Coalition] event_log insert failed (non-fatal):",o.message)}}async function Ze(e){let t=0;for(const[a,i]of Object.entries(Y)){if(!i)continue;const r=Dt(F.nation?.name)||{},n=r.firstNames||["Alex","Maria","Carlos"],o=r.lastNames||["Garcia","Torres","Silva"],p=n[Math.floor(Math.random()*n.length)],d=o[Math.floor(Math.random()*o.length)],s=35+Math.floor(Math.random()*25),m=Nt?Nt(a,F.nation):{},{data:l,error:c}=await O.from("ministries").update({party_id:i,minister_first_name:p,minister_last_name:d,minister_age:s,minister_approval:50,stat_baselines:m,is_active:!0}).eq("nation_id",e).eq("ministry_key",a).select("id");if(c)console.error(`[Coalition] FAILED to update ministry ${a}:`,c.message);else if(!l||l.length===0){const{error:f}=await O.from("ministries").insert({nation_id:e,ministry_key:a,ministry_name:pa[a]||a,party_id:i,minister_first_name:p,minister_last_name:d,minister_age:s,minister_approval:50,stat_baselines:m,is_active:!0});f?console.error(`[Coalition] FAILED to insert ministry ${a}:`,f.message):t++}else t++}console.log(`[Coalition] Updated ${t} ministries for nation ${e}`)}async function ki(){if(!wt){vt=[];return}const{data:e}=await O.from("government_formations").select("*").eq("election_id",wt).eq("status","active").order("created_at",{ascending:!0}),t=[];for(const a of e||[]){const{data:i}=await O.from("government_formation_support").select("faction_id, supports").eq("formation_id",a.id),r=a.party_ids||[],o=(i||[]).filter(l=>r.includes(l.faction_id)).filter(l=>l.supports).length,p=r.length,s=(i||[]).find(l=>l.faction_id===F.faction?.id)?.supports===!0,m=r.includes(F.faction?.id);t.push({...a,supportCount:o,coalitionSize:p,iAmSupporting:s,iAmInvited:m})}vt=t}let Pe=!1;function Ei(e){Pe||(Pe=!0,e.addEventListener("click",async t=>{const a=t.target.closest(".cf-party-check:not(.disabled)");if(a){const r=a.dataset.partyId,o=q.find(s=>s.id===r)?.bloc_id||null,p=!pt.includes(r),d=o?q.filter(s=>s.bloc_id===o).map(s=>s.id):[r];for(const s of d){const m=pt.indexOf(s);p&&m===-1&&pt.push(s),!p&&m>-1&&pt.splice(m,1);const l=e.querySelector(`.cf-party-check[data-party-id="${s}"]`);if(!l)continue;l.classList.toggle("checked",p);const c=l.querySelector(".cf-check-box");c&&(c.textContent=p?"✓":"")}Ci();return}if(t.target.closest("#cf-propose-btn")){await Ii(e);return}const i=t.target.closest(".cf-support-btn, .cf-withdraw-btn");if(i){const r=i.dataset.formationId,n=i.dataset.action;if(n==="configure"){kt=r;const o=vt.find(p=>p.id===r);o&&(Y={...o.ministry_assignments||{}}),await gt(e)}else await Mi(r,n==="support",e);return}if(t.target.closest("#cf-form-gov-btn")){const r=vt.find(n=>n.id===kt);r&&await wi(r,e);return}}),e.addEventListener("change",t=>{const a=t.target.closest(".cf-ministry-select");if(!a)return;const i=a.dataset.ministry,r=a.value||null;Y[i]=r,kt&&O.from("government_formations").update({ministry_assignments:Y}).eq("id",kt).then(({error:o})=>{o&&console.warn("[Coalition] Failed to save assignment:",o.message)});const n=document.getElementById("cf-form-gov-btn");if(n){const o=!!Y.prime_minister;n.disabled=!o,n.style.color=o?"#000":"var(--text-dim)",n.style.background=o?"var(--green)":"var(--bg-body)",n.style.borderColor=o?"var(--green)":"var(--border-main)",n.style.cursor=o?"pointer":"not-allowed"}}))}function Ci(){const e=document.getElementById("cf-preview-seats"),t=document.getElementById("cf-preview-pct"),a=document.getElementById("cf-preview-threshold");if(!e)return;const i=pt.reduce((o,p)=>o+(q.find(d=>d.id===p)?.seats||0),0),r=et?Math.round(i/et*100):0,n=i>=ot;e.textContent=i,e.style.color=n?"var(--green)":"var(--text-bright)",t.textContent=r,a.textContent=n?`✓ Meets ${ot}-seat threshold`:`— needs ${ot} seats`,a.style.color=n?"var(--green)":"var(--text-dim)"}async function Ii(e){if(te)return;const t=F.faction;if((q.find(o=>o.id===t.id)?.seats||0)===0)return;const i=[...new Set(pt)],r=i.reduce((o,p)=>o+(q.find(d=>d.id===p)?.seats||0),0);if(r<ot){alert(`Coalition needs ${ot} seats. Currently: ${r}.`);return}te=!0;const n=document.getElementById("cf-propose-btn");n&&(n.disabled=!0,n.textContent="Submitting...");try{const{data:o}=await O.from("shard").select("current_date").eq("name","Alpha Shard").single(),{data:p,error:d}=await O.from("government_formations").insert({nation_id:F.nation.id,election_id:wt,proposed_by:t.id,party_ids:i,status:"active",game_year:o?.current_date||""}).select().single();if(d){alert("Error: "+d.message);return}const{error:s}=await O.from("government_formation_support").upsert({formation_id:p.id,faction_id:t.id,supports:!0},{onConflict:"formation_id,faction_id"});s&&console.warn("[Coalition] Auto-support insert failed:",s.message),await gt(e)}catch(o){console.error("[Coalition] Create proposal error:",o),alert("Failed to create proposal: "+(o.message||o))}finally{te=!1}}async function Mi(e,t,a){try{const{error:i}=await O.from("government_formation_support").upsert({formation_id:e,faction_id:F.faction?.id,supports:t},{onConflict:"formation_id,faction_id"});i&&console.error("[Coalition] Toggle support error:",i.message),await gt(a)}catch(i){console.error("[Coalition] Toggle support error:",i)}}let Tt=null,ct=[],le=[],de=null;function X(e){if(!e)return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML}function Ae(e){return e>=1e6?(e/1e6).toFixed(2)+"M":e>=1e3?Math.round(e/1e3)+"k":String(e)}function Si(e){return["January","February","March","April","May","June","July","August","September","October","November","December"][e%12]+", "+(2e3+Math.floor(e/12))}function Li(e,t){if((e.election_type||"parliamentary")==="presidential")return{label:"Presidential Election",color:"#5a8aaa"};const i=t?.end_reason||"";return i.includes("no_confidence")||i.includes("vnc")?{label:"Vote of No Confidence",color:"#d44a4a"}:i.includes("snap")||i.includes("dissolved")||i.includes("early")?{label:"Early Elections Called",color:"#c84"}:{label:"General Election",color:"#8b9a6b"}}async function Pi(e,t){Tt=t;const a=document.getElementById("pa-past-elections-root");if(!a)return;a.innerHTML='<div style="padding:40px;text-align:center;color:var(--text-dim);font-family:var(--font-mono);font-size:12px;">Loading election history...</div>';const i=t.nation?.id;if(!i){a.innerHTML='<div style="padding:40px;text-align:center;color:var(--text-dim);font-family:var(--font-mono);font-size:12px;">No nation data.</div>';return}const[r,n,o]=await Promise.all([e.from("elections").select("id, election_tick, election_type, status, results, created_at").eq("nation_id",i).eq("status","completed").order("election_tick",{ascending:!1}),e.from("administrations").select("*").eq("nation_id",i).order("started_at_tick",{ascending:!1}),e.from("factions").select("id, faction_name, abbreviation, party_color, seats").eq("nation_id",i).eq("faction_type","party").is("abandoned_at",null)]);ct=r.data||[],le=n.data||[];const p=o.data||[],d={};for(const s of p)d[s.id]=s;for(const s of ct){const m=s.results?.votes||[];for(const l of m){const c=d[l.party_id];c?(l.color=c.party_color||"#666",l.abbreviation=c.abbreviation||l.party_name?.slice(0,3)?.toUpperCase()||"?"):(l.color="#666",l.abbreviation=l.party_name?.slice(0,3)?.toUpperCase()||"?")}}Ai(a),ta(a)}function Ai(e){e.addEventListener("click",t=>{const a=t.target.closest("[data-election-id]");if(a){const i=a.dataset.electionId;de=de===i?null:i,ta(e)}})}function ta(e,t){if(ct.length===0){e.innerHTML=`<div style="padding:12px 16px;">
        ...
        </div>`;return}const a=Tt.faction?.id,i=Tt.nation?.total_seats||100,r=Math.ceil(i/2)+1,n=ct.map((o,p)=>{const d=de===o.id,s=(o.results?.votes||[]).sort((k,A)=>(A.seats||0)-(k.seats||0)),m=s.slice(0,3),l=o.results?.turnout_pct??0,c=o.results?.total_votes_cast??0,f=o.results?.sector_breakdown?.independent_seats??0,g=Si(o.election_tick),v=le.find(k=>k.started_at_tick>=o.election_tick&&k.started_at_tick<=o.election_tick+5),h=le.find(k=>k.ended_at_tick!=null&&k.ended_at_tick>=o.election_tick-2&&k.ended_at_tick<=o.election_tick+2),x=Li(o,h),b=lt(Tt.nation),y=b?"President":"PM",$=v?.prime_minister||"Unknown",P=v?.pm_party_id&&s.find(k=>k.party_id===v.pm_party_id)?.color||"#888",I=(p<ct.length-1?ct[p+1]:null)?.results?.votes||[];let C=`<div data-election-id="${o.id}" style="
        ...
        ">
            <div class="pe-row-head" style="padding:12px 20px;cursor:pointer;display:flex;align-items:center;justify-content:space-between;gap:10px;">
                <div class="pe-row-head-left" style="display:flex;align-items:center;gap:12px;min-width:0;flex-wrap:wrap;">
                    <div class="pe-date" style="font-family:var(--font-mono);font-size:13px;font-weight:700;color:var(--text-secondary);width:130px;">${g}</div>
                ...
                <div class="pe-row-head-right" style="display:flex;align-items:center;gap:10px;flex-shrink:0;">
                    <div class="pe-leader-meta" style="font-family:var(--font-mono);font-size:10px;color:var(--text-dim);">
                        ${y}: <span style="color:${P};font-weight:700;">${X($)}</span>
                    </div>
                    ...
                    <span class="pe-col-votes" style="width:70px;text-align:right;font-family:var(--font-mono);font-size:12px;color:var(--text-bright);">${Ae(E.votes||0)}</span>
                ...
                </div>`:"");let L="";if(v){const E=v.coalition_parties||[],M=v.total_seats||E.reduce((J,Mt)=>J+(Mt.seats||0),0),N=M>=r,z=N?"Majority Coalition":"Minority Coalition",xe=v.ended_at_tick?v.end_reason||"Ended":"Current Government",W=v.ended_at_tick?"var(--text-dim)":"#5c5",Gt=v.ended_at_tick?Math.abs(v.ended_at_tick-v.started_at_tick)+" ticks":"Ongoing",aa=E.map(J=>{const Mt=s.find(qt=>qt.party_id===J.party_id)?.color||"#666";return`<div style="width:${M>0?(J.seats||0)/M*100:0}%;background:${Mt};height:100%;"></div>`}).join(""),ia=E.map(J=>`<div style="display:flex;align-items:center;gap:4px;">
                    ...
                    <div style="padding:12px 16px;">
                        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;">
                            <div style="display:flex;align-items:center;gap:8px;">
                                ...
                                <span style="font-family:var(--font-mono);font-size:9px;font-weight:700;padding:2px 8px;color:${W};background:${W}0a;border:1px solid ${W}25;">${X(xe.toUpperCase())}</span>
                            </div>
                        ...
                        <div style="display:flex;height:8px;gap:1px;margin-bottom:8px;">${aa}</div>
                ...
                <div style="display:flex;border-bottom:1px solid var(--border-main);">
                    ...
                    <div style="width:260px;padding:12px 20px;display:flex;gap:16px;flex-shrink:0;">
                        ...
                        <div>
                            ...
                            <div style="font-family:var(--font-mono);font-size:13px;font-weight:700;color:var(--text-bright);">${Ae(c)}</div>
                        </div>
                    </div>
                </div>
    ...
    </div>`}let tt=null,ce=!1,Te=!1,pe=!1,Ne=!1,me=!1;function ea(e){document.querySelectorAll(".pa-subtab").forEach(t=>t.classList.toggle("active",t.dataset.panel===e)),document.querySelectorAll(".pa-panel").forEach(t=>t.classList.toggle("active",t.id==="panel-"+e)),sessionStorage.setItem("party_subtab",e),e==="actions"&&!ce&&tt&&(ce=!0,qe(yt,tt)),e==="parties"&&!Te&&tt&&(Te=!0,li(yt,tt,"pa-parties-root")),e==="election"&&!pe&&tt&&(pe=!0,me?gt(document.getElementById("pa-election-root")):Qe(yt,tt).then(()=>{me=!0,gt(document.getElementById("pa-election-root"))})),e==="past-elections"&&!Ne&&tt&&(Ne=!0,Pi(yt,tt))}document.getElementById("pa-subtabs").addEventListener("click",e=>{const t=e.target.closest(".pa-subtab");!t||t.classList.contains("active")||ea(t.dataset.panel)});sa("politics",async e=>{tt=e,Qe(yt,e).then(({needed:a})=>{if(me=!0,a){const i=document.querySelector('.pa-subtab[data-panel="election"]');i&&!i.querySelector(".pa-subtab-badge")&&(i.innerHTML+='<span class="pa-subtab-badge"></span>');const r=document.querySelector('.nav-tab[data-tab="politics"]');r&&!r.querySelector(".pa-subtab-badge")&&(r.innerHTML+='<span class="pa-subtab-badge"></span>')}pe&&gt(document.getElementById("pa-election-root"))});const t=sessionStorage.getItem("party_subtab");t&&t!=="actions"?ea(t):(ce=!0,await qe(yt,e))});
