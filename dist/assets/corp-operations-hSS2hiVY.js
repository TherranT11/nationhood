import{_}from"./supabase-client-BXEzLDpS.js";import{e as b}from"./utils-C2W-HleY.js";import{initMessaging as dn}from"./messaging-B5Fng3EZ.js";import{c as cn,a as Wt,E as Ze,b as mt,d as Ii,e as pn,f as fn,h as hi}from"./equipment-DsuDdEne.js";const Mi={LOW:"#c84",STD:"#ca5",HIGH:"#5c5"},ge=[{key:"concrete",name:"Concrete",category:"RAW",tiers:{LOW:{requirements:[]},STD:{requirements:[{stat:"manufacturing_output",min:20}]},HIGH:{requirements:[{stat:"manufacturing_output",min:50},{stat:"higher_education",min:40}]}},priceDrivers:["manufacturing_output","inflation","fuel_prices","urbanization"]},{key:"steel",name:"Steel",category:"RAW",tiers:{LOW:{requirements:[{stat:"manufacturing_output",min:10}]},STD:{requirements:[{stat:"manufacturing_output",min:35},{stat:"rare_minerals",min:20}]},HIGH:{requirements:[{stat:"manufacturing_output",min:60},{stat:"rare_minerals",min:40},{stat:"higher_education",min:45}]}},priceDrivers:["manufacturing_output","rare_minerals","inflation","fuel_prices"]},{key:"lumber",name:"Lumber",category:"RAW",tiers:{LOW:{requirements:[{stat:"arable_land",min:10}]},STD:{requirements:[{stat:"arable_land",min:30},{stat:"physical_infrastructure",min:20}]},HIGH:{requirements:[{stat:"arable_land",min:50},{stat:"manufacturing_output",min:30}]}},priceDrivers:["arable_land","physical_infrastructure","inflation"]},{key:"aggregate",name:"Aggregate",category:"RAW",tiers:{LOW:{requirements:[]},STD:{requirements:[{stat:"rare_minerals",min:15},{stat:"physical_infrastructure",min:20}]},HIGH:{requirements:[{stat:"rare_minerals",min:35},{stat:"manufacturing_output",min:25}]}},priceDrivers:["rare_minerals","physical_infrastructure","inflation"]},{key:"em",name:"E&M Systems",category:"MANUFACTURED",tiers:{LOW:{requirements:[{stat:"manufacturing_output",min:15}]},STD:{requirements:[{stat:"manufacturing_output",min:40},{stat:"digital_infrastructure",min:25}]},HIGH:{requirements:[{stat:"manufacturing_output",min:55},{stat:"digital_infrastructure",min:50},{stat:"energy_generation",min:40}]}},priceDrivers:["manufacturing_output","digital_infrastructure","inflation","energy_generation"]},{key:"glass",name:"Glass & Facades",category:"MANUFACTURED",tiers:{LOW:{requirements:[{stat:"manufacturing_output",min:20}]},STD:{requirements:[{stat:"manufacturing_output",min:40},{stat:"standard_of_living",min:35}]},HIGH:{requirements:[{stat:"manufacturing_output",min:60},{stat:"digital_infrastructure",min:40},{stat:"higher_education",min:50}]}},priceDrivers:["manufacturing_output","standard_of_living","inflation"]},{key:"asphalt",name:"Asphalt",category:"RAW",tiers:{LOW:{requirements:[{stat:"oil_and_gas",min:10}]},STD:{requirements:[{stat:"oil_and_gas",min:30},{stat:"manufacturing_output",min:25}]},HIGH:{requirements:[{stat:"oil_and_gas",min:45},{stat:"manufacturing_output",min:40},{stat:"physical_infrastructure",min:40}]}},priceDrivers:["oil_and_gas","manufacturing_output","inflation","fuel_prices"]},{key:"heavy",name:"Heavy Machinery Parts",category:"MANUFACTURED",tiers:{LOW:{requirements:[{stat:"manufacturing_output",min:40},{stat:"rare_minerals",min:30}]},STD:{requirements:[{stat:"manufacturing_output",min:60},{stat:"rare_minerals",min:45},{stat:"higher_education",min:40}]},HIGH:{requirements:[{stat:"manufacturing_output",min:75},{stat:"rare_minerals",min:60},{stat:"higher_education",min:55},{stat:"digital_infrastructure",min:45}]}},priceDrivers:["manufacturing_output","rare_minerals","higher_education","digital_infrastructure"]}];function ze(i,e,t){const n=ge.find(s=>s.key===i);if(!n)return{available:!1,failedStat:"unknown_material"};const o=n.tiers[e];if(!o)return{available:!1,failedStat:"unknown_tier"};for(const s of o.requirements){const a=Number(t?.[s.stat]??0);if(a<s.min)return{available:!1,failedStat:s.stat,failedMin:s.min,nationValue:a}}return{available:!0}}function ti(i,e,t){const o={concrete:{LOW:200,STD:300,HIGH:500},steel:{LOW:400,STD:700,HIGH:1200},lumber:{LOW:80,STD:130,HIGH:200},aggregate:{LOW:40,STD:60,HIGH:100},em:{LOW:400,STD:700,HIGH:1200},glass:{LOW:300,STD:500,HIGH:900},asphalt:{LOW:120,STD:200,HIGH:350},heavy:{LOW:800,STD:1400,HIGH:2400}}[i]?.[e];if(!o)return 0;const s=ge.find(l=>l.key===i);if(!s)return o;let a=1;for(const l of s.priceDrivers){const d=Number(t?.[l]??50);l==="inflation"||l==="fuel_prices"?a*=1+(d-50)/200:a*=1-(d-50)/250}return a=Math.max(.4,Math.min(2.5,a)),Math.round(o*a)}function Ai(i,e,t){const o={concrete:{LOW:5e3,STD:3e3,HIGH:1e3},steel:{LOW:2e3,STD:1500,HIGH:500},lumber:{LOW:8e3,STD:4e3,HIGH:1500},aggregate:{LOW:15e3,STD:6e3,HIGH:2e3},em:{LOW:1e3,STD:700,HIGH:300},glass:{LOW:1500,STD:800,HIGH:300},asphalt:{LOW:4e3,STD:2e3,HIGH:800},heavy:{LOW:400,STD:200,HIGH:80}}[i]?.[e]||0,a=ge.find(r=>r.key===i)?.priceDrivers?.[0],d=.3+(a?Number(t?.[a]??50):50)/50*.7;return Math.round(o*d)}const ii=["LOW","STD","HIGH"],Ft={LOW:"Low",STD:"Standard",HIGH:"High"};let Je=[],m=null,E=null,H=null,He=[],Ye={},se=[],Y={},Vt=-1,U="concrete",G="STD",re=500,Z=[],dt={},Yt=0,te="trucks",fe=0,me=1,we=[],qe=null,ct=[],Qt=null,st=null,Kt="ALL",Jt="TIMELINE";function R(i){return Math.abs(i)>=1e6?"$"+(i/1e6).toFixed(1)+"M":Math.abs(i)>=1e3?"$"+(i/1e3).toFixed(0)+"k":"$"+i}function mn(i){if(i>=12){const e=Math.floor(i/12),t=i%12;return t>0?e+"y "+t+"mo":e+"y"}return i+" ticks"}function zi(i){return!i||i.length===0?"":i.map(e=>{const t=dt[e];if(!t)return"";const n=t.reputation_bonus>0?"var(--green)":t.reputation_bonus<0?"var(--red)":"var(--text-dim)",o=t.reputation_bonus>0?"+"+t.reputation_bonus:t.reputation_bonus<0?String(t.reputation_bonus):"";return`<span style="display:inline-flex;align-items:center;gap:3px;padding:2px 6px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:3px;font-family:var(--font-mono);font-size:7px;color:var(--text-secondary);">${t.icon||"📍"} ${b(t.name)}${o?` <span style="color:${n};font-weight:700;">${o} REP</span>`:""}</span>`}).filter(Boolean).join(" ")}function ie(i){return Math.abs(i)>=1e9?"$"+(i/1e9).toFixed(1)+"B":Math.abs(i)>=1e6?"$"+(i/1e6).toFixed(0)+"M":Math.abs(i)>=1e3?"$"+(i/1e3).toFixed(0)+"k":"$"+i}function ni(i){return i==="civil_engineering"?"CIVIL":i==="industrial"?"INDUSTRIAL":i==="mega_project"?"MEGA":i?.toUpperCase()||"—"}function qi(i){return i==="civil_engineering"?"light":i==="industrial"?"heavy":i==="mega_project"?"mega":"light"}function un(){st&&clearInterval(st),st=setInterval(()=>{if(!Qt)return;const i=Qt-Date.now();if(i<=0){document.getElementById("tick-countdown").textContent="Tick due...",clearInterval(st);return}const e=Math.floor(i/36e5),t=Math.floor(i%36e5/6e4),n=Math.floor(i%6e4/1e3);document.getElementById("tick-countdown").textContent=e+"h "+t+"m "+n+"s"},1e3)}function yn(){document.body.classList.toggle("light-mode");const i=document.getElementById("theme-toggle");i.textContent=document.body.classList.contains("light-mode")?"Dark":"Light"}function gn(i,e){i==="type"&&(Kt=e),i==="sort"&&(Jt=e),document.querySelectorAll(`.filter-pill[data-filter="${i}"]`).forEach(t=>{t.classList.toggle("active",t.dataset.value===e)}),Li()}const wi={"Civil Engineering":"civil_engineering","Industrial Construction":"industrial",Megaprojects:"mega_project"};function Ni(i){if(!m)return!1;if(wi[m.corp_subsector]===i.sector)return!0;const t=(W||[]).filter(n=>n.type==="regional_hq"&&n.is_active&&n.nation_id===i.nation_id);for(const n of t)if(wi[n.subsector]===i.sector)return!0;return!1}function Li(){const i=document.getElementById("oc-list");let e=[...He];if(Kt==="GOVERNMENT"?e=e.filter(o=>o.issuer_type==="GOVERNMENT"):Kt==="PRIVATE"&&(e=e.filter(o=>o.issuer_type==="PRIVATE")),Jt==="TIMELINE"&&e.sort((o,s)=>(o.timeline_ticks||0)-(s.timeline_ticks||0)),Jt==="BUDGET"&&e.sort((o,s)=>(s.budget_ceiling||0)-(o.budget_ceiling||0)),document.getElementById("oc-count").textContent=e.length+" AVAILABLE",e.length===0){i.innerHTML=`
            ...
            <div class="oc-item${d}" data-contract-id="${o.id}">
                ...
                <div class="oc-item__stats">
                    <div class="oc-stat">
                        ...
                        <div class="oc-stat__value">${ie(o.budget_ceiling||0)}</div>
                    </div>
                    <div class="oc-stat">
                    ...
                    <div class="oc-eligibility">
                        ${Ye[o.id]?`<span class="oc-eligible-badge yes" style="background:var(--green-faint);border-color:var(--green-border);color:var(--green);">BID: ${ie(Ye[o.id].bid_price)}</span>`:`<span class="oc-eligible-badge ${l?"yes":"no"}">${l?"ELIGIBLE":"LOCKED"}</span>`}
                    </div>
    ...
    `;const a=document.getElementById("cd-blueprint");i.blueprint_svg?(a.innerHTML=i.blueprint_svg,a.style.display=""):(a.innerHTML=zn(i),a.style.display="");const l=i.permits_required||[],d=i.required_equipment||i.equipment_required||[],r=i.required_materials||i.materials_estimated||{},p={civil_engineering:"Civil Engineering",industrial:"Industrial Construction",mega_project:"Megaprojects"}[i.sector]||i.spec_category||i.sector||"—";let f="var(--teal)";i.sector==="industrial"&&(f="var(--orange)"),i.sector==="mega_project"&&(f="var(--red)");let u=R(i.budget_ceiling||i.budget||0),y=(i.timeline_ticks||i.timeline_months||0)+" Months",g="";g+=`
        <div class="cd-issue">
            ...
            </div>`}g+="</div></div>"}g+='<div class="cd-details">',i.project_type&&(g+=he("Type",i.project_type)),i.project_subtype&&(g+=he("Sub-Type",i.project_subtype)),g+=he("Specialization",p,f),g+=he("Total Budget",u,"var(--green)"),g+=he("Timeline",y),g+=he("Nation",E?.name||m.nation||"—"),i.region&&(g+=he("Region",i.region)),g+="</div>",l.length>0&&(g+=`
            <div class="cd-items">
            ...
            </div>`),document.getElementById("cd-content").innerHTML=g;const w=l.filter(B=>B.status==="approved").length,h=l.length-w,A=d.filter(B=>B.owned).length,C=d.length-A;let k="";d.length>0&&(C===0?k+='<span class="cd-footer__badge ok">ALL EQUIPMENT MET</span>':k+=`<span class="cd-footer__badge bad">${C} EQUIPMENT MISSING</span>`),l.length>0&&(h===0?k+='<span class="cd-footer__badge ok">ALL PERMITS APPROVED</span>':k+=`<span class="cd-footer__badge warn">${h} PERMITS PENDING</span>`);const x=s,T=i.issuer_faction_id===m?.id,M=i.status==="bidding",N=Ye[i.id];document.getElementById("cd-footer").innerHTML=`
        <div class="cd-footer__badges">${k}</div>
    ...
    `;let f='<div class="pm-phase__bar">';for(let $=0;$<Te.length;$++){const w=$<i.phaseIdx,h=$===i.phaseIdx;f+=`<div class="pm-phase__seg">
            <div class="pm-phase__seg-fill pm-phase__seg-fill--${w?"done":h?"active":"future"}"></div>
            <span class="pm-phase__seg-label pm-phase__seg-label--${w?"done":h?"active":""}">${Te[$]}</span>
    ...
    `}function Cn(i,e,t,n,o,s,a){const l=Ce(i.awardedTick+i.totalTicks);Ce(i.awardedTick+i.totalTicks);const d=Ce(i.awardedTick),r=[{label:"Budget",value:ie(i.budget),sub:`${n}% spent`,color:t},{label:"Spent",value:ie(i.spent),color:"var(--red)"},{label:"Remaining",value:ie(o),color:"var(--green)"},{label:"Quality",value:`${i.quality}/100`,sub:i.qualityLabel,color:i.quality>=70?"var(--green)":i.quality>=50?"var(--amber)":"var(--red)"},{label:"Workforce",value:`${i.laborCount}/${i.wfNeeded}`,sub:`Bid: ${i.laborCount}`,color:i.laborCount<i.wfNeeded?"var(--orange)":"var(--text-bright)"},{label:"Remaining",value:`${s} ticks`,sub:a?"OVERDUE":`Deadline: ${l}`,color:a?"var(--red)":"var(--text-bright)"}];let c="";c+=`<div style="padding:0 16px"><div class="pm-section">
        ...
        <div class="pm-manager">
            ...
            <span class="pm-evt__status" style="color:${s?"var(--red)":"var(--text-dim)"};font-weight:${s?"700":"400"}">${s?"REQUIRES RESPONSE":"RESOLVED"}</span>
                    ...
                    </div>`,e+=`<div class="pm-resp__detail">${b(r.detail)}</div>`,e+='<div class="pm-resp__costs">',r.cost&&(e+=`<span class="pm-resp__cost" style="color:var(--red)">Cost: ${ie(r.cost)}</span>`),r.qualityImpact&&r.qualityImpact!==0&&(e+=`<span class="pm-resp__cost" style="color:${r.qualityImpact>0?"var(--green)":"var(--red)"}">Quality: ${r.qualityImpact>0?"+":""}${r.qualityImpact}</span>`),!r.cost&&(!r.qualityImpact||r.qualityImpact===0)&&(e+='<span class="pm-resp__cost" style="color:var(--green)">No additional cost</span>'),e+="</div>",c&&(e+=`<div class="pm-resp__confirm">
        ...
        <g transform="translate(470,172)">
            ...
            <div class="ap-budget">
                <div class="ap-budget__header">
                    ...
                    <span class="ap-budget__values" style="color:${k?"var(--red)":x?"var(--orange)":"var(--teal)"}">
                        ${w}/${h} ticks ${k?'<span style="color:var(--red);font-weight:700;"> OVERDUE</span>':""}
                    </span>
                </div>
            ...
            <div class="ap-details">
                <div class="ap-detail-cell" style="flex:1">
                    ...
                    <div class="ap-detail-cell__value" style="font-size:10px;font-weight:700;color:var(--gold)">${ie(c)}</div>
                </div>
                <div class="ap-detail-cell" style="flex:1">
                    <div class="ap-detail-cell__label">EST. COST</div>
                    <div class="ap-detail-cell__value" style="font-size:10px;font-weight:700;color:var(--red)">${ie(p)}</div>
                </div>
                ...
                <div class="ap-detail-cell" style="flex:1">
                    ...
                    <div class="ap-detail-cell__value" style="font-size:10px;font-weight:700;color:${k?"var(--red)":"var(--text-bright)"}">${A} ticks</div>
                </div>
            </div>
        </div>`}i.innerHTML=s,e.style.display=se.length>0?"":"none",se.length>0&&(document.getElementById("ap-total-crew").textContent=se.length,document.getElementById("ap-total-budget").textContent=ie(n),document.getElementById("ap-total-spent").textContent=ie(o))}async function Pi(){if(!m)return;const{data:i,error:e}=await _.from("construction_contracts").select("*, contract_bids!inner(bid_price, material_grades, labor_count, estimated_cost, estimated_quality)").eq("awarded_to_faction",m.id).in("status",["awarded","in_progress"]).eq("contract_bids.faction_id",m.id).order("awarded_at_tick",{ascending:!0});e?(console.warn("Failed to load active projects:",e.message),se=[]):se=i||[],qn()}const ut=3e4;function yt(){let i=0,e=0;for(const t of ge)for(const n of ii){const o=Y[t.key]?.[n];o&&(i+=o.qty,e+=o.value)}return{totalUnits:i,totalValue:e}}function oi(){const i=document.getElementById("wh-list"),{totalUnits:e,totalValue:t}=yt();document.getElementById("wh-count").textContent=e.toLocaleString()+" UNITS",document.getElementById("wh-total-value").textContent=R(t);const n=Math.round(e/ut*100),o=document.getElementById("wh-capacity");o.textContent=n+"%",o.style.color=n>80?"var(--red)":n>50?"var(--orange)":"var(--green)";let s="";for(let a=0;a<ge.length;a++){const l=ge[a],d=Vt===a,r=Y[l.key]?.LOW||{qty:0,value:0},c=Y[l.key]?.STD||{qty:0,value:0},p=Y[l.key]?.HIGH||{qty:0,value:0},f=r.qty+c.qty+p.qty,u=r.value+c.value+p.value,y=f===0,g=ze(l.key,"LOW",E),$=ze(l.key,"STD",E),w=ze(l.key,"HIGH",E),h=r.qty>0?"wh-dot wh-dot--low":"wh-dot wh-dot--empty",A=c.qty>0?"wh-dot wh-dot--std":"wh-dot wh-dot--empty",C=w.available?p.qty>0?"wh-dot wh-dot--high":"wh-dot wh-dot--empty":"wh-dot wh-dot--locked";if(s+='<div class="wh-row">',s+=`<div class="wh-row__collapsed${d?" expanded":""}" onclick="toggleWhRow(${a})">
            ...
            </div>`;const k=[{key:"LOW",label:"Low",data:r,avail:g,color:"var(--orange)",dotClass:"wh-dot--low"},{key:"STD",label:"Standard",data:c,avail:$,color:"var(--amber)",dotClass:"wh-dot--std"},{key:"HIGH",label:"High",data:p,avail:w,color:"var(--green)",dotClass:"wh-dot--high"}];for(const x of k){const T=!x.avail.available,M=x.data.qty>0,N=M?"$"+Math.round(x.data.value/x.data.qty):"—";s+=`<div class="wh-grade${T?" unavailable":""}">
        ...
        </div>`}i.innerHTML=e}function gt(){const i=document.getElementById("pr-content"),e=ze(U,G,E),t=ge.find(k=>k.key===U);if(!t)return;if(!e.available){i.innerHTML=`<div class="pr-locked-panel">
        ...
        <div class="pr-drivers__title">Price Drivers (${b(E?.name||"—")})</div>`;for(const k of t.priceDrivers){const x=Number(E?.[k]??50),T=x>=50?"var(--green)":x>=30?"var(--amber)":x>=15?"var(--orange)":"var(--red)",M=Ln[k]||k;f+=`<div class="pr-driver-row">
        ...
        </div>`}f+="</div>";const y=(Number(m?.corp_cash_reserves)||0)>=s,g=re>o,{totalUnits:$}=yt(),w=ut-$,h=re>w,A=w<=0,C=Mi[G];f+=`<div class="pr-order">
        ...
        <div class="pr-order__box">
            ...
            <div class="pr-qty-row">
                ...
                <div class="pr-qty-btns">
                    ${[100,250,500,1e3].map(k=>`<span class="pr-qty-btn${re===k?" active":""}" onclick="setPrQty(${k})">${k>=1e3?k/1e3+"k":k}</span>`).join("")}
                </div>
            </div>
    ...
    </div>`,i.innerHTML=f}function Bn(i){U=i,G="STD";for(const e of["STD","HIGH","LOW"])if(ze(i,e,E).available){G=e;break}Di(),si(),gt()}function Rn(i){G=i,si(),gt()}function Pn(i){re=i,gt()}let zt=!1;async function On(){if(zt||!m||!E)return;const i=ti(U,G,E),e=Ai(U,G,E),t=i*re,n=Number(m.corp_cash_reserves)||0;if(t>n){alert("Insufficient cash reserves.");return}if(re>e){alert("Exceeds available supply this tick.");return}const{totalUnits:o}=yt(),s=ut-o;if(s<=0){alert("Warehouse is full. Cannot purchase more materials.");return}if(re>s){alert(`Warehouse can only hold ${s.toLocaleString()} more units. Reduce quantity.`);return}zt=!0;const a=document.querySelector(".pr-purchase-btn");a&&(a.disabled=!0,a.textContent="...");try{const l=n-t,{error:d}=await _.from("factions").update({corp_cash_reserves:l}).eq("id",m.id);if(d)throw d;const r=Y[U]?.[G],c=(r?.qty||0)+re,p=(r?.value||0)+t,{error:f}=await _.from("corp_warehouse").upsert({faction_id:m.id,nation_id:m.nation_id,material_key:U,quality_tier:G,quantity:c,total_value:p,last_purchased_tick:H?.current_tick||null,updated_at:new Date().toISOString()},{onConflict:"faction_id,material_key,quality_tier"});if(f){const{error:u}=await _.from("factions").update({corp_cash_reserves:n}).eq("id",m.id);throw u&&console.error("Cash refund failed after warehouse error:",u.message),f}m.corp_cash_reserves=l,Y[U]||(Y[U]={}),Y[U][G]={qty:c,value:p},oi(),Oi(),a&&(a.textContent="PURCHASED",setTimeout(()=>{a.isConnected&&(a.disabled=!1,a.textContent="PURCHASE")},1500))}catch(l){a&&(a.disabled=!1,a.textContent="PURCHASE"),alert("Purchase failed: "+(l.message||"Unknown error"))}finally{zt=!1}}function ji(i){const e=qe||E;if(!e)return[];const t=mt(i);if(!t)return[];const n=pn(i,e),o=[],s=Number(e?.inflation??50),a=Number(e?.fuel_prices??50);Number(e?.manufacturing_output??50);const l=qe&&E&&qe.id!==E.id;let d=null;if(l&&(d=fn(e,E)),n.newAvailable>0){const r=hi(i,e),c=t.basePrice,p=Math.round(c*((s-50)/200)),f=Math.round(c*((a-50)/300));let u=r;const y=[{label:"Base price",value:R(c)},p!==0?{label:`Inflation (${s})`,mod:(p>=0?"+":"")+R(Math.abs(p))}:null,f!==0?{label:`Fuel transport (${a})`,mod:(f>=0?"+":"")+R(Math.abs(f))}:null].filter(Boolean),g=r-c-p-f;if(g!==0&&!l&&y.push({label:"Demand/scarcity",mod:(g>=0?"+":"")+R(Math.abs(g))}),l&&d){const $=Math.round(r*d.tariff),w=Math.round(r*d.transport);u=r+$+w,y.push({label:`Import tariff (${Math.round(d.tariff*100)}%)`,mod:"+"+R($)}),y.push({label:`Transport (${d.deliveryTicks} tick${d.deliveryTicks>1?"s":""})`,mod:"+"+R(w)})}o.push({seller:l?`${e.name} Buyers`:"Local Buyers",sellerType:"LOCAL",nation:e.name||"—",distance:l?d?.deliveryTicks||1:0,condition:100,price:Math.round(u),available:n.newAvailable,delivery:l?d.deliveryTicks+" tick"+(d.deliveryTicks>1?"s":""):"Immediate",deliveryTicks:l?d.deliveryTicks:0,used:!1,priceFactors:y,sourceNationId:e.id})}if(n.usedAvailable>0){const r=n.usedCondition,c=hi(i,e,{used:!0,condition:r});let p=c;const f=[{label:"Base price",value:R(t.basePrice)},{label:`Condition (${r}%)`,mod:"-"+R(Math.max(0,t.basePrice-c))}];if(l&&d){const u=Math.round(c*d.tariff),y=Math.round(c*d.transport);p=c+u+y,f.push({label:`Import tariff (${Math.round(d.tariff*100)}%)`,mod:"+"+R(u)}),f.push({label:`Transport (${d.deliveryTicks} tick${d.deliveryTicks>1?"s":""})`,mod:"+"+R(y)})}o.push({seller:l?`${e.name} Buyers`:"Local Buyers",sellerType:"LOCAL",nation:e.name||"—",distance:l?d?.deliveryTicks||1:0,condition:r,price:Math.round(p),available:n.usedAvailable,delivery:l?d.deliveryTicks+" tick"+(d.deliveryTicks>1?"s":""):"Immediate",deliveryTicks:l?d.deliveryTicks:0,used:!0,priceFactors:f,sourceNationId:e.id})}return o}function vt(){const i=Number(m?.corp_cash_reserves)||0;document.getElementById("em-cash").textContent=R(i);const e=mt(te),t=Ze[e?.tier||1],n=document.getElementById("em-tier-badge");n&&(n.textContent=t.tag,n.style.color=t.color),n.style.background=t.color+"0a",n.style.border="1px solid "+t.color+"33";const o=document.getElementById("em-nation-select");if(o&&o.options.length===0){const l=E?.name||m?.nation||"—";let d=`<option value="">${b(l)} (HQ)</option>`;for(const r of ct)r.id!==E?.id&&(d+=`<option value="${r.id}">${b(r.name)}</option>`);o.innerHTML=d}const s=document.getElementById("em-import-tag"),a=qe&&E&&qe.id!==E.id;s&&(s.style.display=a?"":"none"),Dn(),ri()}function Dn(){let i="";for(let e=1;e<=3;e++){const t=Ze[e],n=Wt(e),o=e===3?"em-selector__grid em-selector__grid--t3":"em-selector__grid em-selector__grid--t12";i+=`<div class="em-selector__row">
            <div class="em-selector__tier-label" style="color:${t.color}">${t.tag}</div>
            <div class="${o}">`;for(const s of n){const a=te===s.key,l=ji(s.key).length>0;i+=`<span class="em-selector__btn${a?" active":""}${l?"":" no-listings"}"
                style="${a?"background:"+t.color+";border-color:"+t.color:""}"
                onclick="setEmType('${s.key}')">${b(s.name)}</span>`}i+="</div></div>"}document.getElementById("em-selector").innerHTML=`<div class="em-selector">${i}</div>`}function ri(){const i=document.getElementById("em-content");if(we=ji(te),we.length===0){i.innerHTML=`<div class="em-no-listings"><div class="em-no-listings__box">
            ...
            </div>`),e+="</div>"}const t=we[fe];if(t){const n=mt(te),o=Ze[n?.tier||1],s=Math.min(t.available,4),a=t.price*me,l=(Number(m?.corp_cash_reserves)||0)>=a;e+=`<div class="em-purchase"><div class="em-purchase__box">
        ...
        </div></div>`}i.innerHTML=e}async function jn(i){if(!i)qe=null;else{let t=ct.find(n=>n.id===i);if(!t)try{const{data:n}=await _.from("nations").select("*").eq("id",i).single();t=n}catch{}qe=t||null}fe=0,me=1;const e=document.getElementById("em-nation-select");e&&(e.value=i||""),vt()}function Hn(i){te=i,fe=0,me=1,vt()}function Un(i){fe=i,me=1,ri()}function Gn(i){me=i,ri()}let qt=!1;async function Wn(){if(qt)return;const i=we[fe];if(!i||!m)return;const e=mt(te);if(!e)return;const t=me,n=i.price*t,o=Number(m.corp_cash_reserves)||0;if(n>o){alert("Insufficient cash reserves.");return}if(t>i.available){alert("Not enough units available.");return}const s=document.querySelector(".em-purchase-btn");s&&(s.disabled=!0,s.textContent="..."),qt=!0;try{const a=o-n,{error:l}=await _.from("factions").update({corp_cash_reserves:a}).eq("id",m.id);if(l)throw l;const d=!i.deliveryTicks||i.deliveryTicks===0;if(d){const c=Z.find(A=>A.equipment_key===te),p=(c?.owned||0)+t,f=c?.purchase_price_avg||0,u=c?.owned||0,y=u>0?Math.round((f*u+i.price*t)/p):i.price,g=e.maintenancePerUnit*p,$=c?.condition||100,w=Math.round(($*u+i.condition*t)/p),{error:h}=await _.from("corp_equipment").upsert({faction_id:m.id,nation_id:m.nation_id,equipment_key:te,tier:e.tier,owned:p,deployed:c?.deployed||0,condition:w,maintenance_per_tick:g,purchase_price_avg:y,last_purchased_tick:H?.current_tick||null,updated_at:new Date().toISOString()},{onConflict:"faction_id,equipment_key"});if(h){const{error:A}=await _.from("factions").update({corp_cash_reserves:o}).eq("id",m.id);throw A&&console.error("Cash refund failed:",A.message),h}c?(c.owned=p,c.condition=w,c.maintenance_per_tick=g):Z.push({equipment_key:te,tier:e.tier,owned:p,deployed:0,condition:w,maintenance_per_tick:g,assigned_projects:[]})}else{const c=(H?.current_tick||0)+i.deliveryTicks,{error:p}=await _.from("corp_equipment_deliveries").insert({faction_id:m.id,equipment_key:te,quantity:t,condition:i.condition,delivery_tick:c,source_nation_id:i.sourceNationId||null,seller_name:i.seller,price_paid:n});if(p){const{error:f}=await _.from("factions").update({corp_cash_reserves:o}).eq("id",m.id);throw f&&console.error("Cash refund failed:",f.message),p}}m.corp_cash_reserves=a,li(),vt();const r=document.getElementById("pr-cash");r&&(r.textContent=R(a)),s&&(s.textContent=d?"PURCHASED":"ORDERED",setTimeout(()=>{s.isConnected&&(s.disabled=!1,s.textContent="PURCHASE")},1500))}catch(a){s&&(s.disabled=!1,s.textContent="PURCHASE"),alert("Purchase failed: "+(a.message||"Unknown error"))}finally{qt=!1}}let Fn=-1,Ue=[],pt=[],Xt=[];function Nt(i){return Math.abs(i)>=1e6?"$"+(i/1e6).toFixed(1)+"M":Math.abs(i)>=1e3?"$"+(i/1e3).toFixed(0)+"k":"$"+i.toLocaleString()}function Vn(i,e,t){if(t)return"var(--orange)";const n=i/(e||1)*100;return n>50?"var(--green)":n>25?"var(--amber)":"var(--red)"}function Ti(){const i=document.getElementById("pm-list"),e=Ue.length,t=pt.length,n=Xt.length,o=Ue.filter(d=>d.expiring_soon).length;document.getElementById("pm-active-count").textContent=`(${e})`,document.getElementById("pm-pending-count").textContent=`(${t})`,document.getElementById("pm-apply-count").textContent=`(${n})`;const s=document.getElementById("pm-badges");let a="";o>0&&(a+=`<span class="pm-badge pm-badge--expiring">${o} EXPIRING</span>`),t>0&&(a+=`<span class="pm-badge pm-badge--pending">${t} PENDING</span>`),s.innerHTML=a;const l=Ue.reduce((d,r)=>d+(r.cost||0),0)+pt.reduce((d,r)=>d+(r.cost||0),0);document.getElementById("pm-total-cost").textContent=Nt(l),document.getElementById("pm-footer-active").textContent=e,document.getElementById("pm-footer-pending").textContent=t;{if(e===0){i.innerHTML=`<div class="pm-empty">
            ...
            <div class="dl-item__inner" style="border-left:2px solid ${g}">
                ...
                </div>`,r){const w=l.inspection||{};a+='<div style="margin-top:8px;">',a+='<div class="dl-section-label">Inspection Report</div>',["materials","structural","systems"].forEach(k=>{const x=w[k]||{score:0,issues:[]},T=Ci(x.score),M=Math.min(x.score/100*100,100);a+=`<div class="dl-inspect-row">
                ...
                ${(h.issues||[]).map(k=>`<div class="dl-inspect-issue dl-inspect-issue--red">${b(k)}</div>`).join("")}
        ...
        </div>`;const o={};for(const l of Z)o[l.equipment_key]=l;let s="";for(let l=1;l<=3;l++){const d=Ze[l],r=Wt(l),c=Yt===l,p=r.reduce((u,y)=>u+(o[y.key]?.owned||0),0),f=r.reduce((u,y)=>u+(o[y.key]?.deployed||0),0);if(s+=`<div class="eq-tier-hdr" onclick="toggleEqTier(${l})">
        ...
        </div>`,c)for(const u of r){const y=o[u.key],g=y?.owned||0,$=y?.deployed||0,w=y?.condition||0,h=u.maintenancePerUnit*g,A=g-$,C=g>0&&A===0,k=g>0&&w<65,x=Ii(w),T=y?.assigned_projects||[],M=T.length>0?T.map(N=>N.contract_name||"Project").join(", ").slice(0,30):g>0&&$>0?$+" project"+($>1?"s":""):"—";s+=`<div class="eq-row${g===0?" unowned":""}">`,s+=`<div class="eq-row__top">
    ...
    <div style="width:380px;height:450px;background:${t.surface};border:1px solid ${t.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        ...
        <div style="padding:8px 14px;border-top:1px solid ${t.border};background:${t.card};flex-shrink:0;">
            <div style="display:flex;justify-content:space-between;align-items:center;${c?"margin-bottom:6px;":""}">
                ...
                <div style="text-align:right;">
                    ...
                    <div style="display:flex;align-items:baseline;gap:4px;justify-content:flex-end;">
                        ...
                        <span style="font-family:${e};font-size:11px;font-weight:700;color:${w>0?t.red:t.greenBright}">${v(g)}</span>`:""}
                    </div>
                </div>
            </div>
            ${c?`<div style="display:flex;justify-content:space-between;align-items:center;padding-top:6px;border-top:1px solid ${t.border};">
                <div style="display:flex;align-items:center;gap:6px;">
                    ...
                    <span style="font-family:${e};font-size:11px;font-weight:700;color:${w>0?t.red:t.greenBright}">${w>0?"+":""}${v(w)}/yr</span>
                    <span style="font-family:${e};font-size:8px;color:${t.dim}">(${w>0?"+":""}${v(Math.round(w/12))}/tick)</span>
                </div>
        ...
        <div style="padding:8px 12px;border-bottom:1px solid ${t.border};">
            ...
            <div style="display:flex;justify-content:space-between;margin-top:1px;">
                ...
                <span style="font-family:${e};font-size:10px;font-weight:700;color:${t.text}">${v(w)}</span>
            </div>
        </div>`}i.innerHTML=`
    <div style="width:380px;height:450px;background:${t.surface};border:1px solid ${t.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        <div style="padding:8px 14px;border-bottom:1px solid ${t.border};display:flex;justify-content:space-between;align-items:center;flex-shrink:0;">
    ...
    <div style="width:380px;height:450px;background:${t.surface};border:1px solid ${t.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        ...
        <div style="padding:8px 14px;border-top:1px solid ${t.border};background:${t.card};flex-shrink:0;">
            <div style="display:flex;gap:6px;justify-content:space-between;">
                ...
                <div onclick="npBuyProperty()" style="flex:1;padding:6px 0;text-align:center;font-family:${e};font-size:9px;font-weight:700;letter-spacing:1px;color:${X!==null?"#000":t.dim};background:${X!==null?t.accent:"transparent"};border:1px solid ${X!==null?t.accent:t.border};cursor:${X!==null?"pointer":"default"};opacity:${X!==null?1:.4}">BUY PROPERTY</div>
            </div>
        </div>
    </div>`}function ro(i){X=X===i?null:i,_t()}let Rt=!1;async function lo(){if(X===null||Rt)return;const i=Ge[X];if(!i)return;const e=Number(m?.corp_cash_reserves??0);if(i.adjusted_cost>e){alert(`Insufficient cash reserves.
...
Regional HQ created with `+d+"% condition.")}catch(a){alert("Failed: "+a.message)}finally{Ot=!1}}}function wt(){const i=document.getElementById("create-subsidiary-container");if(!i)return;const e="'JetBrains Mono', monospace",t={bg:"#121210",surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",accentBright:"#a3b07e",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",yellow:"#ca5",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},n=m?.corp_sector||"General",o=m?.corp_subsector||"",s=Ji(),a=s.find(x=>x.name===Pe)||s[0],l=new Set(W.filter(x=>x.type==="regional_hq").map(x=>x.nation_id)),d=Ke.filter(x=>!l.has(x.id)),r=ne?d.find(x=>x.id===ne):null,c=Re.trim().length>0&&et.trim().length>=2&&r!==null;let p=`
    ...
    </div>`,u="";if(d.length===0)u=`<div style="padding:20px;text-align:center;font-family:${e};font-size:10px;color:${t.dim}">Subsidiaries in all available nations.</div>`;else for(const x of d){const T=x.id===ne,M=Co(x.id),N=Xe[x.id]||0,B=Math.round(Number(x.standard_of_living??50)),z=Zt(x);u+=`
    ...
    </div>`;const w=5e7,h=a.mod,A=r?Zt(r):null,C=r?Xi(r):null;let k=`
    <div style="background:${t.bg};border:1px solid ${t.border};padding:6px 8px;margin-bottom:6px;">
        <div style="display:flex;justify-content:space-between;padding:2px 0;border-bottom:1px solid ${t.border};">
            ...
            <span style="font-family:${e};font-size:9px;color:${t.muted}">${v(w)}</span>
        </div>
        <div style="display:flex;justify-content:space-between;padding:2px 0;border-bottom:1px solid ${t.border};">
    ...
    </div>`}window.subSelectNation=So;window.subCreate=zo;window.subSetName=Mo;window.subSetAbbr=Ao;window.subSetSubsector=Io;let lt=[],Me=0,ae="ALL",ke="REPUTATION";async function qo(){const{data:i}=await _.from("factions").select("id, faction_name, abbreviation, corp_sector, corp_subsector, corp_company_type, corp_ticker, corp_cash_reserves, nation_id, nation, linked_user_id").eq("faction_type","corporation").is("abandoned_at",null).order("faction_name");lt=(i||[]).map(e=>({...e,abbr:e.corp_ticker||e.abbreviation||e.faction_name?.slice(0,4).toUpperCase()||"???",status:(e.corp_company_type||"Private").toUpperCase(),isPlayer:!!e.linked_user_id,reputation:50,revenue:e.status==="PUBLIC"?Number(e.corp_cash_reserves||0)*.1:null,valuation:e.status==="PUBLIC"?Number(e.corp_cash_reserves||0)*3:null}))}function No(i){Me=i,kt()}function Lo(i){ae=i,Me=0,kt()}function Bo(i){ke=i,Me=0,kt()}function kt(){const i=document.getElementById("corporations-container");if(!i)return;const e="'JetBrains Mono', monospace",t={surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",blue:"#5a8aaa",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",yellow:"#ca5",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},n={PUBLIC:{color:t.greenBright,bg:"rgba(92,204,92,0.06)",border:"rgba(92,204,92,0.15)"},PRIVATE:{color:t.gold,bg:"rgba(200,168,50,0.08)",border:"rgba(200,168,50,0.2)"},STATE:{color:t.orange,bg:"rgba(204,136,68,0.06)",border:"rgba(204,136,68,0.15)"}},o=[...new Set(lt.map(f=>f.nation).filter(Boolean))];let s=[...lt];ae!=="ALL"&&(s=s.filter(f=>f.nation===ae)),ke==="REPUTATION"?s.sort((f,u)=>(u.reputation||0)-(f.reputation||0)):ke==="REVENUE"?s.sort((f,u)=>(u.revenue||0)-(f.revenue||0)):ke==="VALUATION"&&s.sort((f,u)=>(u.valuation||0)-(f.valuation||0)),Me>=s.length&&(Me=0);const a=s[Me]||null,l=a&&a.status==="PRIVATE",d=a&&a.status==="STATE";let r="";s.length===0&&(r=`<div style="padding:30px;text-align:center;font-family:${e};font-size:10px;color:${t.dim}">No corporations found.</div>`);for(let f=0;f<s.length;f++){const u=s[f],y=f===Me,g=n[u.status]||n.PRIVATE,$=u.status==="PRIVATE";r+=`
    ...
    <div style="padding:5px 14px;border-bottom:1px solid ${t.border};background:${t.card};display:flex;gap:12px;align-items:center;flex-shrink:0;">
        <div style="display:flex;gap:3px;align-items:center;">
            ...
            <span onclick="corpFilterNation('ALL')" style="padding:2px 7px;font-family:${e};font-size:7px;font-weight:700;cursor:pointer;color:${ae==="ALL"?"#000":t.dim};background:${ae==="ALL"?t.accent:"transparent"};border:1px solid ${ae==="ALL"?t.accent:t.border}">ALL</span>
            ${o.map(f=>`<span onclick="corpFilterNation('${f}')" style="padding:2px 7px;font-family:${e};font-size:7px;font-weight:700;cursor:pointer;color:${ae===f?"#000":t.dim};background:${ae===f?t.accent:"transparent"};border:1px solid ${ae===f?t.accent:t.border}">${f}</span>`).join("")}
        </div>
        <div style="flex:1"></div>
        <div style="display:flex;gap:3px;align-items:center;">
        ...
        <div style="flex:1;display:flex;overflow:hidden;">
            ...
            <div style="flex:1;border-right:1px solid ${e.border};overflow:auto;">
                ...
                <div style="display:flex;justify-content:space-between;padding:5px 14px;border-bottom:1px solid ${e.border};">
                    ...
                    <span style="font-family:${i};font-size:11px;font-weight:700;color:${e.text}">${v(ee)}</span>
                </div>
            </div>
            ...
            <div style="width:280px;display:flex;flex-direction:column;overflow:auto;">
                ...
                ${[{l:"Materials",v:y},{l:"Labor",v:P},{l:"Permits",v:De},{l:"Overhead",v:ee}].map(L=>`<div style="display:flex;justify-content:space-between;padding:4px 14px;border-bottom:1px solid ${e.border};">
...
This action cannot be undone.`)){jt=!0;try{const n=t-e,{error:o}=await _.from("factions").update({corp_cash_reserves:n}).eq("id",m.id);if(o)throw o;const{error:s}=await _.from("contract_bids").delete().eq("contract_id",i).eq("faction_id",m.id);if(s)throw s;m.corp_cash_reserves=n,typeof Qe=="function"&&Qe(n),alert("Bid retracted. $1M penalty applied."),it(),await ve()}catch(n){alert("Failed to retract bid: "+(n.message||"Unknown error"))}finally{jt=!1}}}window.retractBid=Ho;let tt=[],Ae=0,oe=null,Ht=!1,Ut=!1,Gt=!1;async function Uo(){if(!Ne||Ut)return;Ut=!0,oe=Ne,Ae=0;const{data:i,error:e}=await _.from("contract_bids").select("*, factions(faction_name, corp_ticker, corp_subsector)").eq("contract_id",oe.id).in("status",["pending","won"]).order("bid_price",{ascending:!0});if(Ut=!1,e){alert("Failed to load bids: "+e.message);return}tt=(i||[]).map(t=>({...t,corp:t.factions?.faction_name||"Unknown",abbr:t.factions?.corp_ticker||"???",subsector:t.factions?.corp_subsector||"—"})),it(),Zi()}function Tt(){document.getElementById("bid-review-overlay")?.remove(),oe=null}function Go(i){Ae=i,Zi()}async function Wo(){if(Ht||tt.length===0)return;const i=tt[Ae];if(!(!i?.id||!i.faction_id)&&confirm("Accept bid from "+i.corp+`?

Bid Price: `+v(i.bid_price)+`
Quality: `+i.estimated_quality+`/100
Workers: `+i.labor_count+`

This will award the contract. The project begins immediately.`)){Ht=!0;try{const{data:e}=await _.from("shard").select("current_tick").eq("name","Alpha Shard").single(),t=e?.current_tick||0,{error:n}=await _.from("contract_bids").update({status:"won"}).eq("id",i.id);if(n)throw n;const{error:o}=await _.from("contract_bids").update({status:"lost"}).eq("contract_id",oe.id).neq("id",i.id);if(o)throw o;const{error:s}=await _.from("construction_contracts").update({status:"awarded",awarded_to_faction:i.faction_id,awarded_at_tick:t}).eq("id",oe.id);if(s)throw s;Tt(),alert("Contract awarded to "+i.corp+`!

Bid: `+v(i.bid_price)+`
Project begins immediately.`),typeof ve=="function"&&await ve()}catch(e){alert("Failed to accept bid: "+(e.message||e))}finally{Ht=!1}}}async function Fo(){if(!(!oe||Gt)&&confirm(`Decline all bids and cancel this project?

No bids will be accepted. The contract will be removed.`)){Gt=!0;try{const{error:i}=await _.from("contract_bids").update({status:"lost"}).eq("contract_id",oe.id);if(i)throw i;const{error:e}=await _.from("construction_contracts").update({status:"expired"}).eq("id",oe.id);if(e)throw e;Tt(),alert("All bids declined. Contract cancelled."),typeof ve=="function"&&await ve()}catch(i){alert("Failed: "+(i.message||i))}finally{Gt=!1}}}function Zi(){if(document.getElementById("bid-review-overlay")?.remove(),!oe||tt.length===0)return;const i="'JetBrains Mono', monospace",e={surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",accentBright:"#a3b07e",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",yellow:"#ca5",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},t=oe,n=tt;Ae>=n.length&&(Ae=0);const o=n[Ae],s=Number(t.budget_ceiling||0),a=Number(t.timeline_ticks||36),l=Math.min(...n.map(u=>u.bid_price)),d=Math.max(...n.map(u=>u.estimated_quality||0));let r="";for(let u=0;u<n.length;u++){const y=n[u],g=u===Ae,$=y.bid_price===l,w=(y.estimated_quality||0)===d,h=y.bid_price>s;r+=`
