import{_supabase as p}from"./supabase-client-CiYoFhIh.js";/* empty css                  *//* empty css                  */import{i as Go}from"./common-AI9RRvLI.js";import{e as v,t as Z,b as U}from"./utils-oN1e812_.js";import{i as Wo}from"./government-types-CNjNcIHN.js";import{f as Xo}from"./government-structure-DVzKGcwP.js";import{c as bo,a as Qo,s as Jo,d as he,b as Ko}from"./political-actions-CWimzYIQ.js";import"./stats-CBT3qQox.js";import"./preload-helper-BXl3LOEh.js";import"./factions-1eoRseVF.js";import"./corp-topbar-ClQJCe3f.js";import"./config-BdOpHGNJ.js";const Zo=[{id:"world",label:"WORLD"},{id:"diplomacy",label:"DIPLOMACY"},{id:"trade",label:"TRADE"},{id:"ipo",label:"IPO"},{id:"sports",label:"SPORTS"}];let ae="world",uo=!1,Ve=!1,Ft=0;function We(){const e=document.getElementById("diplo-subtabs");e&&(e.innerHTML=Zo.map(t=>{let o="";return(t.id==="trade"||t.id==="world")&&Ve?o='<span style="display:inline-block;width:6px;height:6px;border-radius:50%;background:var(--amber);margin-left:5px;vertical-align:middle;"></span>':t.id==="ipo"&&Ft>0&&(o=`<span class="badge badge--amber" style="margin-left:6px;">${Ft}</span>`),`<div class="diplo-subtab${ae===t.id?" active":""}" data-tab="${t.id}">${t.label}${o}</div>`}).join(""),e.onclick=t=>{const o=t.target.closest(".diplo-subtab");!o||o.dataset.tab===ae||(ae=o.dataset.tab,We(),ea())})}async function yo(){const e=z?.nation?.id,t=z?.faction?.id;if(!e||!t){Ve=!1;return}try{const{data:o}=await p.from("trade_negotiations").select("id, nation_a_id, nation_b_id, approved_by_a, approved_by_b").or(`nation_a_id.eq.${e},nation_b_id.eq.${e}`).in("status",["open","active"]);if(!o||o.length===0){Ve=!1;return}if(o.some(l=>{const s=l.nation_a_id===e,c=s?l.approved_by_a:l.approved_by_b;return(s?l.approved_by_b:l.approved_by_a)&&!c})){Ve=!0;return}const n=z?.shard?.current_tick||0,r=o.map(l=>l.id),{data:i}=await p.from("negotiation_messages").select("id, negotiation_id, sender_nation_id").in("negotiation_id",r).neq("sender_nation_id",e).eq("is_system",!1).gte("sent_at_tick",n-2).limit(1);Ve=i&&i.length>0}catch{Ve=!1}}function ea(){const e=document.getElementById("subtab-world"),t=document.getElementById("subtab-diplomacy"),o=document.getElementById("subtab-trade"),a=document.getElementById("subtab-ipo"),n=document.getElementById("subtab-sports");if(!(!e||!t||!o||!a||!n))if(e.style.display=ae==="world"?"":"none",t.style.display=ae==="diplomacy"?"":"none",o.style.display=ae==="trade"?"":"none",a.style.display=ae==="ipo"?"":"none",n.style.display=ae==="sports"?"":"none",ae==="trade"&&!uo&&(uo=!0,pa()),ae==="sports"&&aa(),ae==="ipo")typeof ie=="function"&&h&&ie();else{if(typeof $e<"u"&&$e){try{p.removeChannel($e)}catch{}$e=null}if(typeof ke<"u"&&ke){try{p.removeChannel(ke)}catch{}ke=null}}}const ta=.03,qt=84,zt=24,oa=12;function st(e){if(!e)return String(e);const t=["th","st","nd","rd"],o=e%100;return e+(t[(o-20)%10]||t[o]||t[0])}function ho(e,t){return!t&&e<0?"UPCOMING":e<=2?`GROUP STAGE — ROUND ${e+1} IN PROGRESS`:e===3?"QUARTERFINALS IN PROGRESS":e===4?"SEMIFINALS IN PROGRESS":e===5?"FINAL IN PROGRESS":"COMPLETE"}function xo(e,t,o){return!o&&t<0?"pending":e===0?"done":e===1?t<=2?"active":"done":e===2?t<=2?"pending":t<=4?"active":"done":e===3?t===5?"active":t>5?"done":"pending":"pending"}function wo(e){const t=Number(e)||0;let o=-1;for(let n=0;n<1e3&&!(qt+zt*n>t);n++)o=n;const a=n=>{const r=qt+zt*n,i=r+5,l=t<r?-1:t-r,s=l>=0&&l<=5;return{cupNum:n+1,cupStart:r,cupEnd:i,isActive:s,stage:l,gs1:r,gs2:r+1,gs3:r+2,qf:r+3,sf:r+4,f:r+5}};return o>=0?a(o):a(0)}function aa(){const e=document.getElementById("sports-subtitle"),t=document.getElementById("sports-cards"),o=document.getElementById("vola-cup"),a=document.getElementById("vola-team");if(!e||!t)return;const n=z?.nation,r=z?.shard?.current_tick??0;if(!n){e.textContent="",t.innerHTML='<div class="sports-empty">No nation selected.</div>',o&&(o.innerHTML=""),a&&(a.innerHTML="");return}const i=Math.max(0,Math.min(100,Number(n.national_vola_culture)||0)),l=Math.round(i*ta*10)/10,s=(n.name||"").toUpperCase();e.textContent=`${s} NATIONAL VOLA AUTHORITY · TICK ${r}`;const c=Math.max(0,Number(n.vwc_ranking)||0),u=Math.max(0,Number(n.national_team_prowess)||0),f=Math.max(0,Number(n.vola_stadiums)||0);let _=null,m=null,d=null,g=null;for(let w=0;w<200&&(_===null||m===null);w++){const S=qt+zt*w,M=S-oa;m===null&&M>=r&&(m=M,g=w+1),_===null&&S>=r&&(_=S,d=w+1)}const x=w=>{if(w==null)return"—";const S=Z(w),[M,N]=S.split(", ");return`${(M||"").slice(0,3)} ${N||""}`.trim()},I=x(_),$=x(m),E=_!=null?`${st(d)} World Vola Cup · tick ${_}`:"no cup scheduled",T=m!=null?`${st(g)} cup qualifiers · tick ${m}`:"no qualifiers scheduled";if(t.innerHTML=`
        ...
        <div class="sports-stat-grid">
            <div class="sports-stat-card sports-stat-card--clickable" id="vwc-ranking-card" role="button" tabindex="0" aria-expanded="false" aria-controls="vwc-ranking-panel">
                ...
                <div class="sports-stat-card-value">${c>0?st(c):"—"}</div>
    ...
    `,na(),o){o.innerHTML=ia(r);const w=wo(r);w?.cupNum&&(la(w.cupNum).catch(S=>console.warn("[Sports] placement render failed:",S?.message||S)),ca(w.cupNum).catch(S=>console.warn("[Sports] group render failed:",S?.message||S)),ra(w.cupNum).catch(S=>console.warn("[Sports] host render failed:",S?.message||S)),da(w.cupNum).catch(S=>console.warn("[Sports] knockout render failed:",S?.message||S)),sa(w.cupNum,r).catch(S=>console.warn("[Sports] schedule render failed:",S?.message||S)))}a&&(a.innerHTML=`
        ...
        `,$o(r).catch(w=>console.warn("[Sports] team render failed:",w?.message||w)))}async function na(){const e=document.getElementById("vwc-ranking-panel-list");if(!e)return;let t=Array.isArray(K)?K:[];if(t.length===0){e.innerHTML='<div class="sports-empty">Loading rankings&hellip;</div>';try{const{data:n}=await p.from("nations").select("id, name, flag_url, vwc_ranking").order("name");t=n||[],K=t}catch(n){e.innerHTML=`<div class="sports-empty">Failed to load: ${v(n?.message||"")}</div>`;return}}if(t.length===0){e.innerHTML='<div class="sports-empty">No nation data available.</div>';return}const o=t.slice().sort((n,r)=>{const i=Number(n?.vwc_ranking)||0,l=Number(r?.vwc_ranking)||0;return i===0&&l===0?(n.name||"").localeCompare(r.name||""):i===0?1:l===0?-1:i-l}),a=z?.nation?.id;e.innerHTML=o.map((n,r)=>{const i=Number(n.vwc_ranking)||0,l=Xe(n,"vwc-ranking-flag"),s=i>0?st(i):"—",c=i>0&&i<=3?'<span class="vwc-ranking-tag">[WORLD CLASS]</span>':"";return`
        ...
        `}).join("")}document.addEventListener("click",e=>{const t=e.target.closest&&e.target.closest("#vwc-ranking-card");if(!t)return;const o=document.getElementById("vwc-ranking-panel");if(!o)return;const a=!o.hidden;o.hidden=a,t.setAttribute("aria-expanded",String(!a)),t.classList.toggle("sports-stat-card--open",!a)});document.addEventListener("keydown",e=>{if(e.key!=="Enter"&&e.key!==" ")return;const t=e.target&&e.target.id==="vwc-ranking-card"?e.target:null;t&&(e.preventDefault(),t.click())});function ia(e){const t=wo(e);if(!t)return"";const a=t.stage<0?`Next World Cup &mdash; <span class="vola-cup-title-date">${Z(t.gs1)}</span>`:`${st(t.cupNum)} World <span class="vola-cup-title-accent">Vola</span> Cup`,n=t.isActive?'<span class="vola-cup-live">&bullet; LIVE</span>':"",r=ho(t.stage,t.isActive),i=f=>f==="done"?"&check;":f==="active"?"&times;":"&#9675;",l=(f,_)=>{const m=xo(f,t.stage,t.isActive);return`<div class="vola-cup-tab vola-cup-tab--${m}">
    ...
    `}const fo=["#d65a5a","#e07a3a","#e8b13a","#cdd055","#9ac84e","#5eb564","#4ab59c","#5aa9d6","#6e8ad6","#9070cf","#b46ac5","#d66aaa","#cc8866"];function dt(e){if(!e)return"var(--text-bright)";let t=0;for(let o=0;o<e.length;o++)t=t*31+e.charCodeAt(o)|0;return fo[Math.abs(t)%fo.length]}function Xe(e,t){if(!e)return"";const o=e.name||"",a=e.flag_url||Ia[o]||(o?`assets/flags/${o}.png`:"");return a?`<img class="${t}" src="${v(a)}" alt="" loading="lazy" onerror="this.style.display='none'">`:""}async function ra(e){const t=document.querySelector(".vola-cup-meta-host");if(!t)return;const{data:o,error:a}=await p.from("vola_cup_hosts").select("host_nation_id, nations:host_nation_id(name)").eq("cup_number",e).maybeSingle();if(a){console.warn("[Sports] host fetch failed:",a.message);return}const n=o?.nations?.name;n&&(t.textContent=n.toUpperCase())}async function sa(e,t){const{data:o,error:a}=await p.from("vola_cup_group_matches").select("scheduled_tick").eq("cup_number",e).eq("round_number",1).order("scheduled_tick",{ascending:!0}).limit(1);if(a){console.warn("[Sports] schedule fetch failed:",a.message||a);return}if(!o||o.length===0)return;const n=Number(o[0].scheduled_tick);if(!Number.isFinite(n))return;const r=n+3,i=n+4,l=n+5,s=(m,d)=>{const g=document.querySelector(`[data-cup-sched="${m}"]`);g&&(g.textContent=d)};s("qf",`${Z(r)} — Quarterfinals begin`),s("sf",`${Z(i)} — Semifinals`),s("f",`${Z(l)} — Final`),s("bracket-qf",`QUARTERFINALS · ${Z(r)}`),s("bracket-sf",`SEMIFINALS · ${Z(i)}`),s("bracket-f",`FINAL · ${Z(l)}`);const u=(Number(t)||0)-n,f=u>=0&&u<=5;s("status",ho(u,f));const _=document.querySelector('[data-cup-sched="tabs"]');if(_){const m=d=>d==="done"?"✓":d==="active"?"×":"○";_.querySelectorAll(".vola-cup-tab").forEach((d,g)=>{const x=xo(g,u,f);d.className=`vola-cup-tab vola-cup-tab--${x}`;const I=d.querySelector(".vola-cup-tab-icon");I&&(I.textContent=m(x))})}}async function la(e){const t=document.querySelector(`.vola-cup-placement-body[data-cup-num="${e}"]`);if(!t)return;const{data:o,error:a}=await p.from("vola_placement_matches").select("match_number, scheduled_tick, team_a_score, team_b_score, winner_nation_id, team_a:team_a_nation_id(id, name, flag_url), team_b:team_b_nation_id(id, name, flag_url)").eq("cup_number",e).order("match_number",{ascending:!0});if(a){t.innerHTML=`<div class="sports-empty">Failed to load placement matches: ${v(a.message||"")}</div>`;return}if(!o||o.length===0){t.innerHTML='<div class="sports-empty">Placement schedule not yet generated. The bottom 3 nations face a 3-tick round-robin starting at the qualifier tick.</div>';return}t.innerHTML=o.map(n=>{const r=n.team_a?.name||"TBD",i=n.team_b?.name||"TBD",l=Xe(n.team_a,"vola-flag"),s=Xe(n.team_b,"vola-flag"),c=dt(r),u=dt(i),f=n.team_a_score,_=n.team_b_score,m=f!=null&&_!=null,d=n.winner_nation_id,g=m&&d===n.team_a?.id,x=m&&d===n.team_b?.id,I=g?c:m?"var(--text-dim)":c,$=x?u:m?"var(--text-dim)":u,E=g?`text-shadow:0 0 8px ${c}55;`:"",T=x?`text-shadow:0 0 8px ${u}55;`:"";return`
        ...
        `}).join("")}async function ca(e){const t=document.querySelectorAll(`.vola-cup-group[data-cup-num="${e}"]`);if(!t.length)return;const[o,a]=await Promise.all([p.from("vola_cup_groups").select("group_letter, seed_rank, qualified_via, nation:nation_id(id, name, flag_url, vwc_ranking)").eq("cup_number",e),p.from("vola_cup_group_matches").select("group_letter, team_a_nation_id, team_b_nation_id, team_a_score, team_b_score, winner_nation_id, resolved_at_tick").eq("cup_number",e)]);if(o.error){console.warn("[Sports] vola_cup_groups fetch failed:",o.error.message||o.error);return}a.error&&console.warn("[Sports] vola_cup_group_matches fetch failed:",a.error.message||a.error);const n=o.data||[];if(n.length===0)return;const r=new Map,i=s=>(r.has(s)||r.set(s,{wins:0,losses:0,points:0,played:0}),r.get(s));for(const s of a.data||[]){if(s.resolved_at_tick==null)continue;const c=s.team_a_nation_id,u=s.team_b_nation_id,f=Number(s.team_a_score)||0,_=Number(s.team_b_score)||0,m=i(c),d=i(u);m.points+=f,d.points+=_,m.played++,d.played++,s.winner_nation_id===c?(m.wins++,d.losses++):s.winner_nation_id===u&&(d.wins++,m.losses++)}const l={A:[],B:[],C:[]};for(const s of n){if(!l[s.group_letter])continue;const c=s.nation?.id,u=c&&r.get(c);l[s.group_letter].push({...s,wins:u?u.wins:0,losses:u?u.losses:0,points:u?u.points:0,played:u?u.played:0,ranking:Number(s.nation?.vwc_ranking)||0})}t.forEach(s=>{const c=s.getAttribute("data-group-letter"),u=s.querySelector(".vola-cup-group-rows");if(!u)return;const f=(l[c]||[]).slice();if(f.length===0)return;const _=m=>m>0?m:Number.POSITIVE_INFINITY;f.sort((m,d)=>{if(d.wins!==m.wins)return d.wins-m.wins;if(d.points!==m.points)return d.points-m.points;const g=_(m.ranking),x=_(d.ranking);if(g!==x)return g-x;const I=m.nation?.name||"",$=d.nation?.name||"";return I.localeCompare($)}),u.innerHTML=f.map((m,d)=>{const g=m.nation||{},x=g.name||"TBD",I=Xe(g,"vola-cup-group-flag"),$=dt(x),E=m.qualified_via==="placement"?'<span class="vola-cup-group-via" title="Qualified via placement round">P</span>':"",T=m.played>0?`${m.wins}-${m.losses}`:'<span class="vola-cup-group-stat--blank">&mdash;</span>',w=m.played>0?String(m.points):'<span class="vola-cup-group-stat--blank">&mdash;</span>',S=m.ranking>0?String(m.ranking):'<span class="vola-cup-group-stat--blank">&mdash;</span>';return`
            ...
            `}).join("")})}async function da(e){const t=document.querySelector(`.vola-cup-bracket[data-cup-num="${e}"]`);if(!t)return;const{data:o,error:a}=await p.from("vola_cup_knockout").select("round, match_number, team_a_seed, team_b_seed, feeder_a_match, feeder_b_match, team_a_score, team_b_score, winner_nation_id, resolved_at_tick, team_a:team_a_nation_id(id, name, flag_url), team_b:team_b_nation_id(id, name, flag_url)").eq("cup_number",e);if(a){console.warn("[Sports] vola_cup_knockout fetch failed:",a.message||a);return}if(!o||o.length===0)return;const n=o.find(i=>i.round==="F"),r=t.querySelector(".vola-cup-champion-text");if(r)if(n?.winner_nation_id&&(n.team_a||n.team_b)){const i=n.winner_nation_id===n.team_a?.id?n.team_a:n.team_b;if(i?.name){const l=Xe(i,"vola-cup-champion-flag"),s=dt(i.name);r.innerHTML=`${l}<span style="color:${s};">${v(i.name)}</span>`,t.classList.add("vola-cup-bracket--crowned")}}else r.textContent="To Be Crowned",t.classList.remove("vola-cup-bracket--crowned");for(const i of o){const l=t.querySelector(`.vola-cup-match[data-round="${i.round}"][data-match-num="${i.match_number}"]`);if(!l)continue;const s=l.querySelector('[data-side="a"]'),c=l.querySelector('[data-side="b"]'),u=l.querySelector(".vola-cup-match-status");if(!s||!c)continue;const f=(_,m,d)=>{if(_?.id){const g=Xe(_,"vola-cup-match-flag");return`<span style="color:${dt(_.name)};">${g}${v(_.name||"TBD")}</span>`}return d!=null?`Winner ${i.round==="SF"?`QF${d}`:`SF${d}`}`:m};if(s.innerHTML=f(i.team_a,"&mdash;",i.feeder_a_match),c.innerHTML=f(i.team_b,"&mdash;",i.feeder_b_match),l.classList.remove("vola-cup-match--played","vola-cup-match--win-a","vola-cup-match--win-b"),u)if(i.resolved_at_tick!=null&&i.winner_nation_id){const _=Number(i.team_a_score)||0,m=Number(i.team_b_score)||0;u.textContent=`${_} – ${m}`,l.classList.add("vola-cup-match--played");const d=i.winner_nation_id===i.team_a?.id?"a":"b";l.classList.add(`vola-cup-match--win-${d}`)}else u.textContent="PENDING"}}async function $o(e){const t=document.getElementById("vola-team-grid"),o=document.getElementById("vola-team-meta"),a=document.getElementById("vola-team-footer");if(!t)return;const n=z?.nation;if(!n?.id){t.innerHTML='<div class="sports-empty">No nation selected.</div>',o&&(o.textContent=""),a&&(a.innerHTML="");return}const{data:r,error:i}=await p.from("vola_team_players").select("id, position_number, position_name, first_name, last_name, age, rating, recruited_at_tick, recruited_at_culture, retires_at_tick, is_captain").eq("nation_id",n.id).order("position_number",{ascending:!0});if(i){t.innerHTML=`<div class="sports-empty">Failed to load roster: ${v(i.message||"")}</div>`,o&&(o.textContent=""),a&&(a.innerHTML="");return}if(!r||r.length===0){t.innerHTML='<div class="sports-empty">Roster pending — players generate next tick.</div>',o&&(o.textContent=""),a&&(a.innerHTML="");return}const l=r.reduce((s,c)=>s+(Number(c.rating)||0),0);if(o&&(o.textContent=`${r.length} PLAYERS · TOTAL PROWESS ${l}`),t.innerHTML=r.map(s=>{const c=Math.max(0,Number(s.retires_at_tick)-Number(e)),u=c===1,f=`${s.first_name||""} ${s.last_name||""}`.trim()||"Unnamed",_=Number(s.recruited_at_culture).toFixed(0),m=u?"vola-player-card vola-player-card--retiring":"vola-player-card",d=u?'<div class="vola-player-retire-warn"><span>&#9888;</span> RETIRES NEXT TICK</div>':`<div class="vola-player-remaining"><span>&#x29D6;</span> ${c} tick${c===1?"":"s"} remaining</div>`,g=u?`<button class="vola-player-recruit-btn" data-position="${s.position_number}">RECRUIT REPLACEMENT &rarr;</button>`:"",x=s.is_captain?`CAPTAIN &middot; POS ${s.position_number}`:`POSITION ${s.position_number}`;return`
            <div class="${m}">
        ...
        <div class="tr-econ-card">
            ...
            <span class="tr-econ-net ${$}">${I===0?"—":(I>0?"+":"−")+s(d,Math.abs(I))}</span>
        </div>`,T){const N=se[d.key]||{},A=Number(N.domestic_production)||0,B=Number(N.domestic_demand)||0,q=Number(N.export_capacity)||0,R=Number(N.import_demand)||0,D=Number(N.export_volume)||0,j=Number(N.import_volume)||0,ee=B>0?A-B:null,F=D-j,W=Math.max(0,R-q-j),H=he(A,d.key),de=he(B,d.key),oe=he(R,d.key),pe=he(j,d.key),tt=he(D,d.key),co=he(W,d.key),po=jt.filter(V=>V.importer_nation_id===l&&V.sector===d.key&&V.trade_volume>0).sort((V,ot)=>ot.trade_volume-V.trade_volume),mo=jt.filter(V=>V.exporter_nation_id===l&&V.sector===d.key&&V.trade_volume>0).sort((V,ot)=>ot.trade_volume-V.trade_volume);i+='<div style="padding:10px 18px 14px;background:var(--bg-card);border-bottom:2px solid var(--border-main);">';const Pt={fuel_energy:{price:85,unit:"barrel"},minerals:{price:120,unit:"tonne"},grains_staples:{price:235,unit:"tonne"},livestock_dairy:{price:2800,unit:"tonne"},fruits_vegetables:{price:900,unit:"tonne"},cash_crops:{price:1400,unit:"tonne"},manufactured_goods:{price:2200,unit:"TEU"},arms:{price:45e3,unit:"unit"}}[d.key];if(Pt&&(i+=`<div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid rgba(42,42,36,0.2);">
                    ...
                    <span style="font-family:var(--font-mono);font-size:12px;font-weight:700;color:var(--amber);">$${Pt.price.toLocaleString()} <span style="font-weight:400;color:var(--text-dim);font-size:10px;">per ${Pt.unit}</span></span>
                ...
                <div style="font-family:var(--font-mono);font-size:10px;font-weight:700;color:var(--red);letter-spacing:0.5px;margin-bottom:4px;">IMPORTING: ${U(j)}${pe?" ("+pe+")":""}</div>`,po.length>0)for(const V of po){const Ot=(K||[]).find(Mt=>Mt.id===V.exporter_nation_id)?.name||"Unknown",at=he(V.trade_volume,d.key),Lt=go(V.exporter_nation_id,d.key);i+=`<div style="display:flex;justify-content:space-between;align-items:center;gap:10px;padding:2px 0 2px 12px;">
                        <span style="font-size:12px;color:var(--text-secondary);">• ${v(Ot)}</span>
                        <span style="display:flex;align-items:center;gap:8px;">
                            ${ht(Lt)}
                            <span style="font-family:var(--font-mono);font-size:11px;color:var(--text-dim);">${U(V.trade_volume)}${at?' <span style="font-size:9px;">('+at+")</span>":""}</span>
                        </span>
                    ...
                    <span style="font-family:var(--font-mono);font-size:12px;font-weight:700;color:var(--red);">${U(W)}${co?' <span style="font-weight:400;font-size:9px;">('+co+")</span>":""}</span>
                </div>`),i+=`<div style="margin-top:8px;">
                <div style="font-family:var(--font-mono);font-size:10px;font-weight:700;color:var(--green);letter-spacing:0.5px;margin-bottom:4px;">EXPORTING: ${U(D)}${tt?" ("+tt+")":""}</div>`,mo.length>0)for(const V of mo){const Ot=(K||[]).find(Mt=>Mt.id===V.importer_nation_id)?.name||"Unknown",at=he(V.trade_volume,d.key),Lt=go(V.importer_nation_id,d.key);i+=`<div style="display:flex;justify-content:space-between;align-items:center;gap:10px;padding:2px 0 2px 12px;">
                        <span style="font-size:12px;color:var(--text-secondary);">• ${v(Ot)}</span>
                        <span style="display:flex;align-items:center;gap:8px;">
                            ${ht(Lt)}
                            <span style="font-family:var(--font-mono);font-size:11px;color:var(--text-dim);">${U(V.trade_volume)}${at?' <span style="font-size:9px;">('+at+")</span>":""}</span>
        ...
        </div>`;i+='<div class="tr-econ-effects-placeholder">More commodity effects unlock as demand models land.</div>',i+="</div>",e.innerHTML=i,e.onclick=d=>{const g=d.target.closest(".tr-commodity-row");if(!g||g.dataset.statbased==="1")return;const x=g.dataset.sector;vt=vt===x?null:x,Dt=vt,Zt(),Fe()}}let je=[],lt=[],wt={},Bt=null;async function eo(){const e=z?.nation?.id;if(!e)return;const[t,o]=await Promise.all([p.from("trade_agreements").select("*").or(`nation_a_id.eq.${e},nation_b_id.eq.${e}`).order("enacted_at_tick",{ascending:!1}),p.from("trade_negotiations").select("id, nation_a_id, nation_b_id, status, agreement_type, opened_at_tick, approved_by_a, approved_by_b, last_seen_at_a, last_seen_at_b").or(`nation_a_id.eq.${e},nation_b_id.eq.${e}`).in("status",["open","active","ratification"]).order("opened_at_tick",{ascending:!1})]);je=t.data||[],lt=o.data||[];const a=lt.map(r=>r.id),n={};if(a.length>0){const{data:r,error:i}=await p.from("negotiation_messages").select("negotiation_id, sender_nation_id, created_at").in("negotiation_id",a).neq("sender_nation_id",e).eq("is_system",!1).order("created_at",{ascending:!1});i&&console.warn("[loadTradeAgreements] unread-state fetch failed:",i.message);const l={};for(const s of r||[])l[s.negotiation_id]||(l[s.negotiation_id]=s.created_at);for(const s of lt){const u=s.nation_a_id===e?s.last_seen_at_a:s.last_seen_at_b,f=l[s.id];f&&(!u||new Date(f)>new Date(u))&&(n[s.id]=!0)}}wt=n,await ga()}let Ie={};async function ga(){Ie={};const e=(je||[]).filter(a=>a.status==="active").map(a=>a.id);if(e.length===0)return;const{data:t,error:o}=await p.from("shipping_contracts").select(`
        ...
        <div class="tr-panel-header">
            ...
            <div class="tr-agreement-header" style="background:${_?"var(--bg-card)":"transparent"};padding:14px 18px;">
                ...
                <div style="padding:4px 8px;background:var(--bg-card);border:1px solid var(--border-main);display:flex;align-items:center;">
            ...
            </div>`;const j=Ht(c.id);if(c.agreement_type!=="retaliatory_tariff"&&c.agreement_type!=="impose_embargo"){if(i+=`<div style="margin-top:6px;background:var(--bg-card);border:1px solid var(--border-main);padding:8px 10px;">
                    ...
                    <div style="font-family:var(--font-mono);font-size:9px;font-weight:700;letter-spacing:1px;color:var(--text-dim);margin-bottom:6px;">🚢 TRADE SHIPPING</div>`;for(const F of B){let W,H;const de=Number(F.consecutive_missed_payments)||0,oe=(F.commodity||"units").replace(/_/g," ");if(F.status==="awarded"&&F.winner_faction_name)de>0?(W="var(--red)",H=`⚠ ${F.energy_per_tick} ${oe}/tick · ${F.winner_faction_name} · ${de} missed payment${de===1?"":"s"}`):(W="var(--green)",H=`${F.energy_per_tick} ${oe}/tick · ${F.winner_faction_name}`);else if(F.status==="open"){W="var(--amber, #b8860b)";const tt=F.expires_at_tick!=null?Math.max(0,F.expires_at_tick-o):0;H=`Awaiting offers · ${F.volume_required} ${oe}/tick · closes in ${tt} tick${tt===1?"":"s"}`}else F.status==="completed"?(W="var(--text-dim)",H="Completed"):F.status==="cancelled"?(W="var(--text-dim)",H="Cancelled"):(W="var(--text-dim)",H=F.status);const pe=F.delivery_priority?`<span style="font-family:var(--font-mono);font-size:7px;letter-spacing:0.5px;text-transform:uppercase;color:var(--text-dim);padding:1px 5px;border:1px solid var(--border-main);">${v(F.delivery_priority)}</span>`:"";i+=`<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:3px;font-family:var(--font-mono);font-size:10px;">
                        <span style="color:${W};">${v(H)}</span>
                        ${pe}
                    </div>`}i+="</div>"}i+="</div>"}i+="</div>"}i+="</div>",e.innerHTML=i,e.onclick=s=>{const c=s.target.closest(".tr-agreement-row");if(!c)return;const u=c.dataset.agId;Bt=Bt===u?null:u,pt()}}let Vt={};async function va(){Vt={}}function _a(e,t){const o=Vt[e]||{},a=Vt[t]||{};let n=0,r=0;for(const l of Object.keys({...o,...a})){if(l==="food_agriculture"&&(o.grains_staples||a.grains_staples))continue;const s=Number(o[l]?.net_flow)||0,c=Number(a[l]?.net_flow)||0;r++,(s>0&&c<0||s<0&&c>0)&&(n+=Math.min(Math.abs(s),Math.abs(c)))}if(r===0)return 0;const i=Object.values(o).reduce((l,s)=>l+(s.export_capacity||0)+(s.import_demand||0),0)||1;return Math.min(99,Math.round(n/i*200))}function Io(){const e={energy:0,minerals:0,food:0,consumer_goods:0,luxury_goods:0},t=z?.nation?.id;if(!t)return e;const o=(je||[]).filter(a=>a.status==="active");for(const a of o){const n=a.nation_a_id===t?a.nation_b_id:a.nation_a_id;if(!n)continue;const r=Et(n)||{needsShipping:!0},i=!!Ht(a.id)?.hasLogistics,l=(Ie[a.id]||[]).filter(u=>u.status==="awarded"),s=l.length>0;if(!r.needsShipping||i||s)for(const u of a.articles||[]){if(u.article_type!=="trade_flow")continue;const f=u.data||{},_=f.commodity;if(!_||!(_ in e))continue;const m=Number(f.volume)||0;if(m<=0)continue;let d=m;if(_==="energy"&&s&&(d=l.reduce(($,E)=>$+(Number(E.energy_per_tick)||0),0)),d<=0)continue;const g=u.author_nation_id?u.author_nation_id===t:a.nation_a_id===t,x=g?t:n;(f.direction==="a_buys_b"?x:g?n:t)===t?e[_]+=d:e[_]-=d}}return e}function ba(e){const t=e||{},o=Number(t.energy)||0,a=Number(t.infrastructure)||0,n=Number(t.industry)||0,r=Number(t.standard_of_living)||0,i=(Number(t.population)||0)/1e6,l=o/3,s=(a+n)*r*Math.sqrt(i)/3500;return{production:l,demand:s,net:l-s}}function ya(e){const t=e||{},o=Number(t.minerals)||0,a=Number(t.unskilled_workers)||0,n=Number(t.industry)||0,r=Number(t.infrastructure)||0,i=o/3*((a+n)/200),l=r/10+n/16;return{production:i,demand:l,net:i-l}}function ha(e){const t=e||{},o=Number(t.farmland)||0,a=Number(t.unskilled_workers)||0,n=(Number(t.population)||0)/1e6,r=o/2*(a/100),i=n/3;return{production:r,demand:i,net:r-i}}function xa(e){const t=e||{},o=Number(t.industry)||0,a=Number(t.unskilled_workers)||0,n=Number(t.standard_of_living)||0,r=(Number(t.population)||0)/1e6,i=o/3*(a/100),l=n/100*r/2;return{production:i,demand:l,net:i-l}}function wa(e){const t=e||{},o=Number(t.standard_of_living)||0,a=Number(t.education)||0,n=Number(t.service_sector)||0,r=(Number(t.population)||0)/1e6,i=o/6*(a*n/1e4),l=Math.pow(o/100,2)*r;return{production:i,demand:l,net:i-l}}function $a(e){const t=(K||[]).find(r=>r.id===e),o=[],a=[],n=[{sector:"energy",icon:"⚡",name:"Energy",balance:ba(t)},{sector:"minerals",icon:"⛏",name:"Minerals",balance:ya(t)},{sector:"food",icon:"🌾",name:"Food",balance:ha(t)},{sector:"consumer_goods",icon:"📦",name:"Consumer Goods",balance:xa(t)},{sector:"luxury_goods",icon:"💎",name:"Luxury Goods",balance:wa(t)}];for(const r of n){const i=r.balance.net;if(i===0)continue;const l={sector:r.sector,icon:r.icon,name:r.name,amount:Math.abs(i),statBased:!0};i>0?o.push(l):a.push(l)}return{surpluses:o,deficits:a}}let Rt=null,_t="compatibility";function Fe(){const e=document.getElementById("trade-right");if(!e)return;const t=z?.nation?.id;if(!t){e.innerHTML="";return}const o=(K||[]).filter(s=>s.id!==t),a=ze||[],n=o.map(s=>{const c=_a(t,s.id),u=t<s.id?t:s.id,f=t<s.id?s.id:t,_=a.find(g=>g.nation_a_id===u&&g.nation_b_id===f),m=_?Number(_.relation_score??0):0;let d="Neutral";return m>=60?d="Friendly":m>=30?d="Warm":m>=-10?d="Neutral":m>=-40?d="Cold":d="Hostile",{...s,compat:c,relLabel:d,relScore:m}});_t==="compatibility"?n.sort((s,c)=>c.compat-s.compat):n.sort((s,c)=>s.name.localeCompare(c.name));const r={Friendly:"var(--green)",Warm:"var(--green)",Neutral:"var(--blue)",Cold:"var(--blue)",Hostile:"var(--red)"},i=Dt;let l=`<div class="tr-panel" style="padding:8px 14px;display:flex;justify-content:space-between;align-items:center;">
        <div style="display:flex;align-items:center;gap:8px;">
            ...
            <span style="font-size:9px;">${ko[i]||""}</span>
    ...
    </div>`;for(const s of n){const c=r[s.relLabel]||"var(--text-dim)",u=Rt===s.id,{surpluses:f,deficits:_}=$a(s.id);let m=!0,d=null;if(i){const T=se[i],w=Number(T?.net_flow)||0,S=_.find(N=>N.sector===i),M=f.find(N=>N.sector===i);w>0&&S?d="export":w<0&&M?d="import":m=!1}const g=s.compat>=75?"var(--green)":s.compat>=50?"var(--amber)":"var(--orange)",x=s.flag_url||`assets/flags/${s.name}.png`,I=s.name.slice(0,2).toUpperCase(),$=Number(s.population||0),E=$>=1e6?($/1e6).toFixed(1)+"M":$.toLocaleString();if(l+=`<div class="tr-partner-card${u?" expanded":""}" data-nation="${s.id}" style="opacity:${i&&!m?"0.3":"1"};border-color:${u?c+"44":""};">
            <div class="tr-partner-header">
                ...
                <div style="display:flex;">
                    <div style="flex:1;padding:14px 18px;border-right:1px solid var(--border-main);">
                        <div style="font-family:var(--font-mono);font-size:10px;font-weight:700;color:var(--teal);margin-bottom:6px;display:flex;align-items:center;gap:5px;"><span style="width:7px;height:7px;background:var(--teal);"></span>THEY CAN OFFER</div>`;for(const A of f.slice(0,6)){const B=T.includes(A.sector),q=A.statBased?Number(A.amount).toFixed(0):U(A.amount);l+=`<div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid rgba(42,42,36,0.15);">
                    <div style="display:flex;align-items:center;gap:6px;">
                    ...
                    <span style="font-family:var(--font-mono);font-size:13px;font-weight:700;color:var(--teal);">${q}<span style="font-weight:400;color:var(--text-dim);font-size:10px;">/mo</span></span>
                        ...
                        <div style="font-family:var(--font-mono);font-size:10px;font-weight:700;color:var(--green);margin-bottom:6px;display:flex;align-items:center;gap:5px;"><span style="width:7px;height:7px;background:var(--green);"></span>THEY NEED</div>`;for(const A of _.slice(0,6)){const B=w.includes(A.sector),q=A.statBased?Number(A.amount).toFixed(0):U(A.amount);l+=`<div style="display:flex;justify-content:space-between;padding:4px 0;border-bottom:1px solid rgba(42,42,36,0.15);">
                    <div style="display:flex;align-items:center;gap:6px;">
                        <span style="font-size:13px;">${A.icon}</span>
                        <span style="font-size:13px;color:var(--text-bright);font-weight:${B?"700":"400"};">${v(A.name)}</span>
                        ${B?'<span class="tr-badge" style="color:var(--green);background:rgba(92,204,92,0.06);border-color:rgba(92,204,92,0.15);font-size:8px;">MATCH</span>':""}
                    </div>
                    <span style="font-family:var(--font-mono);font-size:13px;font-weight:700;color:var(--green);">${q}<span style="font-weight:400;color:var(--text-dim);font-size:10px;">/mo</span></span>
                </div>`}_.length===0&&(l+='<div style="font-size:12px;color:var(--text-dim);font-style:italic;">No deficits</div>'),l+="</div></div>";const S=(je||[]).filter(A=>A.status==="active"&&(A.nation_a_id===s.id||A.nation_b_id===s.id));if(S.length>0){l+=`<div style="padding:10px 18px;border-top:1px solid var(--border-main);">
                    <div style="font-family:var(--font-mono);font-size:9px;font-weight:700;color:var(--green);letter-spacing:1px;margin-bottom:6px;">ACTIVE TRADE AGREEMENTS</div>`;for(const A of S){const B=$t[A.agreement_type]||A.agreement_type,q=A.duration_type==="permanent"?"Permanent":A.expires_at_tick?A.expires_at_tick-(z?.shard?.current_tick||0)+" ticks left":"";l+=`<div style="display:flex;justify-content:space-between;align-items:center;padding:4px 0;border-bottom:1px solid rgba(42,42,36,0.1);">
                        <div style="display:flex;align-items:center;gap:6px;">
                        ...
                        <span style="font-family:var(--font-mono);font-size:9px;color:var(--text-dim);">${q}</span>
                    </div>`}l+="</div>"}const N=lt.some(A=>A.nation_a_id===s.id||A.nation_b_id===s.id)?`<div class="tr-action-btn tr-action-btn--primary" onclick="event.stopPropagation();openTradeNegModal('${s.id}');">TRADE DISCUSSIONS</div>`:`<div class="tr-action-btn tr-action-btn--primary" onclick="event.stopPropagation();openTradeNegModal('${s.id}');">DRAFT TRADE AGREEMENT</div>`;l+=`<div style="padding:10px 18px;border-top:1px solid var(--border-main);background:var(--bg-card);display:flex;justify-content:flex-end;gap:6px;">
                ...
                ${N}
            </div>`,l+="</div>"}l+="</div>"}e.innerHTML=l,e.onclick=s=>{const c=s.target.closest(".tr-sort-btn");if(c){_t=c.dataset.sort,Fe();return}if(s.target.closest(".tr-filter-clear")){Dt=null,Zt(),Fe();return}const u=s.target.closest(".tr-partner-card");if(u&&!s.target.closest(".tr-action-btn")){const f=u.dataset.nation;Rt=Rt===f?null:f,Fe()}}}let h=null,we=null,k=0,L=[],b=null,$e=null,ke=null;const Ut=["#5cb85c","#c8a64e","#5aafa5","#d9534f","#8b7ec8","#5b9bd5","#e07b53","#7bc67e","#c7697a","#59c4d4","#b8a038","#9a8ec2"];async function Eo(e){const{data:t}=await p.from("ipo_members").select("chat_color").eq("org_id",e).eq("is_active",!0),o=(t||[]).map(a=>a.chat_color).filter(Boolean);return Ut.find(a=>!o.includes(a))||Ut[0]}const ka=["◈","⬡","▲","◆","⬢","⊕"];function qe(e,t,o){const a=t+(o?" "+o:"");return e.logo_image_url?`<img src="${v(e.logo_image_url)}" alt="" class="${a} ipo-logo-img" />`:`<span class="${a}">${v(e.logo_symbol)} ${v(e.logo_text)}</span>`}const Ia={Melizea:"assets/flags/Melizea.png",Avelia:"assets/flags/Avelia.png",Sangreza:"assets/flags/sangreza.png",Montequilla:"assets/flags/Montequilla.png","San Estrella":"assets/flags/sanestrella.png",Palvera:"assets/flags/Palvera.png",Calveth:"assets/flags/Calveth.png",Flandis:"assets/flags/Flandis.png",Vostia:"assets/flags/Vostia.png",Sierramar:"assets/flags/Sierramar.png",Hajjara:"assets/flags/Hajjara.png",Dravka:"assets/flags/Dravka.png",Danwei:"assets/flags/Danwei.png"};async function Ea(){const e=document.getElementById("world-map-panel");let t=document.getElementById("world-map-img");if(!e||!t)return;try{const m=t.getAttribute("src")||"";if(m){const d=await fetch(m);if(d.ok){const g=await d.text(),I=new DOMParser().parseFromString(g,"image/svg+xml").documentElement;if(I&&I.tagName.toLowerCase()==="svg"){const $=document.importNode(I,!0);$.id="world-map-img",$.removeAttribute("width"),$.removeAttribute("height"),$.style.cssText="display:block;transform-origin:0 0;width:100%;height:auto;pointer-events:none;",t.replaceWith($),t=$}}}}catch(m){console.warn("[WorldMap] inline-SVG upgrade failed, using <img> fallback:",m?.message||m)}let o=1,a=0,n=0,r=!1,i=0,l=0;const s=1,c=4;function u(){const m=e.clientWidth,d=e.clientHeight,g=t.getBoundingClientRect(),x=g.width,I=g.height;x<=m?a=0:a=Math.max(m-x,Math.min(0,a)),I<=d?n=0:n=Math.max(d-I,Math.min(0,n))}function f(){u(),t.style.transform=`translate(${a}px, ${n}px) scale(${o})`;const m=document.getElementById("map-zoom-label");m&&(m.textContent=Math.round(o*100)+"%")}e.addEventListener("wheel",m=>{m.preventDefault();const d=e.getBoundingClientRect(),g=m.clientX-d.left,x=m.clientY-d.top,I=o,$=m.deltaY>0?.9:1.1;o=Math.max(s,Math.min(c,o*$)),a=g-(g-a)*(o/I),n=x-(x-n)*(o/I),f()},{passive:!1}),e.addEventListener("mousedown",m=>{r=!0,i=m.clientX-a,l=m.clientY-n,e.style.cursor="grabbing"}),window.addEventListener("mousemove",m=>{r&&(a=m.clientX-i,n=m.clientY-l,f())}),window.addEventListener("mouseup",()=>{r=!1,e.style.cursor="grab"});let _=0;e.addEventListener("touchstart",m=>{m.touches.length===1?(r=!0,i=m.touches[0].clientX-a,l=m.touches[0].clientY-n):m.touches.length===2&&(_=Math.hypot(m.touches[0].clientX-m.touches[1].clientX,m.touches[0].clientY-m.touches[1].clientY))},{passive:!0}),e.addEventListener("touchmove",m=>{if(m.touches.length===1&&r)a=m.touches[0].clientX-i,n=m.touches[0].clientY-l,f();else if(m.touches.length===2){const d=Math.hypot(m.touches[0].clientX-m.touches[1].clientX,m.touches[0].clientY-m.touches[1].clientY);_>0&&(o=Math.max(s,Math.min(c,o*(d/_))),f()),_=d}},{passive:!0}),e.addEventListener("touchend",()=>{r=!1,_=0}),document.getElementById("map-zoom-in")?.addEventListener("click",()=>{o=Math.min(c,o*1.25),f()}),document.getElementById("map-zoom-out")?.addEventListener("click",()=>{o=Math.max(s,o*.8),f()}),document.getElementById("map-zoom-reset")?.addEventListener("click",()=>{o=1,a=0,n=0,f()}),f()}let Yt=null;function Sa(e,t){if(!document.getElementById("world-highlight-body")||!e.length)return;const a=t.nation?.id;K=e,z=t;const n=e.find(r=>r.id===a);n?So(n.id):to(e,a)}function to(e,t,o){const a=document.getElementById("world-nations-grid");if(!a)return;const r=(o?e.filter(l=>l.name.toLowerCase().includes(o.toLowerCase())):e).map(l=>{const s=l.id===t,c=l.id===Yt,u=["wn-grid-cell"];c&&u.push("is-selected"),s&&u.push("is-you");const f=l.flag_url||`assets/flags/${l.name}.png`;return`<div class="${u.join(" ")}" data-nation-id="${l.id}">
        ...
        </div>`}).join("");a.innerHTML=r||'<div class="wn-grid-empty">No nations match your search.</div>',a.dataset.clickBound||(a.addEventListener("click",l=>{const s=l.target.closest("[data-nation-id]");s&&So(s.dataset.nationId)}),a.dataset.clickBound="1");const i=document.getElementById("world-nation-search");i&&!i._wired&&(i._wired=!0,i.addEventListener("input",()=>{to(e,t,i.value)}))}let K=[],z=null,ze=null,Gt=null;async function So(e){const t=K.find(i=>i.id===e);if(!t)return;const o=z.nation?.id,a=t.id===o;if(Yt=e,to(K,o),!ze){const[i,l]=await Promise.all([p.from("diplomatic_relations").select("*"),p.from("trade_agreements").select("*").eq("status","active")]);ze=i.data||[],Gt=l.data||[]}const r={gov:await Aa(t.id),tradeData:null};Ca(t,z,ze,Gt,r),!a&&o&&Na(o,t.id).then(i=>{if(Yt!==e)return;const l=document.getElementById("world-trade-section");l&&(l.innerHTML=Ao(i))}).catch(i=>{console.error("[World] Bilateral trade fetch failed:",i)})}async function Aa(e){try{const[t,o,a,n,r]=await Promise.all([p.from("head_of_government").select("first_name, last_name, faction_id").eq("nation_id",e).eq("active",!0).limit(1).maybeSingle(),p.from("presidents").select("first_name, last_name, faction_id").eq("nation_id",e).eq("is_active",!0).limit(1).maybeSingle(),p.from("government_formations").select("party_ids, ministry_assignments, proposed_by, status").eq("nation_id",e).in("status",["formed","caretaker"]).order("formed_at",{ascending:!1}).limit(1).maybeSingle(),p.from("active_crises").select("crisis_id, crisis_templates(name)").eq("nation_id",e),p.from("factions").select("id, faction_name, abbreviation, party_color, seats").eq("nation_id",e).order("seats",{ascending:!1})]),i=r.data||[],l={};for(const I of i)l[I.id]=I;const c=(K.find(I=>I.id===e)?.government_type||"").toLowerCase().includes("presidential"),u=o.data,f=t.data;let _=null,m=null;c&&u?(_={name:`${u.first_name} ${u.last_name}`,title:"President"},m=l[u.faction_id]||null):f?(_={name:`${f.first_name} ${f.last_name}`,title:"Prime Minister"},m=l[f.faction_id]||null):u&&(_={name:`${u.first_name} ${u.last_name}`,title:"President"},m=l[u.faction_id]||null);const d=a.data;let g=[];d&&d.party_ids&&(g=d.party_ids.map(I=>l[I]).filter(Boolean));const x=(n.data||[]).map(I=>I.crisis_templates?.name||"Unknown Crisis").filter(Boolean);return{leader:_,leaderParty:m,coalitionParties:g,crises:x}}catch(t){return console.error("[World] fetchNationGovernmentData failed:",t),{leader:null,leaderParty:null,coalitionParties:[],crises:[]}}}async function Na(e,t){return{exportsToThem:{},importsFromThem:{},totalExports:0,totalImports:0,balance:0,tick:z.shard?.current_tick||0}}const $t={fta:"Free Trade Agreement",free_trade:"Free Trade Agreement",pta:"Preferential Trade",preferential_trade:"Preferential Trade",goods_trade:"Goods & Services Trade Agreement",resource_supply:"Resource Supply Contract",export_subsidy:"Export Subsidy",economic_aid:"Economic Aid",stockpile_purchase:"Stockpile Purchase",retaliatory_tariff:"Retaliatory Tariff",impose_embargo:"Embargo"},Ta=new Set(["trade_flow","transfer","market_access","tariff_reduction","exit_terms"]);function St(e,t){const o=(e||[]).filter(n=>(n.article_type||n.type)!=="duration");return o.length===0?t||null:o.every(n=>Ta.has(n.article_type||n.type))&&(t==="fta"||t===null||t===void 0||t==="pending")?"goods_trade":t}function Ao(e){if(!e)return'<div class="world-trade-loading">Loading trade data…</div>';if(e.totalExports===0&&e.totalImports===0)return'<div style="font-family:var(--font-mono);font-size:8px;color:var(--text-dim);font-style:italic;">No active trade routes.</div>';const t=new Set([...Object.keys(e.exportsToThem),...Object.keys(e.importsFromThem)]),o=[];for(const l of t){const s=e.exportsToThem[l]||0,c=e.importsFromThem[l]||0;o.push({sector:l,exp:s,imp:c,total:s+c})}o.sort((l,s)=>s.total-l.total);let a=`<table class="world-trade-table">
    ...
    </div>`,a}function Ca(e,t,o,a,n){const r=document.getElementById("world-highlight-body");if(!r)return;const i=t.nation?.id,l=e.id===i,s=n?.gov||{},c=n?.tradeData,u=Number(e.population||0),f=u>=1e6?(u/1e6).toFixed(1)+"M":u.toLocaleString(),_=e.flag_url||`assets/flags/${e.name}.png`;let m=`<div class="world-hl-header-row">
        ...
        <div class="ipo-preview-members">${f||'<div style="color:var(--text-dim);font-size:12px;">No members.</div>'}</div>`;return{org:a,members:n,headerHtml:_}}async function Pa(e,t){const o=document.getElementById("ipo-main");if(o){o.innerHTML='<div class="ipo-main-placeholder"><span class="ipo-main-placeholder-text">Loading organisation details...</span></div>';try{const a=await To(e);if(!a){o.innerHTML='<div class="ipo-main-placeholder"><span class="ipo-main-placeholder-text">Organisation not found.</span></div>';return}o.innerHTML=`
            ...
            <div class="ipo-sidebar-item ${m?"is-active":""}"
                ...
                ${qe(_,"ipo-sidebar-logo",m?"is-active":"")}
        ...
        <div class="ipo-main" id="ipo-main">
            ${u}
        </div>`,No(a.length+i),b&&L.length>0&&(Ma(b),te(b).then(()=>Ae()))}async function La(e){const t=L.find(R=>R.org.id===b);if(!t)return`<div class="ipo-main-placeholder">
        ...
        <div class="ipo-bottom-panels">
            <div class="ipo-panel ipo-panel--charter" id="ipo-panel-charter">
                ...
                <div class="ipo-panel-body">${Ga(a)}</div>
            </div>
        ...
        </div>`,N=d.map(R=>{const D=R.factions?.faction_name||"Unknown",j=R.factions?.nation_id&&x[R.factions.nation_id]||"",ee=R.faction_id===h.id,F=R.faction_id===o.president_id,W=R.role==="observer"?" (OBS)":"",H=F?" ★":"";return`<span class="ipo-footer-badge ${ee?"ipo-footer-badge--you":F?"ipo-footer-badge--president":"ipo-footer-badge--other"}">${H?'<span class="ipo-president-star">'+H+"</span>":""}${v(D)}${W}${ee?" (YOU)":""}${j?" · "+v(j):""}</span>`}).join(""),B=!!a.membership?.expulsionClause&&(a.membership.expulsionClause==="president"?r:!i),q=`
        ...
        </div>`;return T+w+M+q}let me=[],Wt={};async function Ma(e){if(!(!document.getElementById("ipo-chat-messages")||!e)){$e&&(p.removeChannel($e),$e=null);try{const{data:o}=await p.from("ipo_members").select("faction_id, chat_color, factions:faction_id ( faction_name )").eq("org_id",e).eq("is_active",!0);Wt={},(o||[]).forEach(a=>{Wt[a.faction_id]={name:a.factions?.faction_name||"Unknown",color:a.chat_color||"#6b6a5e"}})}catch(o){console.warn("[IPO Chat] Member map error:",o)}try{const{data:o,error:a}=await p.from("ipo_chat").select("id, faction_id, is_system, message_text, tick_posted, created_at").eq("org_id",e).order("created_at",{ascending:!1}).limit(100);a?(console.error("[IPO Chat] Fetch error:",a.message),me=[]):me=(o||[]).reverse()}catch(o){console.error("[IPO Chat] Fetch exception:",o),me=[]}Xt(),$e=p.channel("ipo_chat_"+e).on("postgres_changes",{event:"INSERT",schema:"public",table:"ipo_chat",filter:"org_id=eq."+e},o=>{const a=o.new;me.find(n=>n.id===a.id)||(me.push(a),Xt())}).subscribe()}}function Xt(){const e=document.getElementById("ipo-chat-messages");if(e){if(me.length===0){e.innerHTML='<div class="ipo-chat-system">— No messages yet —</div>';return}e.innerHTML=me.map(t=>{if(t.is_system)return`<div class="ipo-chat-system">— ${v(t.message_text)} —</div>`;const o=Wt[t.faction_id],a=o?.name||"Unknown",n=o?.color||"#6b6a5e",r=Ba(t.created_at);return`<div class="ipo-chat-msg">
...
You are the PRESIDENT. Leadership will pass to the next eligible member.`),!!confirm(a))try{const{error:n}=await p.from("ipo_members").update({is_active:!1,left_at_tick:k}).eq("org_id",b).eq("faction_id",h.id).eq("is_active",!0);if(n){alert("Failed to leave organisation: "+n.message);return}await p.from("ipo_chat").insert({org_id:b,faction_id:null,is_system:!0,message_text:`${h.faction_name} has left the organisation.`,tick_posted:k});const{data:r}=await p.from("ipo_members").select("faction_id, role").eq("org_id",b).eq("is_active",!0),i=(r||[]).filter(l=>l.role==="member");if(!r||r.length===0)await p.from("international_orgs").update({is_active:!1,dissolved_at_tick:k}).eq("id",b),await p.from("ipo_invitations").update({status:"expired",responded_at_tick:k}).eq("org_id",b).in("status",["pending","vote_pending"]),await p.from("ipo_votes").update({status:"failed",resolved_at_tick:k,result:{yes:0,no:0,abstain:0,passed:!1,reason:"Organisation dissolved"}}).eq("org_id",b).eq("status","open"),await p.from("ipo_chat").insert({org_id:b,faction_id:null,is_system:!0,message_text:"Organisation dissolved — no members remaining.",tick_posted:k});else if(o&&i.length>0){const l=i[0].faction_id;await p.from("international_orgs").update({president_id:l,president_term_start_tick:k}).eq("id",b);const{data:s}=await p.from("factions").select("faction_name").eq("id",l).single();await p.from("ipo_chat").insert({org_id:b,faction_id:null,is_system:!0,message_text:`${s?.faction_name||"A member"} is now president (previous president departed).`,tick_posted:k})}if(t?.headquarters_nation_id){const{data:l}=await p.from("ipo_members").select("faction_id, factions:faction_id ( nation_id )").eq("org_id",b).eq("is_active",!0);(l||[]).some(c=>c.factions?.nation_id===t.headquarters_nation_id)||(await p.from("international_orgs").update({headquarters_nation_id:null}).eq("id",b),await p.from("ipo_chat").insert({org_id:b,faction_id:null,is_system:!0,message_text:"Headquarters vacated — no member party remains in the HQ nation.",tick_posted:k}))}b=null,ie()}catch(n){console.error("[IPO] Leave org error:",n),alert("Failed to leave organisation.")}}function Va(e){e!==b&&(b=e,ie())}async function Ua(e){if(h)try{const{data:t,error:o}=await p.from("ipo_invitations").select("id, org_id, invited_role, status").eq("id",e).single();if(o||!t||t.status!=="pending"){alert("This invitation is no longer valid."),ie();return}const{data:a}=await p.from("international_orgs").select("charter").eq("id",t.org_id).single();if((a?.charter?.membership?.admission||"vote")==="vote"&&t.invited_role==="member"){if(!await ut(t.org_id)){alert(`This organisation already has ${Ze} open votes. Please try again later.`),P=!1;return}await p.from("ipo_invitations").update({status:"vote_pending",responded_at_tick:k}).eq("id",e),await p.from("ipo_votes").insert({org_id:t.org_id,title:`Admit ${h.faction_name}`,vote_type:"membership",meta:{invite_id:e,target_faction_id:h.id,target_faction_name:h.faction_name},status:"open",opened_at_tick:k,closes_at_tick:k+Qe,proposed_by:h.id}),await p.from("ipo_chat").insert({org_id:t.org_id,faction_id:null,is_system:!0,message_text:`${h.faction_name} has applied for membership. A vote has been opened.`,tick_posted:k}),alert("Your application has been submitted. The organisation will vote on your membership.")}else{let r=[{id:h.id,name:h.faction_name}];for(const l of r){const s=await Eo(t.org_id);await p.from("ipo_members").insert({org_id:t.org_id,faction_id:l.id,role:t.invited_role,joined_at_tick:k,chat_color:s})}await p.from("ipo_invitations").update({status:"accepted",responded_at_tick:k}).eq("id",e);const i=r.length>1?`${h.faction_name} and its ${r.length-1} faction(s) have joined the organisation.`:`${h.faction_name} has joined the organisation.`;await p.from("ipo_chat").insert({org_id:t.org_id,faction_id:null,is_system:!0,message_text:i,tick_posted:k})}ie()}catch(t){console.error("[IPO] Accept invite error:",t),alert("Failed to accept invitation.")}}async function Ya(e){if(h)try{const{data:t}=await p.from("ipo_invitations").select("org_id").eq("id",e).single();await p.from("ipo_invitations").update({status:"declined",responded_at_tick:k}).eq("id",e),t?.org_id&&await p.from("ipo_chat").insert({org_id:t.org_id,faction_id:null,is_system:!0,message_text:`${h.faction_name} declined the invitation to join.`,tick_posted:k}),ie()}catch(t){console.error("[IPO] Decline invite error:",t)}}function Ga(e,t){if(!e||Object.keys(e).length===0)return'<span class="ipo-main-placeholder-text">No charter defined.</span>';const o=[];if(e.mission!=null&&o.push(nt("Article I — Mission Statement",`<div class="ipo-charter-text">${v(e.mission)}</div>`)),e.leadership){const a=e.leadership,n={vote:"Vote",rotation:"Rotation",most_seats:"Most Seats",random:"Random"},r={equal:"Equal (one vote per member)",seat_share:"By Seat Share"},i={majority:"Majority (>50%)",unanimous:"Unanimous"};o.push(nt("Article II — Leadership",`
        ...
        `))}if(e.membership){const a=e.membership;let r=Y("New Member Admission",{vote:"Vote Required",president:"President Decides"}[a.admission]||a.admission);if(a.ideologicalThreshold?.enabled&&a.ideologicalThreshold.directions?.length>0){const i=a.ideologicalThreshold.directions.map(l=>`<span class="ipo-charter-tag">${v(l.charAt(0).toUpperCase()+l.slice(1))}</span>`).join(" ");r+=Y("Ideological Requirements",i)}else r+=Y("Ideological Threshold","None");a.expulsionClause?r+=Y("Expulsion Clause",{president:"President Only",majority:"Majority Vote",unanimous:"Unanimous Vote"}[a.expulsionClause]||a.expulsionClause):r+=Y("Expulsion Clause","Disabled"),o.push(nt("Article III — Membership",r))}if(e.governance){const a=e.governance,n={unilateral:"Unilateral — any member can execute actions",committee:"Committee — all actions require a vote (funded from solidarity fund)",presidential:"Presidential — only the president can execute actions",delegated:"Delegated — president + officers can act, others must vote",tiered:`Tiered — actions ≤${C(2*O)} are unilateral, higher cost requires a vote`},r={public:"Public Ballot",secret:"Secret Ballot"},i={founding:"Founding Party",president:"Current President",hq:"HQ Nation Party"};o.push(nt("Article IV — Transparency & Governance",`
        ...
        `))}if(e.resources){const a=e.resources,n={president:"President Alone",vote:"Majority Vote Required"};let r="";if(a.solidarityFund?.enabled){const i=(Number(a.solidarityFund.contributionPerQuarter)||1)*O;r+=Y("Solidarity Fund",C(i)+" / Quarter")}else r+=Y("Solidarity Fund","Disabled");a.resourceSharingCap!=null?r+=Y("Resource Sharing Cap",a.resourceSharingCap+" per member per term"):r+=Y("Resource Sharing Cap","No limit"),r+=Y("Joint Statements",n[a.jointStatementClause]||a.jointStatementClause),r+=Y("Headquarters",a.headquarters?"Active":"Not designated"),o.push(nt("Article V — Resources & External Relations",r))}return o.join('<div class="ipo-charter-divider"></div>')}function nt(e,t){return`
    ...
    </div>`}let G=null,le=null,Ye=null,Ge=null;function Wa(){if(!h||!b)return;const e=L.find(n=>n.org.id===b);if(!e)return;const t=e.org,o=t.charter||{};if(e.role==="observer"){alert("Observers cannot amend the charter.");return}G=[],o.mission!=null&&G.push({type:"mission",config:{text:o.mission}}),o.leadership&&G.push({type:"leadership",config:{...o.leadership}}),o.membership&&G.push({type:"membership",config:JSON.parse(JSON.stringify(o.membership))}),o.governance&&G.push({type:"governance",config:{...o.governance}}),o.resources&&G.push({type:"resources",config:JSON.parse(JSON.stringify(o.resources))}),G.find(n=>n.type==="mission")||G.unshift({type:"mission",config:{text:""}}),le={symbol:t.logo_symbol||"",text:t.logo_text||"",image_url:t.logo_image_url||null},Ye=null,Ge=t.logo_image_url||null,document.getElementById("ipo-create-modal").classList.add("active"),mt()}function mt(){const e=document.getElementById("ipo-create-modal-inner"),t=J;J=G;const o=G.map((c,u)=>jo(c,u)).join(""),a=new Set(G.map(c=>c.type)),n=At.filter(c=>!a.has(c.key)),i=G.length<5&&n.length>0?`
        ...
        <div class="ipo-modal-body">
            ...
            </div>`}else{const N=c.filter(j=>j.ballot==="yes").length,A=c.filter(j=>j.ballot==="no").length,B=c.filter(j=>j.ballot==="abstain").length,q=I>0?N/I*100:0,R=I>0?A/I*100:0,D=I>0?B/I*100:0;$=`<div class="ipo-vote-tally">
                <div class="ipo-vote-tally-bar">
                    <div class="ipo-vote-tally-seg ipo-vote-tally-seg--yes" style="width:${q}%"></div>
            ...
            <div class="ipo-vote-card ${f?"ipo-vote-card--open":""} ${_?"ipo-vote-card--passed":""} ${s.status==="failed"?"ipo-vote-card--failed":""}">
                ...
                ${qe(i,"ipo-vote-logo-preview","")}
                <span style="color:var(--text-muted);">→</span>
                ${qe(l,"ipo-vote-logo-preview","")}
            </div>`;break}}return o?`<div class="ipo-vote-meta-summary">${o}</div>`:""}let ue=null,X=null,fe=null,Ee=null;function on(){if(!h||!b)return;const e=L.find(o=>o.org.id===b);if(!e||e.role==="observer")return;ue=null,X=null,fe=null,Ee=null,document.getElementById("ipo-create-modal").classList.add("active"),Mo()}function Lo(){document.getElementById("ipo-create-modal").classList.remove("active"),ue=null,X=null,fe=null,Ee=null}function an(e){const t=e?.files?.[0];if(t){if(t.size>512*1024){alert("Logo must be under 512KB.");return}fe=t,Ee=URL.createObjectURL(t),ao()}}function nn(){fe=null,Ee=null,X&&(X.image_url=null),ao()}function Mo(){const e=document.getElementById("ipo-create-modal-inner"),o=L.find(i=>i.org.id===b)?.org,a=o?.charter||{},n=[];(a.membership?.admission||"vote")==="vote"&&n.push("membership"),(a.membership?.expulsionClause==="majority"||a.membership?.expulsionClause==="unanimous")&&n.push("expulsion"),(a.resources?.jointStatementClause||"vote")==="vote"&&n.push("joint_statement"),a.resources?.solidarityFund?.enabled&&n.push("fund_draw"),n.push("charter_amendment"),n.push("change_logo"),n.push("change_headquarters"),(o.symposium_cooldown_remaining||0)<=0&&!o.pending_symposium&&n.push("symposium");const r=n.map(i=>`
        <button class="ipo-vote-type-card" onclick="selectIPOVoteType('${i}')">
            <span class="ipo-vote-type-card-label">${oo[i]}</span>
            <span class="ipo-vote-type-card-desc">${Za[i]}</span>
        </button>
    `).join("");e.innerHTML=`
        <div class="ipo-modal-header">
        ...
        <div class="ipo-modal-body">
            <div class="ipo-vote-type-grid">${r}</div>
        </div>`}async function rn(e){if(ue=e,e==="change_logo"){const o=L.find(a=>a.org.id===b)?.org;X={symbol:o?.logo_symbol||"",text:o?.logo_text||"",image_url:o?.logo_image_url||null},fe=null,Ee=o?.logo_image_url||null}await ao()}async function ao(){const e=document.getElementById("ipo-create-modal-inner"),o=L.find(i=>i.org.id===b)?.org,a=oo[ue];let n="";switch(ue){case"membership":{const{data:i}=await p.from("ipo_invitations").select("id, target_faction_id, status, factions:target_faction_id ( faction_name )").eq("org_id",b).eq("status","vote_pending"),l=(i||[]).map(s=>`<option value="${s.id}" data-name="${v(s.factions?.faction_name||"Unknown")}" data-fid="${s.target_faction_id}">${v(s.factions?.faction_name||"Unknown")}</option>`).join("");l?n=`
                ...
                </select>`;break}case"change_logo":{const i=Ee?`<img src="${v(Ee)}" style="width:48px;height:48px;object-fit:cover;border-radius:6px;border:1px solid var(--border-0);" />`:`<span style="display:inline-flex;align-items:center;justify-content:center;width:48px;height:48px;background:var(--bg-3);border:1px solid var(--border-0);border-radius:6px;font-family:var(--font-mono);font-size:14px;color:var(--text-dim);">${v((X?.symbol||"")+" "+(X?.text||""))}</span>`;n=`
                ...
                <div style="display:flex;gap:12px;align-items:flex-start;margin-top:8px;">
                    ...
                    <div style="flex:1;">
                        ...
                        <div style="display:flex;gap:6px;align-items:center;">
                            ...
                            ${Ee?'<button onclick="ipoVoteRemoveLogo()" style="font-family:var(--font-mono);font-size:8px;padding:3px 8px;background:none;border:1px solid rgba(217,83,79,0.3);color:var(--red);cursor:pointer;border-radius:2px;">Remove</button>':""}
...
Proceed?`))return;try{await p.from("international_orgs").update({emergency_power_used_tick:k}).eq("id",b),await p.from("ipo_chat").insert({org_id:b,faction_id:null,is_system:!0,message_text:`⚡ ${h.faction_name} has invoked EMERGENCY POWERS to execute: ${e.replace(/_/g," ")}.`,tick_posted:k});try{const a=L.find(i=>i.org.id===b)?.org?.name||"An organisation",{data:n}=await p.from("ipo_members").select("nation_id").eq("org_id",b),r=[...new Set((n||[]).map(i=>i.nation_id).filter(Boolean))];for(const i of r)await p.from("event_log").insert({nation_id:i,event_name:"Emergency Powers Invoked",description_chosen:`${a}: ${h.faction_name} invoked emergency powers to ${e.replace(/_/g," ")}.`,category:"DIPLOMATIC",fired_at_tick:k})}catch{}}catch(o){alert("Failed to invoke emergency powers: "+(o.message||"Unknown error"));return}}switch(e){case"hold_rally":await _n();break;case"rally_all":await yn();break;case"back_channel":hn();break;case"joint_statement":wn();break;case"fund_draw":kn();break}}}async function _n(){if(P)return;const e=Q.hold_rally,t=be.filter(n=>n.faction_id!==h.id&&n.is_active);if(t.length===0){alert("No other members in this organisation to rally for.");return}const o=t.map(n=>`<option value="${n.faction_id}">${v(n.factions?.faction_name||"Unknown")}</option>`).join(""),a=document.getElementById("ipo-create-modal-inner");document.getElementById("ipo-create-modal").classList.add("active"),a.innerHTML=`
        ...
        </div>`}async function $n(){if(P)return;const e=document.getElementById("ipo-direct-stmt")?.value?.trim();if(!e){alert("Please write the statement.");return}const t=Q.joint_statement;P=!0;try{const o=await He(h.id,t);if(!o.success){alert(`Insufficient cash. You need ${C(t)}.`);return}h.party_funds=o.newFunds,await p.from("ipo_action_log").insert({org_id:b,faction_id:h.id,action_type:"joint_statement",action_data:{statement_text:e,by_president:!0},ap_cost:t,performed_at_tick:k}),await p.from("ipo_chat").insert({org_id:b,faction_id:null,is_system:!0,message_text:`JOINT STATEMENT (by president): "${e}"`,tick_posted:k});const n=L.find(r=>r.org.id===b)?.org?.name||"International Organisation";try{const{data:r}=await p.from("ipo_members").select("nation_id").eq("org_id",b),i=[...new Set((r||[]).map(l=>l.nation_id).filter(Boolean))];for(const l of i)await p.from("event_log").insert({nation_id:l,event_name:"Joint Statement",description_chosen:`${n}: "${e}"`,category:"DIPLOMATIC",fired_at_tick:k})}catch(r){console.warn("[IPO] Joint statement event_log insert failed (non-blocking):",r)}Ne(),Ae(),alert("Statement published.")}catch(o){console.error("[IPO Action] Statement error:",o),alert("Failed to publish statement.")}finally{P=!1}}function kn(){const e=L.find(a=>a.org.id===b),t=Number(e?.org?.solidarity_fund_balance)||0,o=document.getElementById("ipo-create-modal-inner");document.getElementById("ipo-create-modal").classList.add("active"),o.innerHTML=`
        <div class="ipo-modal-header">
        ...
        </div>`}function Sn(e,t){const o=document.getElementById("ipo-create-modal-inner");document.getElementById("ipo-create-modal").classList.add("active");const a=t.map(n=>{const r=ct.find(i=>i.id===n.outcome_id)||ct[1];return`
        ...
        </div>`}function Ne(){document.getElementById("ipo-create-modal").classList.remove("active"),Be=null,no=1}let Ue=1,ve="",Je="",Te="◈",ce="",ge=null,ye=null,J=[];const At=[{key:"mission",label:"I — Mission Statement",required:!0,maxOne:!0},{key:"leadership",label:"II — Leadership",required:!1,maxOne:!0},{key:"membership",label:"III — Membership",required:!1,maxOne:!0},{key:"governance",label:"IV — Transparency & Governance",required:!1,maxOne:!0},{key:"resources",label:"V — Resources & External Relations",required:!1,maxOne:!0}],An=[{axis:"Individualism / Collectivism",poles:["Individualism","Collectivism"]},{axis:"Tradition / Progress",poles:["Tradition","Progress"]},{axis:"Liberty / Equality",poles:["Liberty","Equality"]},{axis:"Freedom / Security",poles:["Freedom","Security"]},{axis:"Globalism / Nationalism",poles:["Globalism","Nationalism"]}];function Nn(){Ue=1,ve="",Je="",Te="◈",ce="",ge=null,ye=null,J=[{type:"mission",config:{text:""}}],document.getElementById("ipo-create-modal").classList.add("active"),Nt()}function zo(){document.getElementById("ipo-create-modal").classList.remove("active"),ge=null,ye=null}function Nt(){const e=document.getElementById("ipo-create-modal-inner"),t=[1,2,3].map(a=>`<div class="wizard-step ${a===Ue?"active":a<Ue?"completed":""}">
            <span class="wizard-step-num">${a}</span> ${["Identity","Charter","Confirm"][a-1]}
        </div>`).join("");let o="";Ue===1?o=Tn():Ue===2?o=On():o=Un(),e.innerHTML=`
        <div class="ipo-modal-header">
        ...
        <div class="ipo-modal-body">${o}</div>`}function Tn(){const e=ka.map(t=>`<button class="ipo-symbol-btn ${t===Te?"selected":""}"
        ...
        </div>`}function Cn(e){Te=e,document.querySelectorAll(".ipo-symbol-btn").forEach(o=>{o.classList.toggle("selected",o.textContent.trim()===e)});const t=document.getElementById("ipo-create-logo-preview");t&&(t.innerHTML=`Preview: ${Te} ${v(ce)||"..."}`)}function Pn(e){const t=e.files[0],o=document.getElementById("ipo-logo-upload-error");if(!t)return;if(!["image/png","image/jpeg","image/webp"].includes(t.type)){o&&(o.textContent="Only PNG, JPG, or WebP images allowed.",o.style.display=""),e.value="";return}if(t.size>2*1024*1024){o&&(o.textContent="Image must be under 2 MB.",o.style.display=""),e.value="";return}o&&(o.style.display="none"),ge=t;const a=new FileReader;a.onload=function(n){ye=n.target.result;const r=document.getElementById("ipo-logo-upload-zone");if(r&&(r.innerHTML=`<img src="${ye}" class="ipo-logo-upload-preview" alt="preview" />
                <div style="font-size:9px;color:var(--text-tertiary);margin-top:4px;">Click to replace</div>`),!r?.parentElement?.querySelector(".ipo-logo-remove-btn")&&r?.parentElement){const l=document.createElement("button");l.className="ipo-logo-remove-btn",l.style.cssText="margin-top:4px;font-size:9px;color:#d9534f;background:none;border:1px solid #d9534f33;padding:2px 8px;border-radius:3px;cursor:pointer;",l.textContent="Remove Image",l.onclick=function(){Do()},r.parentElement.insertBefore(l,r.nextSibling)}},a.readAsDataURL(t)}function Do(){ge=null,ye=null;const e=document.getElementById("ipo-logo-upload-zone");e&&(e.innerHTML=`<div style="font-size:18px;color:var(--text-tertiary);">⬆</div>
            <div style="font-size:10px;color:var(--text-tertiary);">Click to upload</div>
            <div style="font-size:8px;color:var(--text-quaternary);margin-top:2px;">PNG · JPG · WebP</div>`);const t=document.querySelector(".ipo-logo-remove-btn");t&&t.remove();const o=document.getElementById("ipo-logo-file-input");o&&(o.value="");const a=document.getElementById("ipo-logo-upload-error");a&&(a.style.display="none")}function On(){const e=J.map((i,l)=>jo(i,l)).join(""),t=new Set(J.map(i=>i.type)),o=At.filter(i=>!t.has(i.key)),n=J.length<5&&o.length>0?`
        <div class="ipo-add-article-row">
            <select id="ipo-add-article-select" style="font-size:0.75rem;padding:4px 8px;background:var(--bg-1);color:var(--text-primary);border:1px solid var(--border-hair);border-radius:3px;">
                <option value="">Add article...</option>
        ...
        </div>`}function Ln(){const e=J.find(t=>t.type==="mission");return e&&(e.config.text||"").trim().length>0}function Mn(){const e=document.getElementById("ipo-add-article-select");if(!e||!e.value)return;const t=e.value,o={leadership:{type:"rotation",termYears:2,votingWeight:"equal",votePass:"majority"},membership:{admission:"vote",ideologicalThreshold:{enabled:!1,directions:[]},expulsionClause:null},governance:{actionLeadership:"unilateral",voteTransparency:"public",observerStatus:!1,vetoRight:null,emergencyPowers:!1},resources:{solidarityFund:{enabled:!1,contributionPerQuarter:1},resourceSharingCap:null,jointStatementClause:"vote",headquarters:null}};et().push({type:t,config:o[t]||{}}),ft()}function Bn(e){const t=et();t[e]?.type!=="mission"&&(t.splice(e,1),ft())}function jo(e,t){const a=At.find(l=>l.key===e.type)?.label||e.type,r=e.type!=="mission"?`<button class="ipo-article-remove" onclick="ipoRemoveArticle(${t})">&times;</button>`:"";let i="";switch(e.type){case"mission":i=Rn(e,t);break;case"leadership":i=Fn(e,t);break;case"membership":i=qn(e,t);break;case"governance":i=zn(e,t);break;case"resources":i=Dn(e,t);break}return`
        ...
        <div style="font-family:var(--font-mono);font-size:7px;color:#4a4840;margin-top:2px;">${(e.config.text||"").length}/300</div>`}function Fn(e,t){const o=e.config;return`
        ...
        ${Qt("Succession Term",t,"termYears",[1,2,3,4,5,6,7].map(a=>({value:a,label:a+" Year"+(a>1?"s":"")})),o.termYears)}
        ...
        ${_e("Vote Pass Threshold",t,"votePass",[{value:"majority",label:"Majority",hint:">50% of votes cast"},{value:"unanimous",label:"Unanimous",hint:"All members must vote yes"}],o.votePass)}`}function qn(e,t){const o=e.config,a=o.ideologicalThreshold||{enabled:!1,directions:[]},n=a.directions||[],r=An.map(i=>{const l=i.poles.map(s=>{const c=n.includes(s.toLowerCase()),u=i.poles.find(_=>_!==s),f=n.includes(u.toLowerCase());return`<label class="ipo-ideology-check ${f?"ipo-disabled":""}" style="margin-right:12px;">
        ...
        ${Se("Ideological Threshold",t,"ideologicalThreshold.enabled",a.enabled)}
        ${a.enabled?`<div class="ipo-ideology-grid">${r}</div>`:""}
        ${Se("Expulsion Clause",t,"expulsionClauseEnabled",!!o.expulsionClause)}
        ${o.expulsionClause?_e("Expulsion Method",t,"expulsionClause",[{value:"president",label:"President Only",hint:""},{value:"majority",label:"Majority Vote",hint:""},{value:"unanimous",label:"Unanimous Vote",hint:""}],o.expulsionClause):""}`}function zn(e,t){const o=e.config;return`
        ...
        ${Se("Observer Status",t,"observerStatus",o.observerStatus)}
        ${Se("Veto Right",t,"vetoRightEnabled",!!o.vetoRight)}
        ...
        ${Se("Emergency Powers",t,"emergencyPowers",o.emergencyPowers)}`}function Dn(e,t){const o=e.config,a=o.solidarityFund||{enabled:!1,contributionPerQuarter:1};return`
        ${Se("Solidarity Fund",t,"solidarityFund.enabled",a.enabled)}
        ${a.enabled?Qt("Contribution Rate",t,"solidarityFund.contributionPerQuarter",[1,2,3].map(n=>({value:n,label:C(n*O)+" / Quarter"})),a.contributionPerQuarter):""}
        ${Se("Resource Sharing Cap",t,"resourceSharingCapEnabled",o.resourceSharingCap!=null)}
        ${o.resourceSharingCap!=null?Qt("Max Uses Per Term",t,"resourceSharingCap",[1,2,3].map(n=>({value:n,label:n+" time"+(n>1?"s":"")})),o.resourceSharingCap||1):""}
        ...
        ${Se("Headquarters",t,"headquartersEnabled",o.headquarters!=null)}
        ...
        </div>`}function Qt(e,t,o,a,n){const r=a.map(i=>`<option value="${i.value}" ${i.value==n?"selected":""}>${i.label}</option>`).join("");return`
        <div class="trade-field">
            <label>${e}</label>
        ...
        </div>`}function Se(e,t,o,a){return`
        ...
        </div>`}function et(){return G||J}function ft(){G?mt():Nt()}function jn(e,t,o){const a=et()[e];if(!a)return;const n=t.split(".");let r=a.config;for(let l=0;l<n.length-1;l++)r[n[l]]||(r[n[l]]={}),r=r[n[l]];const i=Number(o);r[n[n.length-1]]=isNaN(i)?o:i,ft()}function Hn(e,t){const o=et()[e];if(o){if(t==="ideologicalThreshold.enabled")o.config.ideologicalThreshold||(o.config.ideologicalThreshold={enabled:!1,directions:[]}),o.config.ideologicalThreshold.enabled=!o.config.ideologicalThreshold.enabled;else if(t==="expulsionClauseEnabled")o.config.expulsionClause=o.config.expulsionClause?null:"majority";else if(t==="vetoRightEnabled")o.config.vetoRight=o.config.vetoRight?null:"president";else if(t==="resourceSharingCapEnabled")o.config.resourceSharingCap=o.config.resourceSharingCap!=null?null:2;else if(t==="headquartersEnabled")o.config.headquarters=o.config.headquarters!=null?null:"__self__";else if(t==="solidarityFund.enabled")o.config.solidarityFund||(o.config.solidarityFund={enabled:!1,contributionPerQuarter:1}),o.config.solidarityFund.enabled=!o.config.solidarityFund.enabled;else{const a=t.split(".");let n=o.config;for(let r=0;r<a.length-1;r++)n[a[r]]||(n[a[r]]={}),n=n[a[r]];n[a[a.length-1]]=!n[a[a.length-1]]}ft()}}function Vn(e,t,o){const a=et()[e];if(!a)return;const n=a.config.ideologicalThreshold;n&&(o?n.directions.includes(t)||n.directions.push(t):n.directions=n.directions.filter(r=>r!==t),ft())}function Un(){const e=4*O,t=Math.max(0,J.length-1),o=t*O,a=e+o,n=J.map(r=>`<div class="ipo-confirm-article">
            <span class="ipo-confirm-article-label">${At.find(l=>l.key===r.type)?.label||r.type}</span>
            <span class="ipo-confirm-article-detail">${Yn(r)}</span>
        </div>`).join("");return`
        <div class="ipo-confirm-preview">
            <div class="ipo-confirm-identity">
                ${ye?`<img src="${ye}" class="ipo-header-logo ipo-logo-img" alt="" />`:`<span class="ipo-header-logo">${v(Te)} ${v(ce)}</span>`}
                <div>
    ...
    `,document.getElementById("trade-neg-modal").classList.add("active");const _=document.getElementById("trade-neg-chat-input-bar"),m=document.getElementById("trade-neg-chat-messages");if(l.canChat){_.style.display="flex",_.innerHTML=`
        ...
        `;const g=document.getElementById("trade-neg-chat-input"),x=document.getElementById("trade-neg-chat-send");g.addEventListener("input",()=>{x.disabled=!g.value.trim()}),g.addEventListener("keydown",I=>{I.key==="Enter"&&!I.shiftKey&&g.value.trim()&&(I.preventDefault(),_o())}),x.addEventListener("click",()=>_o())}else _.style.display="none";gt(),Kn(),lo();const d=document.getElementById("trade-neg-name-btn");d&&y.agreementName&&y.agreementName.trim()&&(d.style.borderColor="var(--green)",d.style.color="var(--green)",d.textContent="Rename Agreement"),await Qn(r.id),Jn(r.id)}catch(t){alert("Trade negotiation error: "+(t.message||t))}finally{bt=!1}}}function io(e){const t=z?.faction?.id;if(e.is_system)return`<div class="trade-neg-msg trade-neg-msg--system">${v(e.message_text)}</div>`;const o=e.sender_faction_id===t,a=o?"trade-neg-msg trade-neg-msg--sent":"trade-neg-msg trade-neg-msg--received",n=o?"":`<div class="trade-neg-msg__sender">${v(e.sender_display_name)}</div>`,r=e.created_at?new Date(e.created_at).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}):"";return`<div class="${a}">
        ${n}
        <div>${v(e.message_text)}</div>
        <div class="trade-neg-msg__time">${r}</div>
    </div>`}async function Qn(e){const t=document.getElementById("trade-neg-chat-messages");if(!t)return;const{data:o,error:a}=await p.from("negotiation_messages").select("*").eq("negotiation_id",e).order("created_at",{ascending:!0}).limit(200);if(a){t.innerHTML='<div style="padding:20px;text-align:center;color:#c55;font-family:var(--font-mono);font-size:10px;">Failed to load messages.</div>';return}if(!o||o.length===0){const n=y?.chatRole?.canChat;y?.partnerNationName,t.innerHTML=n?'<div style="display:flex;align-items:center;justify-content:center;height:100%;color:var(--text-dim);font-family:var(--font-mono);font-size:10px;">No messages yet. Start the conversation.</div>':`<div style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:8px;padding:20px;">
            ...
            </div>`;return}t.innerHTML=o.map(n=>io(n)).join(""),t.scrollTop=t.scrollHeight}let yt=!1;async function _o(){if(yt||!y?.chatRole?.canChat)return;const e=document.getElementById("trade-neg-chat-input"),t=document.getElementById("trade-neg-chat-send");if(!e)return;const o=e.value.trim();if(!o)return;yt=!0,t&&(t.disabled=!0),e.value="";const{data:a}=await p.from("shard").select("current_tick").eq("name","Alpha Shard").single(),n=a?.current_tick||0,r={negotiation_id:y.negotiationId,sender_nation_id:y.myNationId,sender_faction_id:z.faction.id,sender_role:y.chatRole.role,sender_display_name:y.chatRole.displayName,message_text:o,is_system:!1,sent_at_tick:n},{error:i}=await p.from("negotiation_messages").insert(r);if(i)e.value=o,alert("Failed to send: "+i.message);else{const l=document.getElementById("trade-neg-chat-messages");if(l){const s=l.querySelector('[style*="justify-content:center"]');s&&!l.querySelector(".trade-neg-msg")&&s.remove(),l.insertAdjacentHTML("beforeend",io({...r,created_at:new Date().toISOString()})),l.scrollTop=l.scrollHeight}}yt=!1,t&&(t.disabled=!e.value.trim()),e.focus()}function Jn(e){Re&&(p.removeChannel(Re),Re=null),Re=p.channel("neg-chat-"+e).on("postgres_changes",{event:"INSERT",schema:"public",table:"negotiation_messages",filter:`negotiation_id=eq.${e}`},t=>{const o=t.new;if(!o||o.sender_faction_id===z?.faction?.id)return;const a=document.getElementById("trade-neg-chat-messages");if(!a)return;const n=a.querySelector('[style*="justify-content:center"]');n&&!a.querySelector(".trade-neg-msg")&&n.remove(),a.insertAdjacentHTML("beforeend",io(o)),a.scrollTop=a.scrollHeight,o.is_system&&o.message_text?.includes("withdrawn")&&(y&&(y.status="cancelled"),setTimeout(()=>{Ct(),alert("The other party has withdrawn from negotiations."),eo().then(()=>{pt(),Fe()}).catch(()=>{})},500))}).subscribe()}function Kn(){if(!y)return;const e=y.partnerNationId,t=document.getElementById("trade-neg-my-econ");t&&(t.innerHTML=Zn());const o=document.getElementById("trade-neg-their-econ");o&&(o.innerHTML=ei(e))}function Zn(){const e=Io(),t=xt(z?.nation).map(r=>({...r,tradingDelta:Number(e[r.key])||0})).sort((r,i)=>{const l=Math.abs(r.prod-r.dem+r.tradingDelta);return Math.abs(i.prod-i.dem+i.tradingDelta)-l}),o=r=>Math.round(Number(r)||0).toString(),a=r=>Math.abs(r)<.5?"—":(r>0?"+":"-")+Math.abs(Math.round(r));let n=`<div class="trade-neg-econ__head">
    ...
    <div class="trade-neg-econ__list">`;if(t.length===0)n+='<div class="trade-neg-econ__empty">No flow data yet.</div>';else for(const r of t){const i=r.prod-r.dem+r.tradingDelta,l=i>.5?"trade-neg-econ__bal--pos":i<-.5?"trade-neg-econ__bal--neg":"trade-neg-econ__bal--neu";n+=`<div class="trade-neg-econ__row">
            ...
            </div>`}return n+="</div>",n}function ei(e){const t=(K||[]).find(u=>u.id===e),o=xt(t),a=xt(z?.nation),n=new Set(a.filter(u=>u.dem-u.prod>.5).map(u=>u.key)),r=new Set(a.filter(u=>u.prod-u.dem>.5).map(u=>u.key)),i=[],l=[];for(const u of o){const f=u.prod-u.dem,_={key:u.key,name:u.name,icon:u.icon,amount:Math.abs(f)};f>.5?i.push(_):f<-.5&&l.push(_)}i.sort((u,f)=>f.amount-u.amount),l.sort((u,f)=>f.amount-u.amount);const s=u=>Math.round(Number(u)||0).toString(),c=(u,f,_,m)=>{let d=`<div class="trade-neg-econ__section">
            ...
            <div class="trade-neg-econ__list">`;if(_.length===0)d+='<div class="trade-neg-econ__empty">No data</div>';else for(const g of _){const x=m.has(g.key);d+=`<div class="trade-neg-econ__row--simple ${x?"trade-neg-econ__row--match":""}">
                ...
                </div>`}return d+="</div></div>",d};return c("They Can Offer","trade-neg-econ__head--offer",i,n)+c("They Need","trade-neg-econ__head--need",l,r)}function gt(){const e=document.getElementById("trade-neg-articles");if(!e||!y)return;const t=y.articles||[],o=y.myNationId,a=y.status==="ratification"||!!y.approvedByA&&!!y.approvedByB;if(t.length===0){e.innerHTML='<div style="display:flex;align-items:center;justify-content:center;height:100%;min-height:200px;color:var(--text-dim);font-family:var(--font-mono);font-size:11px;">No articles yet. Click "Add Text Article" to begin drafting.</div>';return}const n=["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];let r="";for(let i=0;i<t.length;i++){const l=t[i],s=n[i]||i+1,c=l.author_nation_id===o,u=!!l.strike_requested_by,f=l.strike_requested_by===o,_=l.article_type?Vo(l):v(l.text),m=l.article_type?`<span style="font-family:var(--font-mono);font-size:7px;font-weight:700;letter-spacing:0.5px;padding:1px 5px;color:var(--accent);background:rgba(90,175,165,0.08);border:1px solid rgba(90,175,165,0.15);margin-left:6px;vertical-align:middle;">${v(l.article_type.replace("_"," ").toUpperCase())}</span>`:"";let d="";if(l.article_type==="trade_flow"&&l.data){const g=l.data,x=l.author_nation_id?l.author_nation_id===y.myNationId:!0,I=x?y.myNationId:y.partnerNationId,$=x?y.partnerNationId:y.myNationId,E=x?y.myNationName:y.partnerNationName,T=x?y.partnerNationName:y.myNationName,w=g.direction==="a_buys_b"?I:$,S=g.direction==="a_buys_b"?E:T;if(w===y.myNationId&&se[g.commodity]){const N=se[g.commodity],A=Number(N.import_demand||0),B=Number(N.import_volume||0),q=Math.max(0,A-B);d=`<div style="font-family:var(--font-mono);font-size:9px;color:${Number(g.volume||0)>q?"var(--amber)":"var(--green)"};margin-top:4px;">
                    ${v(S)}'s remaining demand: ${Jt(q)}/tick
                    ${q>0?"(after domestic production and existing trade)":"(fully supplied)"}
            ...
            </div>`,u&&!f){const g=l.strike_requested_by_name||"The other party";r+=`<div class="trade-neg-article__strike">${v(g)} is requesting this article be removed.</div>`}r+="</div>"}e.innerHTML=r}function ro(){const e=document.getElementById("trade-neg-add-article-form");e&&requestAnimationFrame(()=>{try{e.scrollIntoView({behavior:"smooth",block:"start"})}catch{}})}function ti(){if(y?.approvedByA&&y?.approvedByB)return;const e=document.getElementById("trade-neg-add-article-form");if(!e||!y)return;const t=y.agreementName||"";e.style.display="block",e.innerHTML=`<div class="trade-neg-add-form">
    ...
    </div>`,document.getElementById("neg-name-input")?.focus(),ro()}let it=!1;async function oi(){if(it||!y)return;const t=(document.getElementById("neg-name-input")?.value||"").trim();if(!t){alert("Enter a name for the agreement.");return}it=!0;const{error:o}=await p.from("trade_negotiations").update({agreement_name:t}).eq("id",y.negotiationId);if(o){alert("Failed to save name: "+o.message),it=!1;return}y.agreementName=t;const a=document.getElementById("trade-neg-title-text");a&&(a.textContent=t);const n=document.getElementById("trade-neg-name-btn");n&&(n.style.borderColor="var(--green)",n.style.color="var(--green)",n.textContent="Rename Agreement"),Ke(),it=!1}window.negNameAgreementOpen=ti;window.negNameAgreementSave=oi;function Vo(e){const t=e.data||{},o=e.author_nation_id?e.author_nation_id===y?.myNationId:!0,a=o?y?.myNationName||"Nation A":y?.partnerNationName||"Nation A",n=o?y?.partnerNationName||"Nation B":y?.myNationName||"Nation B",r=i=>Ko[i]?.label||It[i]||i||"Unknown";switch(e.article_type){case"transfer":{const i=t.direction==="a_to_b"?a+" → "+n:n+" → "+a,l=t.transfer_type==="recurring"?"Recurring":"One-Time",s=t.transfer_type==="recurring"?" per tick":"";return`${l} Transfer: $${Jt(t.amount)} ${i}${s}`}case"trade_flow":{const i=t.direction==="a_buys_b"?a+" buys from "+n:n+" buys from "+a,l=t.duration===0?"Continuous":t.duration+" ticks",s=t.delivery_priority?` · Delivery: ${t.delivery_priority.charAt(0).toUpperCase()+t.delivery_priority.slice(1)}`:"",c=Math.round(Number(t.volume)||0).toLocaleString();return`${r(t.commodity)}: ${i}, ${c} units/tick. Duration: ${l}${s}`}case"tariff_reduction":{const i=r(t.sector),l=t.mode==="reciprocal"?"Reciprocal":"One-sided";return`${i} Tariff Reduction (${l}): ${a}→${n} ${t.a_tariff_from||"?"}% → ${t.a_tariff_to||"?"}%, ${n}→${a} ${t.b_tariff_from||"?"}% → ${t.b_tariff_to||"?"}%`}case"market_access":{const i=t.scope==="all_goods"?"All Goods":r(t.scope_sector),l={restricted:"Restricted",preferential:"Preferential (reduced tariffs)",free_trade:"Free Trade (0%)"},s=[];return t.volume_priority&&s.push("Volume priority"),t.price_priority&&s.push("Price priority"),`Market Access — ${i}: ${l[t.level]||t.level}${s.length?". "+s.join(", "):""}`}case"exit_terms":{const i=[];i.push("Min duration: "+(t.min_duration||0)+" ticks"),i.push("Exit notice: "+(t.exit_notice||0)+" ticks");const l={none:"No penalty",fixed:"Fixed $"+Jt(t.penalty_amount||0),percentage:(t.penalty_pct||0)+"% of remaining value"};return i.push(l[t.penalty_type]||"No penalty"),`Exit Terms: ${i.join(", ")}`}default:return e.text||"Unknown article type"}}function Jt(e){const t=Number(e)||0;return t>=1e9?(t/1e9).toFixed(1)+"B":t>=1e6?(t/1e6).toFixed(1)+"M":t>=1e3?(t/1e3).toFixed(0)+"k":t.toLocaleString()}const ai=[{key:"transfer",label:"TRANSFER",desc:"One-time or recurring financial transfer between nations."},{key:"trade_flow",label:"TRADE FLOW",desc:"Establish a commodity trade route with volume and price terms."},{key:"tariff_reduction",label:"TARIFF REDUCTION",desc:"Reduce tariffs on a specific sector for one or both nations."},{key:"market_access",label:"MARKET ACCESS",desc:"Grant preferential or free trade access to sectors or all goods."},{key:"exit_terms",label:"EXIT TERMS",desc:"Define minimum duration, exit notice period, and withdrawal penalties."}];let re=null;function ni(){if(y?.approvedByA&&y?.approvedByB)return;re=null;const e=document.getElementById("trade-neg-add-article-form");if(!e)return;e.style.display="block";let t='<div class="trade-neg-add-form">';t+='<div class="trade-neg-add-form__label">Select Article Type</div>';for(const o of ai)t+=`<div onclick="negStructuredArticleSelectType('${o.key}')" style="
        ...
        </div>`;t+='<div class="trade-neg-add-form__actions">',t+='<button onclick="negArticleCancelForm()" style="padding:6px 14px;font-family:var(--font-mono);font-size:10px;font-weight:700;color:var(--text-dim);border:1px solid var(--border-main);background:transparent;cursor:pointer;">Cancel</button>',t+="</div></div>",e.innerHTML=t,ro()}function ii(e){switch(re=e,e){case"transfer":return ri();case"trade_flow":return si();case"tariff_reduction":return ci();case"market_access":return di();case"exit_terms":return pi()}}function ri(){const e=document.getElementById("trade-neg-add-article-form");if(!e)return;const t=y?.myNationName||"Nation A",o=y?.partnerNationName||"Nation B";e.innerHTML=`<div class="trade-neg-add-form">
    ...
    </div>`}function si(){const e=document.getElementById("trade-neg-add-article-form");if(!e)return;const t=y?.myNationName||"Nation A",o=y?.partnerNationName||"Nation B",a=[{value:"energy",label:"⚡ Energy"},{value:"minerals",label:"⛏ Minerals"},{value:"food",label:"🌾 Food"},{value:"consumer_goods",label:"📦 Consumer Goods"},{value:"luxury_goods",label:"💎 Luxury Goods"}].map(n=>`<option value="${n.value}">${n.label}</option>`).join("");e.innerHTML=`<div class="trade-neg-add-form">
    ...
    </div>`,setTimeout(()=>{so("cheapest"),Uo()},0),li().then(()=>Yo())}function Uo(){const e=document.getElementById("neg-flow-direction"),t=document.getElementById("neg-flow-delivery-picker"),o=document.getElementById("neg-flow-priority-note");if(!e||!t)return;const n=(e.value||"a_buys_b")==="a_buys_b";n||so("cheapest"),t.style.opacity=n?"1":"0.45",t.style.pointerEvents=n?"auto":"none",o&&(o.textContent=n?"After ratification, every shipping corp can offer a route. The system auto-awards based on this preference (cheapest is also the universal tiebreaker).":"Locked — only the buyer chooses delivery preference (they pay the freight). Defaults to cheapest.")}window.negFlowSyncPriorityLock=Uo;let Kt="cheapest";function so(e){if(!["fastest","safest","cheapest"].includes(e))return;Kt=e;const t=document.getElementById("neg-flow-delivery-picker");if(t)for(const o of t.querySelectorAll("button[data-priority]")){const a=o.dataset.priority===e;o.style.background=a?"var(--accent,#5aafa5)":"transparent",o.style.color=a?"#000":"var(--text-dim)"}}window.negFlowSetPriority=so;async function li(){if(!y||y._capacityFlows)return;const e=y.myNationId,t=y.partnerNationId;!e||!t||(y._capacityFlows={[e]:{},[t]:{}})}function Yo(){const e=document.getElementById("neg-flow-warnings");if(!e)return;const t=y?._capacityFlows;if(!t){e.style.display="none";return}const o=document.getElementById("neg-flow-commodity")?.value||"",a=document.getElementById("neg-flow-direction")?.value||"a_buys_b",n=Number(document.getElementById("neg-flow-volume")?.value)||0;if(!o||n<=0){e.style.display="none";return}const r=y.myNationId,i=y.partnerNationId,l=a==="a_buys_b"?r:i,s=a==="a_buys_b"?i:r,c=(l===r?y.myNationName:y.partnerNationName)||"Buyer",u=(s===r?y.myNationName:y.partnerNationName)||"Seller",f=t[l]?.[o],_=t[s]?.[o],m=g=>g>=1e9?"$"+(g/1e9).toFixed(1)+"B":g>=1e6?"$"+(g/1e6).toFixed(0)+"M":"$"+Math.round(g).toLocaleString(),d=[];if(_){const g=_.export_capacity;if(n>g){const x=n-g;d.push(`<strong>${v(u)}</strong> has ${m(g)}/tick organic export capacity for this commodity — short by ${m(x)}/tick. The contract will still fire (the engine treats the gap as off-the-books supply / re-export), but expect lower fulfillment if the seller's capacity drops further.`)}}if(f){const g=f.import_demand;g===0&&n>0?d.push(`<strong>${v(c)}</strong> has no organic demand for this commodity (already net-exporter or self-sufficient). The contract creates the demand — ${v(c)} will pay for ${m(n)}/tick they don't currently need.`):n>g*5&&g>0&&d.push(`<strong>${v(c)}</strong>'s organic demand for this commodity is only ${m(g)}/tick — your contract is ${(n/g).toFixed(1)}× that. The contract will fire but the buyer is committing to far more than their natural usage.`)}if(d.length===0){e.style.display="none";return}e.innerHTML=d.map(g=>"⚠ "+g).join("<br><br>"),e.style.display="block"}window.negFlowEvaluateWarnings=Yo;function ci(){const e=document.getElementById("trade-neg-add-article-form");if(!e)return;const t=y?.myNationName||"Nation A",o=y?.partnerNationName||"Nation B",a=bo.map(n=>`<option value="${n.key}">${v(n.label)}</option>`).join("");e.innerHTML=`<div class="trade-neg-add-form">
    ...
    </div>`}function di(){const e=document.getElementById("trade-neg-add-article-form");if(!e)return;const t=bo.map(o=>`<option value="${o.key}">${v(o.label)}</option>`).join("");e.innerHTML=`<div class="trade-neg-add-form">
    ...
    </div>`}function pi(){const e=document.getElementById("trade-neg-add-article-form");e&&(e.innerHTML=`<div class="trade-neg-add-form">
    ...
    </div>`;const t=document.getElementById("trade-neg-article-text"),o=document.getElementById("trade-neg-article-counter"),a=document.getElementById("trade-neg-article-add-btn");t.focus(),t.addEventListener("input",()=>{o.textContent=t.value.length,a.disabled=!t.value.trim()}),ro()}function Ke(){const e=document.getElementById("trade-neg-add-article-form");e&&(e.style.display="none",e.innerHTML="")}async function Tt(e){const{data:t,error:o}=await p.from("trade_negotiations").select("status, approved_by_a, approved_by_b").eq("id",e).single();return o||!t?{locked:!1,fetchFailed:!0}:{locked:t.status==="ratification"||!!t.approved_by_a&&!!t.approved_by_b,fetchFailed:!1,status:t.status}}let Pe=!1;async function fi(){if(Pe||!y)return;const e=document.getElementById("trade-neg-article-text");if(!e)return;const t=e.value.trim();if(!t)return;if(Pe=!0,(await Tt(y.negotiationId)).locked){alert("This agreement is locked — both parties have approved and ratification is in motion. To edit articles, the agreement would need to fail in parliament first."),Pe=!1,Ke();return}const a={id:crypto.randomUUID(),text:t,author_nation_id:y.myNationId,author_nation_name:y.myNationName,added_at_tick:0,strike_requested_by:null,strike_requested_by_name:null},{data:n}=await p.from("shard").select("current_tick").eq("name","Alpha Shard").single();a.added_at_tick=n?.current_tick||0;const{data:r,error:i}=await p.from("trade_negotiations").select("draft_articles, agreement_type").eq("id",y.negotiationId).single();if(i){alert("Failed to load articles: "+i.message),Pe=!1;return}const s=[...r?.draft_articles||[],a],{error:c}=await p.from("trade_negotiations").update({draft_articles:s,agreement_type:St(s,r.agreement_type)}).eq("id",y.negotiationId);if(c){alert("Failed to add article: "+c.message),Pe=!1;return}y.articles=s,Ke(),gt(),Pe=!1}let Oe=!1;async function gi(e){if(!y||Oe||!confirm("Delete this article?"))return;if(Oe=!0,(await Tt(y.negotiationId)).locked){alert("This agreement is locked — both parties have approved and ratification is in motion. Articles cannot be deleted."),Oe=!1;return}const{data:o,error:a}=await p.from("trade_negotiations").select("draft_articles, agreement_type").eq("id",y.negotiationId).single();if(a||!o){alert("Failed to load articles."),Oe=!1;return}const r=(o.draft_articles||[]).filter(l=>l.id!==e),{error:i}=await p.from("trade_negotiations").update({draft_articles:r,agreement_type:St(r,o.agreement_type)}).eq("id",y.negotiationId);if(i){alert("Failed to delete article: "+i.message),Oe=!1;return}y.articles=r,gt(),Oe=!1}let Le=!1;async function vi(e){if(!y||Le)return;if(Le=!0,(await Tt(y.negotiationId)).locked){alert("This agreement is locked — both parties have approved and ratification is in motion. Articles cannot be struck."),Le=!1;return}const{data:o,error:a}=await p.from("trade_negotiations").select("draft_articles, agreement_type").eq("id",y.negotiationId).single();if(a||!o){alert("Failed to load articles."),Le=!1;return}const r=(o.draft_articles||[]).map(l=>l.id!==e?l:{...l,strike_requested_by:y.myNationId,strike_requested_by_name:y.myNationName}),{error:i}=await p.from("trade_negotiations").update({draft_articles:r,agreement_type:St(r,o.agreement_type)}).eq("id",y.negotiationId);if(i){alert("Failed to request strike: "+i.message),Le=!1;return}y.articles=r,gt(),Le=!1}function lo(){const e=document.getElementById("trade-neg-agreement-btn");if(!e||!y)return;const t=y.weAreA?y.approvedByA:y.approvedByB,o=y.weAreA?y.approvedByB:y.approvedByA,a=(t?1:0)+(o?1:0),n=document.getElementById("trade-neg-add-structured-btn"),r=document.getElementById("trade-neg-add-article-btn"),i=document.getElementById("trade-neg-name-btn");a===2?(n&&(n.disabled=!0,n.style.opacity="0.3"),r&&(r.disabled=!0,r.style.opacity="0.3"),i&&(i.disabled=!0,i.style.opacity="0.3")):(n&&(n.disabled=!1,n.style.opacity="1"),r&&(r.disabled=!1,r.style.opacity="1"),i&&(i.disabled=!1,i.style.opacity="1")),a===2?(e.textContent="Agreement [2/2]",e.style.color="#4ade80",e.style.borderColor="rgba(74,222,128,0.3)",e.disabled=!0):t?(e.textContent="Agreement ["+a+"/2]",e.style.color="#5aafa5",e.style.borderColor="rgba(90,175,165,0.3)",e.disabled=!1):(e.textContent="Not in Agreement ["+a+"/2]",e.style.color="var(--text-dim)",e.style.borderColor="var(--border-main)",e.disabled=!1);const l=document.getElementById("trade-neg-send-parliament-btn");if(l){const s=y.status==="ratification";l.style.display=a===2&&!s?"":"none"}}async function _i(){if(!y||!y.negotiationId)return;if(!y.chatRole?.canChat){alert("You need a diplomatic role to send the agreement to parliament.");return}const e=document.getElementById("trade-neg-send-parliament-btn");e&&(e.disabled=!0,e.textContent="Sending…");try{await sendTradeToParliament(y.negotiationId),y.status="ratification",lo()}finally{e&&(e.disabled=!1,e.textContent="Send to Parliament")}}window.sendTradeToParliamentFromModal=_i;let xe=!1;async function bi(){if(xe||!y)return;if(!y.chatRole?.canChat){alert("You need a diplomatic role to vote on the agreement.");return}if(y.status==="cancelled"||y.status==="ratification")return;if(!y.agreementName||!y.agreementName.trim()){alert('The agreement must be named before both parties can agree. Click "Name Agreement" first.');return}const e=y,t=e.weAreA?e.approvedByA:e.approvedByB,o=e.weAreA?"approved_by_a":"approved_by_b",a=e.weAreA?"approved_by_a_role":"approved_by_b_role",n=e.weAreA?"approved_at_a_tick":"approved_at_b_tick";xe=!0;const{data:r}=await p.from("shard").select("current_tick").eq("name","Alpha Shard").single(),i=r?.current_tick||0;if(t){const l={[o]:null,[a]:null,[n]:null},{error:s}=await p.from("trade_negotiations").update(l).eq("id",e.negotiationId);if(s){alert("Failed to revoke agreement: "+s.message),xe=!1;return}e.weAreA?e.approvedByA=null:e.approvedByB=null}else{const l=z?.faction?.id,s=e.chatRole?.role||"trade_minister",c={[o]:l,[a]:s,[n]:i},u=e.weAreA?e.approvedByB:e.approvedByA;if(u){c.status="ratification";const[{data:_},{data:m}]=await Promise.all([p.from("nations").select("name").eq("id",e.weAreA?e.myNationId:e.partnerNationId).single(),p.from("nations").select("name").eq("id",e.weAreA?e.partnerNationId:e.myNationId).single()]),d=_?.name||"Unknown",g=m?.name||"Unknown",x=e.agreementName||"Trade Agreement",I="Ratify: "+x,$='Ratification of the trade agreement "'+x+'" between '+d+" and "+g+". A YES vote enacts the agreement; a NO vote rejects it.",T={bill_type:"ratification",bill_name:I,preamble:$,trade_negotiation_id:e.negotiationId,status:"floor",proposed_tick:i,floor_tick:i,voting_ends_tick:i+3},w=e.weAreA?e.myNationId:e.partnerNationId,S=e.weAreA?e.partnerNationId:e.myNationId,M=e.weAreA?l:e.approvedByA,N=e.weAreA?e.approvedByB:l,A={...T,nation_id:w,proposed_by:M},B={...T,nation_id:S,proposed_by:N},[q,R]=await Promise.all([p.from("bills").insert(A).select("id").single(),p.from("bills").insert(B).select("id").single()]);if(q.error){alert("Error creating ratification bill: "+q.error.message),xe=!1;return}if(R.error){alert("Error creating ratification bill: "+R.error.message),xe=!1;return}c.bill_a_id=q.data?.id||null,c.bill_b_id=R.data?.id||null;const D="The "+x+" has been sent to both parliaments for ratification.";p.from("event_log").insert([w,S].map(j=>({nation_id:j,event_name:x+" — Ratification",category:"trade",description_chosen:D,fired_at_tick:i}))).then(()=>{})}const{error:f}=await p.from("trade_negotiations").update(c).eq("id",e.negotiationId);if(f){alert("Failed to approve: "+f.message),xe=!1;return}e.weAreA?e.approvedByA=l:e.approvedByB=l,u&&(e.status="ratification",alert("Both sides have approved! Ratification bills have been submitted to both parliaments."))}lo(),xe=!1}window.negArticleShowForm=ui;window.negArticleCancelForm=Ke;window.negArticleAdd=fi;window.negArticleDelete=gi;window.negArticleRequestStrike=vi;window.negAgreementToggle=bi;function Ct(){document.getElementById("trade-neg-modal").classList.remove("active"),Re&&(p.removeChannel(Re),Re=null),y=null,yt=!1,rt=!1,bt=!1,Pe=!1,Oe=!1,Le=!1,xe=!1,Ce=!1,re=null,it=!1,pt(),yo().then(()=>We()).catch(()=>{})}let rt=!1;async function yi(){if(!y||rt)return;if(y.status==="cancelled"){alert("This negotiation has already been ended.");return}const e=y.chatRole;if(!e?.canChat){alert("You need a diplomatic role to withdraw from negotiations.");return}const t=y.partnerNationName||"Unknown";if(!confirm("Withdraw from trade negotiations with "+t+`?

This will end the negotiation and cannot be undone.`))return;rt=!0;const o=y.negotiationId,a=y.myNationId,n=y.partnerNationId,{data:r}=await p.from("shard").select("current_tick").eq("name","Alpha Shard").single(),i=r?.current_tick||0,{error:l}=await p.from("trade_negotiations").update({status:"cancelled",concluded_at_tick:i}).eq("id",o);if(l){alert("Failed to withdraw: "+l.message),rt=!1;return}await p.from("negotiation_messages").insert({negotiation_id:o,sender_nation_id:a,sender_faction_id:z.faction.id,sender_role:e.role,sender_display_name:"System",message_text:e.displayName+" has withdrawn from negotiations.",is_system:!0,sent_at_tick:i});const s=e.displayName.split(" (")[0],u=(e.role==="trade_minister"?"Minister of Trade ":"Prime Minister ")+s+" has decided to end trade negotiations with "+t+".";await p.from("event_log").insert([{nation_id:a,event_name:"Trade Negotiations Withdrawn",trigger_key:"trade_negotiation_withdrawn",category:"trade",description_chosen:u,fired_at_tick:i},{nation_id:n,event_name:"Trade Negotiations Withdrawn",trigger_key:"trade_negotiation_withdrawn",category:"trade",description_chosen:u,fired_at_tick:i}]),y.status="cancelled",rt=!1,Ct();try{await eo()}catch{}pt(),Fe()}window.openTradeNegModal=Xn;window.closeTradeNegModal=Ct;window.withdrawFromNegotiations=yi;
