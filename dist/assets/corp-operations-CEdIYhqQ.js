import{_}from"./supabase-client-BXEzLDpS.js";import{e as g}from"./utils-C2W-HleY.js";import{initMessaging as Gi}from"./messaging-B5Fng3EZ.js";import{c as Wi,a as At,E as He,b as Xe,d as pi,e as Fi,f as Vi,h as si}from"./equipment-DsuDdEne.js";const mi={LOW:"#c84",STD:"#ca5",HIGH:"#5c5"},ce=[{key:"concrete",name:"Concrete",category:"RAW",tiers:{LOW:{requirements:[]},STD:{requirements:[{stat:"manufacturing_output",min:20}]},HIGH:{requirements:[{stat:"manufacturing_output",min:50},{stat:"higher_education",min:40}]}},priceDrivers:["manufacturing_output","inflation","fuel_prices","urbanization"]},{key:"steel",name:"Steel",category:"RAW",tiers:{LOW:{requirements:[{stat:"manufacturing_output",min:10}]},STD:{requirements:[{stat:"manufacturing_output",min:35},{stat:"rare_minerals",min:20}]},HIGH:{requirements:[{stat:"manufacturing_output",min:60},{stat:"rare_minerals",min:40},{stat:"higher_education",min:45}]}},priceDrivers:["manufacturing_output","rare_minerals","inflation","fuel_prices"]},{key:"lumber",name:"Lumber",category:"RAW",tiers:{LOW:{requirements:[{stat:"arable_land",min:10}]},STD:{requirements:[{stat:"arable_land",min:30},{stat:"physical_infrastructure",min:20}]},HIGH:{requirements:[{stat:"arable_land",min:50},{stat:"manufacturing_output",min:30}]}},priceDrivers:["arable_land","physical_infrastructure","inflation"]},{key:"aggregate",name:"Aggregate",category:"RAW",tiers:{LOW:{requirements:[]},STD:{requirements:[{stat:"rare_minerals",min:15},{stat:"physical_infrastructure",min:20}]},HIGH:{requirements:[{stat:"rare_minerals",min:35},{stat:"manufacturing_output",min:25}]}},priceDrivers:["rare_minerals","physical_infrastructure","inflation"]},{key:"em",name:"E&M Systems",category:"MANUFACTURED",tiers:{LOW:{requirements:[{stat:"manufacturing_output",min:15}]},STD:{requirements:[{stat:"manufacturing_output",min:40},{stat:"digital_infrastructure",min:25}]},HIGH:{requirements:[{stat:"manufacturing_output",min:55},{stat:"digital_infrastructure",min:50},{stat:"energy_generation",min:40}]}},priceDrivers:["manufacturing_output","digital_infrastructure","inflation","energy_generation"]},{key:"glass",name:"Glass & Facades",category:"MANUFACTURED",tiers:{LOW:{requirements:[{stat:"manufacturing_output",min:20}]},STD:{requirements:[{stat:"manufacturing_output",min:40},{stat:"standard_of_living",min:35}]},HIGH:{requirements:[{stat:"manufacturing_output",min:60},{stat:"digital_infrastructure",min:40},{stat:"higher_education",min:50}]}},priceDrivers:["manufacturing_output","standard_of_living","inflation"]},{key:"asphalt",name:"Asphalt",category:"RAW",tiers:{LOW:{requirements:[{stat:"oil_and_gas",min:10}]},STD:{requirements:[{stat:"oil_and_gas",min:30},{stat:"manufacturing_output",min:25}]},HIGH:{requirements:[{stat:"oil_and_gas",min:45},{stat:"manufacturing_output",min:40},{stat:"physical_infrastructure",min:40}]}},priceDrivers:["oil_and_gas","manufacturing_output","inflation","fuel_prices"]},{key:"heavy",name:"Heavy Machinery Parts",category:"MANUFACTURED",tiers:{LOW:{requirements:[{stat:"manufacturing_output",min:40},{stat:"rare_minerals",min:30}]},STD:{requirements:[{stat:"manufacturing_output",min:60},{stat:"rare_minerals",min:45},{stat:"higher_education",min:40}]},HIGH:{requirements:[{stat:"manufacturing_output",min:75},{stat:"rare_minerals",min:60},{stat:"higher_education",min:55},{stat:"digital_infrastructure",min:45}]}},priceDrivers:["manufacturing_output","rare_minerals","higher_education","digital_infrastructure"]}];function Ee(i,e,t){const a=ce.find(d=>d.key===i);if(!a)return{available:!1,failedStat:"unknown_material"};const n=a.tiers[e];if(!n)return{available:!1,failedStat:"unknown_tier"};for(const d of n.requirements){const s=Number(t?.[d.stat]??0);if(s<d.min)return{available:!1,failedStat:d.stat,failedMin:d.min,nationValue:s}}return{available:!0}}function Ht(i,e,t){const n={concrete:{LOW:200,STD:300,HIGH:500},steel:{LOW:400,STD:700,HIGH:1200},lumber:{LOW:80,STD:130,HIGH:200},aggregate:{LOW:40,STD:60,HIGH:100},em:{LOW:400,STD:700,HIGH:1200},glass:{LOW:300,STD:500,HIGH:900},asphalt:{LOW:120,STD:200,HIGH:350},heavy:{LOW:800,STD:1400,HIGH:2400}}[i]?.[e];if(!n)return 0;const d=ce.find(l=>l.key===i);if(!d)return n;let s=1;for(const l of d.priceDrivers){const r=Number(t?.[l]??50);l==="inflation"||l==="fuel_prices"?s*=1+(r-50)/200:s*=1-(r-50)/250}return s=Math.max(.4,Math.min(2.5,s)),Math.round(n*s)}function fi(i,e,t){const n={concrete:{LOW:5e3,STD:3e3,HIGH:1e3},steel:{LOW:2e3,STD:1500,HIGH:500},lumber:{LOW:8e3,STD:4e3,HIGH:1500},aggregate:{LOW:15e3,STD:6e3,HIGH:2e3},em:{LOW:1e3,STD:700,HIGH:300},glass:{LOW:1500,STD:800,HIGH:300},asphalt:{LOW:4e3,STD:2e3,HIGH:800},heavy:{LOW:400,STD:200,HIGH:80}}[i]?.[e]||0,s=ce.find(o=>o.key===i)?.priceDrivers?.[0],r=.3+(s?Number(t?.[s]??50):50)/50*.7;return Math.round(n*r)}const jt=["LOW","STD","HIGH"],zt={LOW:"Low",STD:"Standard",HIGH:"High"};let Re=[],f=null,k=null,O=null,Ae=[],De={},te=[],W={},Lt=-1,H="concrete",j="STD",Te=500,ie=[],Bt=0,J="trucks",oe=0,se=1,xe=[],Ce=null,Ke=[],qt=null,Ye=null,Nt="ALL",Rt="TIMELINE";function q(i){return Math.abs(i)>=1e6?"$"+(i/1e6).toFixed(1)+"M":Math.abs(i)>=1e3?"$"+(i/1e3).toFixed(0)+"k":"$"+i}function Yi(i){if(i>=12){const e=Math.floor(i/12),t=i%12;return t>0?e+"y "+t+"mo":e+"y"}return i+" ticks"}function X(i){return Math.abs(i)>=1e9?"$"+(i/1e9).toFixed(1)+"B":Math.abs(i)>=1e6?"$"+(i/1e6).toFixed(0)+"M":Math.abs(i)>=1e3?"$"+(i/1e3).toFixed(0)+"k":"$"+i}function Ze(i){return i==="civil_engineering"?"CIVIL":i==="industrial"?"INDUSTRIAL":i==="mega_project"?"MEGA":i?.toUpperCase()||"—"}function ui(i){return i==="civil_engineering"?"light":i==="industrial"?"heavy":i==="mega_project"?"mega":"light"}function Qi(){Ye&&clearInterval(Ye),Ye=setInterval(()=>{if(!qt)return;const i=qt-Date.now();if(i<=0){document.getElementById("tick-countdown").textContent="Tick due...",clearInterval(Ye);return}const e=Math.floor(i/36e5),t=Math.floor(i%36e5/6e4),a=Math.floor(i%6e4/1e3);document.getElementById("tick-countdown").textContent=e+"h "+t+"m "+a+"s"},1e3)}function Ki(){document.body.classList.toggle("light-mode");const i=document.getElementById("theme-toggle");i.textContent=document.body.classList.contains("light-mode")?"Dark":"Light"}function Ji(i,e){i==="type"&&(Nt=e),i==="sort"&&(Rt=e),document.querySelectorAll(`.filter-pill[data-filter="${i}"]`).forEach(t=>{t.classList.toggle("active",t.dataset.value===e)}),vi()}function yi(i){return!(!f||i.sector==="mega_project"&&f.corp_subsector!=="Megaprojects"||i.sector==="industrial"&&!["Heavy Infrastructure","Megaprojects"].includes(f.corp_subsector))}function vi(){const i=document.getElementById("oc-list");let e=[...Ae];if(Nt==="GOVERNMENT"?e=e.filter(n=>n.issuer_type==="GOVERNMENT"):Nt==="PRIVATE"&&(e=e.filter(n=>n.issuer_type==="PRIVATE")),Rt==="TIMELINE"&&e.sort((n,d)=>(n.timeline_ticks||0)-(d.timeline_ticks||0)),Rt==="BUDGET"&&e.sort((n,d)=>(d.budget_ceiling||0)-(n.budget_ceiling||0)),document.getElementById("oc-count").textContent=e.length+" AVAILABLE",e.length===0){i.innerHTML=`
            ...
            </div>`;return}const t=O?.current_tick||0;let a="";for(const n of e){const d=n.issuer_type==="GOVERNMENT",s=d?"gov":"private",l=yi(n),r=l?"":" locked",o=ui(n.sector),c=Ze(n.sector),m=(n.timeline_ticks||0)>18?" warn":"",p=n.bidding_ends_tick?Math.max(0,n.bidding_ends_tick-t):"?";a+=`
            <div class="oc-item${r}" data-contract-id="${n.id}">
                ...
                <div class="oc-item__stats">
                    ...
                    <div class="oc-eligibility">
                        ${De[n.id]?`<span class="oc-eligible-badge yes" style="background:var(--green-faint);border-color:var(--green-border);color:var(--green);">BID: ${X(De[n.id].bid_price)}</span>`:`<span class="oc-eligible-badge ${l?"yes":"no"}">${l?"ELIGIBLE":"LOCKED"}</span>`}
                    </div>
                    ${l?`<button class="bid-btn bid-btn--submit" style="padding:3px 10px;font-size:8px;margin-left:auto;" onclick="event.stopPropagation();openBidModal(contracts.find(x=>x.id==='${n.id}'))">${De[n.id]?"EDIT":"VIEW"}</button>`:""}
                </div>
                ${n.description?`<div style="font-size:9px;color:var(--text-dim);padding:4px 0 0;font-style:italic;">${g(n.description)}</div>`:""}
            </div>`}i.innerHTML=a,i.querySelectorAll(".oc-item:not(.locked)").forEach(n=>{n.addEventListener("click",()=>{const d=n.dataset.contractId,s=Ae.find(l=>l.id===d);s&&gi(s)})})}let pe=null;function gi(i){pe=i;const e=document.getElementById("cd-overlay"),t=i.issuer_type==="GOVERNMENT",a=t?"gov":"private",n=(k?.name||f.nation||"—").toUpperCase(),d=yi(i);document.getElementById("cd-header-left").innerHTML=`
    ...
    `;const s=document.getElementById("cd-blueprint");i.blueprint_svg?(s.innerHTML=i.blueprint_svg,s.style.display=""):(s.innerHTML=vn(i),s.style.display="");const l=i.permits_required||[],r=i.required_equipment||i.equipment_required||[],o=i.required_materials||i.materials_estimated||{},m={civil_engineering:"Civil Engineering",industrial:"Industrial Construction",mega_project:"Megaprojects"}[i.sector]||i.spec_category||i.sector||"—";let p="var(--teal)";i.sector==="industrial"&&(p="var(--orange)"),i.sector==="mega_project"&&(p="var(--red)");let u=q(i.budget_ceiling||i.budget||0),y=(i.timeline_ticks||i.timeline_months||0)+" Months",v="";v+=`
        <div class="cd-issue">
            ...
            </div>`),v+='<div class="cd-details">',i.project_type&&(v+=ge("Type",i.project_type)),i.project_subtype&&(v+=ge("Sub-Type",i.project_subtype)),v+=ge("Specialization",m,p),v+=ge("Total Budget",u,"var(--green)"),v+=ge("Timeline",y),v+=ge("Nation",k?.name||f.nation||"—"),i.region&&(v+=ge("Region",i.region)),v+="</div>",l.length>0&&(v+=`
            <div class="cd-items">
                <div class="cd-section-label">Permits Required</div>
                <div class="cd-items__list">
                    ${l.map(h=>{const C=h.status==="approved"?"approved":"required",R=h.status==="approved"?"&#10003;":"&#9675;";return`<div class="cd-chip ${C}">
            ...
            </div>`),document.getElementById("cd-content").innerHTML=v;const w=l.filter(h=>h.status==="approved").length,$=l.length-w,E=r.filter(h=>h.owned).length,A=r.length-E;let b="";r.length>0&&(A===0?b+='<span class="cd-footer__badge ok">ALL EQUIPMENT MET</span>':b+=`<span class="cd-footer__badge bad">${A} EQUIPMENT MISSING</span>`),l.length>0&&($===0?b+='<span class="cd-footer__badge ok">ALL PERMITS APPROVED</span>':b+=`<span class="cd-footer__badge warn">${$} PERMITS PENDING</span>`);const S=d;(f.action_points??0)>=2;const T=i.issuer_faction_id===f?.id,M=i.status==="bidding";document.getElementById("cd-footer").innerHTML=`
    ...
    `,e.classList.add("open"),document.body.style.overflow="hidden"}function et(i){i&&i.target&&i.target!==document.getElementById("cd-overlay")||(document.getElementById("cd-overlay").classList.remove("open"),document.body.style.overflow="",pe=null)}const Xi=[{key:"concrete",name:"Concrete",unit:"units"},{key:"steel",name:"Steel",unit:"units"},{key:"lumber",name:"Lumber",unit:"units"},{key:"aggregate",name:"Aggregate",unit:"units"},{key:"em_systems",name:"E&M Systems",unit:"units"},{key:"glass_facades",name:"Glass & Facades",unit:"units"},{key:"asphalt",name:"Asphalt",unit:"units"},{key:"heavy_parts",name:"Heavy Machinery Parts",unit:"units"}],Zi=[{key:"work_trucks",name:"Work Trucks",tier:1},{key:"excavators",name:"Excavators",tier:1},{key:"bulldozers",name:"Bulldozers",tier:1},{key:"concrete_mixers",name:"Concrete Mixers",tier:1},{key:"tower_cranes",name:"Tower Cranes",tier:2},{key:"heavy_haulers",name:"Heavy Haulers",tier:2},{key:"pile_drivers",name:"Pile Drivers",tier:2},{key:"asphalt_plants",name:"Asphalt Plants",tier:2}],xi={LOW:.7,STANDARD:1,HIGH:1.4},bi={LOW:35,STANDARD:65,HIGH:90},gt=15;let F=null;function en(i){if(!i)return;const e=i.required_materials||{},t=i.required_equipment||[],a=i.required_workforce||{},n={concrete:18e4,steel:25e4,lumber:12e4,aggregate:8e4,em_systems:32e4,glass_facades:28e4,asphalt:14e4,heavy_parts:4e5},d=Xi.filter(c=>e[c.key]>0).map(c=>({...c,qty:e[c.key],basePrice:n[c.key]||2e5,grade:c.key==="aggregate"?"LOW":"STANDARD",highDisabled:!1})),s=Zi.filter(c=>t.includes(c.key)).map(c=>({...c,owned:(ie||[]).some(m=>m.equipment_key===c.key&&m.quantity>0)})),l=(a.general||100)+(a.skilled||20),r=i.budget_ceiling||1e8,o=Math.round(r*.03);F={contract:i,budgetCeiling:r,materials:d,laborCount:l,laborRate:15200,estimatedTicks:i.timeline_ticks||8,equipment:s,permits:[],overhead:o,markupPct:15,competitors:[],playerRep:f?.standing||50,requiredWorkforce:a},document.getElementById("bid-title").textContent="BID ASSEMBLY",document.getElementById("bid-subtitle").textContent=(i.name||"Contract")+" — "+Ze(i.sector)+" — "+(i.issuer_name||"Government"),document.getElementById("bid-overlay").classList.add("open"),document.body.style.overflow="hidden",tt()}function $i(i){i&&i.target!==document.getElementById("bid-overlay")||(document.getElementById("bid-overlay").classList.remove("open"),document.body.style.overflow="",F=null)}function N(i){return Math.abs(i)>=1e9?"$"+(i/1e9).toFixed(2)+"B":Math.abs(i)>=1e6?"$"+(i/1e6).toFixed(2)+"M":Math.abs(i)>=1e3?"$"+(i/1e3).toFixed(0)+"k":"$"+i.toLocaleString()}function tn(i,e){if(!F)return;const t=F.materials[i];e==="HIGH"&&t.highDisabled||(t.grade=e,tt())}function nn(i){F&&(F.laborCount=i,tt())}function an(i){F&&(F.markupPct=Number(i),tt())}function tt(){if(!F)return;const i=F;let e=0;for(const C of i.materials)C.lineCost=Math.round(C.qty*C.basePrice*xi[C.grade]),e+=C.lineCost;const t=Math.round(i.laborCount*i.laborRate*i.estimatedTicks),a=Math.round(i.equipment.filter(C=>C.owned).length*12e3*i.estimatedTicks);let n=0;const d=i.overhead,s=e+t+a+n+d,l=Math.round(s*i.markupPct/100),r=s+l,o=r>i.budgetCeiling,c=l,m=Math.round(i.materials.reduce((C,R)=>C+bi[R.grade],0)/i.materials.length),p=m>=80?"STRONG":m>=60?"PROMISING":m>=40?"UNCERTAIN":"POOR",u=m>=80?"var(--green)":m>=60?"var(--teal)":m>=40?"var(--orange)":"var(--red)",y=i.budgetCeiling>0?r/i.budgetCeiling:1,v=Math.max(0,Math.min(100,Math.round((1-y)*150))),w=v>=70?"STRONG":v>=40?"COMPETITIVE":v>=15?"WEAK":"UNLIKELY",$=v>=70?"var(--green)":v>=40?"var(--teal)":v>=15?"var(--orange)":"var(--red)",E=Math.round(s*(1-gt/100)),A=Math.round(s*(1+gt/100));let b="";b+='<div class="bid-section"><div class="bid-section__title">Materials</div>',i.materials.forEach((C,R)=>{const L=P=>{const K=C.grade===P,fe=P==="HIGH"&&C.highDisabled;return`<button class="bid-grade-btn ${K?P==="LOW"?"active-low":P==="HIGH"?"active-high":"active":""} ${fe?"disabled":""}" onclick="setBidGrade(${R},'${P}')">${P[0]}</button>`};b+=`<div class="bid-mat-row">
    ...
    </div>`,h+='<div class="bid-section" style="margin-top:8px;"><div class="bid-section__title">Competing Bids</div>',i.competitors.forEach(C=>{h+=`<div class="bid-competitor"><span class="bid-competitor__name">${g(C.name)}</span><span class="bid-competitor__rep">Rep ${C.rep}</span></div>`}),h+=`<div class="bid-competitor" style="color:var(--gold);"><span class="bid-competitor__name">You</span><span class="bid-competitor__rep">Rep ${i.playerRep}</span></div>`,h+="</div>",document.getElementById("bid-right").innerHTML=h,document.getElementById("bid-footer-price").textContent=N(r),document.getElementById("bid-footer-price").style.color=o?"var(--red)":"var(--gold)",document.getElementById("bid-footer-profit").textContent="+"+N(c),document.getElementById("bid-footer-quality").textContent=m+"/100",document.getElementById("bid-footer-quality").style.color=u,document.getElementById("bid-submit-btn").disabled=o}window.openBidModal=en;window.closeBidModal=$i;window.setBidGrade=tn;window.setBidLabor=nn;window.setBidMarkup=an;async function on(){if(!F||!f||Ne)return;const i=F,e=i.contract;let t=0;const a={};for(const m of i.materials)t+=Math.round(m.qty*m.basePrice*xi[m.grade]),a[m.key]=m.grade;const n=Math.round(i.laborCount*i.laborRate*i.estimatedTicks),d=Math.round(i.equipment.filter(m=>m.owned).length*12e3*i.estimatedTicks),s=t+n+d+i.overhead,l=Math.round(s*i.markupPct/100),r=s+l,o=Math.round(i.materials.reduce((m,p)=>m+bi[p.grade],0)/(i.materials.length||1));if(r>i.budgetCeiling){alert("Bid exceeds budget ceiling. Lower your costs or markup.");return}const c=document.getElementById("bid-submit-btn");c.disabled=!0,c.textContent="SUBMITTING...",Ne=!0;try{const{data:m}=await _.from("shard").select("current_tick").eq("name","Alpha Shard").single(),p=m?.current_tick||0,{data:u}=await _.from("contract_bids").select("id").eq("contract_id",e.id).eq("faction_id",f.id).maybeSingle();if(u){const{error:v}=await _.from("contract_bids").update({bid_price:r,material_grades:a,labor_count:i.laborCount,markup_pct:i.markupPct,estimated_cost:s,estimated_quality:o,submitted_at_tick:p}).eq("id",u.id);if(v)throw v}else{const{error:v}=await _.from("contract_bids").insert({contract_id:e.id,faction_id:f.id,bid_price:r,material_grades:a,labor_count:i.laborCount,markup_pct:i.markupPct,estimated_cost:s,estimated_quality:o,status:"pending",submitted_at_tick:p});if(v)throw v}$i();const y=document.getElementById("oc-count");if(y){const v=y.textContent;y.textContent="✓ BID SUBMITTED",y.style.color="var(--green)",setTimeout(()=>{y.textContent=v,y.style.color=""},2e3)}await me()}catch(m){console.error("Bid submission failed:",m),alert("Failed to submit bid: "+(m.message||"Unknown error")),c.disabled=!1,c.textContent="SUBMIT BID"}finally{Ne=!1}}window.submitBid=on;const $e=["Permits","Planning","Foundation","Structural","Systems","Finishing","Delivery"],ri={WEATHER:{color:"var(--blue)",bg:"var(--blue-faint)",border:"var(--blue-border)"},SUPPLY:{color:"var(--gold)",bg:"var(--gold-faint)",border:"var(--gold-border)"},LABOR:{color:"var(--orange)",bg:"var(--orange-faint)",border:"var(--orange-border)"},REGULATORY:{color:"var(--red)",bg:"var(--red-faint)",border:"var(--red-border)"},EQUIPMENT:{color:"var(--amber)",bg:"var(--amber-faint)",border:"var(--amber-border)"},POLITICAL:{color:"var(--teal)",bg:"var(--teal-faint)",border:"var(--teal-border)"}},li={LOW:"var(--green)",MODERATE:"var(--amber)",HIGH:"var(--orange)",CRITICAL:"var(--red)"};let B=null;function sn(i){const e=te.find(M=>M.id===i);if(!e)return;const t=Array.isArray(e.contract_bids)?e.contract_bids[0]:e.contract_bids,a=O?.current_tick||0,n=e.awarded_at_tick||a,d=e.timeline_ticks||8,s=Math.max(0,a-n),l=Math.min(100,s/d*100);let r=Math.min($e.length-1,Math.floor(l/(100/$e.length)));const o=Math.round(l%(100/$e.length)/(100/$e.length)*100),c=e.required_materials||{},m=t?.material_grades||{},p=Object.entries(c).map(([M,h])=>{const C=m[M]||"STANDARD",R=Math.round(h*(l/100)*(.6+Math.random()*.4));return{key:M,name:M.replace(/_/g," ").replace(/\b\w/g,L=>L.toUpperCase()),grade:C,allocated:h,used:Math.min(R,h)}}),y=(e.required_equipment||[]).map(M=>({key:M,name:M.replace(/_/g," ").replace(/\b\w/g,h=>h.toUpperCase()),qty:1+Math.floor(Math.random()*3),condition:55+Math.floor(Math.random()*40)})),v=e.budget_ceiling||0,w=t?.estimated_cost||0,$=Math.round(w*Math.min(1,s/d)),E=t?.estimated_quality||65,A=E>=80?"STRONG":E>=60?"PROMISING":E>=40?"FAIR":"UNCERTAIN",b=e.required_workforce||{},S=(b.general||0)+(b.skilled||0),T=t?.labor_count||S;B={project:e,bid:t,tab:"overview",expandedEvent:-1,selectedResponse:null,currentTick:a,awardedTick:n,totalTicks:d,ticksElapsed:s,phaseIdx:r,phaseProgress:o,materials:p,equipment:y,budget:v,estCost:w,spent:$,quality:E,qualityLabel:A,laborCount:T,wfNeeded:S,events:[]},document.getElementById("pm-overlay").classList.add("open"),document.body.style.overflow="hidden",_i(e.id).then(()=>Ie()),Ie()}function rn(i){i&&i.target!==document.getElementById("pm-overlay")||(document.getElementById("pm-overlay").classList.remove("open"),document.body.style.overflow="",B=null)}function ln(i){B&&(B.tab=i,B.expandedEvent=-1,B.selectedResponse=null,Ie())}function dn(i){B&&(B.expandedEvent=B.expandedEvent===i?-1:i,B.selectedResponse=null,Ie())}function cn(i){B&&(B.selectedResponse=B.selectedResponse===i?null:i,Ie())}function Ie(){if(!B)return;const i=B,e=i.project,t=e.issuer_type==="GOVERNMENT",a=Ze(e.sector),n=f?.nation||"Nation",d=i.awardedTick+i.totalTicks,s=Math.max(0,d-i.currentTick),l=i.currentTick>d,r=i.budget>0?Math.round(i.spent/i.budget*100):0,o=r>85?"var(--red)":r>60?"var(--amber)":"var(--teal)",c=i.budget-i.spent,m=i.events.filter(w=>w.status==="ACTIVE").length;document.getElementById("pm-header").innerHTML=`
    ...
    `}function pn(i,e,t,a,n,d,s){const l=xt(i.awardedTick+i.totalTicks);xt(i.awardedTick+i.totalTicks);const r=xt(i.awardedTick),o=[{label:"Budget",value:X(i.budget),sub:`${a}% spent`,color:t},{label:"Spent",value:X(i.spent),color:"var(--red)"},{label:"Remaining",value:X(n),color:"var(--green)"},{label:"Quality",value:`${i.quality}/100`,sub:i.qualityLabel,color:i.quality>=70?"var(--green)":i.quality>=50?"var(--amber)":"var(--red)"},{label:"Workforce",value:`${i.laborCount}/${i.wfNeeded}`,sub:`Bid: ${i.laborCount}`,color:i.laborCount<i.wfNeeded?"var(--orange)":"var(--text-bright)"},{label:"Remaining",value:`${d} ticks`,sub:s?"OVERDUE":`Deadline: ${l}`,color:s?"var(--red)":"var(--text-bright)"}];let c="";c+=`<div style="padding:0 16px"><div class="pm-section">
        ...
        </div>`}return e}function xt(i){return`${["January","February","March","April","May","June","July","August","September","October","November","December"][i%12]}, ${2e3+Math.floor(i/12)}`}window.openProjectModal=sn;window.closeProjectModal=rn;window.pmSetTab=ln;window.pmToggleEvent=dn;window.pmSelectResponse=cn;async function _i(i){if(!B)return;const{data:e,error:t}=await _.from("construction_events").select("*").eq("contract_id",i).order("fired_at_tick",{ascending:!1});t?(console.warn("Failed to load project events:",t.message),B.events=[]):B.events=(e||[]).map(a=>({id:a.id,type:a.type,severity:a.severity,tick:a.fired_at_tick,title:a.title,desc:a.description,impact:a.impact,status:a.status==="ACTIVE"?"ACTIVE":"RESOLVED",resolution:a.resolution,responses:a.responses||[]})),Ie()}let bt=!1;async function yn(i,e){if(!(bt||!B)){bt=!0;try{const{data:t,error:a}=await _.rpc("resolve_construction_event",{p_event_id:i,p_response_key:e});if(a){console.error("Failed to resolve event:",a.message),alert("Failed to submit response: "+a.message);return}const n=typeof t=="string"?JSON.parse(t):t;if(n?.error){alert("Error: "+n.error);return}await _i(B.project.id),await hi(),n?.quality_applied&&n.quality_applied!==0&&(B.quality=Math.max(0,Math.min(100,B.quality+n.quality_applied)),B.qualityLabel=B.quality>=80?"STRONG":B.quality>=60?"PROMISING":B.quality>=40?"FAIR":"UNCERTAIN"),Ie()}finally{bt=!1}}}window.confirmEventResponse=yn;function ge(i,e,t){const a=t?` style="color:${t}"`:"";return`<div class="cd-detail-row">
        ...
        <g transform="translate(470,172)">
        ...
        </div>`}i.innerHTML=d,e.style.display=te.length>0?"":"none",te.length>0&&(document.getElementById("ap-total-crew").textContent=te.length,document.getElementById("ap-total-budget").textContent=X(a),document.getElementById("ap-total-spent").textContent=X(n))}async function hi(){if(!f)return;const{data:i,error:e}=await _.from("construction_contracts").select("*, contract_bids!inner(bid_price, material_grades, labor_count, estimated_cost, estimated_quality)").eq("awarded_to_faction",f.id).in("status",["awarded","in_progress"]).eq("contract_bids.faction_id",f.id).order("awarded_at_tick",{ascending:!0});e?(console.warn("Failed to load active projects:",e.message),te=[]):te=i||[],xn()}const wi=3e4;function ki(){let i=0,e=0;for(const t of ce)for(const a of jt){const n=W[t.key]?.[a];n&&(i+=n.qty,e+=n.value)}return{totalUnits:i,totalValue:e}}function Ut(){const i=document.getElementById("wh-list"),{totalUnits:e,totalValue:t}=ki();document.getElementById("wh-count").textContent=e.toLocaleString()+" UNITS",document.getElementById("wh-total-value").textContent=q(t);const a=Math.round(e/wi*100),n=document.getElementById("wh-capacity");n.textContent=a+"%",n.style.color=a>80?"var(--red)":a>50?"var(--orange)":"var(--green)";let d="";for(let s=0;s<ce.length;s++){const l=ce[s],r=Lt===s,o=W[l.key]?.LOW||{qty:0,value:0},c=W[l.key]?.STD||{qty:0,value:0},m=W[l.key]?.HIGH||{qty:0,value:0},p=o.qty+c.qty+m.qty,u=o.value+c.value+m.value,y=p===0,v=Ee(l.key,"LOW",k),w=Ee(l.key,"STD",k),$=Ee(l.key,"HIGH",k),E=o.qty>0?"wh-dot wh-dot--low":"wh-dot wh-dot--empty",A=c.qty>0?"wh-dot wh-dot--std":"wh-dot wh-dot--empty",b=$.available?m.qty>0?"wh-dot wh-dot--high":"wh-dot wh-dot--empty":"wh-dot wh-dot--locked";if(d+='<div class="wh-row">',d+=`<div class="wh-row__collapsed${r?" expanded":""}" onclick="toggleWhRow(${s})">
            <span class="wh-row__arrow">${r?"▾":"▸"}</span>
            <span class="wh-row__name${y?" empty":""}">${g(l.name)}</span>
            ...
            <span class="wh-row__val${y?" empty":""}">${u>0?q(u):"—"}</span>
                ...
                </div>`}for(const T of S)!T.avail.available&&T.avail.failedStat&&(d+=`<div class="wh-lock">
                        <span class="wh-lock__text">${T.label.toUpperCase()} GRADE LOCKED — ${g(T.avail.failedStat)} &lt; ${T.avail.failedMin}</span>
                    </div>`);d+="</div>"}d+="</div>"}i.innerHTML=d}function bn(i){Lt=Lt===i?-1:i,Ut()}async function $n(){if(!f)return;const{data:i,error:e}=await _.from("corp_warehouse").select("material_key, quality_tier, quantity, total_value").eq("faction_id",f.id);if(W={},e)console.warn("Failed to load warehouse:",e.message);else if(i)for(const t of i)W[t.material_key]||(W[t.material_key]={}),W[t.material_key][t.quality_tier]={qty:t.quantity||0,value:Number(t.total_value)||0};Ut()}const _n={manufacturing_output:"base production",rare_minerals:"raw input",inflation:"price modifier",fuel_prices:"transport cost",urbanization:"demand pressure",arable_land:"base production",physical_infrastructure:"transport",digital_infrastructure:"component quality",energy_generation:"electrical supply",standard_of_living:"demand tier",oil_and_gas:"base input",higher_education:"engineering"};function Ei(){const i=(k?.name||f?.nation||"—").toUpperCase();document.getElementById("pr-nation-badge").textContent="LOCAL — "+i;const e=Number(f?.corp_cash_reserves)||0;document.getElementById("pr-cash").textContent=q(e);const{totalUnits:t}=ki(),a=Math.round(t/wi*100),n=document.getElementById("pr-wh-capacity");n.textContent=a+"%",n.style.color=a>80?"var(--red)":a>50?"var(--orange)":"var(--green)",Ti(),Gt(),it()}function Ti(){const i=document.getElementById("pr-mat-grid");let e="";for(const t of ce){const a=H===t.key,n=jt.every(s=>!Ee(t.key,s,k).available),d="pr-mat-btn"+(a?" active":"")+(n?" all-locked":"");e+=`<span class="${d}" onclick="setPrMat('${t.key}')">${g(t.name)}</span>`}i.innerHTML=e}function Gt(){const i=document.getElementById("pr-tier-bar");let e='<span class="pr-tier-label">GRADE</span>';for(const t of jt){const a=Ee(H,t,k),n=j===t,d=a.available?Ht(H,t,k):null,s=mi[t],l=!a.available,r="pr-tier-btn"+(n?" active":"")+(l?" locked":"");e+=`<div class="${r}" onclick="${l?"":`setPrTier('${t}')`}">
        ...
        </div>`;return}const a=Ht(H,j,k),n=fi(H,j,k),d=a*Te,s=n>3e3?"LOW":n>1e3?"MODERATE":"HIGH",l=s==="LOW"?"var(--green)":s==="MODERATE"?"var(--amber)":"var(--red)",r=Number(k?.inflation??50),o=r>55?"up":r<45?"down":"flat",c=o==="up"?"&#9650;":o==="down"?"&#9660;":"&#8212;",m=o==="up"?"var(--red)":o==="down"?"var(--green)":"var(--text-dim)";let p="";p+=`<div style="padding:8px 14px;border-bottom:1px solid var(--border-0);">
        ...
        </div>`}p+="</div>";const y=(Number(f?.corp_cash_reserves)||0)>=d,v=Te>n,w=mi[j];p+=`<div class="pr-order">
        ...
        <div class="pr-order__box">
    ...
    </div>`,i.innerHTML=p}function hn(i){H=i,j="STD";for(const e of["STD","HIGH","LOW"])if(Ee(i,e,k).available){j=e;break}Ti(),Gt(),it()}function wn(i){j=i,Gt(),it()}function kn(i){Te=i,it()}let _t=!1;async function En(){if(_t||!f||!k)return;const i=Ht(H,j,k),e=fi(H,j,k),t=i*Te,a=Number(f.corp_cash_reserves)||0;if(t>a){alert("Insufficient cash reserves.");return}if(Te>e){alert("Exceeds available supply this tick.");return}_t=!0;const n=document.querySelector(".pr-purchase-btn");n&&(n.disabled=!0,n.textContent="...");try{const d=a-t,{error:s}=await _.from("factions").update({corp_cash_reserves:d}).eq("id",f.id);if(s)throw s;const l=W[H]?.[j],r=(l?.qty||0)+Te,o=(l?.value||0)+t,{error:c}=await _.from("corp_warehouse").upsert({faction_id:f.id,nation_id:f.nation_id,material_key:H,quality_tier:j,quantity:r,total_value:o,last_purchased_tick:O?.current_tick||null,updated_at:new Date().toISOString()},{onConflict:"faction_id,material_key,quality_tier"});if(c){const{error:m}=await _.from("factions").update({corp_cash_reserves:a}).eq("id",f.id);throw m&&console.error("Cash refund failed after warehouse error:",m.message),c}f.corp_cash_reserves=d,W[H]||(W[H]={}),W[H][j]={qty:r,value:o},Ut(),Ei(),n&&(n.textContent="PURCHASED",setTimeout(()=>{n.isConnected&&(n.disabled=!1,n.textContent="PURCHASE")},1500))}catch(d){n&&(n.disabled=!1,n.textContent="PURCHASE"),alert("Purchase failed: "+(d.message||"Unknown error"))}finally{_t=!1}}function Ci(i){const e=Ce||k;if(!e)return[];const t=Xe(i);if(!t)return[];const a=Fi(i,e),n=[],d=Number(e?.inflation??50),s=Number(e?.fuel_prices??50);Number(e?.manufacturing_output??50);const l=Ce&&k&&Ce.id!==k.id;let r=null;if(l&&(r=Vi(e,k)),a.newAvailable>0){const o=si(i,e),c=t.basePrice,m=Math.round(c*((d-50)/200)),p=Math.round(c*((s-50)/300));let u=o;const y=[{label:"Base price",value:q(c)},m!==0?{label:`Inflation (${d})`,mod:(m>=0?"+":"")+q(Math.abs(m))}:null,p!==0?{label:`Fuel transport (${s})`,mod:(p>=0?"+":"")+q(Math.abs(p))}:null].filter(Boolean),v=o-c-m-p;if(v!==0&&!l&&y.push({label:"Demand/scarcity",mod:(v>=0?"+":"")+q(Math.abs(v))}),l&&r){const w=Math.round(o*r.tariff),$=Math.round(o*r.transport);u=o+w+$,y.push({label:`Import tariff (${Math.round(r.tariff*100)}%)`,mod:"+"+q(w)}),y.push({label:`Transport (${r.deliveryTicks} tick${r.deliveryTicks>1?"s":""})`,mod:"+"+q($)})}n.push({seller:l?`${e.name} Buyers`:"Local Buyers",sellerType:"LOCAL",nation:e.name||"—",distance:l?r?.deliveryTicks||1:0,condition:100,price:Math.round(u),available:a.newAvailable,delivery:l?r.deliveryTicks+" tick"+(r.deliveryTicks>1?"s":""):"Immediate",deliveryTicks:l?r.deliveryTicks:0,used:!1,priceFactors:y,sourceNationId:e.id})}if(a.usedAvailable>0){const o=a.usedCondition,c=si(i,e,{used:!0,condition:o});let m=c;const p=[{label:"Base price",value:q(t.basePrice)},{label:`Condition (${o}%)`,mod:"-"+q(Math.max(0,t.basePrice-c))}];if(l&&r){const u=Math.round(c*r.tariff),y=Math.round(c*r.transport);m=c+u+y,p.push({label:`Import tariff (${Math.round(r.tariff*100)}%)`,mod:"+"+q(u)}),p.push({label:`Transport (${r.deliveryTicks} tick${r.deliveryTicks>1?"s":""})`,mod:"+"+q(y)})}n.push({seller:l?`${e.name} Buyers`:"Local Buyers",sellerType:"LOCAL",nation:e.name||"—",distance:l?r?.deliveryTicks||1:0,condition:o,price:Math.round(m),available:a.usedAvailable,delivery:l?r.deliveryTicks+" tick"+(r.deliveryTicks>1?"s":""):"Immediate",deliveryTicks:l?r.deliveryTicks:0,used:!0,priceFactors:p,sourceNationId:e.id})}return n}function nt(){const i=Number(f?.corp_cash_reserves)||0;document.getElementById("em-cash").textContent=q(i);const e=Xe(J),t=He[e?.tier||1],a=document.getElementById("em-tier-badge");a&&(a.textContent=t.tag,a.style.color=t.color),a.style.background=t.color+"0a",a.style.border="1px solid "+t.color+"33";const n=document.getElementById("em-nation-select");if(n&&n.options.length===0){const l=k?.name||f?.nation||"—";let r=`<option value="">${g(l)} (HQ)</option>`;for(const o of Ke)o.id!==k?.id&&(r+=`<option value="${o.id}">${g(o.name)}</option>`);n.innerHTML=r}const d=document.getElementById("em-import-tag"),s=Ce&&k&&Ce.id!==k.id;d&&(d.style.display=s?"":"none"),Tn(),Wt()}function Tn(){let i="";for(let e=1;e<=3;e++){const t=He[e],a=At(e),n=e===3?"em-selector__grid em-selector__grid--t3":"em-selector__grid em-selector__grid--t12";i+=`<div class="em-selector__row">
            <div class="em-selector__tier-label" style="color:${t.color}">${t.tag}</div>
            <div class="${n}">`;for(const d of a){const s=J===d.key,l=Ci(d.key).length>0;i+=`<span class="em-selector__btn${s?" active":""}${l?"":" no-listings"}"
                style="${s?"background:"+t.color+";border-color:"+t.color:""}"
                onclick="setEmType('${d.key}')">${g(d.name)}</span>`}i+="</div></div>"}document.getElementById("em-selector").innerHTML=`<div class="em-selector">${i}</div>`}function Wt(){const i=document.getElementById("em-content");if(xe=Ci(J),xe.length===0){i.innerHTML=`<div class="em-no-listings"><div class="em-no-listings__box">
        ...
        </div></div>`;return}oe>=xe.length&&(oe=0);let e="";for(let a=0;a<xe.length;a++){const n=xe[a],d=oe===a,s=n.sellerType==="LOCAL"?"var(--teal)":"#5a8aaa",l=pi(n.condition);e+=`<div class="em-listing${d?" selected":""}" style="${d?"border-left-color:"+s:""}" onclick="setEmListing(${a})">`,e+=`<div class="em-listing__row1">
            <div style="display:flex;align-items:center;gap:6px">
            ...
            </div>`),e+="</div>"}const t=xe[oe];if(t){const a=Xe(J),n=He[a?.tier||1],d=Math.min(t.available,4),s=t.price*se,l=(Number(f?.corp_cash_reserves)||0)>=s;e+=`<div class="em-purchase"><div class="em-purchase__box">
            ...
            <div class="em-purchase__qty">
                ...
                <div class="em-purchase__qty-btns">
                    ${Array.from({length:d},(r,o)=>o+1).map(r=>`<span class="em-qty-btn${se===r?" active":""}" style="${se===r?"background:"+n.color+";border-color:"+n.color:""}" onclick="setEmQty(${r})">${r}</span>`).join("")}
                </div>
            ...
            <div class="em-purchase__total">
        ...
        </div></div>`}i.innerHTML=e}async function Cn(i){if(!i)Ce=null;else{let t=Ke.find(a=>a.id===i);if(!t)try{const{data:a}=await _.from("nations").select("*").eq("id",i).single();t=a}catch{}Ce=t||null}oe=0,se=1;const e=document.getElementById("em-nation-select");e&&(e.value=i||""),nt()}function In(i){J=i,oe=0,se=1,nt()}function Mn(i){oe=i,se=1,Wt()}function Sn(i){se=i,Wt()}let ht=!1;async function An(){if(ht)return;const i=xe[oe];if(!i||!f)return;const e=Xe(J);if(!e)return;const t=se,a=i.price*t,n=Number(f.corp_cash_reserves)||0;if(a>n){alert("Insufficient cash reserves.");return}if(t>i.available){alert("Not enough units available.");return}const d=document.querySelector(".em-purchase-btn");d&&(d.disabled=!0,d.textContent="..."),ht=!0;try{const s=n-a,{error:l}=await _.from("factions").update({corp_cash_reserves:s}).eq("id",f.id);if(l)throw l;const r=!i.deliveryTicks||i.deliveryTicks===0;if(r){const c=ie.find(A=>A.equipment_key===J),m=(c?.owned||0)+t,p=c?.purchase_price_avg||0,u=c?.owned||0,y=u>0?Math.round((p*u+i.price*t)/m):i.price,v=e.maintenancePerUnit*m,w=c?.condition||100,$=Math.round((w*u+i.condition*t)/m),{error:E}=await _.from("corp_equipment").upsert({faction_id:f.id,nation_id:f.nation_id,equipment_key:J,tier:e.tier,owned:m,deployed:c?.deployed||0,condition:$,maintenance_per_tick:v,purchase_price_avg:y,last_purchased_tick:O?.current_tick||null,updated_at:new Date().toISOString()},{onConflict:"faction_id,equipment_key"});if(E){const{error:A}=await _.from("factions").update({corp_cash_reserves:n}).eq("id",f.id);throw A&&console.error("Cash refund failed:",A.message),E}c?(c.owned=m,c.condition=$,c.maintenance_per_tick=v):ie.push({equipment_key:J,tier:e.tier,owned:m,deployed:0,condition:$,maintenance_per_tick:v,assigned_projects:[]})}else{const c=(O?.current_tick||0)+i.deliveryTicks,{error:m}=await _.from("corp_equipment_deliveries").insert({faction_id:f.id,equipment_key:J,quantity:t,condition:i.condition,delivery_tick:c,source_nation_id:i.sourceNationId||null,seller_name:i.seller,price_paid:a});if(m){const{error:p}=await _.from("factions").update({corp_cash_reserves:n}).eq("id",f.id);throw p&&console.error("Cash refund failed:",p.message),m}}f.corp_cash_reserves=s,Ft(),nt();const o=document.getElementById("pr-cash");o&&(o.textContent=q(s)),d&&(d.textContent=r?"PURCHASED":"ORDERED",setTimeout(()=>{d.isConnected&&(d.disabled=!1,d.textContent="PURCHASE")},1500))}catch(s){d&&(d.disabled=!1,d.textContent="PURCHASE"),alert("Purchase failed: "+(s.message||"Unknown error"))}finally{ht=!1}}let zn=-1,Pe=[],Pt=[],Ii=[];function wt(i){return Math.abs(i)>=1e6?"$"+(i/1e6).toFixed(1)+"M":Math.abs(i)>=1e3?"$"+(i/1e3).toFixed(0)+"k":"$"+i.toLocaleString()}function Ln(i,e,t){if(t)return"var(--orange)";const a=i/(e||1)*100;return a>50?"var(--green)":a>25?"var(--amber)":"var(--red)"}function Bn(){const i=document.getElementById("pm-list"),e=Pe.length,t=Pt.length,a=Ii.length,n=Pe.filter(r=>r.expiring_soon).length;document.getElementById("pm-active-count").textContent=`(${e})`,document.getElementById("pm-pending-count").textContent=`(${t})`,document.getElementById("pm-apply-count").textContent=`(${a})`;const d=document.getElementById("pm-badges");let s="";n>0&&(s+=`<span class="pm-badge pm-badge--expiring">${n} EXPIRING</span>`),t>0&&(s+=`<span class="pm-badge pm-badge--pending">${t} PENDING</span>`),d.innerHTML=s;const l=Pe.reduce((r,o)=>r+(o.cost||0),0)+Pt.reduce((r,o)=>r+(o.cost||0),0);document.getElementById("pm-total-cost").textContent=wt(l),document.getElementById("pm-footer-active").textContent=e,document.getElementById("pm-footer-pending").textContent=t;{if(e===0){i.innerHTML=`<div class="pm-empty">
            ...
            </div>`;return}let r="";Pe.forEach((o,c)=>{const m=zn===c,p=Ln(o.ticks_left,o.total_ticks,o.expiring_soon),u=Math.min(o.ticks_left/(o.total_ticks||1)*100,100);r+=`<div class="pm-item ${o.expiring_soon?"pm-item--expiring":""} ${m?"expanded":""}" onclick="togglePmExpand(${c})">
                <div class="pm-item__inner">
                    ...
                    </div>`,o.note&&(r+=`<div class="pm-note"><span class="pm-note__text">${g(o.note)}</span></div>`),o.expiring_soon&&o.renewable&&(r+=`<div class="pm-btn-row"><button class="pm-btn pm-btn--renew">RENEW — ${wt(o.cost||0)}</button></div>`),r+="</div>"),r+="</div></div>"}),i.innerHTML=r;return}}function qn(){Pe=[],Pt=[],Ii=[],Bn()}let _e=[],Nn=-1;function ae(i){return Math.abs(i)>=1e6?"$"+(i/1e6).toFixed(2)+"M":Math.abs(i)>=1e3?"$"+(i/1e3).toFixed(0)+"k":"$"+i.toLocaleString()}function di(i){return i>=85?"var(--gold)":i>=60?"var(--green)":i>=40?"var(--orange)":"var(--red)"}function Rn(i){return"dl-result--"+i.toLowerCase()}function ci(){const i=document.getElementById("dl-list"),e=_e.length;document.getElementById("dl-count").textContent=`${e} COMPLETED`;const t=_e.reduce((l,r)=>{const o=r.financials||{};return l+((o.payment||0)+(o.bonus||0)-(o.penalty||0)-(o.total_cost||0))},0),a=document.getElementById("dl-lifetime-profit");a.textContent=(t>=0?"+":"")+ae(t),a.style.color=t>=0?"var(--green)":"var(--red)";const n={};_e.forEach(l=>{n[l.result]=(n[l.result]||0)+1});const d=document.getElementById("dl-footer-results");if(d.innerHTML=Object.entries(n).map(([l,r])=>`<div class="dl-footer__result-box">
        ...
        </div>`;return}let s="";_e.forEach((l,r)=>{const o=Nn===r,c=l.financials||{},m=(c.payment||0)+(c.bonus||0)-(c.penalty||0)-(c.total_cost||0),p=m>=0,u=Rn(l.result),v={DISTINCTION:"var(--gold)",PASS:"var(--green)",CONDITIONAL:"var(--orange)",FAIL:"var(--red)"}[l.result]||"var(--text-dim)",w=l.type==="GOVERNMENT";if(s+=`<div class="dl-item ${o?"expanded":""}" onclick="toggleDlExpand(${r})">
            <div class="dl-item__inner" style="border-left:2px solid ${v}">
                ...
                <div class="dl-summary-bar">
                    <div class="dl-summary-cell" style="flex:1;">
                        ...
                        <div style="display:flex;align-items:center;gap:4px;margin-top:2px;">
                            <span class="dl-summary-value" style="color:${di(l.quality_score)}">${l.quality_score}</span>
                ...
                </div>`,o){const $=l.inspection||{};s+='<div style="margin-top:8px;">',s+='<div class="dl-section-label">Inspection Report</div>',["materials","structural","systems"].forEach(S=>{const T=$[S]||{score:0,issues:[]},M=di(T.score),h=Math.min(T.score/100*100,100);s+=`<div class="dl-inspect-row">
        ...
        <div class="eq-summary__cell">
        ...
        </div>`;const n={};for(const l of ie)n[l.equipment_key]=l;let d="";for(let l=1;l<=3;l++){const r=He[l],o=At(l),c=Bt===l,m=o.reduce((u,y)=>u+(n[y.key]?.owned||0),0),p=o.reduce((u,y)=>u+(n[y.key]?.deployed||0),0);if(d+=`<div class="eq-tier-hdr" onclick="toggleEqTier(${l})">
            ...
            ${m>0?`<span class="eq-tier-hdr__count">${p}/${m}</span>`:'<span class="eq-tier-hdr__none">NONE OWNED</span>'}
        </div>`,c)for(const u of o){const y=n[u.key],v=y?.owned||0,w=y?.deployed||0,$=y?.condition||0,E=u.maintenancePerUnit*v,A=v-w,b=v>0&&A===0,S=v>0&&$<65,T=pi($),M=y?.assigned_projects||[],h=M.length>0?M.map(C=>C.contract_name||"Project").join(", ").slice(0,30):v>0&&w>0?w+" project"+(w>1?"s":""):"—";d+=`<div class="eq-row${v===0?" unowned":""}">`,d+=`<div class="eq-row__top">
                    ...
                    </div>`:d+='<div class="eq-row__hint">Purchase from Equipment Market →</div>',d+="</div>"}}document.getElementById("eq-list").innerHTML=d;const s=[1,2,3].map(l=>{const r=He[l],o=At(l).reduce((c,m)=>c+(n[m.key]?.owned||0),0);return`<div class="eq-footer__tier-box" style="border-color:${o>0?r.color+"33":"var(--border-0)"};background:${o>0?r.color+"0a":"transparent"}">
        ...
        <div class="eq-footer__tiers">${s}</div>`}function On(i){Bt=Bt===i?-1:i,Ft()}async function Dn(){if(!f)return;const{data:i,error:e}=await _.from("corp_equipment").select("equipment_key, tier, owned, deployed, condition, maintenance_per_tick, assigned_projects").eq("faction_id",f.id);e?(console.warn("Failed to load equipment:",e.message),ie=[]):ie=i||[],Ft()}async function Hn(){const{data:{user:i}}=await _.auth.getUser();if(!i){window.location.href="login.html";return}const{data:e}=await _.from("factions").select("*").or(`id.eq.${i.id},linked_user_id.eq.${i.id}`);Re=(e||[]).filter(o=>o.nation_id);const t=sessionStorage.getItem("active_faction_id");if(f=Re.find(o=>o.id===t)||Re.find(o=>o.faction_type==="corporation")||Re[0],!f){await _.auth.signOut(),window.location.href="login.html";return}if(f.faction_type!=="corporation"){window.location.href="dashboard.html";return}const[a,n]=await Promise.all([f.nation_id?_.from("nations").select("*").eq("id",f.nation_id).single():Promise.resolve({data:null}),_.from("shard").select("current_tick, current_date, next_tick_at, tick_interval_hours").eq("name","Alpha Shard").single()]);a.error&&console.warn("Nation load failed:",a.error.message),a.data&&(k=a.data),n.error&&console.warn("Shard load failed:",n.error.message),O=n.data;const d=f.corp_ticker||f.abbreviation||"";if(document.getElementById("corp-logo").textContent=d.slice(0,2)||"—",document.getElementById("corp-name-bar").textContent=f.faction_name||"Unnamed Corp",O){if(document.getElementById("game-date").textContent=O.current_date||"—",document.getElementById("tick-number").textContent=O.current_tick||"—",O.next_tick_at){const c=(Number(O.tick_interval_hours)||8)*36e5,m=new Date(O.next_tick_at).getTime(),u=m-c+c/2;qt=new Date(u>Date.now()?u:m+c/2),Qi()}const o=document.querySelector("#tick-countdown")?.closest(".tick-item")?.querySelector(".tick-label");o&&(o.textContent="Next Corp Tick")}document.getElementById("corp-name-badge").textContent=(d?"["+d+"]":f.faction_name||"Corp")+" ▾";const s=document.getElementById("topbar-cash");if(s){const o=Number(f.corp_cash_reserves??0),c=o>=1e9?"$"+(o/1e9).toFixed(1)+"B":o>=1e6?"$"+(o/1e6).toFixed(1)+"M":"$"+Math.round(o/1e3)+"k";s.textContent="CASH: "+c}const l=f.action_points??0;document.getElementById("topbar-ap").innerHTML='<span class="topbar-ap__count">'+l+" AP</span>",document.getElementById("nation-pill").textContent=(k?.name||f.nation||"—").toUpperCase();const r=document.getElementById("corp-faction-dropdown");if(r){let o="";for(const c of Re){const m=c.id===f.id,p=c.faction_type==="corporation"?"CORP":"PARTY",u=c.faction_type==="corporation"?"var(--teal)":"var(--amber)";o+=`<div class="corp-dd-item${m?" active":""}" onclick="switchToFaction('${c.id}', '${c.faction_type}')">
            ...
            </div>`}r.innerHTML=o}await Promise.all([me(),hi(),$n(),Dn(),qn(),Pn()]);try{const{data:o}=await _.from("nations").select("*").order("name");Ke=o||[]}catch{Ke=[]}if(Ei(),nt(),Gi(f,k,O),document.getElementById("loading").style.display="none",document.getElementById("page-content").style.display="block",new URLSearchParams(window.location.search).get("tab")==="expansion"){const o=document.querySelector('[data-tab="expansion"]');o&&Si({preventDefault:()=>{},target:o})}}async function jn(){await _.auth.signOut(),window.location.href="login.html"}function Un(){const i=document.getElementById("corp-faction-dropdown");i&&i.classList.toggle("open")}function Gn(i,e){const t=document.getElementById("corp-faction-dropdown");t&&t.classList.remove("open"),sessionStorage.setItem("active_faction_id",i),e==="corporation"?window.location.href="corp-operations.html":window.location.href="dashboard.html"}document.addEventListener("click",i=>{const e=document.getElementById("faction-switcher"),t=document.getElementById("corp-faction-dropdown");t&&e&&!e.contains(i.target)&&t.classList.remove("open")});document.addEventListener("keydown",i=>{i.key==="Escape"&&et()});window.doLogout=jn;window.toggleTheme=Ki;window.toggleCorpDropdown=Un;window.switchToFaction=Gn;window.setFilter=Ji;window.openContractDetail=gi;window.closeContractDetail=et;window.placeBid=gn;window.toggleWhRow=bn;window.toggleEqTier=On;window.switchEmNation=Cn;window.setEmType=In;window.setEmListing=Mn;window.setEmQty=Sn;window.purchaseEquipment=An;window.setPrMat=hn;window.setPrTier=wn;window.setPrQty=kn;window.purchaseMaterial=En;let G={general:0,skilled:0,innovative:0},kt=!1;const Be=[{id:"general",label:"General Workforce",multiplier:2,color:"#8b9a6b",factionKey:"corp_general_workforce"},{id:"skilled",label:"Skilled Workforce",multiplier:3,color:"#c8a832",factionKey:"corp_skilled_workforce"},{id:"innovative",label:"Innovative Workforce",multiplier:6,color:"#c84",factionKey:"corp_innovative_workforce"}];function Mi(i){const e=Number(k?.minimum_wage??50),t=Number(k?.inflation??50),a=Number(k?.standard_of_living??50),n=e/100*48e3,d=1+(t-50)/100*.5,s=1+(a-50)/100*.5;return Math.round(n*i*d*s)}function x(i){const e=Math.abs(i),t=i<0?"-":"";return e>=1e9?t+"$"+(e/1e9).toFixed(2)+"B":e>=1e6?t+"$"+(e/1e6).toFixed(2)+"M":e>=1e3?t+"$"+(e/1e3).toFixed(1)+"k":t+"$"+e.toLocaleString()}async function Si(i){i.preventDefault(),document.getElementById("operations-content").style.display="none";const e=document.getElementById("expansion-content");e.style.display="flex",e.style.justifyContent="center",e.style.gap="12px",e.style.alignItems="flex-start",e.style.flexWrap="wrap",document.querySelectorAll(".corp-nav__tab").forEach(t=>t.classList.remove("active")),i.target.classList.add("active"),await Ge(),at(),Yn(),await Yt(),ot(),await aa(),st(),Bi(),await ra(),rt()}function Ai(i){i&&i.preventDefault(),document.getElementById("operations-content").style.display="flex",document.getElementById("expansion-content").style.display="none",document.querySelectorAll(".corp-nav__tab").forEach(e=>e.classList.remove("active")),document.querySelector('[data-tab="operations"]')?.classList.add("active")}function Vt(){return Q.reduce((e,t)=>{const a=Number(t.capacity||0),n=Number(t.condition||0)/100;return e+Math.floor(a*n)},0)+500}function Wn(i,e){const t=Be.find(d=>d.id===i),a=Number(f?.[t.factionKey]??0),n=G[i]+e;if(!(a+n<0)){if(e>0){const d=Be.reduce((l,r)=>{const o=Number(f?.[r.factionKey]??0),c=r.id===i?n:G[r.id];return l+o+c},0),s=Vt();if(d>s)return}G[i]=n,at()}}function Fn(i){i?G[i]=0:G={general:0,skilled:0,innovative:0},at()}async function Vn(){if(kt||!Object.values(G).some(s=>s!==0))return;let e=0;for(const s of Be){const l=G[s.id];l>0&&(e+=l*Mi(s.multiplier)*.1)}const t=Number(f?.corp_cash_reserves??0);if(e>t){alert("Insufficient cash reserves. Hiring cost: "+x(e)+", available: "+x(t));return}const a=Be.reduce((s,l)=>s+Number(f?.[l.factionKey]??0)+G[l.id],0),n=Vt();if(a>n){alert("Cannot hire beyond property capacity ("+n.toLocaleString()+"). You need more workplaces.");return}const d=e>0?`Confirm workforce changes?

Hiring fee: `+x(e)+" (deducted from cash reserves)":`Confirm workforce changes?

Firing workers — no cost.`;if(confirm(d)){kt=!0;try{const s={};for(const o of Be){const c=Number(f?.[o.factionKey]??0);s[o.factionKey]=Math.max(0,c+G[o.id])}e>0&&(s.corp_cash_reserves=Math.max(0,t-Math.round(e)));const{error:l}=await _.from("factions").update(s).eq("id",f.id);if(l)throw l;Object.assign(f,s),G={general:0,skilled:0,innovative:0};const r=document.getElementById("topbar-cash");if(r){const o=Number(f.corp_cash_reserves??0);r.textContent="CASH: "+(o>=1e6?"$"+(o/1e6).toFixed(1)+"M":"$"+Math.round(o/1e3)+"k")}at()}catch(s){alert("Error: "+s.message)}finally{kt=!1}}}function at(){const i=document.getElementById("hf-card-container");if(!i)return;const e="'JetBrains Mono', monospace",t={bg:"#121210",surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",greenBright:"#5c5",red:"#c55",redDim:"#a44",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},a=Number(k?.minimum_wage??50),n=Number(k?.inflation??50),d=Number(k?.standard_of_living??50),s=a/100*48e3,l=(1+(n-50)/100*.5).toFixed(2),r=(1+(d-50)/100*.5).toFixed(2),o=k?.name||f?.nation||"Nation",c=Object.values(G).some(E=>E!==0),m=Vt();let p=0,u=0,y=0,v=0,w="";for(const E of Be){const A=Number(f?.[E.factionKey]??0),b=G[E.id],S=A+b,T=Mi(E.multiplier),M=b>0,h=A*T,C=S*T,R=C-h;p+=A,u+=S,y+=h,v+=C;const L=b!==0?M?"rgba(92,204,92,0.02)":"rgba(204,85,85,0.02)":"transparent";w+=`
        ...
        <div style="flex:1;overflow:auto;">
            ...
            <div style="padding:8px 12px;background:${t.card};border-bottom:1px solid ${t.border};">
                ...
                <div style="display:flex;justify-content:space-between;">
                    ...
                    <span style="font-family:${e};font-size:9px;color:${t.text}">${n}/100 → ${x(l)}/yr</span>
                </div>
                <div style="display:flex;justify-content:space-between;margin-top:2px;">
    ...
    </div>`;for(const y of Q){const v=Je[y.style]||Je.Basic;s+=Number(y.purchase_price||0),l+=Number(y.monthly_maintenance||0),d+=`
        <div style="padding:8px 12px;border-bottom:1px solid ${t.border};">
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:3px;">
    ...
    <div style="width:380px;height:450px;background:${t.surface};border:1px solid ${t.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        ...
        <div style="padding:8px 14px;border-top:1px solid ${t.border};background:${t.card};flex-shrink:0;">
            ...
            <div style="display:flex;justify-content:space-between;align-items:center;">
                ...
                <span style="font-family:${e};font-size:13px;font-weight:700;color:${t.red}">${x(l)}/mo</span>
            </div>
        </div>
    </div>`}let ze=[],Y=null;const Je={Basic:{color:"#6a6660",label:"BASIC"},Modern:{color:"#8b9a6b",label:"MODERN"},Sustainable:{color:"#5c5",label:"SUSTAINABLE"},Innovative:{color:"#c8a832",label:"INNOVATIVE"},Heritage:{color:"#c84",label:"HERITAGE"},Premium:{color:"#ca5",label:"PREMIUM"}};async function Yt(){if(!f?.nation_id)return;const{data:i,error:e}=await _.from("available_properties").select("*").eq("nation_id",f.nation_id).eq("status","available").order("price",{ascending:!0});if(e){console.warn("[Property] Failed to load marketplace:",e.message);return}ze=(i||[]).map(t=>({...t,adjusted_cost:t.price,adjusted_maintenance:t.monthly_maintenance}))}function ot(){const i=document.getElementById("new-property-container");if(!i)return;const e="'JetBrains Mono', monospace",t={surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",redDim:"#a44",yellow:"#ca5",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"};(k?.name||f?.nation||"Nation").toUpperCase();const a=Number(k?.standard_of_living??50),n=Number(k?.gdp_growth??50),d=Number(k?.inflation??50),s=k?.capital||"Capital",l={capital:s,port:s+" Port",industrial:s+" Industrial Zone",suburban:s+" Suburbs",coastal:s+" Coast"};let r="";if(ze.length===0)r=`<div style="padding:20px;text-align:center;font-family:${e};font-size:10px;color:${t.dim}">No properties available in this market.<br>Improve GDP Growth and Standard of Living to unlock more.</div>`;else for(let o=0;o<ze.length;o++){const c=ze[o],m=Y===o,p=Je[c.style]||Je.Basic,u=l[c.city_template]||s;r+=`
    ...
    <div style="width:380px;height:450px;background:${t.surface};border:1px solid ${t.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        ...
        <div style="padding:8px 14px;border-top:1px solid ${t.border};background:${t.card};flex-shrink:0;">
            <div style="display:flex;gap:6px;justify-content:space-between;">
                ...
                <div onclick="npBuyProperty()" style="flex:1;padding:6px 0;text-align:center;font-family:${e};font-size:9px;font-weight:700;letter-spacing:1px;color:${Y!==null?"#000":t.dim};background:${Y!==null?t.accent:"transparent"};border:1px solid ${Y!==null?t.accent:t.border};cursor:${Y!==null?"pointer":"default"};opacity:${Y!==null?1:.4}">BUY PROPERTY</div>
            </div>
        </div>
    </div>`}function Qn(i){Y=Y===i?null:i,ot()}let Et=!1;async function Kn(){if(Y===null||Et)return;const i=ze[Y];if(!i)return;const e=Number(f?.corp_cash_reserves??0);if(i.adjusted_cost>e){alert(`Insufficient cash reserves.
...
All construction corporations in `+e+" can now bid on this project.")}catch(i){alert("Failed to submit project: "+i.message)}finally{Tt=!1}}}function Li(){if(document.getElementById("cp-modal-overlay")?.remove(),!Qt)return;const i="'JetBrains Mono', monospace",e={surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",redDim:"#a44",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},t=zi(),a=k?.name||f?.nation||"Nation",n=he[I.style]?.repGain||1,d=n>=4?e.gold:n>=3?e.greenBright:n>=2?e.accent:e.dim,s=Object.entries(he).map(([o,c])=>{const m=I.style===o;return`<div onclick="cpSetField('style','${o}')" style="padding:5px 6px;cursor:pointer;text-align:center;background:${m?c.color+"18":"transparent"};border:1px solid ${m?c.color+"44":e.border};">
    ...
    </div>`,document.body.appendChild(l);const r=document.getElementById("cp-name-input");r&&r.addEventListener("input",o=>{I.name=o.target.value}),l.addEventListener("click",o=>{o.target===l&&Kt()})}function ea(){const i=document.getElementById("cp-name-input");if(i&&(I.name=i.value),!I.name.trim()){alert("Please enter a building name.");return}Zn()}window.cpClose=Kt;window.cpSetField=Xn;window.cpSubmitFromModal=ea;window.npSelect=Qn;window.npBuyProperty=Kn;window.npOpenConstructionModal=Jn;let qe=!1;async function ta(i){if(qe)return;const e=Q.find(l=>l.id===i);if(!e)return;const t=1+(Number(k?.inflation??50)-50)/100*.3,a=Math.round((e.purchase_price||0)*.1*t),n=Number(f?.corp_cash_reserves??0);if(a>n){alert("Insufficient cash. Refurbishment costs "+x(a)+" (inflation-adjusted), you have "+x(n));return}if(e.condition>=95){alert("Property is already in excellent condition ("+e.condition+"%).");return}const d=5+Math.floor(Math.random()*21),s=Math.min(100,e.condition+d);if(confirm('Refurbish "'+e.name+`"?

Cost: `+x(a)+`
Expected improvement: +`+d+"% condition ("+e.condition+"% → "+s+"%)")){qe=!0;try{await _.from("corp_properties").update({condition:s}).eq("id",i);const l=Math.max(0,n-a);await _.from("factions").update({corp_cash_reserves:l}).eq("id",f.id),f.corp_cash_reserves=l;const r=document.getElementById("topbar-cash");r&&(r.textContent="CASH: "+(l>=1e6?"$"+(l/1e6).toFixed(1)+"M":"$"+Math.round(l/1e3)+"k")),await Ge(),We(),alert("Refurbished! Condition: "+e.condition+"% → "+s+"%")}catch(l){alert("Refurbishment failed: "+l.message)}finally{qe=!1}}}async function ia(i){if(qe)return;const e=Q.find(d=>d.id===i);if(!e)return;const t=1+(Number(k?.inflation??50)-50)/100*.3,a=(e.condition||50)/100,n=Math.round((e.purchase_price||0)*.6*a*t);if(confirm('Sell "'+e.name+`"?

Sale value: `+x(n)+" (60% × "+e.condition+`% condition × inflation)

The property will go back on the market for 6 ticks.
This cannot be undone.`)){qe=!0;try{await _.from("corp_properties").update({is_active:!1}).eq("id",i);const s=Number(f?.corp_cash_reserves??0)+n;await _.from("factions").update({corp_cash_reserves:s}).eq("id",f.id),f.corp_cash_reserves=s;const r=(await _.from("shard").select("current_tick").eq("name","Alpha Shard").single()).data?.current_tick||0;await _.from("available_properties").insert({nation_id:f.nation_id,catalog_id:e.catalog_id||null,name:e.name,type:e.type,style:e.style,capacity:e.capacity,price:Math.round(n*1.1),monthly_maintenance:e.monthly_maintenance,condition:e.condition,city:e.city,generated_at_tick:r,expires_at_tick:r+6,status:"available"});const o=document.getElementById("topbar-cash");o&&(o.textContent="CASH: "+(s>=1e6?"$"+(s/1e6).toFixed(1)+"M":"$"+Math.round(s/1e3)+"k")),await Ge(),We(),await Yt(),ot(),alert('Sold "'+e.name+'" for '+x(n))}catch(d){alert("Sale failed: "+d.message)}finally{qe=!1}}}window.propRefurbish=ta;window.propSell=ia;let Oe=0;function Bi(){const i=document.getElementById("manage-subsidiaries-container");if(!i)return;const e="'JetBrains Mono', monospace",t={surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",blue:"#5a9abf",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",greenDark:"#2a5a3a",red:"#c55",yellow:"#ca5",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},a=Q.filter(r=>r.type==="regional_hq");Oe>=a.length&&(Oe=0);const n=a[Oe]||null;let d="";a.length===0&&(d=`<div style="padding:30px 14px;text-align:center;font-family:${e};font-size:10px;color:${t.dim}">No subsidiaries established.<br>Use Create Subsidiary to expand.</div>`);let s=0;for(let r=0;r<a.length;r++){const o=a[r],c=r===Oe,m=Number(o.purchase_price||0);s+=m;const p=je.find(u=>u.id===o.nation_id)?.name||o.city||"—";d+=`
...
Regional HQ created with `+s+"% condition.")}catch(n){alert("Failed: "+n.message)}finally{Ct=!1}}}function st(){const i=document.getElementById("create-subsidiary-container");if(!i)return;const e="'JetBrains Mono', monospace",t={surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",blue:"#5a9abf",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},a=new Set(Q.filter(r=>r.type==="regional_hq").map(r=>r.nation_id)),n=je.filter(r=>!a.has(r.id)),d=re?n.find(r=>r.id===re):null;let s="";for(const r of n){const o=r.id===re,c=Ot(r),m=Number(r.standard_of_living??50),p=Number(r.stability??50),u=c>6e7?t.red:c>4e7?t.orange:t.greenBright;s+=`
    ...
    <div style="width:380px;height:450px;background:${t.surface};border:1px solid ${t.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        ...
        </div>`}let c="";if(s){const p=a[s.status]||a.PRIVATE,u=[{label:"Sector",value:s.corp_sector||"—",color:t.text},{label:"Subsector",value:s.corp_subsector||"—",color:t.accent},{label:"Reputation",value:s.reputation+"/100",color:s.reputation>=70?t.greenBright:s.reputation>=40?t.accent:t.yellow},{label:"Revenue",value:l?"UNDISCLOSED":x(s.revenue),color:l?t.dim:t.greenBright},{label:"Cash Reserves",value:l?"UNDISCLOSED":x(s.corp_cash_reserves||0),color:l?t.dim:t.text},{label:"Market Valuation",value:l?"UNDISCLOSED":x(s.valuation),color:l?t.dim:t.gold}];c=`
        <div style="padding:8px 14px;border-bottom:1px solid ${t.border};background:${t.card};flex-shrink:0;">
    ...
    <div style="width:760px;height:450px;background:${t.surface};border:1px solid ${t.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        ...
        <div style="display:flex;align-items:center;padding:5px 14px;border-bottom:1px solid ${e.border};">
            ...
            <div style="flex:1.2;display:flex;gap:2px;justify-content:center;">
                ${["LOW","STD","HIGH"].map(ve=>{const vt=ti===ve,oi=c[ve],Ui=x(Math.round(ii*o[ve]));return`<span onclick="bidSetGrade('${z}','${ve}')" style="padding:2px 6px;font-family:${i};font-size:7px;font-weight:700;cursor:pointer;color:${vt?"#000":e.dim};background:${vt?oi:"transparent"};border:1px solid ${vt?oi:e.border}" title="${Ui}/unit">${m[ve]}</span>`}).join("")}
            </div>
            <div style="flex:0.8;text-align:right"><span style="font-family:${i};font-size:10px;color:${e.text}">${x(ni)}</span></div>
        </div>`}const w=t.required_workforce||{},$=Number(w.general||0)+Number(w.skilled||0)||100,E=Math.max(40,Math.round($*.5)),A=$*2,b=[E,Math.round($*.75),$,Math.round($*1.5),A],S=Math.max(0,Math.min(1,(U-E)/(A-E||1))),T=s,M=Math.round(4.5-S*8),h=Math.max(Math.round(T*.6),T+M),C=M>0?`+${M}mo`:M<0?`${M}mo`:"On schedule",R=M>0?e.red:M<0?e.greenBright:e.yellow,L=15200,P=U*L*h,K=d,Me=[{name:"Municipal Zoning Approval",cost:18e4,ticks:2,required:!0},{name:"Structural Engineering Cert.",cost:24e4,ticks:3,required:!0},{name:"Environmental Impact Assessment",cost:34e4,ticks:8,required:K>2e7},{name:"Seismic Resilience Compliance",cost:21e4,ticks:4,required:K>5e7},{name:"Heritage Conservation Review",cost:16e4,ticks:6,required:!1},{name:"Fire Safety Certification",cost:12e4,ticks:2,required:K>1e7}].filter(z=>z.required),Xt=new Set(["Municipal Zoning Approval","Structural Engineering Cert."]),ct=Me.filter(z=>!Xt.has(z.name)).reduce((z,D)=>z+D.cost,0),pt=4e5,mt=y+P+ct+pt,Zt=Math.round(mt*(de/100)),Fe=mt+Zt,V=Fe>d,ft=Zt,ue=V?0:Math.max(0,Math.min(100,Math.round(100-Fe/d*100+30))),ei=ue>70?e.greenBright:ue>40?e.yellow:ue>0?e.orange:e.red,Ni=V?"OVER CEILING":ue>70?"STRONG":ue>40?"COMPETITIVE":ue>20?"WEAK":"UNLIKELY",ut=Object.values(le),ye=ut.length>0?Math.round(ut.reduce((z,D)=>z+(D==="HIGH"?85:D==="STD"?65:45),0)/ut.length):50,Ve=ye>=75?e.greenBright:ye>=55?e.yellow:e.orange,Ri=ye>=75?"STRONG":ye>=55?"PROMISING":"UNCERTAIN",Se=document.createElement("div");Se.id="bid-assembly-overlay",Se.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.7);display:flex;align-items:center;justify-content:center;z-index:9999;",Se.addEventListener("click",z=>{z.target===Se&&Jt()}),Se.innerHTML=`
    <div style="width:740px;max-height:94vh;background:${e.surface};border:1px solid ${e.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        ...
        <div style="padding:10px 16px;border-bottom:1px solid ${e.border};background:${e.card};flex-shrink:0;">
            ...
            <div style="display:flex;align-items:center;gap:8px;margin-top:4px;">
                ...
                <span style="font-family:${i};font-size:9px;color:${e.dim}">·</span>
                <span style="font-family:${i};font-size:9px;color:${e.muted}">Ceiling: <span style="color:${e.text};font-weight:700">${x(d)}</span></span>
                <span style="font-family:${i};font-size:9px;color:${e.dim}">·</span>
        ...
        <div style="flex:1;display:flex;overflow:hidden;">
            ...
            <div style="flex:1;border-right:1px solid ${e.border};overflow:auto;">
                ...
                ${Me.map(z=>{const D=Xt.has(z.name);return`<div style="display:flex;align-items:center;padding:4px 14px;border-bottom:1px solid ${e.border};">
            ...
            <div style="width:280px;display:flex;flex-direction:column;overflow:auto;">
                ...
                <div style="padding:10px 14px;border-bottom:1px solid ${e.border};background:${V?"rgba(204,85,85,0.04)":"rgba(200,168,50,0.03)"};">
                    ...
                    <div style="font-family:${i};font-size:22px;font-weight:700;color:${V?e.red:e.gold}">${x(Fe)}</div>
                    ${V?`<div style="font-family:${i};font-size:8px;font-weight:700;color:${e.red};margin-top:4px;padding:2px 6px;background:rgba(204,85,85,0.08);border:1px solid rgba(204,85,85,0.15);display:inline-block">EXCEEDS BUDGET CEILING (${x(d)})</div>`:""}
                </div>
                ...
                <div style="padding:8px 14px;border-bottom:1px solid ${e.border};">
                    <div style="display:flex;justify-content:space-between;margin-bottom:4px;">
                        ...
                        <span style="font-family:${i};font-size:11px;font-weight:700;color:${ei}">${Ni}</span>
                    </div>
                    <div style="width:100%;height:4px;background:${e.border}"><div style="width:${ue}%;height:100%;background:${ei}"></div></div>
                </div>
                <div style="padding:8px 14px;border-bottom:1px solid ${e.border};">
                    <div style="display:flex;justify-content:space-between;margin-bottom:4px;">
        ...
        <div style="padding:10px 16px;border-top:1px solid ${e.border};background:${e.card};display:flex;justify-content:space-between;align-items:center;flex-shrink:0;">
            <div style="display:flex;gap:12px;">
                <div><div style="font-family:${i};font-size:7px;color:${e.dim}">YOUR BID</div><div style="font-family:${i};font-size:14px;font-weight:700;color:${V?e.red:e.gold}">${x(Fe)}</div></div>
            ...
            <div style="display:flex;gap:8px;">
                ...
                <div onclick="${V?"":"submitBidAssembly()"}" style="padding:6px 24px;font-family:${i};font-size:10px;font-weight:700;letter-spacing:1px;color:${V?e.dim:"#000"};background:${V?e.border:e.gold};cursor:${V?"not-allowed":"pointer"};opacity:${V?.5:1}">SUBMIT BID</div>
            </div>
        </div>
    </div>`,document.body.appendChild(Se)}let Ne=!1;async function ya(){if(Ne||!ne)return;const i=ne,e=i.required_materials||{},t=Object.keys(e),a=Number(i.budget_ceiling||0),n=Number(i.timeline_ticks||8),d={concrete:36e4,steel:5e5,glass_facades:56e4,em_systems:64e4,lumber:24e4,heavy_parts:8e5,aggregate:16e4,asphalt:28e4},s={LOW:.5,STD:1,HIGH:2};let l=0;for(const L of t){const P=Number(e[L]||0),K=le[L]||"STD",fe=d[L]||3e5;l+=P*Math.round(fe*s[K])}const r=15200,o=i.required_workforce||{},c=Number(o.general||0)+Number(o.skilled||0)||100,m=Math.max(40,Math.round(c*.5)),p=c*2,u=Math.max(0,Math.min(1,(U-m)/(p-m||1))),y=Math.round(4.5-u*8),v=Math.max(Math.round(n*.6),n+y),w=U*r*v,$=a,E=[{name:"Municipal Zoning Approval",cost:18e4,required:!0},{name:"Structural Engineering Cert.",cost:24e4,required:!0},{name:"Environmental Impact Assessment",cost:34e4,required:$>2e7},{name:"Seismic Resilience Compliance",cost:21e4,required:$>5e7},{name:"Fire Safety Certification",cost:12e4,required:$>1e7}],A=new Set(["Municipal Zoning Approval","Structural Engineering Cert."]),b=E.filter(L=>L.required&&!A.has(L.name)).reduce((L,P)=>L+P.cost,0),T=l+w+b+4e5,M=Math.round(T*(de/100)),h=T+M;if(h>a){alert("Bid exceeds budget ceiling. Reduce costs or markup.");return}const C=Object.values(le),R=C.length>0?Math.round(C.reduce((L,P)=>L+(P==="HIGH"?85:P==="STD"?65:45),0)/C.length):50;if(confirm('Submit bid for "'+i.name+`"?
...
Once submitted, your bid cannot be changed.`)){Ne=!0;try{const{data:L}=await _.from("shard").select("current_tick").eq("name","Alpha Shard").single(),P=L?.current_tick||0,K={};for(const Me of t)K[Me]=le[Me]||"STD";const{error:fe}=await _.from("contract_bids").insert({contract_id:i.id,faction_id:f.id,bid_price:h,material_grades:K,labor_count:U,markup_pct:de,estimated_cost:T,estimated_quality:R,status:"pending",submitted_at_tick:P});if(fe)throw fe;i.status==="open"&&await _.from("construction_contracts").update({status:"bidding"}).eq("id",i.id).eq("status","open"),Jt(),alert(`Bid submitted successfully!
...
No bids will be accepted. The contract will be removed.`)){St=!0;try{const{error:i}=await _.from("contract_bids").update({status:"lost"}).eq("contract_id",Z.id);if(i)throw i;const{error:e}=await _.from("construction_contracts").update({status:"expired"}).eq("id",Z.id);if(e)throw e;dt(),alert("All bids declined. Contract cancelled."),typeof me=="function"&&await me()}catch(i){alert("Failed: "+(i.message||i))}finally{St=!1}}}function qi(){if(document.getElementById("bid-review-overlay")?.remove(),!Z||Ue.length===0)return;const i="'JetBrains Mono', monospace",e={surface:"#1a1a16",card:"#1c1c18",border:"#2a2a24",accent:"#8b9a6b",accentBright:"#a3b07e",gold:"#c8a832",orange:"#c84",greenBright:"#5c5",red:"#c55",yellow:"#ca5",text:"#e8e4dc",muted:"#9e9a92",dim:"#6a6660"},t=Z,a=Ue;ke>=a.length&&(ke=0);const n=a[ke],d=Number(t.budget_ceiling||0),s=Number(t.timeline_ticks||36),l=Math.min(...a.map(u=>u.bid_price)),r=Math.max(...a.map(u=>u.estimated_quality||0));let o="";for(let u=0;u<a.length;u++){const y=a[u],v=u===ke,w=y.bid_price===l,$=(y.estimated_quality||0)===r,E=y.bid_price>d;o+=`
        ...
        </div>`}const c=n.bid_price>d,m=d>0?Math.round(n.bid_price/d*100):0,p=document.createElement("div");p.id="bid-review-overlay",p.style.cssText="position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.7);display:flex;align-items:center;justify-content:center;z-index:9999;",p.addEventListener("click",u=>{u.target===p&&dt()}),p.innerHTML=`
    <div style="width:640px;max-height:92vh;background:${e.surface};border:1px solid ${e.border};display:flex;flex-direction:column;overflow:hidden;font-family:'IBM Plex Sans',sans-serif;">
        <div style="padding:10px 16px;border-bottom:1px solid ${e.border};background:${e.card};flex-shrink:0;">
            ...
            <div style="display:flex;gap:8px;margin-top:4px;font-family:${i};font-size:9px;color:${e.dim};">
                ...
                <span>·</span>
                <span>Budget: <span style="color:${e.text};font-weight:700">${x(d)}</span></span>
                <span>·</span>
        ...
        <div style="padding:6px 16px;border-bottom:1px solid ${e.border};display:flex;justify-content:space-between;align-items:center;flex-shrink:0;">
            ...
            <div style="display:flex;gap:8px;font-family:${i};font-size:8px;color:${e.dim};">
                <span>Cheapest: <span style="color:${e.greenBright}">${x(l)}</span></span>
    ...
    </div>`,document.body.appendChild(p)}window.openBidReview=va;window.closeBidReview=dt;window.reviewSelectBid=ga;window.acceptBid=xa;window.declineAllBids=ba;window.switchToExpansion=Si;window.switchToOperations=Ai;window.hfSetChange=Wn;window.hfReset=Fn;window.hfConfirm=Vn;document.querySelector('[data-tab="operations"]')?.addEventListener("click",function(i){this.classList.contains("active")||(i.preventDefault(),Ai(i))});Hn();
