-- ===========================================================================
-- 125 · National malaise — the yearly cost of letting a headline stat slip below 9, plus the
...
declare
  ...
  v_regime numeric; v_open boolean; v_gdp_delta numeric; v_debt numeric;
begin
