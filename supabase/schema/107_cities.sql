...
--
-- A city is flavour: a name, an optional capital marker, an optional share of the
-- nation's population, and a description. Shown on the public Nation page; authored
-- in adminsetup. No mechanical effect — nothing in the tick reads these.
-- ===========================================================================
