-- ════════════════════════════════════════════════════════════════════════════════
-- Create corp_cash_history in the production migration path.
--
-- Ported from: sql/migrations/20260419_corp_cash_history.sql
--
-- Why:
--   The dashboard Finances card reads per-tick cash snapshots from
--   public.corp_cash_history to show "Last Tick Cash Change".
--   Production applies migrations from supabase/migrations, so this table
