...
export const BUILD_COALITION_AP_COST = 3;
export const BUILD_COALITION_MONEY_COST = 200000;
export const BUILD_COALITION_COOLDOWN_TICKS = 2;
export const BUILD_COALITION_PANDER_HISTORY_TICKS = 10;

export const PANDER_OPPOSITION_MAP = {
