...
export async function bootstrapPolitician(activeTab) {
  ...
  const [facRes, shardRes] = await Promise.all([
    _supabase.from('factions')
      .select('id, faction_type, faction_name, nation, nation_id, branch, leader_first_name, leader_last_name, leader_age, nickname, founded_tick, party_funds, abandoned_at, is_banned, politician_capital, politician_reputation, politician_skill, politician_influence, politician_suspicion, volunteers, politician_party_id, politician_office, politician_office_won_at_tick, politician_ministry, politician_senior_civil_servant_at_tick, politician_agency_head_of, politician_permanent_secretary_at_tick, politician_permanent_secretary_ministry, politician_junior_portfolio, politician_deputy_minister_ministry, politician_deputy_minister_at_tick, politician_seek_appointment_cooldown_until_tick, politician_former_community_organizer, civil_service_exam_cooldown_until_tick, next_member_action_tick, next_party_motion_tick, next_mp_action_tick, next_local_action_tick, next_civil_service_action_tick, next_lobby_minister_tick, bar_admitted_nation_id, bar_admitted_at_tick, bar_last_attempt_tick, politician_foreign_service_nation_id, politician_foreign_service_at_tick, foreign_service_last_attempt_tick, politician_consul_nation_id, politician_consul_at_tick, next_backchannel_tick, politician_dcm_region, politician_dcm_at_tick, next_dcm_action_tick, politician_foreign_minister_at_tick, politician_special_envoy_at_tick, politician_ambassador_nation_id, politician_ambassador_at_tick, politician_ambassador_strikes, next_ambassador_request_tick, next_ambassador_action_tick, embassy_budget, embassy_reputation, embassy_trust, embassy_leverage, next_embassy_action_tick, next_embassy_contacts_tick, politician_fis_joined_at_tick, next_fis_action_tick, politician_experienced_advocate_at_tick, politician_magistrate_at_tick, politician_state_prosecutor_at_tick, politician_appellate_justice_at_tick, politician_supreme_court_justice_at_tick, politician_mayor_at_tick, politician_mayor_of_capital_at_tick, politician_regional_leader_at_tick, politician_deputy_speaker_at_tick, politician_speaker_of_assembly_at_tick, try_case_cooldown_until_tick, party_cooldown_until_tick')
