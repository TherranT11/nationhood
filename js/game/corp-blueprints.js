...
export const JOB_TRACKS = {
  ...
  management: [
    { rung: 1, name: 'Branch Manager', postable: true,
      desc: 'Your name on the door, the branch\u2019s numbers are your numbers. Everything the bank promises, you deliver across a counter \u2014 the deposits gathered, the queues kept short, the trust kept whole.',
      resp: 'Runs one branch; answers for its deposit growth and its reputation on the street.' },
    { rung: 2, name: 'Regional Director', postable: true,
      desc: 'Twelve branches, one budget, a car allowance and ulcers. You stop seeing customers and start seeing patterns \u2014 which managers grow their book, which towns are drying up, where the next branch should stand.',
      resp: 'Oversees the branches of a region; arbitrates budgets and standards between Branch Managers.' },
    { rung: 3, name: 'Head of Retail Banking', postable: true,
      desc: 'Every region reports to you. The deposit base isn\u2019t weather anymore \u2014 it\u2019s something you steer: the rates pitched at the counter, the campaigns, the standard the whole network holds.',
      resp: 'Commands the entire branch network; owns the bank\u2019s share of the nation\u2019s savings.' },
    { rung: 4, name: 'Treasurer', postable: true,
      desc: 'The bank\u2019s own money is your portfolio now: the float, the reserve, what sits where overnight. The first rung where the liability side keeps you awake \u2014 every deposit gathered downstairs is a promise you have to be able to keep.',
      resp: 'Manages the bank\u2019s liquidity and reserves; answers for every promise the branches make.' },
    { rung: 5, name: 'Chief Financial Officer (CFO)', postable: true,
      desc: 'The books, full stop. The owner decides what the bank dares; you decide what it can afford \u2014 and you\u2019re the one who signs. When the gauge runs hot and the examiners call, yours is the name on the letterhead.',
      resp: 'Ultimate authority over the bank\u2019s finances; answers only to the owner \u2014 and signs everything.' },
  ],
  credit: [
    { rung: 1, name: 'Credit Analyst', postable: true,
      desc: 'The file before the face. You read statements, ratios, and the lies told in footnotes \u2014 you will never meet a borrower, and you\u2019ll know them better than their own accountants do.',
      resp: 'Assesses borrower files; never signs, only recommends.' },
    { rung: 2, name: 'Loan Officer', postable: true,
      desc: 'The desk where borrowers sit. First handshake, first signature, first time a number you wrote becomes someone\u2019s payroll. The board\u2019s asks stop being rows and start being people.',
      resp: 'Originates loans across the desk; owns the borrower relationship.' },
    { rung: 3, name: 'Underwriter', postable: true,
      desc: 'You price the risk. Term, collateral, the rate off prime \u2014 the ticket\u2019s shape is yours before anyone upstairs sees it. Your initials go inside every file, where only auditors and historians look.',
      resp: 'Sets the terms on every loan the bank writes; the last word before the offer.' },
    { rung: 4, name: 'Credit Risk Manager', postable: true,
      desc: 'The professional no. You kill deals everyone loves and you\u2019re right just often enough that they keep you. Nobody thanks the risk manager in the good years; nobody survives without one in the bad.',
      resp: 'Guards the book against bad paper; vetoes what the desk wants to approve.' },
    { rung: 5, name: 'Director of Lending', postable: true,
      desc: 'The whole book is yours: growth targets pulling one way, default exposure the other, the clearing house always one loan too small. You stop judging borrowers and start judging your own judges.',
      resp: 'Runs the entire loan portfolio; balances growth against exposure.' },
    { rung: 6, name: 'Chief Lending Officer (CLO)', postable: true,
      desc: 'You sit across from the CFO and the table is even. The deposit side gathers the money; you decide who deserves it. When a loan goes bad everyone looks at you \u2014 because the book IS the bank, and the book is yours.',
      resp: 'Ultimate authority over the bank\u2019s lending; answers only to the owner.' },
  ],
  manufacturing: [
...
export const INDUSTRY_JOB_TRACKS = {
  ...
  banking: [
    { key: 'management', label: 'MANAGEMENT',
      blurb: 'The field-to-headquarters track. You start running one branch and rise to running the bank\u2019s books as Chief Financial Officer.',
      tension: 'The defining tension: trust is the only product, and it compounds slower than interest while evaporating faster than a run. Every rung you climb, more of the deposit base rests on promises you personally signed.' },
    { key: 'credit', label: 'CREDIT',
      blurb: 'The judgment track. You start reading files nobody else finishes and rise to owning every dollar the bank has lent as Chief Lending Officer.',
      tension: 'The defining tension: every yes you sign outlives you. A deposit can leave in a day; a 36-tick loan is a marriage \u2014 and the analyst who approved it will be three rungs higher when it defaults, with their initials still inside the file.' },
  ],
  automotive: [
